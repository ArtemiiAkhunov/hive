...
public class SubmitWorkInfo implements Writable
{
    ...
    public SubmitWorkInfo(ApplicationId fakeAppId, long creationTime, int vertexParallelism, byte[] vertexSpec, byte[] vertexSpecSignature, Token<JobTokenIdentifier> token)
    {
