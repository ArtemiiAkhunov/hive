...
public interface LlapIo<T>
{
     ...
     * @throws IOException
     */
    MemoryBufferOrBuffers getParquetFooterBuffersFromCache(Path path, JobConf conf, @Nullable Object fileKey) throws IOException;
     ...
     * @throws IOException
     */
    RecordReader<NullWritable, VectorizedRowBatch> llapVectorizedOrcReaderForPath(Object fileKey, Path path, CacheTag tag, List<Integer> tableIncludedCols, JobConf conf, long offset, long length, Reporter reporter) throws IOException;
