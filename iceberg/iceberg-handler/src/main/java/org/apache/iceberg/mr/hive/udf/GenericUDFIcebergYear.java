...
public class GenericUDFIcebergYear extends GenericUDF
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        {
            throw new UDFArgumentLengthException("ICEBERG_YEAR requires 1 arguments (value), but got " + arguments.length);
        }

        if (arguments[0].getCategory() != ObjectInspector.Category.PRIMITIVE)
        {
            throw new UDFArgumentException("ICEBERG_YEAR first argument takes primitive types, got " + argumentOI.getTypeName());
        }
        ...
        switch (inputType)
        {
            ...
            default:
                throw new UDFArgumentException(" ICEBERG_YEAR() only takes DATE/TIMESTAMP/TIMESTAMPLOCALTZ" + " types as first argument, got " + inputType);
        }
