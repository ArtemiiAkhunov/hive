 ...
 */
@Description(name = "iceberg_hour", value = "_FUNC_(value) - " + "Returns the bucket value calculated by Iceberg hour transform function ", extended = "Example:\n  > SELECT _FUNC_('2023-01-01 11:00:57');\n  11")
public class GenericUDFIcebergHour extends GenericUDF
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        {
            throw new UDFArgumentLengthException("ICEBERG_HOUR requires 1 arguments (value), but got " + arguments.length);
        }

        if (arguments[0].getCategory() != ObjectInspector.Category.PRIMITIVE)
        {
            throw new UDFArgumentException("ICEBERG_HOUR first argument takes primitive types, got " + argumentOI.getTypeName());
        }
        ...
        switch (inputType)
        {
            ...
            default:
                throw new UDFArgumentException(" ICEBERG_HOUR() only takes TIMESTAMP/TIMESTAMPLOCALTZ" + " types as first argument, got " + inputType);
        }
