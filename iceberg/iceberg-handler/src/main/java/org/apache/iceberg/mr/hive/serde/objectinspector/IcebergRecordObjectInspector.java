...
public final class IcebergRecordObjectInspector extends StructObjectInspector
{
    ...
    private static final IcebergRecordObjectInspector EMPTY = new IcebergRecordObjectInspector(Types.StructType.of(), Collections.emptyList());
    ...
    public IcebergRecordObjectInspector(Types.StructType structType, List<ObjectInspector> objectInspectors)
    {
        ...
        for (Types.NestedField field : structType.fields())
        {
            ...
            Types.NestedField fieldInLowercase = Types.NestedField.of(field.fieldId(), field.isOptional(), field.name().toLowerCase(), field.type(), field.doc());
