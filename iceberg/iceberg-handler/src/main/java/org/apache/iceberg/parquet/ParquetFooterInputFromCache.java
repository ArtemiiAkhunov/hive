 ...
 */
public final class ParquetFooterInputFromCache extends SeekableInputStream implements InputFile
{
    ...
    public void seek(long pos) throws IOException
    {
        ...
        throw new IOException("Incorrect seek " + targetPos + "; footer length " + footerLength + Arrays.toString(positions));
    }
