...
public class HiveIcebergSerDe extends AbstractSerDe
{
    ...
    public void initialize(@Nullable Configuration configuration, Properties serDeProperties, Properties partitionProperties) throws SerDeException
    {
        ...
        } else
        {
            ...
            } catch (Exception e)
            {
                ...
                if (e instanceof NoSuchTableException && HiveTableUtil.isCtas(serDeProperties) && !Catalogs.hiveCatalog(configuration, serDeProperties))
                {
        ...
        this.projectedSchema = projectedSchema(configuration, serDeProperties.getProperty(Catalogs.NAME), tableSchema, jobConf);
    ...
    private static Schema projectedSchema(Configuration configuration, String tableName, Schema tableSchema, Map<String, String> jobConfs)
    {
        ...
        if (operation == null)
        {
            ...
            Schema projectedSchema = distinctSelectedColumns.length > 0 ? tableSchema.caseInsensitiveSelect(distinctSelectedColumns) : tableSchema;
    ...
    public Writable serialize(Object o, ObjectInspector objectInspector)
    {
        ...
        {
            deserializer = new Deserializer.Builder().schema(projectedSchema).sourceInspector((StructObjectInspector) objectInspector).writerInspector((StructObjectInspector) inspector).build();
