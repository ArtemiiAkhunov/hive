...
public class GenericUDFIcebergBucket extends GenericUDF
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        {
            throw new UDFArgumentException("ICEBERG_BUCKET first argument takes primitive types, got " + argumentOI.getTypeName());
        }
        ...
        switch (inputType)
        {
            ...
            case BINARY:
                converter = new PrimitiveObjectInspectorConverter.BinaryConverter(argumentOI, PrimitiveObjectInspectorFactory.writableBinaryObjectInspector);
            ...
            case INT:
                converter = new PrimitiveObjectInspectorConverter.IntConverter(argumentOI, PrimitiveObjectInspectorFactory.writableIntObjectInspector);
            ...
            case LONG:
                converter = new PrimitiveObjectInspectorConverter.LongConverter(argumentOI, PrimitiveObjectInspectorFactory.writableLongObjectInspector);
            ...
            case DECIMAL:
                ...
                Type.PrimitiveType decimalIcebergType = Types.DecimalType.of(decimalTypeInfo.getPrecision(), decimalTypeInfo.getScale());

                converter = new PrimitiveObjectInspectorConverter.HiveDecimalConverter(argumentOI, new WritableHiveDecimalObjectInspector(decimalTypeInfo));
            ...
            case FLOAT:
                converter = new PrimitiveObjectInspectorConverter.FloatConverter(argumentOI, PrimitiveObjectInspectorFactory.writableFloatObjectInspector);
            ...
            case DATE:
                converter = new PrimitiveObjectInspectorConverter.DateConverter(argumentOI, PrimitiveObjectInspectorFactory.writableDateObjectInspector);
