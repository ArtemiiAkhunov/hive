...
public final class HiveIcebergVectorizedRecordReader extends AbstractMapredIcebergRecordReader<VectorizedRowBatch>
{
    ...
    public HiveIcebergVectorizedRecordReader(org.apache.iceberg.mr.mapreduce.IcebergInputFormat<VectorizedRowBatch> mapreduceInputFormat, IcebergSplit split, JobConf job, Reporter reporter) throws IOException
    {
