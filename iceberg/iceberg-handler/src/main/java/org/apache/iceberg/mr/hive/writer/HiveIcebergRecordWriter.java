...
class HiveIcebergRecordWriter extends HiveIcebergWriterBase
{
    ...
    {
        return fanoutEnabled ? new FanoutDataWriter<>(fileWriterFactory, fileFactory, io, targetFileSize) : new ClusteredDataWriter<>(fileWriterFactory, fileFactory, io, targetFileSize);
    }
}
