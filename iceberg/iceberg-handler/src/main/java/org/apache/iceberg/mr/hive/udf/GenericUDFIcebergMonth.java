...
public class GenericUDFIcebergMonth extends GenericUDF
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        {
            throw new UDFArgumentException("ICEBERG_MONTH first argument takes primitive types, got " + argumentOI.getTypeName());
        }
        ...
        switch (inputType)
        {
            ...
            default:
                throw new UDFArgumentException(" ICEBERG_MONTH() only takes DATE/TIMESTAMP/TIMESTAMPLOCALTZ" + " types as first argument, got " + inputType);
        }
