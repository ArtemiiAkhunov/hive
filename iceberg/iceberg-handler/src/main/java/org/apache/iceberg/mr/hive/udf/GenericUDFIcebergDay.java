 ...
 */
@Description(name = "iceberg_day", value = "_FUNC_(value) - " + "Returns the bucket value calculated by Iceberg bucket transform function ", extended = "Example:\n  > SELECT _FUNC_('2023-01-02', 5);\n  2")
public class GenericUDFIcebergDay extends GenericUDF
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        {
            throw new UDFArgumentLengthException("ICEBERG_DAY requires 1 arguments (value), but got " + arguments.length);
        }

        if (arguments[0].getCategory() != ObjectInspector.Category.PRIMITIVE)
        {
            throw new UDFArgumentException("ICEBERG_DAY first argument takes primitive types, got " + argumentOI.getTypeName());
        }
        ...
        switch (inputType)
        {
            ...
            case TIMESTAMP:
                converter = new PrimitiveObjectInspectorConverter.TimestampConverter(argumentOI, PrimitiveObjectInspectorFactory.writableTimestampObjectInspector);
            ...
            case TIMESTAMPLOCALTZ:
                converter = new PrimitiveObjectInspectorConverter.TimestampLocalTZConverter(argumentOI, PrimitiveObjectInspectorFactory.writableTimestampTZObjectInspector);
            ...
            default:
                throw new UDFArgumentException(" ICEBERG_DAY() only takes DATE/TIMESTAMP/TIMESTAMPLOCALTZ" + " types as first argument, got " + inputType);
        }
