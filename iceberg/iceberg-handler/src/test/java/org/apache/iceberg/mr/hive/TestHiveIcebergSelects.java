...
public class TestHiveIcebergSelects extends HiveIcebergStorageHandlerWithEngineBase
{
    ...
    public void testVectorizedOrcMultipleSplits() throws Exception
    {
        ...
        testTables.createTable(shell, "targettab", HiveIcebergStorageHandlerTestUtils.CUSTOMER_SCHEMA, fileFormat, records);
    ...
    public void testHistory() throws IOException, InterruptedException
    {
        ...
        Table table = testTables.createTableWithVersions(shell, identifier.name(), HiveIcebergStorageHandlerTestUtils.CUSTOMER_SCHEMA, fileFormat, HiveIcebergStorageHandlerTestUtils.CUSTOMER_RECORDS, 1);
