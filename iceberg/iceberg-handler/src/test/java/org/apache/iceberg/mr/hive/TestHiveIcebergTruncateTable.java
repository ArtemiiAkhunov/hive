...
public class TestHiveIcebergTruncateTable extends HiveIcebergStorageHandlerWithEngineBase
{
    ...
    public void testTruncateTableExternalPurgeFalse() throws IOException, TException, InterruptedException
    {
        ...
        String tableName = "customers";
        Table icebergTable = testTables.createTable(shell, tableName, HiveIcebergStorageHandlerTestUtils.CUSTOMER_SCHEMA, fileFormat, HiveIcebergStorageHandlerTestUtils.CUSTOMER_RECORDS);
        testTruncateTable(databaseName, tableName, icebergTable, HiveIcebergStorageHandlerTestUtils.CUSTOMER_RECORDS, HiveIcebergStorageHandlerTestUtils.CUSTOMER_SCHEMA, false, false);
    }
    ...
    public void testTruncateTableForceExternalPurgeFalse() throws IOException, TException, InterruptedException
    {
        ...
        String tableName = "customers";
        Table icebergTable = testTables.createTable(shell, tableName, HiveIcebergStorageHandlerTestUtils.CUSTOMER_SCHEMA, fileFormat, HiveIcebergStorageHandlerTestUtils.CUSTOMER_RECORDS);
        testTruncateTable(databaseName, tableName, icebergTable, HiveIcebergStorageHandlerTestUtils.CUSTOMER_RECORDS, HiveIcebergStorageHandlerTestUtils.CUSTOMER_SCHEMA, false, true);
    }
    ...
    public void testTruncateTableWithPartitionSpecOnUnpartitionedTable() throws IOException, TException, InterruptedException
    {
        ...
        AssertHelpers.assertThrows("should throw exception", IllegalArgumentException.class, "Writing data into a partition fails when the Iceberg table is unpartitioned.", () ->
        {
    ...
    public void testTruncateTableWithPartitionSpecOnPartitionedTable()
    {
        ...
        testTables.createTable(shell, tableName, HiveIcebergStorageHandlerTestUtils.CUSTOMER_SCHEMA, spec, fileFormat, HiveIcebergStorageHandlerTestUtils.CUSTOMER_RECORDS);
        shell.executeStatement("ALTER TABLE " + identifier + " SET TBLPROPERTIES('external.table.purge'='true')");
        shell.executeStatement("ANALYZE TABLE " + identifier + " COMPUTE STATISTICS");
