...
public class TestHiveVectorizedReader
{
    ...
    public void before() throws IOException, HiveException
    {
        ...
        builder = new InputFormatConfig.ConfigBuilder(conf).readFrom(location.toString()).useHiveRows();
    }
    ...
    public void testRecordReaderShouldReuseFooter() throws IOException, InterruptedException
    {
        ...
        try (MockedStatic<ParquetFileReader> mockedParquetFileReader = Mockito.mockStatic(ParquetFileReader.class, Mockito.CALLS_REAL_METHODS))
        {
            ...
            mockedParquetFileReader.verify(times(1), () -> ParquetFileReader.readFooter(any(InputFile.class), any(ParquetMetadataConverter.MetadataFilter.class)));
        }
    }
