...
public abstract class DeleteReadTests
{
    ...
    public void testEqualityDeletes() throws IOException
    {
        ...
        List<Record> dataDeletes = Lists.newArrayList(dataDelete.copy("data", "a"), // id = 29
    ...
    public void testEqualityDeletesSpanningMultipleDataFiles() throws IOException
    {
        ...
        Schema deleteRowSchema = table.schema().select("data");
        Record dataDelete = GenericRecord.create(deleteRowSchema);
        List<Record> dataDeletes = Lists.newArrayList(dataDelete.copy("data", "a"), // id = 29, 144
                dataDelete.copy("data", "d"), // id = 89
                dataDelete.copy("data", "g") // id = 122
        );
    ...
    {
        List<Pair<CharSequence, Long>> deletes = Lists.newArrayList(Pair.of(dataFile.path(), 0L), // id = 29
                Pair.of(dataFile.path(), 3L), // id = 89
                Pair.of(dataFile.path(), 6L) // id = 122
        );

        Pair<DeleteFile, CharSequenceSet> posDeletes = FileHelpers.writeDeleteFile(table, Files.localOutput(temp.newFile()), Row.of(0), deletes);
    ...
    public void testMixedPositionAndEqualityDeletes() throws IOException
    {
        ...
        List<Pair<CharSequence, Long>> deletes = Lists.newArrayList(Pair.of(dataFile.path(), 3L), // id = 89
    ...
    public void testMultipleEqualityDeleteSchemas() throws IOException
    {
        ...
        List<Record> idDeletes = Lists.newArrayList(idDelete.copy("id", 121), // id = 121
    ...
    public void testEqualityDeleteByNull() throws IOException
    {
        ...
        Schema dataSchema = table.schema().select("data");
        Record dataDelete = GenericRecord.create(dataSchema);
        List<Record> dataDeletes = Lists.newArrayList(dataDelete.copy("data", null) // id = 131
        );
