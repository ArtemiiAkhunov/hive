...
public class TestHiveMetastore
{
    ...
    private static final DynConstructors.Ctor<HMSHandler> HMS_HANDLER_CTOR = DynConstructors.builder().impl(HMSHandler.class, String.class, Configuration.class).impl(HMSHandler.class, String.class, HiveConf.class).build();

    private static final DynMethods.StaticMethod GET_BASE_HMS_HANDLER = DynMethods.builder("getProxy").impl(HMSHandlerProxyFactory.class, Configuration.class, IHMSHandler.class, boolean.class).impl(HMSHandlerProxyFactory.class, HiveConf.class, IHMSHandler.class, boolean.class).buildStatic();
    ...
    private static final DynMethods.StaticMethod METASTORE_THREADS_SHUTDOWN = DynMethods.builder("shutdown").impl("org.apache.hadoop.hive.metastore.ThreadPool").orNoop().buildStatic();
    ...
    private void initConf(HiveConf conf, int port)
    {
        ...
        conf.set(HiveConf.ConfVars.HIVE_METASTORE_WAREHOUSE_EXTERNAL.varname, "file:" + HIVE_EXTERNAL_WAREHOUSE_DIR.getAbsolutePath());
