...
public class TestHelpers
{
    ...
    {
        Assert.assertTrue("Expression should have expected type: " + expected, expected.isInstance(expr));
    ...
    {
        Assert.assertTrue("Expression should be a bound predicate: " + expr, expr instanceof BoundPredicate);
    ...
    {
        Assert.assertTrue("Expression should be a bound set predicate: " + expr, expr instanceof BoundSetPredicate);
    ...
    {
        Assert.assertTrue("Expression should be an unbound predicate: " + expr, expr instanceof UnboundPredicate);
    ...
    public static class TestManifestFile implements ManifestFile
    {
        ...
        public TestManifestFile(String path, long length, int specId, Long snapshotId, Integer addedFiles, Integer existingFiles, Integer deletedFiles, List<PartitionFieldSummary> partitions)
        {
            this.path = path;
            this.length = length;
            this.specId = specId;
        ...
        public TestManifestFile(String path, long length, int specId, ManifestContent content, Long snapshotId, Integer addedFiles, Long addedRows, Integer existingFiles, Long existingRows, Integer deletedFiles, Long deletedRows, List<PartitionFieldSummary> partitions)
        {
            this.path = path;
            this.length = length;
            this.specId = specId;
