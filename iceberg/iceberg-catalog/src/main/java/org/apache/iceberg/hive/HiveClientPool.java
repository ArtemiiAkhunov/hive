...
public class HiveClientPool extends ClientPoolImpl<IMetaStoreClient, TException>
{
    ...
    private static final DynMethods.StaticMethod GET_CLIENT = DynMethods.builder("getProxy").impl(RetryingMetaStoreClient.class, HiveConf.class, HiveMetaHookLoader.class, String.class) // Hive 1 and 2
    ...
    protected IMetaStoreClient newClient()
    {
        ...
        } catch (Throwable t)
        {
            ...
            {
                throw new RuntimeMetaException(t, "Failed to start an embedded metastore because embedded " + "Derby supports only one client at a time. To fix this, use a metastore that supports " + "multiple clients.");
            }
