...
public class VersionDelegator extends TempletonDelegator
{
    ...
    {
        return SimpleWebException.buildMessage(HttpStatus.NOT_IMPLEMENTED_501, null, "Sqoop version request not yet implemented");
    }

    private Response getPigVersion()
    {
        return SimpleWebException.buildMessage(HttpStatus.NOT_IMPLEMENTED_501, null, "Pig version request not yet implemented");
    }
}
