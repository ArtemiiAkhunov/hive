...
public abstract class GroupPermissionsDesc
{
    ...
    protected static boolean xequals(boolean a, boolean b)
    {
        return a == b;
    }

    protected static boolean xequals(int a, int b)
    {
        return a == b;
    }

    protected static boolean xequals(char a, char b)
    {
        return a == b;
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return xequals(this.group, that.group) && xequals(this.permissions, that.permissions);
    }
}
