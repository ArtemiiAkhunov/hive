...
{
    private ConcurrentHashMap<JobId, TokenObject> tokenCache = new ConcurrentHashMap<JobId, TokenObject>();
    private static final DelegationTokenCache<String, String> stringFormTokenCache = new DelegationTokenCache<String, String>();
