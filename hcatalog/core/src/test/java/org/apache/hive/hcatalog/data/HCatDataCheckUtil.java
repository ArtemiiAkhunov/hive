...
public class HCatDataCheckUtil
{
    ...
    public static void createTable(IDriver driver, String tableName, String createTableArgs) throws IOException, CommandProcessorException
    {
    ...
    public static ArrayList<String> formattedRun(IDriver driver, String name, String selectCmd) throws IOException, CommandProcessorException
    {
    ...
    public static boolean recordsEqual(HCatRecord first, HCatRecord second, StringBuilder debugDetail)
    {
    ...
    public static int compareRecords(HCatRecord first, HCatRecord second, StringBuilder debugDetail)
    {
        return compareRecordContents(first.getAll(), second.getAll(), debugDetail);
    }

    public static int compareRecordContents(List<Object> first, List<Object> second, StringBuilder debugDetail)
    {
        int mySz = first.size();
