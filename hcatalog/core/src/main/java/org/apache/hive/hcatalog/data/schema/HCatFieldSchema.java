...
similarly for mapKeyType/mapKeyTypeInfo */
    ...
    public enum Type
    {
        ...
        BOOLEAN(PrimitiveObjectInspector.PrimitiveCategory.BOOLEAN), TINYINT(PrimitiveObjectInspector.PrimitiveCategory.BYTE), SMALLINT(PrimitiveObjectInspector.PrimitiveCategory.SHORT), INT(PrimitiveObjectInspector.PrimitiveCategory.INT), BIGINT(PrimitiveObjectInspector.PrimitiveCategory.LONG), FLOAT(PrimitiveObjectInspector.PrimitiveCategory.FLOAT), DOUBLE(PrimitiveObjectInspector.PrimitiveCategory.DOUBLE), DECIMAL(PrimitiveObjectInspector.PrimitiveCategory.DECIMAL), STRING(PrimitiveObjectInspector.PrimitiveCategory.STRING), CHAR(PrimitiveObjectInspector.PrimitiveCategory.CHAR), VARCHAR(PrimitiveObjectInspector.PrimitiveCategory.VARCHAR), BINARY(PrimitiveObjectInspector.PrimitiveCategory.BINARY), DATE(PrimitiveObjectInspector.PrimitiveCategory.DATE), TIMESTAMP(PrimitiveObjectInspector.PrimitiveCategory.TIMESTAMP),

        ARRAY(ObjectInspector.Category.LIST), MAP(ObjectInspector.Category.MAP), STRUCT(ObjectInspector.Category.STRUCT);
        ...
        private Type(ObjectInspector.Category cat)
        {
            ...
            assert category != ObjectInspector.Category.PRIMITIVE : "This c'tor should be used for complex category types";
        }
    ...
    {
        return new ToStringBuilder(this).append("fieldName", fieldName).append("comment", comment).append("type", getTypeString()).append("category", category).toString();
    }
    ...
    public int hashCode()
    {
        ...
        result = 31 * result + (getTypeString() == null ? 0 : getTypeString().hashCode());
        return result;
    }
}
