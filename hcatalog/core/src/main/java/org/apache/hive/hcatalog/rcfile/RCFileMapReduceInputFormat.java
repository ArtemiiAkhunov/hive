...
public class RCFileMapReduceInputFormat<K extends LongWritable, V extends BytesRefArrayWritable> extends FileInputFormat<LongWritable, BytesRefArrayWritable>
{
    ...
    @Override
    public RecordReader<LongWritable, BytesRefArrayWritable> createRecordReader(InputSplit split, TaskAttemptContext context) throws IOException, InterruptedException
    {
    ...
    {
        HiveConf.setLongVar(job.getConfiguration(), HiveConf.ConfVars.MAPRED_MIN_SPLIT_SIZE, SequenceFile.SYNC_INTERVAL);
