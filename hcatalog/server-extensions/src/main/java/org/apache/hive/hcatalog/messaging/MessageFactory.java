...
public abstract class MessageFactory
{
    ...
    private static final String HCAT_MESSAGE_FACTORY_IMPL = hiveConf.get(CONF_LABEL_HCAT_MESSAGE_FACTORY_IMPL_PREFIX + HCAT_MESSAGE_FORMAT, DEFAULT_MESSAGE_FACTORY_IMPL);
    ...
    {
        return getInstance(hiveConf.get(CONF_LABEL_HCAT_MESSAGE_FACTORY_IMPL_PREFIX + format, DEFAULT_MESSAGE_FACTORY_IMPL)).getDeserializer();
    }
     ...
     */
    public abstract AlterPartitionMessage buildAlterPartitionMessage(Table table, Partition before, Partition after, Long writeId);
     ...
     * @return instance of InsertMessage
     */
    public abstract InsertMessage buildInsertMessage(String db, Table table, Map<String, String> partVals, List<String> files);
}
