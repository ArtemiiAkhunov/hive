...
public class JSONAddPartitionMessage extends AddPartitionMessage
{
    ...
    public JSONAddPartitionMessage(String server, String servicePrincipal, String db, String table, String tableType, List<Map<String, String>> partitions, Long timestamp)
    {
        this.server = server;
