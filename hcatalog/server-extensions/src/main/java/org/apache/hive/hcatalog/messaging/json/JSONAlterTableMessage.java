...
public class JSONAlterTableMessage extends AlterTableMessage
{
    ...
    public JSONAlterTableMessage(String server, String servicePrincipal, String db, String table, Long writeId, Long timestamp)
    {
        this(server, servicePrincipal, db, table, null, writeId, timestamp);
    }

    public JSONAlterTableMessage(String server, String servicePrincipal, String db, String table, String tableType, Long writeId, Long timestamp)
    {
        this.server = server;
