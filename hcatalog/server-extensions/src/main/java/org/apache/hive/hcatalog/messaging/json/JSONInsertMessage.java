...
public class JSONInsertMessage extends InsertMessage
{
    ...
    public JSONInsertMessage(String server, String servicePrincipal, String db, String table, Map<String, String> partKeyVals, List<String> files, Long timestamp)
    {
        this(server, servicePrincipal, db, table, null, partKeyVals, files, timestamp);
    }

    public JSONInsertMessage(String server, String servicePrincipal, String db, String table, String tableType, Map<String, String> partKeyVals, List<String> files, Long timestamp)
    {
        this.server = server;
