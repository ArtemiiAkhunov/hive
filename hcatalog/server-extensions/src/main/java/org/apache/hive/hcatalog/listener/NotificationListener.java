...
public class NotificationListener extends MetaStoreEventListener
{
    ...
    public void onAlterPartition(AlterPartitionEvent ape) throws MetaException
    {
        if (ape.getStatus())
        {
            ...
            send(messageFactory.buildAlterPartitionMessage(ape.getTable(), before, after, ape.getWriteId()), topicName);
        }
    }
    ...
    public void onCreateTable(CreateTableEvent tableEvent) throws MetaException
    {
        ...
        if (tableEvent.getStatus())
        {
            ...
            try
            {
                newTbl = handler.get_table_core(tbl.getCatName(), tbl.getDbName(), tbl.getTableName()).deepCopy();
    ...
    public void onAlterTable(AlterTableEvent tableEvent) throws MetaException
    {
        if (tableEvent.getStatus())
        {
            ...
            // DB topic - Alan.
            String topicName = getTopicPrefix(tableEvent.getIHMSHandler().getConf()) + "." + after.getDbName().toLowerCase();
