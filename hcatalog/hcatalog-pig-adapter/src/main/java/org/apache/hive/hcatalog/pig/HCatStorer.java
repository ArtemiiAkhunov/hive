...
public class HCatStorer extends HCatBaseStorer
{
    ...
    {
        validOptions.addOption(ON_OOR_VALUE_OPT, true, "Controls how store operation handles Pig values which are out of range for the target column" + "in Hive table.  Default is to throw an exception.");
    }
