...
public class RCFileGenerator
{
    ...
    private static String[] firstName = {"alice", "bob", "calvin", "david", "ethan", "fred", "gabriella", "holly", "irene", "jessica", "katie", "luke", "mike", "nick", "oscar", "priscilla", "quinn", "rachel", "sarah", "tom", "ulysses", "victor", "wendy", "xavier", "yuri", "zach"};

    private static String[] lastName = {"allen", "brown", "carson", "davidson", "ellison", "falkner", "garcia", "hernandez", "ichabod", "johnson", "king", "laertes", "miller", "nixon", "ovid", "polk", "quirinius", "robinson", "steinbeck", "thompson", "underhill", "van buren", "white", "xylophone", "young", "zipper"};

    private static String randomName()
    {
        StringBuffer buf = new StringBuffer(firstName[rand.nextInt(firstName.length)]);
        buf.append(' ');
    ...
    private static String[] registration = {"democrat", "green", "independent", "libertarian", "republican", "socialist"};
    ...
    {
        System.err.println("Usage: rcfilegen format number_of_rows " + "output_file plain_output_file");
