...
public class SQLUniqueConstraint implements org.apache.thrift.TBase<SQLUniqueConstraint, SQLUniqueConstraint._Fields>, java.io.Serializable, Cloneable, Comparable<SQLUniqueConstraint>
{
    ...
    {
        CAT_NAME((short) 1, "catName"), TABLE_DB((short) 2, "table_db"), TABLE_NAME((short) 3, "table_name"), COLUMN_NAME((short) 4, "column_name"), KEY_SEQ((short) 5, "key_seq"), UK_NAME((short) 6, "uk_name"), ENABLE_CSTR((short) 7, "enable_cstr"), VALIDATE_CSTR((short) 8, "validate_cstr"), RELY_CSTR((short) 9, "rely_cstr");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.UK_NAME, new org.apache.thrift.meta_data.FieldMetaData("uk_name", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    public SQLUniqueConstraint(java.lang.String catName, java.lang.String table_db, java.lang.String table_name, java.lang.String column_name, int key_seq, java.lang.String uk_name, boolean enable_cstr, boolean validate_cstr, boolean rely_cstr)
    {
        this();
