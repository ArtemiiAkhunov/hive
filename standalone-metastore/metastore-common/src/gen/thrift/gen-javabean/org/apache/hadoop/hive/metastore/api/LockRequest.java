...
public class LockRequest implements org.apache.thrift.TBase<LockRequest, LockRequest._Fields>, java.io.Serializable, Cloneable, Comparable<LockRequest>
{
    ...
    {
        COMPONENT((short) 1, "component"), TXNID((short) 2, "txnid"), USER((short) 3, "user"), HOSTNAME((short) 4, "hostname"), AGENT_INFO((short) 5, "agentInfo"), ZERO_WAIT_READ_ENABLED((short) 6, "zeroWaitReadEnabled"), EXCLUSIVE_CTAS((short) 7, "exclusiveCTAS"), LOCKLESS_READS_ENABLED((short) 8, "locklessReadsEnabled");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.COMPONENT, new org.apache.thrift.meta_data.FieldMetaData("component", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, LockComponent.class))));
        tmpMap.put(_Fields.TXNID, new org.apache.thrift.meta_data.FieldMetaData("txnid", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
        ...
        tmpMap.put(_Fields.ZERO_WAIT_READ_ENABLED, new org.apache.thrift.meta_data.FieldMetaData("zeroWaitReadEnabled", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
        tmpMap.put(_Fields.EXCLUSIVE_CTAS, new org.apache.thrift.meta_data.FieldMetaData("exclusiveCTAS", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
        tmpMap.put(_Fields.LOCKLESS_READS_ENABLED, new org.apache.thrift.meta_data.FieldMetaData("locklessReadsEnabled", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    ...
    public LockRequest(java.util.List<LockComponent> component, java.lang.String user, java.lang.String hostname)
    {
        this();
