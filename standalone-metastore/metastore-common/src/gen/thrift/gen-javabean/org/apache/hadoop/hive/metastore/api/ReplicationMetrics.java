...
public class ReplicationMetrics implements org.apache.thrift.TBase<ReplicationMetrics, ReplicationMetrics._Fields>, java.io.Serializable, Cloneable, Comparable<ReplicationMetrics>
{
    ...
    {
        SCHEDULED_EXECUTION_ID((short) 1, "scheduledExecutionId"), POLICY((short) 2, "policy"), DUMP_EXECUTION_ID((short) 3, "dumpExecutionId"), METADATA((short) 4, "metadata"), PROGRESS((short) 5, "progress"), MESSAGE_FORMAT((short) 6, "messageFormat");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.SCHEDULED_EXECUTION_ID, new org.apache.thrift.meta_data.FieldMetaData("scheduledExecutionId", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
        tmpMap.put(_Fields.POLICY, new org.apache.thrift.meta_data.FieldMetaData("policy", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
        tmpMap.put(_Fields.DUMP_EXECUTION_ID, new org.apache.thrift.meta_data.FieldMetaData("dumpExecutionId", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
        tmpMap.put(_Fields.METADATA, new org.apache.thrift.meta_data.FieldMetaData("metadata", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
        tmpMap.put(_Fields.PROGRESS, new org.apache.thrift.meta_data.FieldMetaData("progress", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    public ReplicationMetrics(long scheduledExecutionId, java.lang.String policy, long dumpExecutionId)
    {
        this();
