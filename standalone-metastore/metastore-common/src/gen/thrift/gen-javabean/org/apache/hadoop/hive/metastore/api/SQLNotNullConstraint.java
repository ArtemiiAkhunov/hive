...
public class SQLNotNullConstraint implements org.apache.thrift.TBase<SQLNotNullConstraint, SQLNotNullConstraint._Fields>, java.io.Serializable, Cloneable, Comparable<SQLNotNullConstraint>
{
    ...
    {
        CAT_NAME((short) 1, "catName"), TABLE_DB((short) 2, "table_db"), TABLE_NAME((short) 3, "table_name"), COLUMN_NAME((short) 4, "column_name"), NN_NAME((short) 5, "nn_name"), ENABLE_CSTR((short) 6, "enable_cstr"), VALIDATE_CSTR((short) 7, "validate_cstr"), RELY_CSTR((short) 8, "rely_cstr");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.NN_NAME, new org.apache.thrift.meta_data.FieldMetaData("nn_name", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    public SQLNotNullConstraint(java.lang.String catName, java.lang.String table_db, java.lang.String table_name, java.lang.String column_name, java.lang.String nn_name, boolean enable_cstr, boolean validate_cstr, boolean rely_cstr)
    {
        this();
