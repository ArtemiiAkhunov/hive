...
public class DropDatabaseRequest implements org.apache.thrift.TBase<DropDatabaseRequest, DropDatabaseRequest._Fields>, java.io.Serializable, Cloneable, Comparable<DropDatabaseRequest>
{
    ...
    {
        NAME((short) 1, "name"), CATALOG_NAME((short) 2, "catalogName"), IGNORE_UNKNOWN_DB((short) 3, "ignoreUnknownDb"), DELETE_DATA((short) 4, "deleteData"), CASCADE((short) 5, "cascade"), SOFT_DELETE((short) 6, "softDelete"), TXN_ID((short) 7, "txnId"), DELETE_MANAGED_DIR((short) 8, "deleteManagedDir");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.IGNORE_UNKNOWN_DB, new org.apache.thrift.meta_data.FieldMetaData("ignoreUnknownDb", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
        tmpMap.put(_Fields.DELETE_DATA, new org.apache.thrift.meta_data.FieldMetaData("deleteData", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
        tmpMap.put(_Fields.CASCADE, new org.apache.thrift.meta_data.FieldMetaData("cascade", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
        tmpMap.put(_Fields.SOFT_DELETE, new org.apache.thrift.meta_data.FieldMetaData("softDelete", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
        ...
        tmpMap.put(_Fields.DELETE_MANAGED_DIR, new org.apache.thrift.meta_data.FieldMetaData("deleteManagedDir", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    ...
    public DropDatabaseRequest(java.lang.String name, boolean ignoreUnknownDb, boolean deleteData, boolean cascade)
    {
        this();
        this.name = name;
