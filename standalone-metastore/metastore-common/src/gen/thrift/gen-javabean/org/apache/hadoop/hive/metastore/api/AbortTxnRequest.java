...
public class AbortTxnRequest implements org.apache.thrift.TBase<AbortTxnRequest, AbortTxnRequest._Fields>, java.io.Serializable, Cloneable, Comparable<AbortTxnRequest>
{
    ...
    {
        TXNID((short) 1, "txnid"), REPL_POLICY((short) 2, "replPolicy"),
        /**
         *
         * @see TxnType
         */
        TXN_TYPE((short) 3, "txn_type"), ERROR_CODE((short) 4, "errorCode");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.ERROR_CODE, new org.apache.thrift.meta_data.FieldMetaData("errorCode", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
