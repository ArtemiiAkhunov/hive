...
public class TruncateTableRequest implements org.apache.thrift.TBase<TruncateTableRequest, TruncateTableRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TruncateTableRequest>
{
    ...
    {
        DB_NAME((short) 1, "dbName"), TABLE_NAME((short) 2, "tableName"), PART_NAMES((short) 3, "partNames"), WRITE_ID((short) 4, "writeId"), VALID_WRITE_ID_LIST((short) 5, "validWriteIdList"), ENVIRONMENT_CONTEXT((short) 6, "environmentContext");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.PART_NAMES, new org.apache.thrift.meta_data.FieldMetaData("partNames", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    ...
    public TruncateTableRequest(java.lang.String dbName, java.lang.String tableName)
    {
        this();
        this.dbName = dbName;
