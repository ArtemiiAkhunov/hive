...
public class AddDynamicPartitions implements org.apache.thrift.TBase<AddDynamicPartitions, AddDynamicPartitions._Fields>, java.io.Serializable, Cloneable, Comparable<AddDynamicPartitions>
{
    ...
    {
        TXNID((short) 1, "txnid"), WRITEID((short) 2, "writeid"), DBNAME((short) 3, "dbname"), TABLENAME((short) 4, "tablename"), PARTITIONNAMES((short) 5, "partitionnames"),
        /**
         *
    ...
    static
    {
        ...
        tmpMap.put(_Fields.WRITEID, new org.apache.thrift.meta_data.FieldMetaData("writeid", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
        ...
        tmpMap.put(_Fields.PARTITIONNAMES, new org.apache.thrift.meta_data.FieldMetaData("partitionnames", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    ...
    public AddDynamicPartitions(long txnid, long writeid, java.lang.String dbname, java.lang.String tablename, java.util.List<java.lang.String> partitionnames)
    {
        this();
        this.txnid = txnid;
        setTxnidIsSet(true);
