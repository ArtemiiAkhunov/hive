...
public class ISchemaName implements org.apache.thrift.TBase<ISchemaName, ISchemaName._Fields>, java.io.Serializable, Cloneable, Comparable<ISchemaName>
{
    ...
    {
        CAT_NAME((short) 1, "catName"), DB_NAME((short) 2, "dbName"), SCHEMA_NAME((short) 3, "schemaName");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.SCHEMA_NAME, new org.apache.thrift.meta_data.FieldMetaData("schemaName", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    public ISchemaName(java.lang.String catName, java.lang.String dbName, java.lang.String schemaName)
    {
        this();
