...
public class CompactionResponse implements org.apache.thrift.TBase<CompactionResponse, CompactionResponse._Fields>, java.io.Serializable, Cloneable, Comparable<CompactionResponse>
{
    ...
    {
        ID((short) 1, "id"), STATE((short) 2, "state"), ACCEPTED((short) 3, "accepted"), ERRORMESSAGE((short) 4, "errormessage");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.STATE, new org.apache.thrift.meta_data.FieldMetaData("state", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
        tmpMap.put(_Fields.ACCEPTED, new org.apache.thrift.meta_data.FieldMetaData("accepted", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
        tmpMap.put(_Fields.ERRORMESSAGE, new org.apache.thrift.meta_data.FieldMetaData("errormessage", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    public CompactionResponse(long id, java.lang.String state, boolean accepted)
    {
        this();
        this.id = id;
        setIdIsSet(true);
