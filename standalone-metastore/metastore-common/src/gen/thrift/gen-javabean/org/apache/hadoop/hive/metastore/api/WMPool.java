...
public class WMPool implements org.apache.thrift.TBase<WMPool, WMPool._Fields>, java.io.Serializable, Cloneable, Comparable<WMPool>
{
    ...
    {
        RESOURCE_PLAN_NAME((short) 1, "resourcePlanName"), POOL_PATH((short) 2, "poolPath"), ALLOC_FRACTION((short) 3, "allocFraction"), QUERY_PARALLELISM((short) 4, "queryParallelism"), SCHEDULING_POLICY((short) 5, "schedulingPolicy"), NS((short) 6, "ns");
    ...
    public WMPool(java.lang.String resourcePlanName, java.lang.String poolPath)
    {
        this();
