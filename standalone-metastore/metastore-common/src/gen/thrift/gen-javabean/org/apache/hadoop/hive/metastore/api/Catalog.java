...
public class Catalog implements org.apache.thrift.TBase<Catalog, Catalog._Fields>, java.io.Serializable, Cloneable, Comparable<Catalog>
{
    ...
    {
        NAME((short) 1, "name"), DESCRIPTION((short) 2, "description"), LOCATION_URI((short) 3, "locationUri"), CREATE_TIME((short) 4, "createTime");
    ...
    public Catalog(java.lang.String name, java.lang.String locationUri)
    {
        this();
        this.name = name;
