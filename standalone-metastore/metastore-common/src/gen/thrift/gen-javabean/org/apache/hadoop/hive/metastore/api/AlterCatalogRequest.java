...
public class AlterCatalogRequest implements org.apache.thrift.TBase<AlterCatalogRequest, AlterCatalogRequest._Fields>, java.io.Serializable, Cloneable, Comparable<AlterCatalogRequest>
{
    ...
    {
        NAME((short) 1, "name"), NEW_CAT((short) 2, "newCat");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.NEW_CAT, new org.apache.thrift.meta_data.FieldMetaData("newCat", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Catalog.class)));
    ...
    public AlterCatalogRequest(java.lang.String name, Catalog newCat)
    {
        this();
        this.name = name;
        this.newCat = newCat;
