...
public class GetFieldsRequest implements org.apache.thrift.TBase<GetFieldsRequest, GetFieldsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetFieldsRequest>
{
    ...
    {
        CAT_NAME((short) 1, "catName"), DB_NAME((short) 2, "dbName"), TBL_NAME((short) 3, "tblName"), ENV_CONTEXT((short) 4, "envContext"), VALID_WRITE_ID_LIST((short) 5, "validWriteIdList"), ID((short) 6, "id");
    ...
    public GetFieldsRequest(java.lang.String dbName, java.lang.String tblName)
    {
        this();
        this.dbName = dbName;
