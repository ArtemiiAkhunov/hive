...
public class UtilTest
{
    ...
    public void filterMatchesPositive()
    {
        ...
        assertThat(filterMatches(candidates, new Pattern[]{Pattern.compile("f.*")}, null), is(expected));
    }
    ...
    public void filterMatchesNegative()
    {
        ...
        assertThat(filterMatches(candidates, null, new Pattern[]{Pattern.compile("b")}), is(expected));
    }
    ...
    public void filterMatchesMultiple()
    {
        ...
        List<String> expected = ImmutableList.of("a");
        assertThat(filterMatches(candidates, new Pattern[]{Pattern.compile("^a")}, new Pattern[]{Pattern.compile("y$")}), is(expected));
    }
}