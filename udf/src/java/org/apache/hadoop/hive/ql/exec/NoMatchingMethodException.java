...
public class NoMatchingMethodException extends UDFArgumentException
{
     ...
     * @param methods      All potential matches.
     */
    public NoMatchingMethodException(Class<?> funcClass, List<TypeInfo> argTypeInfos, List<Method> methods)
    {
        super("No matching method for " + funcClass + " with " + argTypeInfos.toString().replace('[', '(').replace(']', ')'), funcClass, argTypeInfos, methods);
    }
}
