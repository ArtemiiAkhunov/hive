...
public class HiveDatabaseMetaData implements DatabaseMetaData
{
    ...
    public ResultSet getCatalogs() throws SQLException
    {
        ...
        return new HiveQueryResultSet.Builder(connection).setClient(client).setStmtHandle(catalogResp.getOperationHandle()).build();
    }
    ...
    private static final class ClientInfoPropertiesResultSet extends HiveMetaDataResultSet<Object>
    {
        ...
        private final static Object[][] DATA = {{"ApplicationName", 1000, null, null},
    ...
    public ResultSet getFunctions(String catalogName, String schemaPattern, String functionNamePattern) throws SQLException
    {
        ...
        return new HiveQueryResultSet.Builder(connection).setClient(client).setStmtHandle(funcResp.getOperationHandle()).build();
    }
    ...
    {
        return new HiveQueryResultSet.Builder(connection).setClient(client).setEmptyResultSet(true).setSchema(Arrays.asList("PKTABLE_CAT", "PKTABLE_SCHEM", "PKTABLE_NAME", "PKCOLUMN_NAME", "FKTABLE_CAT", "FKTABLE_SCHEM", "FKTABLE_NAME", "FKCOLUMN_NAME", "KEY_SEQ", "UPDATE_RULE", "DELETE_RULE", "FK_NAME", "PK_NAME", "DEFERRABILITY"), Arrays.asList("STRING", "STRING", "STRING", "STRING", "STRING", "STRING", "STRING", "STRING", "SMALLINT", "SMALLINT", "SMALLINT", "STRING", "STRING", "STRING")).build();
    }

    public ResultSet getIndexInfo(String catalog, String schema, String table, boolean unique, boolean approximate) throws SQLException
    {
        return new HiveQueryResultSet.Builder(connection).setClient(client).setEmptyResultSet(true).setSchema(Arrays.asList("TABLE_CAT", "TABLE_SCHEM", "TABLE_NAME", "NON_UNIQUE", "INDEX_QUALIFIER", "INDEX_NAME", "TYPE", "ORDINAL_POSITION", "COLUMN_NAME", "ASC_OR_DESC", "CARDINALITY", "PAGES", "FILTER_CONDITION"), Arrays.asList("STRING", "STRING", "STRING", "BOOLEAN", "STRING", "STRING", "SHORT", "SHORT", "STRING", "STRING", "INT", "INT", "STRING")).build();
    }
    ...
    public ResultSet getSchemas(String catalog, String schemaPattern) throws SQLException
    {
        ...
        return new HiveQueryResultSet.Builder(connection).setClient(client).setStmtHandle(schemaResp.getOperationHandle()).build();
    }
    ...
    public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern, String[] types) throws SQLException
    {
        ...
        return new HiveQueryResultSet.Builder(connection).setClient(client).setStmtHandle(getTableResp.getOperationHandle()).build();
    }
    ...
    public ResultSet getTypeInfo() throws SQLException
    {
        ...
        return new HiveQueryResultSet.Builder(connection).setClient(client).setStmtHandle(getTypeInfoResp.getOperationHandle()).build();
    }

    public ResultSet getUDTs(String catalog, String schemaPattern, String typeNamePattern, int[] types) throws SQLException
    {

        return new HiveMetaDataResultSet<Object>(Arrays.asList("TYPE_CAT", "TYPE_SCHEM", "TYPE_NAME", "CLASS_NAME", "DATA_TYPE", "REMARKS", "BASE_TYPE"), Arrays.asList("STRING", "STRING", "STRING", "STRING", "INT", "STRING", "INT"), null)
        {
