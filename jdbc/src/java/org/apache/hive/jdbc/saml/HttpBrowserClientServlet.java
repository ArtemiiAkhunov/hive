...
public class HttpBrowserClientServlet extends HttpServlet
{
    ...
    {
        LOG.info("Received request from {}:{} for browserClient at port {}", req.getRemoteAddr(), req.getRemotePort(), browserClient.toString());
        ...
        HiveJdbcBrowserServerResponse response = new HiveJdbcBrowserServerResponse(status, msg, token);
