...
public class HiveStatement implements java.sql.Statement
{
    ...
    public boolean execute(String sql) throws SQLException
    {
        ...
        resultSet = new HiveQueryResultSet.Builder(this).setClient(client).setStmtHandle(stmtHandle.get()).setMaxRows(maxRows).setFetchSize(fetchSize).setScrollable(isScrollableResultset).build();
        return true;
    }
    ...
    public String getYarnATSGuid()
    {
        ...
        return (stmtHandle.isPresent()) ? Base64.getUrlEncoder().withoutPadding().encodeToString(stmtHandle.get().getOperationId().getGuid()) : null;
    }
