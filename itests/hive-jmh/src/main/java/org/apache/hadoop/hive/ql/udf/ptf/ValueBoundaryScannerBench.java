...
public class ValueBoundaryScannerBench
{
    ...
    public static class BaseBench
    {
        ...
        public void testTimestampEqualsWithInspector()
        {
            ...
            {
                l1 = PrimitiveObjectInspectorUtils.getTimestamp(v1, (PrimitiveObjectInspector) expressionDef.getOI());
                l2 = PrimitiveObjectInspectorUtils.getTimestamp(v2, (PrimitiveObjectInspector) expressionDef.getOI());
                l1.equals(l2);
            }
        }
    ...
    {
        Options opt = new OptionsBuilder().include(".*" + ValueBoundaryScannerBench.class.getSimpleName() + ".*").build();
        new Runner(opt).run();
    }
}