...
public abstract class AbstractMapJoin
{
    ...
    protected static MapJoinOperator setupBenchmarkImplementation(MapJoinTestImplementation mapJoinImplementation, MapJoinTestDescription testDesc, MapJoinTestData testData) throws Exception
    {
        ...
        CreateMapJoinResult createMapJoinResult = MapJoinTestConfig.createMapJoinImplementation(mapJoinImplementation, testDesc, testData, mapJoinDesc,
    ...
    private static void executeBenchmarkImplementationRow(MapJoinTestImplementation mapJoinImplementation, MapJoinTestDescription testDesc, MapJoinTestData testData, MapJoinOperator operator, Object[][] bigTableRows) throws Exception
    {
    ...
    private static void executeBenchmarkImplementationVector(MapJoinTestImplementation mapJoinImplementation, MapJoinTestDescription testDesc, MapJoinTestData testData, MapJoinOperator operator, VectorizedRowBatch[] bigTableBatches) throws Exception
    {
