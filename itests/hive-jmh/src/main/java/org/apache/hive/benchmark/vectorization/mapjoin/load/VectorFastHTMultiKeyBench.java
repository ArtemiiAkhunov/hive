...
public class VectorFastHTMultiKeyBench
{
    ...
    {
        Options opt = new OptionsBuilder().include(".*" + VectorFastHTMultiKeyBench.class.getSimpleName() + ".*").warmupIterations(4) // number of times the warmup iteration should take place
