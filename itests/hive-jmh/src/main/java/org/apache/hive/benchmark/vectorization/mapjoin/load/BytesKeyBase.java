...
public class BytesKeyBase extends AbstractHTLoadBench
{
    ...
    public void doSetup(VectorMapJoinDesc.VectorMapJoinVariation vectorMapJoinVariation, MapJoinTestConfig.MapJoinTestImplementation mapJoinImplementation, int rows) throws Exception
    {
        long seed = 2543;
        int rowCount = rows;
        ...
        setupMapJoinHT(hiveConf, seed, rowCount, vectorMapJoinVariation, mapJoinImplementation, bigTableColumnNames, bigTableTypeInfos, bigTableKeyColumnNums, smallTableValueTypeInfos, smallTableRetainKeyColumnNums, smallTableGenerationParameters);
    ...
    private static CustomKeyValueReader generateByteKVPairs(int rows, long seed) throws IOException
    {
        ...
        LOG.info("Data GEN done after {} sec", TimeUnit.MILLISECONDS.toSeconds(System.currentTimeMillis() - startTime));
    ...
    public static String deserializeBinary(BytesWritable currentKey) throws HiveException
    {
        ...
        BinarySortableDeserializeRead keyBinarySortableDeserializeRead = new BinarySortableDeserializeRead(primitiveTypeInfos,
        ...
        byte[] stringBytes = Arrays.copyOfRange(keyBinarySortableDeserializeRead.currentBytes, keyBinarySortableDeserializeRead.currentBytesStart, keyBinarySortableDeserializeRead.currentBytesStart + keyBinarySortableDeserializeRead.currentBytesLength);
