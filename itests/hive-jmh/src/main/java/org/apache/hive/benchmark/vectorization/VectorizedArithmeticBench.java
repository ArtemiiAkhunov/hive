...
public class VectorizedArithmeticBench
{
    public static class DoubleColAddRepeatingDoubleColumnBench extends AbstractExpression
    {
        ...
        public void setup()
        {
            rowBatch = buildRowBatch(new DoubleColumnVector(), 2, getDoubleColumnVector(), getRepeatingDoubleColumnVector());
    ...
    public static class LongColAddRepeatingLongColumnBench extends AbstractExpression
    {
        ...
        public void setup()
        {
            rowBatch = buildRowBatch(new LongColumnVector(), 2, getLongColumnVector(), getRepeatingLongColumnVector());
    ...
    public static class DoubleColDivideDoubleColumnBench extends AbstractExpression
    {
        ...
        public void setup()
        {
            rowBatch = buildRowBatch(new DoubleColumnVector(), 2, getDoubleColumnVector(), getDoubleColumnVector());
    ...
    public static class LongColDivideLongColumnBench extends AbstractExpression
    {
        ...
        public void setup()
        {
            rowBatch = buildRowBatch(new DoubleColumnVector(), 2, getLongColumnVector(), getLongColumnVector());
    ...
    public static class LongColDivideRepeatingLongColumnBench extends AbstractExpression
    {
        ...
        public void setup()
        {
            rowBatch = buildRowBatch(new DoubleColumnVector(), 2, getLongColumnVector(), getRepeatingLongColumnVector());
            expression = new LongColDivideLongColumn(0, 1, 2);
        }
    }
