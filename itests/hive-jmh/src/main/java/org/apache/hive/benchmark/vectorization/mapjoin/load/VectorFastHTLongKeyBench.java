...
public class VectorFastHTLongKeyBench
{
    ...
    {
        Options opt = new OptionsBuilder().include(".*" + VectorFastHTLongKeyBench.class.getSimpleName() + ".*").warmupIterations(4) // number of times the warmup iteration should take place
