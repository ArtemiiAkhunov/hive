...
public class VectorizedLogicBench
{
    ...
    public static class ColAndColBench extends AbstractExpression
    {
        ...
        public void setup()
        {
            rowBatch = buildRowBatch(new LongColumnVector(), 2, getBooleanLongColumnVector(), getBooleanLongColumnVector());
    ...
    public static class ColAndRepeatingColBench extends AbstractExpression
    {
        ...
        public void setup()
        {
            rowBatch = buildRowBatch(new LongColumnVector(), 2, getBooleanLongColumnVector(), getBooleanRepeatingLongColumnVector());
            expression = new ColAndCol(0, 1, 2);
        }
    }
    ...
    public static class RepeatingColAndColBench extends AbstractExpression
    {
        ...
        public void setup()
        {
            rowBatch = buildRowBatch(new LongColumnVector(), 2, getBooleanRepeatingLongColumnVector(), getBooleanLongColumnVector());
            expression = new ColAndCol(0, 1, 2);
        }
    }
    ...
    public static class IfExprLongColumnLongColumnBench extends AbstractExpression
    {
        ...
        public void setup()
        {
            rowBatch = buildRowBatch(new LongColumnVector(), 3, getBooleanLongColumnVector(), getLongColumnVector(), getLongColumnVector());
    ...
    public static class IfExprRepeatingLongColumnLongColumnBench extends AbstractExpression
    {
        ...
        public void setup()
        {
            rowBatch = buildRowBatch(new LongColumnVector(), 3, getBooleanLongColumnVector(), getRepeatingLongColumnVector(), getLongColumnVector());
            expression = new IfExprLongColumnLongColumn(0, 1, 2, 3);
        }
    }
    ...
    public static class IfExprLongColumnRepeatingLongColumnBench extends AbstractExpression
    {
        ...
        public void setup()
        {
            rowBatch = buildRowBatch(new LongColumnVector(), 3, getBooleanLongColumnVector(), getLongColumnVector(), getRepeatingLongColumnVector());
            expression = new IfExprLongColumnLongColumn(0, 1, 2, 3);
        }
    }
