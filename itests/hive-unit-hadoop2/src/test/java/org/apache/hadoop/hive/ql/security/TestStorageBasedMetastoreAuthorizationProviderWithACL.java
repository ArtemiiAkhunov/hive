...
public class TestStorageBasedMetastoreAuthorizationProviderWithACL extends TestStorageBasedMetastoreAuthorizationProvider
{
    ...
    protected void disallowWriteAccessViaAcl(String userName, String location) throws Exception
    {
        FileSystem fs = FileSystem.get(new URI(location), clientHiveConf);
    ...
    @Override
    protected void allowCreateDatabase(String userName) throws Exception
    {
    ...
    @Override
    protected void disallowCreateDatabase(String userName) throws Exception
    {
    ...
    @Override
    protected void disallowDropOnTable(String tblName, String userName, String location) throws Exception
    {
        disallowWriteAccessViaAcl(userName, location);
    }
