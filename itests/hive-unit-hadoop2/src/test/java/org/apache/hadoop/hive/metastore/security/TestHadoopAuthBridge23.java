...
public class TestHadoopAuthBridge23
{
    ...
    public void testDelegationTokenSharedStore() throws Exception
    {
        ...
        e.setMaxDate(0);
        MyTokenStore.TOKEN_STORE.addToken(e, new DelegationTokenInformation(0, t.getPassword()));
        Assert.assertNotNull(MyTokenStore.TOKEN_STORE.getToken(e));
        anotherManager.renewOrRemoveExpiredTokens();
        Assert.assertNull("Expired token not removed", MyTokenStore.TOKEN_STORE.getToken(e));
