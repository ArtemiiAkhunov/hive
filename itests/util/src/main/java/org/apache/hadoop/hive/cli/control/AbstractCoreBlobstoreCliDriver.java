...
public abstract class AbstractCoreBlobstoreCliDriver extends CliAdapter
{
    ...
    public void beforeClass() throws Exception
    {
        ...
        qt = new QTestUtil(QTestArguments.QTestArgumentsBuilder.instance().withOutDir(cliConfig.getResultsDir()).withLogDir(cliConfig.getLogDir()).withClusterType(miniMR).withConfDir(hiveConfDir).withInitScript(initScript).withCleanupScript(cleanupScript).withLlapIo(true).build());
