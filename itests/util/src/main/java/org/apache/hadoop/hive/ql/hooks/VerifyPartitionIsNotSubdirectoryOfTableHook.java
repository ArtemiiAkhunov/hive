...
public class VerifyPartitionIsNotSubdirectoryOfTableHook implements ExecuteWithHookContext
{
    ...
    {
        Assert.assertFalse("The location of the partition: " + partition.getName() + " was a " + "subdirectory of the location of the table: " + table.getTableName(), partition.getDataLocation().toString().startsWith(table.getPath().toString()));
    }
}
