...
public class CoreNegativeCliDriver extends CliAdapter
{
    ...
    public void beforeClass()
    {
        ...
        try
        {
            qt = new QTestUtil(QTestArguments.QTestArgumentsBuilder.instance().withOutDir(cliConfig.getResultsDir()).withLogDir(cliConfig.getLogDir()).withClusterType(miniMR).withConfDir(hiveConfDir).withInitScript(initScript).withCleanupScript(cleanupScript).withLlapIo(false).build());
        } catch (Exception e)
        {
