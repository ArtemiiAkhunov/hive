...
public class DummyHiveMetastoreAuthorizationProvider implements HiveMetastoreAuthorizationProvider
{
    ...
    {
        USER, DB, TABLE, PARTITION, TABLE_AND_PARTITION, AUTHORIZATION
    }
    ...
    class AuthCallContext
    {
        ...
        AuthCallContext(AuthCallContextType typeOfCall, Privilege[] readRequiredPriv, Privilege[] writeRequiredPriv)
        {
        ...
        AuthCallContext(AuthCallContextType typeOfCall, Object authObject, Privilege[] readRequiredPriv, Privilege[] writeRequiredPriv)
        {
            this(typeOfCall, readRequiredPriv, writeRequiredPriv);
            this.authObjects.add(authObject);
        }

        AuthCallContext(AuthCallContextType typeOfCall, List<? extends Object> authObjects, Privilege[] readRequiredPriv, Privilege[] writeRequiredPriv)
        {
            this(typeOfCall, readRequiredPriv, writeRequiredPriv);
    ...
    {
        debugLog("DHMAP.authorize " + "read:" + debugPrivPrint(readRequiredPriv) + " , write:" + debugPrivPrint(writeRequiredPriv));
        authCalls.add(new AuthCallContext(AuthCallContextType.USER, readRequiredPriv, writeRequiredPriv));
    }
    ...
    {
        debugLog("DHMAP.authorizedb " + "db:" + db.getName() + " , read:" + debugPrivPrint(readRequiredPriv) + " , write:" + debugPrivPrint(writeRequiredPriv));
        authCalls.add(new AuthCallContext(AuthCallContextType.DB, db, readRequiredPriv, writeRequiredPriv));
    }
    ...
    {
        debugLog("DHMAP.authorizetbl " + "tbl:" + table.getCompleteName() + " , read:" + debugPrivPrint(readRequiredPriv) + " , write:" + debugPrivPrint(writeRequiredPriv));
        authCalls.add(new AuthCallContext(AuthCallContextType.TABLE, table, readRequiredPriv, writeRequiredPriv));
    ...
    {
        debugLog("DHMAP.authorizecols " + "tbl:" + table.getCompleteName() + " , part: " + part.getName() + " . cols: " + columns.toString() + " , read:" + debugPrivPrint(readRequiredPriv) + " , write:" + debugPrivPrint(writeRequiredPriv));
        List<Object> authObjects = new ArrayList<Object>();
        authObjects.add(table);
        authObjects.add(part);
        authCalls.add(new AuthCallContext(AuthCallContextType.TABLE_AND_PARTITION, authObjects, readRequiredPriv, writeRequiredPriv));
