...
public class QTestMiniClusters
{
    ...
    {
        MR(CoreClusterType.MR, FsType.HDFS), TEZ(CoreClusterType.TEZ, FsType.HDFS), TEZ_LOCAL(CoreClusterType.TEZ, FsType.LOCAL), LLAP(CoreClusterType.TEZ, FsType.HDFS), LLAP_LOCAL(CoreClusterType.TEZ, FsType.LOCAL), NONE(CoreClusterType.MR, FsType.LOCAL), DRUID_LOCAL(CoreClusterType.TEZ, FsType.LOCAL), DRUID(CoreClusterType.TEZ, FsType.HDFS), DRUID_KAFKA(CoreClusterType.TEZ, FsType.HDFS), KAFKA(CoreClusterType.TEZ, FsType.HDFS), KUDU(CoreClusterType.TEZ, FsType.LOCAL);
    ...
    public void restartSessions(boolean canReuseSession, CliSessionState ss, SessionState oldSs) throws IOException
    {
