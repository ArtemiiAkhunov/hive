...
public class SQLStdHiveAccessControllerForTest extends SQLStdHiveAccessControllerWrapper
{
    ...
    SQLStdHiveAccessControllerForTest(HiveMetastoreClientFactory metastoreClientFactory, HiveConf conf, HiveAuthenticationProvider authenticator, HiveAuthzSessionContext ctx) throws HiveAuthzPluginException
    {
