...
public class AccumuloTestSetup extends QTestMiniClusters.QTestSetup
{
    ...
    public static final List<String> EXTRA_ZOOKEEPER_CONFIG = Arrays.asList("4lw.commands.whitelist=*", "admin.enableServer=false");
    ...
    {
        try (FileWriter f = new FileWriter(tmpDir.getAbsolutePath() + "/conf/zoo.cfg", true); BufferedWriter b = new BufferedWriter(f); PrintWriter p = new PrintWriter(b);)
        {
