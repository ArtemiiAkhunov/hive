...
{
    private static final Path KEYSTORE_DIR = Paths.get(System.getProperty("test.tmp.dir"), "kdc_root_dir" + UUID.randomUUID());
    ...
    public void testLeakAfterHistoryException() throws Exception
    {
        ...
        Assert.assertTrue("Allocated memory, " + diffMem + "bytes , exceeds acceptable variance of 250MB.", diffMem < 250_000_000);
    }
