...
public class TestJdbcWithDBTokenStoreNoDoAs extends TestJdbcWithMiniKdc
{
    ...
    public static void beforeTest() throws Exception
    {
        ...
        System.setProperty(HiveConf.ConfVars.METASTORE_WAREHOUSE.varname, MetastoreConf.getVar(hiveConf, MetastoreConf.ConfVars.WAREHOUSE));
        System.setProperty(HiveConf.ConfVars.METASTORE_CONNECT_URL_KEY.varname, MetastoreConf.getVar(hiveConf, MetastoreConf.ConfVars.CONNECT_URL_KEY));
        System.setProperty(HiveConf.ConfVars.METASTORE_URIS.varname, MetastoreConf.getVar(hiveConf, MetastoreConf.ConfVars.THRIFT_URIS));
        System.setProperty(ConfVars.METASTORE_USE_THRIFT_SASL.varname, String.valueOf(MetastoreConf.getBoolVar(hiveConf, MetastoreConf.ConfVars.USE_THRIFT_SASL)));
        System.setProperty(HiveConf.ConfVars.METASTORE_KERBEROS_PRINCIPAL.varname, MetastoreConf.getVar(hiveConf, MetastoreConf.ConfVars.KERBEROS_PRINCIPAL));
        System.setProperty(ConfVars.METASTORE_KERBEROS_KEYTAB_FILE.varname, MetastoreConf.getVar(hiveConf, MetastoreConf.ConfVars.KERBEROS_KEYTAB_FILE));
    }
}