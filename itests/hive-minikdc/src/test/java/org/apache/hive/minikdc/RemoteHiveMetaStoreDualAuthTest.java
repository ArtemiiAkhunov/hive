...
public class RemoteHiveMetaStoreDualAuthTest extends TestRemoteHiveMetaStore
{
    ...
    public void setUp() throws Exception
    {
        if (null == miniKDC)
        {
            ...
            hiveMetastorePrincipal = miniKDC.getFullyQualifiedServicePrincipal(miniKDC.getHiveMetastoreServicePrincipal());
            hiveMetastoreKeytab = miniKDC.getKeyTabFile(miniKDC.getServicePrincipalForUser(miniKDC.getHiveMetastoreServicePrincipal()));
