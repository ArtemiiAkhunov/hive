...
public class TestHiveMetaStoreAlterColumnPar
{
    ...
    public void testAlterColumn() throws Exception
    {
        ...
        try (Connection hs2Conn1 = DriverManager.getConnection(TestHiveMetaStoreAlterColumnPar.miniHS2.getJdbcURL(), "hive", "hive"); Statement stmt1 = hs2Conn1.createStatement(); Connection hs2Conn2 = DriverManager.getConnection(TestHiveMetaStoreAlterColumnPar.miniHS2.getJdbcURL(), "hive", "hive"); Statement stmt2 = hs2Conn2.createStatement();)
        {
