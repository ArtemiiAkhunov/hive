...
public class TestHDFSPermissionPolicyProvider
{
    ...
    public static void setup() throws Exception
    {
        ...
        String warehouseLocation = "hdfs://" + mDfs.getNameNode().getHostAndPort() + MetastoreConf.ConfVars.WAREHOUSE.getDefaultVal();
        ...
        StorageDescriptor sd = new StorageDescriptor(cols, defaultTbl1Loc, "input", "output", false, 0, serde, null, null, new HashMap<String, String>());
        Table tbl = new Table("tbl1", "default", "foo", now, now, 0, sd, null, new HashMap<String, String>(), null, null, TableType.MANAGED_TABLE.toString());
        client.createTable(tbl);

        sd = new StorageDescriptor(cols, defaultTbl2Loc, "input", "output", false, 0, serde, null, null, new HashMap<String, String>());
        tbl = new Table("tbl2", "default", "foo", now, now, 0, sd, null, new HashMap<String, String>(), null, null, TableType.MANAGED_TABLE.toString());
        client.createTable(tbl);

        Database db = new Database("db1", "no description", db1Loc, new HashMap<String, String>());
        client.createDatabase(db);

        sd = new StorageDescriptor(cols, db1Tbl1Loc, "input", "output", false, 0, serde, null, null, new HashMap<String, String>());
        tbl = new Table("tbl1", "db1", "foo", now, now, 0, sd, null, new HashMap<String, String>(), null, null, TableType.MANAGED_TABLE.toString());
        client.createTable(tbl);
    }
