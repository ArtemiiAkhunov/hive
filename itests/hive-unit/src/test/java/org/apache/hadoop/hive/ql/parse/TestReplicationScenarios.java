...
public class TestReplicationScenarios
{
    ...
    private final static String DBNOTIF_LISTENER_CLASSNAME = "org.apache.hive.hcatalog.listener.DbNotificationListener";
    // FIXME : replace with hive copy once that is copied
    private final static String tid = TestReplicationScenarios.class.getCanonicalName().toLowerCase().replace('.', '_') + "_" + System.currentTimeMillis();
    private final static String TEST_PATH = System.getProperty("test.warehouse.dir", "/tmp") + Path.SEPARATOR + tid;
    ...
    public static void setUpBeforeClass() throws Exception
    {
        ...
        overrideProperties.put(MetastoreConf.ConfVars.EVENT_MESSAGE_FACTORY.getHiveName(), GzipJSONMessageEncoder.class.getCanonicalName());
    ...
    private Tuple bootstrapLoadAndVerify(String dbName, String replDbName, List<String> withClauseOptions) throws IOException
    {
    ...
    private Tuple incrementalLoadAndVerify(String dbName, String replDbName, List<String> withClauseOptions) throws IOException
    {
    ...
    private void loadAndVerify(String replDbName, String sourceDbNameOrPattern, String lastReplId, List<String> withClauseOptions) throws IOException
    {
        String withClause = getWithClause(withClauseOptions);
    ...
    public void testDropsWithCM() throws IOException
    {
        ...
        run("INSERT INTO TABLE " + dbName + ".ptned_copy" + " PARTITION(b='1') SELECT a FROM " + dbName + ".ptned WHERE b='1'", driver);
    ...
    public void testBootstrapWithDataInDumpDir() throws IOException
    {
        ...
        run("LOAD DATA LOCAL INPATH '" + ptnLocn1 + "' OVERWRITE INTO TABLE " + dbName + ".ptned PARTITION(b=1)", driver);
        run("LOAD DATA LOCAL INPATH '" + ptnLocn2 + "' INTO TABLE " + dbName + ".ptned PARTITION(b=2)", driver);
        Tuple dump = replDumpDb(dbName);
        ...
        String tgtFileRelativePath = ReplUtils.REPL_HIVE_BASE_DIR + File.separator + EximUtil.DATA_PATH_NAME + File.separator + dbName.toLowerCase() + File.separator + "unptned" + File.separator + unptnedFileName1;
        ...
        tgtFileRelativePath = ReplUtils.REPL_HIVE_BASE_DIR + File.separator + EximUtil.DATA_PATH_NAME + File.separator + dbName.toLowerCase() + File.separator + "ptned" + File.separator + "b=1" + File.separator + ptnedFileName1;
    ...
    public void testIncrementalLoadWithOneFailedDump() throws IOException
    {
        ...
        String ackFileRelativePath = ReplUtils.REPL_HIVE_BASE_DIR + File.separator + DUMP_ACKNOWLEDGEMENT.toString();
        Path dumpFinishedAckFilePath = new Path(incrementalDump.dumpLocation, ackFileRelativePath);
        Path tmpDumpFinishedAckFilePath = new Path(dumpFinishedAckFilePath.getParent(), "old_" + dumpFinishedAckFilePath.getName());
    ...
    public void testConfiguredDeleteOfPrevDumpDir() throws IOException
    {
        ...
        String dbName = createDB(nameOfTest, driver);
        String replDbName = dbName + "_dupe";
        List<String> withConfigDeletePrevDump = Arrays.asList("'" + HiveConf.ConfVars.REPL_RETAIN_PREV_DUMP_DIR + "'= 'false' ");
        List<String> withConfigRetainPrevDump = Arrays.asList("'" + HiveConf.ConfVars.REPL_RETAIN_PREV_DUMP_DIR + "'= 'true' ", "'" + HiveConf.ConfVars.REPL_RETAIN_PREV_DUMP_DIR_COUNT + "'= '2' ");
        ...
        run("INSERT INTO TABLE " + dbName + ".ptned_late PARTITION(b=3) SELECT a FROM " + dbName + ".ptned WHERE b=2", driver);
    ...
    public void testInsertToMultiKeyPartition() throws IOException
    {
        ...
        verifyRun("SELECT name from " + replDbName + ".namelist where (year=1984 and month=4 and day=1) ORDER BY name", ptn_year_1984_month_4_day_1_1, driverMirror);
        ...
        verifyRunWithPatternMatch("SHOW TABLE EXTENDED LIKE namelist PARTITION (year=1980,month=4,day=1)", "location", "namelist/year=1980/month=4/day=1", driverMirror);
        run("USE " + dbName, driver);
        ...
        verifyRun("SELECT name from " + replDbName + ".namelist where (year=1984 and month=4 and day=1) ORDER BY name", ptn_year_1984_month_4_day_1_2, driverMirror);
        ...
        run("USE " + replDbName, driverMirror);
        verifyRunWithPatternMatch("SHOW TABLE EXTENDED LIKE namelist PARTITION (year=1990,month=5,day=25)", "location", "namelist/year=1990/month=5/day=25", driverMirror);
        run("USE " + dbName, driver);
    ...
    public void testStatus() throws Throwable
    {
        ...
        lastReplDumpId = verifyAndReturnDbReplStatus(dbName, lastReplDumpId, "CREATE TABLE " + dbName + ".ptned(a string) partitioned by (b int) STORED AS TEXTFILE", replDbName);
        lastReplDumpId = verifyAndReturnDbReplStatus(dbName, lastReplDumpId, "ALTER TABLE " + dbName + ".ptned ADD PARTITION (b=1)", replDbName);
        lastReplDumpId = verifyAndReturnDbReplStatus(dbName, lastReplDumpId, "ALTER TABLE " + dbName + ".ptned PARTITION (b=1) RENAME TO PARTITION (b=11)", replDbName);
        lastReplDumpId = verifyAndReturnDbReplStatus(dbName, lastReplDumpId, "ALTER TABLE " + dbName + ".ptned SET TBLPROPERTIES ('blah'='foo')", replDbName);
        lastReplDumpId = verifyAndReturnDbReplStatus(dbName, lastReplDumpId, "ALTER TABLE " + dbName + ".ptned RENAME TO  " + dbName + ".ptned_rn", replDbName);
        lastReplDumpId = verifyAndReturnDbReplStatus(dbName, lastReplDumpId, "ALTER TABLE " + dbName + ".ptned_rn DROP PARTITION (b=11)", replDbName);
        lastReplDumpId = verifyAndReturnDbReplStatus(dbName, lastReplDumpId, "DROP TABLE " + dbName + ".ptned_rn", replDbName);
    ...
    public void testDeleteStagingDir() throws IOException
    {
        ...
        run("CREATE TABLE " + StatsUtils.getFullyQualifiedTableName(dbName, tableName) + "(a string) STORED AS TEXTFILE", driver);
    ...
    public void testEventFilters()
    {
        ...
        IMetaStoreClient.NotificationFilter restrictByDefaultMessageFormat = new MessageFormatFilter(JSONMessageEncoder.FORMAT);
        IMetaStoreClient.NotificationFilter restrictByArbitraryMessageFormat = new MessageFormatFilter(JSONMessageEncoder.FORMAT + "_bogus");
    ...
    public void testPolicyIdImplicitly() throws Exception
    {
        ...
        run("ALTER DATABASE " + name + " Set DBPROPERTIES ( '" + SOURCE_OF_REPLICATION + "' = '')", driver);

        // Create a table with some data.
        run("CREATE TABLE " + dbName + ".dataTable(a string) STORED AS TEXTFILE", driver);

        String[] unptn_data = new String[]{"eleven", "twelve"};
        String unptn_locn = new Path(TEST_PATH, name + "_unptn").toUri().getPath();
        createTestDataFile(unptn_locn, unptn_data);

        run("LOAD DATA LOCAL INPATH '" + unptn_locn + "' OVERWRITE INTO TABLE " + dbName + ".dataTable", driver);
        ...
        assertTrue(fs.exists(new Path(dumpPath, DUMP_ACKNOWLEDGEMENT.toString())));
        assertTrue(fs.exists(new Path(dumpPath, LOAD_ACKNOWLEDGEMENT.toString())));
        verifyRun("SELECT * from " + replicatedDbName + ".dataTable", unptn_data, driverMirror);
        ...
        assertTrue(result.get(0), result.get(0).contains("repl.source.for=default_REPL DUMP " + dbName));
    ...
    public void testAddPartition() throws Throwable
    {
        ...
        run("CREATE TABLE " + dbName + ".ptned(a string) partitioned by (b int) STORED AS TEXTFILE", driver);
        run("insert into table " + dbName + ".ptned partition(b='2') values " + "('delhi')", driver);
    ...
    private void verifyMBeanStatistics(String testName, String replDbName, String nameStri, String[] events, Tuple incrementalDump) throws MalformedObjectNameException, MBeanException, AttributeNotFoundException, InstanceNotFoundException, ReflectionException
    {
        ObjectName name = ObjectName.getInstance(nameStri);

        assertTrue(ManagementFactory.getPlatformMBeanServer().getAttribute(name, "ReplicationType").toString().contains("INCREMENTAL"));
        // Check the dump location is set correctly.
        assertTrue(ManagementFactory.getPlatformMBeanServer().getAttribute(name, "DumpDirectory").toString().startsWith(incrementalDump.dumpLocation));
        // The CurrentEventId should be the last dumped repl id, once the load is complete.
        assertEquals(incrementalDump.lastReplId, ManagementFactory.getPlatformMBeanServer().getAttribute(name, "CurrentEventId"));
        assertEquals(Long.parseLong(incrementalDump.lastReplId), ManagementFactory.getPlatformMBeanServer().getAttribute(name, "LastEventId"));
        assertTrue(ManagementFactory.getPlatformMBeanServer().getAttribute(name, "SourceDatabase").toString().contains(testName));
        assertTrue(ManagementFactory.getPlatformMBeanServer().getAttribute(name, "TargetDatabase").toString().contains(replDbName));
        for (String event : events)
        {
    ...
    private static String createDB(String name, IDriver myDriver)
    {
        ...
        run("CREATE DATABASE " + name + " LOCATION '" + extLocation + "/" + name.toLowerCase() + ".db' MANAGEDLOCATION '" + mgdLocation + "/" + name.toLowerCase() + ".db' WITH DBPROPERTIES ( '" + SOURCE_OF_REPLICATION + "' = '1,2,3')", myDriver);
        return name;
    }
    ...
    private NotificationEvent createDummyEvent(String dbname, String tblname, long evid)
    {
        ...
        NotificationEvent event = new NotificationEvent(evid, (int) System.currentTimeMillis(), MessageBuilder.CREATE_TABLE_EVENT, MessageBuilder.getInstance().buildCreateTableMessage(t, Arrays.asList("/tmp/").iterator()).toString());
    ...
    private String verifyAndReturnDbReplStatus(String dbName, String prevReplDumpId, String cmd, String replDbName) throws IOException
    {
        run(cmd, driver);
    ...
    private String verifyAndReturnTblReplStatus(String dbName, String tblName, String lastDbReplDumpId, String cmd, String replDbName) throws IOException, TException
    {
        run(cmd, driver);
        String lastReplDumpId = incrementalLoadAndVerify(dbName, replDbName).lastReplId;
    ...
    private void verifyIfTableExist(String dbName, String tableName, HiveMetaStoreClient myClient) throws Exception
    {
        Table tbl = myClient.getTable(dbName, tableName);
        assertNotNull(tbl);
    }

    private void verifyIfPartitionNotExist(String dbName, String tableName, List<String> partValues, HiveMetaStoreClient myClient)
    {
        Exception e = null;
        try
        {
    ...
    private void verifyIfPartitionExist(String dbName, String tableName, List<String> partValues, HiveMetaStoreClient myClient)
    {
        try
        {
            Partition ptn = myClient.getPartition(dbName, tableName, partValues);
    ...
    private void verifyDataListFileDoesNotExist(FileSystem fs, Path hiveDumpDir, String part) throws IOException
    {
        FileStatus[] eventFileStatuses = fs.listStatus(hiveDumpDir);
