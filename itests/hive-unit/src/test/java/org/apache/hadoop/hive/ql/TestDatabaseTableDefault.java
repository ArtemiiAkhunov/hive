...
public class TestDatabaseTableDefault
{
    ...
    {
        TRANSACTIONALTBL1("transactional_table_1"), TRANSACTIONALTBL2("transactional_table_2"), TRANSACTIONALTBL3("transactional_table_3"), TRANSACTIONALTBL4("transactional_table_4"), TRANSACTIONALTBL5("transactional_table_5"), TRANSACTIONALTBL6("transactional_table_6"), TRANSACTIONALTBL7("transactional_table_7"), EXTERNALTABLE1("external_table_1"), EXTERNALTABLE2("external_table_2"), EXTERNALTABLE3("external_table_3"), EXTERNALTABLE4("external_table_4"), EXTERNALTABLE5("external_table_5"), EXTERNALTABLE6("external_table_6"), NONACIDPART("nonAcidPart"), NONACIDNONBUCKET("nonAcidNonBucket");
    ...
    public void setUp() throws Exception
    {
        ...
        MetastoreConf.setVar(hiveConf, ConfVars.METASTORE_METADATA_TRANSFORMER_CLASS, "org.apache.hadoop.hive.metastore.MetastoreDefaultTransformer");
