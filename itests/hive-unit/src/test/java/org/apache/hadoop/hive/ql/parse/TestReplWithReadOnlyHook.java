...
public class TestReplWithReadOnlyHook extends BaseReplicationScenariosAcidTables
{
    ...
    public static void classLevelSetup() throws Exception
    {
        ...
        acidEnableConf.put(HiveConf.ConfVars.REPL_RETAIN_CUSTOM_LOCATIONS_FOR_DB_ON_TARGET.varname, "false");
        ...
        overridesForHiveConf1.put("hive.txn.manager", "org.apache.hadoop.hive.ql.lockmgr" + ".DummyTxnManager");
    ...
    public void testDbReadOnlyModeBackWardCompatible() throws Throwable
    {
        ...
        // perform incremental
        primary.run("insert into " + primaryDbName + ".t1 values(\"AAA\")").dump(primaryDbName);
