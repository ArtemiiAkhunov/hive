...
public class TestMetaStoreMultipleEncryptionZones
{
    ...
    public static void setUp() throws Exception
    {
        ...
        hiveConf.set(HiveConf.ConfVars.METASTORE_WAREHOUSE.varname, "hdfs://" + miniDFSCluster.getNameNode().getHostAndPort() + HiveConf.ConfVars.METASTORE_WAREHOUSE.defaultStrVal);
    ...
    public void testClearerEncrypted() throws Exception
    {
        ...
        hiveConfCmClearer.set(HiveConf.ConfVars.METASTORE_WAREHOUSE.varname, "hdfs://" + miniDFSCluster.getNameNode().getHostAndPort() + HiveConf.ConfVars.METASTORE_WAREHOUSE.defaultStrVal);
        ...
        assertTrue(fsWarehouse.exists(ReplChangeManager.getCMPath(hiveConfCmClearer, part11.getName(), fileChksum11, ReplChangeManager.getInstance(conf).getCmRoot(part11).toString())));
        assertTrue(fsWarehouse.exists(ReplChangeManager.getCMPath(hiveConfCmClearer, part12.getName(), fileChksum12, ReplChangeManager.getInstance(conf).getCmRoot(part12).toString())));
        assertTrue(fsWarehouse.exists(ReplChangeManager.getCMPath(hiveConfCmClearer, part21.getName(), fileChksum21, ReplChangeManager.getInstance(conf).getCmRoot(part21).toString())));
        assertTrue(fsWarehouse.exists(ReplChangeManager.getCMPath(hiveConfCmClearer, part22.getName(), fileChksum22, ReplChangeManager.getInstance(conf).getCmRoot(part22).toString())));
        assertTrue(fsWarehouse.exists(ReplChangeManager.getCMPath(hiveConfCmClearer, part31.getName(), fileChksum31, ReplChangeManager.getInstance(conf).getCmRoot(part31).toString())));
        assertTrue(fsWarehouse.exists(ReplChangeManager.getCMPath(hiveConfCmClearer, part32.getName(), fileChksum32, ReplChangeManager.getInstance(conf).getCmRoot(part32).toString())));

        fsWarehouse.setTimes(ReplChangeManager.getCMPath(hiveConfCmClearer, part11.getName(), fileChksum11, ReplChangeManager.getInstance(conf).getCmRoot(part11).toString()), now - 7 * 86400 * 1000 * 2, now - 7 * 86400 * 1000 * 2);
        fsWarehouse.setTimes(ReplChangeManager.getCMPath(hiveConfCmClearer, part21.getName(), fileChksum21, ReplChangeManager.getInstance(conf).getCmRoot(part21).toString()), now - 7 * 86400 * 1000 * 2, now - 7 * 86400 * 1000 * 2);
        fsWarehouse.setTimes(ReplChangeManager.getCMPath(hiveConfCmClearer, part31.getName(), fileChksum31, ReplChangeManager.getInstance(conf).getCmRoot(part31).toString()), now - 7 * 86400 * 1000 * 2, now - 7 * 86400 * 1000 * 2);
        fsWarehouse.setTimes(ReplChangeManager.getCMPath(hiveConfCmClearer, part32.getName(), fileChksum32, ReplChangeManager.getInstance(conf).getCmRoot(part32).toString()), now - 7 * 86400 * 1000 * 2, now - 7 * 86400 * 1000 * 2);
        ...
        do
        {
            ...
            if (!fsWarehouse.exists(ReplChangeManager.getCMPath(hiveConfCmClearer, part11.getName(), fileChksum11, ReplChangeManager.getInstance(conf).getCmRoot(part11).toString())) && fsWarehouse.exists(ReplChangeManager.getCMPath(hiveConfCmClearer, part12.getName(), fileChksum12, ReplChangeManager.getInstance(conf).getCmRoot(part12).toString())) && !fsWarehouse.exists(ReplChangeManager.getCMPath(hiveConfCmClearer, part21.getName(), fileChksum21, ReplChangeManager.getInstance(conf).getCmRoot(part21).toString())) && fsWarehouse.exists(ReplChangeManager.getCMPath(hiveConfCmClearer, part22.getName(), fileChksum22, ReplChangeManager.getInstance(conf).getCmRoot(part22).toString())) && !fsWarehouse.exists(ReplChangeManager.getCMPath(hiveConfCmClearer, part31.getName(), fileChksum31, ReplChangeManager.getInstance(conf).getCmRoot(part31).toString())) && !fsWarehouse.exists(ReplChangeManager.getCMPath(hiveConfCmClearer, part32.getName(), fileChksum32, ReplChangeManager.getInstance(conf).getCmRoot(part32).toString())))
            {
                cleared = true;
            }
        } while (!cleared);
    ...
    public void testCmRootAclPermissions() throws Exception
    {
        ...
        hiveConfAclPermissions.set(HiveConf.ConfVars.METASTORE_WAREHOUSE.varname, "hdfs://" + miniDFSCluster.getNameNode().getHostAndPort() + HiveConf.ConfVars.METASTORE_WAREHOUSE.defaultStrVal);
    ...
    public void testCmrootEncrypted() throws Exception
    {
        ...
        encryptedHiveConf.set(HiveConf.ConfVars.METASTORE_WAREHOUSE.varname, "hdfs://" + miniDFSCluster.getNameNode().getHostAndPort() + HiveConf.ConfVars.METASTORE_WAREHOUSE.defaultStrVal);
    ...
    public void testCmrootFallbackEncrypted() throws Exception
    {
        ...
        String cmRootFallbackEncrypted = "hdfs://" + miniDFSCluster.getNameNode().getHostAndPort() + "/cmrootFallbackEncrypted";
