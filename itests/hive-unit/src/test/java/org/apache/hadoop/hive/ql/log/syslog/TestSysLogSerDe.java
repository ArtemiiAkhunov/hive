...
public class TestSysLogSerDe
{
    ...
    public void testAllValid() throws Exception
    {
        ...
        Text rowText = new Text("<14>1 2020-05-12T08:48:05.299Z hostname.cluster.local coordinator testProc" + " 92a0ae-833-4fd-8d3-0a4a21ca2 [test@001 class=\"util.Version\"" + " level=\"INFO\" thread=\"main\"] HV000001");
        ...
        Assert.assertEquals("2020-05-12 01:48:05.299", ((Timestamp) results.get(3)).toSqlTimestamp().toString());
    ...
    public void testWithMissingFields() throws Exception
    {
        ...
        Text rowText = new Text("<14>1 2020-05-12T08:48:05.299Z hostname.cluster.local - -" + " - [test@001 class=\"util.Version\"" + " level=\"INFO\" thread=\"main\"] HV000001");
