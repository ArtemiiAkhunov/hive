...
public abstract class AbstractTestAuthorizationApiAuthorizer
{
    ...
    private void testFunction(FunctionInvoker mscFunctionInvoker) throws Exception
    {
        ...
        } catch (MetaException e)
        {
            ...
            // authorization checks passed.
            if (exStackString.contains("org.apache.hadoop.hive.metastore.api.NoSuchObjectException") || exStackString.contains("org.apache.hadoop.hive.metastore.api.InvalidObjectException"))
            {
