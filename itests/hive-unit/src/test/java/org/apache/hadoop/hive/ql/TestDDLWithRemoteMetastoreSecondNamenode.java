...
public class TestDDLWithRemoteMetastoreSecondNamenode
{
    ...
    {
        String[] srctables = {Table1Name, Table2Name, Database1Name + "." + Table3Name, Database1Name + "." + Table4Name, Table5Name, Table6Name};
    ...
    private void addPartitionAndCheck(Table table, String column, String value, String location) throws Exception
    {
    ...
    private void alterPartitionAndCheck(Table table, String column, String value, String location) throws Exception
    {
        ...
        executeQuery("ALTER TABLE " + table.getTableName() + " PARTITION (" + column + "='" + value + "')" + " SET LOCATION '" + location + "'");
    ...
    private Table createTableAndCheck(String tableName, String tableLocation) throws Exception
    {
    ...
    {
        executeQuery("CREATE EXTERNAL TABLE " + tableName + (baseTable == null ? " (col1 string, col2 string) PARTITIONED BY (p string) " : " LIKE " + baseTable.getTableName()) + buildLocationClause(tableLocation));
