...
public class TestAuthorizationPreEventListener
{
    ...
    private void validatePartition(Partition expectedPartition, Partition actualPartition)
    {
        ...
        assertEquals(expectedPartition.getSd().getInputFormat(), actualPartition.getSd().getInputFormat());
        assertEquals(expectedPartition.getSd().getOutputFormat(), actualPartition.getSd().getOutputFormat());
        assertEquals(expectedPartition.getSd().getSerdeInfo(), actualPartition.getSd().getSerdeInfo());
    ...
    public void testListener() throws Exception
    {
        ...
        listSize = authCalls.size();
        Database dbFromAlterDatabaseEvent = (Database) assertAndExtractSingleObjectFromEvent(listSize, authCalls, DummyHiveMetastoreAuthorizationProvider.AuthCallContextType.DB);
