...
public class TestCompactionMetrics2 extends CompactorTest
{
    ...
    public void testWritesToDisabledCompactionDatabase() throws Exception
    {
        ...
        burnThroughTransactions(dbName, t.getTableName(), 1, null, new HashSet<>(Collections.singletonList(2L)));
    ...
    public void testWritesToEnabledCompactionDatabase() throws Exception
    {
        ...
        Assert.assertEquals(MetricsConstants.WRITES_TO_DISABLED_COMPACTION_TABLE + " value incorrect", 0, Metrics.getOrCreateGauge(MetricsConstants.WRITES_TO_DISABLED_COMPACTION_TABLE).intValue());
    }
