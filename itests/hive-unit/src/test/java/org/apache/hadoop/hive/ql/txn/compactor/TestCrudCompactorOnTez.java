...
public class TestCrudCompactorOnTez extends CompactorOnTezTest
{
    ...
    public void testRebalanceCompactionOfNotPartitionedImplicitlyBucketedTable() throws Exception
    {
        ...
        String[][] expectedBuckets = new String[][]{{"{\"writeid\":1,\"bucketid\":536870912,\"rowid\":0}\t5\t4", "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":1}\t6\t2", "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":2}\t6\t3", "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":3}\t6\t4", "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":4}\t5\t2",}, {

                "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":5}\t5\t3", "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":6}\t2\t4", "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":7}\t3\t3", "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":8}\t4\t4", "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":9}\t4\t3",}, {"{\"writeid\":1,\"bucketid\":537001984,\"rowid\":10}\t2\t3", "{\"writeid\":1,\"bucketid\":537001984,\"rowid\":11}\t3\t4", "{\"writeid\":2,\"bucketid\":537001984,\"rowid\":12}\t12\t12", "{\"writeid\":3,\"bucketid\":537001984,\"rowid\":13}\t13\t13", "{\"writeid\":4,\"bucketid\":537001984,\"rowid\":14}\t14\t14",}, {"{\"writeid\":5,\"bucketid\":537067520,\"rowid\":15}\t15\t15", "{\"writeid\":6,\"bucketid\":537067520,\"rowid\":16}\t16\t16", "{\"writeid\":7,\"bucketid\":537067520,\"rowid\":17}\t17\t17",},};
        verifyRebalance(testDataProvider, tableName, null, expectedBuckets, new String[]{"bucket_00000", "bucket_00001", "bucket_00002", "bucket_00003"}, "base_0000007_v0000020");
    }
    ...
    public void testRebalanceCompactionOfPartitionedImplicitlyBucketedTable() throws Exception
    {
        ...
        executeStatementOnDriver("insert into " + stageTableName + " values " + "('1',1,'yesterday'), ('1',2,'yesterday'), ('1',3, 'yesterday'), ('1',4, 'yesterday'), " + "('2',1,'today'), ('2',2,'today'), ('2',3,'today'), ('2',4, 'today'), " + "('3',1,'tomorrow'), ('3',2,'tomorrow'), ('3',3,'tomorrow'), ('3',4,'tomorrow')", driver);

        executeStatementOnDriver("drop table if exists " + tableName, driver);
        executeStatementOnDriver("CREATE TABLE " + tableName + "(a string, b int) " + "PARTITIONED BY (ds string) STORED AS ORC TBLPROPERTIES('transactional'='true')", driver);
        ...
        Assert.assertEquals("Test setup does not match the expected: different buckets", Arrays.asList("bucket_00000_0", "bucket_00001_0", "bucket_00002_0"), CompactorTestUtil.getBucketFileNames(fs, table, "ds=tomorrow", "base_0000001"));
        ...
        for (int i = 0; i < 3; i++)
        {
            Assert.assertEquals("rebalanced bucket " + i, Arrays.asList(expectedBuckets[i]), testDataProvider.getBucketData(tableName, BucketCodec.V1.encode(options.bucket(i)) + ""));
        }
    ...
    public void testRebalanceCompactionOfNotPartitionedExplicitlyBucketedTable() throws Exception
    {
        ...
        final String tableName = "rebalance_test";
        executeStatementOnDriver("drop table if exists " + tableName, driver);
        executeStatementOnDriver("CREATE TABLE " + tableName + "(a string, b int) " + "CLUSTERED BY(a) INTO 4 BUCKETS STORED AS ORC TBLPROPERTIES('transactional'='true')", driver);
        ...
        Assert.assertEquals("Expecting error message 'Cannot execute rebalancing compaction on bucketed tables.' and found:" + compacts.get(0).getState(), "Cannot execute rebalancing compaction on bucketed tables.", compacts.get(0).getErrorMessage());
    }
    ...
    private TestDataProvider prepareRebalanceTestData(String tableName) throws Exception
    {
        ...
        executeStatementOnDriver("drop table if exists " + tableName, driver);
        executeStatementOnDriver("CREATE TABLE " + tableName + "(a string, b int) " + "STORED AS ORC TBLPROPERTIES('transactional'='true')", driver);
        ...
        Table table = msClient.getTable("default", tableName);
        FileSystem fs = FileSystem.get(conf);
        Assert.assertEquals("Test setup does not match the expected: different buckets", Arrays.asList("bucket_00000_0", "bucket_00001_0", "bucket_00002_0", "bucket_00003_0"), CompactorTestUtil.getBucketFileNames(fs, table, null, "base_0000001"));
        String[][] expectedBuckets = new String[][]{{"{\"writeid\":1,\"bucketid\":536870912,\"rowid\":0}\t5\t4", "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":1}\t6\t2", "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":2}\t6\t3", "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":3}\t6\t4", "{\"writeid\":2,\"bucketid\":536870912,\"rowid\":0}\t12\t12", "{\"writeid\":3,\"bucketid\":536870912,\"rowid\":0}\t13\t13", "{\"writeid\":4,\"bucketid\":536870912,\"rowid\":0}\t14\t14", "{\"writeid\":5,\"bucketid\":536870912,\"rowid\":0}\t15\t15", "{\"writeid\":6,\"bucketid\":536870912,\"rowid\":0}\t16\t16", "{\"writeid\":7,\"bucketid\":536870912,\"rowid\":0}\t17\t17",}, {"{\"writeid\":1,\"bucketid\":536936448,\"rowid\":0}\t5\t2", "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":1}\t5\t3", "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":2}\t2\t4",}, {"{\"writeid\":1,\"bucketid\":537001984,\"rowid\":0}\t3\t3", "{\"writeid\":1,\"bucketid\":537001984,\"rowid\":1}\t4\t4", "{\"writeid\":1,\"bucketid\":537001984,\"rowid\":2}\t4\t3",}, {"{\"writeid\":1,\"bucketid\":537067520,\"rowid\":0}\t2\t3", "{\"writeid\":1,\"bucketid\":537067520,\"rowid\":1}\t3\t4",},};
        AcidOutputFormat.Options options = new AcidOutputFormat.Options(conf);
        for (int i = 0; i < 3; i++)
        {
            Assert.assertEquals("unbalanced bucket " + i, Arrays.asList(expectedBuckets[i]), testDataProvider.getBucketData(tableName, BucketCodec.V1.encode(options.bucket(i)) + ""));
        }
        return testDataProvider;
    }

    private void verifyRebalance(TestDataProvider testDataProvider, String tableName, String partitionName, String[][] expectedBucketContent, String[] bucketNames, String folderName) throws Exception
    {
        // Verify buckets and their content after rebalance
        Table table = msClient.getTable("default", tableName);
        FileSystem fs = FileSystem.get(conf);
        Assert.assertEquals("Buckets does not match after compaction", Arrays.asList(bucketNames), CompactorTestUtil.getBucketFileNames(fs, table, partitionName, folderName));
        AcidOutputFormat.Options options = new AcidOutputFormat.Options(conf);
        for (int i = 0; i < expectedBucketContent.length; i++)
        {
            Assert.assertEquals("rebalanced bucket " + i, Arrays.asList(expectedBucketContent[i]), testDataProvider.getBucketData(tableName, BucketCodec.V1.encode(options.bucket(i)) + ""));
        }
    }
    ...
    public void testCompactionShouldNotFailOnPartitionsWithBooleanField() throws Exception
    {
        ...
        executeStatementOnDriver("drop table if exists " + tableName, driver);
        executeStatementOnDriver("CREATE TABLE " + tableName + "(id string, value string) PARTITIONED BY (bval boolean) CLUSTERED BY(id) " + "INTO 10 BUCKETS STORED AS ORC TBLPROPERTIES('transactional'='true')", driver);

        executeStatementOnDriver("INSERT INTO TABLE " + tableName + " values ('1','one',true),('2','two', true)," + "('4','four', false),('5','five', true),('6','six', false),('7','seven', false),('8','eight', false)," + "('11','eleven', true),('12','twelve', false),('13','thirteen', false),('14','fourteen', false)," + "('17','seventeen', true),('18','eighteen', false),('19','nineteen', false),('20','twenty', true)", driver);
    ...
    public void secondCompactionShouldBeRefusedBeforeEnqueueing() throws Exception
    {
        ...
        final String tableName = "compaction_test";
        executeStatementOnDriver("drop table if exists " + tableName, driver);
        executeStatementOnDriver("CREATE TABLE " + tableName + "(id string, value string) CLUSTERED BY(id) " + "INTO 10 BUCKETS STORED AS ORC TBLPROPERTIES('transactional'='true')", driver);
        ...
        {
            String errorMessage = ErrorMsg.COMPACTION_REFUSED.format(dbName, tableName, "", "Compaction is already scheduled with state='ready for cleaning' and id=" + resp.getId());
    ...
    public void testStatsAfterQueryCompactionOnTez() throws Exception
    {
        ...
        executeStatementOnDriver("CREATE TABLE " + tblName + "(a INT, b STRING) " + " CLUSTERED BY(a) INTO 4 BUCKETS" + //currently ACID requires table to be bucketed
        ...
        new StatsUpdater().gatherStats(ci, conf, System.getProperty("user.name"), CompactorUtil.getCompactorJobQueueName(conf, ci, table), msClient);
    ...
    public void testMajorCompactionPartitionedWithoutBuckets() throws Exception
    {
        ...
        FileSystem fs = FileSystem.get(conf);
        // Verify deltas
        Assert.assertEquals("Delta directories does not match", Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000004_0000004_0000"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, partitionToday));
        // Verify delete delta
        Assert.assertEquals("Delete directories does not match", Arrays.asList("delete_delta_0000003_0000003_0000", "delete_delta_0000005_0000005_0000"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, partitionToday));

        List<String> expectedRsBucket0 = new ArrayList<>(Arrays.asList("{\"writeid\":1,\"bucketid\":536870912,\"rowid\":1}\t2\t3\tyesterday", "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":2}\t2\t4\ttoday", "{\"writeid\":2,\"bucketid\":536870912,\"rowid\":0}\t3\t3\ttoday", "{\"writeid\":2,\"bucketid\":536870912,\"rowid\":0}\t3\t4\tyesterday", "{\"writeid\":2,\"bucketid\":536870912,\"rowid\":1}\t4\t3\ttomorrow", "{\"writeid\":2,\"bucketid\":536870912,\"rowid\":2}\t4\t4\ttoday", "{\"writeid\":4,\"bucketid\":536870912,\"rowid\":0}\t5\t2\tyesterday", "{\"writeid\":4,\"bucketid\":536870912,\"rowid\":0}\t5\t4\ttoday", "{\"writeid\":4,\"bucketid\":536870912,\"rowid\":1}\t5\t3\tyesterday", "{\"writeid\":4,\"bucketid\":536870912,\"rowid\":1}\t6\t2\ttoday", "{\"writeid\":4,\"bucketid\":536870912,\"rowid\":2}\t6\t3\ttoday", "{\"writeid\":4,\"bucketid\":536870912,\"rowid\":3}\t6\t4\ttoday"));
        Assert.assertEquals("pre-compaction bucket 0", expectedRsBucket0, testDataProvider.getBucketData(tblName, "536870912"));

        // Run major compaction and cleaner for all 3 partitions
        CompactorTestUtil.runCompaction(conf, dbName, tblName, CompactionType.MAJOR, true, partitionToday, partitionTomorrow, partitionYesterday);
        CompactorTestUtil.runCleaner(conf);
        // 3 compaction should be in the response queue with succeeded state
        verifySuccessfulCompaction(3);
        // Should contain only one base directory now
        Assert.assertEquals("Base directory does not match after major compaction", Collections.singletonList("base_0000005_v0000009"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, partitionToday));
        Assert.assertEquals("Base directory does not match after major compaction", Collections.singletonList("base_0000005_v0000014"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, partitionTomorrow));
        Assert.assertEquals("Base directory does not match after major compaction", Collections.singletonList("base_0000005_v0000019"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, partitionYesterday));
        // Check base dir contents
        List<String> expectedBucketFiles = Arrays.asList("bucket_00000");
        Assert.assertEquals("Bucket names are not matching after compaction", expectedBucketFiles, CompactorTestUtil.getBucketFileNames(fs, table, partitionToday, "base_0000005_v0000009"));
        Assert.assertEquals("Bucket names are not matching after compaction", expectedBucketFiles, CompactorTestUtil.getBucketFileNames(fs, table, partitionTomorrow, "base_0000005_v0000014"));
        Assert.assertEquals("Bucket names are not matching after compaction", expectedBucketFiles, CompactorTestUtil.getBucketFileNames(fs, table, partitionYesterday, "base_0000005_v0000019"));
        // Check buckets contents
        Assert.assertEquals("post-compaction bucket 0", expectedRsBucket0, testDataProvider.getBucketData(tblName, "536870912"));
        // Check bucket file contents
        ...
        CompactorTestUtilities.checkAcidVersion(fs.listFiles(new Path(table.getSd().getLocation()), true), fs, conf.getBoolVar(HiveConf.ConfVars.HIVE_WRITE_ACID_VERSION_FILE), new String[]{AcidUtils.BASE_PREFIX});
    }

    @Test
    public void testMajorCompactionPartitionedWithBuckets() throws Exception
    {
        String dbName = "default";
        ...
        Assert.assertEquals("Delete directories does not match", Arrays.asList("delete_delta_0000003_0000003_0000", "delete_delta_0000005_0000005_0000"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, partitionToday));
        // Check bucket contents
        List<String> expectedRsBucket0 = Arrays.asList("{\"writeid\":2,\"bucketid\":536870912,\"rowid\":0}\t3\t3\ttoday", "{\"writeid\":2,\"bucketid\":536870912,\"rowid\":0}\t3\t4\tyesterday");
        List<String> rsBucket0 = dataProvider.getBucketData(tableName, "536870912");

        List<String> expectedRsBucket1 = Arrays.asList("{\"writeid\":1,\"bucketid\":536936448,\"rowid\":0}\t2\t3\tyesterday", "{\"writeid\":1,\"bucketid\":536936448,\"rowid\":0}\t2\t4\ttoday", "{\"writeid\":2,\"bucketid\":536936448,\"rowid\":0}\t4\t3\ttomorrow", "{\"writeid\":2,\"bucketid\":536936448,\"rowid\":1}\t4\t4\ttoday", "{\"writeid\":4,\"bucketid\":536936448,\"rowid\":0}\t5\t2\tyesterday", "{\"writeid\":4,\"bucketid\":536936448,\"rowid\":0}\t5\t4\ttoday", "{\"writeid\":4,\"bucketid\":536936448,\"rowid\":1}\t5\t3\tyesterday", "{\"writeid\":4,\"bucketid\":536936448,\"rowid\":1}\t6\t2\ttoday", "{\"writeid\":4,\"bucketid\":536936448,\"rowid\":2}\t6\t3\ttoday", "{\"writeid\":4,\"bucketid\":536936448,\"rowid\":3}\t6\t4\ttoday");
        ...
        // Run a compaction
        CompactorTestUtil.runCompaction(conf, dbName, tableName, CompactionType.MAJOR, true, partitionToday, partitionTomorrow, partitionYesterday);
        // Clean up resources
        CompactorTestUtil.runCleaner(conf);
        ...
        List<String> baseDeltasInToday = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, partitionToday);
        Assert.assertEquals("Delta directories does not match after compaction", Collections.singletonList(expectedBaseToday), baseDeltasInToday);
        List<String> baseDeltasInTomorrow = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, partitionTomorrow);

        Assert.assertEquals("Delta directories does not match after compaction", Collections.singletonList(expectedBaseTomorrow), baseDeltasInTomorrow);
        List<String> baseDeltasInYesterday = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, partitionYesterday);
        Assert.assertEquals("Delta directories does not match after compaction", Collections.singletonList(expectedBaseYesterday), baseDeltasInYesterday);
        // Verify contents of bases
        Assert.assertEquals("Bucket names are not matching after compaction", Arrays.asList("bucket_00000", "bucket_00001"), CompactorTestUtil.getBucketFileNames(fs, table, partitionToday, expectedBaseToday));
        Assert.assertEquals("Bucket names are not matching after compaction", Arrays.asList("bucket_00001"), CompactorTestUtil.getBucketFileNames(fs, table, partitionTomorrow, expectedBaseTomorrow));
        Assert.assertEquals("Bucket names are not matching after compaction", Arrays.asList("bucket_00000", "bucket_00001"), CompactorTestUtil.getBucketFileNames(fs, table, partitionYesterday, expectedBaseYesterday));
    ...
    public void testMinorCompactionWithoutBuckets() throws Exception
    {
        ...
        testMinorCompactionWithoutBucketsCommon(dbName, tableName, tempTableName, false, expectedDeltas, expectedDeleteDeltas, "delta_0000001_0000008_v0000025", CompactionType.MINOR);
    }
    ...
    public void testMinorCompactionWithoutBucketsInsertOverwrite() throws Exception
    {
        ...
        testMinorCompactionWithoutBucketsCommon(dbName, tableName, tempTableName, true, expectedDeltas, expectedDeleteDeltas, "delta_0000002_0000008_v0000025", CompactionType.MINOR);
    }
    ...
    public void testMajorCompactionWithoutBucketsInsertAndDeleteInsertOverwrite() throws Exception
    {
        ...
        testMinorCompactionWithoutBucketsCommon(dbName, tableName, tempTableName, true, expectedDeltas, expectedDeleteDeltas, "base_0000008_v0000025", CompactionType.MAJOR);
    }
    ...
    public void testMinorAndMajorCompactionWithoutBuckets() throws Exception
    {
        ...
        // Verify delta directories after compaction
        List<String> actualBasesAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, null);
        Assert.assertEquals("Base directory does not match after compaction", Collections.singletonList("base_0000008_v0000039"), actualBasesAfterComp);
        // Verify bucket files in delta dirs
    ...
    public void testMinorCompactionPartitionedWithoutBuckets() throws Exception
    {
        ...
        Assert.assertEquals("Delete directories does not match", Arrays.asList("delete_delta_0000003_0000003_0000", "delete_delta_0000005_0000005_0000"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, partitionToday));
        // Run a compaction
        CompactorTestUtil.runCompaction(conf, dbName, tableName, CompactionType.MINOR, true, partitionToday, partitionTomorrow, partitionYesterday);
        // Clean up resources
        CompactorTestUtil.runCleaner(conf);
        // 3 compaction should be in the response queue with succeeded state
        verifySuccessfulCompaction(3);
        // Verify delta directories after compaction in each partition
        List<String> actualDeltasAfterCompPartToday = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, partitionToday);
        Assert.assertEquals("Delta directories does not match after compaction", Collections.singletonList("delta_0000001_0000005_v0000009"), actualDeltasAfterCompPartToday);
        List<String> actualDeleteDeltasAfterCompPartToday = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, partitionToday);
        Assert.assertEquals("Delete delta directories does not match after compaction", Collections.singletonList("delete_delta_0000001_0000005_v0000009"), actualDeleteDeltasAfterCompPartToday);
        // Verify bucket files in delta dirs
        List<String> expectedBucketFiles = Collections.singletonList("bucket_00000");
        Assert.assertEquals("Bucket names are not matching after compaction", expectedBucketFiles, CompactorTestUtil.getBucketFileNames(fs, table, partitionToday, actualDeltasAfterCompPartToday.get(0)));
        Assert.assertEquals("Bucket names are not matching after compaction", expectedBucketFiles, CompactorTestUtil.getBucketFileNames(fs, table, partitionToday, actualDeleteDeltasAfterCompPartToday.get(0)));
    ...
    public void testMinorCompaction10DeltaDirs() throws Exception
    {
        ...
        List<String> deleteDeltaName = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, null);
        ...
        List<String> actualDeleteDeltasAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, null);
        Assert.assertEquals(Collections.singletonList("delete_delta_0000001_0000015_v0000019"), actualDeleteDeltasAfterComp);
        // Verify bucket file in delta dir
        List<String> expectedBucketFile = Collections.singletonList("bucket_00000");
        Assert.assertEquals("Bucket names are not matching after compaction", expectedBucketFile, CompactorTestUtil.getBucketFileNames(fs, table, null, actualDeltasAfterComp.get(0)));
        Assert.assertEquals("Bucket names are not matching after compaction", expectedBucketFile, CompactorTestUtil.getBucketFileNames(fs, table, null, actualDeleteDeltasAfterComp.get(0)));
    ...
    public void testMultipleMinorCompactions() throws Exception
    {
        ...
        // Verify delta directories after compaction
        List<String> actualDeltasAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, null);
        Assert.assertEquals("Delta directories does not match after compaction", Collections.singletonList("delta_0000001_0000015_v0000046"), actualDeltasAfterComp);
        List<String> actualDeleteDeltasAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, null);
        Assert.assertEquals("Delete delta directories does not match after compaction", Collections.singletonList("delete_delta_0000001_0000015_v0000046"), actualDeleteDeltasAfterComp);
    ...
    public void testMinorCompactionWhileStreamingAfterAbort() throws Exception
    {
        ...
        executeStatementOnDriver("drop table if exists " + tableName, driver);
        executeStatementOnDriver("CREATE TABLE " + tableName + "(a INT, b STRING) " + " CLUSTERED BY(a) INTO 1 BUCKETS" + " STORED AS ORC  TBLPROPERTIES ('transactional'='true')", driver);
        CompactorTestUtil.runStreamingAPI(conf, dbName, tableName, Lists.newArrayList(new CompactorTestUtil.StreamingConnectionOption(false, false), new CompactorTestUtil.StreamingConnectionOption(false, false), new CompactorTestUtil.StreamingConnectionOption(true, false)));
        // Now, compact
        CompactorTestUtil.runCompaction(conf, dbName, tableName, CompactionType.MINOR, true);
        // Find the location of the table
        IMetaStoreClient metaStoreClient = new HiveMetaStoreClient(conf);
        Table table = metaStoreClient.getTable(dbName, tableName);
        FileSystem fs = FileSystem.get(conf);
        Assert.assertEquals("Delta names does not match", Arrays.asList("delta_0000001_0000002", "delta_0000001_0000006_v0000009", "delta_0000003_0000004"), CompactorTestUtil.getBaseOrDeltaNames(fs, null, table, null));
        CompactorTestUtil.checkExpectedTxnsPresent(null, new Path[]{new Path(table.getSd().getLocation(), "delta_0000001_0000006_v0000009")}, "a,b", "int:string", 0, 1L, 4L, Lists.newArrayList(5, 6), 1);
    ...
    public void testMinorCompactionWhileStreamingWithAbort() throws Exception
    {
        ...
        String tableName = "testMinorCompaction";
        executeStatementOnDriver("drop table if exists " + tableName, driver);
        executeStatementOnDriver("CREATE TABLE " + tableName + "(a INT, b STRING, c int, d int, e int, f int, j int, i int) " + " STORED AS ORC  TBLPROPERTIES ('transactional'='true')", driver);
        CompactorTestUtil.runStreamingAPI(conf, dbName, tableName, Lists.newArrayList(new CompactorTestUtil.StreamingConnectionOption(false, false), new CompactorTestUtil.StreamingConnectionOption(true, false), new CompactorTestUtil.StreamingConnectionOption(false, false)));
        // Now, compact
        CompactorTestUtil.runCompaction(conf, dbName, tableName, CompactionType.MINOR, true);
        // Find the location of the table
        IMetaStoreClient metaStoreClient = new HiveMetaStoreClient(conf);
        Table table = metaStoreClient.getTable(dbName, tableName);
        FileSystem fs = FileSystem.get(conf);
        Assert.assertEquals("Delta names does not match", Arrays.asList("delta_0000001_0000002", "delta_0000001_0000006_v0000009", "delta_0000005_0000006"), CompactorTestUtil.getBaseOrDeltaNames(fs, null, table, null));
        CompactorTestUtil.checkExpectedTxnsPresent(null, new Path[]{new Path(table.getSd().getLocation(), "delta_0000001_0000006_v0000009")}, "a,b", "int:string", 0, 1L, 6L, Lists.newArrayList(3, 4), 1);
    }
    ...
    public void testMajorCompactionAfterMinor() throws Exception
    {
        ...
        verifySuccessfulCompaction(1);
        // Verify delta directories after compaction
        Assert.assertEquals("Delta directories does not match after minor compaction", Collections.singletonList("delta_0000001_0000005_v0000009"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, null));
        Assert.assertEquals("Delete delta directories does not match after minor compaction", Collections.singletonList("delete_delta_0000001_0000005_v0000009"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, null));
        // Verify all contents
        List<String> actualData = dataProvider.getAllData(tableName);
        Assert.assertEquals(expectedData, actualData);
        ...
        Assert.assertEquals("Base directory does not match after major compaction", Collections.singletonList("base_0000010_v0000030"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, null));
        // Verify all contents
        actualData = dataProvider.getAllData(tableName);
        Assert.assertEquals(expectedData, actualData);
    }
    ...
    public void testMinorCompactionAfterMajor() throws Exception
    {
        ...
        verifySuccessfulCompaction(1);
        // Verify base directory after compaction
        Assert.assertEquals("Base directory does not match after major compaction", Collections.singletonList("base_0000005_v0000009"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, null));
        // Verify all contents
        List<String> actualData = dataProvider.getAllData(tableName);
        Assert.assertEquals(expectedData, actualData);
        // Insert another round of test data
        ...
        // Verify base directory after compaction
        Assert.assertEquals("Base directory does not match after major compaction", Collections.singletonList("base_0000005_v0000009"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, null));
        Assert.assertEquals("Delta directories do not match after major compaction", Collections.singletonList("delta_0000006_0000010_v0000021"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, null));
        Assert.assertEquals("Delete delta directories does not match after minor compaction", Collections.singletonList("delete_delta_0000006_0000010_v0000021"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, null));
        // Verify all contents
        actualData = dataProvider.getAllData(tableName);
        Assert.assertEquals(expectedData, actualData);
    }
    ...
    public void testCompactionWithSchemaEvolutionAndBuckets() throws Exception
    {
        ...
        executeStatementOnDriver("drop table if exists " + tblName, driver);
        executeStatementOnDriver("create transactional table " + tblName + " (a int, b int) partitioned by(ds string) clustered by (a) into 2 buckets" + " stored as ORC TBLPROPERTIES('bucketing_version'='2', 'transactional'='true'," + " 'transactional_properties'='default')", driver);
        // Insert some data
        executeStatementOnDriver("insert into " + tblName + " partition (ds) values(1,2,'today'),(1,3,'today'),(1,4,'yesterday'),(2,2,'yesterday'),(2,3,'today'),(2,4,'today')", driver);
        // Add a new column
        executeStatementOnDriver("alter table " + tblName + " add columns(c int)", driver);
        // Insert more data
        executeStatementOnDriver("insert into " + tblName + " partition (ds) values(3,2,1000,'yesterday'),(3,3,1001,'today'),(3,4,1002,'yesterday'),(4,2,1003,'today')," + "(4,3,1004,'yesterday'),(4,4,1005,'today')", driver);
        executeStatementOnDriver("delete from " + tblName + " where b = 2", driver);
        ...
        List<String> rsBucket0PtnToday = executeStatementOnDriverAndReturnResults("select ROW__ID, * from  " + tblName + " where ROW__ID.bucketid = 536870912 and ds='today' order by a,b", driver);
        // Bucket 1, partition 'today'
        List<String> rsBucket1PtnToday = executeStatementOnDriverAndReturnResults("select ROW__ID, * from  " + tblName + " where ROW__ID.bucketid = 536936448 and ds='today' order by a,b", driver);
        ...
        //  Run major compaction and cleaner
        CompactorTestUtil.runCompaction(conf, dbName, tblName, CompactionType.MAJOR, true, "ds=yesterday", "ds=today");
        CompactorTestUtil.runCleaner(conf);

        // Bucket 0, partition 'today'
        List<String> rsCompactBucket0PtnToday = executeStatementOnDriverAndReturnResults("select ROW__ID, * from  " + tblName + " where ROW__ID.bucketid = 536870912 and ds='today' order by a,b", driver);
        Assert.assertEquals("compacted read", expectedRsBucket0PtnToday, rsCompactBucket0PtnToday);
        // Bucket 1, partition 'today'
        List<String> rsCompactBucket1PtnToday = executeStatementOnDriverAndReturnResults("select ROW__ID, * from  " + tblName + " where ROW__ID.bucketid = 536936448 and ds='today' order by a,b", driver);
    ...
    public void testCompactionWithSchemaEvolutionNoBucketsMultipleReducers() throws Exception
    {
        ...
        executeStatementOnDriver("drop table if exists " + tblName, driver);
        executeStatementOnDriver("create transactional table " + tblName + " (a int, b int) partitioned by(ds string)" + " stored as ORC TBLPROPERTIES('transactional'='true'," + " 'transactional_properties'='default')", driver);
        // Insert some data
        executeStatementOnDriver("insert into " + tblName + " partition (ds) values(1,2,'today'),(1,3,'today'),(1,4,'yesterday'),(2,2,'yesterday'),(2,3,'today'),(2,4,'today')", driver);
        // Add a new column
        executeStatementOnDriver("alter table " + tblName + " add columns(c int)", driver);
        ...
        // Partition 'today'
        List<String> rsCompactPtnToday = executeStatementOnDriverAndReturnResults("select ROW__ID, * from  " + tblName + " where ds='today'", driver);
        Assert.assertEquals("compacted read", expectedRsPtnToday, rsCompactPtnToday);
        // Partition 'yesterday'
        List<String> rsCompactPtnYesterday = executeStatementOnDriverAndReturnResults("select ROW__ID, * from  " + tblName + " where ds='yesterday'", driver);
    ...
    @Test
    public void testMajorCompactionDb() throws Exception
    {
        testCompactionDb(CompactionType.MAJOR, "base_0000005_v0000011");
    }

    @Test
    public void testMinorCompactionDb() throws Exception
    {
     ...
     */
    @Test
    public void testJustInserts() throws Exception
    {
        String dbName = "default";
        ...
        List<String> actualDeltasAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, null);
        Assert.assertEquals("Delta directories does not match after compaction", Collections.singletonList("delta_0000001_0000003_v0000005"), actualDeltasAfterComp);
        List<String> actualDeleteDeltasAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, null);
        Assert.assertEquals("Delete delta directories does not match after compaction", Collections.emptyList(), actualDeleteDeltasAfterComp);
    }
     ...
     */
    @Test
    public void testJustDeletes() throws Exception
    {
        String dbName = "default";
        ...
        List<String> actualDeltasAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, null);
        Assert.assertEquals("Delta directories does not match after compaction", Collections.singletonList("delta_0000004_0000004_0000"), actualDeltasAfterComp);
        List<String> actualDeleteDeltasAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, null);
        Assert.assertEquals("Delete delta directories does not match after compaction", Collections.singletonList("delete_delta_0000002_0000003_v0000005"), actualDeleteDeltasAfterComp);
    }
    ...
    public void testMajorCompactionAfterTwoMergeStatements() throws Exception
    {
        ...
        executeStatementOnDriver("CREATE TABLE " + tableName + "(id int,value string) STORED AS ORC TBLPROPERTIES ('transactional'='true')", driver);
        executeStatementOnDriver("insert into " + tableName + " values(1, 'value_1'),(2, 'value_2'),(3, 'value_3'),(4, 'value_4'),(5, 'value_5')", driver);
        ...
        runMergeStatement(tableName, Arrays.asList("1, 'newvalue_1'", "2, 'newvalue_2'", "3, 'newvalue_3'", "6, 'value_6'", "7, 'value_7'"));
        runMergeStatement(tableName, Arrays.asList("1, 'newestvalue_1'", "2, 'newestvalue_2'", "5, 'newestvalue_5'", "7, 'newestvalue_7'", "8, 'value_8'"));
        ...
        // Verify delta directories after compaction
        List<String> actualDeltasAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, null);
        Assert.assertEquals("Base directory does not match after compaction", Collections.singletonList("base_0000003_v0000014"), actualDeltasAfterComp);
        ...
        // Verify contents of bucket files.
        List<String> expectedRsBucket0 = Arrays.asList("{\"writeid\":1,\"bucketid\":536870912,\"rowid\":3}\t4\tvalue_4", "{\"writeid\":2,\"bucketid\":536870913,\"rowid\":2}\t3\tnewvalue_3", "{\"writeid\":2,\"bucketid\":536870914,\"rowid\":0}\t6\tvalue_6", "{\"writeid\":3,\"bucketid\":536870913,\"rowid\":0}\t1\tnewestvalue_1", "{\"writeid\":3,\"bucketid\":536870913,\"rowid\":1}\t2\tnewestvalue_2", "{\"writeid\":3,\"bucketid\":536870913,\"rowid\":2}\t5\tnewestvalue_5", "{\"writeid\":3,\"bucketid\":536870913,\"rowid\":3}\t7\tnewestvalue_7", "{\"writeid\":3,\"bucketid\":536870914,\"rowid\":0}\t8\tvalue_8");
    ...
    public void testMinorCompactionAfterMultipleMergeStatements() throws Exception
    {
        ...
        // Create a non bucketed test table and insert some initial data
        executeStatementOnDriver("CREATE TABLE " + tableName + "(id int,value string) STORED AS ORC TBLPROPERTIES ('transactional'='true')", driver);
        executeStatementOnDriver("insert into " + tableName + " values(1, 'value_1'),(2, 'value_2'),(3, 'value_3'),(4, 'value_4'),(5, 'value_5'), (6, 'value_6'), (7, 'value_7'), (8, 'value_8')", driver);
        ...
        runMergeStatement(tableName, Arrays.asList("1, 'newvalue_1'", "2, 'newvalue_2'", "4, 'newvalue_4'", "6, 'newvalue_6'", "9, 'value_9'", "10, 'value_10'", "11, 'value_11'", "12, 'value_12'"));
        runMergeStatement(tableName, Arrays.asList("2, 'newestvalue_2'", "4, 'newestvalue_4'", "6, 'newestvalue_6'", "10, 'newestvalue_10'", "11, 'newestvalue_11'", "13, 'value_13'", "14, 'value_14'"));
        ...
        runMergeStatement(tableName, Arrays.asList("1, 'latestvalue_1'", "4, 'latestvalue_4'", "5, 'latestvalue_5'", "9, 'latestvalue_9'", "11, 'latestvalue_11'", "13, 'latestvalue_13'", "15, 'value_15'"));
        List<String> expectedData = dataProvider.getAllData(tableName);
        ...
        // Verify delta and delete delta directories after compaction
        List<String> actualDeltasAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, null);
        Assert.assertEquals("Delta directory does not match after compaction", Collections.singletonList("delta_0000001_0000004_v0000033"), actualDeltasAfterComp);

        List<String> actualDeleteDeltasAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, null);
        Assert.assertEquals("Delete delta directory does not match after compaction", Collections.singletonList("delete_delta_0000001_0000004_v0000033"), actualDeleteDeltasAfterComp);

        // Verify bucket files in delta dirs
        List<String> expectedBucketFiles = Collections.singletonList("bucket_00000");
        Assert.assertEquals("Bucket name in delta directory is not matching after compaction", expectedBucketFiles, CompactorTestUtil.getBucketFileNames(fs, table, null, actualDeltasAfterComp.get(0)));
        Assert.assertEquals("Bucket name in delete delta directory is not matching after compaction", expectedBucketFiles, CompactorTestUtil.getBucketFileNames(fs, table, null, actualDeleteDeltasAfterComp.get(0)));

        // Verify contents of bucket files.
        List<String> expectedRsBucket0 = Arrays.asList("{\"writeid\":4,\"bucketid\":536870913,\"rowid\":0}\t1\tlatestvalue_1", "{\"writeid\":3,\"bucketid\":536870913,\"rowid\":0}\t2\tnewestvalue_2", "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":2}\t3\tvalue_3", "{\"writeid\":4,\"bucketid\":536870913,\"rowid\":1}\t4\tlatestvalue_4", "{\"writeid\":4,\"bucketid\":536870913,\"rowid\":2}\t5\tlatestvalue_5", "{\"writeid\":3,\"bucketid\":536870913,\"rowid\":2}\t6\tnewestvalue_6", "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":6}\t7\tvalue_7", "{\"writeid\":1,\"bucketid\":536870912,\"rowid\":7}\t8\tvalue_8", "{\"writeid\":4,\"bucketid\":536870913,\"rowid\":3}\t9\tlatestvalue_9", "{\"writeid\":3,\"bucketid\":536870913,\"rowid\":3}\t10\tnewestvalue_10", "{\"writeid\":4,\"bucketid\":536870913,\"rowid\":4}\t11\tlatestvalue_11", "{\"writeid\":2,\"bucketid\":536870914,\"rowid\":3}\t12\tvalue_12", "{\"writeid\":4,\"bucketid\":536870913,\"rowid\":5}\t13\tlatestvalue_13", "{\"writeid\":3,\"bucketid\":536870914,\"rowid\":1}\t14\tvalue_14", "{\"writeid\":4,\"bucketid\":536870914,\"rowid\":0}\t15\tvalue_15");
        List<String> rsBucket0 = executeStatementOnDriverAndReturnResults("select ROW__ID, * from " + tableName + " order by id", driver);
        Assert.assertEquals(expectedRsBucket0, rsBucket0);
        // Verify all contents
        List<String> actualData = dataProvider.getAllData(tableName);
        Assert.assertEquals(expectedData, actualData);
    ...
    private void runMergeStatement(String tableName, List<String> values) throws Exception
    {
        ...
        executeStatementOnDriver("MERGE INTO " + tableName + " AS T USING merge_source AS S ON T.ID = S.ID WHEN MATCHED AND (T.value != S.value AND S.value IS NOT NULL) THEN UPDATE SET value = S.value WHEN NOT MATCHED THEN INSERT VALUES (S.ID, S.value)", driver);
    ...
    @Test
    public void testVectorizationOff() throws Exception
    {
    ...
    public void testIfEmptyBaseIsPresentAfterCompaction() throws Exception
    {
        ...
        executeStatementOnDriver("drop table if exists " + tblName, driver);
        executeStatementOnDriver("create table " + tblName + " (a string) stored as orc " + "TBLPROPERTIES ('transactional'='true')", driver);
    ...
    public void testNonAcidToAcidConversionWithNestedTableWithUnionSubdir() throws Exception
    {
        ...
        executeStatementOnDriver("create table " + helperTblName + " (a int, b int) stored as orc " + "TBLPROPERTIES ('transactional'='false')", driver);
        ...
        executeStatementOnDriver("drop table if exists " + tblName, driver);
        executeStatementOnDriver("create table " + tblName + "(a int, b int) partitioned by (p string, q string) stored as orc TBLPROPERTIES ('transactional'='false')", driver);

        // Insert some union data
        executeStatementOnDriver("insert into " + tblName + " partition(p='p1',q='q1') " + "select a,b from " + helperTblName + " union all select a,b from " + helperTblName, driver);
    ...
    public void testCompactionShouldNotFailOnStructField() throws Exception
    {
        ...
        // Create test table
        executeStatementOnDriver("drop table if exists " + tblName, driver);
        executeStatementOnDriver("CREATE TABLE " + tblName + "(col1 array<struct<arr_col1:int, `timestamp`:string>>)" + "STORED AS ORC TBLPROPERTIES('transactional'='true')", driver);

        // Insert test data into test table
        executeStatementOnDriver("INSERT INTO TABLE " + tblName + " SELECT ARRAY(NAMED_STRUCT('arr_col1',1,'timestamp','2022-07-05 21:51:20.371'))", driver);
        executeStatementOnDriver("INSERT INTO TABLE " + tblName + " SELECT ARRAY(NAMED_STRUCT('arr_col1',2,'timestamp','2022-07-05 21:51:20.371'))", driver);
        ...
        Assert.assertEquals("Expecting compaction state 'succeeded' and found:" + compacts.get(0).getState(), "succeeded", compacts.get(0).getState());
        // Should contain only one base directory now
        ...
        List<String> expectedBucketFiles = Arrays.asList("bucket_00000");
        Assert.assertEquals("Bucket names are not matching after compaction", expectedBucketFiles, CompactorTestUtil.getBucketFileNames(fs, table, null, baseDir.get(0)));
    ...
    public void testCompactionWithCreateTableProps() throws Exception
    {
        ...
        // Create test table
        executeStatementOnDriver("drop table if exists " + tblName, driver);
        executeStatementOnDriver("CREATE TABLE " + tblName + "(col1 array<struct<arr_col1:int, `timestamp`:string>>)" + "STORED AS ORC TBLPROPERTIES('transactional'='true', 'compactor.tez.task.resource.memory.mb'='8000')", driver);

        // Insert test data into test table
        executeStatementOnDriver("INSERT INTO TABLE " + tblName + " SELECT ARRAY(NAMED_STRUCT('arr_col1',1,'timestamp','2022-07-05 21:51:20.371'))", driver);
        executeStatementOnDriver("INSERT INTO TABLE " + tblName + " SELECT ARRAY(NAMED_STRUCT('arr_col1',2,'timestamp','2022-07-06 21:51:20.371'))", driver);
    ...
    public void testCompactionWithAlterTableProps() throws Exception
    {
        ...
        executeStatementOnDriver("ALTER TABLE " + tblName + " COMPACT 'major' WITH OVERWRITE TBLPROPERTIES " + "('compactor.tez.task.resource.memory.mb'='5000')", driver);
    ...
    public void testCompactionShouldNotFailOnKeywordField() throws Exception
    {
        ...
        // Create test table
        executeStatementOnDriver("drop table if exists " + tblName, driver);
        executeStatementOnDriver("CREATE TABLE " + tblName + "(`sessionid` string,`row` int,`timeofoccurrence` bigint)" + "STORED AS ORC TBLPROPERTIES('transactional'='true')", driver);

        // Insert test data into test table
        executeStatementOnDriver("INSERT INTO TABLE " + tblName + " values (\"abcd\",300,21111111111)", driver);
        executeStatementOnDriver("INSERT INTO TABLE " + tblName + " values (\"abcd\",300,21111111111)", driver);
    ...
    public void testStatsAfterCompactionPartTbl(boolean isQueryBased, boolean isAutoGatherStats, CompactionType compactionType) throws Exception
    {
        ...
        IMetaStoreClient msClient = new HiveMetaStoreClient(conf);
        executeStatementOnDriver("drop table if exists " + tblName, driver);
        executeStatementOnDriver("CREATE TABLE " + tblName + "(a INT, b STRING) " + " PARTITIONED BY(bkt INT)" + " STORED AS ORC TBLPROPERTIES ('transactional'='true')", driver);
        ...
        executeStatementOnDriver("INSERT INTO TABLE " + tblName + " PARTITION(bkt=1)" + " values(59, 'Bangalore')", driver);
        executeStatementOnDriver("INSERT INTO TABLE " + tblName + " PARTITION(bkt=1)" + " values(60, 'New York')", driver);
        ...
        Map<String, String> parameters = partitions.stream().filter(p -> p.getName().equals("bkt=1")).findFirst().orElseThrow(() -> new RuntimeException("Could not get Partition")).getParameters();
    ...
    {
        testCompactionWithMerge(CompactionType.MAJOR, false, false, null, Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("base_0000003_v0000007"), true, true, false);
    }

    @Test
    public void testMajorCompactionWithFallbackNotPartitionedWithoutBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MAJOR, false, false, null, Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("base_0000003_v0000007"), true, true, true);
    }

    @Test
    public void testMajorCompactionWithMergePartitionedWithoutBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MAJOR, true, false, "ds=today", Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("base_0000003_v0000007"), true, true, false);
    }

    @Test
    public void testMajorCompactionWithFallbackPartitionedWithoutBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MAJOR, true, false, "ds=today", Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("base_0000003_v0000007"), true, true, true);
    }

    @Test
    public void testMajorCompactionWithMergeNotPartitionedWithBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MAJOR, false, true, null, Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("base_0000003_v0000007"), true, true, false);
    }

    @Test
    public void testMajorCompactionWithFallbackNotPartitionedWithBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MAJOR, false, true, null, Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("base_0000003_v0000007"), true, true, true);
    }

    @Test
    public void testMajorCompactionWithMergePartitionedWithBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MAJOR, true, true, "ds=today", Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("base_0000003_v0000007"), true, true, false);
    }

    @Test
    public void testMajorCompactionWithFallbackPartitionedWithBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MAJOR, true, true, "ds=today", Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("base_0000003_v0000007"), true, true, true);
    }

    @Test
    public void testMinorCompactionWithMergeNotPartitionedWithoutBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MINOR, false, false, null, Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("delta_0000001_0000003_v0000007"), true, true, false);
    }

    @Test
    public void testMinorCompactionWithFallbackNotPartitionedWithoutBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MINOR, false, false, null, Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("delta_0000001_0000003_v0000007"), true, true, true);
    }

    @Test
    public void testMinorCompactionWithMergePartitionedWithoutBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MINOR, true, false, "ds=today", Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("delta_0000001_0000003_v0000007"), true, true, false);
    }

    @Test
    public void testMinorCompactionWithFallbackPartitionedWithoutBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MINOR, true, false, "ds=today", Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("delta_0000001_0000003_v0000007"), true, true, true);
    }

    @Test
    public void testMinorCompactionWithMergeNotPartitionedWithBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MINOR, false, true, null, Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("delta_0000001_0000003_v0000007"), true, true, false);
    }

    @Test
    public void testMinorCompactionWithFallbackNotPartitionedWithBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MINOR, false, true, null, Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("delta_0000001_0000003_v0000007"), true, true, true);
    }

    @Test
    public void testMinorCompactionWithMergePartitionedWithBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MINOR, true, true, "ds=today", Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("delta_0000001_0000003_v0000007"), true, true, false);
    }

    @Test
    public void testMinorCompactionWithFallbackPartitionedWithBuckets() throws Exception
    {
        testCompactionWithMerge(CompactionType.MINOR, true, true, "ds=today", Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("delta_0000001_0000003_v0000007"), true, true, true);
    }

    @Test
    public void testMajorCompactionAfterMinorWithMerge() throws Exception
    {
        testCompactionWithMerge(CompactionType.MINOR, true, true, "ds=today", Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("delta_0000001_0000003_v0000007"), true, false, false);
        testCompactionWithMerge(CompactionType.MAJOR, true, true, "ds=today", Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000003_v0000007", "delta_0000004_0000004_0000", "delta_0000005_0000005_0000", "delta_0000006_0000006_0000"), Collections.singletonList("base_0000006_v0000014"), false, true, false);
    }

    @Test
    public void testMajorCompactionAfterMinorWithFallback() throws Exception
    {
        testCompactionWithMerge(CompactionType.MINOR, true, true, "ds=today", Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("delta_0000001_0000003_v0000007"), true, false, true);
        testCompactionWithMerge(CompactionType.MAJOR, true, true, "ds=today", Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000003_v0000007", "delta_0000004_0000004_0000", "delta_0000005_0000005_0000", "delta_0000006_0000006_0000"), Collections.singletonList("base_0000006_v0000025"), false, true, true);
    }

    @Test
    public void testMinorCompactionAfterMajorWithMerge() throws Exception
    {
        testCompactionWithMerge(CompactionType.MAJOR, false, false, null, Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("base_0000003_v0000007"), true, false, false);
        testCompactionWithMerge(CompactionType.MINOR, false, false, null, Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000004_0000004_0000", "delta_0000005_0000005_0000", "delta_0000006_0000006_0000"), Collections.singletonList("delta_0000001_0000006_v0000014"), false, true, false);
    }

    @Test
    public void testMinorCompactionAfterMajorWithFallback() throws Exception
    {
        testCompactionWithMerge(CompactionType.MAJOR, false, false, null, Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("base_0000003_v0000007"), true, false, true);
        testCompactionWithMerge(CompactionType.MINOR, false, false, null, Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000004_0000004_0000", "delta_0000005_0000005_0000", "delta_0000006_0000006_0000"), Collections.singletonList("delta_0000004_0000006_v0000017"), false, true, true);
    }

    @Test
    public void testMultipleMajorCompactionWithMerge() throws Exception
    {
        testCompactionWithMerge(CompactionType.MAJOR, true, true, "ds=today", Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("base_0000003_v0000007"), true, false, false);
        testCompactionWithMerge(CompactionType.MAJOR, true, true, "ds=today", Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000004_0000004_0000", "delta_0000005_0000005_0000", "delta_0000006_0000006_0000"), Collections.singletonList("base_0000006_v0000014"), false, true, false);
    }

    @Test
    public void testMultipleMajorCompactionWithFallback() throws Exception
    {
        testCompactionWithMerge(CompactionType.MAJOR, true, true, "ds=today", Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("base_0000003_v0000007"), true, false, true);
        testCompactionWithMerge(CompactionType.MAJOR, true, true, "ds=today", Arrays.asList("bucket_00000", "bucket_00001"), Arrays.asList("delta_0000004_0000004_0000", "delta_0000005_0000005_0000", "delta_0000006_0000006_0000"), Collections.singletonList("base_0000006_v0000017"), false, true, true);
    }

    @Test
    public void testMultipleMinorCompactionWithMerge() throws Exception
    {
        testCompactionWithMerge(CompactionType.MINOR, false, false, null, Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("delta_0000001_0000003_v0000007"), true, false, false);
        testCompactionWithMerge(CompactionType.MINOR, false, false, null, Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000003_v0000007", "delta_0000004_0000004_0000", "delta_0000005_0000005_0000", "delta_0000006_0000006_0000"), Collections.singletonList("delta_0000001_0000006_v0000014"), false, true, false);
    }

    @Test
    public void testMultipleMinorCompactionWithFallback() throws Exception
    {
        testCompactionWithMerge(CompactionType.MINOR, false, false, null, Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), Collections.singletonList("delta_0000001_0000003_v0000007"), true, false, true);
        testCompactionWithMerge(CompactionType.MINOR, false, false, null, Collections.singletonList("bucket_00000"), Arrays.asList("delta_0000001_0000003_v0000007", "delta_0000004_0000004_0000", "delta_0000005_0000005_0000", "delta_0000006_0000006_0000"), Collections.singletonList("delta_0000001_0000006_v0000025"), false, true, true);
    }

    private void testCompactionWithMerge(CompactionType compactionType, boolean isPartitioned, boolean isBucketed, String partitionName, List<String> bucketName, List<String> deltaDirNames, List<String> compactDirNames, boolean createTable, boolean dropTable, boolean useFallback) throws Exception
    {
        ...
        List<String> expectedData = dataProvider.getAllData(tableName);
        // Verify deltas
        Assert.assertEquals("Delta directories does not match", deltaDirNames, CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, partitionName));
        // Verify delete delta
        Assert.assertTrue(CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, partitionName).isEmpty());
        ...
        // Verify directories after compaction
        List<String> actualDirAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, compactionType == CompactionType.MAJOR ? AcidUtils.baseFileFilter : AcidUtils.deltaFileFilter, table, partitionName);
        Assert.assertEquals("Base directory does not match after compaction", compactDirNames, actualDirAfterComp);
        Assert.assertTrue(CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deleteEventDeltaDirFilter, table, partitionName).isEmpty());
        // Verify bucket files in delta dirs
        Assert.assertEquals("Bucket names are not matching after compaction", bucketName, CompactorTestUtil.getBucketFileNames(fs, table, partitionName, actualDirAfterComp.get(0)));
        // Verify all contents
        List<String> actualData = dataProvider.getAllData(tableName);
        Assert.assertEquals(expectedData, actualData);
        // Clean up
    ...
    public void testFallbackForMergeCompactionOnParquetTables() throws Exception
    {
        ...
        executeStatementOnDriver("drop table if exists " + tableName, driver);
        executeStatementOnDriver("CREATE TABLE " + tableName + "(a INT, b STRING) " + " PARTITIONED BY(bkt INT)" + " STORED AS PARQUET TBLPROPERTIES ('transactional'='true', 'transactional_properties'='insert_only')", driver);

        executeStatementOnDriver("INSERT INTO TABLE " + tableName + " PARTITION(bkt=1)" + " values(57, 'Budapest')", driver);
        executeStatementOnDriver("INSERT INTO TABLE " + tableName + " PARTITION(bkt=1)" + " values(58, 'Milano')", driver);
        executeStatementOnDriver("INSERT INTO TABLE " + tableName + " PARTITION(bkt=1)" + " values(59, 'Bangalore')", driver);
        executeStatementOnDriver("INSERT INTO TABLE " + tableName + " PARTITION(bkt=1)" + " values(60, 'New York')", driver);
    ...
    public void testFallbackForMergeCompactionWhenDeleteDeltaPresent() throws Exception
    {
        ...
        String partitionName = "bkt=1";
        executeStatementOnDriver("drop table if exists " + tableName, driver);
        executeStatementOnDriver("CREATE TABLE " + tableName + "(a INT, b STRING) " + " PARTITIONED BY(bkt INT)" + " STORED AS ORC TBLPROPERTIES ('transactional'='true')", driver);
