...
public class TestDisallowColChangesExceptionList
{
    ...
    public static void startServices() throws Exception
    {
        ...
        hiveConf.set(MetastoreConf.ConfVars.ALLOW_INCOMPATIBLE_COL_TYPE_CHANGES_TABLE_SERDES.getVarname(), "org.apache.hadoop.hive.ql.io.parquet.serde.ParquetHiveSerDe," + "org.apache.hadoop.hive.ql.io.orc.OrcSerde");
    ...
    public void testDisallowColChangesExceptionList()
    {
        ...
        try (Connection hs2conn = DriverManager.getConnection(TestDisallowColChangesExceptionList.miniHS2.getJdbcURL(), "hive", "hive"); Statement stmt = hs2conn.createStatement();)
        {
            ...
            {
                assertTrue("Unexpected exception: " + e1.getMessage(), e1.getMessage().contains("Unable to alter table. The following columns have types incompatible with the existing columns in their respective positions"));
            }
            try
            {
