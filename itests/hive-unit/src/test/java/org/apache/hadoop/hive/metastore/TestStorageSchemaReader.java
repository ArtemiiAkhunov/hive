...
public class TestStorageSchemaReader
{
    ...
    public void setUp() throws Exception
    {
        ...
        avroTableParams.put("avro.schema.literal", "{\"name\":\"nullable\", \"type\":\"record\", \"fields\":[{\"name\":\"id\", \"type\":\"int\"}, {\"name\":\"value\", \"type\":\"int\"}]}");
    ...
    private Table createTable(String tblName, String serdeClass, String inputFormatClass, String outputFormatClass, Map<String, String> tableParams, Map<String, String> serdeParams) throws TException
    {
        client = new HiveMetaStoreClient(hiveConf);
        return new TableBuilder().setDbName(dbName).setTableName(tblName).addCol("id", "int", "comment for " + tblName).addCol("value", "int", "comment for " + tblName).setSerdeLib(serdeClass).setInputFormat(inputFormatClass).setOutputFormat(outputFormatClass).setTableParams(tableParams).addStorageDescriptorParam("test_param_1", "Use this for comments etc").setSerdeParams(serdeParams).create(client, hiveConf);
    }
    ...
    private void checkFields(List<FieldSchema> fieldSchemas, List<FieldSchema> fieldSchemasFromHMS)
    {
        ...
        {
            assertTrue(fieldSchemas.get(i).getName().equals(fieldSchemasFromHMS.get(i).getName()) && fieldSchemas.get(i).getType().equals(fieldSchemasFromHMS.get(i).getType()));
        }
    }

    @Test
    public void testAvroTableWithDefaultSSR() throws Exception
    {
        ...
        createTable(tblName, AvroSerDe.class.getName(), AvroContainerInputFormat.class.getName(), AvroContainerOutputFormat.class.getName(), avroTableParams, new HashMap<>());
        assertThrows("Storage schema reading not supported", MetaException.class, () -> client.getSchema(dbName, tblName));
    }

    @Test
    public void testAvroTableWithSerdeSSR() throws Exception
    {
        hiveConf.set("metastore.storage.schema.reader.impl", "org.apache.hadoop.hive.metastore.SerDeStorageSchemaReader");
        String tblName = "avroTable";
        Table tbl = createTable(tblName, AvroSerDe.class.getName(), AvroContainerInputFormat.class.getName(), AvroContainerOutputFormat.class.getName(), avroTableParams, new HashMap<>());
        checkSchema(tblName, tbl);
    }

    @Test
    public void testHbaseTableWithDefaultSSR() throws Exception
    {
        hiveConf.set("metastore.storage.schema.reader.impl", "org.apache.hadoop.hive.metastore.DefaultStorageSchemaReader");
    ...
    @Test
    public void testHbaseTableWithSerdeSSR() throws Exception
    {
        hiveConf.set("metastore.storage.schema.reader.impl", "org.apache.hadoop.hive.metastore.SerDeStorageSchemaReader");
        String tblName = "jdbcTable";

        Table table = createTable(tblName, "org.apache.hadoop.hive.hbase.HBaseSerDe", null, null, hbaseTableParams, hbaseSerdeParams);
        checkSchema(tblName, table);
    }

    @Test
    public void testJdbcTableWithDefaultSSR() throws Exception
    {
        hiveConf.set("metastore.storage.schema.reader.impl", "org.apache.hadoop.hive.metastore.DefaultStorageSchemaReader");
        String tblName = "jdbcTable";
    ...
    @Test
    public void testJdbcTableWithSerdeSSR() throws Exception
    {
        hiveConf.set("metastore.storage.schema.reader.impl", "org.apache.hadoop.hive.metastore.SerDeStorageSchemaReader");
        String tblName = "jdbcTable";
    ...
    @Test
    public void testOrcTableWithDefaultSSR() throws Exception
    {
        hiveConf.set("metastore.storage.schema.reader.impl", "org.apache.hadoop.hive.metastore.DefaultStorageSchemaReader");
        String tblName = "orcTable2";
        Table tbl = createTable(tblName, OrcSerde.class.getName(), OrcInputFormat.class.getName(), OrcOutputFormat.class.getName(), new HashMap<>(), new HashMap<>());
        checkSchema(tblName, tbl);
    }

    @Test
    public void testOrcTableWithSerdeSSR() throws Exception
    {
        hiveConf.set("metastore.storage.schema.reader.impl", "org.apache.hadoop.hive.metastore.SerDeStorageSchemaReader");
