...
public class TestMetastoreVersion
{
    ...
    public void setUp() throws Exception
    {
        ...
        System.setProperty(HiveConf.ConfVars.METASTORE_CONNECT_URL_KEY.varname, "jdbc:derby:" + testMetastoreDB + ";create=true");
        metastoreSchemaInfo = MetaStoreSchemaInfoFactory.get(hiveConf, System.getProperty("test.tmp.dir", "target/tmp"), "derby");
    }
    ...
    public void setMetaStoreVersion(String newVersion, String comment) throws HiveMetaException, MetaException
    {
        RawStore ms = HMSHandler.getMSForConf(hiveConf);
        try
        {
