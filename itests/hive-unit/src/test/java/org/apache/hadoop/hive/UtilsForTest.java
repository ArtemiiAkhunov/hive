...
public class UtilsForTest
{
    ...
    public static void setNewDerbyDbLocation(HiveConf conf, String newloc)
    {
        ...
        conf.setVar(ConfVars.METASTORE_CONNECT_URL_KEY, "jdbc:derby:;databaseName=" + newDbLoc + ";create=true");
    }
    ...
    public static HiveConf getHiveOnTezConfFromDir(String confDir) throws Exception
    {
        ...
        hiveConf.addResource(new URL("file://" + new File(confDir).toURI().getPath() + "/tez-site.xml"));
        return hiveConf;
    }
