...
public class TestMmCompactorOnTez extends CompactorOnTezTest
{
    ...
    @Test
    public void testMmMinorCompactionNotPartitionedWithoutBuckets() throws Exception
    {
        ...
        // Verify deltas
        Assert.assertEquals("Delta directories does not match", Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, null));
        ...
        Assert.assertEquals("Delta directories does not match after compaction", Collections.singletonList("delta_0000001_0000003_v0000007"), actualDeltasAfterComp);
        // Verify bucket files in delta dirs
        List<String> expectedBucketFiles = Collections.singletonList("000000_0");
        Assert.assertEquals("Bucket names are not matching after compaction", expectedBucketFiles, CompactorTestUtil.getBucketFileNamesForMMTables(fs, table, null, actualDeltasAfterComp.get(0)));
    ...
    @Test
    public void testMmMinorCompactionNotPartitionedWithBuckets() throws Exception
    {
        String dbName = "default";
        String tableName = "testMmMinorCompaction";
        ...
        // Verify delta directories after compaction
        List<String> actualDeltasAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, null);
        Assert.assertEquals("Delta directories does not match after compaction", Collections.singletonList(newDeltaName), actualDeltasAfterComp);
        // Verify number of files in directory
        FileStatus[] files = fs.listStatus(new Path(table.getSd().getLocation(), newDeltaName), FileUtils.HIDDEN_FILES_PATH_FILTER);
    ...
    @Test
    public void testMmMinorCompactionPartitionedWithoutBuckets() throws Exception
    {
        String dbName = "default";
        String tableName = "testMmMinorCompaction";
        // Create test table
        ...
        Assert.assertEquals("Delta directories does not match", Arrays.asList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, partitionToday));
        // Run a compaction
        ...
        Assert.assertEquals("Delta directories does not match after compaction", Collections.singletonList("delta_0000001_0000003_v0000007"), actualDeltasAfterCompPartToday);
        // Verify bucket files in delta dirs
        List<String> expectedBucketFiles = Collections.singletonList("000000_0");
        Assert.assertEquals("Bucket names are not matching after compaction", expectedBucketFiles, CompactorTestUtil.getBucketFileNamesForMMTables(fs, table, partitionToday, actualDeltasAfterCompPartToday.get(0)));
    ...
    @Test
    public void testMmMinorCompactionPartitionedWithBucketsOrc() throws Exception
    {
        testMmMinorCompactionPartitionedWithBuckets("orc");
    }

    @Test
    public void testMmMinorCompactionPartitionedWithBucketsParquet() throws Exception
    {
        testMmMinorCompactionPartitionedWithBuckets("parquet");
    }

    @Test
    public void testMmMinorCompactionPartitionedWithBucketsAvro() throws Exception
    {
        testMmMinorCompactionPartitionedWithBuckets("avro");
    }

    @Test
    public void testMmMinorCompactionPartitionedWithBucketsTextFile() throws Exception
    {
        testMmMinorCompactionPartitionedWithBuckets("textfile");
    }

    @Test
    public void testMmMinorCompactionPartitionedWithBucketsSequenceFile() throws Exception
    {
        testMmMinorCompactionPartitionedWithBuckets("sequencefile");
    }

    @Test
    public void testMmMinorCompactionPartitionedWithBucketsRcFile() throws Exception
    {
        testMmMinorCompactionPartitionedWithBuckets("RcFile");
    }

    @Test
    public void testMmMinorCompactionPartitionedWithBucketsJsonFile() throws Exception
    {
    ...
    @Test
    public void testMultipleMmMinorCompactions() throws Exception
    {
        String dbName = "default";
        String tableName = "testMmMinorCompaction";
        // Create test table
        ...
        // Verify delta directories after compaction
        List<String> actualDeltasAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, null);
        Assert.assertEquals("Delta directories does not match after compaction", Collections.singletonList("delta_0000001_0000009_v0000028"), actualDeltasAfterComp);

    }

    @Test
    public void testMmMajorCompactionAfterMinor() throws Exception
    {
        String dbName = "default";
        String tableName = "testMmMinorCompaction";
        // Create test table
        ...
        verifySuccessulTxn(1);
        // Verify delta directories after compaction
        Assert.assertEquals("Delta directories does not match after minor compaction", Collections.singletonList("delta_0000001_0000003_v0000007"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, null));
        verifyAllContents(tableName, dataProvider, expectedData);
        ...
        Assert.assertEquals("Base directory does not match after major compaction", Collections.singletonList("base_0000006_v0000020"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, null));
        actualData = dataProvider.getAllData(tableName);
        Assert.assertEquals(expectedData, actualData);
    }

    @Test
    public void testMmMinorCompactionAfterMajor() throws Exception
    {
        String dbName = "default";
        String tableName = "testMmMinorCompaction";
        // Create test table
        ...
        verifySuccessulTxn(1);
        // Verify base directory after compaction
        Assert.assertEquals("Base directory does not match after major compaction", Collections.singletonList("base_0000003_v0000007"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, null));
        verifyAllContents(tableName, dataProvider, expectedData);
        // Insert test data into test table
        dataProvider.insertOnlyTestData(tableName);
        expectedData = dataProvider.getAllData(tableName);
        ...
        Assert.assertEquals("Base directory does not match after major compaction", Collections.singletonList("base_0000003_v0000007"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.baseFileFilter, table, null));
        Assert.assertEquals("Delta directories does not match after minor compaction", Collections.singletonList("delta_0000004_0000006_v0000017"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, null));
        verifyAllContents(tableName, dataProvider, expectedData);
    }

    @Test
    public void testMmMinorCompactionWithSchemaEvolutionAndBuckets() throws Exception
    {
        String dbName = "default";
        String tblName = "testMmMinorCompactionWithSchemaEvolutionAndBuckets";
        executeStatementOnDriver("drop table if exists " + tblName, driver);
        executeStatementOnDriver("create transactional table " + tblName + " (a int, b int) partitioned by(ds string) clustered by (a) into 2 buckets" + " stored as ORC TBLPROPERTIES('bucketing_version'='2', 'transactional'='true'," + " 'transactional_properties'='insert_only')", driver);
        // Insert some data
        ...
        CompactorTestUtil.runCompaction(conf, dbName, tblName, CompactionType.MINOR, true, "ds=yesterday", "ds=today");
        CompactorTestUtil.runCleaner(conf);
        verifySuccessulTxn(2);
    ...
    @Test
    public void testMmMinorCompactionWithSchemaEvolutionNoBucketsMultipleReducers() throws Exception
    {
        ...
        executeStatementOnDriver("drop table if exists " + tblName, driver);
        executeStatementOnDriver("create transactional table " + tblName + " (a int, b int) partitioned by(ds string)" + " stored as ORC TBLPROPERTIES('transactional'='true'," + " 'transactional_properties'='insert_only')", driver);
        // Insert some data
        executeStatementOnDriver("insert into " + tblName + " partition (ds) values" + "(1,2,'today'),(1,3,'today')," + "(1,4,'yesterday'),(2,2,'yesterday')," + "(2,3,'today'),(2,4,'today')", driver);
        // Add a new column
        executeStatementOnDriver("alter table " + tblName + " add columns(c int)", driver);
    ...
    @Test
    public void testMinorMmCompactionRemovesAbortedDirs() throws Exception
    { // see mmTableOpenWriteId
        String dbName = "default";
        String tableName = "testMmMinorCompaction";
        // Create test table
        TestDataProvider testDataProvider = new TestDataProvider();
        ...
        List<String> actualDeltasAfterComp = CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, null);
        Assert.assertEquals(Lists.newArrayList("delta_0000001_0000001_0000", "delta_0000002_0000002_0000", "delta_0000003_0000003_0000", "delta_0000004_0000004_0000", "delta_0000005_0000005_0000", "delta_0000006_0000006_0000"), actualDeltasAfterComp);
        ...
        verifySuccessulTxn(1);
        // Verify delta directories after compaction
        Assert.assertEquals("Delta directories does not match after minor compaction", Collections.singletonList("delta_0000001_0000009_v0000014"), CompactorTestUtil.getBaseOrDeltaNames(fs, AcidUtils.deltaFileFilter, table, null));
        verifyAllContents(tableName, testDataProvider, expectedData);
    }

    @Test
    public void testMmMajorCompactionDb() throws Exception
    {
        testMmCompactionDb(CompactionType.MAJOR, "base_0000003_v0000009");
    }

    @Test
    public void testMmMinorCompactionDb() throws Exception
    {
    ...
    {
        List<ShowCompactResponseElement> compacts = TxnUtils.getTxnStore(conf).showCompact(new ShowCompactRequest()).getCompacts();
        Assert.assertEquals("Completed compaction queue must contain one element", expectedCompleteCompacts, compacts.size());
        compacts.forEach(c -> Assert.assertEquals("Compaction state is not succeeded", "succeeded", c.getState()));
    }
     ...
     */
    private void verifyAllContents(String tblName, TestDataProvider dataProvider, List<String> expectedData) throws Exception
    {
    ...
    {
        return HiveConf.getVar(conf, HiveConf.ConfVars.HIVE_EXECUTION_ENGINE).equalsIgnoreCase(ExecutionMode.TEZ.name());
    }
}
