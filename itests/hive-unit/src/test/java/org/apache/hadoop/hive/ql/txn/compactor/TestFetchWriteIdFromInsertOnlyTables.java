...
public class TestFetchWriteIdFromInsertOnlyTables extends CompactorOnTezTest
{
    ...
    private static final List<String> EXPECTED_RESULT = Arrays.asList("0\t10\t10", "0\t1\t1", "0\t2\t20", "3\t2\t32", "3\t10\t15", "3\t42\t42");
    ...
    public void setup() throws Exception
    {
        ...
        executeStatementOnDriver("create table " + TABLE1 + "(a int, b int) " + "stored as orc TBLPROPERTIES ('transactional'='true', 'transactional_properties'='insert_only')", driver);
    ...
    public void testFetchWriteIdAfterCompaction() throws Exception
    {
        ...
        List<String> result = execSelectAndDumpData("SELECT t1.ROW__ID.writeId, a, b FROM " + TABLE1 + "('insertonly.fetch.bucketid'='true')", driver, "");
