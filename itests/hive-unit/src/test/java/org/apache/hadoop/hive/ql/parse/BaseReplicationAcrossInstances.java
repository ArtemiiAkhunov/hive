...
public class BaseReplicationAcrossInstances
{
    ...
    static void internalBeforeClassSetupExclusiveReplica(Map<String, String> primaryOverrides, Map<String, String> replicaOverrides, Class clazz) throws Exception
    {
        // Setup replica HDFS.
    ...
    public void setup() throws Throwable
    {
        ...
        primary.run("create database " + primaryDbName + " LOCATION '" + extLocation + "' MANAGEDLOCATION '" + mgdLocation + "' WITH DBPROPERTIES ( '" + SOURCE_OF_REPLICATION + "' = '1,2,3')");
    }
