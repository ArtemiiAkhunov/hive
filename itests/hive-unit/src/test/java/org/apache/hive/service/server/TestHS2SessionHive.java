...
public class TestHS2SessionHive
{
    ...
    public void testSessionHive() throws Exception
    {
        ...
        Task task1 = new Task("task1", client1.client, client2.sessionHandle), task2 = new Task("task2", client2.client, client1.sessionHandle);
    ...
    private class Task extends Thread
    {
        ...
        Task(String threadName, TCLIService.Iface client, TSessionHandle sessionHandle)
        {
            this.client = client;
    ...
    {
        Connection conn = DriverManager.getConnection(miniHS2.getJdbcURL(), System.getProperty("user.name"), "");
    ...
    public static void setupBeforeClass() throws Exception
    {
        ...
        try
        {
            ...
            MiniHS2.Builder builder = new MiniHS2.Builder().withConf(conf).withRemoteMetastore().cleanupLocalDirOnStartup(false);
        ...
        try (Connection conn = DriverManager.getConnection(miniHS2.getJdbcURL(), System.getProperty("user.name"), ""); Statement statement = conn.createStatement())
        {
