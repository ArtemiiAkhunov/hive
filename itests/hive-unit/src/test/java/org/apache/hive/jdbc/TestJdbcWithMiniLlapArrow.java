...
public class TestJdbcWithMiniLlapArrow extends BaseJdbcWithMiniLlap
{
    ...
    public static void beforeTest() throws Exception
    {
        ...
        conf.setVar(ConfVars.HIVE_AUTHORIZATION_SQL_STD_AUTH_CONFIG_WHITELIST_APPEND, ConfVars.HIVE_SUPPORT_CONCURRENCY.varname + "|" + ConfVars.HIVE_SERVER2_ENABLE_DOAS.varname);
    ...
    public void testKillQueryById() throws Exception
    {
        ...
        testKillQueryInternal(System.getProperty("user.name"), System.getProperty("user.name"), false, tExecuteHolder, tKillHolder);
