...
public class TestOperationLoggingAPIWithMr extends OperationLoggingAPITestBase
{
    ...
    public static void setUpBeforeClass() throws Exception
    {
        ...
        expectedLogsPerformance = new String[]{"<PERFLOG method=compile from=org.apache.hadoop.hive.ql.Driver>", "<PERFLOG method=parse from=org.apache.hadoop.hive.ql.Driver>", "<PERFLOG method=runTasks from=org.apache.hadoop.hive.ql.Driver>"};
