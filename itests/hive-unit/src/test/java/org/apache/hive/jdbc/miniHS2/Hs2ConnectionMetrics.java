...
public abstract class Hs2ConnectionMetrics
{
    ...
    public static void setup() throws Exception
    {
        ...
        confOverlay.put(HiveConf.ConfVars.SEMANTIC_ANALYZER_HOOK.varname, TestHs2Metrics.MetricCheckingHook.class.getName());
        confOverlay.put(HiveConf.ConfVars.HIVE_SERVER2_METRICS_ENABLED.varname, "true");

        miniHS2.start(confOverlay);
    }

    protected void verifyConnectionMetrics(String metricsJson, int expectedOpenConnections, int expectedCumulativeConnections) throws Exception
    {
        MetricsTestUtils.verifyMetricsJson(metricsJson, MetricsTestUtils.COUNTER, MetricsConstant.OPEN_CONNECTIONS, expectedOpenConnections);
        MetricsTestUtils.verifyMetricsJson(metricsJson, MetricsTestUtils.COUNTER, MetricsConstant.CUMULATIVE_CONNECTION_COUNT, expectedCumulativeConnections);
    }
