...
public class TestOperationLoggingAPIWithTez extends OperationLoggingAPITestBase
{
    ...
    public static void setUpBeforeClass() throws Exception
    {
        ...
        expectedLogsPerformance = new String[]{"<PERFLOG method=compile from=org.apache.hadoop.hive.ql.Driver>", "<PERFLOG method=parse from=org.apache.hadoop.hive.ql.Driver>", "from=org.apache.hadoop.hive.ql.exec.tez.monitoring.TezJobMonitor", "org.apache.tez.common.counters.DAGCounter", "NUM_SUCCEEDED_TASKS", "TOTAL_LAUNCHED_TASKS", "CPU_MILLISECONDS"};
