...
public class TestHiveDatabaseMetaData
{
    ...
    public void testHiveConnectionUdateServerHiveConf()
    {
        ...
        jdbcConnectionParams.getHiveConfs().put(Utils.JdbcConnectionParams.HIVE_CONF_PREFIX + "hive.server2.thrift.resultset.default.fetch.size", "1534");
        ...
        assertEquals("1534", jdbcConnectionParams.getHiveConfs().get(Utils.JdbcConnectionParams.HIVE_CONF_PREFIX + "hive.server2.thrift.resultset.default.fetch.size"));

        // Server configuration should be updated, since its not provided by the client.
        assertEquals("false", jdbcConnectionParams.getHiveConfs().get(Utils.JdbcConnectionParams.HIVE_CONF_PREFIX + "hive.default.nulls.last"));
