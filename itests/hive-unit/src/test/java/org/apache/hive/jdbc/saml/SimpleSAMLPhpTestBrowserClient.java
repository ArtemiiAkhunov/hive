...
public class SimpleSAMLPhpTestBrowserClient extends HiveJdbcBrowserClient
{
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SimpleSAMLPhpTestBrowserClient.class);

    public SimpleSAMLPhpTestBrowserClient(JdbcConnectionParams connectionParams, String username, String password, long tokenDelayMs) throws HiveJdbcBrowserException
    {
    ...
    public void doBrowserSSO() throws HiveJdbcBrowserException
    {
        ...
        {
            injectFailureCount--;
            throw new HiveJdbcBrowserException("This is a injected failure for testing purpose");
        }
        super.doBrowserSSO();
    }
