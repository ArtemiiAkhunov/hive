...
public class TestBeelineWithUserHs2ConnectionFile extends BeelineWithHS2ConnectionFileTestBase
{
    ...
    {
        Assume.assumeTrue(transportMode.equals(MiniHS2.HS2_HTTP_MODE) || transportMode.equalsIgnoreCase(MiniHS2.HS2_ALL_MODE));
        setupHttpHs2();
    ...
    {
        Assume.assumeTrue(transportMode.equals(MiniHS2.HS2_BINARY_MODE) || transportMode.equalsIgnoreCase(MiniHS2.HS2_ALL_MODE));
        setupNoAuthConfHS2();
