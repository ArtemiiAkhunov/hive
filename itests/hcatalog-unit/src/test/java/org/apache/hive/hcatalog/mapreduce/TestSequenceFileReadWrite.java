...
public class TestSequenceFileReadWrite
{
    ...
    public void testSequenceTableWriteReadMR() throws Exception
    {
        ...
        HCatOutputFormat.setOutput(job, OutputJobInfo.create(Warehouse.DEFAULT_DATABASE_NAME, "demo_table_2", null));
    ...
    public void testTextTableWriteReadMR() throws Exception
    {
        ...
        HCatOutputFormat.setOutput(job, OutputJobInfo.create(Warehouse.DEFAULT_DATABASE_NAME, "demo_table_3", null));
        job.setOutputFormatClass(HCatOutputFormat.class);
        HCatOutputFormat.setSchema(job, getSchema());
        assertTrue(job.waitForCompletion(true));
        if (!HCatUtil.isHadoop23())
