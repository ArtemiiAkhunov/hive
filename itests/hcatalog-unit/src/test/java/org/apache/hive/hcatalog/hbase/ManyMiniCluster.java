...
public class ManyMiniCluster
{
    ...
    private void setUpMetastore() throws Exception
    {
        ...
        hiveConf.set(HiveConf.ConfVars.METASTORE_CONNECT_URL_KEY.varname, "jdbc:derby:" + new File(workDir + "/metastore_db") + ";create=true");
        hiveConf.set(HiveConf.ConfVars.METASTORE_WAREHOUSE.toString(), new File(workDir, "warehouse").toString());
