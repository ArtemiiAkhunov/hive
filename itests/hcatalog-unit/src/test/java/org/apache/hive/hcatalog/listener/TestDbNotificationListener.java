...
public class TestDbNotificationListener
{
    ...
    private void testEventCounts(String dbName, long fromEventId, Long toEventId, Integer limit, long expectedCount) throws Exception
    {
    ...
    public void exchangePartition() throws Exception
    {
        ...
        Table tab2 = new Table("tab2", dbName, "me", startTime, startTime, 0, sd2, partCols, emptyParameters, null, null, null); // add_table
