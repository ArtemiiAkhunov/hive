...
{
    private static final TableClass TWO_COLUMN_TABLE = new TableClass("type1", Arrays.asList(new ColumnDefinition("col1", ColumnType.parse("STRING")), new ColumnDefinition("col2", ColumnType.parse("NUMBER"))), true);
