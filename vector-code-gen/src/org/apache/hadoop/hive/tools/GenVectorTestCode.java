...
public class GenVectorTestCode
{
    ...
    public void addColumnScalarOperationCheckedTestCases(boolean op1IsCol, String vectorExpClassName, String inputColumnVectorType, String outputColumnVectorType, String scalarType, boolean isReturnTypeLong) throws IOException
    {
        ...
        for (String outputTypeInfo : outputTypeInfos)
        {
            for (Boolean[] testMatrix : new Boolean[][]{
                    ...
                    {false, true, true, true}, {false, false, false, false}, {true, false, true, false}, {true, true, false, false}, {true, false, false, true}})
            {
                String testCase = templateString;
                testCase = testCase.replaceAll("<TestName>", "test" + vectorExpClassName + createNullRepeatingNameFragment("Out", testMatrix[0], testMatrix[1]) + createNullRepeatingNameFragment("Col", testMatrix[2], testMatrix[3]) + createOutputTypeInfoFragment("Ret", outputTypeInfo));
    ...
    public void addColumnColumnOperationCheckedTestCases(String vectorExpClassName, String inputColumnVectorType1, String inputColumnVectorType2, String outputColumnVectorType, boolean isReturnTypeLong) throws IOException
    {
        ...
        for (String outputTypeInfo : outputTypeInfos)
        {
            for (Boolean[] testMatrix : new Boolean[][]{
                    ...
                    {true, true, false, true, true, true}, {false, false, true, false, false, false}, {true, false, true, false, true, true}, {true, true, true, true, false, false}, {false, false, false, true, true, false}, {false, true, false, false, false, true}})
            {
                String testCase = templateString;
                testCase = testCase.replaceAll("<TestName>", "test" + vectorExpClassName + createNullRepeatingNameFragment("Out", testMatrix[0], testMatrix[1]) + createNullRepeatingNameFragment("C1", testMatrix[2], testMatrix[3]) + createNullRepeatingNameFragment("C2", testMatrix[4], testMatrix[5]) + createOutputTypeInfoFragment("Ret", outputTypeInfo));
                testCase = testCase.replaceAll("<VectorExpClassName>", vectorExpClassName);
    ...
    public void addColumnColumnOperationTestCases(String vectorExpClassName, String inputColumnVectorType1, String inputColumnVectorType2, String outputColumnVectorType) throws IOException
    {
        ...
        {
            String testCase = templateString;
            testCase = testCase.replaceAll("<TestName>", "test" + vectorExpClassName + createNullRepeatingNameFragment("Out", testMatrix[0], testMatrix[1]) + createNullRepeatingNameFragment("C1", testMatrix[2], testMatrix[3]) + createNullRepeatingNameFragment("C2", testMatrix[4], testMatrix[5]));
            testCase = testCase.replaceAll("<VectorExpClassName>", vectorExpClassName);
            testCase = testCase.replaceAll("<InputColumnVectorType1>", inputColumnVectorType1);
            testCase = testCase.replaceAll("<InputColumnVectorType2>", inputColumnVectorType2);
            testCase = testCase.replaceAll("<OutputColumnVectorType>", outputColumnVectorType);
