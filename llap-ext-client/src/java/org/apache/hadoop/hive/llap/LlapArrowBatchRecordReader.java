...
public class LlapArrowBatchRecordReader extends LlapBaseRecordReader<ArrowWrapperWritable>
{
    ...
    public LlapArrowBatchRecordReader(InputStream in, Schema schema, Class<ArrowWrapperWritable> clazz, JobConf job, Closeable client, Socket socket, BufferAllocator allocator) throws IOException
    {
    ...
    {
        this(in, schema, clazz, job, client, socket, RootAllocatorFactory.INSTANCE.getOrCreateRootAllocator(arrowAllocatorLimit));
    }
