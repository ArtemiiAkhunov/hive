...
public class TestBeelineSiteParser
{
    ...
    public void testConfigLocationPathInEtc() throws Exception
    {
        ...
        Assert.assertTrue(locs.contains(BeelineSiteParser.ETC_HIVE_CONF_LOCATION + File.separator + BeelineSiteParser.DEFAULT_BEELINE_SITE_FILE_NAME));
    ...
    public void testConnectionURLWithVarSubsitition() throws Exception
    {
        ...
        Assert.assertEquals("jdbc:hive2://zkhost1:2181,zkhost2:2181,zkhost3:2181/;" + "serviceDiscoveryMode=zooKeeper;zooKeeperNamespace=hiveserver2?tez.queue.name=myqueue", properties.get("test"));
        ;
    }
