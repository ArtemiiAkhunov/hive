...
public interface DatabaseAccessor extends AutoCloseable
{
    ...
    JdbcRecordIterator getRecordIterator(Configuration conf, String partitionColumn, String lowerBound, String upperBound, int limit, int offset) throws HiveJdbcDatabaseAccessException;

    RecordWriter getRecordWriter(TaskAttemptContext context) throws IOException;

    Pair<String, String> getBounds(Configuration conf, String partitionColumn, boolean lower, boolean upper) throws HiveJdbcDatabaseAccessException;
