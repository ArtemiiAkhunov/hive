...
public class JdbcStorageHandler implements HiveStorageHandler
{
    ...
    public URI getURIForAuth(Table table) throws URISyntaxException
    {
        ...
        DatabaseType dbType = DatabaseType.valueOf(tableProperties.get(JdbcStorageConfig.DATABASE_TYPE.getPropertyName()));
        String host_url = DatabaseType.METASTORE == dbType ? "jdbc:metastore://" : tableProperties.get(Constants.JDBC_URL);
