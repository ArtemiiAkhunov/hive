...
INSERT INTO test_strategy (strategy_id, name, referrer, landing, priority, implementation, last_modified)
...
(
    ...
    big_col BIGINT,
    numeric_col NUMERIC,
    numeric_with_prec_scale_col NUMERIC
(
    9,
    3
),
