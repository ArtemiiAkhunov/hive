...
public class TestGenericJdbcDatabaseAccessor
{
    ...
    public void testGetColumnNames_invalidQuery() throws HiveJdbcDatabaseAccessException
    {
        ...
        DatabaseAccessor accessor = DatabaseAccessorFactory.getAccessor(conf);
        @SuppressWarnings("unused") List<String> columnNames = accessor.getColumnNames(conf);
    }
    ...
    public void testGetTotalNumberOfRecords_invalidQuery() throws HiveJdbcDatabaseAccessException
    {
        ...
        DatabaseAccessor accessor = DatabaseAccessorFactory.getAccessor(conf);
        @SuppressWarnings("unused") int numRecords = accessor.getTotalNumberOfRecords(conf);
    }
    ...
    public void testGetRecordIterator_invalidQuery() throws HiveJdbcDatabaseAccessException
    {
        ...
        DatabaseAccessor accessor = DatabaseAccessorFactory.getAccessor(conf);
        @SuppressWarnings("unused") JdbcRecordIterator iterator = accessor.getRecordIterator(conf, null, null, null, 0, 2);
    }


    private Configuration buildConfiguration()
    {
        String scriptPath = TestGenericJdbcDatabaseAccessor.class.getClassLoader().getResource("test_script.sql").getPath();
        ...
        config.set(JdbcStorageConfig.JDBC_URL.getPropertyName(), "jdbc:h2:mem:test;MODE=MySQL;INIT=runscript from '" + scriptPath + "'");
