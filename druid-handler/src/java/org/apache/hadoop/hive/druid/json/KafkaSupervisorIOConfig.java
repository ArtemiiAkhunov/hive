...
public class KafkaSupervisorIOConfig
{
    ...
    {
        return "KafkaSupervisorIOConfig{" + "topic='" + topic + '\'' + ", replicas=" + replicas + ", taskCount=" + taskCount + ", taskDuration=" + taskDuration + ", consumerProperties=" + consumerProperties + ", startDelay=" + startDelay + ", period=" + period + ", useEarliestOffset=" + useEarliestOffset + ", completionTimeout=" + completionTimeout + ", lateMessageRejectionPeriod=" + lateMessageRejectionPeriod + ", skipOffsetGaps=" + skipOffsetGaps + '}';
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (consumerProperties != null ? !consumerProperties.equals(that.consumerProperties) : that.consumerProperties != null)
        {
            return false;
        }
        ...
        if (completionTimeout != null ? !completionTimeout.equals(that.completionTimeout) : that.completionTimeout != null)
        {
            return false;
        }
        if (lateMessageRejectionPeriod.isPresent() ? !lateMessageRejectionPeriod.equals(that.lateMessageRejectionPeriod) : that.lateMessageRejectionPeriod.isPresent())
        {
            return false;
        }
        return earlyMessageRejectionPeriod.isPresent() ? earlyMessageRejectionPeriod.equals(that.earlyMessageRejectionPeriod) : !that.earlyMessageRejectionPeriod.isPresent();
    }
