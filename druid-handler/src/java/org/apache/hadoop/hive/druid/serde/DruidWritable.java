...
public class DruidWritable implements Writable
{
    ...
    public boolean equals(Object o)
    {
        ...
        return compacted == that.compacted && Objects.equals(value, that.value) && Objects.equals(compactedValue, that.compactedValue);
    }

    @Override
    public String toString()
    {
        return "DruidWritable{" + "value=" + value + ", compactedValue=" + compactedValue + ", compacted=" + compacted + '}';
    }
}
