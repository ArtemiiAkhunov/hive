...
public class DruidStorageHandlerInfo implements StorageHandlerInfo
{
    ...
    static final StorageHandlerInfo UNREACHABLE = (StorageHandlerInfo) () -> "Druid Overlord is Unreachable, Runtime Status : unknown";
    ...
    public String formatAsText()
    {
        ...
        sb.append("Druid Storage Handler Runtime Status for ").append(kafkaSupervisorReport.getId()).append("\n").append("kafkaPartitions=").append(kafkaSupervisorReport.getPayload().getPartitions()).append("\n").append("activeTasks=").append(kafkaSupervisorReport.getPayload().getActiveTasks()).append("\n").append("publishingTasks=").append(kafkaSupervisorReport.getPayload().getPublishingTasks());
