...
public class TestLazyArrayMapStruct
{
        ...
        {
            {
                ...
                oi = LazyFactory.createLazyStructInspector(Arrays.asList(new String[]{"a", "b", "c", "d"}), fieldTypeInfos, new byte[]{' ', ':', '='}, nullSequence, true, false, (byte) 0);
    ...
    {
        checkNotExtendedLimitExceeded(DEFAULT_LEVEL_THRESHOLD, ObjectInspector.Category.LIST);
    }
    ...
    {
        checkNotExtendedLimitExceeded(DEFAULT_LEVEL_THRESHOLD - 1, ObjectInspector.Category.MAP);
    }
    ...
    {
        checkNotExtendedLimitExceeded(DEFAULT_LEVEL_THRESHOLD, ObjectInspector.Category.STRUCT);
    }
    ...
    {
        checkNotExtendedLimitExceeded(DEFAULT_LEVEL_THRESHOLD, ObjectInspector.Category.UNION);
    }
     ...
     */
    private void testNestedinArrayAtLevelExtended(int nestingLevel, ObjectInspector.Category dtype) throws SerDeException
    {
