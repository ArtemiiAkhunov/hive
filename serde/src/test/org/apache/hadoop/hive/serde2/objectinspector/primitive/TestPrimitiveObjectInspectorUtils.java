...
public class TestPrimitiveObjectInspectorUtils
{
    ...
    public void testGetTimestampFromString()
    {
        ...
        assertEquals("2015-02-07 00:00:00.000", udfDateFormat.format(PrimitiveObjectInspectorUtils.getTimestampFromString("2015-02-07").toSqlTimestamp()));
    }
    ...
    public void testGetBoolean()
    {
        ...
        {
            assertFalse(falseStr, PrimitiveObjectInspectorUtils.getBoolean(falseStr, PrimitiveObjectInspectorFactory.javaStringObjectInspector));
        ...
        {
            assertTrue(trueStr, PrimitiveObjectInspectorUtils.getBoolean(trueStr, PrimitiveObjectInspectorFactory.javaStringObjectInspector));
    ...
    public void testDecimalToString()
    {
        ...
        PrimitiveObjectInspector decOI_7_0 = PrimitiveObjectInspectorFactory.getPrimitiveJavaObjectInspector(new DecimalTypeInfo(7, 0));
        PrimitiveObjectInspector decOI_7_1 = PrimitiveObjectInspectorFactory.getPrimitiveJavaObjectInspector(new DecimalTypeInfo(7, 1));
        PrimitiveObjectInspector decOI_7_3 = PrimitiveObjectInspectorFactory.getPrimitiveJavaObjectInspector(new DecimalTypeInfo(7, 3));
