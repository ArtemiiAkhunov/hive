...
public class MyTestPrimitiveClass
{
    ...
    public static HiveIntervalYearMonth getRandIntervalYearMonth(Random r)
    {
        ...
        String intervalYearMonthStr = String.format("%s%d-%d", yearMonthSignStr, Integer.valueOf(1800 + r.nextInt(500)),  // year
    ...
    public static HiveIntervalDayTime getRandIntervalDayTime(Random r)
    {
        ...
        String yearMonthSignStr = r.nextInt(2) == 0 ? "" : "-";
        String dayTimeStr = String.format("%s%d %02d:%02d:%02d%s", yearMonthSignStr, Integer.valueOf(1 + r.nextInt(28)),      // day
