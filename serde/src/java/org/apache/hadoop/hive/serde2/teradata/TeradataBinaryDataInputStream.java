...
public class TeradataBinaryDataInputStream extends SwappedDataInputStream
{
    ...
    public String readVarchar() throws IOException
    {
        ...
        {
            throw new EOFException(format("Fail to read the varchar. Expect %d bytes, get %d bytes", varcharLength, numOfBytesRead));
        }
    ...
    public Timestamp readTimestamp(Integer byteNum) throws IOException
    {
        ...
        {
            throw new EOFException(format("Fail to read the timestamp. Expect %d bytes, get %d bytes", byteNum, numOfBytesRead));
        }
    ...
    public String readChar(int totalLength) throws IOException
    {
        ...
        {
            throw new EOFException(format("Fail to read the varchar. Expect %d bytes, get %d bytes", totalLength, numOfBytesRead));
        }
    ...
    public HiveDecimal readDecimal(int scale, int byteNum) throws IOException
    {
        ...
        {
            throw new EOFException(format("Fail to read the decimal. Expect %d bytes, get %d bytes", byteNum, numOfBytesRead));
        }
    ...
    public byte[] readVarbyte() throws IOException
    {
        ...
        {
            throw new EOFException(format("Fail to read the varbyte. Expect %d bytes, get %d bytes", varbyteLength, numOfBytesRead));
        }
