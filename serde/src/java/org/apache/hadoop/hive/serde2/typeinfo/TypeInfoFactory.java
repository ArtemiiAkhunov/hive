...
public final class TypeInfoFactory
{
     ...
     */
    public static final DecimalTypeInfo decimalTypeInfo = new DecimalTypeInfo(HiveDecimal.SYSTEM_DEFAULT_PRECISION, HiveDecimal.SYSTEM_DEFAULT_SCALE);

    /**
     * A TimestampTZTypeInfo with system default time zone.
     */
    public static final TimestampLocalTZTypeInfo timestampLocalTZTypeInfo = new TimestampLocalTZTypeInfo(ZoneId.systemDefault().getId());
    ...
    // instance.
    private static ConcurrentHashMap<String, PrimitiveTypeInfo> cachedPrimitiveTypeInfo = new ConcurrentHashMap<String, PrimitiveTypeInfo>();
