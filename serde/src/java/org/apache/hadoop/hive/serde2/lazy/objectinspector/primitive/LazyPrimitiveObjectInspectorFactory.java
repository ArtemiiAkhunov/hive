...
public final class LazyPrimitiveObjectInspectorFactory
{
    ...
    private static ConcurrentHashMap<ArrayList<Object>, AbstractPrimitiveLazyObjectInspector<?>> cachedLazyStringTypeOIs = new ConcurrentHashMap<ArrayList<Object>, AbstractPrimitiveLazyObjectInspector<?>>();

    private static ConcurrentHashMap<PrimitiveTypeInfo, AbstractPrimitiveLazyObjectInspector<?>> cachedPrimitiveLazyObjectInspectors = new ConcurrentHashMap<PrimitiveTypeInfo, AbstractPrimitiveLazyObjectInspector<?>>();
    ...
    public static AbstractPrimitiveLazyObjectInspector<?> getLazyObjectInspector(PrimitiveTypeInfo typeInfo)
    {
        ...
        switch (typeInfo.getPrimitiveCategory())
        {
            ...
            case DECIMAL:
                ...
                break;
            default:
                throw new RuntimeException("Primitive type " + typeInfo.getPrimitiveCategory() + " should not take parameters");
        }
