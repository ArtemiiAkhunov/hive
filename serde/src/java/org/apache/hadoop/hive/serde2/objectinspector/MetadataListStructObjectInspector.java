...
public class MetadataListStructObjectInspector extends StandardStructObjectInspector
{
    ...
    public static MetadataListStructObjectInspector getInstance(List<String> columnNames, List<String> columnComments)
    {
    ...
    {
        return Collections.nCopies(fields, PrimitiveObjectInspectorFactory.getPrimitiveJavaObjectInspector(PrimitiveCategory.STRING));
    }
    ...
    public MetadataListStructObjectInspector(List<String> columnNames, List<String> columnComments)
    {
