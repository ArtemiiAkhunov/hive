...
public final class LazyFactory
{
     ...
     * @param separatorIndex The current level (for separators). List(array), struct uses 1
     ...
     */
    @Deprecated
    public static ObjectInspector createLazyObjectInspector(TypeInfo typeInfo, byte[] separators, int separatorIndex, Text nullSequence, boolean escaped, byte escapeChar, ObjectInspectorOptions option) throws SerDeException
    {
    ...
    {
        return createLazyObjectInspector(typeInfo, separators, separatorIndex, nullSequence, escaped, escapeChar, false, ObjectInspectorOptions.JAVA);
    }
    ...
    {
        return createLazyObjectInspector(typeInfo, separators, separatorIndex, nullSequence, escaped, escapeChar, extendedBooleanLiteral, ObjectInspectorOptions.JAVA);
    }
     ...
     */
    @Deprecated
    public static ObjectInspector createLazyObjectInspector(TypeInfo typeInfo, byte[] separators, int separatorIndex, Text nullSequence, boolean escaped, byte escapeChar, boolean extendedBooleanLiteral, ObjectInspectorOptions option) throws SerDeException
    {
    ...
    public static ObjectInspector createColumnarStructInspector(List<String> columnNames, List<TypeInfo> columnTypes, LazyObjectInspectorParameters lazyParams) throws SerDeException
    {
        ...
        {
            columnObjectInspectors.add(LazyFactory.createLazyObjectInspector(columnTypes.get(i), 1, lazyParams, ObjectInspectorOptions.JAVA));
        }
