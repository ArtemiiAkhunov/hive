...
public class BaseCharUtils
{
    ...
    public static void validateVarcharParameter(int length)
    {
        ...
        {
            throw new RuntimeException("Varchar length " + length + " out of allowed range [1, " + HiveVarchar.MAX_VARCHAR_LENGTH + "]");
        }
    }
    ...
    public static void validateCharParameter(int length)
    {
        ...
        {
            throw new RuntimeException("Char length " + length + " out of allowed range [1, " + HiveChar.MAX_CHAR_LENGTH + "]");
        }
    }
