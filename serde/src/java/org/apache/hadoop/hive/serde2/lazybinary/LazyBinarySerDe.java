...
public class LazyBinarySerDe extends AbstractSerDe
{
    ...
    public static void serializeStruct(RandomAccessOutput byteStream, Object[] fieldData, List<ObjectInspector> fieldOis) throws SerDeException
    {
     ...
     * @param fieldData            the struct object to serialize
     * @param fieldOis             the struct object inspector
     ...
     */
    private static void serializeStruct(RandomAccessOutput byteStream, Object[] fieldData, List<ObjectInspector> fieldOis, BooleanRef warnedOnceNullMapKey) throws SerDeException
    {
    ...
    private static void serializeUnion(RandomAccessOutput byteStream, Object obj, UnionObjectInspector uoi, BooleanRef warnedOnceNullMapKey) throws SerDeException
    {
    ...
    protected static void serializeText(RandomAccessOutput byteStream, Text t, boolean skipLengthPrefix)
    {
    ...
    public static void writeDateToByteStream(RandomAccessOutput byteStream, DateWritableV2 date)
    {
    ...
    public static void writeToByteStream(RandomAccessOutput byteStream, HiveDecimalWritable decWritable)
    {
     ...
     */
    public static void writeToByteStream(RandomAccessOutput byteStream, HiveDecimal dec, long[] scratchLongs, byte[] scratchBytes, byte[] scratchLongBytes)
    {
     ...
     * @param scratchBytes
     */
    public static void writeToByteStream(RandomAccessOutput byteStream, HiveDecimalWritable decWritable, long[] scratchLongs, byte[] scratchBytes)
    {
        LazyBinaryUtils.writeVInt(byteStream, decWritable.scale());
    ...
    public static void writeToByteStream(RandomAccessOutput byteStream, HiveDecimalWritable decWritable, long[] scratchLongs, byte[] scratchBytes, byte[] scratchLongBytes)
    {
    ...
    protected static void writeSizeAtOffset(RandomAccessOutput byteStream, int byteSizeStart, int size)
    {
