...
public final class ObjectInspectorUtils
{
    ...
    public static Object copyToStandardObject(Object o, ObjectInspector oi, ObjectInspectorCopyOption objectInspectorOption)
    {
        ...
        switch (oi.getCategory())
        {
            case PRIMITIVE:
            {
                ...
                switch (objectInspectorOption)
                {
                    case JAVA:
                        ...
                        } else if (loi.getPrimitiveCategory() == PrimitiveObjectInspector.PrimitiveCategory.TIMESTAMPLOCALTZ)
                        {
                            result = PrimitiveObjectInspectorFactory.javaTimestampTZObjectInspector.copyObject(result);
                        }
                        break;
                    case WRITABLE:
            ...
            case UNION:
            {
                ...
                Object object = copyToStandardObject(uoi.getField(o), objectInspectors.get(tag), objectInspectorOption);
    ...
    public static int getBucketHashCode(Object[] bucketFields, ObjectInspector[] bucketFieldInspectors)
    {
        ...
        for (int i = 0; i < bucketFields.length; i++)
        {
            int fieldHash = ObjectInspectorUtils.hashCodeMurmur(bucketFields[i], bucketFieldInspectors[i], b);
            hashCode = 31 * hashCode + fieldHash;
        }
        return hashCode;
    }
    ...
    public static int compare(Object[] o1, ObjectInspector[] oi1, Object[] o2, ObjectInspector[] oi2, boolean[] columnSortOrderIsDesc, NullValueOption[] nullSortOrder)
    {
        assert (o1.length == oi1.length);
        assert (o2.length == oi2.length);
        assert (o1.length == o2.length);
    ...
    public static int compare(Object o1, ObjectInspector oi1, Object o2, ObjectInspector oi2, MapEqualComparer mapEqualComparer, NullValueOption nullValueOpt)
    {
        ...
        switch (oi1.getCategory())
        {
            ...
            case STRUCT:
            {
                ...
                Object data1 = soi1 instanceof ConstantObjectInspector ? ((ConstantObjectInspector) soi1).getWritableConstantValue() : o1;
                Object data2 = soi2 instanceof ConstantObjectInspector ? ((ConstantObjectInspector) soi2).getWritableConstantValue() : o2;
                for (int i = 0; i < minimum; i++)
                {
                    int r = compare(soi1.getStructFieldData(data1, fields1.get(i)), fields1.get(i).getFieldObjectInspector(), soi2.getStructFieldData(data2, fields2.get(i)), fields2.get(i).getFieldObjectInspector(), mapEqualComparer, nullValueOpt);
                    if (r != 0)
                    {
                        return r;
                    }
    ...
    public static String getTypeNameFromJavaClass(Type t)
    {
        try
        {
            ObjectInspector oi = ObjectInspectorFactory.getReflectionObjectInspector(t, ObjectInspectorOptions.JAVA);
    ...
    private static boolean setOISettablePropertiesMap(ObjectInspector oi, Map<ObjectInspector, Boolean> oiSettableProperties, boolean value)
    {
