...
public class PrimitiveObjectInspectorConverter
{
    ...
    public static class TimestampConverter implements Converter
    {
        ...
        public Object convert(Object input)
        {
            ...
            return outputOI.set(r, PrimitiveObjectInspectorUtils.getTimestamp(input, inputOI, intToTimestampInSeconds));
        }
    }
    ...
    public static class HiveVarcharConverter implements Converter
    {
        ...
        public Object convert(Object input)
        {
            ...
            {
                case BOOLEAN:
                    return outputOI.set(hc, ((BooleanObjectInspector) inputOI).get(input) ? new HiveVarchar("TRUE", -1) : new HiveVarchar("FALSE", -1));
                default:
    ...
    public static class HiveCharConverter implements Converter
    {
        ...
        public Object convert(Object input)
        {
            ...
            {
                case BOOLEAN:
                    return outputOI.set(hc, ((BooleanObjectInspector) inputOI).get(input) ? new HiveChar("TRUE", -1) : new HiveChar("FALSE", -1));
                default:
