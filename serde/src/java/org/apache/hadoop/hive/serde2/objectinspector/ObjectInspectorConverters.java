    ...
    private static Converter getConverter(PrimitiveObjectInspector inputOI, PrimitiveObjectInspector outputOI)
    {
        switch (outputOI.getPrimitiveCategory())
        {
            case VOID:
                ...
                {
                    throw new RuntimeException("Hive internal error: conversion of " + inputOI.getTypeName() + " to void not possible.");
                }
            ...
            case TIMESTAMPLOCALTZ:
                return new PrimitiveObjectInspectorConverter.TimestampLocalTZConverter(inputOI, (SettableTimestampLocalTZObjectInspector) outputOI);
