...
public final class LazyBinaryUtils
{
    ...
    public static void writeVInt(RandomAccessOutput byteStream, int i, byte[] scratchBytes)
    {
    ...
    public static void writeVLong(RandomAccessOutput byteStream, long l, byte[] scratchBytes)
    {
