...
public class TeradataBinaryDataOutputStream extends ByteArrayOutputStream
{
    ...
    public void writeChar(HiveCharWritable writable, int length) throws IOException
    {
        ...
        {
            throw new IOException(format("The byte num %s of HiveCharWritable is more than the byte num %s we can hold. " + "The content of HiveCharWritable is %s", contentLength, length, writable.getPaddedValue()));
        }
