...
public class HttpServer
{
    ...
    static final String STRICT_TRANSPORT_SECURITY = "Strict-Transport-Security:max-age=31536000; includeSubDomains";
    ...
    Connector createChannelConnector(int queueSize, Builder b)
    {
        ...
        } else
        {
            ...
            {
                Set<String> excludeCS = Sets.newHashSet(Splitter.on(",").trimResults().omitEmptyStrings().split(b.excludeCiphersuites.trim()));
