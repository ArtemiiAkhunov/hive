...
public class CopyOnFirstWriteProperties extends Properties
{
    ...
    public String getProperty(String key)
    {
        if (interned != null)
        {
            return interned.getProperty(key);
        } else
        {
    ...
    public String getProperty(String key, String defaultValue)
    {
        if (interned != null)
        {
            return interned.getProperty(key, defaultValue);
        } else
        {
    ...
    public void storeToXML(OutputStream os, String comment) throws IOException
    {
        if (interned != null)
        {
            interned.storeToXML(os, comment);
        } else
        {
    ...
    public void storeToXML(OutputStream os, String comment, String encoding) throws IOException
    {
        if (interned != null)
        {
            interned.storeToXML(os, comment, encoding);
        } else
        {
    ...
    public Set<String> stringPropertyNames()
    {
        if (interned != null)
        {
            return interned.stringPropertyNames();
        } else
        {
    ...
    public synchronized Object clone()
    {
        if (interned != null)
        {
            return new CopyOnFirstWriteProperties(interned);
        } else
        {
            return super.clone();
        }
    ...
    public synchronized Object compute(Object key, BiFunction remappingFunction)
    {
        if (interned != null)
        {
            copyFromInternedToThis();  // We do this because if function returns null,
        }
    ...
    public synchronized boolean contains(Object value)
    {
        if (interned != null)
        {
            return interned.contains(value);
        } else
        {
    ...
    public synchronized boolean containsKey(Object key)
    {
        if (interned != null)
        {
            return interned.containsKey(key);
        } else
        {
    ...
    public synchronized boolean containsValue(Object value)
    {
        if (interned != null)
        {
            return interned.containsValue(value);
        } else
        {
    ...
    public synchronized Object getOrDefault(Object key, Object defaultValue)
    {
        if (interned != null)
        {
            return interned.getOrDefault(key, defaultValue);
        } else
        {
