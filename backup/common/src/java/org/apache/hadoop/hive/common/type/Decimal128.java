...
public final class Decimal128 extends Number implements Comparable<Decimal128>
{
     ...
     */
    public static final Decimal128 MAX_VALUE = new Decimal128(UnsignedInt128.TEN_TO_THIRTYEIGHT, (short) 0, false).subtractDestructive(Decimal128.ONE, (short) 0);

    /**
     * Minimum value that can be represented in this class.
     */
    public static final Decimal128 MIN_VALUE = new Decimal128(UnsignedInt128.TEN_TO_THIRTYEIGHT, (short) 0, true).addDestructive(Decimal128.ONE, (short) 0);
     ...
     *
     * @param precision precision (0-38)
     ...
     * </p>
     *
     * @param val   {@code double} value to be converted to {@code Decimal128}.
     * @param scale scale of the {@code Decimal128}.
     */
     ...
     *
     * @param unscaledVal unscaled value of the {@code Decimal128}.
     * @param scale       scale of the {@code Decimal128}.
     ...
     *
     * @param val {@code long} value to be converted to {@code Decimal128}.
     */
     ...
     *
     * @param val {@code long} value to be set to {@code Decimal128}.
     */
     ...
     *
     * @param buf       ByteBuffer to read values from
     * @param precision 0 to 38. Decimal digits.
     */
     ...
     * @param offset    offset of the long array
     * @param precision 0 to 38. Decimal digits.
     */
     ...
     * @param offset offset of the int array
     */
     ...
     *
     * @param bigDecimal {@link java.math.BigDecimal}
     */
     ...
     *
     * @param bigInt {@link java.math.BigInteger}
     * @param scale
     */
     ...
     *
     * @param array     array to write values to
     * @param offset    offset of the int array
     * @param precision 0 to 38. Decimal digits.
     */
     ...
     *
     * @param buf       ByteBuffer to write values to
     * @param precision 0 to 38. Decimal digits.
     */
     ...
     * @param scale  scale of the result. must be 0 or positive.
     * @param result object to receive the calculation result
     */
     ...
     * value.
     *
     * @param right    right operand. this object is not modified.
     * @param newScale scale of the result. must be 0 or positive.
     */
     ...
     * @param left     left operand
     * @param right    right operand
     * @param quotient result object to receive the calculation result
     * @param scale    scale of the result. must be 0 or positive.
     */
     ...
     * </p>
     *
     * @param n power to raise this object. Unlike
     ...
     *
     * @param val {@code Decimal128} to which this {@code Decimal128} is to be
     *            compared.
     ...
     *
     * @param x {@code Object} to which this {@code Decimal128} is to be compared.
     ...
     *
     * @param precision maximum precision
     */
    ...
    {
        return toFormalString() + "(Decimal128: scale=" + scale + ", signum=" + signum + ", BigDecimal.toString=" + toBigDecimal().toString() + ", unscaledValue=[" + unscaledValue.toString() + "])";
    }
