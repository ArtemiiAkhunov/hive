...
public final class UnsignedInt128 implements Comparable<UnsignedInt128>, Serializable
{
     ...
     */
    public static final UnsignedInt128 MAX_VALUE = new UnsignedInt128(0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
     ...
     */
    public static final UnsignedInt128 TEN_TO_THIRTYEIGHT = new UnsignedInt128(0, 0x98a2240, 0x5a86c47a, 0x4b3b4ca8);
     ...
     * @param tenScale power of 10 to scale up (if positive) or down (if negative) the
     *                 given object.
     * @return a negative integer, zero, or a positive integer as this object is
     * less than, equal to, or greater than the specified object.
     */
    ...
    public int hashCode()
    {
        ...
        return (v[0] * 0x2AB19E23) + (v[1] * 0x4918EACB) + (v[2] * 0xF03051A7) + v[3];
    }
    ...
    public void subtractDestructive(int[] r)
    {
        ...
        for (int i = 0; i < INT_COUNT; ++i)
        {
            sum = (this.v[i] & SqlMathUtil.LONG_MASK) - (r[i] & SqlMathUtil.LONG_MASK) - ((int) -(sum >> 32));
            this.v[i] = (int) sum;
        }
        updateCount();
     ...
     * @param result the object to receive the result. can be same object as left or
     *               right.
     ...
     * </p>
     *
     * @param array    array to scale down. in AND out. length must be 8.
     * @param tenScale distance to scale down
     */
     ...
     *
     * @param array     array to scale down
     * @param fiveScale distance to scale down
     ...
     * semantics).
     *
     * @param rightShifts distance of right-shifts
     */
    ...
    public byte fastUpdateFromInternalStorage(byte[] internalStorage)
    {
        ...
        } else
        {
            ...
            {
                case 16:
                    ++intLength; //intentional fall through
                case 15:
                    ++intLength;
                case 14:
                    ++intLength;
