...
public final class SignedInt128 extends Number implements Comparable<SignedInt128>
{
     ...
     */
    public static final SignedInt128 MAX_VALUE = new SignedInt128(0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x7FFFFFFF);

    /**
     * Minimum value that can be represented in this class.
     */
    public static final SignedInt128 MIN_VALUE = new SignedInt128(0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
     ...
     * int/uint in C++.
     *
     * @param mag UnsignedInt128 object
     */
    public SignedInt128(UnsignedInt128 mag)
    {
        this.negative = mag.getV3() < 0;
        this.mag = new UnsignedInt128(mag.getV0(), mag.getV1(), mag.getV2(), mag.getV3() & SqlMathUtil.FULLBITS_31);
    }
    ...
    {
        update128(array[offset], array[offset + 1], array[offset + 2], array[offset + 3]);
    }
    ...
    public void serializeTo128(int[] array, int offset)
    {
        ...
        array[offset + 3] = this.mag.getV3() | (this.negative ? SqlMathUtil.NEGATIVE_INT_MASK : 0);
    }
    ...
    public void serializeTo64(int[] array, int offset)
    {
        ...
        array[offset] = this.mag.getV0();
        array[offset + 1] = this.mag.getV1() | (this.negative ? SqlMathUtil.NEGATIVE_INT_MASK : 0);
    }
    ...
    public void serializeTo32(int[] array, int offset)
    {
        ...
        array[offset] = this.mag.getV0() | (this.negative ? SqlMathUtil.NEGATIVE_INT_MASK : 0);
    }
    ...
    public void serializeTo128(IntBuffer buf)
    {
        ...
        buf.put(this.mag.getV3() | (this.negative ? SqlMathUtil.NEGATIVE_INT_MASK : 0));
    }
    ...
    {
        assert (this.mag.getV3() == 0 && this.mag.getV2() == 0 && this.mag.getV1() == 0 && this.mag.getV0() >= 0);
        buf.put(this.mag.getV0() | (this.negative ? SqlMathUtil.NEGATIVE_INT_MASK : 0));
    }
    ...
    {
        long unsigned = SqlMathUtil.combineInts(this.mag.getV0(), this.mag.getV1()) & SqlMathUtil.FULLBITS_63;
        return this.negative ? -unsigned : unsigned;
    }
     ...
     * @param remainder result object to receive the calculation result
     */
    ...
    public void incrementDestructive()
    {
        if (!this.negative)
        {
            if (this.mag.equals(SqlMathUtil.FULLBITS_32, SqlMathUtil.FULLBITS_32, SqlMathUtil.FULLBITS_32, SqlMathUtil.FULLBITS_31))
            {
                SqlMathUtil.throwOverflowException();
            }
