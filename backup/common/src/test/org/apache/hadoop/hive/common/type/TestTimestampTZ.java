...
public class TestTimestampTZ
{
    ...
    public void testConvertFromTimestamp()
    {
        ...
        try
        {
            ...
            TimestampTZ tstz1 = TimestampTZUtil.convert(Timestamp.valueOf(s), TimeZone.getTimeZone("Europe/London").toZoneId());
            TimestampTZ tstz2 = TimestampTZUtil.convert(Timestamp.valueOf(s), TimeZone.getTimeZone("America/Los_Angeles").toZoneId());
