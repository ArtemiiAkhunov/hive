...
public class TestHiveConfRestrictList
{
    ...
    public void setUp() throws Exception
    {
        ...
        System.setProperty(ConfVars.HIVE_CONF_RESTRICTED_LIST.varname, ConfVars.HIVE_TEST_MODE_PREFIX.varname);
        conf = new HiveConf();
    }
    ...
    {
        String appendListStr = ConfVars.SCRATCH_DIR.varname + "," + ConfVars.LOCAL_SCRATCH_DIR.varname + "," + ConfVars.METASTORE_URIS.varname;
