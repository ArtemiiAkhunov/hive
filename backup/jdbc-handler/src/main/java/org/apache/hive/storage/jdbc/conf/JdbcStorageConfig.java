...
{
    DATABASE_TYPE(Constants.JDBC_DATABASE_TYPE, true), JDBC_URL(Constants.JDBC_URL, true), JDBC_DRIVER_CLASS(Constants.JDBC_DRIVER, true), QUERY(Constants.JDBC_QUERY, false), TABLE(Constants.JDBC_TABLE, false), JDBC_FETCH_SIZE(Constants.JDBC_CONFIG_PREFIX + ".jdbc.fetch.size", false), COLUMN_MAPPING(Constants.JDBC_CONFIG_PREFIX + ".column.mapping", false);
