...
public class JdbcRecordIterator implements Iterator<Map<String, Object>>
{
    ...
    public JdbcRecordIterator(GenericJdbcDatabaseAccessor accessor, Connection conn, PreparedStatement ps, ResultSet rs, Configuration conf) throws HiveJdbcDatabaseAccessException
    {
