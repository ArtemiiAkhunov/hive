...
public class ConnectionStats
{
    ...
    {
        return "{records-written: " + recordsWritten + ", records-size: " + recordsSize + ", committed-transactions: " + committedTransactions + ", aborted-transactions: " + abortedTransactions + ", auto-flushes: " + autoFlushCount + ", metastore-calls: " + metastoreCalls + ", created-partitions: " + createdPartitions + ", total-partitions: " + totalPartitions + " }";
    }
}
