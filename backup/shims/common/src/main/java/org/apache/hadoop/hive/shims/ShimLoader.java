...
public abstract class ShimLoader
{
     ...
     */
    private static final HashMap<String, String> HADOOP_SHIM_CLASSES = new HashMap<String, String>();
     ...
     */
    private static final HashMap<String, String> EVENT_COUNTER_SHIM_CLASSES = new HashMap<String, String>();
     ...
     */
    private static final HashMap<String, String> HADOOP_THRIFT_AUTH_BRIDGE_CLASSES = new HashMap<String, String>();

    static
    {
        HADOOP_THRIFT_AUTH_BRIDGE_CLASSES.put(HADOOP23VERSIONNAME, "org.apache.hadoop.hive.metastore.security.HadoopThriftAuthBridge23");
    }
