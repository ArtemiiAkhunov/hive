...
public class Var
{
    ...
    public enum Type
    {
        BOOL, CURSOR, DATE, DECIMAL, DERIVED_TYPE, DERIVED_ROWTYPE, DOUBLE, FILE, IDENT, BIGINT, INTERVAL, ROW, RS_LOCATOR, STRING, STRINGLIST, TIMESTAMP, NULL, HPL_OBJECT, HPL_SQL_UDF, SQL_STRING, VARIABLE
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        } else if (type == Type.STRING && var.type == Type.STRING && ((String) value).equals(var.value))
        {
            return true;
        } else if (type == Type.DECIMAL && var.type == Type.DECIMAL && ((BigDecimal) value).compareTo((BigDecimal) var.value) == 0)
        {
            return true;
        } else if (type == Type.DOUBLE)
        {
