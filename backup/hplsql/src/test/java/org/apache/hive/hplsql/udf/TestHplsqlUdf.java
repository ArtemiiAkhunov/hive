...
public class TestHplsqlUdf
{
    ...
    WritableConstantStringObjectInspector funcDefOI = (WritableConstantStringObjectInspector) PrimitiveObjectInspectorFactory.getPrimitiveWritableConstantObjectInspector(TypeInfoFactory.stringTypeInfo, new Text("Dummy function definition"));
