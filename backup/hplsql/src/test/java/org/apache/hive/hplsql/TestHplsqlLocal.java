...
public class TestHplsqlLocal
{
    ...
    String getTestOutput(String s) throws Exception
    {
        ...
        {
            if (!line.startsWith("log4j:") && !line.contains("INFO Log4j") && !line.startsWith("SLF4J") && !line.contains(" StatusLogger ") && !line.contains("Configuration file: ") && !line.contains("Parser tree: "))
            {
                sb.append(line);
                sb.append("\n");
            }
