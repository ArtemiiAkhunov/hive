...
public class TableDesc extends GroupPermissionsDesc
{
    ...
    public static class ClusteredByDesc
    {
        ...
        public String toString()
        {
            String fmt = "ClusteredByDesc(columnNames=%s, sortedBy=%s, numberOfBuckets=%s)";
        ...
        public boolean equals(Object o)
        {
            ...
            return xequals(this.columnNames, that.columnNames) && xequals(this.sortedBy, that.sortedBy) && xequals(this.numberOfBuckets, that.numberOfBuckets);
        }
    }
    ...
    public static class ClusterSortOrderDesc
    {
        ...
        public String toString()
        {
            return String.format("ClusterSortOrderDesc(columnName=%s, order=%s)", columnName, order);
        }
        ...
        public boolean equals(Object o)
        {
            ...
            return xequals(this.columnName, that.columnName) && xequals(this.order, that.order);
        }
    }
    ...
    public static class StorageFormatDesc
    {
        ...
        public boolean equals(Object o)
        {
            ...
            return xequals(this.rowFormat, that.rowFormat) && xequals(this.storedAs, that.storedAs) && xequals(this.storedBy, that.storedBy);
        }
    }
    ...
    public static class RowFormatDesc
    {
        ...
        public boolean equals(Object o)
        {
            ...
            return xequals(this.fieldsTerminatedBy, that.fieldsTerminatedBy) && xequals(this.collectionItemsTerminatedBy, that.collectionItemsTerminatedBy) && xequals(this.mapKeysTerminatedBy, that.mapKeysTerminatedBy) && xequals(this.linesTerminatedBy, that.linesTerminatedBy) && xequals(this.serde, that.serde);
        }
    }
    ...
    public static class SerdeDesc
    {
        ...
        public boolean equals(Object o)
        {
            ...
            return xequals(this.name, that.name) && xequals(this.properties, that.properties);
        }
    }
    ...
    public static class StoredByDesc
    {
        ...
        public boolean equals(Object o)
        {
            ...
            return xequals(this.className, that.className) && xequals(this.properties, that.properties);
        }
    }
