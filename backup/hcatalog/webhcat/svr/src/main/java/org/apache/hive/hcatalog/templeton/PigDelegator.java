...
public class PigDelegator extends LauncherDelegator
{
    ...
    {
        runAs = user;
        List<String> args = makeArgs(execute, srcFile, pigArgs, otherFiles, statusdir, usesHcatalog, completedUrl, enablelog, enableJobReconnect);
    ...
    private List<String> makeArgs(String execute, String srcFile, List<String> pigArgs, String otherFiles, String statusdir, boolean usesHcatalog, String completedUrl, boolean enablelog, Boolean enableJobReconnect) throws BadParam, IOException, InterruptedException
    {
        ...
        try
        {
            ...
            args.addAll(makeLauncherArgs(appConf, statusdir, completedUrl, allFiles, enablelog, enableJobReconnect, JobType.PIG));
