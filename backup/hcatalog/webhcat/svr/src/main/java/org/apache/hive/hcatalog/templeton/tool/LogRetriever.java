...
public class LogRetriever
{
    ...
    static class AttemptInfo
    {
        ...
        {
            return id + "\t" + baseUrl.toString() + "\t" + status.toString() + "\t" + type + "\t" + startTime + "\t" + endTime + "\n";
        }
    }
     ...
     */
    public LogRetriever(String statusDir, JobType jobType, Configuration conf) throws IOException
    {
    ...
    private void logJobConf(String job, String jobURLInString, String jobDir) throws IOException
    {
        ...
        try
        {
            ...
            writer = new PrintWriter(new OutputStreamWriter(fs.create(new Path(jobDir, "job.xml.html"))));
