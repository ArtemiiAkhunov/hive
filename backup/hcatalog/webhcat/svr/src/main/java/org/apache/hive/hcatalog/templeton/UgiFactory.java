...
{
    private static ConcurrentHashMap<String, UserGroupInformation> userUgiMap = new ConcurrentHashMap<String, UserGroupInformation>();
    ...
    public static UserGroupInformation getUgi(String user) throws IOException
    {
        ...
        if (ugi == null)
        {
            ...
            final UserGroupInformation newUgi = UserGroupInformation.createProxyUser(user, UserGroupInformation.getLoginUser());
