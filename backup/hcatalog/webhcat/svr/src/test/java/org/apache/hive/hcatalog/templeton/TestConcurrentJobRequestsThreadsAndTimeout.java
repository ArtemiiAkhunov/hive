...
public class TestConcurrentJobRequestsThreadsAndTimeout extends ConcurrentJobRequestsTestBase
{
    ...
    public static void setUp()
    {
        ...
        statusTooManyRequestsExceptionMessage = "Unable to service the status job request as " + "templeton service is busy with too many status job requests. " + "Please wait for some time before retrying the operation. " + "Please refer to the config templeton.parallellism.job.status " + "to configure concurrent requests.";
        listTooManyRequestsExceptionMessage = "Unable to service the list job request as " + "templeton service is busy with too many list job requests. " + "Please wait for some time before retrying the operation. " + "Please refer to the config templeton.parallellism.job.list " + "to configure concurrent requests.";
        submitTooManyRequestsExceptionMessage = "Unable to service the submit job request as " + "templeton service is busy with too many submit job requests. " + "Please wait for some time before retrying the operation. " + "Please refer to the config templeton.parallellism.job.submit " + "to configure concurrent requests.";
    }
    ...
    public void ConcurrentJobsStatusTimeOutException()
    {
        try
        {
            JobRunnable jobRunnable = ConcurrentJobsStatus(5, config, false, false, statusJobHelper.getDelayedResonseAnswer(6, statusBean));
             ...
             */
            jobRunnable = ConcurrentJobsStatus(5, config, false, false, statusJobHelper.getDelayedResonseAnswer(0, statusBean));
            assertTrue(jobRunnable.exception == null);
        } catch (Exception e)
        {
            assertTrue(false);
    ...
    public void ConcurrentListJobsTimeOutException()
    {
        try
        {
            JobRunnable jobRunnable = ConcurrentListJobs(5, config, false, false, listJobHelper.getDelayedResonseAnswer(6, new ArrayList<JobItemBean>()));
            assertTrue(jobRunnable.exception != null);
            assertTrue(jobRunnable.exception instanceof TimeoutException);
             ...
             * Verify that new job requests should succeed with no issues.
             */
            jobRunnable = ConcurrentListJobs(5, config, false, false, listJobHelper.getDelayedResonseAnswer(1, new ArrayList<JobItemBean>()));
            assertTrue(jobRunnable.exception == null);
        } catch (Exception e)
        {
            assertTrue(false);
    ...
    public void ConcurrentSubmitJobsTimeOutException()
    {
        try
        {
            JobRunnable jobRunnable = SubmitConcurrentJobs(5, config, false, false, submitJobHelper.getDelayedResonseAnswer(6, 0), killJobHelper.getDelayedResonseAnswer(0, statusBean), "job_1000");
            assertTrue(jobRunnable.exception != null);
             ...
             */
            jobRunnable = SubmitConcurrentJobs(1, config, false, false, submitJobHelper.getDelayedResonseAnswer(0, 0), killJobHelper.getDelayedResonseAnswer(0, statusBean), "job_1000");
            verifyTooManyRequestsException(jobRunnable.exception, this.submitTooManyRequestsExceptionMessage);
             ...
             */
            jobRunnable = SubmitConcurrentJobs(5, config, false, false, submitJobHelper.getDelayedResonseAnswer(0, 0), killJobHelper.getDelayedResonseAnswer(0, statusBean), "job_1000");
            assertTrue(jobRunnable.exception == null);
        } catch (Exception e)
        {
            assertTrue(false);
    ...
    public void ConcurrentStatusJobsVerifyExceptions()
    {
        try
        {
            ...
            JobRunnable jobRunnable = ConcurrentJobsStatus(5, config, true, false, statusJobHelper.getDelayedResonseAnswer(timeoutTaskDelay, statusBean));
            assertTrue(jobRunnable.exception != null);
             ...
             */
            jobRunnable = ConcurrentJobsStatus(5, config, false, true, statusJobHelper.getDelayedResonseAnswer(timeoutTaskDelay, statusBean));
            assertTrue(jobRunnable.exception != null);
            assertTrue(jobRunnable.exception instanceof InterruptedException);
            assertTrue(jobRunnable.exception.getMessage().contains(expectedMessage));
             ...
             */
            jobRunnable = ConcurrentJobsStatus(5, config, false, false, statusJobHelper.getIOExceptionAnswer());
            assertTrue(jobRunnable.exception != null);
    ...
    public void ConcurrentListJobsVerifyExceptions()
    {
        try
        {
             ...
             */
            int timeoutTaskDelay = 4;
            JobRunnable jobRunnable = ConcurrentListJobs(5, config, true, false, listJobHelper.getDelayedResonseAnswer(timeoutTaskDelay, new ArrayList<JobItemBean>()));
            assertTrue(jobRunnable.exception != null);
            assertTrue(jobRunnable.exception instanceof InterruptedException);
             ...
             * Interrupt all thread and verify we get InterruptedException and expected Message.
             */
            jobRunnable = ConcurrentListJobs(5, config, false, true, listJobHelper.getDelayedResonseAnswer(timeoutTaskDelay, new ArrayList<JobItemBean>()));
            assertTrue(jobRunnable.exception != null);
            assertTrue(jobRunnable.exception instanceof InterruptedException);
            assertTrue(jobRunnable.exception.getMessage().contains(expectedMessage));
             ...
             * Raise custom exception like IOException and verify expected Message.
             */
            jobRunnable = ConcurrentListJobs(5, config, false, false, listJobHelper.getIOExceptionAnswer());
            assertTrue(jobRunnable.exception != null);
            assertTrue(jobRunnable.exception.getCause() instanceof IOException);
             ...
             */
            jobRunnable = ConcurrentListJobs(5, config, false, false, listJobHelper.getDelayedResonseAnswer(0, new ArrayList<JobItemBean>()));
            assertTrue(jobRunnable.exception == null);
        } catch (Exception e)
        {
            assertTrue(false);
