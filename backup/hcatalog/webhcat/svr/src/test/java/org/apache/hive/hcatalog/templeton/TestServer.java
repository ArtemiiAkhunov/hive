...
public class TestServer
{
    ...
    public void testVerifyPropertyParam()
    {
        ...
        String[] validTblProperties = {"abcd", "Abcd", "1Abcd", "abc1d", "Abcd.efgh", "Abcd-efgh", "Abcd_efgh", "A", "b", "1"};
        ...
        String[] invalidTblProperties = {".abcd", "-Abcd", "_1Abcd", "abc1d.", "Abcd_", "Abcd-", "Abcd ", " Abcd", ".", "-", "_", " ", "$"};
