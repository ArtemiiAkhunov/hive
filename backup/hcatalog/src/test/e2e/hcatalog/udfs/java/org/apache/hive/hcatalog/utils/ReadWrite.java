...
public class ReadWrite extends Configured implements Tool
{
    ...
    public static class Map extends Mapper<WritableComparable, HCatRecord, Text, HCatRecord>
    {
        ...
        @Override
        protected void map(WritableComparable key, HCatRecord value, org.apache.hadoop.mapreduce.Mapper<WritableComparable, HCatRecord, Text, HCatRecord>.Context context) throws IOException, InterruptedException
        {
