...
public class SumNumbers
{
    ...
    public static class SumMapper extends Mapper<WritableComparable, HCatRecord, IntWritable, SumNumbers.ArrayWritable>
    {
        ...
        @Override
        protected void map(WritableComparable key, HCatRecord value, org.apache.hadoop.mapreduce.Mapper<WritableComparable, HCatRecord, IntWritable, SumNumbers.ArrayWritable>.Context context) throws IOException, InterruptedException
        {
            ...
            SumNumbers.ArrayWritable outputValue = new SumNumbers.ArrayWritable(id, intnum5, intnum100, intnum, longnum, floatnum, doublenum);
            context.write(intnum1000, outputValue);

        }
    }

    public static class SumReducer extends Reducer<IntWritable, SumNumbers.ArrayWritable, LongWritable, Text>
    {
        ...
        @Override
        protected void reduce(IntWritable key, java.lang.Iterable<ArrayWritable> values, org.apache.hadoop.mapreduce.Reducer<IntWritable, ArrayWritable, LongWritable, Text>.Context context) throws IOException, InterruptedException
        {
    ...
    public static class ArrayWritable implements Writable
    {
         ...
         * @param doublenum
         */
        public ArrayWritable(IntWritable id, IntWritable intnum5, IntWritable intnum100, IntWritable intnum, LongWritable longnum, FloatWritable floatnum, DoubleWritable doublenum)
        {
            this.id = id;
