...
public class ReadText extends Configured implements Tool
{
    ...
    public static class Map extends Mapper<WritableComparable, HCatRecord, IntWritable, HCatRecord>
    {
        ...
        @Override
        protected void map(WritableComparable key, HCatRecord value, org.apache.hadoop.mapreduce.Mapper<WritableComparable, HCatRecord, IntWritable, HCatRecord>.Context context) throws IOException, InterruptedException
        {
            t = (Byte) value.get(0);
