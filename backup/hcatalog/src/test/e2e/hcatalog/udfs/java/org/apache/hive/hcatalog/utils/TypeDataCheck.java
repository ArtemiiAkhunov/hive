...
public class TypeDataCheck implements Tool
{
    ...
    public static class TypeDataCheckMapper extends Mapper<WritableComparable, HCatRecord, Long, Text>
    {
        ...
        @Override
        protected void setup(org.apache.hadoop.mapreduce.Mapper<WritableComparable, HCatRecord, Long, Text>.Context context) throws IOException, InterruptedException
        {
        ...
        @Override
        protected void map(WritableComparable key, HCatRecord value, org.apache.hadoop.mapreduce.Mapper<WritableComparable, HCatRecord, Long, Text>.Context context) throws IOException, InterruptedException
        {
