...
public class TestSemanticAnalysis extends HCatBaseTest
{
    ...
    public void setUpHCatDriver() throws IOException
    {
        if (hcatDriver == null)
        {
            ...
            hcatConf.set(HiveConf.ConfVars.HIVE_DEFAULT_RCFILE_SERDE.varname, "org.apache.hadoop.hive.serde2.columnar.ColumnarSerDe");
    ...
    public void testAlterTableSetFF() throws Exception
    {
        ...
        hcatDriver.run("alter table " + TBL_NAME + " " + "set fileformat INPUTFORMAT 'org.apache.hadoop.hive.ql.io.RCFileInputFormat' " + "OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.RCFileOutputFormat' " + "serde 'myserde' " + "inputdriver 'mydriver' " + "outputdriver 'yourdriver'");
    ...
    public void testCTAS() throws Exception
    {
        ...
        } catch (CommandProcessorException e)
        {
            ...
            assertTrue(e.getMessage().contains("FAILED: SemanticException Operation not supported. Create table as Select is not a valid operation."));
        }
        hcatDriver.run("drop table junit_sem_analysis");
    }
    ...
    public void testInvalidateNonStringPartition() throws Exception
    {
        ...
        {
            assertEquals(40000, e.getResponseCode());
            assertEquals("FAILED: SemanticException Operation not supported. HCatalog only supports partition columns of " + "type string. For column: b Found type: int", e.getMessage());
        }
    }
