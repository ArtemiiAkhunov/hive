...
public class HCatSemanticAnalyzerBase extends AbstractSemanticAnalyzerHook
{
     ...
     */
    protected void authorizeDDL(HiveSemanticAnalyzerHookContext context, List<Task<?>> rootTasks) throws SemanticException
    {
    ...
    protected void authorize(Privilege[] inputPrivs, Privilege[] outputPrivs) throws AuthorizationException, SemanticException
    {
        try
        {
            getAuthProvider().authorizeDbLevelOperations(inputPrivs, outputPrivs, null, null);
