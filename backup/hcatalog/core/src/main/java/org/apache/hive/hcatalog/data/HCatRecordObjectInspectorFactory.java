...
public class HCatRecordObjectInspectorFactory
{
    ...
    private static final CacheBuilder<Object, Object> boundedCache = CacheBuilder.newBuilder().initialCapacity(INITIAL_CACHE_CAPACITY).maximumSize(MAX_CACHE_CAPACITY).concurrencyLevel(Runtime.getRuntime().availableProcessors()).expireAfterAccess(5, TimeUnit.MINUTES);
