...
public class HCatUtil
{
    ...
    public static Table getTable(IMetaStoreClient client, String dbName, String tableName) throws NoSuchObjectException, TException, MetaException
    {
    ...
    {
        return getStorageHandler(conf, storerInfo.getStorageHandlerClass(), storerInfo.getSerdeClass(), storerInfo.getIfClass(), storerInfo.getOfClass());
    }
    ...
    public static Map<String, String> getInputJobProperties(HiveStorageHandler storageHandler, InputJobInfo inputJobInfo)
    {
        ...
        try
        {
            ...
            LinkedList<InputJobInfo> inputJobInfos = (LinkedList<InputJobInfo>) HCatUtil.deserialize(properties.get(HCatConstants.HCAT_KEY_JOB_INFO));
    ...
    public static HiveConf getHiveConf(Configuration conf) throws IOException
    {
        ...
        {
            hiveConf.setVar(HiveConf.ConfVars.METASTORE_TOKEN_SIGNATURE, conf.get(HCatConstants.HCAT_KEY_TOKEN_SIGNATURE));
        }

        return hiveConf;
    }

    public static HiveConf storePropertiesToHiveConf(Properties properties, HiveConf hiveConf) throws IOException
    {
    ...
    public static void putInputJobInfoToConf(InputJobInfo inputJobInfo, Configuration conf) throws IOException
    {
        ...
        LinkedList<InputJobInfo> inputJobInfos = (LinkedList<InputJobInfo>) HCatUtil.deserialize(conf.get(HCatConstants.HCAT_KEY_JOB_INFO));
