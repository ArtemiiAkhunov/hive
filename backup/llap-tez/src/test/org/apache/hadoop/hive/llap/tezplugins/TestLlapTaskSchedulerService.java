...
public class TestLlapTaskSchedulerService
{
    ...
    @Test(timeout = 10000)
    public void testForcedLocalityMultiplePreemptionsSameHost2() throws IOException, InterruptedException
    {
        Priority priority1 = Priority.newInstance(1);
        Priority priority2 = Priority.newInstance(2);
    ...
    private static class TestTaskSchedulerServiceWrapper
    {
        ...
        private static final TezVertexID VERTEX_ID = TezVertexID.getInstance(TezDAGID.getInstance(ApplicationId.newInstance(1, 1), 0), 0);
