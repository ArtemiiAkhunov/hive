...
public class FilterStringColLikeStringScalar extends AbstractFilterStringColLikeStringScalar
{
    ...
    private static final List<CheckerFactory> CHECKER_FACTORIES = ImmutableList.of(pattern ->
    {
    ...
    CHAINED(ChainedChecker.class), // Accepts simple LIKE patterns like "abc" and creates corresponding checkers.
