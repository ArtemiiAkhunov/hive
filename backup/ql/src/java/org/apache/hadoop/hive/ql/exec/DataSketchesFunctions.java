...
public final class DataSketchesFunctions implements HiveUDFPlugin
{
            ...
            } else
            {
                ...
                if (returnType instanceof ParameterizedType)
                {
                    ...
                    if (parameterizedType.getRawType() == List.class)
                    {
                        ...
                        return Optional.of(typeFactory.createArrayType(typeFactory.createTypeWithNullability(componentRelType, true), -1));
                    }
                    return Optional.empty();
                }
    ...
    private void registerHll()
    {
        ...
        sd.register(SKETCH_TO_ESTIMATE_WITH_ERROR_BOUNDS, org.apache.datasketches.hive.hll.SketchToEstimateAndErrorBoundsUDF.class);
    ...
    private void registerCpc()
    {
        ...
        sd.register(SKETCH_TO_ESTIMATE_WITH_ERROR_BOUNDS, org.apache.datasketches.hive.cpc.GetEstimateAndErrorBoundsUDF.class);
    ...
    private void registerTupleArrayOfDoubles()
    {
        ...
        sd.register(SKETCH_TO_ESTIMATE_WITH_ERROR_BOUNDS, org.apache.datasketches.hive.tuple.ArrayOfDoublesSketchToEstimateAndErrorBoundsUDF.class);
        sd.register(SKETCH_TO_MEANS, org.apache.datasketches.hive.tuple.ArrayOfDoublesSketchToMeansUDF.class);
        sd.register(SKETCH_TO_NUMBER_OF_RETAINED_ENTRIES, org.apache.datasketches.hive.tuple.ArrayOfDoublesSketchToNumberOfRetainedEntriesUDF.class);
        sd.register(SKETCH_TO_QUANTILES_SKETCH, org.apache.datasketches.hive.tuple.ArrayOfDoublesSketchToQuantilesSketchUDF.class);
    ...
    private void registerFrequencies()
    {
        ...
        sd.register(GET_FREQUENT_ITEMS, org.apache.datasketches.hive.frequencies.GetFrequentItemsFromStringsSketchUDTF.class);
