 ...
 */
@Description(name = "quarter", value = "_FUNC_(date/timestamp/string) - Returns the " + "quarter of the year for date, in the range 1 to 4.", extended = "Example: > SELECT _FUNC_('2015-04-08');\n 2")
