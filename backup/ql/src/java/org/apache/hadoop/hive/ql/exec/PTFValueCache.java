...
public class PTFValueCache
{
    ...
    class InstrumentedCacheHandler implements CacheHandler
    {
        ...
        public String getStatistics()
        {
            return String.format("PTFValueCache.InstrumentedCacheHandler statistics: put: %d, evict: %d, hit: %d, miss: %d", put, evict, hit, miss);
        }
    ...
    public PTFValueCache init(int length)
    {
        ...
        LOG.info("PTFValueCache is initialized to {} evaluators, maxSize: {} ({} entries / evaluator)", length, maxSize, maxSizePerEvaluator);
        return this;
    }
