...
public class IfExprDecimal64ScalarDecimal64Column extends IfExprLongScalarLongColumn
{
    ...
    public IfExprDecimal64ScalarDecimal64Column(int arg1Column, long arg2Scalar, int arg3Column, int outputColumnNum)
    {
    ...
    public String vectorExpressionParameters()
    {
        ...
        return getColumnParamString(0, inputColumnNum[0]) + ", decimal64Val " + arg2Scalar + ", decimalVal " + writable.toString() + ", " + getColumnParamString(1, inputColumnNum[1]);
    }
