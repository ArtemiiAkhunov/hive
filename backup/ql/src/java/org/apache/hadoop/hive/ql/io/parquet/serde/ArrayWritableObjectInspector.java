...
public class ArrayWritableObjectInspector extends SettableStructObjectInspector
{
    ...
    private ObjectInspector getObjectInspector(TypeInfo typeInfo, TypeInfo prunedTypeInfo)
    {
        ...
        } else if (typeInfo.getCategory().equals(Category.MAP))
        {
            ...
            {
                return new DeepParquetHiveMapInspector(getObjectInspector(keyTypeInfo, null), getObjectInspector(valueTypeInfo, null));
            } else
            {
                return new StandardParquetHiveMapInspector(getObjectInspector(keyTypeInfo, null), getObjectInspector(valueTypeInfo, null));
            }
    ...
    public boolean equals(Object o)
    {
        ...
        if (isRoot != that.isRoot || (typeInfo != null ? !typeInfo.equals(that.typeInfo) : that.typeInfo != null) || (fieldInfos != null ? !fieldInfos.equals(that.fieldInfos) : that.fieldInfos != null) || (fieldNames != null ? !fieldNames.equals(that.fieldNames) : that.fieldNames != null) || (fields != null ? !fields.equals(that.fields) : that.fields != null))
        {
            return false;
        }
    ...
    private class StructFieldImpl implements StructField
    {
        ...
        public StructFieldImpl(final String name, final ObjectInspector inspector, final int index, int adjustedIndex)
        {
            this.name = name;
