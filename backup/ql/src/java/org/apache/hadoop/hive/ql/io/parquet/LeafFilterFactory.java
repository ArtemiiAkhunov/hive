...
public class LeafFilterFactory
{
    ...
    class IntFilterPredicateLeafBuilder extends FilterPredicateLeafBuilder
    {
         ...
         */
        @Override
        public FilterPredicate buildPredict(Operator op, Object literal, String columnName, TypeInfo columnType)
        {
            switch (op)
            {
                case LESS_THAN:
                ...
                case NULL_SAFE_EQUALS:
                    return eq(intColumn(columnName), (literal == null) ? null : ((Number) literal).intValue());
    ...
    class LongFilterPredicateLeafBuilder extends FilterPredicateLeafBuilder
    {
        ...
        public FilterPredicate buildPredict(Operator op, Object constant, String columnName, TypeInfo columnType)
        {
            switch (op)
            {
                ...
                case EQUALS:
                case NULL_SAFE_EQUALS:
                    return eq(FilterApi.longColumn(columnName), (constant == null) ? null : ((Number) constant).longValue());
                case LESS_THAN_EQUALS:
                    return ltEq(FilterApi.longColumn(columnName), ((Number) constant).longValue());
                default:
                    throw new RuntimeException("Unknown PredicateLeaf Operator type: " + op);
            }
        }
    ...
    class DoubleFilterPredicateLeafBuilder extends FilterPredicateLeafBuilder
    {
        ...
        public FilterPredicate buildPredict(Operator op, Object constant, String columnName, TypeInfo columnType)
        {
            switch (op)
            {
                ...
                case EQUALS:
                case NULL_SAFE_EQUALS:
                    return eq(doubleColumn(columnName), (constant == null) ? null : ((Number) constant).doubleValue());
                case LESS_THAN_EQUALS:
                    return ltEq(FilterApi.doubleColumn(columnName), ((Number) constant).doubleValue());
                default:
                    throw new RuntimeException("Unknown PredicateLeaf Operator type: " + op);
            }
        }
    ...
    {
        @Override
        public FilterPredicate buildPredict(Operator op, Object constant, String columnName, TypeInfo columnType) throws Exception
        {
            switch (op)
            {
                case IS_NULL:
    ...
    class BinaryFilterPredicateLeafBuilder extends FilterPredicateLeafBuilder
    {
        ...
        public FilterPredicate buildPredict(Operator op, Object constant, String columnName, TypeInfo columnType) throws Exception
        {
            ...
            switch (op)
            {
                ...
                case EQUALS:
                case NULL_SAFE_EQUALS:
                    return eq(binaryColumn(columnName), (constant == null) ? null : Binary.fromString(value));
                case LESS_THAN_EQUALS:
