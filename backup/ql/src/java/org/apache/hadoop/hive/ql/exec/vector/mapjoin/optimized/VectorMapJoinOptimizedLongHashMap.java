...
public class VectorMapJoinOptimizedLongHashMap extends VectorMapJoinOptimizedHashMap implements VectorMapJoinLongHashMap
{
    ...
    private static class NonMatchedLongHashMapIterator extends VectorMapJoinOptimizedNonMatchedIterator
    {
        ...
        public void init()
        {
            ...
            keyBinarySortableDeserializeRead = BinarySortableDeserializeRead.with(new TypeInfo[]{integerTypeInfo}, false, hashMap.longCommon.getTableDesc().getProperties());
        }
    ...
    @Override
    public JoinResult lookup(long key, VectorMapJoinHashMapResult hashMapResult) throws IOException
    {
    ...
    @Override
    public JoinResult lookup(long key, VectorMapJoinHashMapResult hashMapResult, MatchTracker matchTracker) throws IOException
    {
    ...
    public VectorMapJoinOptimizedLongHashMap(boolean minMaxEnabled, boolean isOuterJoin, HashTableKeyType hashTableKeyType, MapJoinTableContainer originalTableContainer, ReusableGetAdaptor hashMapRowGetter, TableDesc tableDesc)
    {
