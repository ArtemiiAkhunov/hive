 ...
 */
public abstract class HiveContextAwareRecordReader<K extends WritableComparable, V extends Writable> implements RecordReader<K, V>
{
    ...
    {
        if (this.getIOContext().getComparison() == null || !stopComparisons.contains(this.getIOContext().getComparison()))
        {
            return false;
        }
