...
public class ColumnStatisticsObjTranslator
{
    ...
    public static ColumnStatisticsObj readHiveColumnStatistics(String columnName, String columnType, List<ColumnStatsField> columnStatsFields, int start, List<? extends StructField> fields, List<Object> values) throws HiveException
    {
    ...
    private static void unpackBooleanStats(ObjectInspector oi, Object o, ColumnStatsField csf, ColumnStatisticsObj statsObj)
    {
    ...
    private static void unpackBinaryStats(ObjectInspector oi, Object o, ColumnStatsField csf, ColumnStatisticsObj statsObj)
    {
        switch (csf)
        {
            case COUNT_NULLS:
