 ...
 */
public class VectorMapJoinFastLongHashMultiSetContainer extends VectorMapJoinFastHashTableContainerBase implements VectorMapJoinLongHashMultiSet
{
    ...
    public VectorMapJoinFastLongHashMultiSetContainer(boolean isFullOuter, boolean minMaxEnabled, HashTableKeyType hashTableKeyType, int initialCapacity, float loadFactor, int writeBuffersSize, long estimatedKeyCount, TableDesc tableDesc, int numHTs)
    {
        ...
        {
            vectorMapJoinFastLongHashMultiSets[i] = new VectorMapJoinFastLongHashMultiSet(isFullOuter, minMaxEnabled, hashTableKeyType, initialCapacity, loadFactor, writeBuffersSize, estimatedKeyCount, tableDesc);
        }
