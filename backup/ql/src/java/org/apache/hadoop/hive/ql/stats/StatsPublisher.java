...
public interface StatsPublisher
{
     ...
     *
     * @param fileID : a string identification the statistics to be published by all mappers/reducers
     ...
     * @param stats  : a map containing key-value pairs, where key is a string representing the statistic
     *               to be published,
