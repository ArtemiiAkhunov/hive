...
public class MapJoinObjectSerDeContext
{
    ...
    public MapJoinObjectSerDeContext(AbstractSerDe serde, boolean hasFilter) throws SerDeException
    {
        ...
        this.standardOI = ObjectInspectorUtils.getStandardObjectInspector(serde.getObjectInspector(), ObjectInspectorCopyOption.WRITABLE);
    }
    ...
    public String stringify()
    {
        ...
        return "[types " + typeInfoStrings.toString() + ", serde=" + serde.getClass().getName() + ", hasFilter=" + hasFilter + "]";
    }

    @Override
    public String toString()
    {
        return "MapJoinObjectSerDeContext [standardOI=" + standardOI + ", serde=" + serde + ", hasFilter=" + hasFilter + "]";
    }
