 ...
 */
@Explain(displayName = "Set DataConnector Owner", explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED})
public class AlterDataConnectorSetOwnerDesc extends AbstractAlterDataConnectorDesc
{
