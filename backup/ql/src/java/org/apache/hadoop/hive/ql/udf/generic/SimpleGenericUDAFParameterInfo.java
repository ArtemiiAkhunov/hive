...
public class SimpleGenericUDAFParameterInfo implements GenericUDAFParameterInfo
{
    ...
    public SimpleGenericUDAFParameterInfo(ObjectInspector[] params, boolean isWindowing, boolean distinct, boolean allColumns, boolean respectNulls)
    {
    ...
    public TypeInfo[] getParameters()
    {
        ...
        {
            result[ii] = TypeInfoUtils.getTypeInfoFromObjectInspector(parameters[ii]);
        }
        return result;
    }
