...
public abstract class GenericUDFBaseCompare extends GenericUDFBaseBinary
{
    ...
    protected void checkConversionAllowed(ObjectInspector argOI, ObjectInspector compareOI) throws UDFArgumentException
    {
        ...
        if (ss != null && ss.getConf().getBoolVar(ConfVars.HIVE_STRICT_TIMESTAMP_CONVERSION))
        {
            ...
            {
                throw new UDFArgumentException("Casting DATE/TIMESTAMP to NUMERIC is prohibited (" + ConfVars.HIVE_STRICT_TIMESTAMP_CONVERSION + ")");
            }
        }
    }
    ...
    public Integer compare(DeferredObject[] arguments) throws HiveException
    {
        ...
        if (compareType == CompareType.NEED_CONVERT)
        {
            ...
            return ObjectInspectorUtils.compare(converted_o0, compareOI, converted_o1, compareOI);
        } else
        {
            return ObjectInspectorUtils.compare(o0, argumentOIs[0], o1, argumentOIs[1]);
        }
    }
}
