...
public interface Reader extends org.apache.hadoop.hive.ql.io.orc.Reader
{
     ...
     * @return The reader.
     */
    EncodedReader encodedReader(Object fileKey, DataCache dataCache, LlapDataReader dataReader, PoolFactory pf, IoTrace trace, boolean useCodecPool, CacheTag tag, boolean isReadCacheOnly) throws IOException;
    ...
    public static final class OrcEncodedColumnBatch extends EncodedColumnBatch<OrcBatchKey>
    {
        ...
        public int getColumnsWithDataCount()
        {
            ...
            {
                if (!hasData(childIx) && !hasVectors(childIx))
                {
                    continue;
                }
                ++result;
