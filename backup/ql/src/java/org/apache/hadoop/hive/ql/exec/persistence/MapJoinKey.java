...
public abstract class MapJoinKey
{
    ...
    private static final HashSet<PrimitiveCategory> SUPPORTED_PRIMITIVES = new HashSet<PrimitiveCategory>();
    ...
    public static MapJoinKey readFromVector(Output output, MapJoinKey key, Object[] keyObject, List<ObjectInspector> keyOIs, boolean mayReuseKey) throws HiveException
    {
    ...
    public static MapJoinKey readFromRow(Output output, MapJoinKey key, Object[] keyObject, List<ObjectInspector> keyFieldsOI, boolean mayReuseKey) throws HiveException
    {
        MapJoinKeyObject result = mayReuseKey ? (MapJoinKeyObject) key : new MapJoinKeyObject();
     ...
     * @param byteStream Output to reuse. Can be null, in that case a new one would be created.
     */
    public static Output serializeRow(Output byteStream, Object[] fieldData, List<ObjectInspector> fieldOis, boolean[] sortableSortOrders, byte[] nullMarkers, byte[] notNullMarkers) throws HiveException
    {
        if (byteStream == null)
        {
        ...
        try
        {
            ...
            {
                BinarySortableSerDe.serializeStruct(byteStream, fieldData, fieldOis, sortableSortOrders, nullMarkers, notNullMarkers);
            }
     ...
     */
    public static List<Object> deserializeRow(byte[] keyBytes, int keyOffset, int keyLength, BytesWritable bytesWritable, AbstractSerDe serde) throws HiveException
    {
        try
        {
