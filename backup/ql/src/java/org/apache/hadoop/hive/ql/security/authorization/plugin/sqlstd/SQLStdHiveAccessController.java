...
public class SQLStdHiveAccessController implements HiveAccessController
{
    ...
    private void ensureShowGrantAllowed(HivePrincipal principal) throws HiveAccessControlException, HiveAuthzPluginException
    {
    ...
    public void applyAuthorizationConfigPolicy(HiveConf hiveConf) throws HiveAuthzPluginException
    {
        ...
        if (sessionCtx.getClientType() == CLIENT_TYPE.HIVESERVER2 && hiveConf.getBoolVar(ConfVars.HIVE_AUTHORIZATION_ENABLED))
        {
