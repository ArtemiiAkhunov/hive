...
public class ColStatsProcessor implements IStatsProcessor
{
    ...
    {
        COLUMN_STATS_TYPE("columntype"), COUNT_TRUES("counttrues"), COUNT_FALSES("countfalses"), COUNT_NULLS("countnulls"), MIN("min"), MAX("max"), NDV("numdistinctvalues"), BITVECTOR("ndvbitvector"), KLL_SKETCH("kllsketch"), MAX_LENGTH("maxlength"), AVG_LENGTH("avglength");
    ...
    {
        BOOLEAN(ImmutableList.of(ColumnStatsField.COLUMN_STATS_TYPE, ColumnStatsField.COUNT_TRUES, ColumnStatsField.COUNT_FALSES, ColumnStatsField.COUNT_NULLS)), LONG(ImmutableList.of(ColumnStatsField.COLUMN_STATS_TYPE, ColumnStatsField.MIN, ColumnStatsField.MAX, ColumnStatsField.COUNT_NULLS, ColumnStatsField.NDV, ColumnStatsField.BITVECTOR, ColumnStatsField.KLL_SKETCH)), DOUBLE(ImmutableList.of(ColumnStatsField.COLUMN_STATS_TYPE, ColumnStatsField.MIN, ColumnStatsField.MAX, ColumnStatsField.COUNT_NULLS, ColumnStatsField.NDV, ColumnStatsField.BITVECTOR, ColumnStatsField.KLL_SKETCH)), STRING(ImmutableList.of(ColumnStatsField.COLUMN_STATS_TYPE, ColumnStatsField.MAX_LENGTH, ColumnStatsField.AVG_LENGTH, ColumnStatsField.COUNT_NULLS, ColumnStatsField.NDV, ColumnStatsField.BITVECTOR)), BINARY(ImmutableList.of(ColumnStatsField.COLUMN_STATS_TYPE, ColumnStatsField.MAX_LENGTH, ColumnStatsField.AVG_LENGTH, ColumnStatsField.COUNT_NULLS)), DECIMAL(ImmutableList.of(ColumnStatsField.COLUMN_STATS_TYPE, ColumnStatsField.MIN, ColumnStatsField.MAX, ColumnStatsField.COUNT_NULLS, ColumnStatsField.NDV, ColumnStatsField.BITVECTOR, ColumnStatsField.KLL_SKETCH)), DATE(ImmutableList.of(ColumnStatsField.COLUMN_STATS_TYPE, ColumnStatsField.MIN, ColumnStatsField.MAX, ColumnStatsField.COUNT_NULLS, ColumnStatsField.NDV, ColumnStatsField.BITVECTOR, ColumnStatsField.KLL_SKETCH)), TIMESTAMP(ImmutableList.of(ColumnStatsField.COLUMN_STATS_TYPE, ColumnStatsField.MIN, ColumnStatsField.MAX, ColumnStatsField.COUNT_NULLS, ColumnStatsField.NDV, ColumnStatsField.BITVECTOR, ColumnStatsField.KLL_SKETCH));
