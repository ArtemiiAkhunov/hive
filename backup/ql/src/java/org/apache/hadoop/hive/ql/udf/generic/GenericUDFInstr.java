...
public class GenericUDFInstr extends GenericUDF
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        if (arguments.length > 3 && arguments[3] instanceof ConstantObjectInspector)
        {
            ...
            {
                throw new UDFArgumentException("occurrence of function INSTR should be " + "positive, got " + occurrenceConst);
            }
        }
    ...
    {
        if (arguments[0].get() == null || arguments[1].get() == null || (isPosConst && posConst == null) || (isOccurrenceConst && occurrenceConst == null))
        {
            return null;
        }
        int pos = 1;
        ...
        {
            IntWritable occurrenceWritable = (IntWritable) converters[3].convert(arguments[3].get());
