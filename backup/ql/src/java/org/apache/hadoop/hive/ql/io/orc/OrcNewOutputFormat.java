...
public class OrcNewOutputFormat extends FileOutputFormat<NullWritable, OrcSerdeRow>
{
    ...
    private static class OrcRecordWriter extends RecordWriter<NullWritable, OrcSerdeRow>
    {
        ...
        @Override
        public void write(NullWritable key, OrcSerdeRow row) throws IOException, InterruptedException
        {
            if (writer == null)
            {
    ...
    public RecordWriter getRecordWriter(TaskAttemptContext context) throws IOException, InterruptedException
    {
        ...
        return new OrcRecordWriter(file, OrcFile.writerOptions(ShimLoader.getHadoopShims().getConfiguration(context)));
    }
}
