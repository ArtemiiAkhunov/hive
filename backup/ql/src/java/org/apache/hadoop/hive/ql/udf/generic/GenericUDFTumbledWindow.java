...
public class GenericUDFTumbledWindow extends GenericUDF
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        if (arguments.length == 3)
        {
            ...
            if (!PrimitiveObjectInspectorUtils.getPrimitiveGrouping(originTsOI.getPrimitiveCategory()).equals(PrimitiveObjectInspectorUtils.PrimitiveGrouping.DATE_GROUP))
            {
                throw new UDFArgumentException("Third arg has to be timestamp got " + originTsOI.getTypeInfo().toString());
            }
        }

        if (!PrimitiveObjectInspectorUtils.getPrimitiveGrouping(timestampOI.getPrimitiveCategory()).equals(PrimitiveObjectInspectorUtils.PrimitiveGrouping.DATE_GROUP))
        {
