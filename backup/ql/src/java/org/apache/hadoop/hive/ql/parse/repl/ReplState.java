...
public abstract class ReplState
{
    ...
    public enum LogTag
    {
        START, TABLE_DUMP, FUNCTION_DUMP, EVENT_DUMP, ATLAS_DUMP_START, ATLAS_DUMP_END, RANGER_DUMP_START, RANGER_DUMP_END, TABLE_LOAD, FUNCTION_LOAD, EVENT_LOAD, ATLAS_LOAD_START, ATLAS_LOAD_END, RANGER_LOAD_START, RANGER_LOAD_END, END, DATA_COPY_END
    }
