...
public class VectorMapJoinOptimizedHashMap extends VectorMapJoinOptimizedHashTable implements VectorMapJoinBytesHashMap
{
    ...
    protected static class NonMatchedBytesHashMapIterator extends VectorMapJoinOptimizedNonMatchedIterator
    {
        ...
        {
            super.init();
            nonMatchedIterator = ((MapJoinTableContainer) hashMap.originalTableContainer).createNonMatchedSmallTableIterator(matchTracker);
        }
    ...
    public JoinUtil.JoinResult lookup(byte[] keyBytes, int keyOffset, int keyLength, VectorMapJoinHashMapResult hashMapResult) throws IOException
    {
        ...
        JoinUtil.JoinResult joinResult = doLookup(keyBytes, keyOffset, keyLength, implementationHashMapResult.bytesBytesMultiHashMapResult(), (VectorMapJoinHashTableResult) hashMapResult, null);

        return joinResult;
    }

    @Override
    public JoinUtil.JoinResult lookup(byte[] keyBytes, int keyOffset, int keyLength, VectorMapJoinHashMapResult hashMapResult, MatchTracker matchTracker) throws IOException
    {

        HashMapResult implementationHashMapResult = (HashMapResult) hashMapResult;

        JoinUtil.JoinResult joinResult = doLookup(keyBytes, keyOffset, keyLength, implementationHashMapResult.bytesBytesMultiHashMapResult(), (VectorMapJoinHashTableResult) hashMapResult, matchTracker);

        return joinResult;
    }

    public VectorMapJoinOptimizedHashMap(MapJoinTableContainer originalTableContainer, ReusableGetAdaptor hashMapRowGetter)
    {
