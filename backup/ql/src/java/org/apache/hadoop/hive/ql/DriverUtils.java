...
public final class DriverUtils
{
     ...
     */
    public static void runOnDriver(HiveConf conf, SessionState sessionState, String query, ValidWriteIdList writeIds, long compactorTxnId) throws HiveException
    {
     ...
     */
    public static void runOnDriver(HiveConf conf, SessionState sessionState, String query, long analyzeTableWriteId) throws HiveException
    {
        if (analyzeTableWriteId < 0)
        {
            throw new IllegalArgumentException(JavaUtils.txnIdToString(analyzeTableWriteId) + " is not valid. Context: " + query);
        }
    ...
    public static void handleHiveException(DriverContext driverContext, HiveException e, int ret, String rootMsg) throws CommandProcessorException
    {
