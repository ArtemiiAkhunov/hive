...
public class VectorMapJoinOptimizedHashMultiSet extends VectorMapJoinOptimizedHashTable implements VectorMapJoinBytesHashMultiSet
{
    ...
    @Override
    public JoinUtil.JoinResult contains(byte[] keyBytes, int keyOffset, int keyLength, VectorMapJoinHashMultiSetResult hashMultiSetResult) throws IOException
    {

        HashMultiSetResult implementationHashMultiSetResult = (HashMultiSetResult) hashMultiSetResult;

        JoinUtil.JoinResult joinResult = doLookup(keyBytes, keyOffset, keyLength, implementationHashMultiSetResult.bytesBytesMultiHashMapResult(), (VectorMapJoinHashTableResult) hashMultiSetResult, null);

        return joinResult;
    }

    public VectorMapJoinOptimizedHashMultiSet(MapJoinTableContainer originalTableContainer, ReusableGetAdaptor hashMapRowGetter)
    {
