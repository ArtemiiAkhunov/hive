...
@Description(name = "current_database", value = "_FUNC_() - returns currently using database name")
@NDV(maxNdv = 1)
public class GenericUDFCurrentDatabase extends GenericUDF
{
    ...
    {
        return PrimitiveObjectInspectorFactory.getPrimitiveWritableConstantObjectInspector(TypeInfoFactory.stringTypeInfo, new Text(SessionState.get().getCurrentDatabase()));
    }
