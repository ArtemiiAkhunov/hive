...
public class GenericUDAFPercentileCont extends AbstractGenericUDAFResolver
{
    ...
    public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters) throws SemanticException
    {
        ...
        { // column ref, expression (0 <= percentile <= 1)
    ...
    {
        @Override
        public int compare(Map.Entry<DoubleWritable, LongWritable> o1, Map.Entry<DoubleWritable, LongWritable> o2)
        {
    ...
    public abstract static class PercentileContEvaluator<T, U> extends GenericUDAFEvaluator
    {
        ...
        public ObjectInspector init(Mode m, ObjectInspector[] parameters) throws HiveException
        {
            ...
            {// ...for real input data
                if (parameters.length == 2)
                { // Order direction was not given, default to asc
        ...
        public Object terminate(AggregationBuffer agg) throws HiveException
        {
            ...
            List<Map.Entry<U, LongWritable>> entriesList = new ArrayList<Map.Entry<U, LongWritable>>(entries);
        ...
        protected List<DoubleWritable> calculatePercentile(List<DoubleWritable> percentiles, List<Map.Entry<U, LongWritable>> entriesList, long total, List<DoubleWritable> results)
        {
    ...
    public static class PercentileContLongEvaluator extends PercentileContEvaluator<Long, LongWritable>
    {
        ...
        protected ArrayList<ObjectInspector> getPartialInspectors()
        {
            ...
            foi.add(ObjectInspectorFactory.getStandardMapObjectInspector(PrimitiveObjectInspectorFactory.writableLongObjectInspector, PrimitiveObjectInspectorFactory.writableLongObjectInspector));
            foi.add(ObjectInspectorFactory.getStandardListObjectInspector(PrimitiveObjectInspectorFactory.writableDoubleObjectInspector));
    ...
    public static class PercentileContDoubleEvaluator extends PercentileContEvaluator<Double, DoubleWritable>
    {
        ...
        protected ArrayList<ObjectInspector> getPartialInspectors()
        {
            ...
            foi.add(ObjectInspectorFactory.getStandardMapObjectInspector(PrimitiveObjectInspectorFactory.writableDoubleObjectInspector, PrimitiveObjectInspectorFactory.writableLongObjectInspector));
            foi.add(ObjectInspectorFactory.getStandardListObjectInspector(PrimitiveObjectInspectorFactory.writableDoubleObjectInspector));
            foi.add(PrimitiveObjectInspectorFactory.writableBooleanObjectInspector);
            return foi;
        }
    ...
    public static class PercentileContLongCalculator implements PercentileCalculator<LongWritable>
    {
         ...
         */
        public double getPercentile(List<Entry<LongWritable, LongWritable>> entriesList, double position)
        {
