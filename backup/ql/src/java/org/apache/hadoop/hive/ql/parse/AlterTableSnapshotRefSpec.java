...
public class AlterTableSnapshotRefSpec<T>
{
    ...
    {
        return MoreObjects.toStringHelper(this).add("operationType", operationType.name()).add("operationParams", operationParams).toString();
    }
    ...
    public static class CreateSnapshotRefSpec
    {
        ...
        public CreateSnapshotRefSpec(String refName, Long snapShotId, Long asOfTime, Long maxRefAgeMs, Integer minSnapshotsToKeep, Long maxSnapshotAgeMs, String asOfTag)
        {
        ...
        public String toString()
        {
            return MoreObjects.toStringHelper(this).add("refName", refName).add("snapshotId", snapshotId).add("asOfTime", asOfTime).add("maxRefAgeMs", maxRefAgeMs).add("minSnapshotsToKeep", minSnapshotsToKeep).add("maxSnapshotAgeMs", maxSnapshotAgeMs).omitNullValues().toString();
        }
    }
