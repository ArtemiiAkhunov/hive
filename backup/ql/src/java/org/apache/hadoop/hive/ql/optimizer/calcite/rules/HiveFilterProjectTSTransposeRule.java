...
public class HiveFilterProjectTSTransposeRule extends RelOptRule
{
    ...
    public final static HiveFilterProjectTSTransposeRule INSTANCE = new HiveFilterProjectTSTransposeRule(Filter.class, HiveRelFactories.HIVE_FILTER_FACTORY, HiveProject.class, HiveRelFactories.HIVE_PROJECT_FACTORY, TableScan.class, ProjectMergeRule.DEFAULT_BLOAT);

    public final static HiveFilterProjectTSTransposeRule INSTANCE_DRUID = new HiveFilterProjectTSTransposeRule(Filter.class, HiveRelFactories.HIVE_FILTER_FACTORY, HiveProject.class, HiveRelFactories.HIVE_PROJECT_FACTORY, DruidQuery.class, ProjectMergeRule.DEFAULT_BLOAT);

    private final RelFactories.FilterFactory filterFactory;
    private final RelFactories.ProjectFactory projectFactory;
    private final int bloat;

    private HiveFilterProjectTSTransposeRule(Class<? extends Filter> filterClass, FilterFactory filterFactory, Class<? extends Project> projectClass, ProjectFactory projectFactory, Class<? extends RelNode> tsClass, int bloat)
    {
