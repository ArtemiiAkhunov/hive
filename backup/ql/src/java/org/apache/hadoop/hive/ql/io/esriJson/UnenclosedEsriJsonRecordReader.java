...
public class UnenclosedEsriJsonRecordReader extends UnenclosedBaseJsonRecordReader
{
    ...
    public UnenclosedEsriJsonRecordReader() throws IOException
    {  // explicit just to declare exception
        super();
    }

    public UnenclosedEsriJsonRecordReader(org.apache.hadoop.mapred.InputSplit split, Configuration conf) throws IOException
    {
