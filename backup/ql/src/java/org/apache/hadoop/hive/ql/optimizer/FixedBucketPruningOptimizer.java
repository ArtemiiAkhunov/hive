    ...
    public static class BucketBitsetGenerator extends FilterPruner
    {
        ...
        protected void generatePredicate(NodeProcessorCtx procCtx, FilterOperator fop, TableScanOperator top) throws SemanticException
        {
            ...
            if (tbl.isPartitioned())
            {
                ...
                PrunedPartitionList prunedPartList = PartitionPruner.prune(top, ctxt.pctx, top.getConf().getAlias());
        ...
        private boolean addLiteral(List<Object> literals, PredicateLeaf leaf)
        {
            ...
            {
                case EQUALS:
                    return literals.add(convertLiteral(leaf.getLiteral()));
                case IN:
                    return literals.addAll(leaf.getLiteralList().stream().map(l -> convertLiteral(l)).collect(Collectors.toList()));
                default:
                    return false;
            }
        }
        ...
        private Object convertLiteral(Object o)
        {
            ...
            if (o instanceof java.sql.Date)
            {
                ...
                return Date.ofEpochDay(DateWritable.millisToDays(sqlDate.getTime()));
