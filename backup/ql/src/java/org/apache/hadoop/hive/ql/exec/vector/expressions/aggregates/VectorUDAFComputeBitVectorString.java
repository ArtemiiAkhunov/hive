...
public class VectorUDAFComputeBitVectorString extends VectorAggregateExpression
{
    ...
    {
        return name.equals("compute_bit_vector_hll") && inputColVectorType == ColumnVector.Type.BYTES && outputColVectorType == ColumnVector.Type.BYTES && (mode == GenericUDAFEvaluator.Mode.PARTIAL1 || mode == GenericUDAFEvaluator.Mode.COMPLETE);
    }
