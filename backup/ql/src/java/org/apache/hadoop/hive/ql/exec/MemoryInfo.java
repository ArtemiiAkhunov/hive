...
public class MemoryInfo
{
    ...
    public MemoryInfo(Configuration conf)
    {
        ...
        if (isLlap)
        {
            ...
            {
                long memPerInstanceMb = HiveConf.getLongVar(conf, HiveConf.ConfVars.LLAP_DAEMON_MEMORY_PER_INSTANCE_MB);
        ...
        {
            long executorMemoryFromConf = conf.getInt(MRJobConfig.MAP_MEMORY_MB, MRJobConfig.DEFAULT_MAP_MEMORY_MB) * 1024L * 1024L;
    ...
    {
        return "MEMORY INFO - { isTez: " + isTez() + ", isLlap: " + isLlap() + ", maxExecutorMemory: " + LlapUtil.humanReadableByteCount(getMaxExecutorMemory()) + " }";
    }
}