...
public abstract class VectorMapJoinLeftSemiGenerateResultOperator extends VectorMapJoinGenerateResultOperator
{
     ...
     * @param allMatchCount Number of matches in allMatches.
     */
    private int generateHashSetResults(VectorizedRowBatch batch, int[] allMatches, int allMatchCount) throws HiveException, IOException
    {
     ...
     *
     * @param batch The big table batch whose repeated key matches.
     */
