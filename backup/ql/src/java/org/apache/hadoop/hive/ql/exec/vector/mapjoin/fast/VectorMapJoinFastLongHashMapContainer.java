...
public class VectorMapJoinFastLongHashMapContainer extends VectorMapJoinFastHashTableContainerBase implements VectorMapJoinLongHashMap, MemoryEstimate
{
    ...
    public VectorMapJoinFastLongHashMapContainer(boolean isFullOuter, boolean minMaxEnabled, HashTableKeyType hashTableKeyType, int initialCapacity, float loadFactor, int writeBuffersSize, long estimatedKeyCount, TableDesc tableDesc, int numHTs)
    {
        ...
        {
            vectorMapJoinFastLongHashMaps[i] = new VectorMapJoinFastLongHashMap(isFullOuter, minMaxEnabled, hashTableKeyType, initialCapacity, loadFactor, writeBuffersSize, estimatedKeyCount, tableDesc);
        }
    ...
    public static class NonMatchedLongHashMapIterator extends VectorMapJoinFastNonMatchedIterator
    {
        ...
        private NonMatchedLongHashMapIterator(MatchTracker matchTracker, VectorMapJoinFastLongHashMap[] vectorMapJoinFastLongHashMaps, int numThreads)
        {
            ...
            for (int i = 0; i < numThreads; ++i)
            {
                hashMapIterators[i] = new VectorMapJoinFastLongHashMap.NonMatchedLongHashMapIterator(matchTracker.getPartition(i), vectorMapJoinFastLongHashMaps[i]);
            }
            index = 0;
    ...
    public JoinUtil.JoinResult lookup(long key, VectorMapJoinHashMapResult hashMapResult, MatchTracker matchTracker)
    {
        ...
        return vectorMapJoinFastLongHashMaps[partition].lookup(key, hashMapResult, childMatchTracker);
    }
