...
public class GenericUDFArrayRemove extends AbstractGenericUDFArrayBase
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        {
            throw new UDFArgumentTypeException(VALUE_IDX, String.format("%s type element is expected at function array_remove(array<%s>,%s), but %s is found", arrayElementOI.getTypeName(), arrayElementOI.getTypeName(), arrayElementOI.getTypeName(), valueOI.getTypeName()));
        }
        return defaultOI;
    }
