...
public class HiveSqlSumEmptyIsZeroAggFunction extends SqlAggFunction
{
    ...
    public HiveSqlSumEmptyIsZeroAggFunction(boolean isDistinct, SqlReturnTypeInference returnTypeInference, SqlOperandTypeInference operandTypeInference, SqlOperandTypeChecker operandTypeChecker)
    {
        super("$SUM0", null, SqlKind.SUM0, returnTypeInference, operandTypeInference, operandTypeChecker, SqlFunctionCategory.NUMERIC, false, false);
    }
