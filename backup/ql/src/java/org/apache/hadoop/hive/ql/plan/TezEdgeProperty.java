...
public class TezEdgeProperty
{
    ...
    {//todo: HIVE-15549
        ...
        BROADCAST_EDGE, CONTAINS,//used for union (all?)
        CUSTOM_EDGE,//CO_PARTITION_EDGE
        CUSTOM_SIMPLE_EDGE,//PARTITION_EDGE
        ONE_TO_ONE_EDGE, XPROD_EDGE
    }
    ...
    public TezEdgeProperty(HiveConf hiveConf, EdgeType edgeType, boolean isAutoReduce, boolean isSlowStart, int minReducer, int maxReducer, long bytesPerReducer, float minSrcFraction, float maxSrcFraction)
    {
