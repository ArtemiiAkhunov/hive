...
public class ReplStateLogWork implements Serializable
{
    ...
    {
        TABLE, FUNCTION, EVENT, END, DATA_COPY_END
    }
    ...
    public void replStateLog() throws SemanticException
    {
        switch (logType)
        {
            ...
            case END:
                ...
                {
                    metricCollector.reportStageEnd("REPL_LOAD", Status.SUCCESS, Long.parseLong(lastReplId), new SnapshotUtils.ReplSnapshotCount(), replLogger.getReplStatsTracker());
                }
