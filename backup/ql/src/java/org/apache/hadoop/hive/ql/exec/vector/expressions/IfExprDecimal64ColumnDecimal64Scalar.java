...
public class IfExprDecimal64ColumnDecimal64Scalar extends IfExprLongColumnLongScalar
{
    ...
    public IfExprDecimal64ColumnDecimal64Scalar(int arg1Column, int arg2Column, long arg3Scalar, int outputColumnNum)
    {
    ...
    public String vectorExpressionParameters()
    {
        ...
        return getColumnParamString(0, inputColumnNum[0]) + ", " + getColumnParamString(1, inputColumnNum[1]) + ", decimal64Val " + arg3Scalar + ", decimalVal " + writable.toString();
    }
