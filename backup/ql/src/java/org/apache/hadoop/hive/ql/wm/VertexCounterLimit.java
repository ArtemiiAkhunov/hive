...
public class VertexCounterLimit implements CounterLimit
{
    ...
    {
        DAG_TOTAL_TASKS, DAG_GROUPED_INPUT_SPLITS, DAG_INPUT_DIRECTORIES, DAG_INPUT_FILES, DAG_RAW_INPUT_SPLITS, VERTEX_TOTAL_TASKS, VERTEX_GROUPED_INPUT_SPLITS, VERTEX_INPUT_DIRECTORIES, VERTEX_INPUT_FILES, VERTEX_RAW_INPUT_SPLITS
    }
