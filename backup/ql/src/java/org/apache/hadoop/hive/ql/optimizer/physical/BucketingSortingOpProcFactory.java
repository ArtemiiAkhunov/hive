...
public class BucketingSortingOpProcFactory
{
     ...
     */
    private static void setBucketingColsIfComplete(BucketingSortingCtx bctx, Operator<? extends OperatorDesc> op, BucketCol[] newBucketCols)
    {
     ...
     *                    the method findBucketingSortingColumns
     */
    private static void setSortingColsIfComplete(BucketingSortingCtx bctx, Operator<? extends OperatorDesc> op, SortCol[] newSortCols)
    {
    ...
    private static void findBucketingSortingColumns(List<ExprNodeDesc> exprs, List<ColumnInfo> colInfos, List<BucketCol> bucketCols, List<SortCol> sortCols, BucketCol[] newBucketCols, SortCol[] newSortCols)
    {
        findBucketingSortingColumns(exprs, colInfos, bucketCols, sortCols, newBucketCols, newSortCols, 0);
    }
    ...
    public static class GroupByInferrer extends DefaultInferrer implements SemanticNodeProcessor
    {
        ...
        protected Object processGroupBy(Operator<? extends OperatorDesc> parent, GroupByOperator gop, BucketingSortingCtx bctx)
        {
            ...
            findBucketingSortingColumns(gop.getConf().getKeys(), colInfos, bucketCols, sortCols, newBucketCols, newSortCols);
    ...
    public static class ForwardingInferrer extends DefaultInferrer implements SemanticNodeProcessor
    {
        ...
        public Object process(Node nd, Stack<Node> stack, NodeProcessorCtx procCtx, Object... nodeOutputs) throws SemanticException
        {
            ...
            processForward((Operator<? extends OperatorDesc>) nd, (BucketingSortingCtx) procCtx, getParent(stack));
