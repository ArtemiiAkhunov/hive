...
public final class ConstraintsUtils
{
    ...
    public static void processCheckConstraints(TableName tableName, ASTNode child, List<String> columnNames, List<SQLCheckConstraint> checkConstraints, final ASTNode typeChild, final TokenRewriteStream tokenRewriteStream) throws SemanticException
    {
    ...
    public static void processDefaultConstraints(TableName tableName, ASTNode child, List<String> columnNames, List<SQLDefaultConstraint> defaultConstraints, final ASTNode typeChild, TokenRewriteStream tokenRewriteStream) throws SemanticException
    {
    ...
    private static List<ConstraintInfo> generateConstraintInfos(ASTNode child, List<String> columnNames, ASTNode typeChildForDefault, TokenRewriteStream tokenRewriteStream) throws SemanticException
    {
        ...
        for (int i = 0; i < child.getChildCount(); i++)
        {
            ...
            } else if (childType == HiveParser.TOK_CHECK_CONSTRAINT)
            {
                ...
                checkOrDefaultValue = tokenRewriteStream.toString(CHECK_CONSTRAINT_PROGRAM, grandChild.getTokenStartIndex(), grandChild.getTokenStopIndex());
            }
        }
