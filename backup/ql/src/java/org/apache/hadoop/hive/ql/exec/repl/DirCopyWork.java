...
public class DirCopyWork implements Serializable, StringConvertibleObject
{
    ...
    {
        return "DirCopyWork{" + "fullyQualifiedSourcePath=" + getFullyQualifiedSourcePath() + ", fullyQualifiedTargetPath=" + getFullyQualifiedTargetPath() + ", tableName=" + tableName + ", copyMode=" + getCopyMode() + ", snapshotPrefix=" + getSnapshotPrefix() + '}';
    }
    ...
    public String convertToString()
    {
        ...
        objInStr.append(fullyQualifiedSourcePath).append(URI_SEPARATOR).append(fullyQualifiedTargetPath).append(URI_SEPARATOR).append(tableName).append(URI_SEPARATOR).append(copyMode).append(URI_SEPARATOR).append(snapshotPrefix);
