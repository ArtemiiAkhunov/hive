    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        switch (((PrimitiveObjectInspector) arguments[0]).getPrimitiveCategory())
        {
            case INTERVAL_YEAR_MONTH:
                ...
                converters[0] = ObjectInspectorConverters.getConverter(arguments[0], PrimitiveObjectInspectorFactory.writableHiveIntervalYearMonthObjectInspector);
                break;
            case STRING:
            case CHAR:
            case VARCHAR:
