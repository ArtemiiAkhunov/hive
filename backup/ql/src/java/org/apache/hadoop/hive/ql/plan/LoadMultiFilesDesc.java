...
public class LoadMultiFilesDesc implements Serializable
{
    ...
    public LoadMultiFilesDesc(final List<Path> sourceDirs, final List<Path> targetDir, final boolean isDfsDir, final String columns, final String columnTypes)
    {
        this(sourceDirs, targetDir, null, isDfsDir, columns, columnTypes);
    }

    public LoadMultiFilesDesc(final List<Path> sourceDirs, final List<Path> targetDir, List<String> targetPrefixes, final boolean isDfsDir, final String columns, final String columnTypes)
    {
