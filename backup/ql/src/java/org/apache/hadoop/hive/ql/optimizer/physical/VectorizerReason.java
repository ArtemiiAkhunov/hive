...
public class VectorizerReason
{
    ...
    {
        NONE, NODE_ISSUE, OPERATOR_ISSUE, EXPRESSION_ISSUE
    }
    ...
    public String toString()
    {
        ...
        switch (vectorizerNodeIssue)
        {
            case NODE_ISSUE:
                ...
                break;
            case OPERATOR_ISSUE:
                reason = (operator == null ? "Unknown" : operator.getType()) + " operator: " + (issue == null ? "unknown" : issue);
                break;
            case EXPRESSION_ISSUE:
                reason = expressionTitle + " expression for " + (operator == null ? "Unknown" : operator.getType()) + " operator: " + (issue == null ? "unknown" : issue);
                break;
            default:
