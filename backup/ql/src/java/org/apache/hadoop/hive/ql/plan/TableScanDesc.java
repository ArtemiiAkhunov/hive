...
public class TableScanDesc extends AbstractOperatorDesc implements IStatsGatherDesc
{
    ...
    public static final String PARTITION_PRUNING_FILTER = "hive.io.pruning.filter";

    public static final String AS_OF_TIMESTAMP = "hive.io.as.of.timestamp";

    public static final String AS_OF_VERSION = "hive.io.as.of.version";

    public static final String FROM_VERSION = "hive.io.version.from";

    public static final String SNAPSHOT_REF = "hive.io.snapshot.ref";
    ...
    public TableScanDesc(final String alias, List<VirtualColumn> vcs, Table tblMetadata, TableScanOperator.ProbeDecodeContext probeDecodeContext)
    {
        this.alias = alias;
    ...
    {
        boolean rtn = false;
        if (tableMetadata != null && tableMetadata.getTTable() != null && TextInputFormat.class.isAssignableFrom(tableMetadata.getInputFormatClass()))
        {
    ...
    public Map<String, String> getOpPropsWithStorageHandlerProps()
    {
        ...
        return storageHandler == null ? opProps : storageHandler.getOperatorDescProperties(this, opProps);
    }
    ...
    public class TableScanOperatorExplainVectorization extends OperatorExplainVectorization
    {
        ...
        public String getSchemaColumns()
        {
            ...
            DataTypePhysicalVariation[] projectedColumnDataTypePhysicalVariations = vectorTableScanDesc.getProjectedColumnDataTypePhysicalVariations();

            return BaseExplainVectorization.getColumnAndTypes(projectionColumns, projectedColumnNames, projectedColumnTypeInfos, projectedColumnDataTypePhysicalVariations).toString();
        }
    }
    ...
    public boolean isSame(OperatorDesc other)
    {
        if (getClass().getName().equals(other.getClass().getName()))
        {
            ...
            return Objects.equals(getQualifiedTable(), otherDesc.getQualifiedTable()) && ExprNodeDescUtils.isSame(getFilterExpr(), otherDesc.getFilterExpr()) && getRowLimit() == otherDesc.getRowLimit() && isGatherStats() == otherDesc.isGatherStats();
        }
        return false;
    }
