...
public final class MapJoinFactory
{
    ...
    public static int getPositionParent(AbstractMapJoinOperator<? extends MapJoinDesc> op, Stack<Node> stack)
    {
        ...
        Operator<? extends OperatorDesc> parent = (Operator<? extends OperatorDesc>) stack.get(size - 2);
    ...
    private static class TableScanMapJoinProcessor implements SemanticNodeProcessor
    {
         ...
         */
        private static void initMapJoinPlan(AbstractMapJoinOperator<? extends MapJoinDesc> op, Task<?> currTask, GenMRProcContext opProcCtx, boolean local) throws SemanticException
        {
         ...
         * @param oldTask   the old task for the current mapjoin
         * @param opProcCtx processing context
         * @param pos       position of the parent in the stack
         */
        private static void joinMapJoinPlan(Task<?> oldTask, GenMRProcContext opProcCtx, boolean local) throws SemanticException
        {
            TableScanOperator currTopOp = opProcCtx.getCurrTopOp();
