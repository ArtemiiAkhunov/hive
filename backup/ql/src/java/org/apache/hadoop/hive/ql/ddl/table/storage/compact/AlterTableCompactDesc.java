...
public class AlterTableCompactDesc extends AbstractAlterTableDesc implements DDLDescWithWriteId
{
    ...
    public AlterTableCompactDesc(TableName tableName, Map<String, String> partitionSpec, String compactionType, boolean isBlocking, String poolName, int numberOfBuckets, Map<String, String> properties, String orderByClause) throws SemanticException
    {
    ...
    @Explain(displayName = "blocking", displayOnlyOnTrue = true, explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED})
