...
public class ExplainWork implements Serializable
{
    ...
    public ExplainWork(Path resFile, ParseContext pCtx, List<Task<?>> rootTasks, Task<?> fetchTask, ASTNode astTree, BaseSemanticAnalyzer analyzer, ExplainConfiguration config, String cboInfo, String optimizedSQL, String cboPlan)
    {
