    ...
    public InputSplit[] getSplits(JobConf job, int numSplits) throws IOException
    {
        ...
        for (Path dir : dirs)
        {
            ...
            } else
            {
                ...
                processPathsForMmRead(Lists.newArrayList(dir), newjob, mmIds, finalDirs, dirsWithMmOriginals);
            }
            ...
            for (Path finalDir : finalDirs)
            {
                ...
                {
                    numOrigSplits = addBHISplit(status, inputFormat, inputFormatClass, numOrigSplits, newjob, result);
                }
            }
