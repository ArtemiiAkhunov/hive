...
@VectorizedExpressions({CastLongToTimestamp.class, CastDateToTimestamp.class, CastDoubleToTimestamp.class, CastDecimalToTimestamp.class, CastStringToTimestamp.class})
public class GenericUDFTimestamp extends GenericUDF
{
    ...
    public void configure(MapredContext context)
    {
        ...
        intToTimestampInSeconds = HiveConf.getBoolVar(context.getJobConf(), ConfVars.HIVE_INT_TIMESTAMP_CONVERSION_IN_SECONDS);
    }

    @Override
    public Object evaluate(DeferredObject[] arguments) throws HiveException
    {
        PrimitiveObjectInspectorConverter.TimestampConverter ts = (PrimitiveObjectInspectorConverter.TimestampConverter) tsConvertors[0];
