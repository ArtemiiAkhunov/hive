...
public class VectorInBloomFilterColDynamicValue extends VectorExpression
{
    ...
    private void initValue()
    {
        try
        {
            bloomFilter = (BloomKFilter) runtimeCache.retrieve(bloomFilterDynamicValue.getId(), new Callable<Object>()
            {
                @Override
                public Object call() throws IOException
                {
                    ...
                    try
                    {
                        ...
                        LOG.info("Starting BloomKFilter deserialization for id: {}...", bloomFilterDynamicValue.getId());
