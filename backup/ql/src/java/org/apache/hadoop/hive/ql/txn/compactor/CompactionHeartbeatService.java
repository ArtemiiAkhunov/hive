...
public class CompactionHeartbeatService
{
    ...
    private final class CompactionHeartbeater
    {
        ...
        private CompactionHeartbeater(long txnId, long lockId, String tableName)
        {
            ...
            heartbeatExecutor.setThreadFactory(new ThreadFactoryBuilder().setPriority(Thread.MIN_PRIORITY).setDaemon(true).setNameFormat("CompactionTxnHeartbeater-" + txnId).build());
