...
public class GenericUDFInFile extends GenericUDF
{
    ...
    {
        return new String[]{ObjectInspectorUtils.getWritableConstantValue(fileObjectInspector).toString()};
    }
    ...
    public Object evaluate(DeferredObject[] arguments) throws HiveException
    {
        ...
        String str = ObjectInspectorUtils.copyToStandardJavaObject(arguments[0].get(), strObjectInspector).toString();

        if (set == null)
        {
            String filePath = (String) ObjectInspectorUtils.copyToStandardJavaObject(arguments[1].get(), fileObjectInspector);
