...
public class GenericUDFInternalInterval extends GenericUDF
{
    ...
    public Object evaluate(DeferredObject[] arguments) throws HiveException
    {
        ...
        {
            throw new UDFArgumentTypeException(1, "Error parsing interval " + argString + " using:" + processor.getClass().getSimpleName());
        }
    }
    ...
    private Map<Integer, IntervalProcessor> getProcessorMap()
    {
        ...
        IntervalProcessor ips[] = new IntervalProcessor[]{new IntervalDayTimeLiteralProcessor(),

                new IntervalDayLiteralProcessor(), new IntervalHourLiteralProcessor(), new IntervalMinuteLiteralProcessor(), new IntervalSecondLiteralProcessor(),

                new IntervalYearMonthLiteralProcessor(),

                new IntervalYearLiteralProcessor(), new IntervalMonthLiteralProcessor(),};
