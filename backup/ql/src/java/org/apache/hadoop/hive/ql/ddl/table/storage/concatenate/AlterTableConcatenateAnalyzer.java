...
public class AlterTableConcatenateAnalyzer extends AbstractAlterTableAnalyzer
{
    ...
    protected void analyzeCommand(TableName tableName, Map<String, String> partitionSpec, ASTNode command) throws SemanticException
    {
        ...
        } else
        {
            ...
            if (table.getTableType() != TableType.MANAGED_TABLE)
            {
                ...
                if (!conf.getBoolVar(ConfVars.CONCATENATE_EXTERNAL_TABLE) || table.getTableType() != TableType.EXTERNAL_TABLE)
                {
    ...
    private void compactAcidTable(TableName tableName, Map<String, String> partitionSpec, String poolName) throws SemanticException
    {
        ...
        AlterTableCompactDesc desc = new AlterTableCompactDesc(tableName, partitionSpec, CompactionType.MAJOR.name(), isBlocking, poolName, 0, null, null);
    ...
    private void concatenatePartitionedTable(TableName tableName, Table table, Map<String, String> partitionSpec) throws SemanticException
    {
        ...
        ListBucketingCtx lbCtx = constructListBucketingCtx(part.getSkewedColNames(), part.getSkewedColValues(), part.getSkewedColValueLocationMaps(), part.isStoredAsSubDirectories());
        ...
        createConcatenateTasks(tableName, table, partitionSpec, oldLocation, newLocation, lbCtx, bucketCols, inputFormatClass);
    }
    ...
    private void createConcatenateTasks(TableName tableName, Table table, Map<String, String> partitionSpec, Path oldLocation, Path newLocation, ListBucketingCtx lbCtx, List<String> bucketCols, Class<? extends InputFormat> inputFormatClass) throws SemanticException
    {
        ...
        Task<?> mergeTask = createMergeTask(tableName, table, partitionSpec, oldLocation, lbCtx, inputFormatClass, queryTmpDir);
    ...
    @SuppressWarnings("rawtypes")
    private Task<?> createMergeTask(TableName tableName, Table table, Map<String, String> partitionSpec, Path oldLocation, ListBucketingCtx lbCtx, Class<? extends InputFormat> inputFormatClass, Path queryTmpDir) throws SemanticException
    {
