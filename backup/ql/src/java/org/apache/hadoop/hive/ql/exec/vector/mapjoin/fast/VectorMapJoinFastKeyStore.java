...
public class VectorMapJoinFastKeyStore implements MemoryEstimate
{
    ...
    public boolean equalKey(long keyRefWord, byte[] keyBytes, int keyStart, int keyLength, WriteBuffers.Position readPos)
    {
        ...
        int storedKeyLength = (int) ((keyRefWord & SmallKeyLength.bitMask) >> SmallKeyLength.bitShift);
    ...
    public void getKey(long keyRefWord, ByteSegmentRef keyByteSegmentRef, WriteBuffers.Position readPos)
    {
