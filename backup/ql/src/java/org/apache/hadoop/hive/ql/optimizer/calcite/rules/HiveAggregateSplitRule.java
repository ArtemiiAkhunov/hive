...
public class HiveAggregateSplitRule extends RelOptRule
{
    ...
    {
        super(operandJ(aggregateClass, null, agg -> agg.getGroupType() != Group.SIMPLE, any()), relBuilderFactory, null);
    }
    ...
    public void onMatch(RelOptRuleCall call)
    {
        ...
        final Boolean isUnique = aggregate.getCluster().getMetadataQuery().areColumnsUnique(aggregate.getInput(), bottomAggregateGroupSet);
