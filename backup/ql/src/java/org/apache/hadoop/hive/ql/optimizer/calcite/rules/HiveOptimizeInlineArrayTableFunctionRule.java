...
public class HiveOptimizeInlineArrayTableFunctionRule extends RelOptRule
{
    ...
    public void onMatch(RelOptRuleCall call)
    {
        ...
        List<RexNode> inputRefs = Lists.transform(inputRel.getRowType().getFieldList(), input -> new RexInputRef(input.getIndex(), input.getType()));
        ...
        List<RelDataType> returnTypes = new ArrayList<>(Lists.transform(inputRel.getRowType().getFieldList(), RelDataTypeField::getType));
        ...
        final RelNode newTableFunctionScanNode = tfs.copy(tfs.getTraitSet(), tfs.getInputs(), newInlineCall, tfs.getElementType(), tfs.getRowType(), Collections.emptySet());
