...
public class LlapPluginEndpointClientImpl extends AsyncPbRpcProxy<LlapPluginProtocolPB, JobTokenIdentifier> implements LlapPluginEndpointClient
{
     ...
     */
    @Override
    public void sendUpdateQuery(UpdateQueryRequestProto request, AmPluginNode node, UpdateRequestContext callback)
    {
        queueRequest(new SendUpdateQueryCallable(node, request, callback));
    }

    private class SendUpdateQueryCallable extends CallableRequest<UpdateQueryRequestProto, UpdateQueryResponseProto>
    {
        private final AmPluginNode node;
        private AmPluginInfo info;
        private final UpdateRequestContext context;

        protected SendUpdateQueryCallable(AmPluginNode node, UpdateQueryRequestProto request, UpdateRequestContext callback)
        {
