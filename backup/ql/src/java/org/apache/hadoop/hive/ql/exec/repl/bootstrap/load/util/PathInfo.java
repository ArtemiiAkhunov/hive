...
public class PathInfo
{
    ...
    Path computeStagingDir(Path inputPath)
    {
        ...
        final String key = fileSystemAsString + "-" + stagingPathName + "-" + TaskRunner.getTaskRunnerID();
        ...
        try
        {
            ...
            if (dir == null)
            {
                ...
                Path path = new Path(stagingPathName + "_" + generateExecutionId() + "-" + TaskRunner.getTaskRunnerID());
