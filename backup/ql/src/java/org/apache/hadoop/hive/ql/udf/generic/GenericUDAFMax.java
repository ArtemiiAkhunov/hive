...
public class GenericUDAFMax extends AbstractGenericUDAFResolver
{
    ...
    @VectorizedUDAFs({VectorUDAFMaxLong.class, VectorUDAFMaxDouble.class, VectorUDAFMaxDecimal.class, VectorUDAFMaxDecimal64.class, VectorUDAFMaxTimestamp.class, VectorUDAFMaxIntervalDayTime.class, VectorUDAFMaxString.class})
