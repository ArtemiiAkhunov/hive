...
public class StorageBasedAuthorizationProvider extends HiveAuthorizationProviderBase implements HiveMetastoreAuthorizationProvider
{
    ...
    protected void checkDeletePermission(Path dataLocation, Configuration conf, String userName) throws HiveException
    {
        try
        {
    ...
    protected static void checkPermissions(final FileSystem fs, final FileStatus stat, final EnumSet<FsAction> actions, String user) throws IOException, AccessControlException, HiveException
    {
