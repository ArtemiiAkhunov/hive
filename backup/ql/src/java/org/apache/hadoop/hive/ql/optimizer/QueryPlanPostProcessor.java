...
public class QueryPlanPostProcessor
{
    ...
    public QueryPlanPostProcessor(List<Task<?>> rootTasks, Set<FileSinkDesc> acidSinks, String executionId)
    {
        for (Task<?> t : rootTasks)
        {
            ...
            } else if (work instanceof ReplLoadWork || work instanceof ReplStateLogWork || work instanceof GenTezWork || work instanceof ArchiveWork || work instanceof ColumnStatsUpdateWork || work instanceof BasicStatsWork || work instanceof ConditionalWork || work instanceof CopyWork || work instanceof DDLWork || work instanceof DependencyCollectionWork || work instanceof ExplainSQRewriteWork || work instanceof FetchWork || work instanceof MoveWork || work instanceof BasicStatsNoJobWork || work instanceof StatsWork)
            {
