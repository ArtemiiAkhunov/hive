...
public class BootstrapLoadFunction extends ReplState
{
    ...
    public BootstrapLoadFunction(String dbName, String funcName, long functionSeqNo, long numFunctions)
    {
        this.dbName = dbName;
        this.functionName = funcName;
        this.functionsLoadProgress = new String(new StringBuilder().append(functionSeqNo).append("/").append(numFunctions));
