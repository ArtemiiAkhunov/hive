...
public class OrcFileMerger
{
    ...
    {
        OrcFile.WriterOptions options = OrcFile.writerOptions(conf).compress(reader.getCompression()).version(reader.getFileVersion()).rowIndexStride(reader.getRowIndexStride()).inspector(reader.getObjectInspector());
