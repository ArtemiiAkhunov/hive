...
public class VectorUDFDateAddColCol extends VectorExpression
{
    ...
    public void transientInit(Configuration conf) throws HiveException
    {
        ...
        primitiveCategory = ((PrimitiveTypeInfo) inputTypeInfos[0]).getPrimitiveCategory();
    }
    ...
    public void evaluate(VectorizedRowBatch batch) throws HiveException
    {
        ...
        switch (primitiveCategory)
        {
            case DATE:
                ...
                {
                    evaluateRepeatedDate(inputColVector1, vector2, outV, batch.selectedInUse, batch.selected, n);
            ...
            case TIMESTAMP:
                ...
                {
                    evaluateRepeatedTimestamp(inputColVector1, vector2, outV, batch.selectedInUse, batch.selected, n);
                } else if (inputColVector2.isRepeating)
                {
                    final long repeatedNumDays = vector2[0];
                    if (batch.selectedInUse)
            ...
            case VARCHAR:
                ...
                {
                    evaluateRepeatedString((BytesColumnVector) inputColVector1, vector2, outV, batch.selectedInUse, batch.selected, n);
                } else if (inputColVector2.isRepeating)
                {
                    final long repeatedNumDays = vector2[0];
                    if (batch.selectedInUse)
