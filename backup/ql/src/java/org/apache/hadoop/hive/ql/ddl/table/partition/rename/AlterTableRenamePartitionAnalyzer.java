...
public class AlterTableRenamePartitionAnalyzer extends AbstractAlterTableAnalyzer
{
    ...
    protected void analyzeCommand(TableName tableName, Map<String, String> partitionSpec, ASTNode command) throws SemanticException
    {
        ...
        boolean clonePart = HiveConf.getBoolVar(conf, ConfVars.HIVE_ACID_RENAME_PARTITION_MAKE_COPY) || HiveConf.getBoolVar(conf, ConfVars.HIVE_ACID_LOCKLESS_READS_ENABLED) && AcidUtils.isTransactionalTable(table);

        PartitionUtils.addTablePartsOutputs(db, outputs, table, allPartitionSpecs, false, clonePart ? WriteType.DDL_EXCL_WRITE : WriteType.DDL_EXCLUSIVE);
