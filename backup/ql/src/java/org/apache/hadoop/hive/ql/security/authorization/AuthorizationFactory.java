...
public class AuthorizationFactory
{
    ...
    public static <T> T create(final Object delegated, final Class<T> itface, final AuthorizationExceptionHandler handler)
    {
    ...
    {
        void exception(Exception exception) throws AuthorizationException, HiveAuthzPluginException, HiveAccessControlException;
    }
