...
public class VectorMapJoinFastBytesHashMultiSetStore implements MemoryEstimate
{
    ...
    public static class HashMultiSetResult extends VectorMapJoinHashMultiSetResult
    {
        ...
        public void setContains()
        {
            ...
            {
                count = multiSetStore.writeBuffers.readInt(absoluteOffset - MultiSetCount.byteLength, readPos);
            }
    ...
    public long bumpCount(long refWord, WriteBuffers.Position unsafeReadPos)
    {
         ...
         */
        final long countAbsoluteOffset = KeyRef.getAbsoluteOffset(refWord) - MultiSetCount.byteLength;

        final int currentCount = writeBuffers.readInt(countAbsoluteOffset, unsafeReadPos);
        ...
        writeBuffers.writeInt(countAbsoluteOffset, currentCount + 1);
