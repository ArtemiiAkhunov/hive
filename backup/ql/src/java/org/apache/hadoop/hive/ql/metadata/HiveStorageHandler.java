...
public interface HiveStorageHandler extends Configurable
{
    ...
    List<AlterTableType> DEFAULT_ALLOWED_ALTER_OPS = ImmutableList.of(AlterTableType.ADDPROPS, AlterTableType.DROPPROPS, AlterTableType.ADDCOLS);
    ...
    default boolean addDynamicSplitPruningEdge(org.apache.hadoop.hive.ql.metadata.Table table, ExprNodeDesc syntheticFilterPredicate)
    {
        return false;
    }
     ...
     * @throws SemanticException in case of any error
     */
    default void appendFiles(Table tbl, URI fromURI, boolean isOverwrite, Map<String, String> partitionSpec) throws SemanticException
    {
     ...
     */
    default void setTableParametersForCTLT(org.apache.hadoop.hive.ql.metadata.Table tbl, CreateTableLikeDesc desc, Map<String, String> origParams)
    {
    }
    ...
    {
        NONE, WITH_TRANSACTIONS, WITHOUT_TRANSACTIONS
    }
     ...
     */
    default DynamicPartitionCtx createDPContext(HiveConf conf, org.apache.hadoop.hive.ql.metadata.Table table, Operation writeOperation) throws SemanticException
    {
    ...
    default org.apache.hadoop.hive.ql.metadata.Table checkAndSetTableMetaRef(org.apache.hadoop.hive.ql.metadata.Table hmsTable, String tableMetaRef) throws SemanticException
    {
        return null;
    }
    ...
    default void alterTableSnapshotRefOperation(org.apache.hadoop.hive.ql.metadata.Table table, AlterTableSnapshotRefSpec alterTableSnapshotRefSpec)
    {
    }
     ...
     */
    default void prepareAlterTableEnvironmentContext(AbstractAlterTableDesc alterTableDesc, EnvironmentContext environmentContext)
    {
    }
     ...
     * @throws HiveException
     */
    default List<String> showPartitions(DDLOperationContext context, org.apache.hadoop.hive.ql.metadata.Table tbl) throws UnsupportedOperationException, HiveException
    {
        throw new UnsupportedOperationException("Storage handler does not support show partitions command");
    }

    default void validatePartSpec(org.apache.hadoop.hive.ql.metadata.Table hmsTable, Map<String, String> partitionSpec) throws SemanticException
    {
        throw new UnsupportedOperationException("Storage handler does not support validation of partition values");
    }

    default boolean canUseTruncate(org.apache.hadoop.hive.ql.metadata.Table hmsTable, Map<String, String> partitionSpec) throws SemanticException
    {
        return true;
    }

    default List<String> getPartitionNames(org.apache.hadoop.hive.ql.metadata.Table hmsTable, Map<String, String> partitionSpec) throws SemanticException
    {
        throw new UnsupportedOperationException("Storage handler does not support getting partitions " + "by a partition specification.");
    }
    ...
    {
        throw new UnsupportedOperationException("Storage handler does not support getting column type " + "for a specific column.");
    }

    default boolean canPerformMetadataDelete(org.apache.hadoop.hive.ql.metadata.Table hmsTable, String branchName, SearchArgument searchArgument)
    {
        return false;
    }
    ...
    default List<Partition> getPartitionsByExpr(org.apache.hadoop.hive.ql.metadata.Table hmsTable, ExprNodeDesc desc) throws SemanticException
    {
        throw new UnsupportedOperationException("Storage handler does not support getting partitions by expression " + "for a table.");
    }
}
