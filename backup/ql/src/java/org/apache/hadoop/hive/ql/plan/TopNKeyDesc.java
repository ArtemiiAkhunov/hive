...
public class TopNKeyDesc extends AbstractOperatorDesc
{
    ...
    public TopNKeyDesc(final int topN, final String columnSortOrder, final String nullOrder, final List<ExprNodeDesc> keyColumns, final List<ExprNodeDesc> partitionKeyColumns, float efficiencyThreshold, long checkEfficiencyNumBatches, int maxNumberOfPartitions)
    {
    ...
    {
        return new TopNKeyDesc(topN, commonKeyPrefix.getMappedOrder(), commonKeyPrefix.getMappedNullOrder(), commonKeyPrefix.getMappedColumns(), commonKeyPrefix.getMappedColumns().subList(0, partitionKeyColumns.size()), efficiencyThreshold, checkEfficiencyNumBatches, maxNumberOfPartitions);
    }

    public TopNKeyDesc withKeyColumns(int prefixLength)
    {
        return new TopNKeyDesc(topN, columnSortOrder, nullOrder, keyColumns.subList(0, prefixLength), partitionKeyColumns, efficiencyThreshold, checkEfficiencyNumBatches, maxNumberOfPartitions);
    }
