...
public abstract class GenericUDF implements Closeable
{
    ...
    protected void checkArgPrimitive(ObjectInspector[] arguments, int i) throws UDFArgumentTypeException
    {
        ...
        {
            throw new UDFArgumentTypeException(i, getFuncName() + " only takes primitive types as " + getArgOrder(i) + " argument, got " + oiCat);
        }
    }
    ...
    protected void obtainLongConverter(ObjectInspector[] arguments, int i, PrimitiveCategory[] inputTypes, Converter[] converters) throws UDFArgumentTypeException
    {
        ...
        switch (inputType)
        {
            ...
            case VOID:
                break;
            default:
                throw new UDFArgumentTypeException(i, getFuncName() + " only takes LONG/INT/SHORT/BYTE types as " + getArgOrder(i) + " argument, got " + inputType);
        }

        Converter converter = ObjectInspectorConverters.getConverter(arguments[i], PrimitiveObjectInspectorFactory.writableLongObjectInspector);
        converters[i] = converter;
        inputTypes[i] = inputType;
    }
    ...
    protected void obtainDateConverter(ObjectInspector[] arguments, int i, PrimitiveCategory[] inputTypes, Converter[] converters) throws UDFArgumentTypeException
    {
        ...
        switch (inputType)
        {
            ...
            case TIMESTAMPLOCALTZ:
                break;
            default:
                throw new UDFArgumentTypeException(i, getFuncName() + " only takes STRING_GROUP/DATE_GROUP/VOID_GROUP types as " + getArgOrder(i) + " argument, got " + inputType);
        }
    ...
    protected void obtainTimestampConverter(ObjectInspector[] arguments, int i, PrimitiveCategory[] inputTypes, Converter[] converters) throws UDFArgumentTypeException
    {
        ...
        switch (inputType)
        {
            ...
            case BYTE:
                break;
            default:
                throw new UDFArgumentTypeException(i, getFuncName() + " only takes STRING_GROUP/DATE_GROUP/NUMERIC_GROUP/VOID_GROUP/BOOLEAN_GROUP types as " + getArgOrder(i) + " argument, got " + inputType);
        }
    ...
    protected String getStringValue(DeferredObject[] arguments, int i, Converter[] converters) throws HiveException
    {
        Object obj;
    ...
    protected Integer getIntValue(DeferredObject[] arguments, int i, Converter[] converters) throws HiveException
    {
        Object obj;
        if ((obj = arguments[i].get()) == null)
        {
    ...
    protected Long getLongValue(DeferredObject[] arguments, int i, Converter[] converters) throws HiveException
    {
        Object obj;
        if ((obj = arguments[i].get()) == null)
        {
    ...
    protected Double getDoubleValue(DeferredObject[] arguments, int i, Converter[] converters) throws HiveException
    {
        Object obj;
        if ((obj = arguments[i].get()) == null)
        {
    ...
    protected Date getDateValue(DeferredObject[] arguments, int i, Converter[] converters) throws HiveException
    {
        Object obj;
        if ((obj = arguments[i].get()) == null)
        {
    ...
    protected HiveIntervalDayTime getIntervalDayTimeValue(DeferredObject[] arguments, int i, PrimitiveCategory[] inputTypes, Converter[] converters) throws HiveException
    {
        Object obj;
        if ((obj = arguments[i].get()) == null)
        {
        ...
        switch (inputTypes[i])
        {
            ...
            case INTERVAL_DAY_TIME:
                ...
                break;
            default:
                throw new UDFArgumentTypeException(0, getFuncName() + " only takes INTERVAL_DAY_TIME and STRING_GROUP types, got " + inputTypes[i]);
        }
    ...
    protected Boolean getConstantBooleanValue(ObjectInspector[] arguments, int i) throws UDFArgumentTypeException
    {
        ...
        {
            throw new UDFArgumentTypeException(i, getFuncName() + " only takes BOOLEAN types as " + getArgOrder(i) + " argument, got " + constValue.getClass());
        }
    }
    ...
    protected Integer getConstantIntValue(ObjectInspector[] arguments, int i) throws UDFArgumentTypeException
    {
        ...
        {
            throw new UDFArgumentTypeException(i, getFuncName() + " only takes INT/SHORT/BYTE types as " + getArgOrder(i) + " argument, got " + constValue.getClass());
        }
        return v;
    }
