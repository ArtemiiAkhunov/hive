...
public interface VectorMapJoinBytesHashMap extends VectorMapJoinBytesHashTable, VectorMapJoinHashMap
{
     ...
     */
    JoinUtil.JoinResult lookup(byte[] keyBytes, int keyStart, int keyLength, VectorMapJoinHashMapResult hashMapResult) throws IOException;
     ...
     * ...
     */
    JoinUtil.JoinResult lookup(byte[] keyBytes, int keyStart, int keyLength, VectorMapJoinHashMapResult hashMapResult, MatchTracker matchTracker) throws IOException;
}