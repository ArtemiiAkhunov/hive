...
public abstract class AbstractGenericUDFArrayBase extends GenericUDF
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        checkArgCategory(arguments, ARRAY_IDX, ObjectInspector.Category.LIST, functionName, org.apache.hadoop.hive.serde.serdeConstants.LIST_TYPE_NAME);
    ...
    void checkArgIntPrimitiveCategory(PrimitiveObjectInspector objectInspector, String functionName, int idx) throws UDFArgumentTypeException
    {
        switch (objectInspector.getPrimitiveCategory())
        {
            ...
            case LONG:
                break;
            default:
                throw new UDFArgumentTypeException(0, "Argument " + idx + " of function " + functionName + " must be \"" + serdeConstants.SMALLINT_TYPE_NAME + "\"" + " or \"" + serdeConstants.INT_TYPE_NAME + "\"" + " or \"" + serdeConstants.BIGINT_TYPE_NAME + "\", but \"" + objectInspector.getTypeName() + "\" was found.");
        }
    }
