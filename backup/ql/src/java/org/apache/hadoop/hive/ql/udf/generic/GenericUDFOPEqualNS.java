 ...
 */
@Description(name = "IS NOT DISTINCT FROM", value = "a _FUNC_ b - Returns same result with EQUALNS (IS NOT DISTINCT " + "FROM) operator for non-null operands, but returns TRUE if both are NULL, FALSE if one of the them is NULL")
@NDV(maxNdv = 2)
