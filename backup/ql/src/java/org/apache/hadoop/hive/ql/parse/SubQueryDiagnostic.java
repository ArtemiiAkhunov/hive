...
public class SubQueryDiagnostic
{
    ...
    public static class QBSubQueryRewrite
    {
        ...
        void addSelectClauseRewrite(ASTNode selectExpr, String alias)
        {
            ...
            selectClauseAdditions += ", " + stream.toString(selectExpr.getTokenStartIndex(), selectExpr.getTokenStopIndex()) + " as " + alias;
        }
        ...
        void addGByClauseRewrite(ASTNode selectExpr)
        {
            ...
            gByClauseAdditions += stream.toString(selectExpr.getTokenStartIndex(), selectExpr.getTokenStopIndex());
        }
