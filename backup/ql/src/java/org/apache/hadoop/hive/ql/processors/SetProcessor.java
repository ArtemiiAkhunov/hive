...
public class SetProcessor implements CommandProcessor
{
    ...
    private static final Pattern TIME_ZONE_PATTERN = Pattern.compile("^time(\\s)+zone\\s", Pattern.CASE_INSENSITIVE);
    ...
    static String setConf(SessionState ss, String varName, String key, String varValue, boolean register) throws IllegalArgumentException
    {
        ...
        {
            console.printWarn("Cannot modify " + key + " at runtime. " + "It is in the list of locked configurations that can't be modified at runtime");
        }
