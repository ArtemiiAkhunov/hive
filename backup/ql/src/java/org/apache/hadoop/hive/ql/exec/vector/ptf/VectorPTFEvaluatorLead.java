...
public class VectorPTFEvaluatorLead extends VectorPTFEvaluatorAbstractLeadLag
{
    ...
    public VectorPTFEvaluatorLead(WindowFrameDef windowFrameDef, VectorExpression inputVecExpr, int outputColumnNum, Type type, int amt, VectorExpression defaultValueExpression)
    {
