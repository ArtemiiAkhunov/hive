...
@Description(name = "surrogate_key", value = "_FUNC_() - " + "automatically generate numerical Ids for rows as you enter data into a table", extended = "Example: CREATE TABLE students \n" + "(`ID` BIGINT DEFAULT SURROGATE_KEY(),\n" + " name VARCHAR(64));")
