...
public class AlterTableUnsetPropertiesDesc extends AbstractAlterTableDesc
{
    ...
    public AlterTableUnsetPropertiesDesc(TableName tableName, Map<String, String> partitionSpec, ReplicationSpec replicationSpec, boolean expectView, Map<String, String> props, boolean isExplicitStatsUpdate, EnvironmentContext environmentContext) throws SemanticException
    {
