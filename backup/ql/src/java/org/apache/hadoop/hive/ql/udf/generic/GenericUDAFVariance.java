...
public class GenericUDAFVariance extends AbstractGenericUDAFResolver
{
    ...
    {
        NONE, VARIANCE, VARIANCE_SAMPLE, STANDARD_DEVIATION, STANDARD_DEVIATION_SAMPLE;
    ...
    public static double calculateMerge(long partialCount, long mergeCount, double partialSum, double mergeSum, double partialVariance, double mergeVariance)
    {
        ...
        mergeVariance += partialVariance + ((doubleMergeCount / doublePartialCount) / (doubleMergeCount + doublePartialCount)) * t * t;
    ...
    public static class GenericUDAFVarianceEvaluator extends GenericUDAFEvaluator
    {
        ...
        static class StdAgg extends AbstractAggregationBuffer
        {
            ...
            public int estimate()
            {
                return JavaDataModel.PRIMITIVES2 * 3;
            }
        }
        ...
        public void iterate(AggregationBuffer agg, Object[] parameters) throws HiveException
        {
            ...
            if (p != null)
            {
                ...
                try
                {
                    ...
                    if (myagg.count > 1)
                    {
                        myagg.variance = calculateIntermediate(myagg.count, myagg.sum, v, myagg.variance);
                    }
        ...
        public void merge(AggregationBuffer agg, Object partial) throws HiveException
        {
            if (partial != null)
            {
                ...
                if (m != 0 && n != 0)
                {
                    ...
                    myagg.variance = calculateMerge(
                            /* partialCount */ m, /* mergeCount */ n,
                            /* partialSum */ b, /* mergeSum */ a, sumFieldOI.get(partialVariance), myagg.variance);
        ...
        public Object terminate(AggregationBuffer agg) throws HiveException
        {
            ...
            } else
            {
                if (myagg.count > 1)
                {
                    getResult().set(calculateVarianceResult(myagg.variance, myagg.count));
                } else
