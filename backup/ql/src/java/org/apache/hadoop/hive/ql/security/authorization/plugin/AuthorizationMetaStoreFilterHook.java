...
public class AuthorizationMetaStoreFilterHook extends DefaultMetaStoreFilterHookImpl
{
    ...
    {
        return new HivePrivilegeObject(HivePrivilegeObjectType.TABLE_OR_VIEW, dbName, tableName, null, null, HivePrivilegeObject.HivePrivObjectActionType.OTHER, null, null, owner, ownerType);
    }
    ...
    private List<HivePrivilegeObject> tablesToPrivilegeObjs(List<Table> tableList)
    {
        ...
        {
            objs.add(createPrivilegeObjectForTable(tableObject.getDbName(), tableObject.getTableName(), tableObject.getOwner(), tableObject.getOwnerType()));
        }
        return objs;
    }
    ...
    private List<HivePrivilegeObject> tableMetasToPrivilegeObjs(List<TableMeta> tableMetas)
    {
        ...
        {
            objs.add(createPrivilegeObjectForTable(tableMeta.getDbName(), tableMeta.getTableName(), tableMeta.getOwnerName(), tableMeta.getOwnerType()));
        }
        return objs;
    }
