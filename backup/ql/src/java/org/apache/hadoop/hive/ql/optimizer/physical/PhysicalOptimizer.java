...
public class PhysicalOptimizer
{
    ...
    private void initialize(HiveConf hiveConf)
    {
        ...
        if (hiveConf.getBoolVar(HiveConf.ConfVars.HIVE_VECTORIZATION_ENABLED) || HiveConf.getVar(hiveConf, HiveConf.ConfVars.HIVE_TEST_VECTORIZATION_ENABLED_OVERRIDE).equalsIgnoreCase("enable"))
        {
