...
public class WmEvent
{
    ...
    public static class WmTezSessionInfo
    {
        ...
        WmTezSessionInfo(WmTezSession wmTezSession)
        {
            ...
            this.clusterPercent = wmTezSession.hasClusterFraction() ? wmTezSession.getClusterFraction() * 100.0 : 0;
        }
    ...
    public String toString()
    {
        return "EventType: " + eventType + " EventStartTimestamp: " + eventStartTimestamp + " elapsedTime: " + elapsedTime + " wmTezSessionInfo:" + wmTezSessionInfo;
    }
}
