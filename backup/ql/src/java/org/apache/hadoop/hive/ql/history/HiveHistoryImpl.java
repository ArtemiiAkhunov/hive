...
public class HiveHistoryImpl implements HiveHistory
{
    ...
    public HiveHistoryImpl(SessionState ss)
    {
        ...
        try
        {
            ...
            String conf_file_loc = ss.getConf().getVar(HiveConf.ConfVars.HIVE_HISTORY_FILE_LOC);
     ...
     * write out counters.
     */
    static final ThreadLocal<Map<String, String>> ctrMapFactory = new ThreadLocal<Map<String, String>>()
    {
        @Override
