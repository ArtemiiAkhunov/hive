...
public class FilterDecimal64ColumnNotBetween extends FilterLongColumnNotBetween
{
    ...
    public String vectorExpressionParameters()
    {
        ...
        return getColumnParamString(0, inputColumnNum[0]) + ", decimal64LeftVal " + leftValue + ", decimalLeftVal " + writable1.toString() + ", decimal64RightVal " + rightValue + ", decimalRightVal " + writable2.toString();
    }
