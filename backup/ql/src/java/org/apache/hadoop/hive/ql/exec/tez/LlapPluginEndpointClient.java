...
public interface LlapPluginEndpointClient
{
    ...
    public static interface UpdateRequestContext extends ExecuteRequestCallback<UpdateQueryResponseProto>
    {
        void setNodeInfo(AmPluginInfo info, int version);
    }

    void sendUpdateQuery(UpdateQueryRequestProto request, AmPluginNode node, UpdateRequestContext callback);
}