...
public class GenericUDFStringToMap extends GenericUDF
{
    ...
    public Object evaluate(DeferredObject[] arguments) throws HiveException
    {
        ...
        String delimiter1 = (soi_de1 == null) ? default_de1 : (String) soi_de1.convert(arguments[1].get());
        String delimiter2 = (soi_de2 == null) ? default_de2 : (String) soi_de2.convert(arguments[2].get());
