...
public interface VectorMapJoinHashTable extends MemoryEstimate
{
     ...
     */
    void putRow(long hashCode, BytesWritable currentKey, BytesWritable currentValue) throws SerDeException, HiveException, IOException;

    /**
     * @param currentKey The key to check for existence.
     * @return true
