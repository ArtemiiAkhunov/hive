...
public class JoinOperator extends CommonJoinOperator<JoinDesc> implements Serializable
{
    ...
    public void process(Object row, int tag) throws HiveException
    {
        try
        {
            ...
            if (alias == numAliases - 1 && !(handleSkewJoin && skewJoinKeyContext.currBigKeyTag >= 0) && !hasLeftSemiJoin && !hasLeftAntiSemiJoin)
            {
    ...
    private void moveUpFiles(Path specPath, Configuration hconf, Logger log) throws IOException, HiveException
    {
