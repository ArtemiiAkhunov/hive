...
public class TopNKeyProcessor implements SemanticNodeProcessor
{
    ...
    public static Operator<? extends OperatorDesc> copyDown(Operator<? extends OperatorDesc> child, OperatorDesc operatorDesc)
    {
        ...
        final Operator<? extends OperatorDesc> newOperator = OperatorFactory.getAndMakeChild(child.getCompilationOpContext(), operatorDesc, new RowSchema(parents.get(0).getSchema()), child.getParentOperators());
