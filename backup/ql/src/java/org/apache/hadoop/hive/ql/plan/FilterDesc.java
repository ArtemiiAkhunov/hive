...
public class FilterDesc extends AbstractOperatorDesc
{
    ...
    public FilterDesc(final org.apache.hadoop.hive.ql.plan.ExprNodeDesc predicate, boolean isSamplingPred)
    {
    ...
    public FilterDesc(final org.apache.hadoop.hive.ql.plan.ExprNodeDesc predicate, boolean isSamplingPred, final SampleDesc sampleDescr)
    {
        this.predicate = predicate;
        this.isSamplingPred = isSamplingPred;
    ...
    public boolean isSame(OperatorDesc other)
    {
        if (getClass().getName().equals(other.getClass().getName()))
        {
            ...
            return Objects.equals(getPredicateString(), otherDesc.getPredicateString()) && Objects.equals(getSampleDescExpr(), otherDesc.getSampleDescExpr()) && getIsSamplingPred() == otherDesc.getIsSamplingPred();
        }
        return false;
    }
