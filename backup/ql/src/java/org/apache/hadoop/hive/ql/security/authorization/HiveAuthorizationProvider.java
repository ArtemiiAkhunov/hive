...
public interface HiveAuthorizationProvider extends Configurable
{
     ...
     * @param inputs            input entities to be authorized
     * @param outputs           output entities to be authorized
     * @throws HiveException
     * @throws AuthorizationException
     */
    void authorizeDbLevelOperations(Privilege[] readRequiredPriv, Privilege[] writeRequiredPriv, Collection<ReadEntity> inputs, Collection<WriteEntity> outputs) throws HiveException, AuthorizationException;
