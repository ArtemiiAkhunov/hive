...
public class CacheTableHelper
{
    ...
    private static final Cache<String, Set<String>> underlyingTableHints = Caffeine.newBuilder().maximumSize(10000).build();
    ...
    {
        String dbName = dbTablePair.getLeft() == null ? SessionState.get().getCurrentDatabase() : dbTablePair.getLeft();
