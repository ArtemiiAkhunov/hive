...
class CommandUtil
{
     ...
     */
    static CommandProcessorResponse authorizeCommand(SessionState ss, HiveOperationType type, List<String> command) throws CommandProcessorException
    {
        if (ss == null)
        {
     ...
     */
    private static void authorizeCommandThrowEx(SessionState ss, HiveOperationType type, List<String> command) throws HiveAuthzPluginException, HiveAccessControlException
    {
     ...
     * capturing the authorization error
     */
    static CommandProcessorResponse authorizeCommandAndServiceObject(SessionState ss, HiveOperationType type, List<String> command, String serviceObject) throws CommandProcessorException
    {
        if (ss == null)
        {
            // ss can be null in unit tests
