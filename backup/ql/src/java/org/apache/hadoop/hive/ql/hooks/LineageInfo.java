...
public class LineageInfo implements Serializable
{
    ...
    public static class DataContainer implements Serializable
    {
        ...
        {
            return isPartition() ? StatsUtils.getFullyQualifiedTableName(part.getDbName(), part.getTableName()) + "@" + part.getValues() : Warehouse.getQualifiedName(tab);
        }
    }
    ...
    public static class TableAliasInfo implements Serializable
    {
        ...
        public int hashCode()
        {
            return (alias != null ? alias.hashCode() : 7) + (table != null ? table.hashCode() : 11);
        }
        ...
        public boolean equals(Object obj)
        {
            ...
            return StringUtils.equals(alias, tabAlias.alias) && (table == null ? tabAlias.table == null : table.equals(tabAlias.table));
        }
    }
