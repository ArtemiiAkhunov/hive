...
public interface HiveOutputFormat<K, V> extends OutputFormat<K, V>
{
     ...
     * @param finalOutPath    the final output file to be created
     * @param valueClass      the value class used for create
     * @param isCompressed    whether the content is compressed or not
     * @param tableProperties the table properties of this file's corresponding table
     * @param progress        progress used for status report
     * @return the RecordWriter for the output file
     */
    RecordWriter getHiveRecordWriter(JobConf jc, Path finalOutPath, final Class<? extends Writable> valueClass, boolean isCompressed, Properties tableProperties, Progressable progress) throws IOException;
