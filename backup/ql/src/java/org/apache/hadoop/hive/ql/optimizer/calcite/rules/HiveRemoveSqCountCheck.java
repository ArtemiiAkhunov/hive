...
public class HiveRemoveSqCountCheck extends RelOptRule
{
    ...
    {
        super(operand(Join.class, some(operand(Project.class, operand(Join.class, some(operand(RelNode.class, any()), operand(Filter.class, any())))), operand(Project.class, operand(Aggregate.class, any())))), HiveRelFactories.HIVE_BUILDER, "HiveRemoveSqCountCheck");
    }
