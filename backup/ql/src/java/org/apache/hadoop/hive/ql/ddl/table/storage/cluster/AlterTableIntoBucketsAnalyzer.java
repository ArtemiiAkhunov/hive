 ...
 */
@DDLType(types = {HiveParser.TOK_ALTERTABLE_BUCKETS, HiveParser.TOK_ALTERPARTITION_BUCKETS})
public class AlterTableIntoBucketsAnalyzer extends AbstractAlterTableAnalyzer
{
    public AlterTableIntoBucketsAnalyzer(QueryState queryState) throws SemanticException
    {
        super(queryState);
    }
    ...
    protected void analyzeCommand(TableName tableName, Map<String, String> partitionSpec, ASTNode command) throws SemanticException
    {
        ...
        if (CollectionUtils.isEmpty(table.getBucketCols()))
        {
            throw new SemanticException(ErrorMsg.ALTER_BUCKETNUM_NONBUCKETIZED_TBL.getMsg());
        }

        validateAlterTableType(table, AlterTableType.INTO_BUCKETS, false);
