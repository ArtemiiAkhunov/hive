...
public class ColumnInfo implements Serializable
{
    ...
    {
        this(internalName, TypeInfoUtils.getStandardWritableObjectInspectorFromTypeInfo(type), true, tabAlias, isVirtualCol, isHiddenVirtualCol);
    }
    ...
    {
        this(internalName, TypeInfoUtils.getStandardWritableObjectInspectorFromTypeInfo(type), nullable, tabAlias, isVirtualCol, isHiddenVirtualCol);
    }
    ...
    {
        objectInspector = TypeInfoUtils.getStandardWritableObjectInspectorFromTypeInfo(type);
    ...
    public boolean internalEquals(ColumnInfo dest)
    {
        ...
        if ((!checkEquals(internalName, dest.getInternalName())) || (!checkEquals(getType(), dest.getType())) || (isSkewedCol != dest.isSkewedCol()) || (isVirtualCol != dest.getIsVirtualCol()) || (isHiddenVirtualCol != dest.isHiddenVirtualCol()))
        {
            return false;
        }
    ...
    {
        return checkEquals(tabAlias, other.tabAlias) && checkEquals(alias, other.alias) && checkEquals(internalName, other.internalName) && checkEquals(getType(), other.getType());
    }

    public String toMappingString(String tab, String col)
    {
        return tab + "." + col + " => {" + tabAlias + ", " + alias + ", " + internalName + ": " + getType() + "}";
    }
