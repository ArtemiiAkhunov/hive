...
public class StorageFormat
{
    ...
    {
        DEFAULT(), ICEBERG("\'org.apache.iceberg.mr.hive.HiveIcebergStorageHandler\'", "org.apache.iceberg.mr.hive.HiveIcebergInputFormat", "org.apache.iceberg.mr.hive.HiveIcebergOutputFormat");
        ...
        switch (child.getToken().getType())
        {
            ...
            case HiveParser.TOK_FILEFORMAT_GENERIC:
                if (storageHandler != null)
                {
                    ...
                    LOG.info("'STORED AS' clause will be ignored, since a default storage handler class is already set: '{}'", storageHandler);
                    break;
                }
    ...
    public void fillDefaultStorageFormat(boolean isExternal, boolean isMaterializedView) throws SemanticException
    {
        if ((inputFormat == null) && (storageHandler == null))
        {
            ...
            {
                defaultFormat = defaultManagedFormat = HiveConf.getVar(conf, HiveConf.ConfVars.HIVE_MATERIALIZED_VIEW_FILE_FORMAT);
