...
public abstract class GenericUDFBaseTrim extends GenericUDF
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        {
            throw new UDFArgumentException(udfName + " requires at least one value argument. Found :" + arguments.length);
        }
        if (arguments.length > 2)
        {
            throw new UDFArgumentException(udfName + " requires no more than two value arguments. Found :" + arguments.length);
        }
    ...
    private PrimitiveObjectInspector getArgumentObjectInspector(ObjectInspector argument) throws UDFArgumentException
    {
        ...
        {
            throw new UDFArgumentException(udfName + " takes only primitive types. found " + argument.getTypeName());
        }
