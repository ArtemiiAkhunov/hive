...
public class BootstrapLoadTable extends ReplState
{
    ...
    public BootstrapLoadTable(String dbName, String tableName, TableType tableType, long tableSeqNo, long numTables)
    {
        this.dbName = dbName;
        this.tableName = tableName;
        this.tableType = tableType.name();
        this.tablesLoadProgress = new String(new StringBuilder().append(tableSeqNo).append("/").append(numTables));
