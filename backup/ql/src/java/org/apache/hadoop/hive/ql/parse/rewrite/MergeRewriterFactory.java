...
public class MergeRewriterFactory implements RewriterFactory<MergeStatement>
{
    ...
    public Rewriter<MergeStatement> createRewriter(Table table, String targetTableFullName, String subQueryAlias) throws SemanticException
    {
        ...
        SqlGeneratorFactory sqlGeneratorFactory = new SqlGeneratorFactory(table, targetTableFullName, conf, !copyOnWriteMode ? subQueryAlias : null, copyOnWriteMode ? TARGET_PREFIX : EMPTY);
