...
public class RexNodeExprFactory extends ExprFactory<RexNode>
{
    ...
    protected RexNode toExpr(ColumnInfo colInfo, RowResolver rowResolver, int offset) throws CalciteSemanticException
    {
        ...
        return rexBuilder.makeInputRef(TypeConverter.convert(colInfo.getType(), colInfo.isNullable(), rexBuilder.getTypeFactory()), index + offset);
    }
    ...
    {
        int index = rowResolver.getPosition(colInfo.getInternalName());
        return rexBuilder.makeInputRef(TypeConverter.convert(colInfo.getType(), rexBuilder.getTypeFactory()), index + offset);
    }
    ...
    protected RexNode createColumnRefExpr(ColumnInfo colInfo, List<RowResolver> rowResolverList) throws SemanticException
    {
        ...
        return rexBuilder.makeInputRef(TypeConverter.convert(colInfo.getType(), rexBuilder.getTypeFactory()), index);
    }
    ...
    {
        return rexBuilder.makeNullLiteral(rexBuilder.getTypeFactory().createSqlType(SqlTypeName.NULL));
    }
    ...
    protected RexNode createBooleanConstantExpr(String value)
    {
        ...
        return rexBuilder.makeLiteral(b, rexBuilder.getTypeFactory().createSqlType(SqlTypeName.BOOLEAN), false);
    }
    ...
    {
        return rexBuilder.makeLiteral(new BigDecimal(Long.valueOf(value)), rexBuilder.getTypeFactory().createSqlType(SqlTypeName.BIGINT), false);
    }
    ...
    {
        return rexBuilder.makeLiteral(new BigDecimal(Integer.valueOf(value)), rexBuilder.getTypeFactory().createSqlType(SqlTypeName.INTEGER), false);
    }
    ...
    {
        return rexBuilder.makeLiteral(new BigDecimal(Short.valueOf(value)), rexBuilder.getTypeFactory().createSqlType(SqlTypeName.SMALLINT), false);
    }
    ...
    {
        return rexBuilder.makeLiteral(new BigDecimal(Byte.valueOf(value)), rexBuilder.getTypeFactory().createSqlType(SqlTypeName.TINYINT), false);
    }
    ...
    protected RexNode createFloatConstantExpr(String value)
    {
        ...
        return rexBuilder.makeApproxLiteral(new BigDecimal(Float.toString(f)), rexBuilder.getTypeFactory().createSqlType(SqlTypeName.FLOAT));
    }
    ...
    protected RexNode createDoubleConstantExpr(String value) throws SemanticException
    {
        ...
        return rexBuilder.makeApproxLiteral(new BigDecimal(Double.toString(d)), rexBuilder.getTypeFactory().createSqlType(SqlTypeName.DOUBLE));
    }
    ...
    protected RexNode createDecimalConstantExpr(String value, boolean allowNullValueConstantExpr)
    {
        ...
        return rexBuilder.makeExactLiteral(bd, TypeConverter.convert(type, rexBuilder.getTypeFactory()));
    }
    ...
    protected RexLiteral createStringConstantExpr(String value)
    {
        ...
        return (RexLiteral) rexBuilder.makeLiteral(makeHiveUnicodeString(value), stringType, true);
    }
    ...
    protected RexLiteral createDateConstantExpr(String value)
    {
        ...
        return rexBuilder.makeDateLiteral(DateString.fromDaysSinceEpoch(d.toEpochDay()));
    }
    ...
    protected RexLiteral createTimestampConstantExpr(String value)
    {
        ...
        return (RexLiteral) rexBuilder.makeLiteral(TimestampString.fromMillisSinceEpoch(t.toEpochMilli()).withNanos(t.getNanos()), rexBuilder.getTypeFactory().createSqlType(SqlTypeName.TIMESTAMP, rexBuilder.getTypeFactory().getTypeSystem().getDefaultPrecision(SqlTypeName.TIMESTAMP)), false);
    }
    ...
    protected RexNode createStructExpr(TypeInfo typeInfo, List<RexNode> operands) throws CalciteSemanticException
    {
        ...
        return rexBuilder.makeCall(TypeConverter.convert(typeInfo, rexBuilder.getTypeFactory()), SqlStdOperatorTable.ROW, operands);
    }
    ...
    protected RexNode createConstantExpr(TypeInfo typeInfo, Object constantValue) throws CalciteSemanticException
    {
        if (typeInfo instanceof StructTypeInfo)
        {
            ...
            {
                operands.add(rexBuilder.makeLiteral(objectList.get(i), TypeConverter.convert(typeList.get(i), rexBuilder.getTypeFactory()), false));
            }
            return rexBuilder.makeCall(TypeConverter.convert(typeInfo, rexBuilder.getTypeFactory()), SqlStdOperatorTable.ROW, operands);
        }
        return rexBuilder.makeLiteral(constantValue, TypeConverter.convert(typeInfo, rexBuilder.getTypeFactory()), false);
    }
    ...
    protected RexNode createNestedColumnRefExpr(TypeInfo typeInfo, RexNode expr, String fieldName, Boolean isList) throws CalciteSemanticException
    {
        ...
        } else
        {
            ...
            // supplied by serdes.
            throw new CalciteSemanticException("Unexpected rexnode : " + expr.getClass().getCanonicalName(), UnsupportedFeature.Schema_less_table);
        }
    }
    ...
    protected RexNode createFuncCallExpr(TypeInfo typeInfo, FunctionInfo functionInfo, String funcText, List<RexNode> inputs) throws SemanticException
    {
        ...
        List<RexNode> newInputs = functionHelper.convertInputs(functionInfo, inputs, returnType);
        // 4) Return Calcite function
        return functionHelper.getExpression(funcText, functionInfo, newInputs, returnType);
    }
    ...
    protected RexNode setTypeInfo(RexNode expr, TypeInfo type) throws CalciteSemanticException
    {
        ...
        if (expr instanceof RexCall)
        {
            ...
            return rexBuilder.makeCall(t, call.getOperator(), call.getOperands());
    ...
    private static RexNode getSomeSubquery(final RelOptCluster cluster, final RelNode subqueryRel, final RexNode lhs, final SqlQuantifyOperator quantifyOperator)
    {
