...
public final class DirectionUtils
{
    ...
    private static final ImmutableMap<String, Object> ASCENDING_DATA = ImmutableMap.of("code", ASCENDING_CODE, "sign", '+', "text", "ASC", "direction", Direction.ASCENDING, "token", HiveParser.TOK_TABSORTCOLNAMEASC);

    private static final ImmutableMap<String, Object> DESCENDING_DATA = ImmutableMap.of("code", DESCENDING_CODE, "sign", '-', "text", "DESC", "direction", Direction.DESCENDING, "token", HiveParser.TOK_TABSORTCOLNAMEDESC);
