...
public class HiveMetaStoreAuthorizer extends MetaStorePreEventListener implements MetaStoreFilterHook
{
    ...
    private void checkPrivileges(final HiveMetaStoreAuthzInfo authzContext, HiveAuthorizer authorizer) throws HiveAccessControlException, HiveAuthzPluginException
    {
