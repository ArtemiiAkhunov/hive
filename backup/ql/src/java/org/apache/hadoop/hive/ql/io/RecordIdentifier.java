...
public class RecordIdentifier implements WritableComparable<RecordIdentifier>
{
    ...
    public enum Field
    {
        ...
        writeId(TypeInfoFactory.longTypeInfo, PrimitiveObjectInspectorFactory.javaLongObjectInspector), bucketId(TypeInfoFactory.intTypeInfo, PrimitiveObjectInspectorFactory.javaIntObjectInspector), rowId(TypeInfoFactory.longTypeInfo, PrimitiveObjectInspectorFactory.javaLongObjectInspector);
    ...
    public static final class StructInfo
    {
        ...
        public static final TypeInfo typeInfo = TypeInfoFactory.getStructTypeInfo(fieldNames, fieldTypes);
        public static final ObjectInspector oi = ObjectInspectorFactory.getStandardStructObjectInspector(fieldNames, fieldOis);
    ...
    public boolean equals(Object other)
    {
        ...
        return oth.writeId == writeId && oth.bucketId == bucketId && oth.rowId == rowId;
    }
    ...
    {
        return "RecordIdentifier(" + writeId + ", " + bucketToString(bucketId) + "," + getRowId() + ")";
    }
