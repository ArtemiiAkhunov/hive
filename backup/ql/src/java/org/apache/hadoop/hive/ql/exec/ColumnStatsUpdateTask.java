...
public class ColumnStatsUpdateTask extends Task<ColumnStatsUpdateWork>
{
    ...
    private static transient final Logger LOG = LoggerFactory.getLogger(ColumnStatsUpdateTask.class);
    ...
    private int persistColumnStats(Hive db) throws HiveException, MetaException, IOException
    {
        ...
        SetPartitionsStatsRequest request = new SetPartitionsStatsRequest(Collections.singletonList(colStats));
    ...
    private Timestamp readTimestampValue(String timestampStr)
    {
        try
        {
            TimestampWritableV2 writableVal = new TimestampWritableV2(org.apache.hadoop.hive.common.type.Timestamp.valueOf(timestampStr));
