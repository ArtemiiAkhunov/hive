...
public class HiveRecordReader<K extends WritableComparable, V extends Writable> extends HiveContextAwareRecordReader<K, V>
{
    ...
    public HiveRecordReader(RecordReader<K, V> recordReader) throws IOException
    {
        super(recordReader);
    }

    public HiveRecordReader(RecordReader<K, V> recordReader, JobConf conf) throws IOException
    {
