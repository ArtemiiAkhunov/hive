...
public class AlterTableDropConstraintOperation extends DDLOperation<AlterTableDropConstraintDesc>
{
    ...
    {
        if (!DDLUtils.allowOperationInReplicationScope(context.getDb(), desc.getDbTableName(), null, desc.getReplicationSpec()))
        {
        ...
        try
        {
            context.getDb().dropConstraint(desc.getTableName().getDb(), desc.getTableName().getTable(), desc.getConstraintName());
