...
class CreateTableHandler extends AbstractEventHandler<CreateTableMessage>
{
    ...
    public void handle(Context withinContext) throws Exception
    {
        ...
        EximUtil.createExportDump(metaDataPath.getFileSystem(withinContext.hiveConf), metaDataPath, qlMdTable, null, withinContext.replicationSpec, withinContext.hiveConf);
