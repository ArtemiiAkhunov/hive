...
public class BootstrapDumpTable extends ReplState
{
    ...
    public BootstrapDumpTable(String dbName, String tableName, TableType tableType, long tableSeqNo, long estimatedNumTables)
    {
        this.dbName = dbName;
        this.tableName = tableName;
        this.tableType = tableType.name();
        this.tablesDumpProgress = new String(new StringBuilder().append(tableSeqNo).append("/").append(estimatedNumTables));
