...
public class CreateFunctionAnalyzer extends AbstractFunctionAnalyzer
{
    ...
    private static final Map<Integer, ResourceType> TOKEN_TYPE_TO_RESOURCE_TYPE = ImmutableMap.of(HiveParser.TOK_JAR, ResourceType.JAR, HiveParser.TOK_FILE, ResourceType.FILE, HiveParser.TOK_ARCHIVE, ResourceType.ARCHIVE);
