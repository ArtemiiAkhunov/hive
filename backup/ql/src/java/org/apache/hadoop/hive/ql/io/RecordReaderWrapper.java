...
class RecordReaderWrapper extends LineRecordReader
{
    ...
    static RecordReader create(InputFormat inputFormat, HiveInputFormat.HiveInputSplit split, TableDesc tableDesc, JobConf jobConf, Reporter reporter) throws IOException
    {
        ...
        {
            LOG.debug("Using {} to read data with skip.header.line.count {} and skip.footer.line.count {}", innerReader.getClass().getSimpleName(), headerCount, footerCount);
        }
     ...
     *
     * @param job   Current job configuration.
