...
public class GenericUDFCase extends GenericUDF implements StatEstimatorProvider
{
    ...
    public Object evaluate(DeferredObject[] arguments) throws HiveException
    {
        ...
        for (int i = 1; i + 1 < arguments.length; i += 2)
        {
            ...
            if (PrimitiveObjectInspectorUtils.comparePrimitiveObjects(caseOIResolver.convertIfNecessary(exprValue, argumentOIs[0]), caseOI, caseOIResolver.convertIfNecessary(caseKey, argumentOIs[i], false), caseOI))
            {
