...
public class HashMapWrapper extends AbstractMapJoinTableContainer implements Serializable
{
    ...
    {
        this(HiveConf.ConfVars.HIVE_HASHTABLE_KEY_COUNT_ADJUSTMENT.defaultFloatVal, HiveConf.ConfVars.HIVE_HASHTABLE_THRESHOLD.defaultIntVal, HiveConf.ConfVars.HIVE_HASHTABLE_LOAD_FACTOR.defaultFloatVal, -1);
    }

    public HashMapWrapper(Configuration hconf, long keyCount)
    {
        this(HiveConf.getFloatVar(hconf, HiveConf.ConfVars.HIVE_HASHTABLE_KEY_COUNT_ADJUSTMENT), HiveConf.getIntVar(hconf, HiveConf.ConfVars.HIVE_HASHTABLE_THRESHOLD), HiveConf.getFloatVar(hconf, HiveConf.ConfVars.HIVE_HASHTABLE_LOAD_FACTOR), keyCount);
    }
    ...
    @Override
    public MapJoinKey putRow(Writable currentKey, Writable currentValue) throws SerDeException, HiveException
    {
    ...
    private class GetAdaptor implements ReusableGetAdaptor
    {
        ...
        @Override
        public JoinUtil.JoinResult setFromVectorNoNulls(VectorHashKeyWrapperBase kw, VectorExpressionWriter[] keyOutputWriters, VectorHashKeyWrapperBatch keyWrapperBatch, MatchTracker matchTracer) throws HiveException
        {
