...
public class KeyWrapperFactory
{
    ...
    class ListKeyWrapper extends KeyWrapper
    {
        ...
        {
            Object[] newDefaultKeys = deepCopyElements(keys, keyObjectInspectors, ObjectInspectorCopyOption.WRITABLE);
        ...
        public void copyKey(KeyWrapper oldWrapper)
        {
            ...
            equalComparer = currentStructEqualComparer;
            deepCopyElements(listWrapper.keys, keyObjectInspectors, keys, ObjectInspectorCopyOption.WRITABLE);
        }
        ...
        private Object[] deepCopyElements(Object[] keys, ObjectInspector[] keyObjectInspectors, ObjectInspectorCopyOption copyOption)
        {
        ...
        private void deepCopyElements(Object[] keys, ObjectInspector[] keyObjectInspectors, Object[] result, ObjectInspectorCopyOption copyOption)
        {
            for (int i = 0; i < keys.length; i++)
            {
                result[i] = ObjectInspectorUtils.copyToStandardObject(keys[i], keyObjectInspectors[i], copyOption);
            }
        }
    }
    ...
    class TextKeyWrapper extends KeyWrapper
    {
        ...
        public KeyWrapper copyKey()
        {
            return new TextKeyWrapper(hashcode, ObjectInspectorUtils.copyToStandardObject(key, soi_new, ObjectInspectorCopyOption.WRITABLE), true);
        }
        ...
        public void copyKey(KeyWrapper oldWrapper)
        {
            ...
            isCopy = true;
            key = ObjectInspectorUtils.copyToStandardObject(textWrapper.key, soi_new, ObjectInspectorCopyOption.WRITABLE);
        }
