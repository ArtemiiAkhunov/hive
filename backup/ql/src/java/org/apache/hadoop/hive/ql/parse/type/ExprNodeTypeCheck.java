...
public class ExprNodeTypeCheck
{
    ...
    {
        TypeCheckProcFactory<ExprNodeDesc> factory = new TypeCheckProcFactory<>(new ExprNodeDescExprFactory());
    ...
    {
        JoinCondTypeCheckProcFactory<ExprNodeDesc> typeCheckProcFactory = new JoinCondTypeCheckProcFactory<>(new ExprNodeDescExprFactory());
    ...
    {
        return new ConstraintExprGenerator<>(conf, new TypeCheckProcFactory<>(new ExprNodeDescExprFactory())).genConstraintsExpr(targetTable, updateStatement, inputRR);
    }
}
