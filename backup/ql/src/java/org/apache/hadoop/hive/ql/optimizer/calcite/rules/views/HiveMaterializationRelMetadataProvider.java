...
public class HiveMaterializationRelMetadataProvider
{
    ...
    public static final JaninoRelMetadataProvider DEFAULT = JaninoRelMetadataProvider.of(ChainedRelMetadataProvider.of(ImmutableList.of(SOURCE_NODE_TYPES, SOURCE_EXPRESSION_LINEAGE, SOURCE_ALL_PREDICATES, SOURCE_TABLE_REFERENCES, JaninoRelMetadataProvider.DEFAULT)));
