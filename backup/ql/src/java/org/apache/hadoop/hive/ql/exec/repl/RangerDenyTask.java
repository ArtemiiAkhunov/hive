...
public class RangerDenyTask extends Task<RangerDenyWork> implements Serializable
{
    ...
    public int execute()
    {
        try
        {
            ...
            {
                RangerPolicy rangerDenyPolicy = rangerRestClient.getDenyPolicyForReplicatedDb(rangerHiveServiceName, work.getSourceDbName(), work.getTargetDbName());

                RangerExportPolicyList rangerExportPolicyList = new RangerExportPolicyList();
                rangerExportPolicyList.setPolicies(new ArrayList<RangerPolicy>()
                {{
                    add(rangerDenyPolicy);
                }});
