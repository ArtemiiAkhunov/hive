...
public class VectorMapJoinOptimizedLongHashSet extends VectorMapJoinOptimizedHashSet implements VectorMapJoinLongHashSet
{
  ...
  */
    ...
    @Override
    public JoinResult contains(long key, VectorMapJoinHashSetResult hashSetResult) throws IOException
    {
    ...
    public VectorMapJoinOptimizedLongHashSet(boolean minMaxEnabled, boolean isOuterJoin, HashTableKeyType hashTableKeyType, MapJoinTableContainer originalTableContainer, ReusableGetAdaptor hashMapRowGetter, TableDesc tableDesc)
    {
