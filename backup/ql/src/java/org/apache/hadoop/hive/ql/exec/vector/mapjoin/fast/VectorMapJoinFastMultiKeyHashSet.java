 ...
 */
public class VectorMapJoinFastMultiKeyHashSet extends VectorMapJoinFastBytesHashSet
{
    ...
    public VectorMapJoinFastMultiKeyHashSet(boolean isFullOuter, int initialCapacity, float loadFactor, int writeBuffersSize, long estimatedKeyCount)
    {
