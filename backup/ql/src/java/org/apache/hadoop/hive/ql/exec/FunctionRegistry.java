...
public final class FunctionRegistry
{
    ...
    static
    {
        ...
        try
        {
            system.registerGenericUDF("iceberg_bucket", (Class<? extends GenericUDF>) Class.forName("org.apache.iceberg.mr.hive.udf.GenericUDFIcebergBucket"));
            system.registerGenericUDF("iceberg_truncate", (Class<? extends GenericUDF>) Class.forName("org.apache.iceberg.mr.hive.udf.GenericUDFIcebergTruncate"));
            system.registerGenericUDF("iceberg_year", (Class<? extends GenericUDF>) Class.forName("org.apache.iceberg.mr.hive.udf.GenericUDFIcebergYear"));
            system.registerGenericUDF("iceberg_month", (Class<? extends GenericUDF>) Class.forName("org.apache.iceberg.mr.hive.udf.GenericUDFIcebergMonth"));
            system.registerGenericUDF("iceberg_day", (Class<? extends GenericUDF>) Class.forName("org.apache.iceberg.mr.hive.udf.GenericUDFIcebergDay"));
            system.registerGenericUDF("iceberg_hour", (Class<? extends GenericUDF>) Class.forName("org.apache.iceberg.mr.hive.udf.GenericUDFIcebergHour"));
    ...
    public static TypeInfo getCommonClass(TypeInfo a, TypeInfo b)
    {
        ...
        if (a.getCategory() == Category.STRUCT && b.getCategory() == Category.STRUCT)
        {
            return getCommonClassForStruct((StructTypeInfo) a, (StructTypeInfo) b, (type1, type2) -> getCommonClass(type1, type2));
        }
        return null;
    }
    ...
    public static GenericUDAFEvaluator getGenericUDAFEvaluator(String name, List<ObjectInspector> argumentOIs, boolean isDistinct, boolean isAllColumns) throws SemanticException
    {
        ...
        GenericUDAFParameterInfo paramInfo = new SimpleGenericUDAFParameterInfo(args, false, isDistinct, isAllColumns);
    ...
    public static GenericUDAFEvaluator getGenericWindowingEvaluator(String name, List<ObjectInspector> argumentOIs, boolean isDistinct, boolean isAllColumns, boolean respectNulls) throws SemanticException
    {
        Registry registry = SessionState.getRegistry();
        GenericUDAFEvaluator evaluator = registry == null ? null : registry.getGenericWindowingEvaluator(name, argumentOIs, isDistinct, isAllColumns, respectNulls);
        return evaluator != null ? evaluator : system.getGenericWindowingEvaluator(name, argumentOIs, isDistinct, isAllColumns, respectNulls);
    }
    ...
    public static Object invoke(Method m, Object thisObject, Object... arguments) throws HiveException
    {
        ...
        } catch (Exception e)
        {
            ...
            String detailedMsg = e instanceof java.lang.reflect.InvocationTargetException ? e.getCause().getMessage() : e.getMessage();
            ...
            LOG.trace("Unable to execute method " + m + " with arguments " + argumentString);
    ...
    public static boolean isOpCast(GenericUDF genericUDF)
    {
        ...
        return udfClass == UDFToBoolean.class || udfClass == UDFToByte.class || udfClass == UDFToDouble.class || udfClass == UDFToFloat.class || udfClass == UDFToInteger.class || udfClass == UDFToLong.class || udfClass == UDFToShort.class || udfClass == GenericUDFToString.class || udfClass == GenericUDFToVarchar.class || udfClass == GenericUDFToChar.class || udfClass == GenericUDFTimestamp.class || udfClass == GenericUDFToBinary.class || udfClass == GenericUDFToDate.class || udfClass == GenericUDFToDecimal.class || udfClass == GenericUDFToTimestampLocalTZ.class;
    }
    ...
    public static FunctionInfo registerPermanentFunction(String functionName, String className, boolean registerToSession, FunctionResource[] resources) throws SemanticException
    {
