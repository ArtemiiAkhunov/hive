...
public class IncrementalDumpEvent extends ReplState
{
    ...
    public IncrementalDumpEvent(String dbName, String eventId, String eventType, long eventSeqNo, long estimatedNumEvents)
    {
        this.dbName = dbName;
        this.eventId = eventId;
        this.eventType = eventType;
        this.eventsDumpProgress = new String(new StringBuilder().append(eventSeqNo).append("/").append(estimatedNumEvents));
