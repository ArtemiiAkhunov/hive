...
public class PartitionKeySampler implements OutputCollector<HiveKey, Object>
{
    ...
    // random sampling
    public static FetchOperator createSampler(FetchWork work, JobConf job, Operator<?> operator) throws HiveException
    {
        int sampleNum = HiveConf.getIntVar(job, HiveConf.ConfVars.HIVE_SAMPLING_NUMBER_FOR_ORDERBY);
        float samplePercent = HiveConf.getFloatVar(job, HiveConf.ConfVars.HIVE_SAMPLING_PERCENT_FOR_ORDERBY);
