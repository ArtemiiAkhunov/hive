    ...
    public static class SelectRule implements SemanticNodeProcessor
    {
        ...
        public List<List<String>> getConvertedColNames(List<List<String>> parentColNames, SelectOperator selOp, boolean processSortCols)
        {
            ...
            for (List<String> colNames : parentColNames)
            {
                ...
                for (String colName : colNames)
                {
                    ...
                    {
                        if ((entry.getValue() instanceof ExprNodeColumnDesc) && (((ExprNodeColumnDesc) (entry.getValue())).getColumn().equals(colName)))
                        {
        ...
        public Object process(Node nd, Stack<Node> stack, NodeProcessorCtx procCtx, Object... nodeOutputs) throws SemanticException
        {
            ...
            if (selOp.getColumnExprMap() != null)
            {
                ...
                List<List<String>> parentSortColNames = selOp.getParentOperators().get(0).getOpTraits().getSortCols();
