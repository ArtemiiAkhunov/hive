...
public class GenericUDFOPNotEqualNS extends GenericUDFOPNotEqual
{
    ...
    @Description(name = "IS DISTINCT FROM", value = "a _FUNC_ b - Returns same result with NOTEQUALNS (IS DISTINCT " + "FROM) operator for non-null operands, but returns FALSE if both are NULL, TRUE if one of the them is NULL")
