 ...
 */
public class VectorMapJoinFastMultiKeyHashMultiSetContainer extends VectorMapJoinFastHashTableContainerBase implements VectorMapJoinBytesHashMultiSet
{
    ...
    {
        vectorMapJoinFastMultiKeyHashMultiSets[(int) ((numThreads - 1) & hashCode)].putRow(hashCode, currentKey, currentValue);
    }
    ...
    public JoinUtil.JoinResult contains(byte[] keyBytes, int keyStart, int keyLength, VectorMapJoinHashMultiSetResult hashMultiSetResult) throws IOException
    {
        ...
        return vectorMapJoinFastMultiKeyHashMultiSets[(int) ((numThreads - 1) & hashCode)].contains(keyBytes, keyStart, keyLength, hashMultiSetResult);
    }
