...
abstract class AbstractAddPartitionAnalyzer extends AbstractAlterTableAnalyzer
{
    ...
    protected void analyzeCommand(TableName tableName, Map<String, String> partitionSpec, ASTNode command) throws SemanticException
    {
        ...
        outputs.add(new WriteEntity(table,
                ...
                ifNotExists && AcidUtils.isTransactionalTable(table) ? WriteType.DDL_EXCL_WRITE : WriteType.DDL_SHARED));
    ...
    private AlterTableAddPartitionDesc.PartitionDesc createPartitionDesc(Table table, String location, Map<String, String> partitionSpec)
    {
        Map<String, String> params = null;
        if (conf.getBoolVar(HiveConf.ConfVars.HIVESTATSAUTOGATHER) && location == null)
        {
            params = new HashMap<String, String>();
            StatsSetupConst.setStatsStateForCreateTable(params, MetaStoreUtils.getColumnNames(table.getCols()), StatsSetupConst.TRUE);
        }
    ...
    protected abstract void postProcess(TableName tableName, Table table, AlterTableAddPartitionDesc desc, Task<DDLWork> ddlTask) throws SemanticException;
