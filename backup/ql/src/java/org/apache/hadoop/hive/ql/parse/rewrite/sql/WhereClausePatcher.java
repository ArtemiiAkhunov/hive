...
public class WhereClausePatcher
{
    public void patch(ASTNode rewrittenInsert, ASTNode whereTree) throws SemanticException
    {
        ...
        {
            throw new SemanticException("Expected TOK_INSERT as second child of TOK_QUERY but found " + rewrittenInsert.getName());
        }
        ...
        if (rewrittenInsert.getChildren().size() == 3)
        {
            ...
            assert sortBy.getToken().getType() == HiveParser.TOK_SORTBY : "Expected TOK_SORTBY to be third child of TOK_INSERT, but found " + sortBy.getName();
        ...
        } else
        {
            ...
            assert select.getToken().getType() == HiveParser.TOK_SELECT : "Expected TOK_SELECT to be second child of TOK_INSERT, but found " + select.getName();
