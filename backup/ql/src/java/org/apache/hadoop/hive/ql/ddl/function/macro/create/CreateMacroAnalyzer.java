...
public class CreateMacroAnalyzer extends BaseSemanticAnalyzer
{
    ...
    private void getMacroColumnData(List<FieldSchema> arguments, Set<String> actualColumnNames, RowResolver rowResolver, ArrayList<String> macroColumnNames, ArrayList<TypeInfo> macroColumnTypes) throws SemanticException
    {
    ...
    private ExprNodeDesc getBody(ASTNode root, List<FieldSchema> arguments, RowResolver rowResolver) throws SemanticException
    {
        ...
        ExprNodeDesc body = arguments.isEmpty() ? sa.genExprNodeDesc((ASTNode) root.getChild(1), rowResolver) : sa.genExprNodeDesc((ASTNode) root.getChild(2), rowResolver);
        return body;
    }
}
