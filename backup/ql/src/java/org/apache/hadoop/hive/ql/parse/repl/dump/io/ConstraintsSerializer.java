...
public class ConstraintsSerializer implements JsonWriter.Serializer
{
    ...
    public ConstraintsSerializer(List<SQLPrimaryKey> pks, List<SQLForeignKey> fks, List<SQLUniqueConstraint> uks, List<SQLNotNullConstraint> nns, List<SQLDefaultConstraint> dks, List<SQLCheckConstraint> cks, HiveConf hiveConf)
    {
