...
public class RevokeRoleOperation extends DDLOperation<RevokeRoleDesc>
{
    ...
    public int execute() throws HiveException
    {
        ...
        List<HivePrincipal> principals = AuthorizationUtils.getHivePrincipals(desc.getPrincipals(), PrivilegeUtils.getAuthorizationTranslator(authorizer));
        HivePrincipal grantorPrincipal = null;
        if (desc.getGrantor() != null)
        {
            grantorPrincipal = new HivePrincipal(desc.getGrantor(), AuthorizationUtils.getHivePrincipalType(PrincipalType.USER));
        }
