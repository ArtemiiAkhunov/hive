...
public class UniqueConstraint implements Serializable
{
    ...
    public UniqueConstraint(List<SQLUniqueConstraint> uks, String tableName, String databaseName)
    {
        ...
        {
            if (uk.getTable_db().equalsIgnoreCase(databaseName) && uk.getTable_name().equalsIgnoreCase(tableName))
            {
                ...
                UniqueConstraintCol currCol = new UniqueConstraintCol(uk.getColumn_name(), uk.getKey_seq(), enable, validate, rely);
