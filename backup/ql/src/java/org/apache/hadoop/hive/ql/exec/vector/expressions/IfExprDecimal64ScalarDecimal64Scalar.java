...
public class IfExprDecimal64ScalarDecimal64Scalar extends IfExprLongScalarLongScalar
{
    ...
    public IfExprDecimal64ScalarDecimal64Scalar(int arg1Column, long arg2Scalar, long arg3Scalar, int outputColumnNum)
    {
    ...
    public String vectorExpressionParameters()
    {
        ...
        return getColumnParamString(0, inputColumnNum[0]) + ", decimal64Val1 " + arg2Scalar + ", decimalVal1 " + writable1.toString() + ", decimal64Val2 " + arg3Scalar + ", decimalVal2 " + writable2.toString();
    }
