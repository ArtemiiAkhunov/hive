...
public class VectorAppMasterEventOperator extends AppMasterEventOperator implements VectorizationOperator
{
    ...
    public VectorAppMasterEventOperator(CompilationOpContext ctx, OperatorDesc conf, VectorizationContext vContext, VectorDesc vectorDesc)
    {
        super(ctx);
    ...
    public void initializeOp(Configuration hconf) throws HiveException
    {
        ...
        inputObjInspectors[0] = VectorizedBatchUtil.convertToStandardStructObjectInspector((StructObjectInspector) inputObjInspectors[0]);
