...
public class ExprNodeConstantDesc extends ExprNodeDesc implements Serializable
{
    ...
    {
        return ObjectInspectorUtils.getConstantObjectInspector(TypeInfoUtils.getStandardJavaObjectInspectorFromTypeInfo(typeInfo), value);
    }
    ...
    private static String getFormatted(TypeInfo typeInfo, Object value)
    {
        ...
        } else if (typeInfo.getTypeName().equals(serdeConstants.INTERVAL_DAY_TIME_TYPE_NAME) || typeInfo.getTypeName().equals(serdeConstants.INTERVAL_YEAR_MONTH_TYPE_NAME))
        {
