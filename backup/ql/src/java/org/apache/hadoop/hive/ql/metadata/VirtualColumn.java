...
public enum VirtualColumn
{
    ...
    public static final ImmutableSet<String> VIRTUAL_COLUMN_NAMES = ImmutableSet.of(FILENAME.getName(), BLOCKOFFSET.getName(), ROWOFFSET.getName(), RAWDATASIZE.getName(), GROUPINGID.getName(), ROWID.getName(), ROWISDELETED.getName(), PARTITION_SPEC_ID.getName(), PARTITION_HASH.getName(), FILE_PATH.getName(), ROW_POSITION.getName());

    public static final ImmutableMap<String, VirtualColumn> VIRTUAL_COLUMN_NAME_MAP = new ImmutableMap.Builder<String, VirtualColumn>().putAll(getColumnNameMap()).build();
    ...
    public static List<TypeInfo> removeVirtualColumnTypes(final List<String> columnNames, final List<TypeInfo> columnTypes)
    {
    ...
    public static boolean isVirtualColumnBasedOnAlias(ColumnInfo column)
    {
        ...
        if (column.getAlias() != null && VirtualColumn.VIRTUAL_COLUMN_NAMES.contains(column.getAlias().toUpperCase()))
        {
            return true;
        }
        return false;
