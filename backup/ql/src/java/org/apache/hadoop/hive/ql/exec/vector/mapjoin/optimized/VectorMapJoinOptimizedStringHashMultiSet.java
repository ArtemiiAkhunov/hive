...
public class VectorMapJoinOptimizedStringHashMultiSet extends VectorMapJoinOptimizedHashMultiSet implements VectorMapJoinBytesHashMultiSet
{
  ...
  */
    ...
    @Override
    public JoinResult contains(byte[] keyBytes, int keyStart, int keyLength, VectorMapJoinHashMultiSetResult hashMultiSetResult) throws IOException
    {
    ...
    public VectorMapJoinOptimizedStringHashMultiSet(boolean isOuterJoin, MapJoinTableContainer originalTableContainer, ReusableGetAdaptor hashMapRowGetter, TableDesc tableDesc)
    {
