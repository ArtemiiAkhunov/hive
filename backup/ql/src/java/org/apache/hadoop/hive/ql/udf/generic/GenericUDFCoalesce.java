...
public class GenericUDFCoalesce extends GenericUDF implements StatEstimatorProvider
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentTypeException
    {
        ...
        for (int i = 0; i < arguments.length; i++)
        {
            ...
            {
                throw new UDFArgumentTypeException(i, "The expressions after COALESCE should all have the same type: \"" + returnOIResolver.get().getTypeName() + "\" is expected but \"" + arguments[i].getTypeName() + "\" is found");
            }
        }
