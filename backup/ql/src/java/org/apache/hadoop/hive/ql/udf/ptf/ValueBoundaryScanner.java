...
|------+----------------+----------------+----------+-------+-----------------------------------|
  ...
  |------+----------------+---------------+----------+-------+-----------------------------------|
    ...
    protected int binarySearchBack(int rowId, PTFPartition p, Object sortKey, int amt, Order order) throws HiveException
    {
    ...
    private int linearSearchBack(int r, PTFPartition p, Object sortKey, int amt, Order order) throws HiveException
    {
        boolean isOrderDesc = order.equals(Order.DESC);
        Object rowVal = sortKey;
        while (r >= 0 && !isDistanceGreater(isOrderDesc ? rowVal : sortKey, isOrderDesc ? sortKey : rowVal, amt))
        {
            Pair<Integer, Object> stepResult = skipOrStepBack(r, p);
            r = stepResult.getLeft();
            rowVal = stepResult.getRight();
    ...
    protected int binarySearchForward(int rowId, PTFPartition p, Object sortKey, int amt, Order order) throws HiveException
    {
        boolean isOrderDesc = order.equals(Order.DESC);
        Object rowVal = null;
        ...
        {
            rowVal = computeValueUseCache(rowId, p);
            isDistanceGreater = isDistanceGreater(isOrderDesc ? sortKey : rowVal, isOrderDesc ? rowVal : sortKey, amt);
            if (isDistanceGreater)
            {
                rMax = rowId;
            } else
    ...
    private int linearSearchForward(int r, PTFPartition p, Object sortKey, int amt, Order order) throws HiveException
    {
        boolean isOrderDesc = order.equals(Order.DESC);
        Object rowVal = sortKey;
        while (r < p.size() && !isDistanceGreater(isOrderDesc ? sortKey : rowVal, isOrderDesc ? rowVal : sortKey, amt))
        {
            Pair<Integer, Object> stepResult = skipOrStepForward(r, p);
            r = stepResult.getLeft();
            rowVal = stepResult.getRight();
    ...
    public static SingleValueBoundaryScanner getScanner(BoundaryDef start, BoundaryDef end, OrderDef orderDef, boolean nullsLast) throws HiveException
    {
        ...
        if (pOI != null)
        {// non-vectorized codepath: PTFOperator
        ...
        { // vectorized codepath: VectorPTFOperator
    ...
    public static SingleValueBoundaryScanner getBoundaryScanner(BoundaryDef start, BoundaryDef end, boolean nullsLast, OrderExpressionDef exprDef, PrimitiveCategory primitiveCategory) throws HiveException
    {
...
{
    public SinglePrimitiveValueBoundaryScanner(BoundaryDef start, BoundaryDef end, OrderExpressionDef expressionDef, boolean nullsLast)
    {
...
{
    public LongValueBoundaryScanner(BoundaryDef start, BoundaryDef end, OrderExpressionDef expressionDef, boolean nullsLast)
    {
        super(start, end, expressionDef, nullsLast);
    }
...
class LongPrimitiveValueBoundaryScanner extends SinglePrimitiveValueBoundaryScanner<Long>
{
    ...
    public LongPrimitiveValueBoundaryScanner(BoundaryDef start, BoundaryDef end, OrderExpressionDef expressionDef, boolean nullsLast)
    {
        super(start, end, expressionDef, nullsLast);
    }
...
{
    public DoubleValueBoundaryScanner(BoundaryDef start, BoundaryDef end, OrderExpressionDef expressionDef, boolean nullsLast)
    {
        super(start, end, expressionDef, nullsLast);
    }
...
class DoublePrimitiveValueBoundaryScanner extends SinglePrimitiveValueBoundaryScanner<Double>
{
    ...
    public DoublePrimitiveValueBoundaryScanner(BoundaryDef start, BoundaryDef end, OrderExpressionDef expressionDef, boolean nullsLast)
    {
        super(start, end, expressionDef, nullsLast);
    }
...
class HiveDecimalPrimitiveValueBoundaryScanner extends SinglePrimitiveValueBoundaryScanner<HiveDecimalWritable>
{
...
class DatePrimitiveValueBoundaryScanner extends SinglePrimitiveValueBoundaryScanner<Long>
{
    ...
    public DatePrimitiveValueBoundaryScanner(BoundaryDef start, BoundaryDef end, OrderExpressionDef expressionDef, boolean nullsLast)
    {
        super(start, end, expressionDef, nullsLast);
    }
...
class TimestampValueBoundaryScanner extends SingleValueBoundaryScanner
{
    ...
    public boolean isDistanceGreater(Object v1, Object v2, int amt)
    {
        if (v1 != null && v2 != null)
        {
            ...
            {
                long l1 = PrimitiveObjectInspectorUtils.getTimestamp(v1, (PrimitiveObjectInspector) expressionDef.getOI()).toEpochMilli();
                long l2 = PrimitiveObjectInspectorUtils.getTimestamp(v2, (PrimitiveObjectInspector) expressionDef.getOI()).toEpochMilli();
    ...
    public boolean isEqual(Object v1, Object v2)
    {
        if (v1 != null && v2 != null)
        {
            ...
            {
                Timestamp l1 = PrimitiveObjectInspectorUtils.getTimestamp(v1, (PrimitiveObjectInspector) expressionDef.getOI());
                Timestamp l2 = PrimitiveObjectInspectorUtils.getTimestamp(v2, (PrimitiveObjectInspector) expressionDef.getOI());
                return l1.equals(l2);
            }
        }
        return v1 == null && v2 == null; // True if both are null
...
class TimestampLocalTZValueBoundaryScanner extends SingleValueBoundaryScanner
{
    ...
    public boolean isDistanceGreater(Object v1, Object v2, int amt)
    {
        if (v1 != null && v2 != null)
        {
            long l1 = PrimitiveObjectInspectorUtils.getTimestampLocalTZ(v1, (PrimitiveObjectInspector) expressionDef.getOI(), null).getEpochSecond();
            long l2 = PrimitiveObjectInspectorUtils.getTimestampLocalTZ(v2, (PrimitiveObjectInspector) expressionDef.getOI(), null).getEpochSecond();
...
class TimestampTZPrimitiveValueBoundaryScanner extends SinglePrimitiveValueBoundaryScanner<Long>
{
    ...
    public TimestampTZPrimitiveValueBoundaryScanner(BoundaryDef start, BoundaryDef end, OrderExpressionDef expressionDef, boolean nullsLast)
    {
        super(start, end, expressionDef, nullsLast);
    }
...
{
    public StringValueBoundaryScanner(BoundaryDef start, BoundaryDef end, OrderExpressionDef expressionDef, boolean nullsLast)
    {
        super(start, end, expressionDef, nullsLast);
    }
    ...
    public boolean isDistanceGreater(Object v1, Object v2, int amt)
    {
        String s1 = PrimitiveObjectInspectorUtils.getString(v1, (PrimitiveObjectInspector) expressionDef.getOI());
        String s2 = PrimitiveObjectInspectorUtils.getString(v2, (PrimitiveObjectInspector) expressionDef.getOI());
...
{
    public StringPrimitiveValueBoundaryScanner(BoundaryDef start, BoundaryDef end, OrderExpressionDef expressionDef, boolean nullsLast)
    {
        super(start, end, expressionDef, nullsLast);
    }
...
{
    public BooleanPrimitiveValueBoundaryScanner(BoundaryDef start, BoundaryDef end, OrderExpressionDef expressionDef, boolean nullsLast)
    {
        super(start, end, expressionDef, nullsLast);
    }
...
class CharValueBoundaryScanner extends SingleValueBoundaryScanner
{
    ...
    public boolean isDistanceGreater(Object v1, Object v2, int amt)
    {
        HiveChar s1 = PrimitiveObjectInspectorUtils.getHiveChar(v1, (PrimitiveObjectInspector) expressionDef.getOI());
        HiveChar s2 = PrimitiveObjectInspectorUtils.getHiveChar(v2, (PrimitiveObjectInspector) expressionDef.getOI());
        return s1 != null && s2 != null && s1.compareTo(s2) > 0;
    }
...
{
    public VarcharValueBoundaryScanner(BoundaryDef start, BoundaryDef end, OrderExpressionDef expressionDef, boolean nullsLast)
    {
        super(start, end, expressionDef, nullsLast);
    }
    ...
    public boolean isDistanceGreater(Object v1, Object v2, int amt)
    {
        HiveVarchar s1 = PrimitiveObjectInspectorUtils.getHiveVarchar(v1, (PrimitiveObjectInspector) expressionDef.getOI());
        HiveVarchar s2 = PrimitiveObjectInspectorUtils.getHiveVarchar(v2, (PrimitiveObjectInspector) expressionDef.getOI());
        return s1 != null && s2 != null && s1.compareTo(s2) > 0;
    }
...
class BooleanValueBoundaryScanner extends SingleValueBoundaryScanner
{
    ...
    public boolean isDistanceGreater(Object v1, Object v2, int amt)
    {
        if (v1 != null && v2 != null)
        {
            boolean b1 = PrimitiveObjectInspectorUtils.getBoolean(v1, (PrimitiveObjectInspector) expressionDef.getOI());
            boolean b2 = PrimitiveObjectInspectorUtils.getBoolean(v2, (PrimitiveObjectInspector) expressionDef.getOI());
...
class MultiValueBoundaryScanner extends ValueBoundaryScanner
{
    ...
    public static ValueBoundaryScanner getScanner(BoundaryDef start, BoundaryDef end, OrderDef orderDef, boolean nullsLast) throws HiveException
    {
        OrderExpressionDef exprDef = orderDef.getExpressions().get(0);
        PrimitiveObjectInspector pOI = (PrimitiveObjectInspector) exprDef.getOI();
    ...
    static class MultiPrimitiveValueBoundaryScanner extends MultiValueBoundaryScanner
    {
        ...
        public MultiPrimitiveValueBoundaryScanner(BoundaryDef start, BoundaryDef end, OrderDef orderDef, boolean nullsLast) throws HiveException
        {
            ...
            for (int i = 0; i < scanners.length; i++)
            {
                 ...
                 * values.
                 */
                scanners[i] = SingleValueBoundaryScanner.getBoundaryScanner(start, end, nullsLast, exprDef, typeString);
            }
        }
        ...
        public boolean isEqual(Object values1, Object values2)
        {
            ...
            {
                if (!scanners[i].isEqual(arrValues1 == null ? null : arrValues1[i], arrValues2 == null ? null : arrValues2[i]))
                {
                    return false;
                }
            }
   ...
   */
    ...
    public boolean isEqual(Object val1, Object val2)
    {
        ...
        for (int i = 0; i < v1.length; i++)
        {
            ...
            if (ObjectInspectorUtils.compare(v1[i], orderDef.getExpressions().get(i).getOI(), v2[i], orderDef.getExpressions().get(i).getOI()) != 0)
            {
                return false;
            }
        }
