...
public abstract class Task<T extends Serializable> implements Serializable, Node
{
    ...
    public enum TaskState
    {
        ...
        UNKNOWN, // Task is just created
    CREATED, // Task data structures have been initialized
    INITIALIZED, // Task has been queued for execution by the driver
    QUEUED, // Task is currently running
    ...
    public static List<Task<?>> findLeafs(List<Task<?>> rootTasks)
    {
