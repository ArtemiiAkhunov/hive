...
public class KeyWrapperComparator implements Comparator<KeyWrapper>
{
    ...
    {
        return ObjectInspectorUtils.compare(key1.getKeyArray(), key1.isCopy() ? copyObjectInspectors : newObjectInspectors, key2.getKeyArray(), key2.isCopy() ? copyObjectInspectors : newObjectInspectors, columnSortOrderIsDesc, nullSortOrder);
    }
}
