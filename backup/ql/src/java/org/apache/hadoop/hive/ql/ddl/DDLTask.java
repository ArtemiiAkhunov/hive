...
public final class DDLTask extends Task<DDLWork> implements Serializable
{
    ...
    private static final Map<Class<? extends DDLDesc>, Class<? extends DDLOperation>> DESC_TO_OPERATION = new HashMap<>();

    static
    {
        Set<Class<? extends DDLOperation>> operationClasses = new Reflections("org.apache.hadoop.hive.ql.ddl").getSubTypesOf(DDLOperation.class);
        for (Class<? extends DDLOperation> operationClass : operationClasses)
        {
            ...
            @SuppressWarnings("unchecked") Class<? extends DDLDesc> descClass = (Class<? extends DDLDesc>) parameterizedType.getActualTypeArguments()[0];
    ...
    public int execute()
    {
        ...
        try
        {
            ...
            {
                DDLOperationContext ddlOperationContext = new DDLOperationContext(conf, context, this, (DDLWork) work, queryState, queryPlan, console);
