    ...
    private ExprNodeDesc deserializeExpr(byte[] exprBytes) throws MetaException
    {
        ...
        } catch (Exception ex)
        {
            ...
            } catch (Exception e)
            {
                ...
                throw new MetaException("SerializationUtilities#deserializeObjectWithTypeInformation: " + ex.getMessage() + ", SerializationUtilities#deserializeObjectFromKryo: " + e.getMessage());
            }
        }
        if (expr == null)
        {
