...
public class GenericUDFArrayUnion extends AbstractGenericUDFArrayBase
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        checkArgCategory(arguments, ARRAY2_IDX, ObjectInspector.Category.LIST, FUNC_NAME, org.apache.hadoop.hive.serde.serdeConstants.LIST_TYPE_NAME);
        if (!ObjectInspectorUtils.compareTypes(arrayOI.getListElementObjectInspector(), ((ListObjectInspector) arguments[ARRAY2_IDX]).getListElementObjectInspector()))
        {
    ...
    public Object evaluate(DeferredObject[] arguments) throws HiveException
    {
        ...
        return Stream.concat(((ListObjectInspector) argumentOIs[ARRAY_IDX]).getList(array).stream(), ((ListObjectInspector) argumentOIs[ARRAY2_IDX]).getList(array2).stream()).distinct().map(o -> converter.convert(o)).collect(Collectors.toList());
    }
}
