...
{
    public static final SqlFunction INSTANCE = new SqlFunction("FROM_UNIXTIME", SqlKind.OTHER_FUNCTION, ReturnTypes.explicit(SqlTypeName.VARCHAR, 100).andThen(SqlTypeTransforms.TO_NULLABLE), null, OperandTypes.family(Arrays.asList(SqlTypeFamily.INTEGER, SqlTypeFamily.STRING), number -> number == 1), SqlFunctionCategory.STRING);
