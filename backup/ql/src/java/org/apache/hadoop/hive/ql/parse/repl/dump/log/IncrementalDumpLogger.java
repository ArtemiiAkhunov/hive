...
public class IncrementalDumpLogger extends ReplLogger<String>
{
    ...
    {
        (new IncrementalDumpBegin(dbName, estimatedNumEvents, fromEventId, toEventId, Long.valueOf(maxEvents))).log(LogTag.START);
    }
    ...
    {
        eventSeqNo++;
        (new IncrementalDumpEvent(dbName, eventId, eventType, eventSeqNo, estimatedNumEvents)).log(LogTag.EVENT_DUMP);
    }
