...
public class MiniZooKeeperCluster
{
    ...
    private ServerCnxnFactory createServerCnxnFactory(int currentClientPort) throws IOException
    {
        ...
        if (sslEnabled)
        {
            ...
            serverCnxnFactory.configure(new InetSocketAddress(currentClientPort), configuration.getInt(HConstants.ZOOKEEPER_MAX_CLIENT_CNXNS, HConstants.DEFAULT_ZOOKEPER_MAX_CLIENT_CNXNS), -1, true);
        } else
        {
            serverCnxnFactory = ServerCnxnFactory.createFactory();
