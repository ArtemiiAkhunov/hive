...
public class TestVectorCastStatement
{
    ...
    private void doIfTests(Random random, String typeName, DataTypePhysicalVariation dataTypePhysicalVariation) throws Exception
    {
        ...
        for (PrimitiveCategory targetPrimitiveCategory : PrimitiveCategory.values())
        {
            ...
            if (targetPrimitiveCategory == PrimitiveCategory.INTERVAL_YEAR_MONTH || targetPrimitiveCategory == PrimitiveCategory.INTERVAL_DAY_TIME)
            {
            ...
            if (targetPrimitiveCategory == PrimitiveCategory.VOID || targetPrimitiveCategory == PrimitiveCategory.TIMESTAMPLOCALTZ || targetPrimitiveCategory == PrimitiveCategory.UNKNOWN)
            {
                continue;
            }
            ...
            {
                if (primitiveCategory != PrimitiveCategory.CHAR && primitiveCategory != PrimitiveCategory.VARCHAR && primitiveCategory != PrimitiveCategory.DECIMAL)
                {
                    continue;
                }
            }
