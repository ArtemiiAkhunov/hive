...
public class TestVectorIndex
{
    ...
    public void testMapIndex() throws Exception
    {
        ...
        {
            doIndex(random, /* isList */ false, typeInfo.getTypeName(), /* isFullElementTypeGamut */ false);
        }
    }
    ...
    private boolean doIndexOnRandomDataType(Random random, boolean isList, String keyTypeName, String elementRootTypeName, boolean allowNulls, boolean isScalarIndex) throws Exception
    {
        ...
        String elementTypeName = VectorRandomRowSource.getDecoratedTypeName(random, elementRootTypeName, SupportedTypes.ALL, /* allowedTypeNameSet */ null,
                /* depth */ 0, /* maxDepth */ 3);
        ...
        Object exampleObject = (isList ? ((WritableIntObjectInspector) keyObjectInspector).create(0) : VectorRandomRowSource.randomWritable(random, keyTypeInfo, keyObjectInspector, DataTypePhysicalVariation.NONE,
                /* allowNull */ false));
        ...
        while (fillAllKeyCount < allKeyCount)
        {
            ...
            } else
            {
                do
                {
                    object = VectorRandomRowSource.randomWritable(random, keyTypeInfo, keyObjectInspector, DataTypePhysicalVariation.NONE,
                            /* allowNull */ false);
                } while (allKeyTreeSet.contains(object));
            }
    ...
    */
        ...
        for (int i = 0; i < rowCount; i++)
        {
            ...
            try
            {
                copyResult = ObjectInspectorUtils.copyToStandardObject(result, elementObjectInspector, ObjectInspectorCopyOption.WRITABLE);
            } catch (Exception e)
            {
                System.out.println("here");
                throw e;
