...
public class TestSessionHiveMetastoreClientGetPartitionsTempTable extends TestGetPartitions
{
    ...
    public void testGetPartitionWithAuthInfo() throws Exception
    {
        ...
        Partition partition = getClient().getPartitionWithAuthInfo(DB_NAME, TABLE_NAME, Lists.newArrayList("1997", "05", "16"), USER_NAME, GROUPS);
    ...
    {
        createTable3PartCols1PartAuthOn(getClient());
        Partition partition = getClient().getPartitionWithAuthInfo(DB_NAME, TABLE_NAME, Lists.newArrayList("1997", "05", "16"), "", Lists.newArrayList());
        assertNotNull(partition);
        assertAuthInfoReturned(USER_NAME, GROUPS, partition);
    }
