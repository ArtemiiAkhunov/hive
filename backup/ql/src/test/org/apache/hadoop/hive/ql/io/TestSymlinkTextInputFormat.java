...
public class TestSymlinkTextInputFormat
{
     ...
     *
     * @param symlinkFile The symlink file to write.
     * @param paths       The list of paths to write to the symlink file.
     */
    private void writeSymlinkFile(Path symlinkFile, Path... paths) throws IOException
    {
        OutputStreamWriter writer = new OutputStreamWriter(fileSystem.create(symlinkFile));
        for (Path path : paths)
        {
