...
public class TestHiveSchemaConverter
{
    ...
    {
        testConversion("a,b,c,d,e,f,g", "int,bigint,double,boolean,string,float,binary", "message hive_schema {\n" + "  optional int32 a;\n" + "  optional int64 b;\n" + "  optional double c;\n" + "  optional boolean d;\n" + "  optional binary e (UTF8);\n" + "  optional float f;\n" + "  optional binary g;\n" + "}\n");
    }
    ...
    public void testTimestampType() throws Exception
    {
        ...
        testConversion("a", "timestamp", "message hive_schema {\n" + "  optional int96 a;\n" + "}\n", conf);
    }
    ...
    {
        testConversion("arrayCol", "array<tinyint>", "message hive_schema {\n" + "  optional group arrayCol (LIST) {\n" + "    repeated group bag {\n" + "      optional int32 array_element (INT_8);\n" + "    }\n" + "  }\n" + "}\n");
    }

    @Test
    public void testArraySmallInt() throws Exception
    {
        testConversion("arrayCol", "array<smallint>", "message hive_schema {\n" + "  optional group arrayCol (LIST) {\n" + "    repeated group bag {\n" + "      optional int32 array_element (INT_16);\n" + "    }\n" + "  }\n" + "}\n");
    }

    @Test
    public void testArrayString() throws Exception
    {
        testConversion("arrayCol", "array<string>", "message hive_schema {\n" + "  optional group arrayCol (LIST) {\n" + "    repeated group bag {\n" + "      optional binary array_element (UTF8);\n" + "    }\n" + "  }\n" + "}\n");
    }
    ...
    {
        conf.setBoolean(HiveConf.ConfVars.HIVE_PARQUET_WRITE_INT64_TIMESTAMP.varname, false);
        testConversion("arrayCol", "array<timestamp>", "message hive_schema {\n" + "  optional group arrayCol (LIST) {\n" + "    repeated group bag {\n" + "      optional int96 array_element;\n" + "    }\n" + "  }\n" + "}\n", conf);
    }

    @Test
    public void testArrayStruct() throws Exception
    {
        testConversion("structCol", "array<struct<a:string,b:int>>", "message hive_schema {\n" + "  optional group structCol (LIST) {\n" + "    repeated group bag {\n" + "      optional group array_element {\n" + "        optional binary a (UTF8);\n" + "        optional int32 b;\n" + "      }\n" + "    }\n" + "  }\n" + "}\n");
    }
    ...
    {
        testConversion("structCol", "struct<a:tinyint,b:smallint,c:int,d:bigint>", "message hive_schema {\n" + "  optional group structCol {\n" + "    optional int32 a (INT_8);\n" + "    optional int32 b (INT_16);\n" + "    optional int32 c;\n" + "    optional int64 d;\n" + "  }\n" + "}\n");
    }

    @Test
    public void testStructStrings() throws Exception
    {
        testConversion("structCol", "struct<a:char(5),b:varchar(25),c:string>", "message hive_schema {\n" + "  optional group structCol {\n" + "    optional binary a (UTF8);\n" + "    optional binary b (UTF8);\n" + "    optional binary c (UTF8);\n" + "  }\n" + "}\n");
    }
    ...
    {
        conf.setBoolean(HiveConf.ConfVars.HIVE_PARQUET_WRITE_INT64_TIMESTAMP.varname, false);
        testConversion("structCol", "struct<a:timestamp>", "message hive_schema {\n" + "  optional group structCol {\n" + "    optional int96 a;\n" + "  }\n" + "}\n", conf);
    }

    @Test
    public void testStructList() throws Exception
    {
        testConversion("structCol", "struct<a:array<string>,b:int,c:string>", "message hive_schema {\n" + "  optional group structCol {\n" + "    optional group a (LIST) {\n" + "      repeated group bag {\n" + "        optional binary array_element (UTF8);\n" + "      }\n" + "    }\n" + "    optional int32 b;\n" + "    optional binary c (UTF8);" + "  }\n" + "}\n");
    }
    ...
    {
        testConversion("mapCol", "map<smallint,tinyint>", "message hive_schema {\n" + "  optional group mapCol (MAP) {\n" + "    repeated group key_value (MAP_KEY_VALUE) {\n" + "      required int32 key (INT_16);\n" + "      optional int32 value (INT_8);\n" + "    }\n" + "  }\n" + "}\n");
    }

    @Test
    public void testMapStruct() throws Exception
    {
        testConversion("mapCol", "map<string,struct<a:smallint,b:int>>", "message hive_schema {\n" + "  optional group mapCol (MAP) {\n" + "    repeated group key_value (MAP_KEY_VALUE) {\n" + "      required binary key (UTF8);\n" + "      optional group value {\n" + "        optional int32 a (INT_16);\n" + "        optional int32 b;\n" + "      }\n" + "    }\n" + "  }\n" + "}\n");
    }

    @Test
    public void testMapList() throws Exception
    {
        testConversion("mapCol", "map<string,array<string>>", "message hive_schema {\n" + "  optional group mapCol (MAP) {\n" + "    repeated group key_value (MAP_KEY_VALUE) {\n" + "      required binary key (UTF8);\n" + "      optional group value (LIST) {\n" + "        repeated group bag {\n" + "          optional binary array_element (UTF8);\n" + "        }\n" + "      }\n" + "    }\n" + "  }\n" + "}\n");
    }
    ...
    public void testLogicalTypes() throws Exception
    {
        ...
        testLogicalTypeAnnotation("timestamp", "a", LogicalTypeAnnotation.timestampType(false, LogicalTypeAnnotation.TimeUnit.MICROS), conf);
    ...
    private void checkField(Type field, String expectedName, Repetition expectedRepetition, LogicalTypeAnnotation expectedLogicalType)
    {
