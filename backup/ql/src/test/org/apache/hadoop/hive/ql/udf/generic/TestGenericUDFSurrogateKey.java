...
public class TestGenericUDFSurrogateKey
{
    ...
    public void testIllegalNumberOfArgs() throws HiveException
    {
        ...
        expectedException.expectMessage("The function SURROGATE_KEY takes 0 or 2 integer arguments (write id bits, taks id bits), but found 1");

        ConstantObjectInspector argument0 = PrimitiveObjectInspectorFactory.getPrimitiveWritableConstantObjectInspector(TypeInfoFactory.intTypeInfo, new IntWritable(10));
    ...
    {
        ConstantObjectInspector argument0 = PrimitiveObjectInspectorFactory.getPrimitiveWritableConstantObjectInspector(TypeInfoFactory.intTypeInfo, new IntWritable(writeIdBits));
        ConstantObjectInspector argument1 = PrimitiveObjectInspectorFactory.getPrimitiveWritableConstantObjectInspector(TypeInfoFactory.intTypeInfo, new IntWritable(taskIdBits));
