...
public class TestGenericUDFSortArray
{
    ...
    {
        ObjectInspector[] inputOIs = {ObjectInspectorFactory.getStandardListObjectInspector(PrimitiveObjectInspectorFactory.writableIntObjectInspector)};
    ...
    private void runAndVerify(List<Object> actual, List<Object> expected) throws HiveException
    {
