...
public class RowTestObjectsMultiSet
{
    ...
    public enum RowFlag
    {
        NONE(0), REGULAR(0x01), LEFT_OUTER(0x02), FULL_OUTER(0x04);
    ...
    public void displayDifferences(RowTestObjectsMultiSet other, String left, String right)
    {
        ...
        Iterator<Entry<RowTestObjects, Value>> leftOnlyIterator = leftOnly.sortedMap.entrySet().iterator();
        ...
        Iterator<Entry<RowTestObjects, Value>> rightOnlyIterator = rightOnly.sortedMap.entrySet().iterator();
