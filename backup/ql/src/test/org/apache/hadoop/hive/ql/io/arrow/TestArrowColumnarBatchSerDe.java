...
public class TestArrowColumnarBatchSerDe
{
    ...
    private final static Object[][] INTEGER_ROWS = {{byteW(0), shortW(0), intW(0), longW(0)}, {byteW(1), shortW(1), intW(1), longW(1)}, {byteW(-1), shortW(-1), intW(-1), longW(-1)}, {byteW(Byte.MIN_VALUE), shortW(Short.MIN_VALUE), intW(Integer.MIN_VALUE), longW(Long.MIN_VALUE)}, {byteW(Byte.MAX_VALUE), shortW(Short.MAX_VALUE), intW(Integer.MAX_VALUE), longW(Long.MAX_VALUE)}, {null, null, null, null},};

    private final static Object[][] FLOAT_ROWS = {{floatW(0f), doubleW(0d)}, {floatW(1f), doubleW(1d)}, {floatW(-1f), doubleW(-1d)}, {floatW(Float.MIN_VALUE), doubleW(Double.MIN_VALUE)}, {floatW(-Float.MIN_VALUE), doubleW(-Double.MIN_VALUE)}, {floatW(Float.MAX_VALUE), doubleW(Double.MAX_VALUE)}, {floatW(-Float.MAX_VALUE), doubleW(-Double.MAX_VALUE)}, {floatW(Float.POSITIVE_INFINITY), doubleW(Double.POSITIVE_INFINITY)}, {floatW(Float.NEGATIVE_INFINITY), doubleW(Double.NEGATIVE_INFINITY)}, {null, null},};

    private final static Object[][] STRING_ROWS = {{text(""), charW("", 10), varcharW("", 10)}, {text("Hello"), charW("Hello", 10), varcharW("Hello", 10)}, {text("world!"), charW("world!", 10), varcharW("world!", 10)}, {text("안녕?"), charW("안녕?", 10), varcharW("안녕?", 10)}, {null, null, null},};
    ...
    private final static Object[][] DTI_ROWS = {{new DateWritableV2(DateWritableV2.millisToDays(TIME_IN_MILLIS)), new TimestampWritableV2(TIMESTAMP), new HiveIntervalYearMonthWritable(new HiveIntervalYearMonth(1, 2)), new HiveIntervalDayTimeWritable(new HiveIntervalDayTime(1, 2, 3, 4, 5_000_000))}, {new DateWritableV2(DateWritableV2.millisToDays(NEGATIVE_TIME_IN_MILLIS)), new TimestampWritableV2(NEGATIVE_TIMESTAMP_WITHOUT_NANOS), null, null}, {null, null, null, null},};

    private final static Object[][] DECIMAL_ROWS = {{decimalW(HiveDecimal.ZERO)}, {decimalW(HiveDecimal.ONE)}, {decimalW(HiveDecimal.ONE.negate())}, {decimalW(HiveDecimal.create("0.000001"))}, {decimalW(HiveDecimal.create("100000"))}, {null},};

    private final static Object[][] BOOLEAN_ROWS = {{new BooleanWritable(true)}, {new BooleanWritable(false)}, {null},};

    private final static Object[][] BINARY_ROWS = {{new BytesWritable("".getBytes())}, {new BytesWritable("Hello".getBytes())}, {new BytesWritable("world!".getBytes())}, {null},};
    ...
    private void initAndSerializeAndDeserializeSelected(String[][] schema, Object[][] rows, int[] selected) throws SerDeException
    {
        ArrowColumnarBatchSerDe serDe = new ArrowColumnarBatchSerDe();
        StructObjectInspector rowOI = initSerDe(serDe, schema);
    ...
    public void testComprehensive() throws SerDeException
    {
        ...
        Object[][] comprehensiveRows = {{intW(0), // c1:int
                new BooleanWritable(false), // c2:boolean
                doubleW(0), // c3:double
                text("Hello"), // c4:string
                newArrayList(intW(0), intW(1), intW(2)), // c5:array<int>
                Maps.toMap(newArrayList(intW(0), intW(1), intW(2)), input -> text("Number " + input)), // c6:map<int,string>
                Maps.toMap(newArrayList(text("apple"), text("banana"), text("carrot")), input -> text(input.toString().toUpperCase())), // c7:map<string,string>
                new Object[]{text("0"), intW(1), doubleW(2)}, // c8:struct<r:string,s:int,t:double>
                byteW(0), // c9:tinyint
                shortW(0), // c10:smallint
                floatW(0), // c11:float
                longW(0), // c12:bigint
                newArrayList(newArrayList(text("a"), text("b"), text("c")), newArrayList(text("A"), text("B"), text("C"))), // c13:array<array<string>>
                Maps.toMap(newArrayList(intW(0), intW(1), intW(2)), x -> Maps.toMap(newArrayList(x, intW(x.get() * 2)), y -> y)), // c14:map<int,map<int,int>>
                new Object[]{intW(0), newArrayList(intW(1), text("Hello"))}, // c15:struct<r:int,s:struct<a:int,b:string>>
                Collections.singletonList(newArrayList(Maps.toMap(newArrayList(text("hello")), input -> text(input.toString().toUpperCase())), intW(0))), // c16:array<struct<m:map<string,string>,n:int>>
    ...
    {
        String[][] schema = {{"tinyint1", "tinyint"}, {"smallint1", "smallint"}, {"int1", "int"}, {"bigint1", "bigint"}};
    ...
    {
        String[][] schema = {{"float1", "float"}, {"double1", "double"},};
    ...
    {
        String[][] schema = {{"string1", "string"}, {"char1", "char(10)"}, {"varchar1", "varchar(10)"},};
    ...
    {
        String[][] schema = {{"date1", "date"}, {"timestamp1", "timestamp"}, {"interval_year_month1", "interval_year_month"}, {"interval_day_time1", "interval_day_time"},};
    ...
    @Test
    public void testNativeDecimalSelected() throws SerDeException
    {
        String[][] schema = {{"decimal1", "decimal(38,10)"},};
        int[] selectedRows = new int[]{0, 2, 4};
    ...
    {
        String[][] schema = {{"boolean1", "boolean"},};
    ...
    {
        String[][] schema = {{"tinyint_list", "array<tinyint>"}, {"smallint_list", "array<smallint>"}, {"int_list", "array<int>"}, {"bigint_list", "array<bigint>"},};
    ...
    {
        String[][] schema = {{"float_list", "array<float>"}, {"double_list", "array<double>"},};
    ...
    {
        String[][] schema = {{"string_list", "array<string>"}, {"char_list", "array<char(10)>"}, {"varchar_list", "array<varchar(10)>"},};
    ...
    {
        String[][] schema = {{"date_list", "array<date>"}, {"timestamp_list", "array<timestamp>"}, {"interval_year_month_list", "array<interval_year_month>"}, {"interval_day_time_list", "array<interval_day_time>"},};
    ...
    {
        String[][] schema = {{"boolean_list", "array<boolean>"},};
    ...
    {
        String[][] schema = {{"binary_list", "array<binary>"},};
    ...
    {
        String[][] schema = {{"int_struct", "struct<tinyint1:tinyint,smallint1:smallint,int1:int,bigint1:bigint>"},};
        int[] selectedRows = new int[]{1, 3, 5};
    ...
    {
        String[][] schema = {{"float_struct", "struct<float1:float,double1:double>"},};
    ...
    {
        String[][] schema = {{"string_struct", "struct<string1:string,char1:char(10),varchar1:varchar(10)>"},};
    ...
    {
        String[][] schema = {{"date_struct", "struct<date1:date,timestamp1:timestamp," + "interval_year_month1:interval_year_month,interval_day_time1:interval_day_time>"},};
    ...
    {
        String[][] schema = {{"decimal_struct", "struct<decimal1:decimal(38,10)>"},};
    ...
    {
        String[][] schema = {{"boolean_struct", "struct<boolean1:boolean>"},};
    ...
    {
        String[][] schema = {{"binary_struct", "struct<binary1:binary>"},};
    ...
    {
        String[][] schema = {{"tinyint_map", "map<string,tinyint>"}, {"smallint_map", "map<string,smallint>"}, {"int_map", "map<string,int>"}, {"bigint_map", "map<string,bigint>"},};
        int[] selectedRows = new int[]{1, 3, 5};
    ...
    {
        String[][] schema = {{"float_map", "map<string,float>"}, {"double_map", "map<string,double>"},};
    ...
    {
        String[][] schema = {{"string_map", "map<string,string>"}, {"char_map", "map<string,char(10)>"}, {"varchar_map", "map<string,varchar(10)>"},};
    ...
    {
        String[][] schema = {{"date_map", "map<string,date>"}, {"timestamp_map", "map<string,timestamp>"}, {"interval_year_month_map", "map<string,interval_year_month>"}, {"interval_day_time_map", "map<string,interval_day_time>"},};
    ...
    {
        String[][] schema = {{"boolean_map", "map<string,boolean>"},};
    ...
    {
        String[][] schema = {{"binary_map", "map<string,binary>"},};
    ...
    {
        String[][] schema = {{"decimal_map", "map<string,decimal(38,10)>"},};
    ...
    {
        String[][] schema = {{"decimal_list", "array<decimal(38,10)>"},};
    ...
    {
        String[][] schema = {{"int_map", "map<string,int>"},};
