...
public class TestVectorMapJoinFastHashMapContainerNonMatched
{
    ...
    public void testLongHashMapContainer() throws Exception
    {
        ...
        VectorMapJoinFastLongHashMapContainer hashMapContainer = new VectorMapJoinFastLongHashMapContainer(true, /* isFullOuter */
                false, /* minMaxEnabled */
                VectorMapJoinDesc.HashTableKeyType.LONG, initialCapacity, loadFactor, writeBufferSize, estimatedKeyCount, tableDesc, numHashTable);
    ...
    public void testStringHashMapContainer() throws Exception
    {
        ...
        VectorMapJoinFastStringHashMapContainer hashMapContainer = new VectorMapJoinFastStringHashMapContainer(true, /* isFullOuter */
                initialCapacity, loadFactor, writeBufferSize, estimatedKeyCount, tableDesc, numHashTable);
    ...
    {
        Random random = new Random();
        BinarySortableSerializeWrite serializeWrite = BinarySortableSerializeWrite.with(new Properties(), 2);
        ...
        VectorMapJoinFastMultiKeyHashMapContainer hashMapContainer = new VectorMapJoinFastMultiKeyHashMapContainer(true, /* isFullOuter */
                initialCapacity, loadFactor, writeBufferSize, estimatedKeyCount, numHashTable);
