...
public class TestVectorMapJoinFastRowHashMap extends CommonFastHashTable
{
    ...
    private void addAndVerifyRows(VectorRandomRowSource valueSource, Object[][] rows, VectorMapJoinFastHashTableContainerBase map, HashTableKeyType hashTableKeyType, VerifyFastRowHashMap verifyTable, String[] keyTypeNames, boolean doClipping, boolean useExactBytes) throws HiveException, IOException
    {
    ...
    public void testBigIntRows() throws Exception
    {
        ...
        valueSource.init(random, VectorRandomRowSource.SupportedTypes.ALL, 4,
                /* allowNulls */ false, /* isUnicodeOk */ false);

        int rowCount = 1000;
        Object[][] rows = valueSource.randomRows(rowCount);

        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.LONG, verifyTable, new String[]{"bigint"},
    ...
    public void testIntRows() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.INT, verifyTable, new String[]{"int"},
                /* doClipping */ false, /* useExactBytes */ false);
    }
    ...
    public void testStringRows() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.STRING, verifyTable, new String[]{"string"},
                /* doClipping */ false, /* useExactBytes */ false);
    }
    ...
    public void testMultiKeyRows1() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.MULTI_KEY, verifyTable, new String[]{"int", "int"},
                /* doClipping */ false, /* useExactBytes */ false);
    }
    ...
    public void testMultiKeyRows2() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.MULTI_KEY, verifyTable, new String[]{"string", "string"},
                /* doClipping */ false, /* useExactBytes */ false);
    }
    ...
    public void testMultiKeyRows3() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.MULTI_KEY, verifyTable, new String[]{"bigint", "timestamp", "double"},
                /* doClipping */ false, /* useExactBytes */ false);
    }
    ...
    public void testMultiKeyRowsClipped1() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.MULTI_KEY, verifyTable, new String[]{"varchar(20)", "date", "interval_day_time"},
                /* doClipping */ true, /* useExactBytes */ false);
    }
    ...
    public void testMultiKeyRowsClipped2() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.MULTI_KEY, verifyTable, new String[]{"varchar(20)", "varchar(40)"},
                /* doClipping */ true, /* useExactBytes */ false);
    }
    ...
    public void testMultiKeyRowsClipped3() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.MULTI_KEY, verifyTable, new String[]{"float", "tinyint"},
                /* doClipping */ true, /* useExactBytes */ false);
    }
    ...
    public void testMultiKeyRowsExact1() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.MULTI_KEY, verifyTable, new String[]{"string", "string", "string", "string"},
                /* doClipping */ false, /* useExactBytes */ true);
    }
    ...
    public void testMultiKeyRowsExact2() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.MULTI_KEY, verifyTable, new String[]{"smallint"},
                /* doClipping */ false, /* useExactBytes */ true);
    }
    ...
    public void testMultiKeyRowsExact3() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.MULTI_KEY, verifyTable, new String[]{"int", "binary"},
                /* doClipping */ false, /* useExactBytes */ true);
    }
    ...
    public void testMultiKeyRowsClippedExact1() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.MULTI_KEY, verifyTable, new String[]{"interval_year_month", "decimal(12,8)"},
                /* doClipping */ true, /* useExactBytes */ true);
    }
    ...
    public void testMultiKeyRowsClippedExact2() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.MULTI_KEY, verifyTable, new String[]{"bigint", "string", "int"},
                /* doClipping */ true, /* useExactBytes */ true);
    }
    ...
    public void testMultiKeyRowsClippedExact3() throws Exception
    {
        ...
        addAndVerifyRows(valueSource, rows, map, HashTableKeyType.MULTI_KEY, verifyTable, new String[]{"bigint", "string", "varchar(5000)"},
                /* doClipping */ true, /* useExactBytes */ true);
    }
}
