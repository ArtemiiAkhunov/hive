...
public class TestTxnConcatenate extends TxnCommandsBaseForTests
{
    ...
    /*in UTs, there is no standalone HMS running to kick off compaction so it's done via runWorker()
     but in normal usage 'concatenate' is blocking, */
        ...
        String[][] expected2 = new String[][]{{"{\"writeid\":2,\"bucketid\":536936449,\"rowid\":0}\t1\t4", "acidtbl/base_0000003_v0000021/bucket_00001"}, {"{\"writeid\":2,\"bucketid\":536936449,\"rowid\":1}\t4\t4", "acidtbl/base_0000003_v0000021/bucket_00001"}, {"{\"writeid\":3,\"bucketid\":536936448,\"rowid\":0}\t5\t6", "acidtbl/base_0000003_v0000021/bucket_00001"}, {"{\"writeid\":3,\"bucketid\":536936448,\"rowid\":1}\t8\t8", "acidtbl/base_0000003_v0000021/bucket_00001"}};
    ...
    /*in UTs, there is no standalone HMS running to kick off compaction so it's done via runWorker()
      but in normal usage 'concatenate' is blocking, */
        ...
        Assert.assertEquals(1, rsp.getCompactsSize());
        Assert.assertEquals(TxnStore.CLEANING_RESPONSE, rsp.getCompacts().get(0).getState());
        String[][] expected2 = new String[][]{{"1\t2", "t/base_0000003_v0000022/000000_0"}, {"4\t5", "t/base_0000003_v0000022/000000_0"}, {"5\t6", "t/base_0000003_v0000022/000000_0"}, {"8\t8", "t/base_0000003_v0000022/000000_0"}};
        checkResult(expected2, testQuery, false, "check data after concatenate", LOG);
    }
}
