...
*/
        ...
        fs.rename(new Path(getWarehouseDir() + "/tflat/000000_0_copy_1"), new Path(getWarehouseDir() + "/tflat/subdir/part-0001"));
        //simulate Insert ... Select ... Union All...
        fs.rename(new Path(getWarehouseDir() + "/tflat/000000_0_copy_3"), new Path(getWarehouseDir() + "/tflat/1/000000_0"));
        fs.rename(new Path(getWarehouseDir() + "/tflat/000000_0_copy_4"), new Path(getWarehouseDir() + "/tflat/2/000000_0"));
        ...
        Assert.assertEquals("Expected TAcid to not be full acid", false, AcidUtils.isFullAcidTable(tacid));
        org.apache.hadoop.hive.ql.metadata.Table tacidpart = db.getTable("default", "tacidpart");
        Assert.assertEquals("Expected TAcidPart to not be full acid", false, AcidUtils.isFullAcidTable(tacidpart));

        org.apache.hadoop.hive.ql.metadata.Table t = db.getTable("default", "tflat");
        Assert.assertEquals("Expected TAcid to not be full acid", false, AcidUtils.isFullAcidTable(t));
        t = db.getTable("default", "tflattext");
        Assert.assertEquals("Expected TAcidPart to not be full acid", false, AcidUtils.isInsertOnlyTable(tacidpart));
        ...
        Assert.assertEquals("Expected TAcid to become full acid", true, AcidUtils.isFullAcidTable(tacid));
        tacidpart = db.getTable("default", "tacidpart");
        Assert.assertEquals("Expected TAcidPart to become full acid", true, AcidUtils.isFullAcidTable(tacidpart));

        t = db.getTable("default", "tflat");
        Assert.assertEquals("Expected TAcid to become acid", true, AcidUtils.isFullAcidTable(t));
        t = db.getTable("default", "tflattext");
        Assert.assertEquals("Expected TAcidPart to become MM", true, AcidUtils.isInsertOnlyTable(t));
