...
public class TestOrcRecordUpdater
{
    ...
    public void testAccessors() throws Exception
    {
        ...
        event.setFieldValue(OrcRecordUpdater.CURRENT_WRITEID, new LongWritable(100));
        event.setFieldValue(OrcRecordUpdater.ORIGINAL_WRITEID, new LongWritable(50));
    ...
    private static int getBucketId(OrcStruct row)
    {
        ...
        return BucketCodec.determineVersion(bucketValue).decodeWriterId(bucketValue);
    }
