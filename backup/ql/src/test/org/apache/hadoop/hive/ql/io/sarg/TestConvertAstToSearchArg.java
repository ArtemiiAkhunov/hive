...
public class TestConvertAstToSearchArg
{
    ...
    /* first_name is null or
       ...
       id <= 4; */
        ...
        assertEquals("(or leaf-0 (not leaf-1) (not leaf-2) leaf-3)", sarg.getExpression().toOldString());
        assertNoSharedNodes(sarg.getExpression(), Sets.<ExpressionTree>newIdentityHashSet());
    ...
    /* (id between 23 and 45) and
       ...
       substr(first_name, 3) == 'yyy' */
        ...
        assertEquals("(and leaf-0 leaf-1 leaf-2)", sarg.getExpression().toOldString());
        assertNoSharedNodes(sarg.getExpression(), Sets.<ExpressionTree>newIdentityHashSet());
    }
    ...
    /* id <> 12 and
      ...
      ('john', 'sue') */
        ...
        assertEquals("(and (not leaf-0) leaf-1 leaf-2)", sarg.getExpression().toOldString());
        assertNoSharedNodes(sarg.getExpression(), Sets.<ExpressionTree>newIdentityHashSet());
    ...
    /* (id < 10 and id < 11 and id < 12) or (id < 13 and id < 14 and id < 15) or
       (id < 16 and id < 17) or id < 18 */
        ...
        assertEquals("(and" + " (or leaf-0 leaf-1 leaf-2 leaf-3)" + " (or leaf-0 leaf-4 leaf-2 leaf-3)" + " (or leaf-0 leaf-5 leaf-2 leaf-3)" + " (or leaf-0 leaf-1 leaf-6 leaf-3)" + " (or leaf-0 leaf-4 leaf-6 leaf-3)" + " (or leaf-0 leaf-5 leaf-6 leaf-3)" + " (or leaf-0 leaf-1 leaf-7 leaf-3)" + " (or leaf-0 leaf-4 leaf-7 leaf-3)" + " (or leaf-0 leaf-5 leaf-7 leaf-3)" + " (or leaf-0 leaf-1 leaf-2 leaf-8)" + " (or leaf-0 leaf-4 leaf-2 leaf-8)" + " (or leaf-0 leaf-5 leaf-2 leaf-8)" + " (or leaf-0 leaf-1 leaf-6 leaf-8)" + " (or leaf-0 leaf-4 leaf-6 leaf-8)" + " (or leaf-0 leaf-5 leaf-6 leaf-8)" + " (or leaf-0 leaf-1 leaf-7 leaf-8)" + " (or leaf-0 leaf-4 leaf-7 leaf-8)" + " (or leaf-0 leaf-5 leaf-7 leaf-8))", sarg.getExpression().toOldString());
    }
    ...
    {
        ExprNodeGenericFuncDesc node = getColumnEqualsConstantExpression(TypeInfoFactory.timestampTypeInfo, "ts", Timestamp.ofEpochMilli(1426595696000L));
    ...
    {
        ExprNodeGenericFuncDesc node = getColumnEqualsConstantExpression(TypeInfoFactory.dateTypeInfo, "dt", "2015-05-05");
        String serialAst = SerializationUtilities.serializeExpression(node);
    ...
    {
        ExprNodeGenericFuncDesc node = getColumnEqualsConstantExpression(TypeInfoFactory.decimalTypeInfo, "dec", 123);
        String serialAst = SerializationUtilities.serializeExpression(node);
    ...
    {
        ExprNodeGenericFuncDesc node = getColumnEqualsConstantExpression(TypeInfoFactory.charTypeInfo, "ch", "char      ");
        String serialAst = SerializationUtilities.serializeExpression(node);
    ...
    {
        ExprNodeGenericFuncDesc node = getColumnEqualsConstantExpression(TypeInfoFactory.varcharTypeInfo, "vc", "variable");
        String serialAst = SerializationUtilities.serializeExpression(node);
    ...
    {
        ExprNodeGenericFuncDesc node = getColumnEqualsConstantExpression(TypeInfoFactory.intTypeInfo, "bi", 12345);
        String serialAst = SerializationUtilities.serializeExpression(node);
    ...
    {
        ExprNodeDesc column1 = new ExprNodeColumnDesc(TypeInfoFactory.booleanTypeInfo, "b1", null, false);
        ExprNodeDesc column2 = new ExprNodeColumnDesc(TypeInfoFactory.booleanTypeInfo, "b2", null, false);
        ExprNodeDesc constant = new ExprNodeConstantDesc(TypeInfoFactory.booleanTypeInfo, true);

        ExprNodeGenericFuncDesc function1 = new ExprNodeGenericFuncDesc(TypeInfoFactory.booleanTypeInfo, new GenericUDFOPEqual(), Lists.newArrayList(column1, constant));
        ExprNodeGenericFuncDesc function2 = new ExprNodeGenericFuncDesc(TypeInfoFactory.booleanTypeInfo, new GenericUDFOPEqual(), Lists.newArrayList(column2, constant));

        List<ExprNodeDesc> children = Lists.newArrayList();

        children.add(function1);
        children.add(function2);
        ExprNodeGenericFuncDesc node = new ExprNodeGenericFuncDesc(TypeInfoFactory.booleanTypeInfo, new GenericUDFOPAnd(), children);
        String serialAst = SerializationUtilities.serializeExpression(node);
    ...
    {
        ExprNodeGenericFuncDesc node = getColumnEqualsConstantExpression(TypeInfoFactory.floatTypeInfo, "flt", 1.1f);
        String serialAst = SerializationUtilities.serializeExpression(node);
    ...
    {
        ExprNodeGenericFuncDesc node = getColumnEqualsConstantExpression(TypeInfoFactory.doubleTypeInfo, "dbl", 2.2);
        String serialAst = SerializationUtilities.serializeExpression(node);
    ...
    private ExprNodeGenericFuncDesc getColumnEqualsConstantExpression(TypeInfo typeInfo, String columnName, Object value)
    {
        ...
        ExprNodeGenericFuncDesc node = new ExprNodeGenericFuncDesc(typeInfo, new GenericUDFOPEqual(), children);
        return node;
    }
}
