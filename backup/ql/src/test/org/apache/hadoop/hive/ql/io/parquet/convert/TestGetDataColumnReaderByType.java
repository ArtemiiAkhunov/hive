...
public class TestGetDataColumnReaderByType
{
    ...
    public void testGetDecimalReader() throws Exception
    {
        ...
        ParquetDataColumnReader reader = ParquetDataColumnReaderFactory.getDataColumnReaderByType(Types.optional(PrimitiveTypeName.FIXED_LEN_BYTE_ARRAY).length(20).as(LogicalTypeAnnotation.decimalType(2, 5)).named("value"), hiveTypeInfo, null, true, null, false);
    ...
    public void testGetStringReader() throws Exception
    {
        ...
        ParquetDataColumnReader reader = ParquetDataColumnReaderFactory.getDataColumnReaderByType(Types.optional(PrimitiveTypeName.BINARY).as(LogicalTypeAnnotation.stringType()).named("value"), hiveTypeInfo, null, true, null, false);
    ...
    {
        TypeInfo hiveTypeInfo = new DecimalTypeInfo(7, 2);
        ParquetDataColumnReader reader = ParquetDataColumnReaderFactory.getDataColumnReaderByType(Types.optional(PrimitiveTypeName.BINARY).as(LogicalTypeAnnotation.decimalType(2, 5)).named("value"), hiveTypeInfo, null, true, null, false);
        assertTrue(reader instanceof TypesFromDecimalPageReader);
    }
    ...
    public void testGetBinaryReaderNoOriginalType() throws Exception
    {
        PrimitiveTypeInfo hiveTypeInfo = new PrimitiveTypeInfo();
        hiveTypeInfo.setTypeName("string");
        ParquetDataColumnReader reader = ParquetDataColumnReaderFactory.getDataColumnReaderByType(Types.optional(PrimitiveTypeName.BINARY).named("value"), hiveTypeInfo, null, true, null, false);
    ...
    public void testGetBinaryReaderJsonOriginalType() throws Exception
    {
        ...
        ParquetDataColumnReader reader = ParquetDataColumnReaderFactory.getDataColumnReaderByType(Types.optional(PrimitiveTypeName.BINARY).as(LogicalTypeAnnotation.jsonType()).named("value"), hiveTypeInfo, null, true, null, false);
        assertTrue(reader instanceof DefaultParquetDataColumnReader);
    }
    ...
    public void testGetIntReader() throws Exception
    {
        ...
        ParquetDataColumnReader reader = ParquetDataColumnReaderFactory.getDataColumnReaderByType(Types.optional(PrimitiveTypeName.INT32).as(LogicalTypeAnnotation.intType(32, false)).named("value"), hiveTypeInfo, null, true, null, false);
    ...
    public void testGetIntReaderNoOriginalType() throws Exception
    {
        PrimitiveTypeInfo hiveTypeInfo = new PrimitiveTypeInfo();
        hiveTypeInfo.setTypeName("int");
        ParquetDataColumnReader reader = ParquetDataColumnReaderFactory.getDataColumnReaderByType(Types.optional(PrimitiveTypeName.INT32).named("value"), hiveTypeInfo, null, true, null, false);
        assertTrue(reader instanceof TypesFromInt32PageReader);
    }
    ...
    public void testGetInt64ReaderNoOriginalType() throws Exception
    {
        ...
        ParquetDataColumnReader reader = ParquetDataColumnReaderFactory.getDataColumnReaderByType(Types.optional(PrimitiveTypeName.INT64).named("value"), hiveTypeInfo, null, true, null, false);
    ...
    public void testGetInt64Reader() throws Exception
    {
        PrimitiveTypeInfo hiveTypeInfo = new PrimitiveTypeInfo();
        hiveTypeInfo.setTypeName("bigint");
        ParquetDataColumnReader reader = ParquetDataColumnReaderFactory.getDataColumnReaderByType(Types.optional(PrimitiveTypeName.INT64).as(LogicalTypeAnnotation.intType(64, false)).named("value"), hiveTypeInfo, null, true, null, false);
        assertTrue(reader instanceof TypesFromInt64PageReader);
    }
    ...
    public void testGetFloatReader() throws Exception
    {
        ...
        ParquetDataColumnReader reader = ParquetDataColumnReaderFactory.getDataColumnReaderByType(Types.optional(PrimitiveTypeName.FLOAT).named("value"), hiveTypeInfo, null, true, null, false);
    ...
    public void testGetDoubleReader() throws Exception
    {
        ...
        ParquetDataColumnReader reader = ParquetDataColumnReaderFactory.getDataColumnReaderByType(Types.optional(PrimitiveTypeName.DOUBLE).named("value"), hiveTypeInfo, null, true, null, false);
    ...
    public void testGetInt96Reader() throws Exception
    {
        ...
        ParquetDataColumnReader reader = ParquetDataColumnReaderFactory.getDataColumnReaderByType(Types.optional(PrimitiveTypeName.INT96).named("value"), hiveTypeInfo, null, true, null, false);
    ...
    public void testGetBooleanReader() throws Exception
    {
        ...
        ParquetDataColumnReader reader = ParquetDataColumnReaderFactory.getDataColumnReaderByType(Types.optional(PrimitiveTypeName.BOOLEAN).named("value"), hiveTypeInfo, null, true, null, false);
