...
public class TestCompactionTxnHandler
{
    ...
    public void testMarkFailed() throws Exception
    {
        ...
        try
        {
            ...
            txnHandler.markFailed(ci);
            fail("The first call to markFailed() must have failed as this call did " + "not throw the expected exception");
    ...
    public void testFindPotentialCompactions() throws Exception
    {
        ...
        potentials = txnHandler.findPotentialCompactions(100, -1, Instant.now().minusSeconds(1).toEpochMilli());
        assertEquals(2, potentials.size());
