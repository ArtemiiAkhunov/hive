...
public class TestExprProcessorGetFuncExpr
{
    ...
    public void setUp() throws Exception
    {
        ...
        Function function = new Function("myupper", sessionState.getCurrentDatabase(), "org.apache.hadoop.hive.ql.udf.generic.GenericUDFUpper", sessionState.getUserName(), PrincipalType.USER, (int) (System.currentTimeMillis() / 1000), FunctionType.JAVA, null);
