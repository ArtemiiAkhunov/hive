...
public class TestOperatorCmp
{
    ...
    {
        IDriver driver = createDriver();
        PlanMapper pm0 = getMapperForQuery(driver, "select u,v from tu,tv where tu.id_uv = tv.id_uv and u>1 and v<10 group by u,v");
        PlanMapper pm1 = getMapperForQuery(driver, "select u,v from tu,tv where tu.id_uv = tv.id_uv and u>1 and v<10 group by u,v");
