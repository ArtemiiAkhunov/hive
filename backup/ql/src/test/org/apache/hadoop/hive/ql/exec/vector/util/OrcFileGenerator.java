...
public class OrcFileGenerator
{
    ...
    {
        AllValues, NoNulls, RepeatingValue, RepeatingNull
    }
    ...
    private static class ByteBatchGenerator extends BatchGenerator<Byte>
    {
        ...
        {
            return (byte) (rand.nextInt((Byte.MAX_VALUE - Byte.MIN_VALUE) / 2) - Math.abs(Byte.MIN_VALUE / 2));
        }
    ...
    private static class ShortBatchGenerator extends BatchGenerator<Short>
    {
        ...
        {
            return (short) (rand.nextInt((Short.MAX_VALUE - Short.MIN_VALUE) / 2) + (Short.MIN_VALUE / 2));
        }
    ...
    private static class TimestampBatchGenerator extends BatchGenerator<Timestamp>
    {
        ...
        protected Timestamp[] initializeFixedPointValues()
        {
            ...
            return new Timestamp[]{new Timestamp(-29071), new Timestamp(-10669), new Timestamp(16558), new Timestamp(31808)};
        }
    }
