...
public class TestTxnAddPartition extends TxnCommandsBaseForTests
{
    ...
    private void addPartition(boolean isVectorized) throws Exception
    {
        ...
        String stmt = "ALTER TABLE T ADD IF NOT EXISTS " + "PARTITION (p=0) location '" + getWarehouseDir() + "/3/data' "//p=0 exists and is not empty
    ...
    private void addPartitionMM(boolean isVectorized) throws Exception
    {
        ...
        //should be no-op since p=3 exists
        runStatementOnDriver("ALTER TABLE T ADD IF NOT EXISTS " + "PARTITION (p=0) location '" + getWarehouseDir() + "/3/data' "//p=0 exists and is not empty
                + "PARTITION (p=2) location '" + getWarehouseDir() + "/3/data'"//p=2 exists and is empty
                + "PARTITION (p=3) location '" + getWarehouseDir() + "/3/data'");//p=3 doesn't exist
    ...
    public void addPartitionBucketed() throws Exception
    {
        ...
        String[][] expected = new String[][]{{"{\"writeid\":1,\"bucketid\":536936448,\"rowid\":0}\t0\t0\t2", "warehouse/t/p=0/delta_0000001_0000001_0000/000001_0"}, {"{\"writeid\":1,\"bucketid\":536936448,\"rowid\":1}\t0\t1\t4", "warehouse/t/p=0/delta_0000001_0000001_0000/000001_0"}};
