...
public class TestGenericUDFOPPlus extends AbstractTestGenericUDFOPNumeric
{
    ...
    public void testTimestampPlusIntervalYearMonth() throws Exception
    {
        ...
        TimestampWritableV2 left = new TimestampWritableV2(Timestamp.valueOf("2001-11-15 01:02:03.123456789"));
    ...
    public void testTimestampPlusIntervalDayTime() throws Exception
    {
        ...
        TimestampWritableV2 left = new TimestampWritableV2(Timestamp.valueOf("2001-01-01 00:00:00"));
    ...
    public void testIntervalDayTimePlusDate() throws Exception
    {
        ...
        HiveIntervalDayTimeWritable left = new HiveIntervalDayTimeWritable(HiveIntervalDayTime.valueOf("1 2:3:4.567"));
        DateWritableV2 right = new DateWritableV2(Date.valueOf("2001-01-01"));
