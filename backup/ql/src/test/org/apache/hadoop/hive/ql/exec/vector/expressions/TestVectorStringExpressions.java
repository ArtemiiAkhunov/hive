...
public class TestVectorStringExpressions
{
    ...
    public void testCharScalarCompareStringCol() throws HiveException
    {
        VectorizedRowBatch batch = makeStringBatch();
        VectorExpression expr;
        expr = new FilterCharScalarEqualStringGroupColumn(new HiveChar(new String(red2), 8).getStrippedValue().getBytes(), 0);
        expr.evaluate(batch);
    ...
    public void testCharScalarCompareStringColProjection() throws HiveException
    {
        ...
        expr = new CharScalarEqualStringGroupColumn(new HiveChar(new String(red2), 8).getStrippedValue().getBytes(), 0, 2);
        expr.evaluate(batch);
        Assert.assertEquals(3, batch.size);
        LongColumnVector outVector = (LongColumnVector) batch.cols[2];
        Assert.assertEquals(1, outVector.vector[0]);
    ...
    public void testStringLikePatternType() throws HiveException
    {
        ...
        expr = new FilterStringColLikeStringScalar(0, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa_b".getBytes());
        expr.transientInit(hiveConf);
        expr.evaluate(vrb);
        Assert.assertEquals(FilterStringColLikeStringScalar.ComplexChecker.class, expr.checker.getClass());
    ...
    public void testSubstrStart() throws HiveException
    {
        ...
        Assert.assertEquals(0, StringExpr.compare(
