...
public class TestVectorUDAFBloomFilterMerge
{
    ...
    private void testMergeBloomKFilterBytesParallel(int threads) throws IOException
    {
        ...
        byte[] bf1Bytes = getBloomKFilterBytesFromStringValues(expectedEntries, "bloo", "bloom fil", "bloom filter", "cuckoo filter");
        byte[] bf2Bytes = getBloomKFilterBytesFromStringValues(expectedEntries, "2_bloo", "2_bloom fil", "2_bloom filter", "2_cuckoo filter");
        byte[] bf3Bytes = getBloomKFilterBytesFromStringValues(expectedEntries, "3_bloo", "3_bloom fil", "3_bloom filter", "3_cuckoo filter");
        byte[] bf4Bytes = getBloomKFilterBytesFromStringValues(expectedEntries, "4_bloo", "4_bloom fil", "4_bloom filter", "4_cuckoo filter");
        byte[] bf5Bytes = getBloomKFilterBytesFromStringValues(expectedEntries, "5_bloo", "5_bloom fil", "5_bloom filter", "5_cuckoo filter");
        ...
        VectorUDAFBloomFilterMerge.Aggregation agg = new VectorUDAFBloomFilterMerge.Aggregation(expectedEntries, threads);
