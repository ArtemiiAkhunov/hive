...
public class TestBucketCodec
{
    ...
    {
        BucketCodec.getCodec(1).encode(new AcidOutputFormat.Options(null).bucket(BucketCodec.MAX_BUCKET_ID + 1).statementId(16));
    }
    ...
    {
        BucketCodec.getCodec(1).encode(new AcidOutputFormat.Options(null).bucket(7).statementId(BucketCodec.MAX_STATEMENT_ID + 1));
    }

    @Test
    public void testBucketIdTakesExtra8BitsFromStmtId()
    {
        AcidOutputFormat.Options options = new AcidOutputFormat.Options(null).bucket(5000)             // 1|001110001000
    ...
    {
        AcidOutputFormat.Options options = new AcidOutputFormat.Options(null).bucket(65535).statementId(150)         //   000010010110
    ...
    {
        BucketCodec.getCodec(1).encode(new AcidOutputFormat.Options(null).bucket(65536).statementId(1).maxStmtId(150));   //   000010010110
    }
    ...
    public void testBucketIdRollOver()
    {
        ...
        {
            int encode = BucketCodec.getCodec(1).encode(new AcidOutputFormat.Options(null).bucket(i).statementId(10).maxStmtId(0b001000000000)); // 2 bit free
