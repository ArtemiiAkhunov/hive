...
public class TestGenericUDFTypeOf
{
    ...
    {
        ObjectInspector oi = ObjectInspectorFactory.getStandardListObjectInspector(PrimitiveObjectInspectorFactory.writableStringObjectInspector);
    ...
    public void testStructType() throws HiveException
    {
        ...
        List<ObjectInspector> structOIs = Arrays.asList(PrimitiveObjectInspectorFactory.writableStringObjectInspector, PrimitiveObjectInspectorFactory.writableLongObjectInspector, ObjectInspectorFactory.getStandardListObjectInspector(PrimitiveObjectInspectorFactory.writableStringObjectInspector));
    ...
    public void testMapType() throws HiveException
    {
        ...
        ObjectInspector valueOI = ObjectInspectorFactory.getStandardListObjectInspector(PrimitiveObjectInspectorFactory.writableStringObjectInspector);
    ...
    {
        GenericUDFTypeOf udf = new GenericUDFTypeOf();
        ObjectInspector[] arguments = {PrimitiveObjectInspectorFactory.writableDateObjectInspector, PrimitiveObjectInspectorFactory.writableDateObjectInspector};
        udf.initialize(arguments);
    }
}
