...
public class TestGuaranteedTaskAllocator
{
    ...
    {
        testAllocation(8, 1.0f, new double[]{0.5f, 0.25f, 0.25f}, new int[]{4, 2, 2});
        testAllocation(10, 1.0f, new double[]{0.33f, 0.4f, 0.27f}, new int[]{3, 4, 3});
        // Test incorrect totals. We don't normalize; just make sure we don't under- or overshoot.
        testAllocation(10, 1.0f, new double[]{0.5f, 0.5f, 0.5f}, new int[]{5, 5, 0});
        testAllocation(100, 0.5f, new double[]{0.15f, 0.15f, 0.15f}, new int[]{15, 15, 20});
    }
