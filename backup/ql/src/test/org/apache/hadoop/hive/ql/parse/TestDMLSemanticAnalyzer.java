...
public class TestDMLSemanticAnalyzer
{
    ...
    private String explain(SemanticAnalyzer sem, QueryPlan plan) throws IOException
    {
        ...
        ExplainWork work = new ExplainWork(tmp, sem.getParseContext(), sem.getRootTasks(), sem.getFetchTask(), null, sem, config, null, plan.getOptimizedQueryString(), plan.getOptimizedCBOPlan());
