...
public class TestETypeConverter
{
    ...
    {
        PrimitiveType primitiveType = Types.optional(PrimitiveTypeName.BINARY).as(LogicalTypeAnnotation.decimalType(2, 7)).named("value");
        Writable writable = getWritableFromPrimitiveConverter(createHiveTypeInfo("int"), primitiveType, 2200);
    ...
    {
        PrimitiveType primitiveType = Types.optional(PrimitiveTypeName.BINARY).as(LogicalTypeAnnotation.decimalType(2, 7)).named("value");
        Writable writable = getWritableFromPrimitiveConverter(createHiveTypeInfo("bigint"), primitiveType, 2200);
    ...
    {
        PrimitiveType primitiveType = Types.optional(PrimitiveTypeName.BINARY).as(LogicalTypeAnnotation.decimalType(2, 7)).named("value");
        Writable writable = getWritableFromPrimitiveConverter(createHiveTypeInfo("float"), primitiveType, 2200);
    ...
    public void testGetTextConverterForString() throws Exception
    {
        ...
        Text textWritable = (Text) getWritableFromBinaryConverter(stringTypeInfo, primitiveType, Binary.fromString(value));
    ...
    public void testGetTextConverterForCharPadsValueWithSpacesTillLen()
    {
        PrimitiveType primitiveType = Types.optional(PrimitiveTypeName.BINARY).as(LogicalTypeAnnotation.stringType()).named("value");
        String value = "this_is_a_value";
        HiveCharWritable textWritable = (HiveCharWritable) getWritableFromBinaryConverter(new CharTypeInfo(value.length() + 2), primitiveType, Binary.fromString(value));
        assertEquals(value + "  ", textWritable.toString());
    }
    ...
    public void testGetTextConverterForCharTruncatesValueExceedingLen()
    {
        PrimitiveType primitiveType = Types.optional(PrimitiveTypeName.BINARY).as(LogicalTypeAnnotation.stringType()).named("value");
        String value = "this_is_a_value";
        HiveCharWritable textWritable = (HiveCharWritable) getWritableFromBinaryConverter(new CharTypeInfo(6), primitiveType, Binary.fromString(value));
    ...
    public void testGetTextConverterForVarcharTruncatesValueExceedingLen()
    {
        PrimitiveType primitiveType = Types.optional(PrimitiveTypeName.BINARY).as(LogicalTypeAnnotation.stringType()).named("value");
        String value = "this_is_a_value";
        HiveVarcharWritable textWritable = (HiveVarcharWritable) getWritableFromBinaryConverter(new VarcharTypeInfo(6), primitiveType, Binary.fromString(value));
        assertEquals(value.substring(0, 6), textWritable.toString());
    }
    ...
    public void testGetTextConverterForVarchar()
    {
        PrimitiveType primitiveType = Types.optional(PrimitiveTypeName.BINARY).as(LogicalTypeAnnotation.stringType()).named("value");
        String value = "this_is_a_value";
        HiveVarcharWritable textWritable = (HiveVarcharWritable) getWritableFromBinaryConverter(new VarcharTypeInfo(34), primitiveType, Binary.fromString(value));
        assertEquals(value, textWritable.toString());
    }
    ...
    {
        PrimitiveType primitiveType = Types.optional(PrimitiveTypeName.INT32).as(LogicalTypeAnnotation.intType(8, false)).named("value");
        Writable writable = getWritableFromPrimitiveConverter(createHiveTypeInfo("tinyint"), primitiveType, 125);
        IntWritable intWritable = (IntWritable) writable;
    ...
    {
        PrimitiveType primitiveType = Types.optional(PrimitiveTypeName.INT32).as(LogicalTypeAnnotation.intType(16, false)).named("value");
        Writable writable = getWritableFromPrimitiveConverter(createHiveTypeInfo("smallint"), primitiveType, 32766);
        IntWritable intWritable = (IntWritable) writable;
    ...
    {
        MyConverterParent converterParent = new MyConverterParent();
        GroupType type = Types.optionalList().element(Types.optional(PrimitiveTypeName.INT64).named("value")).named("array");
    ...
    {
        MyConverterParent converterParent = new MyConverterParent();
        GroupType type = Types.optionalMap().key(Types.optional(PrimitiveTypeName.INT64).named("key")).value(Types.optional(PrimitiveTypeName.INT64).named("value")).named("map");
        HiveGroupConverter f = HiveGroupConverter.getConverterFromDescription(type, 1, converterParent, null);
        assertTrue(f instanceof HiveCollectionConverter);
    }
