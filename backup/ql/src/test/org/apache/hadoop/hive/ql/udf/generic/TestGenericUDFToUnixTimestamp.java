...
public class TestGenericUDFToUnixTimestamp
{
    ...
    public void testStringArg1() throws HiveException
    {
        ...
        runAndVerify(udf1, new Text("2001-01-01 01:02:03"), new LongWritable(TimestampTZUtil.parse("2001-01-01 01:02:03", ZoneId.systemDefault()).getEpochSecond()));
        runAndVerify(udf1, new Text("1400-11-08 01:53:11"), new LongWritable(TimestampTZUtil.parse("1400-11-08 01:53:11", ZoneId.systemDefault()).getEpochSecond()));
        runAndVerify(udf1, new Text("1800-11-08 01:53:11"), new LongWritable(TimestampTZUtil.parse("1800-11-08 01:53:11", ZoneId.systemDefault()).getEpochSecond()));
    ...
    public void testStringArg2() throws HiveException
    {
        ...
        runAndVerify(udf2, new Text("2001.07.04 AD at 12:08:56 PDT"), new Text("yyyy.MM.dd G 'at' HH:mm:ss z"), new LongWritable(TimestampTZUtil.parse("2001-07-04 12:08:56", ZoneId.systemDefault()).getEpochSecond()));
        runAndVerify(udf2, new Text("Wed, Jul 4, '01"), new Text("EEE, MMM d, ''yy"), new LongWritable(TimestampTZUtil.parse("2001-07-04", ZoneId.systemDefault()).getEpochSecond()));
        runAndVerify(udf2, new Text("2009 Mar 20 11:30:01 AM"), new Text("yyyy MMM dd h:mm:ss a"), new LongWritable(TimestampTZUtil.parse("2009-03-20 11:30:01", ZoneId.systemDefault()).getEpochSecond()));
        runAndVerify(udf2, new Text("2009 Mar 20 11:30:01 pm"), new Text("yyyy MMM dd h:mm:ss a"), new LongWritable(TimestampTZUtil.parse("2009-03-20 23:30:01", ZoneId.systemDefault()).getEpochSecond()));
        runAndVerify(udf2, new Text("1800-02-03"), new Text("yyyy-MM-dd"), new LongWritable(TimestampTZUtil.parse("1800-02-03", ZoneId.systemDefault()).getEpochSecond()));
        runAndVerify(udf2, new Text("1400-02-01 00:00:00 ICT"), new Text("yyyy-MM-dd HH:mm:ss z"), new LongWritable(TimestampTZUtil.parse("1400-01-31 09:00:22", ZoneId.systemDefault()).getEpochSecond()));
        runAndVerify(udf2, new Text("1400-02-01 00:00:00 UTC"), new Text("yyyy-MM-dd HH:mm:ss z"), new LongWritable(TimestampTZUtil.parse("1400-01-31 16:07:02", ZoneId.systemDefault()).getEpochSecond()));
        runAndVerify(udf2, new Text("1400-02-01 00:00:00 GMT"), new Text("yyyy-MM-dd HH:mm:ss z"), new LongWritable(TimestampTZUtil.parse("1400-01-31 16:07:02", ZoneId.systemDefault()).getEpochSecond()));
        ...
        runAndVerify(udf2, new Text("1400-20-00 00:00:00 ICT"), new Text("yyyy-MM-dd HH:mm:ss z"), null);
    }
}
