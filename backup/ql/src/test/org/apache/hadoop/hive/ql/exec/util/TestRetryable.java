...
public class TestRetryable
{
    ...
    {
        Retryable retryable = Retryable.builder().withTotalDuration(10).withInitialDelay(1).withBackoff(1.0).withRetryOnException(NullPointerException.class).build();
        try
        {
    ...
    {
        Retryable retryable = Retryable.builder().withTotalDuration(60).withInitialDelay(1).withBackoff(1.0).withRetryOnExceptionList(Arrays.asList(NullPointerException.class, IOException.class)).build();
        try
        {
            retryable.executeCallable(new Callable<Void>()
            {
    ...
    {
        Retryable retryable = Retryable.builder().withTotalDuration(10).withBackoff(10.0).withInitialDelay(1).withRetryOnException(NullPointerException.class).build();
        try
        {
            retryable.executeCallable(new Callable<Void>()
            {
    ...
    {
        Retryable retryable = Retryable.builder().withTotalDuration(20).withBackoff(10.0).withInitialDelay(10).withMaxJitterValue(1).withRetryOnExceptionList(Arrays.asList(NullPointerException.class, IOException.class)).build();
        try
        {
            retryable.executeCallable(new Callable<Void>()
            {
    ...
    {
        Retryable retryable = Retryable.builder().withTotalDuration(20).withBackoff(10.0).withInitialDelay(1).withMaxJitterValue(1).withMaxRetryDelay(1).withRetryOnExceptionList(Arrays.asList(NullPointerException.class, IOException.class)).build();
        try
        {
            retryable.executeCallable(new Callable<Void>()
            {
    ...
    {
        Retryable retryable = Retryable.builder().withTotalDuration(20).withBackoff(100.0).withInitialDelay(1).withMaxJitterValue(1).withRetryOnException(NullPointerException.class).build();
        try
        {
            retryable.executeCallable(new Callable<Void>()
            {
    ...
    {
        Retryable retryable = Retryable.builder().withTotalDuration(30).withBackoff(10.0).withInitialDelay(1).withMaxJitterValue(1).withRetryOnExceptionList(Arrays.asList(NullPointerException.class, IOException.class)).build();
        try
        {
            retryable.executeCallable(new Callable<Void>()
            {
    ...
    {
        Retryable retryable = Retryable.builder().withTotalDuration(30).withBackoff(10.0).withInitialDelay(1).withMaxJitterValue(1).withRetryOnException(IOException.class).withFailOnException(FileNotFoundException.class).build();
        try
        {
            retryable.executeCallable(new Callable<Void>()
            {
    ...
    public void testRetrySuccessSecureCallable() throws Throwable
    {
        ...
        Retryable retryable = Retryable.builder().withTotalDuration(10).withInitialDelay(1).withBackoff(1.0).withRetryOnExceptionList(Arrays.asList(InterruptedException.class, IOException.class)).build();
        try
        {
        ...
        ArgumentCaptor<PrivilegedExceptionAction> privilegedActionArgumentCaptor = ArgumentCaptor.forClass(PrivilegedExceptionAction.class);
        Mockito.verify(userGroupInformation, Mockito.times(1)).doAs(privilegedActionArgumentCaptor.capture());
    }
