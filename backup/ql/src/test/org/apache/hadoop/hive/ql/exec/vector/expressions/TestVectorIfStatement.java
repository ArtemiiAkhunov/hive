...
public class TestVectorIfStatement
{
    ...
    public void testDecimal64() throws Exception
    {
        ...
        doIfTestsWithDiffColumnScalar(random, "decimal(10,4)", ColumnScalarMode.COLUMN_COLUMN, IfVariation.PROJECTION_IF, DataTypePhysicalVariation.DECIMAL_64, false, false);
        doIfTestsWithDiffColumnScalar(random, "decimal(10,4)", ColumnScalarMode.COLUMN_SCALAR, IfVariation.PROJECTION_IF, DataTypePhysicalVariation.DECIMAL_64, false, false);
        doIfTestsWithDiffColumnScalar(random, "decimal(10,4)", ColumnScalarMode.SCALAR_COLUMN, IfVariation.PROJECTION_IF, DataTypePhysicalVariation.DECIMAL_64, false, false);
        doIfTestsWithDiffColumnScalar(random, "decimal(10,4)", ColumnScalarMode.SCALAR_SCALAR, IfVariation.PROJECTION_IF, DataTypePhysicalVariation.DECIMAL_64, false, false);
    }

    public enum IfStmtTestMode
    {
        ROW_MODE, ADAPTOR_WHEN, VECTOR_EXPRESSION;
    ...
    {
        COLUMN_COLUMN, COLUMN_SCALAR, SCALAR_COLUMN, SCALAR_SCALAR;
    ...
    {
        doIfTestsWithDiffColumnScalar(random, typeName, ColumnScalarMode.COLUMN_COLUMN, ifVariation, dataTypePhysicalVariation, false, false);
        doIfTestsWithDiffColumnScalar(random, typeName, ColumnScalarMode.COLUMN_SCALAR, ifVariation, dataTypePhysicalVariation, false, false);
        doIfTestsWithDiffColumnScalar(random, typeName, ColumnScalarMode.COLUMN_SCALAR, ifVariation, dataTypePhysicalVariation, false, true);
        doIfTestsWithDiffColumnScalar(random, typeName, ColumnScalarMode.SCALAR_COLUMN, ifVariation, dataTypePhysicalVariation, false, false);
        doIfTestsWithDiffColumnScalar(random, typeName, ColumnScalarMode.SCALAR_COLUMN, ifVariation, dataTypePhysicalVariation, true, false);
        doIfTestsWithDiffColumnScalar(random, typeName, ColumnScalarMode.SCALAR_SCALAR, ifVariation, dataTypePhysicalVariation, false, false);
    }
    ...
    */
        ...
        rowSource.initExplicitSchema(random, explicitTypeNameList, /* maxComplexDepth */ 0,
    ...
    private void doVectorIfTest(TypeInfo typeInfo, IfVariation ifVariation, List<String> columns, String[] columnNames, TypeInfo[] typeInfos, DataTypePhysicalVariation[] dataTypePhysicalVariations, List<ExprNodeDesc> children, IfStmtTestMode ifStmtTestMode, ColumnScalarMode columnScalarMode, VectorRandomBatchSource batchSource, Object[] resultObjects) throws Exception
    {
        ...
        VectorizedRowBatchCtx batchContext = new VectorizedRowBatchCtx(columnNames, typeInfos, dataTypePhysicalVariations,
                /* dataColumnNums */ null,
                /* partitionColumnCount */ 0,
                /* virtualColumnCount */ 0,
                /* neededVirtualColumns */ null, outputScratchTypeNames, outputDataTypePhysicalVariations);
