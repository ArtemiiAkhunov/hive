...
public class TestHostAffinitySplitLocationProvider
{
    ...
    public void testConsistentHashing() throws IOException
    {
        ...
        if (moveRatioAvg > 1.2f || newRatioAvg < 0.8f || movedRatioWorst > 1.67f || newRatioWorst < 0.5f)
        {
    ...
    static FileSplit createMockFileSplit(boolean createOrcSplit, String fakePathString, long start, long length, String[] locations) throws IOException
    {
        FileSplit fileSplit;
        if (createOrcSplit)
        {
