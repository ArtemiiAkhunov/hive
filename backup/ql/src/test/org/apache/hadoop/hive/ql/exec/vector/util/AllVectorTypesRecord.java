...
public class AllVectorTypesRecord
{
     ...
     * @param cboolean2
     */
    public AllVectorTypesRecord(Byte ctinyInt, Short csmallInt, Integer cint, Long cbigInt, Float cfloat, Double cdouble, String cstring1, String cstring2, Timestamp ctimestamp1, Timestamp ctimestamp2, Boolean cboolean1, Boolean cboolean2)
    {
    ...
    public static final String TABLE_CREATE_COMMAND = "CREATE TABLE " + TABLE_NAME + "(" + "ctinyint tinyint, " + "csmallint smallint, " + "cint int, " + "cbigint bigint, " + "cfloat float, " + "cdouble double, " + "cstring1 string, " + "cstring2 string, " + "ctimestamp1 timestamp, " + "ctimestamp2 timestamp, " + "cboolean1 boolean, " + "cboolean2 boolean) " + "STORED AS ORC";
}
