...
public class CloseableThreadLocalTest
{
    ...
    {
        CloseableThreadLocal<AutoCloseableStub> closeableThreadLocal = new CloseableThreadLocal<>(AutoCloseableStub::new, 1);
    ...
    {
        CloseableThreadLocal<AutoCloseableStub> closeableThreadLocal = new CloseableThreadLocal<>(AutoCloseableStub::new, 2);
