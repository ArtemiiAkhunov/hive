...
*/
    ...
    public void testExportBucketed() throws Exception
    {
        ...
        runStatementOnDriver("export table " + Table.ACIDTBL + "  to '" + getTestDataDir() + "/export'");
        runStatementOnDriver("drop table if exists TImport ");
    ...
    {
        runStatementOnDriver("drop table if exists T");
        runStatementOnDriver("create table T like " + Table.ACIDTBL + " TBLPROPERTIES " + "('transactional'='true')");
    ...
    private void testImport(boolean isVectorized, boolean existingTarget) throws Exception
    {
        ...
        String[][] expected2 = new String[][]{{"{\"writeid\":1,\"bucketid\":536870912,\"rowid\":0}\t1\t2", "t/delta_0000001_0000001_0000/000000_0"}, {"{\"writeid\":1,\"bucketid\":536870912,\"rowid\":1}\t3\t4", "t/delta_0000001_0000001_0000/000000_0"}, {"{\"writeid\":2,\"bucketid\":536870913,\"rowid\":0}\t0\t6", "t/delta_0000002_0000002_0001/bucket_00000_0"}};
        checkResult(expected2, testQuery, isVectorized, "update imported table");

        runStatementOnDriver("alter table T compact 'minor'");
        TestTxnCommands2.runWorker(hiveConf);
        String[][] expected3 = new String[][]{{"{\"writeid\":1,\"bucketid\":536870912,\"rowid\":0}\t1\t2", ".*t/delta_0000001_0000002_v000002[6-7]/bucket_00000"}, {"{\"writeid\":1,\"bucketid\":536870912,\"rowid\":1}\t3\t4", ".*t/delta_0000001_0000002_v000002[6-7]/bucket_00000"}, {"{\"writeid\":2,\"bucketid\":536870913,\"rowid\":0}\t0\t6", ".*t/delta_0000001_0000002_v000002[6-7]/bucket_00000"}};
    ...
    public void testImportPartitionedOrc() throws Exception
    {
        ...
        {
            List<String> rsPartitionProperties = runStatementOnDriver("describe formatted Tstage partition(" + rsTstagePartition + ")");
            Assert.assertEquals("COLUMN_STATS_ACCURATE of partition " + rsTstagePartition + " of Tstage table", true, rsPartitionProperties.contains("\tCOLUMN_STATS_ACCURATE\t{\\\"BASIC_STATS\\\":\\\"true\\\"}"));
            Assert.assertEquals(" of partition " + rsTstagePartition + " of Tstage table", true, rsPartitionProperties.contains("\tnumRows             \t1                   "));
        }
        ...
        Assert.assertEquals("COLUMN_STATS_ACCURATE of T table", false, rsTProperties.contains("COLUMN_STATS_ACCURATE\t{\"BASIC_STATS\":\"true\"}"));
        ...
        for (String rsTPartition : rsTPartitionsProperties)
        {
            ...
            Assert.assertEquals("COLUMN_STATS_ACCURATE of partition " + rsTPartition + " of T table", false, rsPartitionProperties.contains("\tCOLUMN_STATS_ACCURATE\t{\\\"BASIC_STATS\\\":\\\"true\\\"}"));
            Assert.assertEquals(" of partition " + rsTPartition + " of T table", false, rsPartitionProperties.contains("\tnumRows             \t1                   "));
        }
    ...
    public void testImportPartitionedCreate() throws Exception
    {
        ...
        Assert.assertEquals("reading imported data", TestTxnCommands2.stringifyValues(data), rs);
    ...
    private void testMM(boolean existingTable, boolean isSourceMM) throws Exception
    {
        ...
        runStatementOnDriver("create table Tstage (a int, b int)" + (isSourceMM ? "" : " tblproperties('transactional'='false')"));
        runStatementOnDriver("insert into Tstage" + TestTxnCommands2.makeValuesClause(data));
        runStatementOnDriver("export table Tstage to '" + getWarehouseDir() + "/1'");
    ...
    public void testImportOrc() throws Exception
    {
        ...
        Assert.assertEquals("COLUMN_STATS_ACCURATE of Tstage table", true, rsTStageProperties.contains("COLUMN_STATS_ACCURATE\t{\"BASIC_STATS\":\"true\"}"));
