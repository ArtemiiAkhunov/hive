...
public class TestHiveFunctionHelper
{
    ...
    public void testGetUDTFFunction() throws SemanticException
    {
        ...
        List<RexNode> operands = Lists.newArrayList(rexBuilder.makeLiteral("hello"), rexBuilder.makeLiteral("world"));
        List<RexNode> arrayNode = Lists.newArrayList(rexBuilder.makeCall(SqlStdOperatorTable.ARRAY_VALUE_CONSTRUCTOR, operands));
