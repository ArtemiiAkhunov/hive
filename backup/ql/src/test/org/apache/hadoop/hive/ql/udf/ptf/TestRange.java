...
public class TestRange
{
    ...
    public void testRangeEqualsOnlyIfSamePartition() throws HiveException
    {
        ...
        PTFPartition partition1 = PTFPartition.createRolling(new Configuration(), null, null, null, 0, 0);
        PTFPartition partition2 = PTFPartition.createRolling(new Configuration(), null, null, null, 0, 0);
