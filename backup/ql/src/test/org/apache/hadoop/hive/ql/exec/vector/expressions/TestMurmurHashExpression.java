...
public class TestMurmurHashExpression
{
    ...
    {
        BytesColumnVector cvString1 = (BytesColumnVector) ColumnVectorGenUtil.generateColumnVector(TypeInfoFactory.getPrimitiveTypeInfo("string"), false, false, SIZE, rand);
        BytesColumnVector cvString2 = (BytesColumnVector) ColumnVectorGenUtil.generateColumnVector(TypeInfoFactory.getPrimitiveTypeInfo("string"), false, false, SIZE, rand);
        ...
        for (int i = 0; i < SIZE; i++)
        {
            ...
            Assert.assertEquals(ObjectInspectorUtils.getBucketHashCode(new Object[]{t1, t2}, new ObjectInspector[]{PrimitiveObjectInspectorFactory.writableStringObjectInspector, PrimitiveObjectInspectorFactory.writableStringObjectInspector}), ((LongColumnVector) vrb.cols[2]).vector[i]);
        }
    }
    ...
    {
        BytesColumnVector cvString1 = (BytesColumnVector) ColumnVectorGenUtil.generateColumnVector(TypeInfoFactory.getPrimitiveTypeInfo("string"), true, false, SIZE, rand);
        BytesColumnVector cvString2 = (BytesColumnVector) ColumnVectorGenUtil.generateColumnVector(TypeInfoFactory.getPrimitiveTypeInfo("string"), true, false, SIZE, rand);
    ...
    {
        LongColumnVector cvInt1 = (LongColumnVector) ColumnVectorGenUtil.generateColumnVector(TypeInfoFactory.getPrimitiveTypeInfo("int"), true, false, SIZE, rand);
        LongColumnVector cvInt2 = (LongColumnVector) ColumnVectorGenUtil.generateColumnVector(TypeInfoFactory.getPrimitiveTypeInfo("int"), true, false, SIZE, rand);
        ...
        for (int i = 0; i < SIZE; i++)
        {
            Assert.assertEquals(ObjectInspectorUtils.getBucketHashCode(new Object[]{cvInt1.isNull[i] ? null : new LongWritable(cvInt1.vector[i]), cvInt2.isNull[i] ? null : new LongWritable(cvInt2.vector[i])}, new ObjectInspector[]{PrimitiveObjectInspectorFactory.writableLongObjectInspector, PrimitiveObjectInspectorFactory.writableLongObjectInspector}), ((LongColumnVector) vrb.cols[2]).vector[i]);
        }
    }
}
