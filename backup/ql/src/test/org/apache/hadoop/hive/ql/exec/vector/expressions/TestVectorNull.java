...
public class TestVectorNull
{
    ...
    private boolean doIsNullOnRandomDataType(Random random, String functionName, boolean isFilter) throws Exception
    {
        ...
        {
            typeName = VectorRandomRowSource.getRandomTypeName(random, SupportedTypes.ALL, /* allowedTypeNameSet */ null);
            typeName = VectorRandomRowSource.getDecoratedTypeName(random, typeName, SupportedTypes.ALL, /* allowedTypeNameSet */ null,
                    /* depth */ 0, /* maxDepth */ 2);
        }
