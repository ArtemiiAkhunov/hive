...
public class TestMSCKRepairOnAcid extends TxnCommandsBaseForTests
{
    ...
    public void testAddPartitionDeltas() throws Exception
    {
        ...
        FileUtil.copy(fs, new Path(getWarehouseDir() + "/" + Table.ACIDTBLPART.toString().toLowerCase() + "/p=p1"), fs, new Path(getWarehouseDir(), acidTblPartMsck), false, hiveConf);
    ...
    public void testAddMultiPartitionDeltas() throws Exception
    {
        ...
        FileSystem fs = FileSystem.get(hiveConf);
        FileUtil.copy(fs, new Path(getWarehouseDir() + "/" + Table.ACIDTBLPART.toString().toLowerCase() + "/p=p1"), fs, new Path(getWarehouseDir(), acidTblPartMsck), false, hiveConf);
        FileUtil.copy(fs, new Path(getWarehouseDir() + "/" + Table.ACIDTBLPART.toString().toLowerCase() + "/p=p2"), fs, new Path(getWarehouseDir(), acidTblPartMsck), false, hiveConf);
    ...
    public void testAddPartitionLowerWriteId() throws Exception
    {
        ...
        // copy files on fs
        FileSystem fs = FileSystem.get(hiveConf);
        FileUtil.copy(fs, new Path(getWarehouseDir() + "/" + Table.ACIDTBLPART.toString().toLowerCase() + "/p=p1"), fs, new Path(getWarehouseDir(), acidTblPartMsck), false, false, hiveConf);
    ...
    public void testBackUpAndRestorePartition() throws Exception
    {
        ...
        FileUtil.copy(fs, new Path(getWarehouseDir() + "/" + Table.ACIDTBLPART.toString().toLowerCase() + "/p=p1"), fs, new Path(getWarehouseDir(), "mybackup"), true, hiveConf);
        ...
        // copy the data back
        FileUtil.copy(fs, new Path(getWarehouseDir() + "/" + "mybackup" + "/p=p1"), fs, new Path(getWarehouseDir(), Table.ACIDTBLPART.toString().toLowerCase()), true, hiveConf);
    ...
    public void testAddPartitionMMInsertOverwrite() throws Exception
    {
        ...
        runStatementOnDriver("create table " + mmTable + "(a int, b int) partitioned by (p string) stored as orc" + " TBLPROPERTIES ('transactional'='true', 'transactional_properties'='insert_only')");
        runStatementOnDriver("create table " + sourceTable + "(a int, b int) partitioned by (p string) stored as orc" + " TBLPROPERTIES ('transactional'='false')");
        ...
        runStatementOnDriver("insert overwrite table " + mmTable + " PARTITION(p='p1') " + " select a,b from " + sourceTable + " where " + sourceTable + ".p='p1'");
        ...
        // copy files on fs
        FileSystem fs = FileSystem.get(hiveConf);
        FileUtil.copy(fs, new Path(getWarehouseDir() + "/" + mmTable + "/p=p1"), fs, new Path(getWarehouseDir(), acidTblPartMsck), false, hiveConf);
        FileUtil.copy(fs, new Path(getWarehouseDir() + "/" + mmTable + "/p=p2"), fs, new Path(getWarehouseDir(), acidTblPartMsck), false, hiveConf);
    ...
    public void testNonPartitionedTable() throws Exception
    {
        ...
        {
            FileUtil.copy(fs, status.getPath(), fs, new Path(getWarehouseDir(), acidTblMsck), false, hiveConf);
        }
