...
public class TestSessionHiveMetastoreClientAlterPartitionsTempTable extends TestAlterPartitions
{
    ...
    {
        createTable4PartColsParts(getClient());
        assertPartitionRollback(getClient().listPartitions(DB_NAME, TABLE_NAME, (short) -1), Lists.newArrayList(null, null));
    }
    ...
    public void testAlterPartitionsCheckRollbackChangeDBName() throws Exception
    {
        ...
        assertPartitionRollback(oldPartitions, Lists.newArrayList(oldPartitions.get(0), oldPartitions.get(1), newPart1, oldPartitions.get(2)));
    }
