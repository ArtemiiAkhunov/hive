...
public class Task implements org.apache.thrift.TBase<Task, Task._Fields>, java.io.Serializable, Cloneable, Comparable<Task>
{
    ...
    private @org.apache.thrift.annotation.Nullable TaskType taskType; // required
    private @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String, java.lang.String> taskAttributes; // required
    private @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String, java.lang.Long> taskCounters; // required
    private @org.apache.thrift.annotation.Nullable Graph operatorGraph; // optional
    private @org.apache.thrift.annotation.Nullable java.util.List<Operator> operatorList; // optional
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum
    {
         ...
         * @see TaskType
         */
        TASK_TYPE((short) 2, "taskType"), TASK_ATTRIBUTES((short) 3, "taskAttributes"), TASK_COUNTERS((short) 4, "taskCounters"), OPERATOR_GRAPH((short) 5, "operatorGraph"), OPERATOR_LIST((short) 6, "operatorList"), DONE((short) 7, "done"), STARTED((short) 8, "started");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.TASK_ID, new org.apache.thrift.meta_data.FieldMetaData("taskId", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
        tmpMap.put(_Fields.TASK_TYPE, new org.apache.thrift.meta_data.FieldMetaData("taskType", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, TaskType.class)));
        tmpMap.put(_Fields.TASK_ATTRIBUTES, new org.apache.thrift.meta_data.FieldMetaData("taskAttributes", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING), new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
        ...
        tmpMap.put(_Fields.OPERATOR_GRAPH, new org.apache.thrift.meta_data.FieldMetaData("operatorGraph", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Graph.class)));
    ...
    public Task(java.lang.String taskId, TaskType taskType, java.util.Map<java.lang.String, java.lang.String> taskAttributes, java.util.Map<java.lang.String, java.lang.Long> taskCounters, boolean done, boolean started)
    {
        this();
        this.taskId = taskId;
    ...
    public Task(Task other)
    {
        ...
        {
            java.util.Map<java.lang.String, java.lang.String> __this__taskAttributes = new java.util.HashMap<java.lang.String, java.lang.String>(other.taskAttributes);
            this.taskAttributes = __this__taskAttributes;
        }
        if (other.isSetTaskCounters())
        {
            java.util.Map<java.lang.String, java.lang.Long> __this__taskCounters = new java.util.HashMap<java.lang.String, java.lang.Long>(other.taskCounters);
        ...
        {
            java.util.List<Operator> __this__operatorList = new java.util.ArrayList<Operator>(other.operatorList.size());
     ...
     * @see TaskType
     */
    public void setTaskType(@org.apache.thrift.annotation.Nullable TaskType taskType)
    {
        this.taskType = taskType;
    }
    ...
    public void putToTaskAttributes(java.lang.String key, java.lang.String val)
    {
        if (this.taskAttributes == null)
        {
            this.taskAttributes = new java.util.HashMap<java.lang.String, java.lang.String>();
        }
        this.taskAttributes.put(key, val);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.Map<java.lang.String, java.lang.String> getTaskAttributes()
    {
        return this.taskAttributes;
    }

    public void setTaskAttributes(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String, java.lang.String> taskAttributes)
    {
        this.taskAttributes = taskAttributes;
    }
    ...
    public void putToTaskCounters(java.lang.String key, long val)
    {
        if (this.taskCounters == null)
        {
            this.taskCounters = new java.util.HashMap<java.lang.String, java.lang.Long>();
        }
        this.taskCounters.put(key, val);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.Map<java.lang.String, java.lang.Long> getTaskCounters()
    {
        return this.taskCounters;
    }

    public void setTaskCounters(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String, java.lang.Long> taskCounters)
    {
        this.taskCounters = taskCounters;
    }
    ...
    public void setOperatorGraph(@org.apache.thrift.annotation.Nullable Graph operatorGraph)
    {
    ...
    public void addToOperatorList(Operator elem)
    {
        ...
        {
            this.operatorList = new java.util.ArrayList<Operator>();
        }
        this.operatorList.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<Operator> getOperatorList()
    {
        return this.operatorList;
    }

    public void setOperatorList(@org.apache.thrift.annotation.Nullable java.util.List<Operator> operatorList)
    {
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value)
    {
        switch (field)
        {
            ...
            case TASK_ATTRIBUTES:
                ...
                {
                    setTaskAttributes((java.util.Map<java.lang.String, java.lang.String>) value);
                }
                break;
            ...
            case TASK_COUNTERS:
                ...
                {
                    setTaskCounters((java.util.Map<java.lang.String, java.lang.Long>) value);
                }
                break;
            ...
            case OPERATOR_LIST:
                ...
                {
                    setOperatorList((java.util.List<Operator>) value);
                }
                break;
    ...
    public int hashCode()
    {
        ...
        hashCode = hashCode * 8191 + ((isSetTaskAttributes()) ? 131071 : 524287);
        if (isSetTaskAttributes())
        {
            hashCode = hashCode * 8191 + taskAttributes.hashCode();
        }

        hashCode = hashCode * 8191 + ((isSetTaskCounters()) ? 131071 : 524287);
        if (isSetTaskCounters())
        {
            hashCode = hashCode * 8191 + taskCounters.hashCode();
        }

        hashCode = hashCode * 8191 + ((isSetOperatorGraph()) ? 131071 : 524287);
        if (isSetOperatorGraph())
        {
            hashCode = hashCode * 8191 + operatorGraph.hashCode();
        }

        hashCode = hashCode * 8191 + ((isSetOperatorList()) ? 131071 : 524287);
        if (isSetOperatorList())
        {
            hashCode = hashCode * 8191 + operatorList.hashCode();
        }
    ...
    public int compareTo(Task other)
    {
        ...
        lastComparison = java.lang.Boolean.compare(isSetTaskAttributes(), other.isSetTaskAttributes());
        if (lastComparison != 0)
        {
            return lastComparison;
        }
        ...
        lastComparison = java.lang.Boolean.compare(isSetTaskCounters(), other.isSetTaskCounters());
        if (lastComparison != 0)
        {
            return lastComparison;
        }
        ...
        lastComparison = java.lang.Boolean.compare(isSetOperatorGraph(), other.isSetOperatorGraph());
        if (lastComparison != 0)
        {
            return lastComparison;
        }
        ...
        lastComparison = java.lang.Boolean.compare(isSetOperatorList(), other.isSetOperatorList());
        if (lastComparison != 0)
        {
            return lastComparison;
        }
                        ...
                        {
                            {
                                ...
                                struct.taskAttributes = new java.util.HashMap<java.lang.String, java.lang.String>(2 * _map44.size);
                        ...
                        {
                            {
                                ...
                                struct.taskCounters = new java.util.HashMap<java.lang.String, java.lang.Long>(2 * _map48.size);
                        ...
                        {
                            {
                                ...
                                struct.operatorList = new java.util.ArrayList<Operator>(_list52.size);
                                @org.apache.thrift.annotation.Nullable Operator _elem53;
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, Task struct) throws org.apache.thrift.TException
        {
            ...
            if (struct.taskAttributes != null)
            {
                oprot.writeFieldBegin(TASK_ATTRIBUTES_FIELD_DESC);
                {
                    ...
                    for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter55 : struct.taskAttributes.entrySet())
                    {
            ...
            if (struct.taskCounters != null)
            {
                oprot.writeFieldBegin(TASK_COUNTERS_FIELD_DESC);
                {
                    ...
                    for (java.util.Map.Entry<java.lang.String, java.lang.Long> _iter56 : struct.taskCounters.entrySet())
                    {
    ...
    private static class TaskTupleScheme extends org.apache.thrift.scheme.TupleScheme<Task>
    {
            ...
            {
                {
                    ...
                    for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter58 : struct.taskAttributes.entrySet())
                    {
            ...
            {
                {
                    ...
                    for (java.util.Map.Entry<java.lang.String, java.lang.Long> _iter59 : struct.taskCounters.entrySet())
                    {
        ...
        public void read(org.apache.thrift.protocol.TProtocol prot, Task struct) throws org.apache.thrift.TException
        {
            ...
            {
                {
                    org.apache.thrift.protocol.TMap _map61 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING);
                    struct.taskAttributes = new java.util.HashMap<java.lang.String, java.lang.String>(2 * _map61.size);
            ...
            {
                {
                    org.apache.thrift.protocol.TMap _map65 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64);
                    struct.taskCounters = new java.util.HashMap<java.lang.String, java.lang.Long>(2 * _map65.size);
            ...
            {
                {
                    ...
                    struct.operatorList = new java.util.ArrayList<Operator>(_list69.size);
                    @org.apache.thrift.annotation.Nullable Operator _elem70;
