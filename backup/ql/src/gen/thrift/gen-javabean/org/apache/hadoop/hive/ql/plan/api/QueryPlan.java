...
public class QueryPlan implements org.apache.thrift.TBase<QueryPlan, QueryPlan._Fields>, java.io.Serializable, Cloneable, Comparable<QueryPlan>
{
    ...
    {
        QUERIES((short) 1, "queries"), DONE((short) 2, "done"), STARTED((short) 3, "started");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.QUERIES, new org.apache.thrift.meta_data.FieldMetaData("queries", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Query.class))));
    ...
    public QueryPlan(java.util.List<Query> queries, boolean done, boolean started)
    {
        this();
