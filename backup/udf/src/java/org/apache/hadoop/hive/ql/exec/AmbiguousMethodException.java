...
public class AmbiguousMethodException extends UDFArgumentException
{
     ...
     */
    public AmbiguousMethodException(Class<?> funcClass, List<TypeInfo> argTypeInfos, List<Method> methods)
    {
        super("Ambiguous method for " + funcClass + " with " + argTypeInfos.toString().replace('[', '(').replace(']', ')'), funcClass, argTypeInfos, methods);
    }
}
