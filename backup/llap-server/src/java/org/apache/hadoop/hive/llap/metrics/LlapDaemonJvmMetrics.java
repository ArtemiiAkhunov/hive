...
public class LlapDaemonJvmMetrics implements MetricsSource
{
    ...
    private LlapDaemonJvmMetrics(String displayName, String sessionId, final Configuration conf)
    {
        ...
        Class<? extends ResourceCalculatorProcessTree> clazz = conf.getClass(YarnConfiguration.NM_CONTAINER_MON_PROCESS_TREE, null, ResourceCalculatorProcessTree.class);
    ...
    public static LlapDaemonJvmMetrics create(String displayName, String sessionId, final Configuration conf)
    {
        MetricsSystem ms = LlapMetricsSystem.instance();
        return ms.register(displayName, "LlapDaemon JVM Metrics", new LlapDaemonJvmMetrics(displayName, sessionId, conf));
    }
