...
public class LlapLoadGeneratorService extends AbstractService
{
    ...
    protected void serviceInit(Configuration conf) throws Exception
    {
        ...
        {
            throw new IllegalArgumentException(HiveConf.ConfVars.HIVE_TEST_LOAD_UTILIZATION.varname + " should " + "be between 0.0 and 1.0. The configuration specified [" + threshold + "]");
        }
