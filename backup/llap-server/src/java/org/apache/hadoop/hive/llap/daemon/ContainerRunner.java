...
public interface ContainerRunner
{
    ...
    LlapDaemonProtocolProtos.RegisterDagResponseProto registerDag(LlapDaemonProtocolProtos.RegisterDagRequestProto request) throws IOException;

    SubmitWorkResponseProto submitWork(SubmitWorkRequestProto request) throws IOException;

    SourceStateUpdatedResponseProto sourceStateUpdated(SourceStateUpdatedRequestProto request) throws IOException;

    QueryCompleteResponseProto queryComplete(QueryCompleteRequestProto request) throws IOException;

    TerminateFragmentResponseProto terminateFragment(TerminateFragmentRequestProto request) throws IOException;

    UpdateFragmentResponseProto updateFragment(UpdateFragmentRequestProto request) throws IOException;

    SetCapacityResponseProto setCapacity(SetCapacityRequestProto request) throws IOException;
}
