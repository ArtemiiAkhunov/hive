...
public class TestTaskExecutorService
{
    ...
    private void testPreemptionHelper(MockRequest r1, MockRequest r2, boolean isPreemted) throws InterruptedException
    {
        TaskExecutorServiceForTest taskExecutorService = new TaskExecutorServiceForTest(1, 2, ShortestJobFirstComparator.class.getName(), true, mockMetrics);
    ...
    public void testPreemptionQueueOnFinishableStateUpdates() throws InterruptedException
    {
        ...
        TaskExecutorServiceForTest taskExecutorService = new TaskExecutorServiceForTest(4, 2, ShortestJobFirstComparator.class.getName(), true, mockMetrics);
        taskExecutorService.init(new Configuration());
        taskExecutorService.start();
    ...
    private void testWaitQueuePreemptionHelper(MockRequest r1, MockRequest r2, MockRequest r3, MockRequest r4, MockRequest r5) throws InterruptedException
    {
        TaskExecutorServiceForTest taskExecutorService = new TaskExecutorServiceForTest(1, 2, ShortestJobFirstComparator.class.getName(), true, mockMetrics);
        taskExecutorService.init(new Configuration());
        taskExecutorService.start();
    ...
    {
        TaskExecutorServiceForTest taskExecutorService = new TaskExecutorServiceForTest(2, 3, ShortestJobFirstComparator.class.getName(), true, mockMetrics);
    ...
    {
        TaskExecutorServiceForTest taskExecutorService = new TaskExecutorServiceForTest(1, 1, ShortestJobFirstComparator.class.getName(), true, mockMetrics);
    ...
    {
        TaskExecutorServiceForTest taskExecutorService = new TaskExecutorServiceForTest(2, 10, ShortestJobFirstComparator.class.getName(), true, mockMetrics);
