...
public class TestVectorDeserializeOrcWriter
{
    ...
    public void testConcurrencyIssueWhileWriting() throws Exception
    {
        ...
        FixedSizedObjectPool<ColumnVectorBatch> cvbPool = (FixedSizedObjectPool<ColumnVectorBatch>) cvbPoolField.get(consumer);
    ...
    {
        VectorDeserializeOrcWriter orcWriter = mock(VectorDeserializeOrcWriter.class, withSettings().defaultAnswer(CALLS_REAL_METHODS));
