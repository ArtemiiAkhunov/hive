...
public class TestLlapOrcCacheLoader
{
    ...
    {
        try (LlapOrcCacheLoader loader = new LlapOrcCacheLoader(new Path(TEST_PATH), null, conf, null, null, null, null))
        {
            loader.init();
        }
    }
    ...
    public void testLoadFooter() throws IOException
    {
        ...
        try (LlapOrcCacheLoader loader = new LlapOrcCacheLoader(path, key, conf, null, metaCache, null, null))
        {
            loader.init();
    ...
    public void testLoadUncompressedRanges() throws IOException
    {
        ...
        Object key = fileId(path);
        try (LlapOrcCacheLoader loader = new LlapOrcCacheLoader(path, key, conf, mockDataCache, metaCache, null, tracePool))
        {
            loader.init();
            ...
            cache.getFileData(key, range, 0, mockDiskRangeListFactory, null, gotAllData);
