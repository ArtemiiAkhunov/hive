...
public class TestBasicLlapCacheHydration
{
    ...
    public void testSaveAndLoad() throws IOException
    {
        ...
        ArgumentCaptor<LlapDaemonProtocolProtos.CacheEntryList> captor = forClass(LlapDaemonProtocolProtos.CacheEntryList.class);
    ...
    private LlapDaemonProtocolProtos.CacheEntryList createTestData() throws IOException
    {
        ...
        LlapDaemonProtocolProtos.CacheEntry ce = LlapDaemonProtocolProtos.CacheEntry.newBuilder().setCacheTag(ct).setFilePath("dummyPath").setFileKey(ByteString.copyFromUtf8("dummyKey")).addRanges(re2).addRanges(re1).build();
