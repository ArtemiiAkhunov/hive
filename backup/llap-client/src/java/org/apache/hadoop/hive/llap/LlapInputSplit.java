...
public class LlapInputSplit implements InputSplitWithLocationInfo
{
    ...
    public LlapInputSplit(int splitNum, byte[] planBytes, byte[] fragmentBytes, byte[] fragmentBytesSignature, SplitLocationInfo[] locations, LlapDaemonInfo[] llapDaemonInfos, Schema schema, String llapUser, byte[] tokenBytes, String jwt)
    {
