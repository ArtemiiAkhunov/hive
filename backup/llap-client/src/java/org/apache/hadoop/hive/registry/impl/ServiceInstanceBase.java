...
public class ServiceInstanceBase implements ServiceInstance
{
    ...
    public ServiceInstanceBase(ServiceRecord srv, String rpcName) throws IOException
    {
        ...
        this.rpcPort = Integer.parseInt(RegistryTypeUtils.getAddressField(rpc.addresses.get(0), AddressTypes.ADDRESS_PORT_FIELD));
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(getWorkerIdentity(), other.getWorkerIdentity()) && Objects.equals(host, other.host) && Objects.equals(rpcPort, other.rpcPort);
    }
