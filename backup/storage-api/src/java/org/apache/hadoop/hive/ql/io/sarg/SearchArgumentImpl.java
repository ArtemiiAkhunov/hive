...
public final class SearchArgumentImpl implements SearchArgument
{
    ...
    public static final class PredicateLeafImpl implements PredicateLeaf
    {
        ...
        public PredicateLeafImpl(Operator operator, Type type, String columnName, Object literal, List<Object> literalList)
        {
            this(operator, type, columnName, literal, literalList, null);
        }

        public PredicateLeafImpl(Operator operator, Type type, String columnName, Object literal, List<Object> literalList, Configuration conf)
        {
        ...
        public int hashCode()
        {
            return operator.hashCode() + type.hashCode() * 17 + columnName.hashCode() * 3 * 17 + (literal == null ? 0 : literal.hashCode()) * 101 * 3 * 17 + (literalList == null ? 0 : literalList.hashCode()) * 103 * 101 * 3 * 17;
        }
    ...
    {
        return normalizedExpression == null ? TruthValue.YES : normalizedExpression.evaluate(leaves);
    }
    ...
    static class BuilderImpl implements Builder
    {
        ...
        private final ExpressionTree root = new ExpressionTree(ExpressionTree.Operator.AND);
        ...
        @Override
        public Builder lessThan(String column, PredicateLeaf.Type type, Object literal)
        {
            ...
            {
                PredicateLeafImpl leaf = new PredicateLeafImpl(PredicateLeaf.Operator.LESS_THAN, type, column, literal, null, conf);
        ...
        @Override
        public Builder lessThanEquals(String column, PredicateLeaf.Type type, Object literal)
        {
            ExpressionTree parent = currentTree.getFirst();
            if (column == null || literal == null)
            {
            ...
            {
                PredicateLeafImpl leaf = new PredicateLeafImpl(PredicateLeaf.Operator.LESS_THAN_EQUALS, type, column, literal, null, conf);
                parent.getChildren().add(new ExpressionTree(addLeaf(leaf)));
            }
            return this;
        }
        ...
        @Override
        public Builder equals(String column, PredicateLeaf.Type type, Object literal)
        {
            ExpressionTree parent = currentTree.getFirst();
            if (column == null || literal == null)
            {
            ...
            {
                PredicateLeafImpl leaf = new PredicateLeafImpl(PredicateLeaf.Operator.EQUALS, type, column, literal, null, conf);
                parent.getChildren().add(new ExpressionTree(addLeaf(leaf)));
            }
            return this;
        }
        ...
        @Override
        public Builder nullSafeEquals(String column, PredicateLeaf.Type type, Object literal)
        {
            ExpressionTree parent = currentTree.getFirst();
            if (column == null || literal == null)
            {
            ...
            {
                PredicateLeafImpl leaf = new PredicateLeafImpl(PredicateLeaf.Operator.NULL_SAFE_EQUALS, type, column, literal, null, conf);
                parent.getChildren().add(new ExpressionTree(addLeaf(leaf)));
            }
            return this;
        }
        ...
        @Override
        public Builder in(String column, PredicateLeaf.Type type, Object... literal)
        {
            ExpressionTree parent = currentTree.getFirst();
            if (column == null || literal == null)
            {
            ...
            } else
            {
                ...
                PredicateLeafImpl leaf = new PredicateLeafImpl(PredicateLeaf.Operator.IN, type, column, null, argList, conf);
                parent.getChildren().add(new ExpressionTree(addLeaf(leaf)));
            }
            return this;
        }
        ...
        public Builder isNull(String column, PredicateLeaf.Type type)
        {
            ...
            {
                PredicateLeafImpl leaf = new PredicateLeafImpl(PredicateLeaf.Operator.IS_NULL, type, column, null, null, conf);
                parent.getChildren().add(new ExpressionTree(addLeaf(leaf)));
            }
            return this;
        }
        ...
        @Override
        public Builder between(String column, PredicateLeaf.Type type, Object lower, Object upper)
        {
            ExpressionTree parent = currentTree.getFirst();
            ...
            } else
            {
                ...
                argList.add(lower);
                argList.add(upper);
                PredicateLeafImpl leaf = new PredicateLeafImpl(PredicateLeaf.Operator.BETWEEN, type, column, null, argList, conf);
                parent.getChildren().add(new ExpressionTree(addLeaf(leaf)));
            }
            return this;
        }
