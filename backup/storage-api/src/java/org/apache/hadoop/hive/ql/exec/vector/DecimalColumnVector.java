...
public class DecimalColumnVector extends ColumnVector implements IDecimalColumnVector
{
    ...
    public void setElement(int outputElementNum, int inputElementNum, ColumnVector inputColVector)
    {
        ...
        {
            vector[outputElementNum].set(((DecimalColumnVector) inputColVector).vector[inputElementNum], precision, scale);
    ...
    public void ensureSize(int size, boolean preserveData)
    {
        ...
        {
            return; // We assume the existing vector is always valid.
        }
