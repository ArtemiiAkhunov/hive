...
public final class HiveDecimal extends FastHiveDecimal implements Comparable<HiveDecimal>
{
    ...
    @HiveDecimalVersionV2
    public static final int SCRATCH_BUFFER_LEN_SERIALIZATION_UTILS_READ = FAST_SCRATCH_BUFFER_LEN_SERIALIZATION_UTILS_READ;
    ...
    @HiveDecimalVersionV2
    public static final int SCRATCH_BUFFER_LEN_BIG_INTEGER_BYTES = FAST_SCRATCH_BUFFER_LEN_BIG_INTEGER_BYTES;
