...
public interface FileMetadataCache
{
    ...
    @Deprecated
    MemoryBufferOrBuffers putFileMetadata(Object fileKey, int length, InputStream is) throws IOException;

    @Deprecated
    MemoryBufferOrBuffers putFileMetadata(Object fileKey, ByteBuffer tailBuffer);

    @Deprecated
    MemoryBufferOrBuffers putFileMetadata(Object fileKey, int length, InputStream is, CacheTag tag) throws IOException;
     ...
     * The caller must decref this buffer when done.
     */
    MemoryBufferOrBuffers putFileMetadata(Object fileKey, ByteBuffer tailBuffer, CacheTag tag, AtomicBoolean isStopped);

    MemoryBufferOrBuffers putFileMetadata(Object fileKey, int length, InputStream is, CacheTag tag, AtomicBoolean isStopped) throws IOException;
