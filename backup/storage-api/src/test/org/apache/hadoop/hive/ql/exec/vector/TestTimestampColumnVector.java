...
{
    private static final GregorianCalendar PROLEPTIC_GREGORIAN_CALENDAR_UTC = new GregorianCalendar(TimeZone.getTimeZone("UTC"));
    private static final GregorianCalendar GREGORIAN_CALENDAR_UTC = new GregorianCalendar(TimeZone.getTimeZone("UTC"));

    private static final SimpleDateFormat PROLEPTIC_GREGORIAN_TIMESTAMP_FORMATTER_UTC = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    private static final SimpleDateFormat GREGORIAN_TIMESTAMP_FORMATTER_UTC = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    public void testProlepticCalendar()
    {
        ...
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(16768, randomMillis), appendTime("2015-11-29", randomMillis), false, true);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-141418, randomMillis), appendTime("1582-10-24", randomMillis), false, true);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-141427, randomMillis), appendTime("1582-10-15", randomMillis), false, true);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-141428, randomMillis), appendTime("1582-10-04", randomMillis), false, true);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-141430, randomMillis), appendTime("1582-10-02", randomMillis), false, true);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-141437, randomMillis), appendTime("1582-09-25", randomMillis), false, true);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-499952, randomMillis), appendTime("0601-03-04", randomMillis), false, true);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-499955, randomMillis), appendTime("0601-03-01", randomMillis), false, true);

        // from proleptic internal representation to hybrid
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(16768, randomMillis), appendTime("2015-11-29", randomMillis), true, false);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-141418, randomMillis), appendTime("1582-10-24", randomMillis), true, false);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-141427, randomMillis), appendTime("1582-10-15", randomMillis), true, false);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-141428, randomMillis), appendTime("1582-10-24", randomMillis), true, false);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-141430, randomMillis), appendTime("1582-10-22", randomMillis), true, false);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-141437, randomMillis), appendTime("1582-10-15", randomMillis), true, false);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-499952, randomMillis), appendTime("0601-03-07", randomMillis), true, false);
        setAndVerifyProlepticUpdate(getMillisForDayPlusMillis(-499955, randomMillis), appendTime("0601-03-04", randomMillis), true, false);
    }
    ...
    private void setAndVerifyProlepticUpdate(long epochMilli, String expected, boolean originalUseProleptic, boolean newUseProleptic)
    {
        ...
        TimestampColumnVector timestampColVector = new TimestampColumnVector().setUsingProlepticCalendar(originalUseProleptic);
        ...
        Assert.assertEquals(expected, testFormatter.format(Timestamp.from(Instant.ofEpochMilli(timestampColVector.time[0]))));
