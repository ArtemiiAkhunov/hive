...
public class TestBloomKFilter
{
    ...
    public void testMergeBloomKFilterBytes() throws Exception
    {
        ...
        // Merge bytes
        BloomKFilter.mergeBloomFilterBytes(bf1Bytes, 0, bf1Bytes.length, bf2Bytes, 0, bf2Bytes.length);
    ...
    public void testMergeBloomKFilterBytesFailureCases() throws Exception
    {
        ...
        {
            // this should fail
            BloomKFilter.mergeBloomFilterBytes(bf1Bytes, 0, bf1Bytes.length, bf3Bytes, 0, bf3Bytes.length);
            Assert.fail("Expected exception not encountered");
        } catch (IllegalArgumentException err)
        {
            // expected
    ...
    private int getFp(int size, BloomKFilter bf)
    {
        int fp = 0;
        for (int i = 0; i < size; i++)
        {
