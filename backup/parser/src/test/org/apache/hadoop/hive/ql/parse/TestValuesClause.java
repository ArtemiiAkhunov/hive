...
public class TestValuesClause
{
    ...
    {
        ASTNode tree = parseDriver.parse("select 1 a, 2 as b, 3", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("insert into t1(a,b,c) values (1,2,3),(4,5,6)", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("insert into t1 select 1 a, 2 b, 3", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("VALUES(1,2,3),(4,5,6)", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("VALUES(1),(4)", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("VALUES(1 a),(4)", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("VALUES(1, 2 b, 3),(4, 5, 6)", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("VALUES(1 a, 2 b, 3),(4, 5, 6)", null).getTree();
