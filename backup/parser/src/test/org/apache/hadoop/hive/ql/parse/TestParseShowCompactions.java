...
public class TestParseShowCompactions
{
    ...
    {
        ASTNode tree = parseDriver.parse("SHOW COMPACTIONS", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("SHOW COMPACTIONS DATABASE db1", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("SHOW COMPACTIONS DATABASE db1 POOL 'pool0' TYPE 'minor' STATUS 'ready for clean' ORDER BY cq_table DESC, cq_state LIMIT 42", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("SHOW COMPACTIONS SCHEMA db1", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("SHOW COMPACTIONS tbl0", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("SHOW COMPACTIONS compactionid =1", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("SHOW COMPACTIONS db1.tbl0", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("SHOW COMPACTIONS POOL 'pool0'", null).getTree();
    ...
    {
        ASTNode tree = parseDriver.parse("SHOW COMPACTIONS db1.tbl0 PARTITION (p=101,day='Monday') POOL 'pool0' TYPE 'minor' STATUS 'ready for clean' ORDER BY cq_table DESC, cq_state LIMIT 42", null).getTree();
