...
public class TestParseDriver
{
    ...
    public void testParse() throws Exception
    {
        ...
        ASTNode tree = parseDriver.parse(selectStr + " from table1 where " + whereStr + " group by field1, field2 having  " + havingStr).getTree();
    ...
    public void testNestedFunctionCalls() throws Exception
    {
        ...
        parseDriver.parse("select greatest(1,greatest(1,greatest(1,greatest(1,greatest(1,greatest(1,greatest(1," + "greatest(1,greatest(1,greatest(1,greatest(1,greatest(1,greatest(1,greatest(1," + "greatest(1,greatest(1,(greatest(1,greatest(1,2)))))))))))))))))))");
    }
