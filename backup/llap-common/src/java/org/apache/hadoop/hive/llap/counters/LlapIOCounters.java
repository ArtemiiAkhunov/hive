...
{
    NUM_VECTOR_BATCHES(true), NUM_DECODED_BATCHES(true), SELECTED_ROWGROUPS(true), NUM_ERRORS(true), ROWS_EMITTED(true), METADATA_CACHE_HIT(true), METADATA_CACHE_MISS(true), CACHE_HIT_BYTES(true), CACHE_MISS_BYTES(true), ALLOCATED_BYTES(true), ALLOCATED_USED_BYTES(true), TOTAL_IO_TIME_NS(false), DECODE_TIME_NS(false), HDFS_TIME_NS(false), CONSUMER_TIME_NS(false), IO_CPU_NS(false), IO_USER_NS(false);
