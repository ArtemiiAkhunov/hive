...
public enum LlapDaemonInfo
{
    ...
    {
        public LlapDaemonInfoHolder(int numExecutors, long executorMemory, long cacheSize, boolean isDirectCache, boolean isLlapIo, final String pid)
        {
    ...
    private AtomicReference<LlapDaemonInfoHolder> dataRef = new AtomicReference<LlapDaemonInfoHolder>();
    ...
    public static void initialize(String appName, int numExecutors, long executorMemoryBytes, long ioMemoryBytes, boolean isDirectCache, boolean isLlapIo, final String pid)
    {
        INSTANCE.dataRef.set(new LlapDaemonInfoHolder(numExecutors, executorMemoryBytes, ioMemoryBytes, isDirectCache, isLlapIo, pid));
    }
