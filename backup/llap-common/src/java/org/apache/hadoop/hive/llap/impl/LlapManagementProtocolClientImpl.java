...
public class LlapManagementProtocolClientImpl implements LlapManagementProtocolPB
{
    ...
    private LlapManagementProtocolPB createProxy() throws IOException
    {
        ...
        ProtocolProxy<LlapManagementProtocolPB> proxy = RPC.getProtocolProxy(LlapManagementProtocolPB.class, 0, serverAddr, ugi == null ? UserGroupInformation.getCurrentUser() : ugi, conf, socketFactory, 0, retryPolicy);
    ...
    @Override
    public LlapDaemonProtocolProtos.EvictEntityResponseProto evictEntity(RpcController controller, LlapDaemonProtocolProtos.EvictEntityRequestProto request) throws ServiceException
    {
        try
        {
    ...
    @Override
    public LlapDaemonProtocolProtos.GetCacheContentResponseProto getCacheContent(RpcController controller, final LlapDaemonProtocolProtos.GetCacheContentRequestProto request) throws ServiceException
    {
        try
        {
