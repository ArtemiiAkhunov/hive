...
public class TestConverters
{
    ...
    private void verifyInputSpecAndProto(InputSpec inputSpec, IOSpecProto inputSpecProto)
    {
        ...
        assertEquals(inputSpec.getInputDescriptor().getClassName(), inputSpecProto.getIoDescriptor().getClassName());
    ...
    private void verifyOutputSpecAndProto(OutputSpec outputSpec, IOSpecProto outputSpecProto)
    {
        ...
        assertEquals(outputSpec.getOutputDescriptor().getClassName(), outputSpecProto.getIoDescriptor().getClassName());
        assertEquals(outputSpec.getOutputDescriptor().getUserPayload().getPayload(), outputSpecProto.getIoDescriptor().getUserPayload().getUserPayload().asReadOnlyByteBuffer());
    }
}
