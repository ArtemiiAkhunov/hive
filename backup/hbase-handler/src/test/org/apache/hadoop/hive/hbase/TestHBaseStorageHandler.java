...
public class TestHBaseStorageHandler
{
    ...
    public void testHbaseConfigIsAddedToJobConf()
    {
        ...
        Assert.assertTrue("hbase-site.xml is supposed to be present", jobConfToConfigure.get("hbase.some.fake.option.from.xml.file") == null);

        hbaseStorageHandler.configureJobConf(tableDesc, jobConfToConfigure);

        Assert.assertTrue("hbase-site.xml is supposed to be added as a resource by HBaseStorageHandler", jobConfToConfigure.get("hbase.some.fake.option.from.xml.file") != null);
    }
