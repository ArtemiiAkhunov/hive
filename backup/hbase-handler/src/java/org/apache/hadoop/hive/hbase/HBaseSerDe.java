...
public class HBaseSerDe extends AbstractSerDe
{
    ...
    {
        HBaseSerDeParameters serdeParams = new HBaseSerDeParameters(jobConf, tableDesc.getProperties(), HBaseSerDe.class.getName());
