...
public class AccumuloPredicateHandler
{
     ...
     * @param columnMapper        Mapping of Hive to Accumulo columns for the query
     * @param hiveRowIdColumnName Name of the hive column mapped to the Accumulo rowid
     * @param root                Root of some ExprNodeDesc tree to traverse, the WHERE clause
     ...
     * type.
     *
     * @param accumuloColumnMapping ColumnMapping to filter
     * @param sc                    IndexSearchCondition
     * @param binaryEncodedValues   flag for binary encodedValues
     * @return IteratorSetting
     * @throws SerDeException
     */
    public IteratorSetting toSetting(HiveAccumuloColumnMapping accumuloColumnMapping, IndexSearchCondition sc, boolean binaryEncodedValues) throws SerDeException
    {
        iteratorCount++;
        ...
        final String type = binaryEncodedValues ? sc.getColumnDesc().getTypeString() : ColumnEncoding.STRING.getName();
