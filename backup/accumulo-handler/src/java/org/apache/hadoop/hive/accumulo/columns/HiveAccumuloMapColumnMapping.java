...
public class HiveAccumuloMapColumnMapping extends ColumnMapping
{
    ...
    /**
     * @param columnFamily          The column family that all qualifiers within should be placed into the same Hive map
     * @param columnQualifierPrefix The column qualifier prefix to include in the map, null is treated as an empty prefix
     * @param keyEncoding           The encoding scheme for keys in this column family
     * @param valueEncoding         The encoding scheme for the Accumulo values
     */
    ...
    public boolean equals(Object o)
    {
        if (o instanceof HiveAccumuloMapColumnMapping)
        {
            ...
            return columnFamily.equals(other.columnFamily) && columnQualifierPrefix.equals(other.columnQualifierPrefix) && keyEncoding.equals(other.keyEncoding) && valueEncoding.equals(other.valueEncoding);
        }
    ...
    {
        return "[" + this.getClass().getSimpleName() + ": " + columnFamily + ":" + columnQualifierPrefix + "* encoding: " + keyEncoding + ":" + valueEncoding + "]";
    }
}
