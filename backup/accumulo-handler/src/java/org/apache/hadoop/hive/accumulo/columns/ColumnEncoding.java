...
public enum ColumnEncoding
{
    ...
    private static final HashMap<String, ColumnEncoding> CODE_CACHE = new HashMap<String, ColumnEncoding>(), NAME_CACHE = new HashMap<String, ColumnEncoding>();
     ...
     *
     * @param code The one-character 'code' which uniquely identifies the ColumnEncoding
     ...
     *
     * @param columnMapping The mapping from Hive column to an Accumulo column
     ...
     *
     * @param columnMapping The mapping from Hive column to Accumulo column
    ...
    public static String stripCode(String columnMapping)
    {
        ...
        int offset = columnMapping.lastIndexOf(AccumuloHiveConstants.POUND);
        if (-1 == offset || (0 < offset && AccumuloHiveConstants.ESCAPE == columnMapping.charAt(offset - 1)))
        {
