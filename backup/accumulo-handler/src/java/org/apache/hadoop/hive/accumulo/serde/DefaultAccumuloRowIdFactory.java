...
public class DefaultAccumuloRowIdFactory implements AccumuloRowIdFactory
{
    ...
    public void init(AccumuloSerDeParameters accumuloSerDeParams, Properties properties) throws SerDeException
    {
        ...
        this.serializer = new AccumuloRowSerializer(accumuloSerDeParams.getRowIdOffset(), serdeParams, accumuloSerDeParams.getColumnMappings(), accumuloSerDeParams.getTableVisibilityLabel(), this);
    ...
    {
        return LazyFactory.createLazyObjectInspector(type, serdeParams.getSeparators(), 1, serdeParams.getNullSequence(), serdeParams.isEscaped(), serdeParams.getEscapeChar());
    }
    ...
    public LazyObjectBase createRowId(ObjectInspector inspector) throws SerDeException
    {
        ...
        return LazyFactory.createLazyObject(inspector, !TypeInfoFactory.stringTypeInfo.getTypeName().equals(inspector.getTypeName()) && ColumnEncoding.BINARY == rowIdMapping.getEncoding());
    }
