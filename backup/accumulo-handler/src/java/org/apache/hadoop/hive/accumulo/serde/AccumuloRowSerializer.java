...
public class AccumuloRowSerializer
{
    ...
    {
        Preconditions.checkArgument(primaryKeyOffset >= 0, "A valid offset to the mapping for the Accumulo RowID is required, received " + primaryKeyOffset);
     ...
     *
     * @param fieldObjectInspector ObjectInspector for the column value being serialized
     * @param value                The Object itself being serialized
     * @param output               A temporary buffer to reduce object creation
     * @return The serialized bytes from the provided value.
     * @throws IOException An error occurred when performing IO to serialize the data
     */
