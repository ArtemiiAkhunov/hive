...
public class AccumuloStorageHandler extends DefaultStorageHandler implements HiveMetaHook, HiveStoragePredicateHandler
{
     ...
     *
     * @param desc     Hive table description
     * @param jobProps Properties that will be added to the JobConf by Hive
     */
    @Override
    ...
    protected String getIndexTableName(Table table)
    {
        ...
        // Then try SERDEPROPERTIES
        idxTableName = table.getSd().getSerdeInfo().getParameters().get(AccumuloIndexParameters.INDEXTABLE_NAME);
    ...
    public void configureOutputJobProperties(TableDesc tableDesc, Map<String, String> jobProperties)
    {
        ...
        if (null != indexTable)
        {
            ...
            jobProperties.put(AccumuloIndexParameters.INDEXED_COLUMNS, getIndexedColFamQuals(tableDesc, indexColumns, colMap));
        }
        ...
        {
            jobProperties.put(AccumuloSerDeParameters.VISIBILITY_LABEL_KEY, props.getProperty(AccumuloSerDeParameters.VISIBILITY_LABEL_KEY));
        }
    }
    ...
    private String getIndexedColFamQuals(TableDesc tableDesc, String indexColumns, String colMap)
    {
        ...
        String[] hiveTypes = tableDesc.getProperties().getProperty(serdeConstants.LIST_COLUMN_TYPES).split(":");
