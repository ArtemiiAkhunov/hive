...
public class HiveResultSetMetaData implements java.sql.ResultSetMetaData
{
    ...
    {
        return JdbcColumn.columnClassName(getHiveType(column), columnAttributes.get(toZeroIndex(column)));
    }
    ...
    {
        return JdbcColumn.columnDisplaySize(getHiveType(column), columnAttributes.get(toZeroIndex(column)));
    }
    ...
    {
        return JdbcColumn.columnPrecision(getHiveType(column), columnAttributes.get(toZeroIndex(column)));
    }
