...
public class HttpJwtAuthRequestInterceptor extends HttpRequestInterceptorBase
{
    ...
    public HttpJwtAuthRequestInterceptor(String signedJwt, CookieStore cookieStore, String cn, boolean isSSL, Map<String, String> additionalHeaders, Map<String, String> customCookies)
    {
