...
public class HttpSamlAuthRequestInterceptor extends HttpRequestInterceptorBase
{
    ...
    private static final Logger LOG = LoggerFactory.getLogger(HttpSamlAuthRequestInterceptor.class);
    ...
    protected void addHttpAuthHeader(HttpRequest httpRequest, HttpContext httpContext) throws Exception
    {
        ...
        String token = browserClient.getServerResponse() == null ? null : browserClient.getServerResponse().getToken();
