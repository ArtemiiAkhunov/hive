...
public class TestHiveConnection
{
    ...
    {
        JdbcConnectionParams params = Utils.parseURL("jdbc:hive2://hello.host:10002/default;transportMode=http;httpPath=cliservice;socketTimeout=60;requestTrack=true;");
