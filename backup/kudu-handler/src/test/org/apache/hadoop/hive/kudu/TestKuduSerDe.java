...
public class TestKuduSerDe
{
    ...
    public void testMissingMasters() throws Exception
    {
        ...
        {
            assertThat(ex.getMessage(), containsString("Kudu master addresses are not specified in the table property"));
        }
    }
    ...
    public void testBadTable() throws Exception
    {
        ...
        {
            assertThat(ex.getMessage(), containsString("Kudu table does not exist: default.notatable"));
        }
    }
}
