 ...
 */
public class DruidTimeseriesQueryRecordReader extends DruidQueryRecordReader<Result<TimeseriesResultValue>>
{
    ...
    public DruidWritable getCurrentValue() throws IOException, InterruptedException
    {
        ...
        value.getValue().put(DruidConstants.EVENT_TIMESTAMP_COLUMN, current.getTimestamp() == null ? null : current.getTimestamp().getMillis());
