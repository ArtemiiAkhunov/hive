...
public class DruidStorageHandler extends DefaultHiveMetaHook implements HiveStorageHandler
{
    ...
    public void preCreateTable(Table table) throws MetaException
    {
        ...
        Collection<String> existingDataSources = DruidStorageHandlerUtils.getAllDataSourceNames(getConnector(), getDruidMetadataStorageTablesConfig());
    ...
    public URI getURIForAuth(Table table) throws URISyntaxException
    {
        ...
        String host_name = conf.get(DRUID_HOST_NAME) != null ? conf.get(DRUID_HOST_NAME) : HiveConf.getVar(getConf(), HiveConf.ConfVars.HIVE_DRUID_BROKER_DEFAULT_ADDRESS);
    ...
    public void commitInsertTable(Table table, boolean overwrite) throws MetaException
    {
        ...
        try
        {
            ...
            if (segmentsToLoad.isEmpty() && overwrite)
            {
                ...
                DruidStorageHandlerUtils.disableDataSource(getConnector(), getDruidMetadataStorageTablesConfig(), dataSourceName);
    ...
    private List<DataSegment> fetchSegmentsMetadata(Path segmentDescriptorDir) throws IOException
    {
        ...
        {
            LOG.info("Directory {} does not exist, ignore this if it is create statement or inserts of 0 rows," + " no Druid segments to move, cleaning working directory {}", segmentDescriptorDir.toString(), getStagingWorkingDir().toString());
    ...
    public void configureOutputJobProperties(TableDesc tableDesc, Map<String, String> jobProperties)
    {
        ...
        jobProperties.put(DruidConstants.DRUID_SEGMENT_INTERMEDIATE_DIRECTORY, getIntermediateSegmentDir().toString());
    }
    ...
    private String getUniqueId()
    {
        if (uniqueId == null)
        {
            uniqueId = Preconditions.checkNotNull(Strings.emptyToNull(HiveConf.getVar(getConf(), HiveConf.ConfVars.HIVE_QUERY_ID)), "Hive query id is null");
        }
        return uniqueId;
    }
