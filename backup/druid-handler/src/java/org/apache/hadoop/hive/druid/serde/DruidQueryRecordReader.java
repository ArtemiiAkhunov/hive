 ...
 * the query.
 */
public abstract class DruidQueryRecordReader<R extends Comparable<R>> extends RecordReader<NullWritable, DruidWritable> implements org.apache.hadoop.mapred.RecordReader<NullWritable, DruidWritable>
{
    ...
    {
        initialize(split, DruidStorageHandlerUtils.JSON_MAPPER, DruidStorageHandlerUtils.SMILE_MAPPER, DruidStorageHandler.getHttpClient(), conf);
    }
