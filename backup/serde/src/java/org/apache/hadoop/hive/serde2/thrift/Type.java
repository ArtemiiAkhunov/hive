...
public enum Type
{
     ...
     *
     * @return DatabaseMetaData.typeNoNulls - does not allow NULL values
     ...
     *
     * @return DatabaseMetaData.typePredNone - No support
