...
public class ThriftDeserializer extends AbstractSerDe
{
    ...
    public void initialize(Configuration configuration, Properties tableProperties, Properties partitionProperties) throws SerDeException
    {
        ...
        try
        {
            ...
            String className = properties.getProperty(org.apache.hadoop.hive.serde.serdeConstants.SERIALIZATION_CLASS);
            Class<?> recordClass = configuration.getClassByName(className);

            String protoName = properties.getProperty(org.apache.hadoop.hive.serde.serdeConstants.SERIALIZATION_FORMAT);
            if (protoName == null)
            {
