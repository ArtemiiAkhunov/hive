...
public class TeradataBinarySerde extends AbstractSerDe
{
    ...
    public Writable serialize(Object obj, ObjectInspector objInspector) throws SerDeException
    {
        try
        {
            ...
            {
                throw new SerDeException("Cannot serialize the object because there are " + fieldRefs.size() + " fieldRefs but the table defined " + numCols + " columns.");
            }
    ...
    private int getDecimalByteNum(int precision) throws SerDeException
    {
        ...
        throw new IllegalArgumentException(format("the precision of Decimal should be smaller than 39. %d is illegal", precision));
    }
}
