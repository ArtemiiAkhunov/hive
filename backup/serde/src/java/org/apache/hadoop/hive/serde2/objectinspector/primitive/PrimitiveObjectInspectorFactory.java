...
public final class PrimitiveObjectInspectorFactory
{
    ...
    private static Map<PrimitiveCategory, AbstractPrimitiveWritableObjectInspector> primitiveCategoryToWritableOI = new EnumMap<>(PrimitiveCategory.class);
    ...
    public static final JavaTimestampLocalTZObjectInspector javaTimestampTZObjectInspector = new JavaTimestampLocalTZObjectInspector(TypeInfoFactory.timestampLocalTZTypeInfo);
    ...
    private static ConcurrentHashMap<PrimitiveTypeInfo, AbstractPrimitiveJavaObjectInspector> cachedPrimitiveJavaInspectorCache = new ConcurrentHashMap<>();
    ...
    private static Map<PrimitiveCategory, AbstractPrimitiveJavaObjectInspector> primitiveCategoryToJavaOI = new EnumMap<>(PrimitiveCategory.class);
