...
public class BytesRefArrayWritable implements Writable, Comparable<BytesRefArrayWritable>
{
     ...
     *
     * @param index the position index, starting from zero
    ...
    public BytesRefWritable get(int index)
    {
        if (index >= valid)
        {
            throw new IndexOutOfBoundsException("This BytesRefArrayWritable only has " + valid + " valid values.");
        }
     ...
     * @param bytesRefWritable the new element
     * @throws IllegalArgumentException if the specified new element is null
     */
     ...
     *
     * @param newValidCapacity the desired capacity
     */
