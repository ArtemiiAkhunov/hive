...
public class LazySimpleSerDe extends AbstractEncodingAwareSerDe
{
    ...
    public String toString()
    {
        ...
        sb.append(getClass() + " [serdeParams=" + serdeParams + ", cachedObjectInspector=" + cachedObjectInspector + ", serializedSize=" + serializedSize + ", stats=" + stats + ", lastOperationSerialize=" + lastOperationSerialize + ", lastOperationDeserialize=" + lastOperationDeserialize);
    ...
    protected List<TypeInfo> parseColumnTypes()
    {
        ...
        return (!columnTypes.isEmpty()) ? columnTypes : Collections.nCopies(getColumnNames().size(), TypeInfoFactory.stringTypeInfo);
    }
     ...
     * @param needsEscape  Which byte needs to be escaped for 256 bytes.
     * @throws IOException
     * @throws SerDeException
     */
    public static void serialize(ByteStream.Output out, Object obj, ObjectInspector objInspector, byte[] separators, int level, Text nullSequence, boolean escaped, byte escapeChar, boolean[] needsEscape) throws IOException, SerDeException
    {
        ...
        switch (objInspector.getCategory())
        {
            ...
            case UNION:
                ...
                {
                    LazyUtils.writePrimitiveUTF8(out, Byte.valueOf(uoi.getTag(obj)), PrimitiveObjectInspectorFactory.javaByteObjectInspector, escaped, escapeChar, needsEscape);
                    out.write(separator);
