...
public class JavaTimestampLocalTZObjectInspector extends AbstractPrimitiveJavaObjectInspector implements SettableTimestampLocalTZObjectInspector
{
    ...
    {
        TimestampLocalTZWritable.setTimestampTZ((TimestampTZ) o, bytes, offset, ((TimestampLocalTZTypeInfo) typeInfo).timeZone());
        return o;
    }
    ...
    public Object set(Object o, TimestampTZ t)
    {
        ...
        ((TimestampTZ) o).setZonedDateTime(t.getZonedDateTime().withZoneSameInstant(((TimestampLocalTZTypeInfo) typeInfo).timeZone()));
        return o;
    }
    ...
    public Object set(Object o, TimestampLocalTZWritable t)
    {
        ...
        ((TimestampTZ) o).setZonedDateTime(t.getTimestampTZ().getZonedDateTime().withZoneSameInstant(((TimestampLocalTZTypeInfo) typeInfo).timeZone()));
        return o;
    }
