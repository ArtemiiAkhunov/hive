...
public abstract class AbstractSerDe implements Deserializer, Serializer
{
    ...
    protected List<String> parseColumnNames(String key)
    {
        ...
        final String columnNameDelimiter = this.properties.getProperty(serdeConstants.COLUMN_NAME_DELIMITER, String.valueOf(SerDeUtils.COMMA));
    ...
    protected List<String> parseColumnComments(String key)
    {
        ...
        return columnCommentProperty.isEmpty() ? Collections.emptyList() : Collections.unmodifiableList(Arrays.asList(columnCommentProperty.split(Character.toString(ColumnType.COLUMN_COMMENTS_DELIMITER))));
    }
    ...
    {
        return "AbstractSerDe [log=" + log + ", configuration=" + configuration + ", properties=" + properties + ", tableProperties=" + tableProperties + ", partitionProperties=" + partitionProperties + ", columnNames=" + columnNames + ", columnTypes=" + columnTypes + ", getClass()=" + getClass() + "]";
    }
