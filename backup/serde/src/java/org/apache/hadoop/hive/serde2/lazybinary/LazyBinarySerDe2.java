...
public class LazyBinarySerDe2 extends LazyBinarySerDe
{
    ...
    {
        public void serializeValue(RandomAccessOutput byteStream, Object obj, ObjectInspector objInspector, boolean skipLengthPrefix, BooleanRef warnedOnceNullMapKey)
        {
            if (obj != null)
            {
        ...
        abstract void serialize(RandomAccessOutput byteStream, Object obj, ObjectInspector objInspector, boolean skipLengthPrefix, BooleanRef warnedOnceNullMapKey);
    }
    ...
    static class LBListSerializer extends LBSerializer
    {
        ...
        void serialize(RandomAccessOutput byteStream, Object obj, ObjectInspector objInspector, boolean skipLengthPrefix, BooleanRef warnedOnceNullMapKey)
        {
            ...
            for (int eid = 0; eid < size; eid++)
            {
                elementSerializer.serializeValue(byteStream, loi.getListElement(obj, eid), eoi, false, warnedOnceNullMapKey);
            }
        ...
        void serialize(RandomAccessOutput byteStream, Object obj, ObjectInspector objInspector, boolean skipLengthPrefix, BooleanRef warnedOnceNullMapKey)
        {
            ...
            for (int i = 0; i < size; ++i)
            {
                ...
                if (7 == i % 8 || i == size - 1)
                {
                    ...
                    {
                        serializers[j].serializeValue(byteStream, fieldData[j], fields.get(j).getFieldObjectInspector(), false, warnedOnceNullMapKey);
                    }
                    lasti = i + 1;
                    nullByte = 0;
                }
    ...
    static class LBUnionSerializer extends LBSerializer
    {
        ...
        void serialize(RandomAccessOutput byteStream, Object obj, ObjectInspector objInspector, boolean skipLengthPrefix, BooleanRef warnedOnceNullMapKey)
        {
            ...
            unionFieldSerializers[tag].serializeValue(byteStream, uoi.getField(obj), uoi.getObjectInspectors().get(tag), false, warnedOnceNullMapKey);
