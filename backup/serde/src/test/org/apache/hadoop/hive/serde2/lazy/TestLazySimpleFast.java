...
public class TestLazySimpleFast
{
    ...
    private void testLazySimpleFast(SerdeRandomRowSource source, Object[][] rows, LazySimpleSerDe serde, StructObjectInspector rowOI, LazySimpleSerDe serde_fewer, StructObjectInspector writeRowOI, LazySerDeParameters serdeParams, LazySerDeParameters serdeParams_fewer, TypeInfo[] typeInfos, boolean useIncludeColumns, boolean doWriteFewerColumns, Random r) throws Throwable
    {
        ...
        {
            Object[] row = rows[i];
            LazySimpleDeserializeRead lazySimpleDeserializeRead = new LazySimpleDeserializeRead(writeTypeInfos,
                    /* useExternalBuffer */ false, serdeParams);
    ...
    private void verifyReadNull(LazySimpleDeserializeRead lazySimpleDeserializeRead, TypeInfo typeInfo) throws IOException
    {
    ...
    private void verifyRead(LazySimpleDeserializeRead lazySimpleDeserializeRead, TypeInfo typeInfo, Object expectedObject) throws IOException
    {
        if (typeInfo.getCategory() == Category.PRIMITIVE)
        {
    ...
    private LazySerDeParameters getSerDeParams(String fieldNames, String fieldTypes, byte[] separators) throws SerDeException
    {
        Configuration conf = new Configuration();
        Properties tbl = createProperties(fieldNames, fieldTypes);
    ...
    public void testLazySimpleFastCase(int caseNum, boolean doNonRandomFill, Random r, SerdeRandomRowSource.SupportedTypes supportedTypes, int depth) throws Throwable
    {
        ...
        testLazySimpleFast(source, rows, serde, rowStructObjectInspector, serde_fewer, writeRowStructObjectInspector, serdeParams, serdeParams_fewer, typeInfos,
