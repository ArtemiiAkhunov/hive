...
public class TestTimestampWritableV2
{
    ...
    {
        assertEquals(normalizeTimestampStr(expected.toString()), normalizeTimestampStr(actual.toString()));
    ...
    private static TimestampWritableV2 serializeDeserializeAndCheckTimestamp(Timestamp ts) throws IOException
    {
        ...
        {
            assertEquals(Timestamp.ofEpochSecond(timeSeconds), fromIntAndVInts((int) timeSeconds, 0).getTimestamp());
    ...
    private static void checkTimestampWithAndWithoutNanos(Timestamp ts, int nanos) throws IOException
    {
    ...
    public void testSerializationFormatDirectly() throws IOException
    {
        ...
        assertEquals("2038-01-19 03:14:07.012345678", fromIntAndVInts(Integer.MAX_VALUE | HAS_DECIMAL_MASK,  // this is really just -1
                876543210).toString());
