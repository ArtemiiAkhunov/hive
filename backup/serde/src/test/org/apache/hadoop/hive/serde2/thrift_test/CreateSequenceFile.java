...
public final class CreateSequenceFile
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        for (int i = 0; i < lines; i++)
        {
            ...
            Complex complex = new Complex(rand.nextInt(), "record_" + String.valueOf(i), alist, slist, islist, hash, unionMap, PropValueUnion.stringValue("test" + i), PropValueUnion.unionMStringString(hash), PropValueUnion.lString(slist));
