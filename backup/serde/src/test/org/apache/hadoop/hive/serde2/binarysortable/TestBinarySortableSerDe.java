...
public class TestBinarySortableSerDe
{
    ...
    public static AbstractSerDe getSerDe(String fieldNames, String fieldTypes, String order, String nullOrder) throws Throwable
    {
    ...
    private void testBinarySortableSerDe(Object[] rows, ObjectInspector rowOI, AbstractSerDe serde, boolean ascending) throws Throwable
    {
