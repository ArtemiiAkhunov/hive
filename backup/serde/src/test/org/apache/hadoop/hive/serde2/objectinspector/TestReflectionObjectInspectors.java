...
public class TestReflectionObjectInspectors
{
    ...
    public void testObjectInspectorMaxCacheSize()
    {
        ...
        {
            ObjectInspectorFactory.getStandardUnionObjectInspector(Lists.newArrayList(new JavaConstantStringObjectInspector("" + i)));
        }
        assertTrue("Got: " + ObjectInspectorFactory.cachedStandardUnionObjectInspector.size(), ObjectInspectorFactory.cachedStandardUnionObjectInspector.size() <= maxSize);
        for (int i = 0; i < 1000; i++)
        {
            ObjectInspectorFactory.getStandardUnionObjectInspector(Lists.newArrayList(new JavaConstantStringObjectInspector("" + (10240 + i))));
        }
        assertTrue("Got: " + ObjectInspectorFactory.cachedStandardUnionObjectInspector.size(), ObjectInspectorFactory.cachedStandardUnionObjectInspector.size() <= maxSize);
    }
