...
public class TestLazyStruct
{
    ...
    public void testParseMultiDelimit() throws Throwable
    {
        try
        {
            ...
            LazyObjectInspectorParameters lazyObjectInspectorParameters = new LazyObjectInspectorParametersImpl(false, (byte) '0', false, null, separators, sequence);
            ...
            lazyStruct.parseMultiDelimit(rowData.getBytes(StandardCharsets.UTF_8), fieldDelimiter.getBytes(StandardCharsets.UTF_8));
