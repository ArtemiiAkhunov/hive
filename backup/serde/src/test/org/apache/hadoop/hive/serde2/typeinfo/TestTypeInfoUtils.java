...
public class TestTypeInfoUtils
{
    ...
    {
        String[] validTypeStrings = {"int", "string", "varchar(10)", "char(15)", "array<int>", "decimal(10,2)", "decimal(10, 2)", "decimal(10, 2 )", "decimal( 10, 2 )", "struct<user id:int,user group: int>"};

        String[] invalidTypeStrings = {"array<", "varchar(123", "varchar(123,", "varchar()", "varchar(", "char(123", "char(123,)", "char()", "char(", "decimal()"};
