...
public class TestLazyPrimitive
{
    ...
    public void testLazyByte() throws Throwable
    {
        try
        {
            LazyByte b = new LazyByte(LazyPrimitiveObjectInspectorFactory.LAZY_BYTE_OBJECT_INSPECTOR);
    ...
    public void testLazyString() throws Throwable
    {
        try
        {
            LazyString b = new LazyString(LazyPrimitiveObjectInspectorFactory.getLazyStringObjectInspector(false, (byte) 0));
            initLazyObject(b, new byte[]{'0'}, 0, 0);
    ...
    private void testIntCaseWithPass(String strVal, int intVal, boolean trim)
    {
        ...
        assertEquals(intVal, LazyInteger.parseInt(text.getBytes(), 0, text.getLength(), 10, trim));
    }
    ...
    {
        Text text = new Text(strVal);
        assertEquals(longVal, LazyLong.parseLong(text.getBytes(), 0, text.getLength(), 10, trim));
    }
    ...
    {
        Object[][] casesWithoutSpaces = {{"0", 0}, {"-128", -128}, {"128", 128}, {"+128", 128}, {"-2147483648", -2147483648}, {"2147483647", 2147483647}, {"+2147483647", 2147483647},};

        Object[][] casesWithSpaces = {{" 0", 0}, {"0 ", 0}, {" 0 ", 0}, {" -128", -128}, {"-128 ", -128}, {"   -128   ", -128}, {"  128", 128}, {"128  ", 128}, {"  128  ", 128}, {" +128", 128}, {"+128 ", 128}, {"   +128    ", 128}, {"   +128    ", 128}, {"   -2147483648", -2147483648}, {"-2147483648    ", -2147483648}, {"   -2147483648   ", -2147483648}, {"  2147483647", 2147483647}, {"2147483647  ", 2147483647}, {"  2147483647  ", 2147483647}, {"   +2147483647", 2147483647}, {"+2147483647   ", 2147483647}, {"   +2147483647   ", 2147483647},};

        String[] casesWithErrors = {"", "  ", "one", " one ", "123:", "123a", " 123a ", "a123", " a123 ",
                // Exceeds MAX_VALUE
    ...
    {
        Object[][] casesWithoutSpaces = {{"0", 0}, {"-128", -128}, {"128", 128}, {"+128", 128}, {"-9223372036854775808", -9223372036854775808L}, {"9223372036854775807", 9223372036854775807L}, {"+9223372036854775807", 9223372036854775807L},};

        Object[][] casesWithSpaces = {{" 0", 0}, {"0 ", 0}, {" 0 ", 0}, {" -128", -128}, {"-128 ", -128}, {"   -128   ", -128}, {"  128", 128}, {"128  ", 128}, {"  128  ", 128}, {" +128", 128}, {"+128 ", 128}, {"   +128    ", 128}, {"   +128    ", 128}, {"   -9223372036854775808", -9223372036854775808L}, {"-9223372036854775808    ", -9223372036854775808L}, {"   -9223372036854775808   ", -9223372036854775808L}, {"  9223372036854775807", 9223372036854775807L}, {"9223372036854775807  ", 9223372036854775807L}, {"  9223372036854775807  ", 9223372036854775807L}, {"   +9223372036854775807", 9223372036854775807L}, {"+9223372036854775807   ", 9223372036854775807L}, {"   +9223372036854775807   ", 9223372036854775807L},};
