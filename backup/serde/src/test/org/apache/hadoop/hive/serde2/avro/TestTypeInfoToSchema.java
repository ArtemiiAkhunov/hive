...
public class TestTypeInfoToSchema
{
    ...
    private static final TypeInfo STRING = TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.STRING_TYPE_NAME);
    private static final TypeInfo INT = TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.INT_TYPE_NAME);
    private static final TypeInfo BOOLEAN = TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.BOOLEAN_TYPE_NAME);
    private static final TypeInfo LONG = TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.BIGINT_TYPE_NAME);
    private static final TypeInfo FLOAT = TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.FLOAT_TYPE_NAME);
    private static final TypeInfo DOUBLE = TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.DOUBLE_TYPE_NAME);
    private static final TypeInfo BINARY = TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.BINARY_TYPE_NAME);
    private static final TypeInfo BYTE = TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.TINYINT_TYPE_NAME);
    private static final TypeInfo SHORT = TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.SMALLINT_TYPE_NAME);
    private static final TypeInfo VOID = TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.VOID_TYPE_NAME);
    private static final TypeInfo DATE = TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.DATE_TYPE_NAME);
    private static final TypeInfo TIMESTAMP = TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.TIMESTAMP_TYPE_NAME);
    private static final int PRECISION = 4;
    private static final int SCALE = 2;
    private static final TypeInfo DECIMAL = TypeInfoFactory.getPrimitiveTypeInfo(new DecimalTypeInfo(PRECISION, SCALE).getQualifiedName());
    private static final int CHAR_LEN = 5;
    private static final TypeInfo CHAR = TypeInfoFactory.getPrimitiveTypeInfo(new CharTypeInfo(CHAR_LEN).getQualifiedName());
    private static final TypeInfo VARCHAR = TypeInfoFactory.getPrimitiveTypeInfo(new VarcharTypeInfo(CHAR_LEN).getQualifiedName());
    ...
    {
        return typeInfoToSchema.convert(COLUMN_NAMES, Arrays.asList(columnType), Arrays.asList(""), "org.apache.hive.avro.testing", "avrotest", "This is to test hive-avro").toString();
    }

    private String genSchemaWithoutNull(String specificSchema)
    {
        return "{" + "\"type\":\"record\"," + "\"name\":\"avrotest\"," + "\"namespace\":\"org.apache.hive.avro.testing\"," + "\"doc\":\"This is to test hive-avro\"," + "\"fields\":[" + "{\"name\":\"testCol\"," + "\"type\":" + specificSchema + "," + "\"doc\":\"\"," + "\"default\":null}" + "]}";
    }
