...
public class Complex implements org.apache.thrift.TBase<Complex, Complex._Fields>, java.io.Serializable, Cloneable, Comparable<Complex>
{
    ...
    {
        AINT((short) 1, "aint"), A_STRING((short) 2, "aString"), LINT((short) 3, "lint"), L_STRING((short) 4, "lString"), LINT_STRING((short) 5, "lintString"), M_STRING_STRING((short) 6, "mStringString"), ATTRIBUTES((short) 7, "attributes"), UNION_FIELD1((short) 8, "unionField1"), UNION_FIELD2((short) 9, "unionField2"), UNION_FIELD3((short) 10, "unionField3");
    ...
    public Complex(int aint, java.lang.String aString, java.util.List<java.lang.Integer> lint, java.util.List<java.lang.String> lString, java.util.List<IntString> lintString, java.util.Map<java.lang.String, java.lang.String> mStringString, java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.util.Map<java.lang.String, PropValueUnion>>> attributes, PropValueUnion unionField1, PropValueUnion unionField2, PropValueUnion unionField3)
    {
        this();
        this.aint = aint;
        setAintIsSet(true);
