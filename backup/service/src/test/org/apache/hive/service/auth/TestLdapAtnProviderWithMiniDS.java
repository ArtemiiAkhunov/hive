...
@CreateLdapServer(transports = {@CreateTransport(protocol = "LDAP", port = 10389), @CreateTransport(protocol = "LDAPS", port = 10636)})
...
@ApplyLdifFiles({"ldap/example.com.ldif", "ldap/microsoft.schema.ldif", "ldap/ad.example.com.ldif"})
public class TestLdapAtnProviderWithMiniDS extends AbstractLdapTestUnit
{
    ...
    {
        testCase = defaultBuilder().userDNPatterns("uid=%s,ou=People,dc=example,dc=com").groupDNPatterns("uid=%s,ou=Groups,dc=example,dc=com").build();
    ...
    {
        testCase = defaultBuilder().baseDN("ou=DummyPeople,dc=example,dc=com").build();
    ...
    {
        testCase = defaultBuilder().userDNPatterns("uid=%s,ou=DummyPeople,dc=example,dc=com").groupDNPatterns("uid=%s,ou=DummyGroups,dc=example,dc=com").build();
    ...
    {
        testCase = defaultBuilder().userDNPatterns(" ").groupDNPatterns(" ").build();
    ...
    {
        testCase = defaultBuilder().userDNPatterns("uid=%s,ou=People,dc=example,dc=com").userFilters(USER1.getId()).build();

        testCase.assertAuthenticatePasses(USER1.credentialsWithId());
        testCase.assertAuthenticatePasses(USER1.credentialsWithDn());

        testCase = defaultBuilder().userDNPatterns("uid=%s,ou=People,dc=example,dc=com").userFilters(USER2.getId()).build();

        testCase.assertAuthenticatePasses(USER2.credentialsWithId());
        testCase.assertAuthenticatePasses(USER2.credentialsWithDn());

        testCase = defaultBuilder().userDNPatterns("uid=%s,ou=People,dc=example,dc=com").userFilters(USER1.getId(), USER2.getId()).build();
    ...
    public void testUserFilterNegative()
    {
        ...
        testCase = defaultBuilder().userDNPatterns("uid=%s,ou=People,dc=example,dc=com").userFilters(USER3.getId()).build();
    ...
    {
        testCase = defaultBuilder().userDNPatterns("uid=%s,ou=People,dc=example,dc=com").groupDNPatterns("uid=%s,ou=Groups,dc=example,dc=com").groupFilters(GROUP1_NAME, GROUP2_NAME).build();
        ...
        testCase = defaultBuilder().userDNPatterns("uid=%s,ou=People,dc=example,dc=com").groupDNPatterns("uid=%s,ou=Groups,dc=example,dc=com").groupFilters(GROUP2_NAME).build();
    ...
    public void testGroupFilterNegative()
    {
        ...
        testCase = defaultBuilder().userDNPatterns("uid=%s,ou=People,dc=example,dc=com").groupDNPatterns("uid=%s,ou=Groups,dc=example,dc=com").groupFilters(GROUP1_NAME).build();
    ...
    {
        testCase = defaultBuilder().userDNPatterns("uid=%s,ou=People,dc=example,dc=com").groupDNPatterns("uid=%s,ou=Groups,dc=example,dc=com").userFilters(USER1.getId(), USER2.getId()).groupFilters(GROUP1_NAME, GROUP2_NAME).build();
    ...
    {
        testCase = defaultBuilder().baseDN("ou=People,dc=example,dc=com").userDNPatterns("cn=%s,ou=People,dc=example,dc=com", "uid=%s,ou=People,dc=example,dc=com").groupDNPatterns("cn=%s,ou=People,dc=example,dc=com").customQuery(String.format("(&(objectClass=person)(|(uid=%s)(uid=%s)))", USER1.getId(), USER4.getId())).build();
        ...
        testCase = defaultBuilder().baseDN("ou=People,dc=example,dc=com").customQuery("(&(objectClass=person)(uid=%s))").build();
    ...
    {
        testCase = defaultBuilder().baseDN("ou=People,dc=example,dc=com").customQuery("(&(objectClass=person)(cn=%s))").build();
    ...
    */
    ...
    {
        testCase = defaultBuilder().userDNPatterns("cn=%s,ou=People,dc=example,dc=com").groupDNPatterns("cn=%s,ou=Groups,dc=example,dc=com").groupFilters(GROUP3_NAME).guidKey("cn").build();
    ...
    {
        testCase = defaultBuilder().userDNPatterns("cn=%s,ou=People,dc=example,dc=com").groupDNPatterns("cn=%s,ou=Groups,dc=example,dc=com").groupFilters(GROUP4_NAME).guidKey("cn").groupMembershipKey("uniqueMember").groupClassKey("groupOfUniqueNames").build();
    ...
    {
        testCase = defaultBuilder().userDNPatterns("sAMAccountName=%s,ou=Engineering,dc=ad,dc=example,dc=com", "sAMAccountName=%s,ou=Management,dc=ad,dc=example,dc=com").groupDNPatterns("sAMAccountName=%s,ou=Teams,dc=ad,dc=example,dc=com", "sAMAccountName=%s,ou=Resources,dc=ad,dc=example,dc=com").groupFilters(GROUP_TEAM1_NAME, GROUP_TEAM2_NAME, GROUP_RESOURCE1_NAME, GROUP_RESOURCE2_NAME).guidKey("sAMAccountName").userMembershipKey("memberOf").build();
    ...
    {
        testCase = defaultBuilder().userDNPatterns("sAMAccountName=%s,ou=Engineering,dc=ad,dc=example,dc=com", "sAMAccountName=%s,ou=Management,dc=ad,dc=example,dc=com").groupDNPatterns("cn=%s,ou=Teams,dc=ad,dc=example,dc=com").groupFilters(GROUP_TEAM1_NAME).guidKey("sAMAccountName").userMembershipKey("memberOf").build();
    ...
    {
        testCase = defaultBuilder().groupDNPatterns("cn=%s,ou=Teams,dc=ad,dc=example,dc=com").groupFilters(GROUP_TEAM1_NAME).guidKey("sAMAccountName").userMembershipKey("memberOf").build();
    ...
    {
        testCase = defaultBuilder().userDNPatterns("sAMAccountName=%s,ou=Engineering,dc=ad,dc=example,dc=com").groupDNPatterns("cn=%s,ou=Teams,dc=ad,dc=example,dc=com").groupFilters(GROUP_TEAM1_NAME).guidKey("sAMAccountName").userMembershipKey("memberOf").build();
    ...
    {
        testCase = defaultBuilder().userDNPatterns("sAMAccountName=%s,ou=Administration,dc=ad,dc=example,dc=com").groupDNPatterns("cn=%s,ou=Administration,dc=ad,dc=example,dc=com").groupFilters(GROUP_ADMINS_NAME).guidKey("sAMAccountName").userMembershipKey("memberOf").groupClassKey("groupOfUniqueNames").build();
    ...
    {
        testCase = defaultBuilder().userDNPatterns("sAMAccountName=%s,ou=Administration,dc=ad,dc=example,dc=com").groupDNPatterns("cn=%s,ou=Administration,dc=ad,dc=example,dc=com").groupFilters(GROUP_ADMINS_NAME).guidKey("sAMAccountName").userMembershipKey("memberOf").groupClassKey("wrongClass").build();
    ...
    {
        testCase = defaultBuilder().baseDN("ou=People,dc=example,dc=com").userSearchFilter("(&(|(uid={0})(sAMAccountName={0}))(objectClass=person))").guidKey("uid").build();

        testCase.assertAuthenticatePasses(USER1.credentialsWithId());
        testCase.assertAuthenticatePasses(USER2.credentialsWithId());

        testCase = defaultBuilder().baseDN("ou=Engineering,dc=ad,dc=example,dc=com").userSearchFilter("(&(|(uid={0})(sAMAccountName={0}))(objectClass=person))").guidKey("sAMAccountName").build();
    ...
    {
        testCase = defaultBuilder().baseDN("ou=Engineering,dc=ad,dc=example,dc=com").userSearchFilter("(&(sAMAccountName={0})(objectClass=person)").guidKey("uid").build();
    ...
    {
        testCase = defaultBuilder().baseDN("ou=People,dc=example,dc=com").userSearchFilter("(&(|(uid={0})(sAMAccountName={0}))(objectClass=person))").guidKey("uid").groupBaseDN("ou=Groups,dc=example,dc=com").groupSearchFilter("(&(|(member={0})(member={1}))(&(|(cn=group1)(cn=group2))(objectClass=groupOfNames)))").build();
    ...
    {
        testCase = defaultBuilder().baseDN("ou=People,dc=example,dc=com").userSearchFilter("(&(|(uid={0})(sAMAccountName={0}))(objectClass=person)").guidKey("uid").groupBaseDN("ou=Groups,dc=example,dc=com").groupSearchFilter("(&(|(member={0})(member={1}))(&(cn=group1)(objectClass=groupOfNames)))").build();
