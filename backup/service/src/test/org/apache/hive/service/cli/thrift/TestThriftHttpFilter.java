...
public class TestThriftHttpFilter
{
    ...
    {
        return Arrays.asList(new Object[][]{{HiveConf.ConfVars.HIVE_SERVER2_XSRF_FILTER_ENABLED.varname, true, ThriftHttpFilter.X_XSRF_HEADER, true, 1}, {HiveConf.ConfVars.HIVE_SERVER2_XSRF_FILTER_ENABLED.varname, true, ThriftHttpFilter.X_XSRF_HEADER, false, 0}, {HiveConf.ConfVars.HIVE_SERVER2_XSRF_FILTER_ENABLED.varname, false, ThriftHttpFilter.X_XSRF_HEADER, true, 1}, {HiveConf.ConfVars.HIVE_SERVER2_XSRF_FILTER_ENABLED.varname, false, ThriftHttpFilter.X_XSRF_HEADER, false, 1}, {HiveConf.ConfVars.HIVE_SERVER2_CSRF_FILTER_ENABLED.varname, true, ThriftHttpFilter.X_CSRF_TOKEN, true, 1}, {HiveConf.ConfVars.HIVE_SERVER2_CSRF_FILTER_ENABLED.varname, true, ThriftHttpFilter.X_CSRF_TOKEN, false, 0}, {HiveConf.ConfVars.HIVE_SERVER2_CSRF_FILTER_ENABLED.varname, false, ThriftHttpFilter.X_CSRF_TOKEN, true, 1}, {HiveConf.ConfVars.HIVE_SERVER2_CSRF_FILTER_ENABLED.varname, false, ThriftHttpFilter.X_CSRF_TOKEN, false, 1}});
    }
