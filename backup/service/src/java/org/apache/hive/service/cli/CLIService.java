...
public class CLIService extends CompositeService implements ICLIService
{
    ...
    private void setupBlockedUdfs()
    {
        ...
        FunctionRegistry.setupPermissionsForBuiltinUDFs(hiveConf.getVar(ConfVars.HIVE_SERVER2_BUILTIN_UDF_WHITELIST), hiveConf.getVar(ConfVars.HIVE_SERVER2_BUILTIN_UDF_BLACKLIST));
    }
    ...
    {
        sessionManager.createSession(sessionHandle, SERVER_VERSION, username, password, null, configuration, false, null);
    ...
    {
        return fetchResults(opHandle, Operation.DEFAULT_FETCH_ORIENTATION, defaultFetchRows, FetchType.QUERY_OUTPUT);
    }
