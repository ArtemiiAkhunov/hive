...
public interface ICLIService
{
    ...
    OperationHandle executeStatement(SessionHandle sessionHandle, String statement, Map<String, String> confOverlay, long queryTimeout) throws HiveSQLException;
    ...
    OperationHandle executeStatementAsync(SessionHandle sessionHandle, String statement, Map<String, String> confOverlay, long queryTimeout) throws HiveSQLException;
    ...
    OperationStatus getOperationStatus(OperationHandle opHandle, boolean getProgressUpdate) throws HiveSQLException;
    ...
    OperationHandle getCrossReference(SessionHandle sessionHandle, String primaryCatalog, String primarySchema, String primaryTable, String foreignCatalog, String foreignSchema, String foreignTable) throws HiveSQLException;

    void setApplicationName(SessionHandle sh, String value) throws HiveSQLException;

    OperationHandle uploadData(SessionHandle sessionHandle, ByteBuffer values, String tableName, String path) throws HiveSQLException;

    OperationHandle downloadData(SessionHandle sessionHandle, String tableName, String query, String format, Map<String, String> options) throws HiveSQLException;
}
