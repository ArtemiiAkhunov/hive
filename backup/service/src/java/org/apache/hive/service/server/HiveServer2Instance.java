...
public class HiveServer2Instance extends ServiceInstanceBase
{
    ...
    public boolean equals(final Object o)
    {
        ...
        return super.equals(o) && isLeader == other.isLeader && Objects.equals(transportMode, other.transportMode) && Objects.equals(httpEndpoint, other.httpEndpoint);
    }
    ...
    {
        String result = "instanceId: " + getWorkerIdentity() + " isLeader: " + isLeader + " host: " + getHost() + " port: " + getRpcPort() + " transportMode: " + transportMode;
