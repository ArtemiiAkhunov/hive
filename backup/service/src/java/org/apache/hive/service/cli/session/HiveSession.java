...
public interface HiveSession extends HiveSessionBase
{
     ...
     * @throws HiveSQLException
     */
    OperationHandle executeStatement(String statement, Map<String, String> confOverlay, long queryTimeout) throws HiveSQLException;
     ...
     * @throws HiveSQLException
     */
    OperationHandle executeStatementAsync(String statement, Map<String, String> confOverlay, long queryTimeout) throws HiveSQLException;
     ...
     * @throws HiveSQLException
     */
    OperationHandle getPrimaryKeys(String catalog, String schema, String table) throws HiveSQLException;
     ...
     * @throws HiveSQLException
     */
    OperationHandle getCrossReference(String primaryCatalog, String primarySchema, String primaryTable, String foreignCatalog, String foreignSchema, String foreignTable) throws HiveSQLException;
     ...
     * @throws HiveSQLException
     */
    OperationHandle uploadData(ByteBuffer values, String tableName, String path) throws HiveSQLException;
     ...
     * @throws HiveSQLException
     */
    OperationHandle downloadData(String tableName, String query, String format, Map<String, String> options) throws HiveSQLException;
