...
public class GetColumnsOperation extends MetadataOperation
{
    ...
    protected GetColumnsOperation(HiveSession parentSession, String catalogName, String schemaName, String tableName, String columnName)
    {
        ...
        LOG.info("Starting GetColumnsOperation with the following parameters: " + "catalogName={}, schemaName={}, tableName={}, columnName={}", catalogName, schemaName, tableName, columnName);
    }
            ...
            for (Entry<String, List<String>> dbTabs : db2Tabs.entrySet())
            {
                ...
                for (Table table : new TableIterable(metastoreClient, dbName, tableNames, maxBatchSize))
                {
                    ...
                    for (ColumnDescriptor column : schema.getColumnDescriptors())
                    {
                        ...
                        Object[] rowData = new Object[]{null,  // TABLE_CAT
                                ...
                                pkColNames.contains(column.getName().toLowerCase()) ? DatabaseMetaData.columnNoNulls : DatabaseMetaData.columnNullable, // NULLABLE
