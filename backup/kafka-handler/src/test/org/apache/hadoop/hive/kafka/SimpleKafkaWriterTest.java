...
public class SimpleKafkaWriterTest
{
    ...
    public void testMissingBrokerString()
    {
        new SimpleKafkaWriter("t", null, new Properties());
    }

    @Test
    public void testCheckWriterId()
    {
    ...
    @Test
    public void testSendToNoWhere() throws IOException
    {
    ...
    public void testSend() throws IOException
    {
        ...
        SimpleKafkaWriter writer = new SimpleKafkaWriter(topic, null, properties);
