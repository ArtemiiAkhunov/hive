...
public class KafkaWritable implements Writable
{
    ...
    public boolean equals(Object o)
    {
        ...
        return partition == writable.partition && offset == writable.offset && timestamp == writable.timestamp && Arrays.equals(value, writable.value) && Arrays.equals(recordKey, writable.recordKey);
    }
    ...
    {
        return "KafkaWritable{" + "partition=" + partition + ", offset=" + offset + ", timestamp=" + timestamp + ", value=" + Arrays.toString(value) + ", recordKey=" + Arrays.toString(recordKey) + '}';
    }
