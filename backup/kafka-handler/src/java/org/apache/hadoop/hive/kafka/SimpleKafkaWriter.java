...
class SimpleKafkaWriter implements FileSinkOperator.RecordWriter, RecordWriter<BytesWritable, KafkaWritable>
{
    ...
    SimpleKafkaWriter(String topic, @Nullable String writerId, Properties properties)
    {
        ...
        Preconditions.checkState(properties.getProperty(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG) != null, "set [" + ProducerConfig.BOOTSTRAP_SERVERS_CONFIG + "] property");
        ...
        LOG.info("Starting WriterId [{}], Delivery Semantic [{}], Target Kafka Topic [{}]", writerId, writeSemantic, topic);
    }
    ...
    public void close(boolean abort) throws IOException
    {
        ...
        LOG.info("Closed WriterId [{}] Delivery semantic [{}], Topic[{}], Total sent Records [{}], Total Lost Records [{}]", writerId, writeSemantic, topic, sentRecords, lostRecords.get());
        checkExceptions();
    }
