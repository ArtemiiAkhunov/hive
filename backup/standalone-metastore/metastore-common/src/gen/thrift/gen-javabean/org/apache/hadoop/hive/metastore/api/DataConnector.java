...
public class DataConnector implements org.apache.thrift.TBase<DataConnector, DataConnector._Fields>, java.io.Serializable, Cloneable, Comparable<DataConnector>
{
    ...
    {
        NAME((short) 1, "name"), TYPE((short) 2, "type"), URL((short) 3, "url"), DESCRIPTION((short) 4, "description"), PARAMETERS((short) 5, "parameters"), OWNER_NAME((short) 6, "ownerName"),
        /**
         *
         * @see PrincipalType
         */
        OWNER_TYPE((short) 7, "ownerType"), CREATE_TIME((short) 8, "createTime");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.URL, new org.apache.thrift.meta_data.FieldMetaData("url", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    public DataConnector(java.lang.String name, java.lang.String type, java.lang.String url)
    {
        this();
        this.name = name;
        this.type = type;
