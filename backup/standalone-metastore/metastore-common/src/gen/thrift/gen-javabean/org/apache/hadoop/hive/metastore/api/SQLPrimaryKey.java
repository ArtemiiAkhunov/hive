...
public class SQLPrimaryKey implements org.apache.thrift.TBase<SQLPrimaryKey, SQLPrimaryKey._Fields>, java.io.Serializable, Cloneable, Comparable<SQLPrimaryKey>
{
    ...
    {
        TABLE_DB((short) 1, "table_db"), TABLE_NAME((short) 2, "table_name"), COLUMN_NAME((short) 3, "column_name"), KEY_SEQ((short) 4, "key_seq"), PK_NAME((short) 5, "pk_name"), ENABLE_CSTR((short) 6, "enable_cstr"), VALIDATE_CSTR((short) 7, "validate_cstr"), RELY_CSTR((short) 8, "rely_cstr"), CAT_NAME((short) 9, "catName");
    ...
    public SQLPrimaryKey(java.lang.String table_db, java.lang.String table_name, java.lang.String column_name, int key_seq, java.lang.String pk_name, boolean enable_cstr, boolean validate_cstr, boolean rely_cstr)
    {
        this();
