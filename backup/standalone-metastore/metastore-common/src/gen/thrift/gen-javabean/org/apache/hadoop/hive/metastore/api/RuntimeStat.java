...
public class RuntimeStat implements org.apache.thrift.TBase<RuntimeStat, RuntimeStat._Fields>, java.io.Serializable, Cloneable, Comparable<RuntimeStat>
{
    ...
    {
        CREATE_TIME((short) 1, "createTime"), WEIGHT((short) 2, "weight"), PAYLOAD((short) 3, "payload");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.WEIGHT, new org.apache.thrift.meta_data.FieldMetaData("weight", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
        tmpMap.put(_Fields.PAYLOAD, new org.apache.thrift.meta_data.FieldMetaData("payload", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING, true)));
    ...
    public RuntimeStat(int weight, java.nio.ByteBuffer payload)
    {
        this();
        this.weight = weight;
        setWeightIsSet(true);
