...
public class PrimaryKeysRequest implements org.apache.thrift.TBase<PrimaryKeysRequest, PrimaryKeysRequest._Fields>, java.io.Serializable, Cloneable, Comparable<PrimaryKeysRequest>
{
    ...
    {
        DB_NAME((short) 1, "db_name"), TBL_NAME((short) 2, "tbl_name"), CAT_NAME((short) 3, "catName"), VALID_WRITE_ID_LIST((short) 4, "validWriteIdList"), TABLE_ID((short) 5, "tableId");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.DB_NAME, new org.apache.thrift.meta_data.FieldMetaData("db_name", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
        tmpMap.put(_Fields.TBL_NAME, new org.apache.thrift.meta_data.FieldMetaData("tbl_name", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    public PrimaryKeysRequest(java.lang.String db_name, java.lang.String tbl_name)
    {
        this();
