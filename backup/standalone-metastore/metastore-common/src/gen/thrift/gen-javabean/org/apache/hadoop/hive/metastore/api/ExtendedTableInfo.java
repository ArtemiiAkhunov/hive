...
public class ExtendedTableInfo implements org.apache.thrift.TBase<ExtendedTableInfo, ExtendedTableInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ExtendedTableInfo>
{
    ...
    {
        TBL_NAME((short) 1, "tblName"), ACCESS_TYPE((short) 2, "accessType"), REQUIRED_READ_CAPABILITIES((short) 3, "requiredReadCapabilities"), REQUIRED_WRITE_CAPABILITIES((short) 4, "requiredWriteCapabilities");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.ACCESS_TYPE, new org.apache.thrift.meta_data.FieldMetaData("accessType", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    ...
    public ExtendedTableInfo(java.lang.String tblName)
    {
        this();
