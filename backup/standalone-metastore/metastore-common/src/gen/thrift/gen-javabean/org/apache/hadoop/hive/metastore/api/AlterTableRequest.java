...
public class AlterTableRequest implements org.apache.thrift.TBase<AlterTableRequest, AlterTableRequest._Fields>, java.io.Serializable, Cloneable, Comparable<AlterTableRequest>
{
    ...
    {
        CAT_NAME((short) 1, "catName"), DB_NAME((short) 2, "dbName"), TABLE_NAME((short) 3, "tableName"), TABLE((short) 4, "table"), ENVIRONMENT_CONTEXT((short) 5, "environmentContext"), WRITE_ID((short) 6, "writeId"), VALID_WRITE_ID_LIST((short) 7, "validWriteIdList"), PROCESSOR_CAPABILITIES((short) 8, "processorCapabilities"), PROCESSOR_IDENTIFIER((short) 9, "processorIdentifier"), EXPECTED_PARAMETER_KEY((short) 10, "expectedParameterKey"), EXPECTED_PARAMETER_VALUE((short) 11, "expectedParameterValue");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.DB_NAME, new org.apache.thrift.meta_data.FieldMetaData("dbName", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
        tmpMap.put(_Fields.TABLE_NAME, new org.apache.thrift.meta_data.FieldMetaData("tableName", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
        ...
        tmpMap.put(_Fields.ENVIRONMENT_CONTEXT, new org.apache.thrift.meta_data.FieldMetaData("environmentContext", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, EnvironmentContext.class)));
        ...
        tmpMap.put(_Fields.VALID_WRITE_ID_LIST, new org.apache.thrift.meta_data.FieldMetaData("validWriteIdList", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
        ...
        tmpMap.put(_Fields.EXPECTED_PARAMETER_KEY, new org.apache.thrift.meta_data.FieldMetaData("expectedParameterKey", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
        tmpMap.put(_Fields.EXPECTED_PARAMETER_VALUE, new org.apache.thrift.meta_data.FieldMetaData("expectedParameterValue", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    public AlterTableRequest(java.lang.String dbName, java.lang.String tableName, Table table)
    {
        this();
        this.dbName = dbName;
                        ...
                        {
                            {
                                ...
                                struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list1416.size);
                                ...
                                for (int _i1418 = 0; _i1418 < _list1416.size; ++_i1418)
                                {
                                    ...
                                    struct.processorCapabilities.add(_elem1417);
                                }
                                iprot.readListEnd();
                            }
            ...
            if (struct.processorCapabilities != null)
            {
                if (struct.isSetProcessorCapabilities())
                {
                    oprot.writeFieldBegin(PROCESSOR_CAPABILITIES_FIELD_DESC);
                    {
                        ...
                        for (java.lang.String _iter1419 : struct.processorCapabilities)
                        {
            ...
            {
                {
                    ...
                    for (java.lang.String _iter1420 : struct.processorCapabilities)
                    {
            ...
            {
                {
                    ...
                    struct.processorCapabilities = new java.util.ArrayList<java.lang.String>(_list1421.size);
                    ...
                    for (int _i1423 = 0; _i1423 < _list1421.size; ++_i1423)
                    {
                        ...
                        struct.processorCapabilities.add(_elem1422);
                    }
                }
                struct.setProcessorCapabilitiesIsSet(true);
            }
