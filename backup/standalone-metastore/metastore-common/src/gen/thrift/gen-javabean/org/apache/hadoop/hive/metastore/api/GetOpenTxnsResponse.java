...
public class GetOpenTxnsResponse implements org.apache.thrift.TBase<GetOpenTxnsResponse, GetOpenTxnsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<GetOpenTxnsResponse>
{
    ...
    {
        TXN_HIGH_WATER_MARK((short) 1, "txn_high_water_mark"), OPEN_TXNS((short) 2, "open_txns"), MIN_OPEN_TXN((short) 3, "min_open_txn"), ABORTED_BITS((short) 4, "abortedBits");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.TXN_HIGH_WATER_MARK, new org.apache.thrift.meta_data.FieldMetaData("txn_high_water_mark", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
        tmpMap.put(_Fields.OPEN_TXNS, new org.apache.thrift.meta_data.FieldMetaData("open_txns", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64))));
        tmpMap.put(_Fields.MIN_OPEN_TXN, new org.apache.thrift.meta_data.FieldMetaData("min_open_txn", org.apache.thrift.TFieldRequirementType.OPTIONAL, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    ...
    public GetOpenTxnsResponse(long txn_high_water_mark, java.util.List<java.lang.Long> open_txns, java.nio.ByteBuffer abortedBits)
    {
        this();
                        ...
                        {
                            {
                                ...
                                struct.open_txns = new java.util.ArrayList<java.lang.Long>(_list780.size);
                                long _elem781;
                                for (int _i782 = 0; _i782 < _list780.size; ++_i782)
                                {
                                    _elem781 = iprot.readI64();
                                    struct.open_txns.add(_elem781);
                                }
                                iprot.readListEnd();
                            }
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, GetOpenTxnsResponse struct) throws org.apache.thrift.TException
        {
            ...
            if (struct.open_txns != null)
            {
                oprot.writeFieldBegin(OPEN_TXNS_FIELD_DESC);
                {
                    ...
                    for (long _iter783 : struct.open_txns)
                    {
    ...
    private static class GetOpenTxnsResponseTupleScheme extends org.apache.thrift.scheme.TupleScheme<GetOpenTxnsResponse>
    {
        ...
        public void write(org.apache.thrift.protocol.TProtocol prot, GetOpenTxnsResponse struct) throws org.apache.thrift.TException
        {
            ...
            oprot.writeI64(struct.txn_high_water_mark);
            {
                ...
                for (long _iter784 : struct.open_txns)
                {
        ...
        public void read(org.apache.thrift.protocol.TProtocol prot, GetOpenTxnsResponse struct) throws org.apache.thrift.TException
        {
            ...
            struct.setTxn_high_water_markIsSet(true);
            {
                ...
                struct.open_txns = new java.util.ArrayList<java.lang.Long>(_list785.size);
                long _elem786;
                for (int _i787 = 0; _i787 < _list785.size; ++_i787)
                {
                    _elem786 = iprot.readI64();
                    struct.open_txns.add(_elem786);
                }
            }
            struct.setOpen_txnsIsSet(true);
            struct.abortedBits = iprot.readBinary();
