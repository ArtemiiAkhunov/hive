...
public class ShowLocksResponse implements org.apache.thrift.TBase<ShowLocksResponse, ShowLocksResponse._Fields>, java.io.Serializable, Cloneable, Comparable<ShowLocksResponse>
{
    ...
    static
    {
        ...
        tmpMap.put(_Fields.LOCKS, new org.apache.thrift.meta_data.FieldMetaData("locks", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ShowLocksResponseElement.class))));
    ...
    public ShowLocksResponse(java.util.List<ShowLocksResponseElement> locks)
    {
        this();
        this.locks = locks;
    }
                        ...
                        {
                            {
                                ...
                                struct.locks = new java.util.ArrayList<ShowLocksResponseElement>(_list892.size);
                                @org.apache.thrift.annotation.Nullable ShowLocksResponseElement _elem893;
                                for (int _i894 = 0; _i894 < _list892.size; ++_i894)
                                {
                                    _elem893 = new ShowLocksResponseElement();
                                    _elem893.read(iprot);
                                    struct.locks.add(_elem893);
                                }
                                iprot.readListEnd();
                            }
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, ShowLocksResponse struct) throws org.apache.thrift.TException
        {
            ...
            if (struct.locks != null)
            {
                oprot.writeFieldBegin(LOCKS_FIELD_DESC);
                {
                    ...
                    for (ShowLocksResponseElement _iter895 : struct.locks)
                    {
            ...
            {
                {
                    ...
                    for (ShowLocksResponseElement _iter896 : struct.locks)
                    {
            ...
            {
                {
                    ...
                    struct.locks = new java.util.ArrayList<ShowLocksResponseElement>(_list897.size);
                    @org.apache.thrift.annotation.Nullable ShowLocksResponseElement _elem898;
                    for (int _i899 = 0; _i899 < _list897.size; ++_i899)
                    {
                        _elem898 = new ShowLocksResponseElement();
                        _elem898.read(iprot);
                        struct.locks.add(_elem898);
                    }
                }
                struct.setLocksIsSet(true);
            }
