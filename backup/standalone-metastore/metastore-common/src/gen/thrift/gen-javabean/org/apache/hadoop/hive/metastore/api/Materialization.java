...
public class Materialization implements org.apache.thrift.TBase<Materialization, Materialization._Fields>, java.io.Serializable, Cloneable, Comparable<Materialization>
{
    ...
    {
        SOURCE_TABLES_UPDATE_DELETE_MODIFIED((short) 1, "sourceTablesUpdateDeleteModified"), SOURCE_TABLES_COMPACTED((short) 2, "sourceTablesCompacted");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.SOURCE_TABLES_COMPACTED, new org.apache.thrift.meta_data.FieldMetaData("sourceTablesCompacted", org.apache.thrift.TFieldRequirementType.REQUIRED, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    ...
    public Materialization(boolean sourceTablesUpdateDeleteModified, boolean sourceTablesCompacted)
    {
        this();
