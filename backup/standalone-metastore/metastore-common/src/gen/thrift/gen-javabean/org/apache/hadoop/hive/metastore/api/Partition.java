...
public class Partition implements org.apache.thrift.TBase<Partition, Partition._Fields>, java.io.Serializable, Cloneable, Comparable<Partition>
{
    ...
    {
        VALUES((short) 1, "values"), DB_NAME((short) 2, "dbName"), TABLE_NAME((short) 3, "tableName"), CREATE_TIME((short) 4, "createTime"), LAST_ACCESS_TIME((short) 5, "lastAccessTime"), SD((short) 6, "sd"), PARAMETERS((short) 7, "parameters"), PRIVILEGES((short) 8, "privileges"), CAT_NAME((short) 9, "catName"), WRITE_ID((short) 10, "writeId"), IS_STATS_COMPLIANT((short) 11, "isStatsCompliant"), COL_STATS((short) 12, "colStats"), FILE_METADATA((short) 13, "fileMetadata");
    ...
    static
    {
        ...
        tmpMap.put(_Fields.VALUES, new org.apache.thrift.meta_data.FieldMetaData("values", org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    ...
    public Partition(java.util.List<java.lang.String> values, java.lang.String dbName, java.lang.String tableName, int createTime, int lastAccessTime, StorageDescriptor sd, java.util.Map<java.lang.String, java.lang.String> parameters)
    {
        this();
        this.values = values;
