    ...
    <div class="row">
        ...
        <section>
            ...
            <table class="table table-striped">
                ...
                %>
                <tr>
                    <td><%= hiveSession.getUserName() %>
                    </td>
                    <td><%= hiveSession.getIpAddress() %>
                    </td>
                    <td><%= hiveSession.getOpenOperationCount() %>
                    </td>
                    <td><%= (currentTime - hiveSession.getCreationTime()) / 1000 %>
                    </td>
                    <td><%= (currentTime - hiveSession.getLastAccessTime()) / 1000 %>
                    </td>
                </tr>
                <%
                    }
                %>
                <tr>
                    <td colspan="5">Total number of sessions: <%= sessionCount %>
                    </td>
                </tr>
            </table>
        </section>
        ...
        <section>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td><%= HtmlEncoder.text(operation.getQueryDisplay() == null ? "Unknown" : operation.getQueryDisplay().getQueryString()) %>
                    </td>
                    <td><%= operation.getExecutionEngine() %>
                    <td><%= operation.getState() %>
                    </td>
                    <td><%= new Date(operation.getBeginTime()) %>
                    </td>
                    <td><%= operation.getElapsedTime() / 1000 %>
                    </td>
                    <td><%= operation.getRuntime() == null ? "Not finished" : operation.getRuntime() / 1000 %>
                    </td>
                ...
                %>
                <tr>
                    <td colspan="8">Total number of queries: <%= queries %>
                    </td>
                </tr>
            </table>
        </section>
        ...
        <section>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td><%= operation.getEndTime() == null ? "In Progress" : new Date(operation.getEndTime()) %>
                    </td>
                    <td><%= operation.getRuntime() == null ? "n/a" : operation.getRuntime() / 1000 %>
                    </td>
                    <% String link = "/query_page.html?operationId=" + operation.getOperationId(); %>
                    <td><a href= <%= link %>>Drilldown</a></td>
                </tr>
        ...
        <section>
            ...
            <table class="table table-striped">
                ...
                <tr>
                    <td>Hive Version</td>
                    <td><%= HiveVersionInfo.getVersion() %>, r<%= HiveVersionInfo.getRevision() %>
                    </td>
                    <td>Hive version and revision</td>
                </tr>
                <tr>
                    <td>Hive Compiled</td>
                    <td><%= HiveVersionInfo.getDate() %>, <%= HiveVersionInfo.getUser() %>
                    </td>
                    <td>When Hive was compiled and by whom</td>
                </tr>
                <tr>
                    <td>HiveServer2 Start Time</td>
                    <td><%= new Date(startcode) %>
                    </td>
