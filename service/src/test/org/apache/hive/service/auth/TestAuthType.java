...
public class TestAuthType
{
    ...
    private void testOnePasswordAuthWithSAML(HiveAuthConstants.AuthTypes type) throws Exception
    {
        ...
        Set<HiveAuthConstants.AuthTypes> disabledAuthTypes = Arrays.stream(HiveAuthConstants.AuthTypes.values()).collect(Collectors.toSet());
    ...
    private void verify(String authTypes, HiveServer2TransportMode mode, boolean shouldThrowException)
    {
        try
        {
            ...
            } else
            {
                ...
                {
                    HiveAuthConstants.AuthTypes authMech = EnumUtils.getEnumIgnoreCase(HiveAuthConstants.AuthTypes.class, authMethods[i]);
