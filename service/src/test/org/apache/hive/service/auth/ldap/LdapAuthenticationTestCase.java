...
public final class LdapAuthenticationTestCase
{
    ...
    public static final class Builder
    {
        ...
        {
            return setVarOnce(HiveConf.ConfVars.HIVE_SERVER2_PLAIN_LDAP_USERSEARCHFILTER, userSearchFilter);
        }

        public Builder groupSearchFilter(String groupSearchFilter)
        {
            return setVarOnce(HiveConf.ConfVars.HIVE_SERVER2_PLAIN_LDAP_GROUPSEARCHFILTER, groupSearchFilter);
        }

        public Builder groupBaseDN(String groupBaseDN)
        {
            return setVarOnce(HiveConf.ConfVars.HIVE_SERVER2_PLAIN_LDAP_GROUPBASEDN, groupBaseDN);
        }
