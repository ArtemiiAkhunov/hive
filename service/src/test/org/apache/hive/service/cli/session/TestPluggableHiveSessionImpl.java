...
public class TestPluggableHiveSessionImpl
{
    ...
    public static class SampleHiveSessionImpl extends HiveSessionImpl
    {
        ...
        public SampleHiveSessionImpl(SessionHandle sessionHandle, TProtocolVersion protocol, String username, String password, HiveConf serverhiveConf, String ipAddress, List<String> forwardAddresses)
        {
    ...
    public static class SampleHiveSessionImplWithUGI extends HiveSessionImplwithUGI
    {
        ...
        public SampleHiveSessionImplWithUGI(SessionHandle sessionHandle, TProtocolVersion protocol, String username, String password, HiveConf serverhiveConf, String ipAddress, String delegationToken, List<String> forwardedAddresses) throws HiveSQLException
        {
            super(sessionHandle, protocol, username, password, serverhiveConf, ipAddress, delegationToken, forwardedAddresses);
        }
