...
public abstract class AbstractService implements Service
{
    ...
    {
        if (state == STATE.STOPPED || state == STATE.INITED || state == STATE.NOTINITED || state == STATE.DECOMMISSIONING)
        {
            return;
        }
    ...
    public synchronized void stop()
    {
        ...
        {
            throw new IllegalStateException("For stop operation, the current service state must be " + STATE.DECOMMISSIONING + " or " + STATE.STARTED + " instead of " + state);
        }
