...
public final class Query
{
    ...
    public static final class QueryBuilder
    {
        ...
        {
            Preconditions.checkArgument(filterTemplate != null, "filter is required for LDAP search query");
        }
        ...
        private void updateControls()
        {
            ...
            {
                controls.setReturningAttributes(returningAttributes.toArray(new String[returningAttributes.size()]));
            }
        }
