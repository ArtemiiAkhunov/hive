...
public abstract class ExecuteStatementOperation extends Operation
{
    ...
    public static ExecuteStatementOperation newExecuteStatementOperation(HiveSession parentSession, String statement, Map<String, String> confOverlay, boolean runAsync, long queryTimeout) throws HiveSQLException
    {
        ...
        if (proceduralMode(confOverlay) && hplSqlMode())
        {
            ...
            {
                Exec interpreter = new Exec(new Conf(), new BeelineConsole(), new HplSqlQueryExecutor(parentSession), parentSession.getMetaStoreClient(), new HiveHplSqlSessionState(SessionState.get()));
