...
public class GetFunctionsOperation extends MetadataOperation
{
    ...
    public GetFunctionsOperation(HiveSession parentSession, String catalogName, String schemaName, String functionName)
    {
        ...
        LOG.info("Starting GetFunctionsOperation with the following parameters: catalogName={}, schemaName={}, functionName={}", catalogName, schemaName, functionName);
    }
        ...
        try
        {
            if ((null == catalogName || "".equals(catalogName)) && (null == schemaName || "".equals(schemaName)))
            {
                ...
                for (String functionName : functionNames)
                {
                    ...
                    Object rowData[] = new Object[]{null, // FUNCTION_CAT
                            null, // FUNCTION_SCHEM
                            functionInfo.getDisplayName(), // FUNCTION_NAME
                            "", // REMARKS
                            (functionInfo.isGenericUDTF() ? DatabaseMetaData.functionReturnsTable : DatabaseMetaData.functionNoTable), // FUNCTION_TYPE
