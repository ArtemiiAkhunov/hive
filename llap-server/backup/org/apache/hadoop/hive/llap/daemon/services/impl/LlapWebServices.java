...
public class LlapWebServices extends AbstractService
{
    ...
    public void serviceInit(Configuration conf)
    {
        ...
        if (conf.getBoolean(ConfVars.LLAP_DAEMON_WEB_XFRAME_ENABLED.varname, ConfVars.LLAP_DAEMON_WEB_XFRAME_ENABLED.defaultBoolVal))
        {
            builder.configureXFrame(true).setXFrameOption(conf.get(ConfVars.LLAP_DAEMON_WEB_XFRAME_VALUE.varname, ConfVars.LLAP_DAEMON_WEB_XFRAME_VALUE.defaultStrVal));
        }
        if (UserGroupInformation.isSecurityEnabled())
        {
            ...
            if (this.useSPNEGO)
            {
                ...
                builder.setSPNEGOPrincipal(HiveConf.getVar(conf, ConfVars.LLAP_WEBUI_SPNEGO_PRINCIPAL, HiveConf.getVar(conf, ConfVars.LLAP_KERBEROS_PRINCIPAL)));
                builder.setSPNEGOKeytab(HiveConf.getVar(conf, ConfVars.LLAP_WEBUI_SPNEGO_KEYTAB_FILE, HiveConf.getVar(conf, ConfVars.LLAP_KERBEROS_KEYTAB_FILE)));
            }
        }
