...
public class FunctionLocalizer implements GenericUDFBridge.UdfWhitelistChecker
{
    ...
    public FunctionLocalizer(Configuration conf, String localDir)
    {
        ...
        AddToClassPathAction addAction = new AddToClassPathAction(TezClassLoader.getInstance(), Collections.emptyList(), true);
    ...
    {
        void run(FunctionLocalizer parent) throws URISyntaxException, IOException, InterruptedException;
    }
