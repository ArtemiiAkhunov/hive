...
public class QueryInfo
{
    ...
    private final Set<QueryFragmentInfo> knownFragments = Collections.newSetFromMap(new ConcurrentHashMap<QueryFragmentInfo, Boolean>());
    ...
    public QueryInfo(QueryIdentifier queryIdentifier, String appIdString, String dagIdString, String dagName, String hiveQueryIdString, int dagIdentifier, String user, ConcurrentMap<String, SourceStateProto> sourceStateMap, String[] localDirsBase, FileSystem localFs, String tokenUserName, String tokenAppId, final LlapNodeId amNodeId, String tokenIdentifier, Token<JobTokenIdentifier> appToken, boolean isExternalQuery, ContainerRunnerImpl.UgiPool ugiPool)
    {
    ...
    public QueryFragmentInfo registerFragment(String vertexName, int fragmentNumber, int attemptNumber, SignableVertexSpec vertexSpec, String fragmentIdString)
    {
        ...
        if (!wasUniqueFragment)
        {
            ...
            String message = "Fragment " + fragmentIdString + "(isExternal=" + isExternalQuery() + ") has already been registered.";
    ...
    {
        return finishableStateTracker.registerForUpdates(handler, sources, fragmentInfo, lastFinishableState);
    }
