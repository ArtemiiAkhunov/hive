...
public class EvictingPriorityBlockingQueue<E>
{
    ...
    private void offerToDequeueInternal(E e)
    {
        ...
        if (!result)
        {
            LOG.error("Failed to insert element into queue with capacity available. size={}, element={}", size(), e);
    ...
    public synchronized String toString()
    {
        ...
        sb.append("currentSize=").append(size()).append(", queue=").append(deque.toString());
        return sb.toString();
    }
}
