...
class IndexCache
{
     ...
     * @throws IOException
     */
    public TezIndexRecord getIndexInformation(String mapId, int reduce, Path fileName, String expectedIndexOwner) throws IOException
    {
    ...
    private static class IndexInformation
    {
        ...
        int getSize()
        {
            return mapSpillRecord == null ? 0 : mapSpillRecord.size() * Constants.MAP_OUTPUT_INDEX_RECORD_LENGTH;
        }
    }
}
