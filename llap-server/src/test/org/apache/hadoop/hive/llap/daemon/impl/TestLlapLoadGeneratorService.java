...
public class TestLlapLoadGeneratorService
{
    ...
    public void testLoadGeneratorStops() throws InterruptedException, UnknownHostException
    {
        ...
        HiveConf.setVar(conf, HiveConf.ConfVars.HIVE_TEST_LOAD_HOSTNAMES, InetAddress.getLocalHost().getHostName() + ",???");
        ...
        service.init(conf);
        service.start();
        assertEquals("The number of threads is not correct", Runtime.getRuntime().availableProcessors(), service.threads.length);
