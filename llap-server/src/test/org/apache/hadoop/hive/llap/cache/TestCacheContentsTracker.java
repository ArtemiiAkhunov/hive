...
public class TestCacheContentsTracker
{
    ...
    public void testCacheTagComparison()
    {
        ...
        compareViceVersa(0, cacheTagBuilder("dbname.tablename"), cacheTagBuilder("dbname.tablename"));
        ...
        compareViceVersa(1, cacheTagBuilder("dbname.tablename", "p1=v1"), cacheTagBuilder("dbname.tablename"));
    ...
    {
        tracker.cache(createMockBuffer(4 * 1024L, cacheTagBuilder("default.testtable")), null);
        tracker.cache(createMockBuffer(2 * 1024L, cacheTagBuilder("otherdb.testtable", "p=v1", "pp=vv1")), null);
        tracker.cache(createMockBuffer(32 * 1024L, cacheTagBuilder("otherdb.testtable", "p=v1", "pp=vv1")), null);
        tracker.cache(createMockBuffer(64 * 1024L, cacheTagBuilder("otherdb.testtable", "p=v1", "pp=vv2")), null);
        tracker.cache(createMockBuffer(128 * 1024L, cacheTagBuilder("otherdb.testtable", "p=v2", "pp=vv1")), null);
        tracker.cache(createMockBuffer(256 * 1024L, cacheTagBuilder("otherdb.testtable2", "p=v3")), null);
        tracker.cache(createMockBuffer(512 * 1024 * 1024L, cacheTagBuilder("otherdb.testtable2", "p=v3")), null);
        tracker.cache(createMockBuffer(1024 * 1024 * 1024L, cacheTagBuilder("otherdb.testtable3")), null);
        tracker.cache(createMockBuffer(2 * 1024 * 1024L, cacheTagBuilder("default.testtable")), null);
    }

    private static void evictSomeTestBuffers()
    {
        tracker.notifyEvicted(createMockBuffer(32 * 1024L, cacheTagBuilder("otherdb.testtable", "p=v1", "pp=vv1")));
        tracker.notifyEvicted(createMockBuffer(512 * 1024 * 1024L, cacheTagBuilder("otherdb.testtable2", "p=v3")));
        tracker.notifyEvicted(createMockBuffer(2 * 1024 * 1024L, cacheTagBuilder("default.testtable")));
        tracker.notifyEvicted(createMockBuffer(4 * 1024L, cacheTagBuilder("default.testtable")));
    }
