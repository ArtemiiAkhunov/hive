...
public class LlapRecordReaderQueueSizeTest
{
    ...
    public void testOrderDecimal64VsLong()
    {
        ...
        int[] colsProjected = IntStream.range(0, 300).toArray();
        Assert.assertEquals(LlapRecordReader.determineQueueLimit(MAX_BUFFERED_SIZE, 10000, 5, longCols, colsProjected, true), LlapRecordReader.determineQueueLimit(MAX_BUFFERED_SIZE, 10000, 5, decimalCols, colsProjected, true));
    }
