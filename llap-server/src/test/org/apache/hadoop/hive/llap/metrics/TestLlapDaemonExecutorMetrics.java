...
public class TestLlapDaemonExecutorMetrics
{
    ...
    {
        TimedAverageMetrics metrics = new TimedAverageMetrics(10, 6 * 1000 * 1000);
    ...
    public void testTimedAverageMetricsBigData()
    {
        ...
        TimedAverageMetrics metrics = generateTimedAverageMetrics(15000, 10L * 60L * 1000L * 1000L * 1000L, 20000, -5000, 1, currentTime, 50L * 1000L * 1000L);
    ...
    public void testSimpleAndDerivedMetricsCalculations()
    {
        ...
        LlapDaemonExecutorMetrics metrics = LlapDaemonExecutorMetrics.create("test", "test", numExecutorsConfigured, waitQueueSizeConfigured, new int[]{1}, 1, 1, 1);
    ...
    private TimedAverageMetrics generateTimedAverageMetrics(int windowDataSize, long windowTimeSize, int dataNum, long firstData, long dataDelta, long firstTime, long timeDelta)
    {
        TimedAverageMetrics metrics = new TimedAverageMetrics(windowDataSize, windowTimeSize, firstTime - windowTimeSize);
