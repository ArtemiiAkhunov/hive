...
public final class LlapIoMocks
{
    ...
    public static final class MockDataCache implements DataCache, Allocator.BufferObjectFactory
    {
        ...
        {
            return data != null ? cache.putFileData(fileKey, ranges, data, baseOffset, LowLevelCache.Priority.NORMAL, null, null) : null;
        }
        ...
        {
            return data != null ? cache.putFileData(fileKey, ranges, data, baseOffset, LowLevelCache.Priority.NORMAL, null, tag) : null;
        }
    }
