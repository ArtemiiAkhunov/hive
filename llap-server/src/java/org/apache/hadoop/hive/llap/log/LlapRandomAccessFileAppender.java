...
public final class LlapRandomAccessFileAppender extends AbstractOutputStreamAppender<RandomAccessFileManager>
{
    ...
    protected LlapRandomAccessFileAppender(String name, Layout<? extends Serializable> layout, Filter filter, boolean ignoreExceptions, boolean immediateFlush, Property[] properties, RandomAccessFileManager manager)
    {
     ...
     */
    public static class Builder<B extends LlapRandomAccessFileAppender.Builder<B>> extends AbstractOutputStreamAppender.Builder<B> implements org.apache.logging.log4j.core.util.Builder<LlapRandomAccessFileAppender>
    {
        ...
        public LlapRandomAccessFileAppender build()
        {
            ...
            final RandomAccessFileManager manager = RandomAccessFileManager.getFileManager(fileName, append, immediateFlush, getBufferSize(), null, layout, null);
            if (manager == null)
            {
                return null;
            }

            return new LlapRandomAccessFileAppender(name, layout, getFilter(), isIgnoreExceptions(), immediateFlush, getPropertyArray(), manager);
        }
