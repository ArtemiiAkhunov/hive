...
public class LlapServiceDriver
{
    ...
    private int run() throws Exception
    {
        ...
        try
        {
            ...
            LlapTarComponentGatherer tarComponentGatherer = new LlapTarComponentGatherer(cl, conf, propsDirectOptions, fs, rawFs, executor, tmpDir);
            ...
            LlapConfigJsonCreator lcjCreator = new LlapConfigJsonCreator(conf, rawFs, tmpDir, cl.getCache(), cl.getXmx(), javaHome);
    ...
    private void startCluster(Configuration conf, String name, String packageName, Path packageDir, String queue)
    {
        ...
        try
        {
            ...
            String llapPackageDir = HiveConf.getVar(conf, HiveConf.ConfVars.LLAP_HDFS_PACKAGE_DIR) + LLAP_RELATIVE_PACKAGE_DIR;
