...
public final class SynchronizedMetaStoreClient
{
    ...
    public synchronized void alter_partition(String catName, String dbName, String tblName, Partition newPart, EnvironmentContext environmentContext, String writeIdList) throws TException
    {
        client.alter_partition(catName, dbName, tblName, newPart, environmentContext, writeIdList);
    }

    public void alter_partitions(String catName, String dbName, String tblName, List<Partition> partitions, EnvironmentContext environmentContext, String writeIdList, long writeId) throws TException
    {
        client.alter_partitions(catName, dbName, tblName, partitions, environmentContext, writeIdList, writeId);
    }
