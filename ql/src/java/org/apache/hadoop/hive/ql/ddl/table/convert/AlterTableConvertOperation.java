...
public class AlterTableConvertOperation extends AbstractAlterTableOperation<AlterTableConvertDesc>
{
    ...
    {
        ICEBERG(ImmutableMap.of(META_TABLE_STORAGE, "org.apache.iceberg.mr.hive.HiveIcebergStorageHandler")), ACID(ImmutableMap.of(TABLE_IS_TRANSACTIONAL, "true", TABLE_TRANSACTIONAL_PROPERTIES, DEFAULT_TRANSACTIONAL_PROPERTY));
