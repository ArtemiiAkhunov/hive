    ...
    public ErrorAndSolution getErrorAndSolution()
    {
        ...
        if (getQueryMatches() && configMatches)
        {
            ...
            if (matchingLines.size() > 0)
            {
                ...
                float confValue = HiveConf.getFloatVar(getConf(), HiveConf.ConfVars.HIVE_MAP_AGGR_HASH_MEMORY);
