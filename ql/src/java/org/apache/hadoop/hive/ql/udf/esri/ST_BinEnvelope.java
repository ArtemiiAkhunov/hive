...
public class ST_BinEnvelope extends GenericUDF
{
    ...
    private boolean isPrimitiveNumber(ObjectInspector oi)
    {
        ...
        return EnumSet.of(PrimitiveCategory.DOUBLE, PrimitiveCategory.INT, PrimitiveCategory.LONG, PrimitiveCategory.SHORT, PrimitiveCategory.FLOAT, PrimitiveCategory.DECIMAL).contains(((PrimitiveObjectInspector) oi).getPrimitiveCategory());
    }
