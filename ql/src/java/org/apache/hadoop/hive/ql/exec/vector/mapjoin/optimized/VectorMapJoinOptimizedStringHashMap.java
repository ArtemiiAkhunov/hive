...
public class VectorMapJoinOptimizedStringHashMap extends VectorMapJoinOptimizedHashMap implements VectorMapJoinBytesHashMap
{
    ...
    private static class NonMatchedStringHashMapIterator extends NonMatchedBytesHashMapIterator
    {
        ...
        public void init()
        {
            ...
            keyBinarySortableDeserializeRead = BinarySortableDeserializeRead.with(typeInfos, false, this.hashMap.stringCommon.getTableDesc().getProperties());
        }
    ...
    @Override
    public JoinResult lookup(byte[] keyBytes, int keyStart, int keyLength, VectorMapJoinHashMapResult hashMapResult) throws IOException
    {
    ...
    @Override
    public JoinResult lookup(byte[] keyBytes, int keyStart, int keyLength, VectorMapJoinHashMapResult hashMapResult, MatchTracker matchTracker) throws IOException
    {
    ...
    public VectorMapJoinOptimizedStringHashMap(boolean isOuterJoin, MapJoinTableContainer originalTableContainer, ReusableGetAdaptor hashMapRowGetter, TableDesc tableDesc)
    {
