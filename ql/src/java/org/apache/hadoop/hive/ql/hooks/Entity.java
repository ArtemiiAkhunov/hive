...
public class Entity implements Serializable
{
     ...
     *
     * @param database Database that is read or written to.
     * @param complete Means the database is target, not for table or partition, etc.
     */
     ...
     *
     * @param dataconnector Database that is read or written to.
     * @param complete      Means the dataconnector is target
     */
     ...
     *
     * @param name Used for service that action is being authorized on.
     ...
     *
     * @param t Table that is read or written to.
     */
     ...
     *
     * @param p Partition that is read or written to.
     */
     ...
     *
     * @param f Function that is read or written to.
     */
