...
public class SessionStateUtil
{
    ...
    {
        getQueryState(conf).orElseThrow(() -> new IllegalStateException("Query state is missing; failed to add resource for " + key)).addResource(key, resource);
    }
     ...
     */
    public static boolean addCommitInfo(Configuration conf, String tableName, String jobId, int taskNum, Map<String, String> additionalProps)
    {
