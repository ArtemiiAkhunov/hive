...
@Description(name = "rank", value = "_FUNC_(x) NTILE allows easy calculation of tertiles, quartiles, deciles and other " + "common summary statistics. This function divides an ordered partition into a " + "specified number of groups called buckets and assigns a bucket number to each row " + "in the partition.")
