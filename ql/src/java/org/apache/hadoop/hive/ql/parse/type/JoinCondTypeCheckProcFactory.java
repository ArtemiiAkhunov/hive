...
public class JoinCondTypeCheckProcFactory<T> extends TypeCheckProcFactory<T>
{
    ...
    public class JoinCondColumnExprProcessor extends ColumnExprProcessor
    {
        ...
        public Object process(Node nd, Stack<Node> stack, NodeProcessorCtx procCtx, Object... nodeOutputs) throws SemanticException
        {
            ...
            } else
            {
                ...
                throw new SemanticException(ASTErrorUtils.getMsg(ErrorMsg.INVALID_TABLE_ALIAS.getMsg(), expr));
            }
        }
        ...
        private boolean hasTableAlias(JoinTypeCheckCtx ctx, String tabName, ASTNode expr) throws SemanticException
        {
            ...
            if (tblAliasCnt > 1)
            {
                throw new SemanticException(ASTErrorUtils.getMsg(ErrorMsg.AMBIGUOUS_TABLE_OR_COLUMN.getMsg(), expr));
            }
    ...
    protected class JoinCondDefaultExprProcessor extends DefaultExprProcessor
    {
        ...
        protected T processQualifiedColRef(TypeCheckCtx ctx, ASTNode expr, Object... nodeOutputs) throws SemanticException
        {
            ...
            ColumnInfo colInfo = getColInfo((JoinTypeCheckCtx) ctx, tableAlias, exprFactory.getConstantValueAsString((T) nodeOutputs[1]), expr);
