...
/**
 * DDL task description for ALTER TABLE ... ARCHIVE [PARTITION ...] commands.
 */
@Explain(displayName = "Archive", explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED})
public class AlterTableArchiveDesc implements DDLDesc
{
    private final String tableName;
    private final Map<String, String> partitionSpec;

    public AlterTableArchiveDesc(String tableName, Map<String, String> partitionSpec)
    {
