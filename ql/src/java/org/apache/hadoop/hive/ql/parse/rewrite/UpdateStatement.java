...
public class UpdateStatement extends DeleteStatement
{
    ...
    public UpdateStatement(Table targetTable, ASTNode whereTree, ASTNode setClauseTree, Map<String, ASTNode> setCols, Map<String, String> colNameToDefaultConstraint)
    {
        super(targetTable, whereTree);
