...
public class VectorPTFDesc extends AbstractVectorDesc
{
    ...
    {
        ROW_NUMBER, RANK, DENSE_RANK, MIN, MAX, SUM, AVG, FIRST_VALUE, LAST_VALUE, COUNT(true), LEAD, LAG;
    ...
    public static HashMap<String, SupportedFunctionType> supportedFunctionsMap = new HashMap<String, SupportedFunctionType>();
