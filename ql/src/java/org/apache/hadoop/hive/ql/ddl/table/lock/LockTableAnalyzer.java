 ...
 */
@DDLType(types = HiveParser.TOK_LOCKTABLE)
public class LockTableAnalyzer extends BaseSemanticAnalyzer
{
    ...
    public void analyzeInternal(ASTNode root) throws SemanticException
    {
        ...
        LockTableDesc desc = new LockTableDesc(tableName, mode, partitionSpec, HiveConf.getVar(conf, ConfVars.HIVE_QUERY_ID), ctx.getCmd());
