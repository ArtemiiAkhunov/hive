...
public class CastLongToDecimal64 extends VectorExpression
{
    ...
    public VectorExpressionDescriptor.Descriptor getDescriptor()
    {
        ...
        b.setMode(VectorExpressionDescriptor.Mode.PROJECTION).setNumArguments(1).setArgumentTypes(VectorExpressionDescriptor.ArgumentType.INT_FAMILY).setInputExpressionTypes(VectorExpressionDescriptor.InputExpressionType.COLUMN);
        return b.build();
    }
