...
public final class HiveSortExchange extends SortExchange implements HiveRelNode
{
    ...
    private static RelTraitSet getTraitSet(RelOptCluster cluster, RelCollation collation, RelDistribution distribution)
    {
    ...
    {
        return new HiveSortExchange(getCluster(), traitSet, newInput, newDistribution, newCollation, keys);
    }
