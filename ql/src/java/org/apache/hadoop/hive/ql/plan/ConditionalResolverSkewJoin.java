...
public class ConditionalResolverSkewJoin implements ConditionalResolver, Serializable
{
    ...
    public static class ConditionalResolverSkewJoinCtx implements Serializable
    {
        ...
        public ConditionalResolverSkewJoinCtx(HashMap<Path, Task<?>> dirToTaskMap, List<Task<?>> noSkewTask)
        {
            super();
        ...
        public void setDirToTaskMap(HashMap<Path, Task<?>> dirToTaskMap)
        {
            this.dirToTaskMap = dirToTaskMap;
        }
    ...
    public List<Task<?>> getTasks(HiveConf conf, Object objCtx)
    {
        ...
        Map<Path, Task<?>> dirToTaskMap = ctx.getDirToTaskMap();
        Iterator<Entry<Path, Task<?>>> bigKeysPathsIter = dirToTaskMap.entrySet().iterator();
        try
        {
