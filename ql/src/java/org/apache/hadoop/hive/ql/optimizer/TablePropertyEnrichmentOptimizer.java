...
class TablePropertyEnrichmentOptimizer extends Transform
{
    ...
    private static class WalkerCtx implements NodeProcessorCtx
    {
        ...
        {
            this.conf = conf;
            serdeClassesUnderConsideration.addAll(Arrays.asList(HiveConf.getVar(conf, HiveConf.ConfVars.HIVE_OPTIMIZE_TABLE_PROPERTIES_FROM_SERDE_LIST).split(",")));
    ...
    private static class Processor implements SemanticNodeProcessor
    {
        ...
        public Object process(Node nd, Stack<Node> stack, NodeProcessorCtx procCtx, Object... nodeOutputs) throws SemanticException
        {
            ...
            try
            {
                ...
                AbstractSerDe serDe = ReflectionUtil.newInstance(context.conf.getClassByName(deserializerClassName).asSubclass(AbstractSerDe.class), context.conf);
