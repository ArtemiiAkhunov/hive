...
public class GenericUDAFComputeBitVectorFMSketch extends GenericUDAFComputeBitVectorBase
{
    ...
    public GenericUDAFEvaluator getEvaluator(TypeInfo[] parameters) throws SemanticException
    {
        ...
        {
            throw new UDFArgumentTypeException(parameters.length - 1, "Exactly 2 (col + #bitvectors) arguments are expected.");
        }
    ...
    public static abstract class NumericStatsEvaluator<V, OI extends PrimitiveObjectInspector> extends NumericStatsEvaluatorBase
    {
        ...
        public void iterate(AggregationBuffer agg, Object[] parameters) throws HiveException
        {
            ...
            if (myagg.numDV == null)
            {
                ...
                if (parameters.length == 2)
                {
                    numVectors = parameters[1] == null ? 0 : PrimitiveObjectInspectorUtils.getInt(parameters[1], numVectorsOI);
