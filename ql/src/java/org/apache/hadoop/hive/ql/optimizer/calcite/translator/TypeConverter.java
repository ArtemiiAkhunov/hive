...
public class TypeConverter
{
    ...
    static
    {
        ...
        b.put(SqlTypeName.INTERVAL_YEAR.getName(), new HiveToken(HiveParser.Identifier, serdeConstants.INTERVAL_YEAR_MONTH_TYPE_NAME));
        b.put(SqlTypeName.INTERVAL_MONTH.getName(), new HiveToken(HiveParser.Identifier, serdeConstants.INTERVAL_YEAR_MONTH_TYPE_NAME));
        b.put(SqlTypeName.INTERVAL_YEAR_MONTH.getName(), new HiveToken(HiveParser.Identifier, serdeConstants.INTERVAL_YEAR_MONTH_TYPE_NAME));
        b.put(SqlTypeName.INTERVAL_DAY.getName(), new HiveToken(HiveParser.Identifier, serdeConstants.INTERVAL_DAY_TIME_TYPE_NAME));
        b.put(SqlTypeName.INTERVAL_DAY_HOUR.getName(), new HiveToken(HiveParser.Identifier, serdeConstants.INTERVAL_DAY_TIME_TYPE_NAME));
        b.put(SqlTypeName.INTERVAL_DAY_MINUTE.getName(), new HiveToken(HiveParser.Identifier, serdeConstants.INTERVAL_DAY_TIME_TYPE_NAME));
        b.put(SqlTypeName.INTERVAL_DAY_SECOND.getName(), new HiveToken(HiveParser.Identifier, serdeConstants.INTERVAL_DAY_TIME_TYPE_NAME));
        b.put(SqlTypeName.INTERVAL_HOUR.getName(), new HiveToken(HiveParser.Identifier, serdeConstants.INTERVAL_DAY_TIME_TYPE_NAME));
        b.put(SqlTypeName.INTERVAL_HOUR_MINUTE.getName(), new HiveToken(HiveParser.Identifier, serdeConstants.INTERVAL_DAY_TIME_TYPE_NAME));
        b.put(SqlTypeName.INTERVAL_HOUR_SECOND.getName(), new HiveToken(HiveParser.Identifier, serdeConstants.INTERVAL_DAY_TIME_TYPE_NAME));
        b.put(SqlTypeName.INTERVAL_MINUTE.getName(), new HiveToken(HiveParser.Identifier, serdeConstants.INTERVAL_DAY_TIME_TYPE_NAME));
        b.put(SqlTypeName.INTERVAL_MINUTE_SECOND.getName(), new HiveToken(HiveParser.Identifier, serdeConstants.INTERVAL_DAY_TIME_TYPE_NAME));
        b.put(SqlTypeName.INTERVAL_SECOND.getName(), new HiveToken(HiveParser.Identifier, serdeConstants.INTERVAL_DAY_TIME_TYPE_NAME));
    ...
    public static RelDataType convert(TypeInfo type, boolean nullable, RelDataTypeFactory dtFactory) throws CalciteSemanticException
    {
    ...
    public static RelDataType convert(StructTypeInfo structType, final RelDataTypeFactory dtFactory) throws CalciteSemanticException
    {
    ...
    public static HiveToken hiveToken(RelDataType calciteType)
    {
        ...
        switch (calciteType.getSqlTypeName())
        {
            ...
            case VARCHAR:
            {
                ...
                {
                    ht = new HiveToken(HiveParser.TOK_STRING, "TOK_STRING", String.valueOf(calciteType.getPrecision()));
                } else
                {
                    ht = new HiveToken(HiveParser.TOK_VARCHAR, "TOK_VARCHAR", String.valueOf(calciteType.getPrecision()));
                }
            }
            break;
            case DECIMAL:
            {
                ht = new HiveToken(HiveParser.TOK_DECIMAL, "TOK_DECIMAL", String.valueOf(calciteType.getPrecision()), String.valueOf(calciteType.getScale()));
            }
            break;
            case TIMESTAMP_WITH_LOCAL_TIME_ZONE:
            {
