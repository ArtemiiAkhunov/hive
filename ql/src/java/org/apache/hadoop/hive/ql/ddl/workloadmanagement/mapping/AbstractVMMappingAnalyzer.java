...
public abstract class AbstractVMMappingAnalyzer extends BaseSemanticAnalyzer
{
    ...
    public void analyzeInternal(ASTNode root) throws SemanticException
    {
        ...
        String poolPath = root.getChild(3).getType() == HiveParser.TOK_UNMANAGED ? null : WMUtils.poolPath(root.getChild(3)); // Null path => unmanaged
    ...
    protected abstract DDLDesc getDesc(String resourcePlanName, String entityType, String entityName, String poolPath, Integer ordering);
}
