...
public class LineageCtx implements NodeProcessorCtx
{
    ...
    public static class Index implements Serializable
    {
        ...
        public Index()
        {
            depMap = new LinkedHashMap<Operator<? extends OperatorDesc>, Map<ColumnInfo, Dependency>>();
            condMap = new HashMap<Operator<? extends OperatorDesc>, Set<Predicate>>();
            finalSelectOps = new LinkedHashMap<String, Pair<SelectOperator, Table>>();
        }
         ...
         */
        public Dependency getDependency(Operator<? extends OperatorDesc> op, ColumnInfo col)
        {
         ...
         * null if no dependency is found.
         */
        public Dependency getDependency(Operator<? extends OperatorDesc> op, String internalName)
        {
            Map<ColumnInfo, Dependency> colMap = depMap.get(op);
            if (colMap != null)
            {
         ...
         */
        public void putDependency(Operator<? extends OperatorDesc> op, ColumnInfo col, Dependency dep)
        {
            Map<ColumnInfo, Dependency> colMap = depMap.get(op);
            if (colMap == null)
            {
         ...
         */
        public void mergeDependency(Operator<? extends OperatorDesc> op, ColumnInfo ci, Dependency dep)
        {
