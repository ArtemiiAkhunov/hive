...
public class AlterResourcePlanEnableDesc implements DDLDesc, Serializable
{
    ...
    @Explain(displayName = "Enable", explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED}, displayOnlyOnTrue = true)
    public boolean isEnable()
    {
        return enable;
    }

    @Explain(displayName = "Activate", explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED}, displayOnlyOnTrue = true)
    public boolean isActivate()
    {
        return activate;
    }

    @Explain(displayName = "Replace", explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED}, displayOnlyOnTrue = true)
