...
public enum RewriteAlgorithm
{
    ...
    public static final Predicate<Set<RewriteAlgorithm>> ANY = rewriteAlgorithms -> true;
    public static final Predicate<Set<RewriteAlgorithm>> NON_CALCITE = rewriteAlgorithms -> !rewriteAlgorithms.contains(CALCITE);
}
