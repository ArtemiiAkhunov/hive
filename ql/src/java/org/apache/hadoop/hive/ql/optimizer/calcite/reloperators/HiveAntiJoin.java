...
public class HiveAntiJoin extends Join implements HiveRelNode
{
    ...
    public static HiveAntiJoin getAntiJoin(RelOptCluster cluster, RelTraitSet traitSet, RelNode left, RelNode right, RexNode condition)
    {
        try
        {
    ...
    protected HiveAntiJoin(RelOptCluster cluster, RelTraitSet traitSet, RelNode left, RelNode right, RexNode condition) throws CalciteSemanticException
    {
