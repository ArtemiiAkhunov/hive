...
public class HivePlannerContext implements Context
{
    ...
    public HivePlannerContext(HiveAlgorithmsConf algoConfig, HiveRulesRegistry registry, CalciteConnectionConfig calciteConfig, HiveConfPlannerContext isCorrelatedColumns, StatsSource statsSource)
    {
