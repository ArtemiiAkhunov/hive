...
abstract class HiveTxnManagerImpl implements HiveTxnManager, Configurable
{
    ...
    public int lockTable(Hive db, LockTableDesc lockTbl) throws HiveException
    {
        ...
        HiveLockObjectData lockData = new HiveLockObjectData(lockTbl.getQueryId(), String.valueOf(System.currentTimeMillis()), "EXPLICIT", lockTbl.getQueryStr(), conf);
    ...
    public int lockDatabase(Hive hiveDB, LockDatabaseDesc lockDb) throws HiveException
    {
        ...
        HiveLockObjectData lockData = new HiveLockObjectData(lockDb.getQueryId(), String.valueOf(System.currentTimeMillis()), "EXPLICIT", lockDb.getQueryStr(), conf);
