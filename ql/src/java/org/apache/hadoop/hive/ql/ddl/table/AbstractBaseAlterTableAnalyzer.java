...
public abstract class AbstractBaseAlterTableAnalyzer extends BaseSemanticAnalyzer
{
    ...
    protected void addInputsOutputsAlterTable(TableName tableName, Map<String, String> partitionSpec, AbstractAlterTableDesc desc, AlterTableType op, boolean doForceExclusive) throws SemanticException
    {
        ...
        WriteEntity.WriteType writeType = doForceExclusive ? WriteType.DDL_EXCLUSIVE : determineAlterTableWriteType(table, desc, op);
    ...
    protected void validateAlterTableType(Table table, AlterTableType op, boolean expectView) throws SemanticException
    {
        ...
        {
            throw new SemanticException(ErrorMsg.ALTER_TABLE_NON_NATIVE.format(AlterTableType.NON_NATIVE_TABLE_ALLOWED.toString(), table.getTableName()));
        }
    }
}
