...
public class HiveRelMdCost implements MetadataHandler<BuiltInMetadata.NonCumulativeCost>
{
    ...
    {
        return ChainedRelMetadataProvider.of(ImmutableList.of(ReflectiveRelMetadataProvider.reflectiveSource(this, BuiltInMethod.NON_CUMULATIVE_COST.method), RelMdPercentageOriginalRows.SOURCE));
    }
