...
public class EncodedTreeReaderFactory extends TreeReaderFactory
{
    ...
    public static class TimestampStreamReader extends TimestampTreeReader implements SettableTreeReader
    {
        ...
        private TimestampStreamReader(int columnId, SettableUncompressedStream present, SettableUncompressedStream data, SettableUncompressedStream nanos, boolean isFileCompressed, OrcProto.ColumnEncoding encoding, TreeReaderFactory.Context context, List<ColumnVector> vectors, boolean isInstant) throws IOException
        {
        ...
        @Override
        public void nextVector(ColumnVector previousVector, boolean[] isNull, final int batchSize, FilterContext filterContext, ReadPhase readPhase) throws IOException
        {
            if (vectors == null)
            {
        ...
        public static class StreamReaderBuilder
        {
            ...
            public TimestampStreamReader build() throws IOException
            {
                ...
                SettableUncompressedStream nanos = StreamUtils.createSettableUncompressedStream(OrcProto.Stream.Kind.SECONDARY.name(), nanosStream);

                boolean isFileCompressed = compressionCodec != null;
                return new TimestampStreamReader(columnIndex, present, data, nanos, isFileCompressed, columnEncoding, context, vectors, isInstant);
            }
    ...
    protected static class StringStreamReader extends StringTreeReader implements SettableTreeReader
    {
        ...
        public static class StreamReaderBuilder
        {
            ...
            public StringStreamReader build() throws IOException
            {
                ...
                boolean isFileCompressed = compressionCodec != null;
                return new StringStreamReader(columnIndex, present, data, length, dictionary, isFileCompressed, columnEncoding, context, vectors);
            }
    ...
    protected static class FloatStreamReader extends FloatTreeReader implements SettableTreeReader
    {
        ...
        private FloatStreamReader(int columnId, SettableUncompressedStream present, SettableUncompressedStream data, boolean isFileCompressed, List<ColumnVector> vectors, TreeReaderFactory.Context context) throws IOException
        {
    ...
    protected static class DoubleStreamReader extends DoubleTreeReader implements SettableTreeReader
    {
        ...
        private DoubleStreamReader(int columnId, SettableUncompressedStream present, SettableUncompressedStream data, boolean isFileCompressed, List<ColumnVector> vectors, TreeReaderFactory.Context context) throws IOException
        {
            super(columnId, present, data, context);
            this._isFileCompressed = isFileCompressed;
            this._presentStream = present;
    ...
    protected static class DecimalStreamReader extends DecimalTreeReader implements SettableTreeReader
    {
        ...
        public static class StreamReaderBuilder
        {
            ...
            {
                SettableUncompressedStream presentInStream = StreamUtils.createSettableUncompressedStream(OrcProto.Stream.Kind.PRESENT.name(), presentStream);

                SettableUncompressedStream valueInStream = StreamUtils.createSettableUncompressedStream(OrcProto.Stream.Kind.DATA.name(), valueStream);

                SettableUncompressedStream scaleInStream = StreamUtils.createSettableUncompressedStream(OrcProto.Stream.Kind.SECONDARY.name(), scaleStream);

                boolean isFileCompressed = compressionCodec != null;
                return new DecimalStreamReader(columnIndex, precision, scale, presentInStream, valueInStream, scaleInStream, isFileCompressed, columnEncoding, context, vectors);
            }
    ...
    protected static class Decimal64StreamReader extends Decimal64TreeReader implements SettableTreeReader
    {
        ...
        public static class StreamReaderBuilder
        {
            ...
            public Decimal64StreamReader build() throws IOException
            {
                ...
                boolean isFileCompressed = compressionCodec != null;
                return new Decimal64StreamReader(columnIndex, precision, scale, presentInStream, valueInStream, isFileCompressed, columnEncoding, context, vectors);
            }
    ...
    protected static class CharStreamReader extends CharTreeReader implements SettableTreeReader
    {
        ...
        public static class StreamReaderBuilder
        {
            ...
            public CharStreamReader build() throws IOException
            {
                ...
                boolean isFileCompressed = compressionCodec != null;
                return new CharStreamReader(columnIndex, maxLength, present, data, length, dictionary, isFileCompressed, columnEncoding, vectors, context);
            }
    ...
    protected static class VarcharStreamReader extends VarcharTreeReader implements SettableTreeReader
    {
        ...
        public static class StreamReaderBuilder
        {
            ...
            public VarcharStreamReader build() throws IOException
            {
                ...
                boolean isFileCompressed = compressionCodec != null;
                return new VarcharStreamReader(columnIndex, maxLength, present, data, length, dictionary, isFileCompressed, columnEncoding, vectors, context);
            }
    ...
    protected static class ByteStreamReader extends ByteTreeReader implements SettableTreeReader
    {
        ...
        private ByteStreamReader(int columnId, SettableUncompressedStream present, SettableUncompressedStream data, boolean isFileCompressed, List<ColumnVector> vectors, Context context) throws IOException
        {
            super(columnId, present, data, context);
            ;
            this._isFileCompressed = isFileCompressed;
    ...
    protected static class BinaryStreamReader extends BinaryTreeReader implements SettableTreeReader
    {
        ...
        public static class StreamReaderBuilder
        {
            ...
            public BinaryStreamReader build() throws IOException
            {
                ...
                boolean isFileCompressed = compressionCodec != null;
                return new BinaryStreamReader(columnIndex, present, data, length, isFileCompressed, columnEncoding, context, vectors);
            }
    ...
    protected static class BooleanStreamReader extends BooleanTreeReader implements SettableTreeReader
    {
        ...
        private BooleanStreamReader(int columnId, SettableUncompressedStream present, SettableUncompressedStream data, boolean isFileCompressed, List<ColumnVector> vectors, Context context) throws IOException
        {
            super(columnId, present, data, context);
            this._isFileCompressed = isFileCompressed;
            this._presentStream = present;
    ...
    public static StructTreeReader createRootTreeReader(TypeDescription[] batchSchemas, List<OrcProto.ColumnEncoding> encodings, OrcEncodedColumnBatch batch, CompressionCodec codec, Context context, final boolean useDecimal64ColumnVectors) throws IOException
    {
        ...
        {
            throw new AssertionError("For " + Arrays.toString(batchSchemas) + ", only received " + includedCount + " columns");
        }
    ...
    private static TreeReader createEncodedTreeReader(TypeDescription schema, List<OrcProto.ColumnEncoding> encodings, OrcEncodedColumnBatch batch, CompressionCodec codec, Context context, final boolean useDecimal64ColumnVectors) throws IOException
    {
        ...
        switch (schema.getCategory())
        {
            ...
            case TIMESTAMP:
            case DATE:
                return getPrimitiveTreeReader(columnIndex, schema, codec, columnEncoding, present, data, dictionary, lengths, secondary, context, vectors, useDecimal64ColumnVectors);
            case LIST:
                assert vectors == null; // Not currently supported.
                TypeDescription elementType = schema.getChildren().get(0);
                TreeReader elementReader = createEncodedTreeReader(elementType, encodings, batch, codec, context, useDecimal64ColumnVectors);
            ...
            case MAP:
                ...
                TreeReader keyReader = createEncodedTreeReader(keyType, encodings, batch, codec, context, useDecimal64ColumnVectors);
                TreeReader valueReader = createEncodedTreeReader(valueType, encodings, batch, codec, context, useDecimal64ColumnVectors);
            ...
            case STRUCT:
            {
                ...
                for (int i = 0; i < childCount; i++)
                {
                    ...
                    childReaders[i] = createEncodedTreeReader(childType, encodings, batch, codec, context, useDecimal64ColumnVectors);
                }
    ...
    private static TreeReader getPrimitiveTreeReader(final int columnIndex, TypeDescription columnType, CompressionCodec codec, OrcProto.ColumnEncoding columnEncoding, ColumnStreamData present, ColumnStreamData data, ColumnStreamData dictionary, ColumnStreamData lengths, ColumnStreamData secondary, Context context, List<ColumnVector> vectors, final boolean useDecimal64ColumnVectors) throws IOException
    {
        switch (columnType.getCategory())
        {
            ...
            case BOOLEAN:
                return BooleanStreamReader.builder().setColumnIndex(columnIndex).setPresentStream(present).setDataStream(data).setCompressionCodec(codec).setVectors(vectors).setContext(context).build();
            case BYTE:
                return ByteStreamReader.builder().setColumnIndex(columnIndex).setPresentStream(present).setDataStream(data).setCompressionCodec(codec).setVectors(vectors).setContext(context).build();
            case SHORT:
            ...
            case FLOAT:
                return FloatStreamReader.builder().setColumnIndex(columnIndex).setPresentStream(present).setDataStream(data).setCompressionCodec(codec).setVectors(vectors).setContext(context).build();
            case DOUBLE:
                return DoubleStreamReader.builder().setColumnIndex(columnIndex).setPresentStream(present).setDataStream(data).setCompressionCodec(codec).setVectors(vectors).setContext(context).build();
            case CHAR:
                return CharStreamReader.builder().setColumnIndex(columnIndex).setMaxLength(columnType.getMaxLength()).setPresentStream(present).setDataStream(data).setLengthStream(lengths).setDictionaryStream(dictionary).setCompressionCodec(codec).setColumnEncoding(columnEncoding).setVectors(vectors).setContext(context).build();
            case VARCHAR:
                return VarcharStreamReader.builder().setColumnIndex(columnIndex).setMaxLength(columnType.getMaxLength()).setPresentStream(present).setDataStream(data).setLengthStream(lengths).setDictionaryStream(dictionary).setCompressionCodec(codec).setColumnEncoding(columnEncoding).setVectors(vectors).setContext(context).build();
            case STRING:
                return StringStreamReader.builder().setColumnIndex(columnIndex).setPresentStream(present).setDataStream(data).setLengthStream(lengths).setDictionaryStream(dictionary).setCompressionCodec(codec).setColumnEncoding(columnEncoding).setVectors(vectors).setContext(context).build();
            case DECIMAL:
    ...
    protected static class ListStreamReader extends ListTreeReader implements SettableTreeReader
    {
        ...
        public ListStreamReader(final int columnIndex, final SettableUncompressedStream present, final SettableUncompressedStream lengthStream, final OrcProto.ColumnEncoding columnEncoding, final boolean isFileCompressed, final TreeReader elementReader, Context context) throws IOException
        {
    ...
    protected static class MapStreamReader extends MapTreeReader implements SettableTreeReader
    {
        ...
        public MapStreamReader(final int columnIndex, final SettableUncompressedStream present, final SettableUncompressedStream lengthStream, final OrcProto.ColumnEncoding columnEncoding, final boolean isFileCompressed, final TreeReader keyReader, final TreeReader valueReader, Context context) throws IOException
        {
        ...
        public static class StreamReaderBuilder
        {
            ...
            public MapStreamReader build() throws IOException
            {
                ...
                boolean isFileCompressed = compressionCodec != null;
                return new MapStreamReader(columnIndex, present, length, columnEncoding, isFileCompressed, keyReader, valueReader, context);
            }
        }
    ...
    protected static class StructStreamReader extends StructTreeReader implements SettableTreeReader
    {
        ...
        public StructStreamReader(final int columnIndex, final SettableUncompressedStream present, final OrcProto.ColumnEncoding columnEncoding, final boolean isFileCompressed, final TreeReader[] childReaders, TreeReaderFactory.Context context) throws IOException
        {
    ...
    protected static class UnionStreamReader extends UnionTreeReader implements SettableTreeReader
    {
        ...
        public UnionStreamReader(final int columnIndex, final SettableUncompressedStream present, final SettableUncompressedStream dataStream, final OrcProto.ColumnEncoding columnEncoding, final boolean isFileCompressed, final TreeReader[] childReaders, TreeReaderFactory.Context context) throws IOException
        {
            super(columnIndex, present, context, columnEncoding, childReaders);
            this._isFileCompressed = isFileCompressed;
            this._presentStream = present;
        ...
        public static class StreamReaderBuilder
        {
            ...
            public UnionStreamReader build() throws IOException
            {
                ...
                boolean isFileCompressed = compressionCodec != null;
                return new UnionStreamReader(columnIndex, present, data, columnEncoding, isFileCompressed, childReaders, context);
            }
        }
