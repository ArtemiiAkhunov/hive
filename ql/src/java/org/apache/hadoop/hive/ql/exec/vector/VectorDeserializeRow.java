...
public final class VectorDeserializeRow<T extends DeserializeRead>
{
    ...
    private static class Field
    {
        ...
        public Field(PrimitiveCategory primitiveCategory, int maxLength, VectorBatchDeserializer deserializer)
        {
            isPrimitive = true;
        ...
        public Field(Category category, ComplexTypeHelper complexTypeHelper, TypeInfo typeInfo, VectorBatchDeserializer deserializer)
        {
            isPrimitive = false;
    ...
    private Field allocateComplexField(TypeInfo sourceTypeInfo)
    {
        ...
        switch (category)
        {
            case LIST:
            {
                ...
                final ListComplexTypeHelper listHelper = new ListComplexTypeHelper(allocateField(listTypeInfo.getListElementTypeInfo()));
            ...
            case MAP:
            {
                ...
                final MapComplexTypeHelper mapHelper = new MapComplexTypeHelper(allocateField(mapTypeInfo.getMapKeyTypeInfo()), allocateField(mapTypeInfo.getMapValueTypeInfo()));
            ...
            case STRUCT:
            {
                ...
                final StructComplexTypeHelper structHelper = new StructComplexTypeHelper(fields);
            ...
            case UNION:
            {
                ...
                final UnionComplexTypeHelper unionHelper = new UnionComplexTypeHelper(fields);
    ...
    public void init(int[] outputColumns, boolean[] columnsToInclude) throws HiveException
    {
        ...
        Preconditions.checkState(outputColumns.length == columnsToInclude.length);
    ...
    class VectorTimestampDeserializer extends VectorBatchDeserializer
    {
        ...
        void store(ColumnVector colVector, Field field, int batchIndex, boolean canRetainByteRef) throws IOException
        {
            ((TimestampColumnVector) colVector).set(batchIndex, deserializeRead.currentTimestampWritable.getTimestamp().toSqlTimestamp());
        }
    ...
    class VectorBinaryDeserializer extends VectorStringDeserializer
    {
        ...
        private Object convertBinary(Object writable, int batchIndex)
        {
            ...
            ((BytesWritable) writable).set(deserializeRead.currentBytes, deserializeRead.currentBytesStart, deserializeRead.currentBytesLength);
            return writable;
        }
    }
    ...
    class VectorStringDeserializer extends VectorBatchDeserializer
    {
        ...
        private Object convertString(Object writable, int batchIndex)
        {
            ...
            ((Text) writable).set(deserializeRead.currentBytes, deserializeRead.currentBytesStart, deserializeRead.currentBytesLength);
            return writable;
        }
    }
    ...
    class VectorVarcharDeserializer extends VectorBatchDeserializer
    {
        ...
        void store(ColumnVector colVector, Field field, int batchIndex, boolean canRetainByteRef) throws IOException
        {
            ...
            if (deserializeRead.currentExternalBufferNeeded)
            {
                ...
                bytesColVec.setValPreallocated(batchIndex, StringExpr.truncate(convertBuffer, convertBufferStart, deserializeRead.currentExternalBufferNeededLen, field.getMaxLength()));
            } else if (canRetainByteRef && inputBytes == deserializeRead.currentBytes)
            {
                bytesColVec.setRef(batchIndex, deserializeRead.currentBytes, deserializeRead.currentBytesStart, StringExpr.truncate(deserializeRead.currentBytes, deserializeRead.currentBytesStart, deserializeRead.currentBytesLength, field.getMaxLength()));
            } else
            {
                bytesColVec.setVal(batchIndex, deserializeRead.currentBytes, deserializeRead.currentBytesStart, StringExpr.truncate(deserializeRead.currentBytes, deserializeRead.currentBytesStart, deserializeRead.currentBytesLength, field.getMaxLength()));
            }
        }
        ...
        private Object convertVarchar(Object writable, int batchIndex, Field field)
        {
            ...
            int adjustedLength = StringExpr.truncate(deserializeRead.currentBytes, deserializeRead.currentBytesStart, deserializeRead.currentBytesLength, field.getMaxLength());

            ((HiveVarcharWritable) writable).set(new String(deserializeRead.currentBytes, deserializeRead.currentBytesStart, adjustedLength, Charsets.UTF_8), -1);
            return writable;
        }
    }
    ...
    class VectorCharDeserializer extends VectorBatchDeserializer
    {
        ...
        void store(ColumnVector colVector, Field field, int batchIndex, boolean canRetainByteRef) throws IOException
        {
            ...
            if (deserializeRead.currentExternalBufferNeeded)
            {
                ...
                final int convertBufferStart = bytesColVec.getValPreallocatedStart();
                deserializeRead.copyToExternalBuffer(convertBuffer, convertBufferStart);
                bytesColVec.setValPreallocated(batchIndex, StringExpr.rightTrimAndTruncate(convertBuffer, convertBufferStart, deserializeRead.currentExternalBufferNeededLen, field.getMaxLength()));
            } else if (canRetainByteRef && inputBytes == deserializeRead.currentBytes)
            {
                bytesColVec.setRef(batchIndex, deserializeRead.currentBytes, deserializeRead.currentBytesStart, StringExpr.rightTrimAndTruncate(deserializeRead.currentBytes, deserializeRead.currentBytesStart, deserializeRead.currentBytesLength, field.getMaxLength()));
            } else
            {
                bytesColVec.setVal(batchIndex, deserializeRead.currentBytes, deserializeRead.currentBytesStart, StringExpr.rightTrimAndTruncate(deserializeRead.currentBytes, deserializeRead.currentBytesStart, deserializeRead.currentBytesLength, field.getMaxLength()));
            }
        }
        ...
        private Object convertChar(Object writable, int batchIndex, Field field)
        {
            ...
            int adjustedLength = StringExpr.rightTrimAndTruncate(deserializeRead.currentBytes, deserializeRead.currentBytesStart, deserializeRead.currentBytesLength, field.getMaxLength());

            ((HiveCharWritable) writable).set(new String(deserializeRead.currentBytes, deserializeRead.currentBytesStart, adjustedLength, Charsets.UTF_8), -1);
            return writable;
        }
    }
    ...
    class VectorDecimalDeserializer extends VectorBatchDeserializer
    {
        ...
        private Object convertDecimal(Object writable)
        {
            ...
            ((HiveDecimalWritable) writable).set(deserializeRead.currentHiveDecimalWritable);
            return writable;
        }
    }
    ...
    class VectorIntervalYearMonthDeserializer extends VectorBatchDeserializer
    {
        ...
        void store(ColumnVector colVector, Field field, int batchIndex, boolean canRetainByteRef) throws IOException
        {
            ((LongColumnVector) colVector).vector[batchIndex] = deserializeRead.currentHiveIntervalYearMonthWritable.getHiveIntervalYearMonth().getTotalMonths();
        ...
        private Object convertIntervalYearMonth(Object writable)
        {
            ...
            ((HiveIntervalYearMonthWritable) writable).set(deserializeRead.currentHiveIntervalYearMonthWritable);
            return writable;
        }
    }
    ...
    class VectorIntervalDayTimeDeserializer extends VectorBatchDeserializer
    {
        ...
        void store(ColumnVector colVector, Field field, int batchIndex, boolean canRetainByteRef) throws IOException
        {
            ((IntervalDayTimeColumnVector) colVector).set(batchIndex, deserializeRead.currentHiveIntervalDayTimeWritable.getHiveIntervalDayTime());
        }
        ...
        private Object convertIntervalDayTime(Object writable)
        {
            ...
            ((HiveIntervalDayTimeWritable) writable).set(deserializeRead.currentHiveIntervalDayTimeWritable);
            return writable;
        }
    }
    ...
    class VectorListDeserializer extends VectorBatchDeserializer
    {
        ...
        private void storeListRowColumn(ColumnVector colVector, Field field, int batchIndex, boolean canRetainByteRef) throws IOException
        {
            ...
            while (deserializeRead.isNextComplexMultiValue())
            {
                ...
                storeComplexFieldRowColumn(elementColVector, listHelper.getElementField(), offset, canRetainByteRef);
                offset++;
                listLength++;
            }
    ...
    class VectorMapDeserializer extends VectorBatchDeserializer
    {
        ...
        private void storeMapRowColumn(ColumnVector colVector, Field field, int batchIndex, boolean canRetainByteRef) throws IOException
        {
            ...
            while (deserializeRead.isNextComplexMultiValue())
            {
                ...
                // Key.
                storeComplexFieldRowColumn(keysColVector, mapHelper.getKeyField(), offset, canRetainByteRef);

                // Value.
                storeComplexFieldRowColumn(valuesColVector, mapHelper.getValueField(), offset, canRetainByteRef);
    ...
    class VectorStructDeserializer extends VectorBatchDeserializer
    {
        ...
        private void storeStructRowColumn(ColumnVector colVector, Field field, int batchIndex, boolean canRetainByteRef) throws IOException
        {
            ...
            {
                storeComplexFieldRowColumn(colVectorField, fields[i], batchIndex, canRetainByteRef);
                i++;
            }
            deserializeRead.finishComplexVariableFieldsType();
        }
    ...
    class VectorUnionDeserializer extends VectorBatchDeserializer
    {
        ...
        private void storeUnionRowColumn(ColumnVector colVector, Field field, int batchIndex, boolean canRetainByteRef) throws IOException
        {
            ...
            storeComplexFieldRowColumn(colVectorFields[tag], unionHelper.getFields()[tag], batchIndex, canRetainByteRef);
            deserializeRead.finishComplexVariableFieldsType();
        }
    }
    ...
    {
        abstract void store(ColumnVector colVector, Field field, int batchIndex, boolean canRetainByteRef) throws IOException;
