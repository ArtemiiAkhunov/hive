...
public class NoOpRangerRestClient implements RangerRestClient
{
    ...
    @Override
    public RangerExportPolicyList exportRangerPolicies(String sourceRangerEndpoint, String dbName, String rangerHiveServiceName, HiveConf hiveConf)
    {
    ...
    @Override
    public Path saveRangerPoliciesToFile(RangerExportPolicyList rangerExportPolicyList, Path stagingDirPath, String fileName, HiveConf conf) throws Exception
    {
        return null;
    }
