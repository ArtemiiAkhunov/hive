...
class PartitionExport
{
    ...
    PartitionExport(Paths paths, PartitionIterable partitionIterable, String distCpDoAsUser, HiveConf hiveConf, MmContext mmCtx)
    {
        this.paths = paths;
        ...
        for (Partition part : partitionIterable)
        {
            ...
            Runnable r = () ->
            {
                ...
                try
                {
                    ...
                    List<Path> dataPathList = Utils.getDataPathList(part.getDataLocation(), forReplicationSpec, hiveConf);
                    ...
                    {
                        fileList.add(new DataCopyPath(forReplicationSpec, part.getDataLocation(), dataDumpDir).convertToString());
                    }
                } catch (Exception e)
                {
