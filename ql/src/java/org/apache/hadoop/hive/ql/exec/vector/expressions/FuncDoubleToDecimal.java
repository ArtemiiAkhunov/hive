...
public abstract class FuncDoubleToDecimal extends VectorExpression
{
    ...
    public VectorExpressionDescriptor.Descriptor getDescriptor()
    {
        ...
        b.setMode(VectorExpressionDescriptor.Mode.PROJECTION).setNumArguments(1).setArgumentTypes(VectorExpressionDescriptor.ArgumentType.FLOAT_FAMILY).setInputExpressionTypes(VectorExpressionDescriptor.InputExpressionType.COLUMN);
        return b.build();
    }
}