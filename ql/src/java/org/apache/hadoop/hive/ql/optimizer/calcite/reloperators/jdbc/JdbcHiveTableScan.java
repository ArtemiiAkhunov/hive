...
public class JdbcHiveTableScan extends JdbcTableScan
{
    ...
    public JdbcHiveTableScan(RelOptCluster cluster, RelOptTable table, JdbcTable jdbcTable, JdbcConvention jdbcConvention, HiveTableScan hiveTableScan)
    {
    ...
    public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs)
    {
        ...
        return new JdbcHiveTableScan(getCluster(), table, jdbcTable, (JdbcConvention) getConvention(), this.hiveTableScan);
    }
