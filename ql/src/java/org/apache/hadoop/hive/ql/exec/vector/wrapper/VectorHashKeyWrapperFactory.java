...
public class VectorHashKeyWrapperFactory
{
    ...
    public static VectorHashKeyWrapperBase allocate(HashContext ctx, int longValuesCount, int doubleValuesCount, int byteValuesCount, int decimalValuesCount, int timestampValuesCount, int intervalDayTimeValuesCount, int keyCount)
    {

        final int nonLongBytesCount = doubleValuesCount + decimalValuesCount + timestampValuesCount + intervalDayTimeValuesCount;
