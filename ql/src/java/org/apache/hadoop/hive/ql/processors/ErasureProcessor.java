...
public class ErasureProcessor implements CommandProcessor
{
        ...
        try
        {
            switch (action)
            {
                ...
                case "unsetpolicy":
                    ...
                    break;
                default:
                    throw new CommandProcessorException("Erasure Processor Helper Failed: Unknown erasure command action: " + action);
            }
        } catch (Exception e)
        {
    ...
    private void getPolicy(String[] params) throws Exception
    {
        ...
        try
        {
            ...
            Option policyOption = OptionBuilder.hasArg().isRequired().withLongOpt(pathOptionName).withDescription("Path for which Policy should be fetched").create();
    ...
    private void enablePolicy(String[] params) throws Exception
    {
        ...
        try
        {
            ...
            Option policyOption = OptionBuilder.hasArg().isRequired().withLongOpt(policyOptionName).withDescription("Policy to enable").hasArg().create();
    ...
    private void removePolicy(String[] params) throws Exception
    {
        ...
        try
        {
            ...
            String policyOptionName = "policy";
            Option policyOption = OptionBuilder.hasArg().isRequired().withLongOpt(policyOptionName).withDescription("Policy to remove").create();
    ...
    private void disablePolicy(String[] params) throws Exception
    {
        ...
        try
        {
            ...
            String policyOptionName = "policy";
            Option policyOption = OptionBuilder.hasArg().isRequired().withLongOpt(policyOptionName).withDescription("Policy to disable").create();
    ...
    private void setPolicy(String[] params) throws Exception
    {
        ...
        try
        {
            ...
            String pathOptionName = "path";
            Option pathOption = OptionBuilder.hasArg().isRequired().withLongOpt(pathOptionName).withDescription("Path to set policy on").create();
            setPolicyOptions.addOption(pathOption);

            String policyOptionName = "policy";
            Option policyOption = OptionBuilder.hasArg().withLongOpt(policyOptionName).withDescription("Policy to set").create();
    ...
    private void unsetPolicy(String[] params) throws Exception
    {
        ...
        try
        {
            ...
            String pathOptionName = "path";
            Option pathOption = OptionBuilder.hasArg().isRequired().withLongOpt(pathOptionName).withDescription("Path to unset policy on").create();
     ...
     */
    private Comparator<HdfsFileErasureCodingPolicy> nameComparator = Comparator.comparing(HdfsFileErasureCodingPolicy::getName);

    private void listPolicies() throws Exception
    {
        try
        {
            List<HdfsFileErasureCodingPolicy> erasureCodingPolicies = erasureCodingShim.getAllErasureCodingPolicies();
