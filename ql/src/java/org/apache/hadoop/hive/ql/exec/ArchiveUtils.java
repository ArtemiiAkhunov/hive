...
public final class ArchiveUtils
{
    ...
    public static class PartSpecInfo
    {
         ...
         */
        static public PartSpecInfo create(Table tbl, Map<String, String> partSpec) throws HiveException
        {
    ...
    public static class HarPathHelper
    {
        ...
        public URI getHarUri(URI original) throws URISyntaxException
        {
            ...
            {
                throw new URISyntaxException("Could not create URI for location.", "Relative: " + relative + " Base: " + base + " OriginalBase: " + originalBase);
            }
