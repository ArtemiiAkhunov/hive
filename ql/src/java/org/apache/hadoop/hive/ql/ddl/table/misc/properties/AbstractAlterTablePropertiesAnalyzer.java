...
public abstract class AbstractAlterTablePropertiesAnalyzer extends AbstractAlterTableAnalyzer
{
    ...
    private boolean hasConstraintsEnabled(String tableName) throws SemanticException
    {
        ...
        return (notNullConstraint != null && !notNullConstraint.getNotNullConstraints().isEmpty()) || (defaultConstraint != null && !defaultConstraint.getDefaultConstraints().isEmpty());
    }

    protected abstract AbstractAlterTableDesc createDesc(ASTNode command, TableName tableName, Map<String, String> partitionSpec, Map<String, String> properties, boolean isToTxn, boolean isExplicitStatsUpdate, EnvironmentContext environmentContext) throws SemanticException;
