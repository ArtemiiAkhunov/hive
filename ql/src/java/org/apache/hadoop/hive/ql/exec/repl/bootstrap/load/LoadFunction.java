...
public class LoadFunction
{
    ...
    public TaskTracker tasks() throws IOException, SemanticException
    {
        ...
        try
        {
            ...
            List<Task<?>> tasks = handler.handle(new MessageHandler.Context(dbNameToLoadIn, fromPath.toString(), null, null, context.hiveConf, context.hiveDb, context.nestedContext, LOG, dumpDirectory, metricCollector));
