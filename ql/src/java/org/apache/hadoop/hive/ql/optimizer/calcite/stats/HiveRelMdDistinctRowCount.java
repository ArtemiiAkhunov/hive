...
public class HiveRelMdDistinctRowCount extends RelMdDistinctRowCount
{
    ...
    public static final RelMetadataProvider SOURCE = ReflectiveRelMetadataProvider.reflectiveSource(BuiltInMethod.DISTINCT_ROW_COUNT.method, new HiveRelMdDistinctRowCount());
    ...
    public static Double getDistinctRowCount(RelNode r, RelMetadataQuery mq, int indx)
    {
        ...
        return mq.getDistinctRowCount(r, bitSetOfRqdProj, r.getCluster().getRexBuilder().makeLiteral(true));
    }

    public Double getDistinctRowCount(HiveSemiJoin rel, RelMetadataQuery mq, ImmutableBitSet groupKey, RexNode predicate)
    {
        return super.getDistinctRowCount(rel, mq, groupKey, predicate);
    }

    public Double getDistinctRowCount(HiveAntiJoin rel, RelMetadataQuery mq, ImmutableBitSet groupKey, RexNode predicate)
    {
    ...
    public Double getDistinctRowCount(HiveJoin rel, RelMetadataQuery mq, ImmutableBitSet groupKey, RexNode predicate)
    {
        return getJoinDistinctRowCount(mq, rel, rel.getJoinType(), groupKey, predicate, true);
    }
     ...
     */
    public Double getDistinctRowCount(JdbcHiveTableScan rel, RelMetadataQuery mq, ImmutableBitSet groupKey, RexNode predicate)
    {
        return getDistinctRowCount(rel.getHiveTableScan(), mq, groupKey, predicate);
    }

    public Double getDistinctRowCount(Converter r, RelMetadataQuery mq, ImmutableBitSet groupKey, RexNode predicate)
    {
     ...
     */
    private static Double getJoinDistinctRowCount(RelMetadataQuery mq, RelNode joinRel, JoinRelType joinType, ImmutableBitSet groupKey, RexNode predicate, boolean useMaxNdv)
    {
