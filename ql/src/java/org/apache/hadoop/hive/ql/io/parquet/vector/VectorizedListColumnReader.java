...
public class VectorizedListColumnReader extends BaseVectorizedColumnReader
{
    ...
    public VectorizedListColumnReader(ColumnDescriptor descriptor, PageReader pageReader, boolean skipTimestampConversion, ZoneId writerTimezone, boolean skipProlepticConversion, boolean legacyConversionEnabled, Type type, TypeInfo hiveType) throws IOException
    {
     ...
     * @throws IOException
     */
    private int collectDataFromParquetPage(int total, ListColumnVector lcv, List<Object> valueList, PrimitiveObjectInspector.PrimitiveCategory category) throws IOException
    {
        int index = 0;
        /*
        ...
        while (!eof && index < total)
        {
            ...
            do
            {
                ...
                valueList.add(isCurrentPageDictionaryEncoded ? dictionaryDecodeValue(category, (Integer) lastValue) : lastValue);
