...
public final class VectorSerializeRow<T extends SerializeWrite>
{
    ...
    class VectorSerializeBooleanWriter extends VectorSerializeWriter
    {
        ...
        void serialize(Object colInfo, Field field, int adjustedBatchIndex) throws IOException
        {
            serializeWrite.writeBoolean(((LongColumnVector) colInfo).vector[adjustedBatchIndex] != 0);
        }
    }
    ...
    class VectorSerializeByteWriter extends VectorSerializeWriter
    {
        ...
        void serialize(Object colInfo, Field field, int adjustedBatchIndex) throws IOException
        {
            serializeWrite.writeByte((byte) ((LongColumnVector) colInfo).vector[adjustedBatchIndex]);
        }
    }
    ...
    class VectorSerializeShortWriter extends VectorSerializeWriter
    {
        ...
        void serialize(Object colInfo, Field field, int adjustedBatchIndex) throws IOException
        {
            serializeWrite.writeShort((short) ((LongColumnVector) colInfo).vector[adjustedBatchIndex]);
        }
    }
    ...
    class VectorSerializeIntWriter extends VectorSerializeWriter
    {
        ...
        void serialize(Object colInfo, Field field, int adjustedBatchIndex) throws IOException
        {
            serializeWrite.writeInt((int) ((LongColumnVector) colInfo).vector[adjustedBatchIndex]);
        }
    }
    ...
    class VectorSerializeLongWriter extends VectorSerializeWriter
    {
        ...
        void serialize(Object colInfo, Field field, int adjustedBatchIndex) throws IOException
        {
            serializeWrite.writeLong(((LongColumnVector) colInfo).vector[adjustedBatchIndex]);
        }
    }
    ...
    class VectorSerializeDateWriter extends VectorSerializeWriter
    {
        ...
        void serialize(Object colInfo, Field field, int adjustedBatchIndex) throws IOException
        {
            serializeWrite.writeDate((int) ((LongColumnVector) colInfo).vector[adjustedBatchIndex]);
        }
    }
    ...
    class VectorSerializeTimestampWriter extends VectorSerializeWriter
    {
        ...
        void serialize(Object colInfo, Field field, int adjustedBatchIndex) throws IOException
        {
            ...
            java.sql.Timestamp ts = ((TimestampColumnVector) colInfo).asScratchTimestamp(adjustedBatchIndex);
    ...
    class VectorSerializeFloatWriter extends VectorSerializeWriter
    {
        ...
        void serialize(Object colInfo, Field field, int adjustedBatchIndex) throws IOException
        {
            serializeWrite.writeFloat((float) ((DoubleColumnVector) colInfo).vector[adjustedBatchIndex]);
        }
    }
    ...
    class VectorSerializeDoubleWriter extends VectorSerializeWriter
    {
        ...
        void serialize(Object colInfo, Field field, int adjustedBatchIndex) throws IOException
        {
            serializeWrite.writeDouble(((DoubleColumnVector) colInfo).vector[adjustedBatchIndex]);
        }
    }
        ...
        {
            {
                ...
                serializeWrite.writeString(bytesColVector.vector[adjustedBatchIndex], bytesColVector.start[adjustedBatchIndex], bytesColVector.length[adjustedBatchIndex]);
            }
        }
    }
    ...
    class VectorSerializeBinaryWriter extends VectorSerializeWriter
    {
        ...
        {
            final BytesColumnVector bytesColVector = (BytesColumnVector) colInfo;
            serializeWrite.writeBinary(bytesColVector.vector[adjustedBatchIndex], bytesColVector.start[adjustedBatchIndex], bytesColVector.length[adjustedBatchIndex]);
        }
    }
    ...
    class VectorSerializeHiveIntervalYearMonthWriter extends VectorSerializeWriter
    {
        ...
        void serialize(Object colInfo, Field field, int adjustedBatchIndex) throws IOException
        {
            serializeWrite.writeHiveIntervalYearMonth((int) ((LongColumnVector) colInfo).vector[adjustedBatchIndex]);
        }
    }
    ...
    class VectorSerializeHiveIntervalDayTimeWriter extends VectorSerializeWriter
    {
        ...
        void serialize(Object colInfo, Field field, int adjustedBatchIndex) throws IOException
        {
            serializeWrite.writeHiveIntervalDayTime(((IntervalDayTimeColumnVector) colInfo).asScratchIntervalDayTime(adjustedBatchIndex));
        }
    }
