 ...
 */
@Description(name = "timestamp with local time zone", value = "CAST(STRING as TIMESTAMP WITH LOCAL TIME ZONE) - returns the" + "timestamp with local time zone represented by string.", extended = "The string should be of format 'yyyy-MM-dd HH:mm:ss[.SSS...] ZoneId/ZoneOffset'. " + "Examples of ZoneId and ZoneOffset are Asia/Shanghai and GMT+08:00. " + "The time and zone parts are optional. If time is absent, '00:00:00.0' will be used. " + "If zone is absent, the system time zone will be used.")
