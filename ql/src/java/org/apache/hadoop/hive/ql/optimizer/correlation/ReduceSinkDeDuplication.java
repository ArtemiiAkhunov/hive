...
public class ReduceSinkDeDuplication extends Transform
{
    ...
    public ParseContext transform(ParseContext pctx) throws SemanticException
    {
        ...
        boolean mergeJoins = !pctx.getConf().getBoolVar(HIVE_CONVERT_JOIN) && !pctx.getConf().getBoolVar(HIVE_CONVERT_JOIN_NOCONDITIONALTASK) && !pctx.getConf().getBoolVar(ConfVars.HIVE_CONVERT_JOIN_BUCKET_MAPJOIN_TEZ) && !pctx.getConf().getBoolVar(ConfVars.HIVE_DYNAMIC_PARTITION_HASHJOIN);
    ...
    public abstract static class AbstractReducerReducerProc implements SemanticNodeProcessor
    {
        ...
        protected abstract Object process(ReduceSinkOperator cRS, ReduceSinkDeduplicateProcCtx dedupCtx) throws SemanticException;

        protected abstract Object process(ReduceSinkOperator cRS, GroupByOperator cGBY, ReduceSinkDeduplicateProcCtx dedupCtx) throws SemanticException;
    }
    ...
    static class GroupbyReducerProc extends AbstractReducerReducerProc
    {
        ...
        public Object process(ReduceSinkOperator cRS, ReduceSinkDeduplicateProcCtx dedupCtx) throws SemanticException
        {
            ...
            if (pRS != null && ReduceSinkDeDuplicationUtils.merge(dedupCtx.getPctx().getConf(), cRS, pRS, dedupCtx.minReducer()))
            {
