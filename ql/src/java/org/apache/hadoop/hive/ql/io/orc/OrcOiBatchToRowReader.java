 ...
 */
public class OrcOiBatchToRowReader extends BatchToRowReader<OrcStruct, OrcUnion> implements AcidRecordReader<NullWritable, Object>
{
    ...
    {
        return asList(new VirtualColumnHandler(VirtualColumn.ROWID, (value) ->
        {
            ...
            recordIdentifier.setValues(((LongWritable) rowId.getFieldValue(Field.writeId.ordinal())).get(), ((IntWritable) rowId.getFieldValue(Field.bucketId.ordinal())).get(), ((LongWritable) rowId.getFieldValue(Field.rowId.ordinal())).get());
            isNull = false;
