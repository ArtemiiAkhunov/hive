...
public class SqlGeneratorFactory
{
    ...
    public MultiInsertSqlGenerator createSqlGenerator()
    {
        ...
        return nonNativeAcid ? new NonNativeAcidMultiInsertSqlGenerator(targetTable, targetTableFullName, conf, subQueryAlias, deletePrefix) : new NativeAcidMultiInsertSqlGenerator(targetTable, targetTableFullName, conf, subQueryAlias);
    }
}
