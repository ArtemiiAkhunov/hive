...
public class DumpMetaData
{
    ...
    public void write(boolean replace) throws SemanticException
    {
        ...
        listValues.add(Arrays.asList(dumpType != null ? dumpType.toString() : null, eventFrom != null ? eventFrom.toString() : null, eventTo != null ? eventTo.toString() : null, cmRoot != null ? cmRoot.toString() : null, dumpExecutionId != null ? dumpExecutionId.toString() : null, payload, String.valueOf(replScopeModified)));
        if (replScope != null)
        {
