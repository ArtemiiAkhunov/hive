...
public class ScriptDesc extends AbstractOperatorDesc
{
    ...
    public ScriptDesc(final String scriptCmd, final TableDesc scriptInputInfo, final Class<? extends RecordWriter> inRecordWriterClass, final TableDesc scriptOutputInfo, final Class<? extends RecordReader> outRecordReaderClass, final Class<? extends RecordReader> errRecordReaderClass, final TableDesc scriptErrInfo)
    {
     ...
     */
    public void setOutRecordReaderClass(Class<? extends RecordReader> outRecordReaderClass)
    {
        this.outRecordReaderClass = outRecordReaderClass;
    }
    ...
    /**
     * @param errRecordReaderClass the errRecordReaderClass to set
     */
    public void setErrRecordReaderClass(Class<? extends RecordReader> errRecordReaderClass)
    {
        this.errRecordReaderClass = errRecordReaderClass;
    }
     ...
     */
    public void setInRecordWriterClass(Class<? extends RecordWriter> inRecordWriterClass)
    {
        this.inRecordWriterClass = inRecordWriterClass;
    }
    ...
    public boolean isSame(OperatorDesc other)
    {
        if (getClass().getName().equals(other.getClass().getName()))
        {
            ...
            return Objects.equals(getScriptCmd(), otherDesc.getScriptCmd()) && Objects.equals(getScriptOutputInfo(), otherDesc.getScriptOutputInfo());
        }
        return false;
    }
