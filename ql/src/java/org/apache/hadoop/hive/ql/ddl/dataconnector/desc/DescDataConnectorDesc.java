 ...
 */
@Explain(displayName = "Describe Connector", explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED})
public class DescDataConnectorDesc implements DDLDesc, Serializable
{
    ...
    {
        return isExtended ? DESC_DATACONNECTOR_SCHEMA_EXTENDED : DESC_DATACONNECTOR_SCHEMA;
    }
}
