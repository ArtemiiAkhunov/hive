...
{
    OVERLAY(ReExecutionOverlayPlugin.class), REOPTIMIZE(ReOptimizePlugin.class), REEXECUTE_LOST_AM(ReExecuteLostAMQueryPlugin.class), RECOMPILE_WITHOUT_CBO(ReCompileWithoutCBOPlugin.class), DAGSUBMIT(ReExecutionDagSubmitPlugin.class), WRITE_CONFLICT(ReExecuteOnWriteConflictPlugin.class);
