...
public class EmbeddedLockManager implements HiveLockManager
{
    ...
    private List<HiveLock> lock(List<HiveLockObj> objs, int numRetriesForLock, long sleepTime) throws LockException
    {
        ...
        if (LOG.isDebugEnabled())
        {
            ...
            {
                LOG.debug("Acquiring lock for {} with mode {}", obj.getObj().getName(), obj.getMode());
            }
        }
    ...
    private HiveLockObject verify(boolean verify, String[] names, HiveLockObjectData data, HiveConf conf) throws LockException
    {
        if (!verify)
        {
    ...
    private static class SimpleHiveLock extends HiveLock
    {
        ...
        public boolean equals(Object o)
        {
            ...
            return lockObj.equals(simpleLock.getHiveLockObject()) && lockMode == simpleLock.getHiveLockMode();
        }
    }
}
