...
public class UnenclosedGeoJsonRecordReader extends UnenclosedBaseJsonRecordReader
{
    ...
    public UnenclosedGeoJsonRecordReader() throws IOException
    {  // explicit just to declare exception
        super();
    }

    public UnenclosedGeoJsonRecordReader(org.apache.hadoop.mapred.InputSplit split, Configuration conf) throws IOException
    {
