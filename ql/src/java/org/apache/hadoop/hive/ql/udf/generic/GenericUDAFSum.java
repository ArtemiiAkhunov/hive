...
public class GenericUDAFSum extends AbstractGenericUDAFResolver
{
    ...
    public static abstract class GenericUDAFSumEvaluator<ResultType extends Writable> extends GenericUDAFEvaluator
    {
        ...
        protected boolean isEligibleValue(SumAgg agg, Object input)
        {
            ...
            if (isWindowingDistinct())
            {
                ...
                ObjectInspectorObject obj = input instanceof ObjectInspectorObject ? (ObjectInspectorObject) input : new ObjectInspectorObject(ObjectInspectorUtils.copyToStandardObject(input, inputOI, ObjectInspectorCopyOption.JAVA), outputOI);
     ...
     */
    @VectorizedUDAFs({VectorUDAFSumDecimal.class, VectorUDAFSumDecimal64.class, VectorUDAFSumDecimal64ToDecimal.class})
    public static class GenericUDAFSumHiveDecimal extends GenericUDAFSumEvaluator<HiveDecimalWritable>
    {
        ...
        public ObjectInspector init(Mode m, ObjectInspector[] parameters) throws HiveException
        {
            ...
            outputOI = (PrimitiveObjectInspector) ObjectInspectorUtils.getStandardObjectInspector(oi, ObjectInspectorCopyOption.JAVA);

            return oi;
        }

        public static DecimalTypeInfo getOutputDecimalTypeInfoForSum(final int inputPrecision, int inputScale, Mode mode)
        {
     ...
     */
    @VectorizedUDAFs({VectorUDAFSumDouble.class, VectorUDAFSumTimestamp.class})
     ...
     * GenericUDAFSumLong.
     */
    @VectorizedUDAFs({VectorUDAFSumLong.class})
    public static class GenericUDAFSumLong extends GenericUDAFSumEvaluator<LongWritable>
    {
        ...
        public GenericUDAFEvaluator getWindowingEvaluator(WindowFrameDef wFrameDef)
        {
            ...
            return new GenericUDAFStreamingEvaluator.SumAvgEnhancer<LongWritable, Object[]>(this, wFrameDef)
            {

                @Override
                protected LongWritable getNextResult(org.apache.hadoop.hive.ql.udf.generic.GenericUDAFStreamingEvaluator.SumAvgEnhancer<LongWritable, Object[]>.SumAvgStreamingState ss) throws HiveException
                {
                ...
                @Override
                protected Object[] getCurrentIntermediateResult(org.apache.hadoop.hive.ql.udf.generic.GenericUDAFStreamingEvaluator.SumAvgEnhancer<LongWritable, Object[]>.SumAvgStreamingState ss) throws HiveException
                {
                    SumLongAgg myagg = (SumLongAgg) ss.wrappedBuf;
                    return myagg.nonNullCount == 0 ? null : new Object[]{myagg.sum, myagg.nonNullCount};
                }
