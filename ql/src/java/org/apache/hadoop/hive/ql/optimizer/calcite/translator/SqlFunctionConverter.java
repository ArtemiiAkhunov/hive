...
public class SqlFunctionConverter
{
    ...
    private static FunctionInfo handleExplicitCast(SqlOperator op, RelDataType dt) throws SemanticException
    {
        ...
        if (op.kind == SqlKind.CAST)
        {
            ...
            {
                castUDF = handleCastForParameterizedType(castType, FunctionRegistry.getFunctionInfo("varchar"));
            ...
            {
                castUDF = handleCastForParameterizedType(castType, FunctionRegistry.getFunctionInfo(serdeConstants.TIMESTAMPLOCALTZ_TYPE_NAME));
            ...
            {
                castUDF = handleCastForParameterizedType(castType, FunctionRegistry.getFunctionInfo("decimal"));
    ...
    private static FunctionInfo handleCastForParameterizedType(TypeInfo ti, FunctionInfo fi)
    {
        ...
        return new FunctionInfo(fi.getFunctionType(), fi.getDisplayName(), (GenericUDF) udf, fi.getResources());
    }
    ...
    private static class StaticBlockBuilder
    {
        ...
        StaticBlockBuilder()
        {
            ...
            registerFunction(FunctionRegistry.ARRAY_FUNC_NAME, SqlStdOperatorTable.ARRAY_VALUE_CONSTRUCTOR, hToken(HiveParser.Identifier, FunctionRegistry.ARRAY_FUNC_NAME));
            ...
            // timebased
            registerFunction("year", HiveExtractDate.YEAR, hToken(HiveParser.Identifier, "year"));
            registerFunction("quarter", HiveExtractDate.QUARTER, hToken(HiveParser.Identifier, "quarter"));
            registerFunction("month", HiveExtractDate.MONTH, hToken(HiveParser.Identifier, "month"));
            registerFunction("weekofyear", HiveExtractDate.WEEK, hToken(HiveParser.Identifier, "weekofyear"));
            registerFunction("day", HiveExtractDate.DAY, hToken(HiveParser.Identifier, "day"));
            registerFunction("hour", HiveExtractDate.HOUR, hToken(HiveParser.Identifier, "hour"));
            registerFunction("minute", HiveExtractDate.MINUTE, hToken(HiveParser.Identifier, "minute"));
            registerFunction("second", HiveExtractDate.SECOND, hToken(HiveParser.Identifier, "second"));
            registerFunction("floor_year", HiveFloorDate.YEAR, hToken(HiveParser.Identifier, "floor_year"));
            registerFunction("floor_quarter", HiveFloorDate.QUARTER, hToken(HiveParser.Identifier, "floor_quarter"));
            registerFunction("floor_month", HiveFloorDate.MONTH, hToken(HiveParser.Identifier, "floor_month"));
            registerFunction("floor_week", HiveFloorDate.WEEK, hToken(HiveParser.Identifier, "floor_week"));
            registerFunction("floor_day", HiveFloorDate.DAY, hToken(HiveParser.Identifier, "floor_day"));
            registerFunction("floor_hour", HiveFloorDate.HOUR, hToken(HiveParser.Identifier, "floor_hour"));
            registerFunction("floor_minute", HiveFloorDate.MINUTE, hToken(HiveParser.Identifier, "floor_minute"));
            registerFunction("floor_second", HiveFloorDate.SECOND, hToken(HiveParser.Identifier, "floor_second"));
            registerFunction("power", SqlStdOperatorTable.POWER, hToken(HiveParser.Identifier, "power"));
            registerDuplicateFunction("pow", SqlStdOperatorTable.POWER, hToken(HiveParser.Identifier, "power"));
            registerFunction("ceil", SqlStdOperatorTable.CEIL, hToken(HiveParser.Identifier, "ceil"));
            registerDuplicateFunction("ceiling", SqlStdOperatorTable.CEIL, hToken(HiveParser.Identifier, "ceil"));
            ...
            registerFunction("concat", HiveConcat.INSTANCE, hToken(HiveParser.Identifier, "concat"));
            registerFunction("substring", SqlStdOperatorTable.SUBSTRING, hToken(HiveParser.Identifier, "substring"));
            ...
            registerFunction("div", SqlStdOperatorTable.DIVIDE_INTEGER, hToken(HiveParser.DIV, "div"));
            ...
            registerFunction("character_length", SqlStdOperatorTable.CHAR_LENGTH, hToken(HiveParser.Identifier, "character_length"));
            registerDuplicateFunction("char_length", SqlStdOperatorTable.CHAR_LENGTH, hToken(HiveParser.Identifier, "character_length"));
            registerFunction("length", SqlStdOperatorTable.CHARACTER_LENGTH, hToken(HiveParser.Identifier, "length"));
            ...
            registerFunction("to_unix_timestamp", HiveToUnixTimestampSqlOperator.INSTANCE, hToken(HiveParser.Identifier, "to_unix_timestamp"));
            registerFunction("unix_timestamp", HiveUnixTimestampSqlOperator.INSTANCE, hToken(HiveParser.Identifier, "unix_timestamp"));
            registerFunction("from_unixtime", HiveFromUnixTimeSqlOperator.INSTANCE, hToken(HiveParser.Identifier, "from_unixtime"));
        ...
        private void registerPlugin(HiveUDFPlugin plugin)
        {
            for (UDFDescriptor udfDesc : plugin.getDescriptors())
            {
                ...
                {
                    registerDuplicateFunction(udfDesc.getFunctionName(), calciteFunction.get(), hToken(HiveParser.Identifier, udfDesc.getFunctionName()));
                }
            }
        ...
        if (calciteAggFn == null)
        {
            ...
            switch (hiveUdfName.toLowerCase())
            {
                case "sum":
                    ...
                    break;
                case "$sum0":
                    calciteAggFn = new HiveSqlSumEmptyIsZeroAggFunction(isDistinct, udfInfo.returnTypeInference, udfInfo.operandTypeInference, udfInfo.operandTypeChecker);
                    break;
                case "count":
                ...
                case "max":
                    ...
                    break;
                case "avg":
                    calciteAggFn = new HiveSqlAverageAggFunction(isDistinct, udfInfo.returnTypeInference, udfInfo.operandTypeInference, udfInfo.operandTypeChecker);
                    break;
                case "std":
                case "stddev":
                case "stddev_pop":
