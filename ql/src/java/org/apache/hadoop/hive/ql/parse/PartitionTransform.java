...
public class PartitionTransform
{
    ...
    {
        return fields.stream().map(field -> new TransformSpec(field.getName(), TransformType.IDENTITY, Optional.empty())).collect(Collectors.toList());
    }
