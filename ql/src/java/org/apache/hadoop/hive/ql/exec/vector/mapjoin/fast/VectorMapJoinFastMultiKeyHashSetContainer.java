 ...
 */
public class VectorMapJoinFastMultiKeyHashSetContainer extends VectorMapJoinFastHashTableContainerBase implements VectorMapJoinBytesHashSet
{
    ...
    public VectorMapJoinFastMultiKeyHashSetContainer(boolean isFullOuter, int initialCapacity, float loadFactor, int writeBuffersSize, long estimatedKeyCount, int numHTs)
    {
        ...
        {
            this.vectorMapJoinFastMultiKeyHashSets[i] = new VectorMapJoinFastMultiKeyHashSet(isFullOuter, initialCapacity, loadFactor, writeBuffersSize, estimatedKeyCount);
        }
