...
public class VectorMapJoinFastBytesHashMapStore implements MemoryEstimate
{
    ...
    public static class HashMapResult extends VectorMapJoinHashMapResult
    {
        ...
        public void setMatch()
        {
            ...
            hashMapStore.writeBuffers.setReadPoint(keyAbsoluteOffset + keyLength, readPos);
        ...
        public ByteSegmentRef internalRead()
        {
            ...
            if (readIndex == 0)
            {
                ...
                } else
                {
                    ...
                    final long referenceAbsoluteOffset = absoluteOffset - KeyRef.AbsoluteOffset.byteLength;
                    hashMapStore.writeBuffers.setReadPoint(referenceAbsoluteOffset, readPos);
                    long relativeNextValueOffset = hashMapStore.writeBuffers.readNByteLong(KeyRef.AbsoluteOffset.byteLength, readPos);
            ...
            } else
            {
                ...
                long relativeNextValueOffset = hashMapStore.writeBuffers.readNByteLong(RelativeOffset.byteLength, readPos);
            ...
            hashMapStore.writeBuffers.getByteSegmentRefToCurrent(byteSegmentRef, nextValueLength, readPos);
    ...
    public long addMore(long refWord, byte[] valueBytes, int valueStart, int valueLength, WriteBuffers.Position unsafeReadPos)
    {
         ...
         */
        final long referenceAbsoluteOffset = KeyRef.getAbsoluteOffset(refWord) - KeyRef.AbsoluteOffset.byteLength;
        ...
        } else
        {
            ...
            long oldPrevRelativeValueOffset = writeBuffers.readNByteLong(referenceAbsoluteOffset, RelativeOffset.byteLength, unsafeReadPos);
    ...
    public void getKey(long refWord, ByteSegmentRef keyByteSegmentRef, WriteBuffers.Position readPos)
    {
