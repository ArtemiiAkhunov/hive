...
public class VectorUDAFSumTimestamp extends VectorAggregateExpression
{
    ...
    public boolean matches(String name, ColumnVector.Type inputColVectorType, ColumnVector.Type outputColVectorType, Mode mode)
    {
         ...
         */
        return name.equals("sum") && inputColVectorType == ColumnVector.Type.TIMESTAMP && outputColVectorType == ColumnVector.Type.DOUBLE && (mode == Mode.PARTIAL1 || mode == Mode.COMPLETE);
    }
