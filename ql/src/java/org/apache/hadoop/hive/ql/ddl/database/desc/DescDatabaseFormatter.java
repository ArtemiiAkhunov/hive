...
abstract class DescDatabaseFormatter
{
    ...
    abstract void showDatabaseDescription(DataOutputStream out, String database, String comment, String location, String managedLocation, String ownerName, PrincipalType ownerType, Map<String, String> params, String connectorName, String remoteDbName) throws HiveException;
    ...
    {
        @Override
        void showDatabaseDescription(DataOutputStream out, String database, String comment, String location, String managedLocation, String ownerName, PrincipalType ownerType, Map<String, String> params, String connectorName, String remoteDbName) throws HiveException
        {
