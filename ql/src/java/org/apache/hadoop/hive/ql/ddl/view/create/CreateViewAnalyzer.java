...
public class CreateViewAnalyzer extends AbstractCreateViewAnalyzer
{
    ...
    private List<FieldSchema> getPartitionColumns(List<FieldSchema> imposedSchema, ASTNode select, TableName viewName, List<String> partitionColumnNames) throws SemanticException
    {
        ...
        List<FieldSchema> partitionColumns = schema.subList(schema.size() - partitionColumnNames.size(), schema.size());
