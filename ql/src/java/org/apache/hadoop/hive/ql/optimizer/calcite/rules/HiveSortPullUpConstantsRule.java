...
public final class HiveSortPullUpConstantsRule
{
    ...
    private static final class HiveSortLimitPullUpConstantsRule extends HiveSortPullUpConstantsRuleBase<HiveSortLimit>
    {
        ...
        protected void buildSort(RelBuilder relBuilder, HiveSortLimit sortNode, Mappings.TargetMapping mapping)
        {
            ...
            relBuilder.sortLimit(sortNode.offset == null ? -1 : RexLiteral.intValue(sortNode.offset), sortNode.fetch == null ? -1 : RexLiteral.intValue(sortNode.fetch), sortFields);
        }
    }

    public static final HiveSortExchangePullUpConstantsRule SORT_EXCHANGE_INSTANCE = new HiveSortExchangePullUpConstantsRule();

    private static final class HiveSortExchangePullUpConstantsRule extends HiveSortPullUpConstantsRuleBase<HiveSortExchange>
    {
    ...
    private abstract static class HiveSortPullUpConstantsRuleBase<T extends SingleRel> extends RelOptRule
    {
        ...
        public void onMatch(RelOptRuleCall call)
        {
            ...
            Map<RexNode, RexNode> conditionsExtracted = RexUtil.predicateConstants(RexNode.class, rexBuilder, predicates.pulledUpPredicates);
            ...
            final Mappings.TargetMapping mapping = RelOptUtil.permutation(Pair.left(newChildExprs), sortNode.getInput().getRowType()).inverse();
