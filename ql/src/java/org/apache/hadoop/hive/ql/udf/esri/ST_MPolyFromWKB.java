...
public class ST_MPolyFromWKB extends ST_Geometry
{
    ...
    public BytesWritable evaluate(BytesWritable wkb, int wkid) throws UDFArgumentException
    {
        ...
        {  // IllegalArgumentException, GeometryException
