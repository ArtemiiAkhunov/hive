...
public interface MessageHandler
{
    ...
    class Context
    {
        ...
        public Context(String dbName, String location, Task<?> precursor, DumpMetaData dmd, HiveConf hiveConf, Hive db, org.apache.hadoop.hive.ql.Context nestedContext, Logger log)
        {
            this.dbName = dbName;
        ...
        public Context(String dbName, String location, Task<?> precursor, DumpMetaData dmd, HiveConf hiveConf, Hive db, org.apache.hadoop.hive.ql.Context nestedContext, Logger log, String dumpDirectory, ReplicationMetricCollector metricCollector)
        {
            this.dbName = dbName;
            this.location = location;
            this.precursor = precursor;
