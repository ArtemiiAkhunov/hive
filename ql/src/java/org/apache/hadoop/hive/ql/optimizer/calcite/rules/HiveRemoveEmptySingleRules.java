...
public class HiveRemoveEmptySingleRules extends PruneEmptyRules
{
    ...
    public static final RelOptRule PROJECT_INSTANCE = RelRule.Config.EMPTY.withDescription("HivePruneEmptyProject").as(PruneEmptyRules.RemoveEmptySingleRule.Config.class).withOperandFor(HiveProject.class, project -> true).withRelBuilderFactory(HiveRelFactories.HIVE_BUILDER).toRule();

    public static final RelOptRule FILTER_INSTANCE = RelRule.Config.EMPTY.withDescription("HivePruneEmptyFilter").as(PruneEmptyRules.RemoveEmptySingleRule.Config.class).withOperandFor(HiveFilter.class, singleRel -> true).withRelBuilderFactory(HiveRelFactories.HIVE_BUILDER).toRule();
        ...
        default PruneEmptyRule toRule()
        {
            return new PruneEmptyRule(this)
            {
                ...
                public void onMatch(RelOptRuleCall call)
                {
                    ...
                    {
                        throw new IllegalStateException("Class JoinLeftEmptyRuleConfig is redundant after fix is merged into Calcite");
                    }
    ...
    {
        return RelRule.Config.EMPTY.withOperandSupplier(b0 -> b0.operand(clazz).inputs(b1 -> b1.operand(RelNode.class).anyInputs(), b2 -> b2.operand(Values.class).predicate(Values::isEmpty).noInputs())).withDescription("HivePruneEmptyJoin(right)").as(JoinRightEmptyRuleConfig.class).withRelBuilderFactory(HiveRelFactories.HIVE_BUILDER).toRule();
    }
        ...
        default PruneEmptyRule toRule()
        {
            return new PruneEmptyRule(this)
            {
                ...
                public void onMatch(RelOptRuleCall call)
                {
                    if (Bug.CALCITE_5294_FIXED)
                    {
                        throw new IllegalStateException("Class JoinRightEmptyRuleConfig is redundant after fix is merged into Calcite");
                    }
    ...
    public static final RelOptRule CORRELATE_RIGHT_INSTANCE = RelRule.Config.EMPTY.withOperandSupplier(b0 -> b0.operand(Correlate.class).inputs(b1 -> b1.operand(RelNode.class).anyInputs(), b2 -> b2.operand(Values.class).predicate(Values::isEmpty).noInputs())).withDescription("PruneEmptyCorrelate(right)").withRelBuilderFactory(HiveRelFactories.HIVE_BUILDER).as(CorrelateRightEmptyRuleConfig.class).toRule();
    public static final RelOptRule CORRELATE_LEFT_INSTANCE = RelRule.Config.EMPTY.withOperandSupplier(b0 -> b0.operand(Correlate.class).inputs(b1 -> b1.operand(Values.class).predicate(Values::isEmpty).noInputs(), b2 -> b2.operand(RelNode.class).anyInputs())).withDescription("PruneEmptyCorrelate(left)").withRelBuilderFactory(HiveRelFactories.HIVE_BUILDER).as(CorrelateLeftEmptyRuleConfig.class).toRule();
    ...
    public static final RelOptRule SORT_INSTANCE = RelRule.Config.EMPTY.withDescription("HivePruneEmptySort").as(PruneEmptyRules.RemoveEmptySingleRule.Config.class).withOperandFor(HiveSortLimit.class, singleRel -> true).withRelBuilderFactory(HiveRelFactories.HIVE_BUILDER).toRule();

    public static final RelOptRule SORT_FETCH_ZERO_INSTANCE = RelRule.Config.EMPTY.withOperandSupplier(b -> b.operand(HiveSortLimit.class).anyInputs()).withDescription("HivePruneSortLimit0").as(PruneEmptyRules.SortFetchZeroRuleConfig.class).withRelBuilderFactory(HiveRelFactories.HIVE_BUILDER).toRule();

    public static final RelOptRule AGGREGATE_INSTANCE = RelRule.Config.EMPTY.withDescription("HivePruneEmptyAggregate").as(PruneEmptyRules.RemoveEmptySingleRule.Config.class).withOperandFor(HiveAggregate.class, Aggregate::isNotGrandTotal).withRelBuilderFactory(HiveRelFactories.HIVE_BUILDER).toRule();

    public static final RelOptRule UNION_INSTANCE = RelRule.Config.EMPTY.withOperandSupplier(b0 -> b0.operand(HiveUnion.class).unorderedInputs(b1 -> b1.operand(Values.class).predicate(Values::isEmpty).noInputs())).withDescription("HivePruneEmptyUnionBranch").as(HiveUnionEmptyPruneRuleConfig.class).withRelBuilderFactory(HiveRelFactories.HIVE_BUILDER).toRule();
    ...
    {
        @Override
        default PruneEmptyRules.PruneEmptyRule toRule()
        {
            return new PruneEmptyRules.PruneEmptyRule(this)
            {
                ...
                public void onMatch(RelOptRuleCall call)
                {
                    ...
                    {
                        throw new IllegalStateException("Class HiveUnionEmptyPruneRuleConfig is redundant after fix is merged into Calcite");
                    }
    ...
    private static boolean isEmpty(RelNode node)
    {
        if (Bug.CALCITE_5293_FIXED)
        {
            throw new IllegalStateException("Method HiveRemoveEmptySingleRules.isEmpty is redundant after fix is merged into Calcite");
        }
