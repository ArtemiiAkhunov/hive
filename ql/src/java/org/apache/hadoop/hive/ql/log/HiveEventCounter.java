...
public class HiveEventCounter extends AbstractAppender
{
    ...
    @PluginFactory
    public static HiveEventCounter createInstance(@PluginAttribute("name") String name, @PluginAttribute("ignoreExceptions") boolean ignoreExceptions, @PluginElement("Layout") Layout layout, @PluginElement("Filters") Filter filter)
    {
        if (name == null)
        {
            name = APPENDER_NAME;
