...
public class AggregationDesc implements java.io.Serializable
{
    ...
    public AggregationDesc(final String genericUDAFName, final GenericUDAFEvaluator genericUDAFEvaluator, final List<ExprNodeDesc> parameters, final boolean distinct, final GenericUDAFEvaluator.Mode mode)
    {
    ...
    public GenericUDAFEvaluator getGenericUDAFEvaluator()
    {
        ...
        try
        {
            return genericUDAFEvaluator = ReflectionUtils.newInstance(Class.forName(genericUDAFEvaluatorClassName, true, Utilities.getSessionSpecifiedClassLoader()).asSubclass(GenericUDAFEvaluator.class), null);
