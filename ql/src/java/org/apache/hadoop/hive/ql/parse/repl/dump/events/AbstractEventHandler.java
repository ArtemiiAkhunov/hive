...
abstract class AbstractEventHandler<T extends EventMessage> implements EventHandler
{
    ...
    protected void writeEncodedDumpFiles(Context withinContext, Iterable<String> files, Path dataPath) throws IOException, SemanticException
    {
    ...
    protected void writeFileEntry(Table table, Partition ptn, String file, Context withinContext) throws IOException, LoginException, HiveFatalException
    {
