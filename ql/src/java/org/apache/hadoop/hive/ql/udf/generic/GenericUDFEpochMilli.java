...
public class GenericUDFEpochMilli extends GenericUDF
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        {
            throw new UDFArgumentTypeException(0, String.format("%s only takes TIMESTAMP, got %s", getFuncName(), arguments[0].getTypeName()));
        }
    ...
    public Object evaluate(DeferredObject[] arguments) throws HiveException
    {
        ...
        result.set(tsOi == null ? tsWithLocalTzOi.getPrimitiveJavaObject(a0).getZonedDateTime().toInstant().toEpochMilli() : tsOi.getPrimitiveJavaObject(a0).toEpochMilli());
        return result;
    }
