...
public class HiveIncrementalRelMdRowCount extends HiveRelMdRowCount
{
    ...
    {
        return JaninoRelMetadataProvider.of(ChainedRelMetadataProvider.of(ImmutableList.of(HiveIncrementalRelMdRowCount.source(materialization), HiveTezModelRelMetadataProvider.DEFAULT)));
    }
