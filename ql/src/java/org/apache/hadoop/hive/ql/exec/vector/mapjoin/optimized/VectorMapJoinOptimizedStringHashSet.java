...
public class VectorMapJoinOptimizedStringHashSet extends VectorMapJoinOptimizedHashSet implements VectorMapJoinBytesHashSet
{
  ...
  */
    ...
    @Override
    public JoinResult contains(byte[] keyBytes, int keyStart, int keyLength, VectorMapJoinHashSetResult hashSetResult) throws IOException
    {
    ...
    public VectorMapJoinOptimizedStringHashSet(boolean isOuterJoin, MapJoinTableContainer originalTableContainer, ReusableGetAdaptor hashMapRowGetter, TableDesc tableDesc)
    {
