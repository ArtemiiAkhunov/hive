...
public class VectorHashKeyWrapperTwoLong extends VectorHashKeyWrapperTwoBase
{
    ...
    public void setHashKey()
    {
        if (isNull0 || isNull1)
        {
            hashcode = (isNull0 && isNull1 ? twoNullHashcode : (isNull0 ? null0Hashcode ^ HashCodeUtil.calculateLongHashCode(longValue1) : HashCodeUtil.calculateLongHashCode(longValue0) ^ null1Hashcode));
        } else
        {
    ...
    public boolean equals(Object that)
    {
        if (that instanceof VectorHashKeyWrapperTwoLong)
        {
            ...
            return isNull0 == keyThat.isNull0 && longValue0 == keyThat.longValue0 && isNull1 == keyThat.isNull1 && longValue1 == keyThat.longValue1;
        }
        return false;
    }
