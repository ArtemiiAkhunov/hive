...
public class MatchPath extends TableFunctionEvaluator
{
    ...
    public static class MatchPathResolver extends TableFunctionResolver
    {
        ...
        {
            SymbolParser syP = new SymbolParser(evaluator.patternStr, evaluator.symInfo.symbolExprsNames, evaluator.symInfo.symbolExprsEvaluators, evaluator.symInfo.symbolExprsOIs);
            syP.parse();
    ...
    public static abstract class SymbolFunction
    {
        ...
        public static SymbolFunctionResult match(SymbolFunction syFn, Object row, PTFPartitionIterator<Object> pItr) throws HiveException
        {
        ...
        protected abstract SymbolFunctionResult match(Object row, PTFPartitionIterator<Object> pItr) throws HiveException;
    ...
    public static class Symbol extends SymbolFunction
    {
        ...
        public Symbol(ExprNodeEvaluator symbolExprEval, ObjectInspector symbolOI)
        {
            ...
            converter = ObjectInspectorConverters.getConverter(symbolOI, PrimitiveObjectInspectorFactory.javaBooleanObjectInspector);
        }

        @Override
        protected SymbolFunctionResult match(Object row, PTFPartitionIterator<Object> pItr) throws HiveException
        {
            Object val = null;
    ...
    public static class ResultExpressionParser
    {
        ...
        public static ExprNodeDesc buildExprNode(ASTNode expr, TypeCheckCtx typeCheckCtx) throws SemanticException
        {
            ...
            Map<ASTNode, ExprNodeDesc> map = ExprNodeTypeCheck.genExprNode(expr, typeCheckCtx);
    ...
    public static Object getSelectListInput(Object currRow, ObjectInspector rowOI, PTFPartitionIterator<Object> pItr, int sz) throws HiveException
    {
        ArrayList<Object> oRow = new ArrayList<Object>();
    ...
    public static ArrayList<Object> getPath(Object currRow, ObjectInspector rowOI, PTFPartitionIterator<Object> pItr, int sz) throws HiveException
    {
