...
public class HiveCalciteUtil
{
    ...
    public static class JoinPredicateInfo
    {
        ...
        public static JoinPredicateInfo constructJoinPredicateInfo(List<RelNode> inputs, List<RelDataTypeField> systemFieldList, RexNode predicate) throws CalciteSemanticException
        {
    ...
    public static class JoinLeafPredicateInfo
    {
        ...
        private static JoinLeafPredicateInfo constructJoinLeafPredicateInfo(List<RelNode> inputs, List<RelDataTypeField> systemFieldList, RexNode pe) throws CalciteSemanticException
        {
            JoinLeafPredicateInfo jlpi = null;
            ...
            RexNode otherConditions = HiveRelOptUtil.splitHiveJoinCondition(systemFieldList, inputs, pe, joinExprs, filterNulls, new ArrayList<SqlOperator>());
    ...
    public List<RexNode> getDeterministicFuncWithSingleInputRef(List<RexNode> exprs, final Set<Integer> validInputRefs)
    {
    ...
    public static boolean isDeterministicFuncWithSingleInputRef(RexNode expr, final Set<Integer> validInputRefs)
    {
    ...
    public static HiveProject createProjectWithoutColumn(RelNode input, Set<Integer> positions) throws CalciteSemanticException
    {
        List<RexNode> originalInputRefs = Lists.transform(input.getRowType().getFieldList(), new Function<RelDataTypeField, RexNode>()
        {
            @Override
    ...
    public static boolean isLiteral(RexNode expr)
    {
        if (expr instanceof RexCall)
        {
            ...
            if (call.getOperator() == SqlStdOperatorTable.ROW || call.getOperator() == SqlStdOperatorTable.ARRAY_VALUE_CONSTRUCTOR || call.getOperator() == SqlStdOperatorTable.MAP_VALUE_CONSTRUCTOR)
            {
     ...
     */
    public static List<RexNode> fixNullability(final RexBuilder rexBuilder, List<RexNode> nodes, final List<RelDataType> fieldTypes)
    {
     ...
     * <p>Throws if there any greater inconsistencies of type.
     */
    public static RexNode fixNullability(final RexBuilder rexBuilder, RexNode node, final List<RelDataType> fieldTypes)
    {
