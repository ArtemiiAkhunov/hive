...
public class PartitionDesc implements Serializable, Cloneable
{
    ...
    public PartitionDesc(final Partition part, final TableDesc tableDesc) throws HiveException
    {
        ...
        if (Utilities.isInputFileFormatSelfDescribing(this))
        {
            ...
            setProperties(MetaStoreUtils.getSchemaWithoutCols(part.getTPartition().getSd(), part.getParameters(), tbl.getDbName(), tbl.getTableName(), tbl.getPartitionKeys()));
        } else
        {
     ...
     */
    public PartitionDesc(final Partition part, final TableDesc tblDesc, boolean usePartSchemaProperties) throws HiveException
    {
    ...
    private void PartitionDescConstructorHelper(final Partition part, final TableDesc tblDesc, boolean setInputFileFormat) throws HiveException
    {
    ...
    public Deserializer getDeserializer(Configuration conf) throws Exception
    {
        ...
        AbstractSerDe serDe = ReflectionUtil.newInstance(conf.getClassByName(clazzName).asSubclass(AbstractSerDe.class), conf);
    ...
    public boolean equals(Object o)
    {
        ...
        cond = (properties1 == null && properties2 == null) || (properties1 != null && properties1.equals(properties2));
        if (!cond)
        {
            return false;
        }
        ...
        cond = (tableDesc1 == null && tableDesc2 == null) || (tableDesc1 != null && tableDesc1.equals(tableDesc2));
        if (!cond)
        {
            return false;
        }
        ...
        cond = (partSpec1 == null && partSpec2 == null) || (partSpec1 != null && partSpec1.equals(partSpec2));
        if (!cond)
        {
            return false;
        }
    ...
    public int hashCode()
    {
        final int prime = 31;
        int result = 1;
        result = result * prime + (getInputFileFormatClass() == null ? 0 : getInputFileFormatClass().hashCode());
        result = result * prime + (getOutputFileFormatClass() == null ? 0 : getOutputFileFormatClass().hashCode());
        ...
        result = result * prime + (getVectorPartitionDesc() == null ? 0 : getVectorPartitionDesc().hashCode());
        return result;
    }
    ...
    {
        return "PartitionDesc [tableDesc=" + tableDesc + ", partSpec=" + partSpec + ", inputFileFormatClass=" + inputFileFormatClass + ", outputFileFormatClass=" + outputFileFormatClass + ", properties=" + properties + ", baseFileName=" + baseFileName + ", vectorPartitionDesc=" + vectorPartitionDesc + "]";
    }
}
