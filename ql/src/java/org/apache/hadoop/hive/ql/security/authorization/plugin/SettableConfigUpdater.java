...
public class SettableConfigUpdater
{
    ...
    public static void setHiveConfWhiteList(HiveConf hiveConf) throws HiveAuthzPluginException
    {
        ...
        {
            throw new HiveAuthzPluginException("Configuration parameter " + ConfVars.HIVE_AUTHORIZATION_SQL_STD_AUTH_CONFIG_WHITELIST.varname + " is not initialized.");
        }

        // append regexes that user wanted to add
        String whiteListAppend = hiveConf.getVar(ConfVars.HIVE_AUTHORIZATION_SQL_STD_AUTH_CONFIG_WHITELIST_APPEND);
