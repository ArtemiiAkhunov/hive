...
public class ReplCopyWork extends CopyWork
{
    ...
    public ReplCopyWork(final Path srcPath, final Path destPath, boolean errorOnSrcEmpty, boolean overWrite, String dumpDirectory, ReplicationMetricCollector metricCollector)
    {
        this(srcPath, destPath, errorOnSrcEmpty);
        this.overWrite = overWrite;
