...
public class FiltertagAppenderProc implements SemanticNodeProcessor
{
    ...
    public Object process(Node nd, Stack<Node> stack, NodeProcessorCtx procCtx, Object... nodeOutputs) throws SemanticException
    {
        ...
        for (byte pos = 0; pos < filterMap.length; pos++)
        {
            ...
            ExprNodeDesc filterTagExpr = generateFilterTagExpression(filterMap[pos], mapJoinDesc.getFilters().get(pos));
            ...
            ColumnInfo filterTagColumnInfo = new ColumnInfo(Utilities.ReduceField.VALUE + "." + filterColumnName, shortType, "", false);
    ...
    private ExprNodeDesc generateFilterTagMask(byte tag, ExprNodeDesc condition)
    {
        ...
        ExprNodeDesc negate = new ExprNodeGenericFuncDesc(TypeInfoFactory.getPrimitiveTypeInfo(serdeConstants.BOOLEAN_TYPE_NAME), new GenericUDFOPNot(), negateArg);
