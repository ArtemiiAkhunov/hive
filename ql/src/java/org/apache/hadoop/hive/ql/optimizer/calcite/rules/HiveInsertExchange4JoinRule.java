...
public class HiveInsertExchange4JoinRule extends RelOptRule
{
    ...
    protected static transient final Logger LOG = LoggerFactory.getLogger(HiveInsertExchange4JoinRule.class);

    /**
     * Rule that creates Exchange operators under a MultiJoin operator.
     */
    public static final HiveInsertExchange4JoinRule EXCHANGE_BELOW_MULTIJOIN = new HiveInsertExchange4JoinRule(HiveMultiJoin.class);
