...
public class MaterializedViewUpdateDesc implements DDLDesc, Serializable
{
    ...
    public MaterializedViewUpdateDesc(String name, boolean retrieveAndInclude, boolean disableRewrite, boolean updateCreationMetadata)
    {
        this.name = name;
    ...
    @Explain(displayName = "retrieve and include", displayOnlyOnTrue = true, explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED})
    public boolean isRetrieveAndInclude()
    {
        return retrieveAndInclude;
    }

    @Explain(displayName = "disable rewrite", displayOnlyOnTrue = true, explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED})
    public boolean isDisableRewrite()
    {
        return disableRewrite;
    }

    @Explain(displayName = "update creation metadata", displayOnlyOnTrue = true, explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED})
