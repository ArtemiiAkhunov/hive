...
@VectorizedExpressions({LongColLessLongColumn.class, LongColLessDoubleColumn.class, DoubleColLessLongColumn.class, DoubleColLessDoubleColumn.class, LongColLessLongScalar.class, LongColLessDoubleScalar.class, DoubleColLessLongScalar.class, DoubleColLessDoubleScalar.class, LongScalarLessLongColumn.class, LongScalarLessDoubleColumn.class, DoubleScalarLessLongColumn.class, DoubleScalarLessDoubleColumn.class,
        ...
        IntervalYearMonthScalarLessIntervalYearMonthColumn.class, FilterIntervalYearMonthScalarLessIntervalYearMonthColumn.class, IntervalYearMonthColLessIntervalYearMonthScalar.class, FilterIntervalYearMonthColLessIntervalYearMonthScalar.class,

        IntervalDayTimeColLessIntervalDayTimeColumn.class, FilterIntervalDayTimeColLessIntervalDayTimeColumn.class, IntervalDayTimeScalarLessIntervalDayTimeColumn.class, FilterIntervalDayTimeScalarLessIntervalDayTimeColumn.class, IntervalDayTimeColLessIntervalDayTimeScalar.class, FilterIntervalDayTimeColLessIntervalDayTimeScalar.class,

        DateColLessDateScalar.class, FilterDateColLessDateScalar.class, DateScalarLessDateColumn.class, FilterDateScalarLessDateColumn.class,})
