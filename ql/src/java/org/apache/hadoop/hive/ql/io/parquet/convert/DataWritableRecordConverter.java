...
public class DataWritableRecordConverter extends RecordMaterializer<ArrayWritable>
{
    ...
    {
        this.root = new HiveStructConverter(requestedSchema, MessageTypeParser.parseMessageType(metadata.get(DataWritableReadSupport.HIVE_TABLE_AS_PARQUET_SCHEMA)), metadata, hiveTypeInfo);
    }
