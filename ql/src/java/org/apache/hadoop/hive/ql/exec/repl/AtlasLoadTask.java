...
public class AtlasLoadTask extends Task<AtlasLoadWork> implements Serializable
{
    ...
    public int execute()
    {
        try
        {
            ...
            LOG.info("Loading atlas metadata from srcDb: {} to tgtDb: {} from staging: {}", atlasReplInfo.getSrcDB(), atlasReplInfo.getTgtDB(), atlasReplInfo.getStagingDir());
    ...
    AtlasReplInfo createAtlasReplInfo() throws SemanticException, MalformedURLException
    {
        ...
        AtlasReplInfo atlasReplInfo = new AtlasReplInfo(endpoint, work.getSrcDB(), work.getTgtDB(), srcCluster, tgtCluster, work.getStagingDir(), conf);
