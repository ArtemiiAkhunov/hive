...
public class AlterMaterializedViewRewriteDesc implements DDLDescWithWriteId
{
    ...
    @Explain(displayName = "enable", displayOnlyOnTrue = true, explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED})
     ...
     * Only for explaining.
     */
    @Explain(displayName = "disable", displayOnlyOnTrue = true, explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED})
