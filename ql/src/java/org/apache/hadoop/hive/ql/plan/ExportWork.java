...
public class ExportWork implements Serializable
{
     ...
     */
    public ExportWork(String exportRootDirName, TableSpec tableSpec, ReplicationSpec replicationSpec, String astRepresentationForErrorMsg, String acidFqTableName, MmContext mmContext)
    {
    ...
    public void acidPostProcess(Hive db) throws HiveException
    {
        ...
        {
            LOG.info("Swapping export of " + tableSpec.getTableName().getTable() + " to " + acidFqTableName + " using partSpec=" + tableSpec.partSpec);
