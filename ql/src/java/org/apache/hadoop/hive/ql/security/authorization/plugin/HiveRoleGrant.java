...
public class HiveRoleGrant implements Comparable<HiveRoleGrant>
{
    ...
    public int compareTo(HiveRoleGrant other)
    {
        ...
        return ComparisonChain.start().compare(roleName, other.roleName).compare(principalName, other.principalName).compare(principalType, other.principalType).compare(grantOption, other.grantOption).compare(grantTime, other.grantTime).compare(grantor, other.grantor).result();
