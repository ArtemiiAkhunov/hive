...
public class AlterTableSetSkewedLocationAnalyzer extends AbstractAlterTableAnalyzer
{
    ...
    private static final Set<Integer> CONSTANT_TYPES = Sets.newHashSet(HiveParser.Number, HiveParser.StringLiteral, HiveParser.IntegralLiteral, HiveParser.NumberLiteral, HiveParser.CharSetName, HiveParser.KW_TRUE, HiveParser.KW_FALSE);
