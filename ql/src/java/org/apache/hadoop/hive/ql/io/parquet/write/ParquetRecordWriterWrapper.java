...
public class ParquetRecordWriterWrapper implements RecordWriter<NullWritable, ParquetHiveRecord>, StatsProvidingRecordWriter, org.apache.hadoop.hive.ql.exec.FileSinkOperator.RecordWriter
{
    ...
    public ParquetRecordWriterWrapper(final OutputFormat<Void, ParquetHiveRecord> realOutputFormat, final JobConf jobConf, final String name, final Progressable progress, Properties tableProperties) throws IOException
    {
        try
        {
            ...
            realWriter = ((ParquetOutputFormat) realOutputFormat).getRecordWriter(taskContext, this.file);
    ...
    public ParquetRecordWriterWrapper(final ParquetOutputFormat<ParquetHiveRecord> realOutputFormat, final JobConf jobConf, final String name, final Progressable progress) throws IOException
    {
