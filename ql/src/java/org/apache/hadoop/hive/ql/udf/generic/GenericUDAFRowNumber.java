...
@Description(name = "row_number", value = "_FUNC_() - The ROW_NUMBER function assigns a unique number (sequentially, starting " + "from 1, as defined by ORDER BY) to each row within the partition.")
@WindowFunctionDescription(supportsWindow = false, pivotResult = true)
public class GenericUDAFRowNumber extends AbstractGenericUDAFResolver
{
    ...
    public static class GenericUDAFRowNumberEvaluator extends GenericUDAFAbstractRowNumberEvaluator implements ISupportStreamingModeForWindowing
    {
