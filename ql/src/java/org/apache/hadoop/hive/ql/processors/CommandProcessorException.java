...
public class CommandProcessorException extends Exception
{
    ...
    {
        return "(responseCode = " + responseCode + ", errorMessage = " + getMessage() + ", " + (hiveErrorCode > 0 ? "hiveErrorCode = " + hiveErrorCode + ", " : "") + "SQLState = " + sqlState + (getCause() == null ? "" : ", exception = " + getCause().getMessage()) + ")";
    }
