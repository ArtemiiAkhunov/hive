...
public class IfExprLongColumnLongColumn extends VectorExpression
{
    ...
    public void evaluate(VectorizedRowBatch batch) throws HiveException
    {
        ...
        } else /* there are nulls */
        {
            if (batch.selectedInUse)
            {
                ...
                {
                    int i = sel[j];
                    outputVector[i] = (!arg1IsNull[i] && vector1[i] == 1 ? vector2[i] : vector3[i]);
    ...
    {
        return getColumnParamString(0, inputColumnNum[0]) + ", " + getColumnParamString(1, inputColumnNum[1]) + ", " + getColumnParamString(1, inputColumnNum[2]);
    }
