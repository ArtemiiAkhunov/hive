...
public class DemuxDesc extends AbstractOperatorDesc
{
    ...
    public DemuxDesc(Map<Integer, Integer> newTagToOldTag, Map<Integer, Integer> newTagToChildIndex, Map<Integer, Integer> childIndexToOriginalNumParents, List<TableDesc> keysSerializeInfos, List<TableDesc> valuesSerializeInfos)
    {
    ...
    public void setChildIndexToOriginalNumParents(Map<Integer, Integer> childIndexToOriginalNumParents)
    {
        this.childIndexToOriginalNumParents = childIndexToOriginalNumParents;
    }
}
