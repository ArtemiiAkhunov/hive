...
public class VectorPTFEvaluatorLag extends VectorPTFEvaluatorAbstractLeadLag
{
    ...
    public VectorPTFEvaluatorLag(WindowFrameDef windowFrameDef, VectorExpression inputVecExpr, int outputColumnNum, Type type, int amt, VectorExpression defaultValueExpression)
    {
