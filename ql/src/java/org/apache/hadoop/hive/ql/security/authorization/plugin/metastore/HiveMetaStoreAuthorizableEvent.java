...
public abstract class HiveMetaStoreAuthorizableEvent
{
    ...
    {
        return new HivePrivilegeObject(HivePrivilegeObject.HivePrivilegeObjectType.DATABASE, database.getName(), null, null, null, HivePrivilegeObject.HivePrivObjectActionType.OTHER, null, null, database.getOwnerName(), database.getOwnerType());
    }

    protected HivePrivilegeObject getHivePrivilegeObject(Table table)
    {
        return new HivePrivilegeObject(HivePrivilegeObject.HivePrivilegeObjectType.TABLE_OR_VIEW, table.getDbName(), table.getTableName(), null, null, HivePrivilegeObject.HivePrivObjectActionType.OTHER, null, null, table.getOwner(), table.getOwnerType());
    }
    ...
    {
        return new HivePrivilegeObject(HivePrivilegeObject.HivePrivilegeObjectType.DATACONNECTOR, null, connector.getName(), null, null, HivePrivilegeObject.HivePrivObjectActionType.OTHER, null, null, connector.getOwnerName(), connector.getOwnerType());
    }
