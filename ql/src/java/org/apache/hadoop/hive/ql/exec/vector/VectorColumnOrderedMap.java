...
public class VectorColumnOrderedMap
{
    ...
    public void add(int orderedColumn, int valueColumn, TypeInfo typeInfo)
    {
        ...
        {
            throw new RuntimeException(name + " duplicate column " + orderedColumn + " in ordered column map " + orderedTreeMap.toString() + " when adding value column " + valueColumn + ", type into " + typeInfo.toString());
        }
