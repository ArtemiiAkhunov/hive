...
@Description(name = "cume_dist", value = "_FUNC_(x) - The CUME_DIST function (defined as the inverse of percentile in some " + "statistical books) computes the position of a specified value relative to a set of values. " + "To compute the CUME_DIST of a value x in a set S of size N, you use the formula: " + "CUME_DIST(x) =  number of values in S coming before " + "   and including x in the specified order/ N")
...
public class GenericUDAFCumeDist extends GenericUDAFRank
{
    ...
    public static class GenericUDAFCumeDistEvaluator extends GenericUDAFAbstractRankEvaluator
    {
        ...
        public ObjectInspector init(Mode m, ObjectInspector[] parameters) throws HiveException
        {
            ...
            return ObjectInspectorFactory.getStandardListObjectInspector(writableDoubleObjectInspector);
        }
