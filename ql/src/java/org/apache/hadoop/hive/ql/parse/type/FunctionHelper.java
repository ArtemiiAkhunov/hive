...
public interface FunctionHelper
{
     ...
     */
    RelDataType getReturnType(FunctionInfo functionInfo, List<RexNode> inputs) throws SemanticException;
     ...
     */
    List<RexNode> convertInputs(FunctionInfo functionInfo, List<RexNode> inputs, RelDataType returnType) throws SemanticException;
     ...
     * the function call.
     */
    RexNode getExpression(String functionText, FunctionInfo functionInfo, List<RexNode> inputs, RelDataType returnType) throws SemanticException;

    /**
     * Returns aggregation information based on given parameters.
     */
    AggregateInfo getAggregateFunctionInfo(boolean isDistinct, boolean isAllColumns, String aggregateName, List<RexNode> aggregateParameters, List<FieldCollation> fieldCollations) throws SemanticException;

    /**
     * Returns aggregation information for analytical function based on given parameters.
     */
    AggregateInfo getWindowAggregateFunctionInfo(boolean isDistinct, boolean isAllColumns, String aggregateName, List<RexNode> aggregateParameters) throws SemanticException;

    /**
     * Returns RexCall for UDTF from the appropriate function registry based on given parameters
     */
    RexCall getUDTFFunction(String functionName, List<RexNode> operands) throws SemanticException;
    ...
    class AggregateInfo
    {
        ...
        public AggregateInfo(List<RexNode> parameters, TypeInfo returnType, String aggregateName, boolean distinct, List<FieldCollation> collation)
        {
            this.parameters = ImmutableList.copyOf(parameters);
            this.returnType = returnType;
            this.aggregateName = aggregateName;
