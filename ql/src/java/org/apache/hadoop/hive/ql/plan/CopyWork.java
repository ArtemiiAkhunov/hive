...
public class CopyWork implements Serializable, BaseCopyWork
{
    ...
    public CopyWork(final Path fromPath, final Path toPath, boolean errorOnSrcEmpty, String dumpDirectory, ReplicationMetricCollector metricCollector, boolean isReplication)
    {
        this(new Path[]{fromPath}, new Path[]{toPath});
    ...
    public CopyWork(final Path fromPath, final Path toPath, boolean errorOnSrcEmpty, boolean overwrite, String dumpDirectory, ReplicationMetricCollector metricCollector, boolean isReplication)
    {
        this(new Path[]{fromPath}, new Path[]{toPath});
        this.setErrorOnSrcEmpty(errorOnSrcEmpty);
        this.setOverwrite(overwrite);
