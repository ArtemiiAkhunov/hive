...
public class HiveLockObject
{
    ...
    public static class HiveLockObjectData
    {
         ...
         *                 string or not
         */
        public HiveLockObjectData(String queryId, String lockTime, String lockMode, String queryStr, HiveConf conf)
        {
            ...
            this.queryStr = StringInternUtils.internIfNotNull(queryStr == null ? null : StringUtils.abbreviate(removeDelimiter(queryStr.trim()), conf.getIntVar(HiveConf.ConfVars.HIVE_LOCK_QUERY_STRING_MAX_LENGTH)));
        }
        ...
        {
            return queryId + ":" + lockTime + ":" + lockMode + ":" + queryStr + ":" + clientIp;
        }
    ...
    {
        this(new String[]{par.getTable().getDbName(), FileUtils.escapePathName(par.getTable().getTableName()).toLowerCase(), par.getName()}, lockData);
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return StringUtils.equals(this.getName(), tgt.getName()) && (data == null ? tgt.getData() == null : data.equals(tgt.getData()));
    }
