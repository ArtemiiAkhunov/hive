    ...
    public static SplitLocationProvider getSplitLocationProvider(Configuration conf, boolean useCacheAffinity, Logger LOG) throws IOException
    {
        ...
        if (customLocationProvider)
        {
            ...
            try
            {
                ...
                locationProviderImpl = JavaUtils.newInstance(JavaUtils.getClass(locationProviderClass, SplitLocationProvider.class), new Class<?>[]{Configuration.class}, new Object[]{conf});
            } catch (Exception e)
            {
                LOG.warn("Unable to instantiate {} class. Will try no-arg constructor invocation..", locationProviderClass, e);
                try
                {
                    locationProviderImpl = JavaUtils.newInstance(JavaUtils.getClass(locationProviderClass, SplitLocationProvider.class));
                } catch (Exception ex)
                {
