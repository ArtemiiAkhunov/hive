...
public final class ParquetDataColumnReaderFactory
{
        ...
        long validatedLong(long longValue, String typeName, boolean isUnSigned)
        {
            switch (typeName)
            {
                ...
                case serdeConstants.INT_TYPE_NAME:
                    isValid = ((longValue <= Integer.MAX_VALUE) && (longValue >= (isUnSigned ? 0 : Integer.MIN_VALUE)));
                    break;
                case serdeConstants.SMALLINT_TYPE_NAME:
                    isValid = ((longValue <= Short.MAX_VALUE) && (longValue >= (isUnSigned ? 0 : Short.MIN_VALUE)));
                    break;
                case serdeConstants.TINYINT_TYPE_NAME:
                    isValid = ((longValue <= Byte.MAX_VALUE) && (longValue >= (isUnSigned ? 0 : Byte.MIN_VALUE)));
                    break;
                default:
                    isValid = true;
            }
        ...
        double validatedDouble(double doubleValue, String typeName)
        {
            switch (typeName)
            {
                case serdeConstants.FLOAT_TYPE_NAME:
                    ...
                    isValid = ((absDoubleValue <= Float.MAX_VALUE) && (absDoubleValue >= Float.MIN_VALUE) && (exponent <= Float.MAX_EXPONENT) && (exponent >= Float.MIN_EXPONENT));
                    break;
                case serdeConstants.BIGINT_TYPE_NAME:
                    isValid = ((doubleValue <= Long.MAX_VALUE) && (doubleValue >= Long.MIN_VALUE) && (doubleValue % 1 == 0));
                    break;
                case serdeConstants.INT_TYPE_NAME:
                    isValid = ((doubleValue <= Integer.MAX_VALUE) && (doubleValue >= Integer.MIN_VALUE) && (doubleValue % 1 == 0));
                    break;
                case serdeConstants.SMALLINT_TYPE_NAME:
                    isValid = ((doubleValue <= Short.MAX_VALUE) && (doubleValue >= Short.MIN_VALUE) && (doubleValue % 1 == 0));
                    break;
                case serdeConstants.TINYINT_TYPE_NAME:
                    isValid = ((doubleValue <= Byte.MAX_VALUE) && (doubleValue >= Byte.MIN_VALUE) && (doubleValue % 1 == 0));
                    break;
                default:
                    isValid = true;
            }
    ...
    public static class TypesFromUInt64PageReader extends TypesFromInt64PageReader
    {
        ...
        public float readFloat()
        {
            return (float) super.validatedLong(valuesReader.readLong(), serdeConstants.BIGINT_TYPE_NAME, true);
        }

        @Override
        public float readFloat(int id)
        {
            return (float) super.validatedLong(dict.decodeToLong(id), serdeConstants.BIGINT_TYPE_NAME, true);
        }

        @Override
        public double readDouble()
        {
            return (double) super.validatedLong(valuesReader.readLong(), serdeConstants.BIGINT_TYPE_NAME, true);
        }

        @Override
        public double readDouble(int id)
        {
            return (double) super.validatedLong(dict.decodeToLong(id), serdeConstants.BIGINT_TYPE_NAME, true);
        }

        @Override
        public byte[] readDecimal()
        {
            long validatedLongValue = super.validatedLong(valuesReader.readLong(), serdeConstants.BIGINT_TYPE_NAME, true);
            if (super.isValid)
            {
        ...
        public byte[] readDecimal(int id)
        {
            long validatedLongValue = super.validatedLong(dict.decodeToLong(id), serdeConstants.BIGINT_TYPE_NAME, true);
            if (super.isValid)
            {
                return super.validatedDecimal(validatedLongValue);
            } else
    ...
    public static class TypesFromUInt32PageReader extends TypesFromInt32PageReader
    {
        ...
        public float readFloat()
        {
            return (float) super.validatedLong(valuesReader.readInteger(), serdeConstants.BIGINT_TYPE_NAME, true);
        }
        ...
        public double readDouble()
        {
            return (double) super.validatedLong(valuesReader.readInteger(), serdeConstants.BIGINT_TYPE_NAME, true);
        }
        ...
        public byte[] readDecimal()
        {
            long validatedIntValue = super.validatedLong(valuesReader.readInteger(), serdeConstants.INT_TYPE_NAME, true);
            if (super.isValid)
            {
        ...
        public byte[] readDecimal(int id)
        {
            long validatedIntValue = super.validatedLong(dict.decodeToInt(id), serdeConstants.INT_TYPE_NAME, true);
            if (super.isValid)
            {
                return super.validatedDecimal(validatedIntValue);
            } else
    ...
    public static class TypesFromFloatPageReader extends DefaultParquetDataColumnReader
    {
        ...
        public byte[] readVarchar()
        {
            String value = enforceMaxLength(convertToString(valuesReader.readFloat()));
            return convertToBytes(value);
        }
        ...
        public byte[] readVarchar(int id)
        {
            String value = enforceMaxLength(convertToString(dict.decodeToFloat(id)));
            return convertToBytes(value);
        }
        ...
        public long readLong()
        {
            return (long) (super.validatedDouble(valuesReader.readFloat(), serdeConstants.BIGINT_TYPE_NAME));
        }
        ...
        public long readSmallInt()
        {
            return (long) super.validatedDouble(valuesReader.readFloat(), serdeConstants.SMALLINT_TYPE_NAME);
        }
        ...
        public long readTinyInt()
        {
            return (long) super.validatedDouble(valuesReader.readFloat(), serdeConstants.TINYINT_TYPE_NAME);
        }
    ...
    public static class TypesFromDoublePageReader extends DefaultParquetDataColumnReader
    {
        ...
        public byte[] readVarchar()
        {
            String value = enforceMaxLength(convertToString(valuesReader.readDouble()));
            return convertToBytes(value);
        }
        ...
        public byte[] readVarchar(int id)
        {
            String value = enforceMaxLength(convertToString(dict.decodeToDouble(id)));
            return convertToBytes(value);
        }
        ...
        public long readLong()
        {
            return (long) (super.validatedDouble(valuesReader.readDouble(), serdeConstants.BIGINT_TYPE_NAME));
        }

        @Override
        public long readLong(int id)
        {
            return (long) (super.validatedDouble(dict.decodeToDouble(id), serdeConstants.BIGINT_TYPE_NAME));
        }

        @Override
        public long readInteger()
        {
            return (long) (super.validatedDouble(valuesReader.readDouble(), serdeConstants.INT_TYPE_NAME));
        }
        ...
        public float readFloat()
        {
            return (float) (super.validatedDouble(valuesReader.readDouble(), serdeConstants.FLOAT_TYPE_NAME));
        }

        @Override
        public float readFloat(int id)
        {
            return (float) (super.validatedDouble(dict.decodeToDouble(id), serdeConstants.FLOAT_TYPE_NAME));
        }
    ...
    public static class TypesFromBooleanPageReader extends DefaultParquetDataColumnReader
    {
        ...
        public byte[] readVarchar()
        {
            String value = enforceMaxLength(convertToString(valuesReader.readBoolean()));
            return convertToBytes(value);
        }
        ...
        public byte[] readVarchar(int id)
        {
            String value = enforceMaxLength(convertToString(dict.decodeToBoolean(id)));
            return convertToBytes(value);
        }
    ...
    public static class TypesFromInt96PageReader extends DefaultParquetDataColumnReader
    {
        ...
        public TypesFromInt96PageReader(ValuesReader realReader, int length, ZoneId targetZone, boolean legacyConversionEnabled)
        {
            super(realReader, length);
        ...
        public byte[] readVarchar()
        {
            String value = enforceMaxLength(convertToString(readTimestamp()));
            return convertToBytes(value);
        }
        ...
        public byte[] readVarchar(int id)
        {
            String value = enforceMaxLength(convertToString(readTimestamp(id)));
            return convertToBytes(value);
        }
    ...
    public static class TypesFromDecimalPageReader extends DefaultParquetDataColumnReader
    {
        ...
        public byte[] readVarchar()
        {
            String value = enforceMaxLength(convertToString(valuesReader.readBytes()));
            return convertToBytes(value);
        }
        ...
        public byte[] readVarchar(int id)
        {
            String value = enforceMaxLength(convertToString(dict.decodeToBinary(id)));
            return convertToBytes(value);
        }
    ...
    public static ParquetDataColumnReader getDataColumnReaderByTypeOnDictionary(PrimitiveType parquetType, TypeInfo hiveType, Dictionary realReader, boolean skipTimestampConversion, ZoneId writerTimezone, boolean legacyConversionEnabled) throws IOException
    {
        return getDataColumnReaderByTypeHelper(true, parquetType, hiveType, realReader, null, skipTimestampConversion, writerTimezone, legacyConversionEnabled);
    }

    public static ParquetDataColumnReader getDataColumnReaderByType(PrimitiveType parquetType, TypeInfo hiveType, ValuesReader realReader, boolean skipTimestampConversion, ZoneId writerTimezone, boolean legacyConversionEnabled) throws IOException
    {
        return getDataColumnReaderByTypeHelper(false, parquetType, hiveType, null, realReader, skipTimestampConversion, writerTimezone, legacyConversionEnabled);
    }
