...
public abstract class FuncTimestampToTimestamp extends VectorExpression
{
    ...
    protected abstract void func(TimestampColumnVector outputColVector, TimestampColumnVector inputColVector, int i);
    ...
    public VectorExpressionDescriptor.Descriptor getDescriptor()
    {
        ...
        b.setMode(VectorExpressionDescriptor.Mode.PROJECTION).setNumArguments(1).setArgumentTypes(getInputColumnType()).setInputExpressionTypes(VectorExpressionDescriptor.InputExpressionType.COLUMN);
        return b.build();
    }
