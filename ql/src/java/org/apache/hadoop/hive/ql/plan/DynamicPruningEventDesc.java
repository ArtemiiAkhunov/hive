...
public class DynamicPruningEventDesc extends AppMasterEventDesc
{
    ...
    public boolean isSame(OperatorDesc other)
    {
        if (super.isSame(other))
        {
            ...
            return Objects.equals(getTargetColumnName(), otherDesc.getTargetColumnName()) && Objects.equals(getTargetColumnType(), otherDesc.getTargetColumnType()) && Objects.equals(getPartKeyString(), otherDesc.getPartKeyString()) && Objects.equals(getPartPredicateString(), otherDesc.getPartPredicateString());
        }
        return false;
    }
