...
public class GenericUDFValidateAcidSortOrder extends GenericUDF
{
    ...
    public Object evaluate(DeferredObject[] arguments) throws HiveException
    {
        ...
        } else
        {
            ...
            {
                throw new HiveException("One writer is supposed to handle only one bucket. We saw these 2 different buckets: " + bucketNumForWriter + " and " + bucketNum);
            }
        }
        ...
        if (previousWriteIdRowId != null)
        {
            ...
            {
                throw new HiveException("Wrong sort order of Acid rows detected for the rows: " + previousWriteIdRowId.toString() + " and " + current.toString());
            }
        }
