...
public class NumericUDAFEvaluatorResolver extends DefaultUDAFEvaluatorResolver
{
     ...
     */
    @Override
    public Class<? extends UDAFEvaluator> getEvaluatorClass(List<TypeInfo> argTypeInfos) throws UDFArgumentException
    {
        ...
        {
            if (arg.equals(TypeInfoFactory.voidTypeInfo) || arg.equals(TypeInfoFactory.stringTypeInfo))
            {
