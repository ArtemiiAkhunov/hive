...
public class HiveAuthorizationTaskFactoryImpl implements HiveAuthorizationTaskFactory
{
    ...
    @Override
    public Task<?> createDropRoleTask(ASTNode ast, Set<ReadEntity> inputs, Set<WriteEntity> outputs)
    {
        String roleName = BaseSemanticAnalyzer.unescapeIdentifier(ast.getChild(0).getText());
    ...
    @Override
    public Task<?> createGrantRoleTask(ASTNode ast, Set<ReadEntity> inputs, Set<WriteEntity> outputs)
    {
        return analyzeGrantRevokeRole(true, ast, inputs, outputs);
    }

    @Override
    public Task<?> createRevokeRoleTask(ASTNode ast, Set<ReadEntity> inputs, Set<WriteEntity> outputs)
    {
    ...
    @Override
    public Task<?> createSetRoleTask(String roleName, Set<ReadEntity> inputs, Set<WriteEntity> outputs) throws SemanticException
    {
    ...
    @Override
    public Task<?> createShowCurrentRoleTask(Set<ReadEntity> inputs, Set<WriteEntity> outputs, Path resFile) throws SemanticException
    {
    ...
    @Override
    public Task<?> createShowRolesTask(ASTNode ast, Path resFile, Set<ReadEntity> inputs, Set<WriteEntity> outputs) throws SemanticException
    {
