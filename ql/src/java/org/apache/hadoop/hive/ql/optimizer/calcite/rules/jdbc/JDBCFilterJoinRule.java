...
public class JDBCFilterJoinRule extends HiveFilterJoinRule
{
    ...
    {
        super(RelOptRule.operand(HiveFilter.class, RelOptRule.operand(HiveJoin.class, RelOptRule.operand(HiveJdbcConverter.class, RelOptRule.any()), RelOptRule.operand(HiveJdbcConverter.class, RelOptRule.any()))), "JDBCFilterJoinRule", true, HiveRelFactories.HIVE_BUILDER);
    }
