 ...
 */
public class VectorizedParquetInputFormat extends FileInputFormat<NullWritable, VectorizedRowBatch> implements LlapCacheOnlyInputFormatInterface
{
    ...
    {
        return new VectorizedParquetRecordReader(inputSplit, jobConf, metadataCache, dataCache, cacheConf, metadata);
    }
