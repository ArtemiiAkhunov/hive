...
public class PostExecutePrinter implements ExecuteWithHookContext
{
    ...
    public class DependencyKeyComp implements Comparator<Map.Entry<DependencyKey, Dependency>>
    {
        ...
        public int compare(Map.Entry<DependencyKey, Dependency> o1, Map.Entry<DependencyKey, Dependency> o2)
        {
            ...
            } else
            {
                ...
                if (o1.getKey().getDataContainer().isPartition() && o2.getKey().getDataContainer().isPartition())
                {
                    ...
                    ret = o1.getKey().getDataContainer().getPartition().getValues().toString().compareTo(o2.getKey().getDataContainer().getPartition().getValues().toString());
