...
public class GenericUDFBridge extends GenericUDF implements Serializable
{
    ...
    {
        @SuppressWarnings("unchecked") Class<? extends UDF> clazz = (Class<? extends UDF>) Class.forName(udfClassName, true, Utilities.getSessionSpecifiedClassLoader());
    ...
    public Object evaluate(DeferredObject[] arguments) throws HiveException
    {
        ...
        {
            result = HiveDecimalWritable.enforcePrecisionScale((HiveDecimalWritable) result, HiveDecimal.SYSTEM_DEFAULT_PRECISION, HiveDecimal.SYSTEM_DEFAULT_SCALE);
        }
