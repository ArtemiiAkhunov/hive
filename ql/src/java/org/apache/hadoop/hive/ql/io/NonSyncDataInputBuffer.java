...
public class NonSyncDataInputBuffer extends FilterInputStream implements DataInput
{
     ...
     * @param offset the offset the operation start at
     * @param length the maximum number of bytes to read
     * @throws IOException  if a problem occurs while reading from this stream
     * @throws EOFException if reaches the end of the stream before enough bytes have been
     *                      read
     */
    @Override
     ...
     * end of stream.
     * @throws IOException If the DataInputStream is already closed or some other IO error
     *                     occurs.
