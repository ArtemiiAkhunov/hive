...
public class ReduceSinkDesc extends AbstractOperatorDesc
{
    ...
    public ReduceSinkDesc(List<ExprNodeDesc> keyCols, int numDistributionKeys, List<ExprNodeDesc> valueCols, List<String> outputKeyColumnNames, List<List<Integer>> distinctColumnIndices, List<String> outputValueColumnNames, int tag, List<ExprNodeDesc> partitionCols, int numReducers, final TableDesc keySerializeInfo, final TableDesc valueSerializeInfo, AcidUtils.Operation writeType)
    {
        setKeyCols(keyCols);
    ...
    public void setPartitionCols(final List<ExprNodeDesc> partitionCols)
    {
    ...
    {
        return keySerializeInfo.getProperties().getProperty(org.apache.hadoop.hive.serde.serdeConstants.SERIALIZATION_SORT_ORDER);
    }

    public void setOrder(String orderStr)
    {
        keySerializeInfo.getProperties().setProperty(org.apache.hadoop.hive.serde.serdeConstants.SERIALIZATION_SORT_ORDER, orderStr);
    }
    ...
    {
        return keySerializeInfo.getProperties().getProperty(org.apache.hadoop.hive.serde.serdeConstants.SERIALIZATION_NULL_SORT_ORDER);
    }

    public void setNullOrder(String nullOrderStr)
    {
        keySerializeInfo.getProperties().setProperty(org.apache.hadoop.hive.serde.serdeConstants.SERIALIZATION_NULL_SORT_ORDER, nullOrderStr);
    }
    ...
    private static final Set<String> vectorizableReduceSinkNativeEngines = new LinkedHashSet<String>(Arrays.asList("tez"));
    ...
    public class ReduceSinkOperatorExplainVectorization extends OperatorExplainVectorization
    {
        ...
        public List<String> getKeyColumns()
        {
            ...
            return outputColumnsAndTypesToStringList(vectorReduceSinkInfo.getReduceSinkKeyColumnMap(), vectorReduceSinkInfo.getReduceSinkKeyTypeInfos());
        }
        ...
        public List<String> getValueColumns()
        {
            ...
            return outputColumnsAndTypesToStringList(vectorReduceSinkInfo.getReduceSinkValueColumnMap(), vectorReduceSinkInfo.getReduceSinkValueTypeInfos());
        }
        ...
        public List<String> getBucketColumns()
        {
            ...
            return outputColumnsAndTypesToStringList(vectorReduceSinkInfo.getReduceSinkBucketColumnMap(), vectorReduceSinkInfo.getReduceSinkBucketTypeInfos());
        }
        ...
        public List<String> getPartitionColumns()
        {
            ...
            return outputColumnsAndTypesToStringList(vectorReduceSinkInfo.getReduceSinkPartitionColumnMap(), vectorReduceSinkInfo.getReduceSinkPartitionTypeInfos());
        }
    ...
    public boolean isSame(OperatorDesc other)
    {
        if (getClass().getName().equals(other.getClass().getName()))
        {
            ...
            return ExprNodeDescUtils.isSame(getKeyCols(), otherDesc.getKeyCols()) && ExprNodeDescUtils.isSame(getValueCols(), otherDesc.getValueCols()) && ExprNodeDescUtils.isSame(getPartitionCols(), otherDesc.getPartitionCols()) && getTag() == otherDesc.getTag() && Objects.equals(getOrder(), otherDesc.getOrder()) && getTopN() == otherDesc.getTopN() && isAutoParallel() == otherDesc.isAutoParallel();
        }
        return false;
    }
