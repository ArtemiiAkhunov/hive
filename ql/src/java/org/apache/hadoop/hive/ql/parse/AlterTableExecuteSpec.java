...
public class AlterTableExecuteSpec<T>
{
    ...
    {
        ROLLBACK, EXPIRE_SNAPSHOT, SET_CURRENT_SNAPSHOT, FAST_FORWARD, CHERRY_PICK, DELETE_METADATA, DELETE_ORPHAN_FILES;
    }
    ...
    public static class RollbackSpec
    {
        ...
        public String toString()
        {
            return MoreObjects.toStringHelper(this).add("rollbackType", rollbackType.name()).add("param", param).toString();
        }
    }
    ...
    public static class FastForwardSpec
    {
        ...
        public String toString()
        {
            return MoreObjects.toStringHelper(this).add("sourceBranch", sourceBranch).add("targetBranch", targetBranch).toString();
        }
    }
