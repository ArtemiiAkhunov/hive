...
public class AppMasterEventDesc extends AbstractOperatorDesc
{
    ...
    public boolean isSame(OperatorDesc other)
    {
        if (getClass().getName().equals(other.getClass().getName()))
        {
            ...
            return Objects.equals(getInputName(), otherDesc.getInputName()) && Objects.equals(getVertexName(), otherDesc.getVertexName()) && Objects.equals(getTable(), otherDesc.getTable());
        }
        return false;
    }
