...
public interface HiveHistory
{
    ...
    {
        SESSION_ID, QUERY_ID, TASK_ID, QUERY_RET_CODE, QUERY_NUM_TASKS, QUERY_STRING, TIME, TASK_RET_CODE, TASK_NAME, TASK_HADOOP_ID, TASK_HADOOP_PROGRESS, TASK_COUNTERS, TASK_NUM_MAPPERS, TASK_NUM_REDUCERS, ROWS_INSERTED
    }
     ...
     * @param task
     */
    public void startTask(String queryId, Task<?> task, String taskName);
