...
public class HiveJoinInsertIncrementalRewritingRule extends RelOptRule
{
    ...
    public static final HiveJoinInsertIncrementalRewritingRule INSTANCE = new HiveJoinInsertIncrementalRewritingRule();

    private HiveJoinInsertIncrementalRewritingRule()
    {
        super(operand(Union.class, any()), HiveRelFactories.HIVE_BUILDER, "HiveJoinInsertIncrementalRewritingRule");
    }
