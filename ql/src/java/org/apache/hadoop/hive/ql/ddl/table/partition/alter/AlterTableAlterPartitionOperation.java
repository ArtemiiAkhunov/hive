...
public class AlterTableAlterPartitionOperation extends DDLOperation<AlterTableAlterPartitionDesc>
{
    ...
    private void check(Table tbl) throws HiveException
    {
        ...
        {
            throw new HiveException("Exception while checking type conversion of existing partition values to " + desc.getPartKeySpec() + " : " + e.getMessage());
        }
    }
    ...
    private void checkPartitionValues(Table tbl, int colIndex) throws HiveException
    {
        ...
        List<String> partNames = context.getDb().getPartitionNames(tbl.getDbName(), tbl.getTableName(), (short) -1);
        for (String partName : partNames)
        {
            ...
            {
                throw new HiveException("Exception while converting " + TypeInfoFactory.stringTypeInfo + " to " + expectedType + " for partition : " + partName + ", index: " + colIndex);
            }
        }
    }
