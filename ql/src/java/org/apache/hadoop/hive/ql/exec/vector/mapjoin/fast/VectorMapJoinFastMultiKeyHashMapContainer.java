 ...
 */
public class VectorMapJoinFastMultiKeyHashMapContainer extends VectorMapJoinFastHashTableContainerBase implements VectorMapJoinBytesHashMap
{
    ...
    public VectorMapJoinFastMultiKeyHashMapContainer(boolean isFullOuter, int initialCapacity, float loadFactor, int writeBuffersSize, long estimatedKeyCount, int numHTs)
    {
        ...
        {
            vectorMapJoinFastMultiKeyHashMaps[i] = new VectorMapJoinFastMultiKeyHashMap(isFullOuter, initialCapacity, loadFactor, writeBuffersSize, estimatedKeyCount);
        }
    ...
    public JoinUtil.JoinResult lookup(byte[] keyBytes, int keyStart, int keyLength, VectorMapJoinHashMapResult hashMapResult, MatchTracker matchTracker) throws IOException
    {
        ...
        return vectorMapJoinFastMultiKeyHashMaps[partition].lookup(keyBytes, keyStart, keyLength, hashMapResult, childMatchTracker);
    }
