...
public class CreateTableLikeOperation extends DDLOperation<CreateTableLikeDesc>
{
    ...
    public int execute() throws HiveException
    {
        ...
        if (desc.getLocation() == null && !tbl.isPartitioned() && context.getConf().getBoolVar(HiveConf.ConfVars.HIVESTATSAUTOGATHER))
        {
    ...
    private Table createTableLikeTable(Table table, Map<String, String> originalProperties) throws SemanticException, HiveException
    {
    ...
    private void setStorage(Table table) throws HiveException
    {
        ...
        if (table.getTTable().getSd().getSerdeInfo() != null && table.getTTable().getSd().getSerdeInfo().getParameters() != null)
        {
