...
public class HiveReflectUtil
{
     ...
     */
    protected static <T, E> MethodDispatcherWrapper<T, E> createCalciteMethodDispatcherWrapper(final MethodDispatcher<T> methodDispatcher)
    {
     ...
     */
    protected static <E, T> HiveMethodDispatcher<T, E> createMethodDispatcher(final Class<T> returnClazz, final ReflectiveVisitor visitor, final String methodName, final Class<E> arg0Clazz, final Class... otherArgClasses)
    {
        final List<Class> otherArgClassList = ImmutableList.copyOf(otherArgClasses);
        final VisitDispatcher<ReflectiveVisitor, E> dispatcher = createDispatcher((Class<ReflectiveVisitor>) visitor.getClass(), arg0Clazz);
        return new HiveMethodDispatcher<>(dispatcher, returnClazz, visitor, methodName, arg0Clazz, otherArgClassList);
    }
     ...
     */
    private static <R extends ReflectiveVisitor, E> VisitDispatcher<R, E> createDispatcher(final Class<R> visitorBaseClazz, final Class<E> visiteeBaseClazz)
    {
    ...
    protected static class VisitDispatcher<R extends ReflectiveVisitor, E>
    {
        ...
        public VarArgsFunc lookupVisitFunc(Class<? extends R> visitorClass, Class<? extends E> visiteeClass, String visitMethodName, List<Class> additionalParameterTypes) throws Throwable
        {
            ...
            if (method == null)
            {
                ...
                {
                    Method method1 = ReflectUtil.lookupVisitMethod(visitorClass, visiteeClass, visitMethodName, additionalParameterTypes);
                    MethodHandles.Lookup lookup = MethodHandles.lookup();
                    MethodHandle methodHandle = lookup.unreflect(method1);
                    int argsLength = 1 + method1.getParameterTypes().length;
                    MethodType invokedType = MethodType.methodType(getVarArgsFuncClass(argsLength));
    ...
    protected static class HiveMethodDispatcher<T, E> implements ClassMethodDispatcher<T, E>
    {
        ...
        public HiveMethodDispatcher(final VisitDispatcher<ReflectiveVisitor, E> dispatcher, final Class<T> returnClazz, final ReflectiveVisitor visitor, final String methodName, final Class<E> arg0Clazz, final List<Class> otherArgClassList)
        {
        ...
        public T invoke(Object... args)
        {
            ...
            {
                throw new RuntimeException("While invoking method " + (method != null ? "'" + method + "'" : ""), e);
            }
        }
        ...
        private VarArgsFunc lookupVisitFunc(final Object arg0) throws Throwable
        {
            ...
            VarArgsFunc method = dispatcher.lookupVisitFunc(visitor.getClass(), (Class<? extends E>) arg0.getClass(), methodName, otherArgClassList);
            if (method == null)
            {
        ...
        public void register(Iterable<Class<? extends E>> classes) throws Throwable
        {
            ...
            {
                VarArgsFunc method = dispatcher.lookupVisitFunc(visitor.getClass(), c, methodName, otherArgClassList);
                if (method == null)
                {
                    List<Class> classList = new ArrayList<>();
                    classList.add(arg0Clazz);
    ...
    private static class MethodDispatcherWrapper<T, E> implements ClassMethodDispatcher<T, E>
    {
        ...
        public MethodDispatcherWrapper(final MethodDispatcher<T> methodDispatcher)
        {
