...
public final class GenMRSkewJoinProcessor
{
    ...
    public static void processSkewJoin(JoinOperator joinOp, Task<?> currTask, ParseContext parseCtx) throws SemanticException
    {
        ...
        joinDescriptor.setSkewKeyDefinition(HiveConf.getIntVar(parseCtx.getConf(), HiveConf.ConfVars.HIVE_SKEWJOIN_KEY));
        ...
        for (int i = 0; i < numAliases - 1; i++)
        {
            ...
            newPlan.setNumMapTasks(HiveConf.getIntVar(jc, HiveConf.ConfVars.HIVE_SKEWJOIN_MAPJOIN_NUM_MAP_TASK));
            newPlan.setMinSplitSize(HiveConf.getLongVar(jc, HiveConf.ConfVars.HIVE_SKEWJOIN_MAPJOIN_MIN_SPLIT));
