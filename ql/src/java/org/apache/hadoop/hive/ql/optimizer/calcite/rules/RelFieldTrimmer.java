...
public class RelFieldTrimmer implements ReflectiveVisitor
{
    ...
    protected RelFieldTrimmer(boolean useLMFBasedDispatcher)
    {
        ...
        {
            this.trimFieldsDispatcher = HiveReflectUtil.createMethodDispatcher(TrimResult.class, this, "trimFields", RelNode.class, ImmutableBitSet.class, Set.class);
        } else
        {
            this.trimFieldsDispatcher = HiveReflectUtil.createCalciteMethodDispatcherWrapper(ReflectUtil.createMethodDispatcher(TrimResult.class, this, "trimFields", RelNode.class, ImmutableBitSet.class, Set.class));
        }
    }
    ...
    public RelNode trim(RelBuilder relBuilder, RelNode root)
    {
        try
        {
            ...
            {
                LOG.debug(RelOptUtil.dumpPlan("Plan after trimming unused fields", trimResult.left, SqlExplainFormat.TEXT, SqlExplainLevel.EXPPLAN_ATTRIBUTES));
            }
