...
public class ShowCompactionsDesc implements DDLDesc, Serializable
{
  ...
  // @formatter:on
    ...
    public ShowCompactionsDesc(Path resFile, long compactionId, String dbName, String tbName, String poolName, String compactionType, String compactionStatus, Map<String, String> partSpec, short limit, String orderBy)
    {
