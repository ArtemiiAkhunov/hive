 ...
 */
public abstract class UnenclosedBaseJsonRecordReader extends RecordReader<LongWritable, Text> implements org.apache.hadoop.mapred.RecordReader<LongWritable, Text>
{
    ...
    public boolean next(LongWritable key, Text value) throws IOException
    {
        ...
        {  // That should only ever be true on the very first read in the split
            chr = getNonWhite();
