...
public class ListBucketingPruner extends Transform
{
     ...
     * @param pruner expression node tree
     * @return
     */
    ...
    private static Path[] execute(ParseContext ctx, Partition part, ExprNodeDesc pruner) throws SemanticException
    {
        ...
        } else
        {
            ...
            List<Boolean> nonSkewedValueMatchResult = decideSkewedValueDirSelection(part, pruner, selectedPaths, indexCollection, uniqSkewValues);
    ...
    private static List<Boolean> decideSkewedValueDirSelection(Partition part, ExprNodeDesc pruner, List<Path> selectedPaths, List<List<String>> collections, List<List<String>> uniqSkewedValues) throws SemanticException
    {
        ...
        for (List<String> cell : collections)
        {
            ...
            { // if it is skewed value
                if ((matchResult == null) || matchResult)
                { // add directory to path unless value is false
    ...
    public static class DynamicMultiDimensionalCollection
    {
        ...
        {
            // Calculate unique skewed elements for each skewed column.
            List<List<String>> uniqSkewedElements = DynamicMultiDimensionalCollection.uniqueElementsList(values, ListBucketingPrunerUtils.HIVE_LIST_BUCKETING_DEFAULT_KEY);
         ...
         *
         * @param values skewed value list
