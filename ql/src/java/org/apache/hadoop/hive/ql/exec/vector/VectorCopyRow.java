...
public class VectorCopyRow
{
    ...
    private class DecimalCopyRow extends CopyRow
    {
        ...
        void copy(VectorizedRowBatch inBatch, int inBatchIndex, VectorizedRowBatch outBatch, int outBatchIndex)
        {
            ...
            if (inColVector instanceof DecimalColumnVector)
            {
                ...
                {
                    copyDecimalToDecimal((DecimalColumnVector) inColVector, inBatchIndex, (DecimalColumnVector) outColVector, outBatchIndex);
                } else
                {
                    copyDecimalToDecimal64((DecimalColumnVector) inColVector, inBatchIndex, (Decimal64ColumnVector) outColVector, outBatchIndex);
                }
            } else
            {
                if (outColVector instanceof DecimalColumnVector)
                {
                    copyDecimal64ToDecimal((Decimal64ColumnVector) inColVector, inBatchIndex, (DecimalColumnVector) outColVector, outBatchIndex);
                } else
                {
                    copyDecimal64ToDecimal64((Decimal64ColumnVector) inColVector, inBatchIndex, (Decimal64ColumnVector) outColVector, outBatchIndex);
                }
            }
        }

        private void copyDecimalToDecimal(DecimalColumnVector inColVector, int inBatchIndex, DecimalColumnVector outColVector, int outBatchIndex)
        {
            if (inColVector.isRepeating)
            {
                if (inColVector.noNulls || !inColVector.isNull[0])
        ...
        private void copyDecimalToDecimal64(DecimalColumnVector inColVector, int inBatchIndex, Decimal64ColumnVector outColVector, int outBatchIndex)
        {
            if (inColVector.isRepeating)
            {
                if (inColVector.noNulls || !inColVector.isNull[0])
        ...
        private void copyDecimal64ToDecimal(Decimal64ColumnVector inColVector, int inBatchIndex, DecimalColumnVector outColVector, int outBatchIndex)
        {
            if (inColVector.isRepeating)
            {
                if (inColVector.noNulls || !inColVector.isNull[0])
        ...
        private void copyDecimal64ToDecimal64(Decimal64ColumnVector inColVector, int inBatchIndex, Decimal64ColumnVector outColVector, int outBatchIndex)
        {
            if (inColVector.isRepeating)
            {
                if (inColVector.noNulls || !inColVector.isNull[0])
    ...
    {
        init(columnMapping.getInputColumns(), columnMapping.getOutputColumns(), columnMapping.getTypeInfos());
    }
    ...
    public void init(int[] inputColumnMap, int[] outputColumnMap, TypeInfo[] typeInfos) throws HiveException
    {
