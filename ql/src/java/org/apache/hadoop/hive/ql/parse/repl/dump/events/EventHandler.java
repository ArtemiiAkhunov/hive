...
public interface EventHandler
{
    ...
    class Context
    {
        ...
        public Context(Path eventRoot, Path dumpRoot, Path cmRoot, Hive db, HiveConf hiveConf, ReplicationSpec replicationSpec, ReplScope replScope, ReplScope oldReplScope, Set<String> tablesForBootstrap)
        {
        ...
        DumpMetaData createDmd(EventHandler eventHandler)
        {
            ...
            return new DumpMetaData(eventRoot, eventHandler.dumpType(), eventHandler.fromEventId(), eventHandler.toEventId(), cmRoot, hiveConf);
        }
