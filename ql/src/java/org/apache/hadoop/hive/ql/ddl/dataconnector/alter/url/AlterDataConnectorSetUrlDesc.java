 ...
 */
@Explain(displayName = "Set Connector URL", explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED})
public class AlterDataConnectorSetUrlDesc extends AbstractAlterDataConnectorDesc
{
