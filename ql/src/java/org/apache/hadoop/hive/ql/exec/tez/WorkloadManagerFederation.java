...
public class WorkloadManagerFederation
{
    ...
    public static TezSessionState getSession(TezSessionState session, HiveConf conf, MappingInput input, boolean isUnmanagedLlapMode, WmContext wmContext) throws Exception
    {
    ...
    private static TezSessionState getUnmanagedSession(TezSessionState session, HiveConf conf, Set<String> desiredCounters, boolean isWorkLlapNode, final WmContext wmContext) throws Exception
    {
