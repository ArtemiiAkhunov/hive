...
public class ReplicationState implements Serializable
{
    ...
    public static class PartitionState
    {
        ...
        public PartitionState(String tableName, AlterTableAddPartitionDesc lastReplicatedPartition, AlterTableAddPartitionDesc.PartitionDesc lastProcessedPartSpec, Stage stage)
        {
            this.tableName = tableName;
            this.lastReplicatedPartition = lastReplicatedPartition;
    ...
    {
        return "ReplicationState{" + ", partitionState=" + partitionState + ", lastTableReplicated='" + lastTableReplicated + '\'' + ", functionName='" + functionName + '\'' + '}';
    }
}
