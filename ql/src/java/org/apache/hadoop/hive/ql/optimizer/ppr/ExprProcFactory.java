...
public final class ExprProcFactory extends PrunerExpressionOperatorFactory
{
     ...
     *
     * @param tabAlias The table alias of the partition table that is being considered
     *                 for pruning
     * @param pred     The predicate from which the partition pruner needs to be
     *                 generated
    ...
    public static ExprNodeDesc genPruner(String tabAlias, ExprNodeDesc pred) throws SemanticException
    {
        ...
        Map<Node, Object> outputMap = PrunerUtils.walkExprTree(pred, pprCtx, getColumnProcessor(), getFieldProcessor(), getGenericFuncProcessor(), getDefaultExprProcessor());
