...
class DAGSummary implements PrintSummary
{
    ...
    private long hiveInputRecordsFromHiveCounters(String inputVertexName)
    {
        ...
        String intermediateRecordsCounterName = formattedName(ReduceSinkOperator.Counter.RECORDS_OUT_INTERMEDIATE.toString(), inputVertexName);
        String recordsOutCounterName = formattedName(FileSinkOperator.Counter.RECORDS_OUT.toString(), inputVertexName);
