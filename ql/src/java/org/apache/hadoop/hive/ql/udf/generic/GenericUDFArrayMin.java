 ...
 * @see GenericUDF
 */
@Description(name = "array_min", value = "_FUNC_(array(obj1, obj2,...)) - " + "The function returns the minimum value in array with elements for which order is supported", extended = "Example:\n" + "  > SELECT _FUNC_(array(1, 3, 0, NULL)) FROM src LIMIT 1;\n" + "  0")
