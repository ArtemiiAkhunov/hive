...
public class VectorUDAFComputeBitVectorDecimal extends VectorAggregateExpression
{
    ...
    {
        return name.equals("compute_bit_vector_hll") && outputColVectorType == ColumnVector.Type.BYTES && inputColVectorType == ColumnVector.Type.DECIMAL && (mode == GenericUDAFEvaluator.Mode.PARTIAL1 || mode == GenericUDAFEvaluator.Mode.COMPLETE);
    }
