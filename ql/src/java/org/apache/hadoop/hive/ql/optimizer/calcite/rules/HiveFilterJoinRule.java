...
public abstract class HiveFilterJoinRule extends FilterJoinRule
{
    ...
    protected HiveFilterJoinRule(RelOptRuleOperand operand, String id, boolean smart, RelBuilderFactory relBuilderFactory)
    {
        ...
        super((Config) RelRule.Config.EMPTY.withDescription("HiveFilterJoinRule(" + id + ")").withOperandSupplier(b0 -> b0.exactly(operand)).as(FilterJoinRule.Config.class).withSmart(smart).withPredicate((join, joinType, exp) -> true).withRelBuilderFactory(relBuilderFactory));
    }
    ...
    public static class HiveFilterNonFilteringJoinMergeRule extends HiveFilterJoinMergeRule
    {
        ...
        public boolean matches(RelOptRuleCall call)
        {
            ...
            RewritablePKFKJoinInfo joinInfo = HiveRelOptUtil.isRewritablePKFKJoin(join, join.getLeft(), join.getRight(), call.getMetadataQuery());
    ...
    public static class HiveFilterJoinMergeRule extends HiveFilterJoinRule
    {
        ...
        {
            super(operand(Filter.class, operand(Join.class, any())), HiveFilterJoinMergeRule.class.getSimpleName(), true, HiveRelFactories.HIVE_BUILDER);
        }
    ...
    public static class HiveFilterJoinTransposeRule extends HiveFilterJoinRule
    {
        ...
        {
            super(RelOptRule.operand(Join.class, RelOptRule.any()), HiveFilterJoinTransposeRule.class.getSimpleName(), true, HiveRelFactories.HIVE_BUILDER);
        }
