...
public interface Repeated extends ConverterParent
{
    ...
    class RepeatedPrimitiveConverter extends RepeatedConverterParent
    {
        ...
        public void parentEnd()
        {
            parent.set(index, new ArrayWritable(Writable.class, list.toArray(new Writable[list.size()])));
        }
     ...
     * ArrayWritable.
     */
    class RepeatedGroupConverter extends HiveGroupConverter implements Repeated
    {
