...
public class HiveMaterializedViewBoxing
{
    ...
    private static final class BoxingRelShuttle extends HiveRelShuttleImpl
    {
        ...
        public RelNode visit(HiveJoin join)
        {
            ...
            return newJoin.copy(newJoin.getTraitSet(), ImmutableList.of(leftInput, rightInput));
        }
        ...
        {
            final Multimap<Class<? extends RelNode>, RelNode> m = mq.getNodeTypes(rel);
    ...
    protected static final class Box extends TableScan implements HiveRelNode
    {
        ...
        {
            super(cluster, TraitsUtil.getDefaultTraitSet(cluster), new BoxRelOptTable(null, name, eqRelNode.getRowType()));
