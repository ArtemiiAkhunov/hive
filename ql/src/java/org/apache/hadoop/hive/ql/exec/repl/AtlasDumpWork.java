...
public class AtlasDumpWork implements Serializable
{
    ...
    public AtlasDumpWork(String srcDB, Path stagingDir, boolean bootstrap, Path prevAtlasDumpDir, Path tableListPath, ReplicationMetricCollector metricCollector)
    {
        this.srcDB = srcDB;
