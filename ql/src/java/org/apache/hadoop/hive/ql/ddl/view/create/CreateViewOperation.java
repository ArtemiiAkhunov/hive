...
public class CreateViewOperation extends DDLOperation<CreateViewDesc>
{
    ...
    public int execute() throws HiveException
    {
        ...
        if (oldview != null)
        {
            ...
            DDLUtils.addIfAbsentByName(new WriteEntity(oldview, WriteEntity.WriteType.DDL_NO_LOCK), context.getWork().getOutputs());
        } else
        {
            // We create new view
            Table view = createViewObject();
            context.getDb().createTable(view, desc.getIfNotExists());
            DDLUtils.addIfAbsentByName(new WriteEntity(view, WriteEntity.WriteType.DDL_NO_LOCK), context.getWork().getOutputs());
