...
public class VectorMapJoinInfo
{
    ...
    public void setSlimmedBigTableValueExpressions(VectorExpression[] slimmedBigTableValueExpressions)
    {
    ...
    public void setFullOuterSmallTableKeyMapping(VectorColumnSourceMapping fullOuterSmallTableKeyMapping)
    {
