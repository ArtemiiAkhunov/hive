...
public final class DDLSemanticAnalyzerFactory
{
    ...
    static
    {
        Set<Class<? extends BaseSemanticAnalyzer>> analyzerClasses = new Reflections(DDL_ROOT).getSubTypesOf(BaseSemanticAnalyzer.class);
        ...
        Set<Class<? extends DDLSemanticAnalyzerCategory>> analyzerCategoryClasses = new Reflections(DDL_ROOT).getSubTypesOf(DDLSemanticAnalyzerCategory.class);
