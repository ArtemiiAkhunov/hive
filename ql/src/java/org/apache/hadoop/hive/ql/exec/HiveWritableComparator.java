...
class HiveWritableComparator extends WritableComparator
{
    ...
    public int compare(Object key1, Object key2)
    {
        ...
        if ((key1 instanceof DoubleWritable && key2 instanceof DoubleWritable && ((DoubleWritable) key1).get() == 0.0d && ((DoubleWritable) key2).get() == 0.0d) || (key1 instanceof FloatWritable && key2 instanceof FloatWritable && ((FloatWritable) key1).get() == 0.0f && ((FloatWritable) key2).get() == 0.0f))
        {
            return 0;
        }
