...
public class BootstrapDumpFunction extends ReplState
{
    ...
    public BootstrapDumpFunction(String dbName, String funcName, long functionSeqNo, long estimatedNumFunctions)
    {
        this.dbName = dbName;
        this.functionName = funcName;
        this.functionsDumpProgress = new String(new StringBuilder().append(functionSeqNo).append("/").append(estimatedNumFunctions));
