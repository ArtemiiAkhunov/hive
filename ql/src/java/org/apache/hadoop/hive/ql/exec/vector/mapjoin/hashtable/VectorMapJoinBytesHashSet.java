 ...
 */
public interface VectorMapJoinBytesHashSet extends VectorMapJoinBytesHashTable, VectorMapJoinHashSet
{
     ...
     */
    JoinUtil.JoinResult contains(byte[] keyBytes, int keyStart, int keyLength, VectorMapJoinHashSetResult hashSetResult) throws IOException;
