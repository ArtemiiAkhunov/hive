...
public class VectorReduceSinkStringOperator extends VectorReduceSinkUniformHashOperator
{
    ...
    public VectorReduceSinkStringOperator(CompilationOpContext ctx, OperatorDesc conf, VectorizationContext vContext, VectorDesc vectorDesc) throws HiveException
    {
    ...
    protected void initializeOp(Configuration hconf) throws HiveException
    {
        ...
        serializedKeySeries = new VectorKeySeriesBytesSerialized<BinarySortableSerializeWrite>(singleKeyColumn, keyBinarySortableSerializeWrite);
    }
}