...
abstract class AbstractConstraintEventHandler<T extends EventMessage> extends AbstractEventHandler<T>
{
    ...
    {
        return Utils.shouldReplicate(event, withinContext.replicationSpec, withinContext.db, true, withinContext.getTablesForBootstrap(), withinContext.oldReplScope, withinContext.hiveConf);
    }
}
