...
public class VectorMapJoinOptimizedHashSet extends VectorMapJoinOptimizedHashTable implements VectorMapJoinBytesHashSet
{
    ...
    public JoinUtil.JoinResult contains(byte[] keyBytes, int keyOffset, int keyLength, VectorMapJoinHashSetResult hashSetResult) throws IOException
    {
        ...
        JoinUtil.JoinResult joinResult = doLookup(keyBytes, keyOffset, keyLength, implementationHashSetResult.bytesBytesMultiHashMapResult(), (VectorMapJoinHashTableResult) hashSetResult, null);

        return joinResult;
    }

    public VectorMapJoinOptimizedHashSet(MapJoinTableContainer originalTableContainer, ReusableGetAdaptor hashMapRowGetter)
    {
