...
public final class VectorExpressionWriterFactory
{
    ...
    private static abstract class VectorExpressionWriterDecimal extends VectorExpressionWriterBase
    {
        ...
        public Object writeValue(ColumnVector column, int row) throws HiveException
        {
            if (column instanceof Decimal64ColumnVector)
            {
                ...
                {
                    throw new HiveException(String.format("Incorrect null/repeating: row:%d noNulls:%b isRepeating:%b isNull[row]:%b isNull[0]:%b", row, d64cv.noNulls, d64cv.isRepeating, d64cv.isNull[row], d64cv.isNull[0]));
                }
    ...
    public static VectorExpressionWriter genVectorExpressionWritable(ObjectInspector fieldObjInspector) throws HiveException
    {
        ...
        switch (fieldObjInspector.getCategory())
        {
            case PRIMITIVE:
                switch (((PrimitiveObjectInspector) fieldObjInspector).getPrimitiveCategory())
                {
                    ...
                    case INTERVAL_YEAR_MONTH:
                        return genVectorExpressionWritableIntervalYearMonth((SettableHiveIntervalYearMonthObjectInspector) fieldObjInspector);
                    case INTERVAL_DAY_TIME:
                        return genVectorExpressionWritableIntervalDayTime((SettableHiveIntervalDayTimeObjectInspector) fieldObjInspector);
                    case DECIMAL:
            ...
            case LIST:
                return genVectorExpressionWritableList((SettableListObjectInspector) fieldObjInspector);

            case MAP:
                return genVectorExpressionWritableMap((SettableMapObjectInspector) fieldObjInspector);

            case STRUCT:
                return genVectorExpressionWritableStruct((SettableStructObjectInspector) fieldObjInspector);

            case UNION:
                return genVectorExpressionWritableUnion((SettableUnionObjectInspector) fieldObjInspector);
    ...
    private static VectorExpressionWriter genVectorExpressionWritableIntervalYearMonth(SettableHiveIntervalYearMonthObjectInspector fieldObjInspector) throws HiveException
    {
        return new VectorExpressionWriterLong()
        {
            private Object obj;
            ...
            public VectorExpressionWriter init(SettableHiveIntervalYearMonthObjectInspector objInspector) throws HiveException
            {
                super.init(objInspector);
    ...
    private static VectorExpressionWriter genVectorExpressionWritableIntervalDayTime(SettableHiveIntervalDayTimeObjectInspector fieldObjInspector) throws HiveException
    {
    ...
    private static VectorExpressionWriter genVectorExpressionWritableVarchar(SettableHiveVarcharObjectInspector fieldObjInspector) throws HiveException
    {
        return new VectorExpressionWriterBytes()
        {
            ...
            public Object initValue(Object ignored)
            {
                return ((SettableHiveVarcharObjectInspector) this.objectInspector).create(new HiveVarchar(StringUtils.EMPTY, -1));
            }
        }.init(fieldObjInspector);
    }
    ...
    private static VectorExpressionWriter genVectorExpressionWritableBoolean(SettableBooleanObjectInspector fieldObjInspector) throws HiveException
    {
        return new VectorExpressionWriterLong()
        {
            ...
            public Object writeValue(long value) throws HiveException
            {
                ((SettableBooleanObjectInspector) this.objectInspector).set(this.obj, value == 0 ? false : true);
                return this.obj;
            }
            ...
            public Object setValue(Object field, long value) throws HiveException
            {
                ...
                ((SettableBooleanObjectInspector) this.objectInspector).set(field, value == 0 ? false : true);
                return field;
            }
    ...
    private static VectorExpressionWriter genVectorExpressionWritableList(SettableListObjectInspector fieldObjInspector) throws HiveException
    {
        ...
        return new VectorExpressionWriterList()
        {
            ...
            public VectorExpressionWriter init(SettableListObjectInspector objInspector) throws HiveException
            {
                ...
                listTypeInfo = (ListTypeInfo) TypeInfoUtils.getTypeInfoFromTypeString(objInspector.getTypeName());
                return this;
            }
            ...
            public Object writeValue(ColumnVector column, int row) throws HiveException
            {
                ...
                final SettableListObjectInspector listOI = (SettableListObjectInspector) this.objectInspector;
                final List value = (List) vectorExtractRow.extractRowColumn(listColVector, listTypeInfo, listOI, row);
                if (value == null)
                {
                    return null;
                }
            ...
            @Override
            public Object setValue(Object list, ColumnVector column, int row) throws HiveException
            {
                if (list == null)
                {
                    list = initValue(null);
    ...
    private static VectorExpressionWriter genVectorExpressionWritableMap(SettableMapObjectInspector fieldObjInspector) throws HiveException
    {
        ...
        return new VectorExpressionWriterMap()
        {
            ...
            public VectorExpressionWriter init(SettableMapObjectInspector objInspector) throws HiveException
            {
                ...
                obj = initValue(null);
                vectorExtractRow = new VectorExtractRow();
                mapTypeInfo = (MapTypeInfo) TypeInfoUtils.getTypeInfoFromTypeString(objInspector.getTypeName());
                return this;
            }
            ...
            public Object writeValue(ColumnVector column, int row) throws HiveException
            {
                ...
                final SettableMapObjectInspector mapOI = (SettableMapObjectInspector) this.objectInspector;
                final Map<Object, Object> value = (Map<Object, Object>) vectorExtractRow.extractRowColumn(mapColVector, mapTypeInfo, mapOI, row);
                if (value == null)
                {
                    return null;
                }
            ...
            @Override
            public Object setValue(Object map, ColumnVector column, int row) throws HiveException
            {
                if (map == null)
                {
                    map = initValue(null);
    ...
    private static VectorExpressionWriter genVectorExpressionWritableStruct(SettableStructObjectInspector fieldObjInspector) throws HiveException
    {
        ...
        return new VectorExpressionWriterStruct()
        {
            ...
            public VectorExpressionWriter init(SettableStructObjectInspector objInspector) throws HiveException
            {
                ...
                obj = initValue(null);
                vectorExtractRow = new VectorExtractRow();
                structTypeInfo = (StructTypeInfo) TypeInfoUtils.getTypeInfoFromTypeString(objInspector.getTypeName());
                return this;
            }
            ...
            private Object setValueInternal(final Object struct, ColumnVector colVector, int batchIndex)
            {
                ...
                for (int i = 0; i < size; i++)
                {
                    ...
                    final Object value = vectorExtractRow.extractRowColumn(structColumnVector.fields[i], fieldTypeInfo, structField.getFieldObjectInspector(), adjustedIndex);
    ...
    private static VectorExpressionWriter genVectorExpressionWritableUnion(SettableUnionObjectInspector fieldObjInspector) throws HiveException
    {
        ...
        return new VectorExpressionWriterMap()
        {
            ...
            public VectorExpressionWriter init(SettableUnionObjectInspector objInspector) throws HiveException
            {
                ...
                obj = initValue(null);
                vectorExtractRow = new VectorExtractRow();
                unionTypeInfo = (UnionTypeInfo) TypeInfoUtils.getTypeInfoFromTypeString(objInspector.getTypeName());
                return this;
            }
            ...
            public Object writeValue(ColumnVector column, int row) throws HiveException
            {
                ...
                final SettableUnionObjectInspector unionOI = (SettableUnionObjectInspector) this.objectInspector;
                ObjectInspector fieldOI = unionOI.getObjectInspectors().get(tag);
                ColumnVector fieldColVector = unionColumnVector.fields[tag];
                final Object value = vectorExtractRow.extractRowColumn(fieldColVector, unionTypeInfo.getAllUnionObjectTypeInfos().get(tag), fieldOI, row);
                if (value == null)
                {
                    return null;
                }
            ...
            @Override
            public Object setValue(Object union, ColumnVector column, int row) throws HiveException
            {
                if (union == null)
                {
     ...
     * Helper function to create an array of writers from a list of expression descriptors.
     */
    public static VectorExpressionWriter[] getExpressionWriters(VectorExpression[] vecExprs) throws HiveException
    {
