...
public class GenericUDTFStack extends GenericUDTF
{
    ...
    private transient ArrayList<ReturnObjectInspectorResolver> returnOIResolvers = new ArrayList<ReturnObjectInspectorResolver>();
    ...
    public StructObjectInspector initialize(ObjectInspector[] args) throws UDFArgumentException
    {
        ...
        {
            throw new UDFArgumentException("The first argument to STACK() must be a constant.");
        }
        ...
        {
            throw new UDFArgumentTypeException(0, "The first argument to STACK() must be a constant integer (got " + args[0].getTypeName() + " instead).");
        }
