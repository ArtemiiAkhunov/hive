...
public class OpTraits
{
    ...
    public OpTraits(List<List<String>> bucketColNames, int numBuckets, List<List<String>> sortColNames, int numReduceSinks)
    {
    ...
    {
        return "{ bucket column names: " + bucketColNames + "; sort column names: " + sortColNames + "; bucket count: " + numBuckets + "}";
    }
}
