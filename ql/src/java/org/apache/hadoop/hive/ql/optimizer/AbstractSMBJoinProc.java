...
abstract public class AbstractSMBJoinProc extends AbstractBucketJoinProc implements SemanticNodeProcessor
{
    ...
    {
        boolean canConvert = canConvertJoinToBucketMapJoin(joinOperator, smbJoinContext);
