    ...
    private static void verifyFractionType(ObjectInspector oi) throws UDFArgumentTypeException
    {
        ...
        switch (pc)
        {
            ...
            case DECIMAL:
                break;
            default:
                throw new UDFArgumentTypeException(1, "Only a floating point or decimal, or " + "floating point or decimal array argument is accepted as parameter 2, but " + pc + " was passed instead.");
        }
    }
    ...
    public static class GenericUDAFSinglePercentileApproxEvaluator extends GenericUDAFPercentileApproxEvaluator
    {
        ...
        public ObjectInspector init(Mode m, ObjectInspector[] parameters) throws HiveException
        {
            ...
            if (m == Mode.PARTIAL1 || m == Mode.COMPLETE)
            {
                ...
                {
                    nbins = PrimitiveObjectInspectorUtils.getInt(((ConstantObjectInspector) parameters[2]).getWritableConstantValue(), (PrimitiveObjectInspector) parameters[2]);
                }
            } else
            {
    ...
    public abstract static class GenericUDAFPercentileApproxEvaluator extends GenericUDAFEvaluator
    {
        ...
        static class PercentileAggBuf extends AbstractAggregationBuffer
        {
            ...
            public int estimate()
            {
                ...
                return histogram.lengthFor(model) + model.array() + JavaDataModel.PRIMITIVES2 * quantiles.length;
            }
        }
