...
public class PcrOpWalkerCtx implements NodeProcessorCtx
{
    ...
    static public class OpToDeleteInfo
    {
        ...
        public OpToDeleteInfo(Operator<? extends OperatorDesc> parent, FilterOperator operator)
        {
            super();
            this.parent = parent;
     ...
     * Constructor.
     */
    public PcrOpWalkerCtx(ParseContext parseContext, List<OpToDeleteInfo> opToRemove)
    {
