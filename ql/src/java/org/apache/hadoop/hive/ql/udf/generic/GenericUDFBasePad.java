...
public abstract class GenericUDFBasePad extends GenericUDF
{
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException
    {
        ...
        {
            throw new UDFArgumentException(udfName + " requires three arguments. Found :" + arguments.length);
        }
    ...
    protected abstract void performOp(StringBuilder builder, int len, String str, String pad);
    ...
    private Converter checkTextArguments(ObjectInspector[] arguments, int i) throws UDFArgumentException
    {
        ...
        Converter converter = ObjectInspectorConverters.getConverter((PrimitiveObjectInspector) arguments[i], PrimitiveObjectInspectorFactory.writableStringObjectInspector);
