...
public abstract class AbstractAlterTableSetPropertiesAnalyzer extends AbstractAlterTablePropertiesAnalyzer
{
    ...
    protected AbstractAlterTableDesc createDesc(ASTNode command, TableName tableName, Map<String, String> partitionSpec, Map<String, String> properties, boolean isToTxn, boolean isExplicitStatsUpdate, EnvironmentContext environmentContext) throws SemanticException
    {
        ...
        boolean isAcidConversion = isToTxn && AcidUtils.isFullAcidTable(properties) && !AcidUtils.isFullAcidTable(getTable(tableName, true));
        return new AlterTableSetPropertiesDesc(tableName, partitionSpec, null, isView(), properties, isExplicitStatsUpdate, isAcidConversion, environmentContext);
    }
