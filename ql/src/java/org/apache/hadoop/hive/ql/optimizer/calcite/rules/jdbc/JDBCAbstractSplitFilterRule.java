...
public abstract class JDBCAbstractSplitFilterRule extends RelOptRule
{
    ...
    public static class JDBCSplitFilterAboveJoinRule extends JDBCAbstractSplitFilterRule
    {
        ...
        {
            super(operand(HiveFilter.class, operand(HiveJoin.class, operand(HiveJdbcConverter.class, any()))));
        }
        ...
        public boolean matches(RelOptRuleCall call)
        {
            ...
            return canSplitFilter(filter.getCondition(), dialect) && JDBCRexCallValidator.isValidJdbcOperation(joinCond, dialect);
        }
    ...
    public static class JDBCSplitFilterRule extends JDBCAbstractSplitFilterRule
    {
        ...
        {
            super(operand(HiveFilter.class, operand(HiveJdbcConverter.class, any())));
        }
