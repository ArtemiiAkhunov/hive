...
public class AtlasRequestBuilder
{
    ...
    private List<AtlasObjectId> getItemsToExport(AtlasReplInfo atlasReplInfo) throws SemanticException
    {
        ...
        {
            final List<String> tableQualifiedNames = getQualifiedNames(atlasReplInfo.getSrcCluster(), atlasReplInfo.getSrcDB(), atlasReplInfo.getTableListFile(), atlasReplInfo.getConf());
    ...
    private List<String> getQualifiedNames(String clusterName, String srcDb, Path listOfTablesFile, HiveConf conf) throws SemanticException
    {
    ...
    public AtlasImportRequest createImportRequest(String sourceDataSet, String targetDataSet, String sourceClusterName, String targetClusterName, String sourceFsEndpoint, String targetFsEndpoint)
    {
        ...
        addTransforms(request.getOptions(), sourceClusterName, targetClusterName, sourceDataSet, targetDataSet, sourceFsEndpoint, targetFsEndpoint);
    ...
    private void addTransforms(Map<String, String> options, String srcClusterName, String tgtClusterName, String sourceDataSet, String targetDataSet, String sourcefsEndpoint, String targetFsEndpoint)
    {
        ...
        addClassificationTransform(transforms, String.format(REPLICATED_TAG_NAME, sanitizedSourceClusterName));
    ...
    {
        transforms.add(create(HIVE_DB_LOCATION, "STARTS_WITH_IGNORE_CASE: " + srcFsUri, HIVE_DB_LOCATION, "REPLACE_PREFIX: = :" + srcFsUri + "=" + tgtFsUri));
        transforms.add(create(HIVE_SD_LOCATION, "STARTS_WITH_IGNORE_CASE: " + srcFsUri, HIVE_SD_LOCATION, "REPLACE_PREFIX: = :" + srcFsUri + "=" + tgtFsUri));
    }

    private void addDataSetRenameTransform(List<AttributeTransform> transforms, String sourceDataSet, String targetDataSet)
    {
        transforms.add(create(HIVE_DB_NAME, "EQUALS: " + sourceDataSet, HIVE_DB_NAME, "SET: " + targetDataSet));
    }

    private void addClusterRenameTransform(List<AttributeTransform> transforms, String srcClusterName, String tgtClustername)
    {
        transforms.add(create(HIVE_DB_CLUSTER_NAME, "EQUALS: " + srcClusterName, HIVE_DB_CLUSTER_NAME, "SET: " + tgtClustername));
    }
    ...
    {
        transforms.add(create("__entity", "topLevel: ", "__entity", "ADD_CLASSIFICATION: " + classificationName));
    }
