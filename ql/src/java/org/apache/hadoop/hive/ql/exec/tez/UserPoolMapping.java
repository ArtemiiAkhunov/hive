...
class UserPoolMapping
{
    ...
    private final Map<String, Mapping> userMappings = new HashMap<>(), groupMappings = new HashMap<>(), appMappings = new HashMap<>();
    ...
    private final static class Mapping
    {
        ...
        {
            return "[" + (fullPoolName == null ? "unmanaged" : fullPoolName) + ", priority=" + priority + "]";
        }
    }
    ...
    public static final class MappingInput
    {
        ...
        public String toString()
        {
            return "{" + userName + "; app " + appName + "; pool " + wmPool + "; groups " + groups + "}";
        }
