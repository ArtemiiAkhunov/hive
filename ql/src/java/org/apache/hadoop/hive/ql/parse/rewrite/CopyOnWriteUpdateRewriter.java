...
public class CopyOnWriteUpdateRewriter implements Rewriter<UpdateStatement>
{
    ...
    public ParseUtils.ReparseResult rewrite(Context context, UpdateStatement updateBlock) throws SemanticException
    {
        ...
        ASTNode rewrittenInsert = (ASTNode) (!shouldOverwrite ? new CalcitePlanner.ASTSearcher().simpleBreadthFirstSearch(rewrittenTree, HiveParser.TOK_FROM, HiveParser.TOK_SUBQUERY, HiveParser.TOK_UNIONALL).getChild(0).getChild(0) : rewrittenTree).getChild(1);
