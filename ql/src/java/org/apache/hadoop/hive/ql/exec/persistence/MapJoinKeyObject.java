...
public class MapJoinKeyObject extends MapJoinKey
{
    ...
    {
        @SuppressWarnings("unchecked") List<Object> value = (List<Object>) ObjectInspectorUtils.copyToStandardObject(obj, oi, ObjectInspectorCopyOption.WRITABLE);
        if (value == null)
        {
    ...
    public void readFromRow(Object[] fieldObjs, List<ObjectInspector> keyFieldsOI) throws HiveException
    {
        ...
        {
            key[keyIndex] = (ObjectInspectorUtils.copyToStandardObject(fieldObjs[keyIndex], keyFieldsOI.get(keyIndex), ObjectInspectorCopyOption.WRITABLE));
        }
    }
    ...
    public void readFromVector(VectorHashKeyWrapperBase kw, VectorExpressionWriter[] keyOutputWriters, VectorHashKeyWrapperBatch keyWrapperBatch) throws HiveException
    {
        ...
        {
            key[keyIndex] = keyWrapperBatch.getWritableKeyValue(kw, keyIndex, keyOutputWriters[keyIndex]);
        }
    }
}
