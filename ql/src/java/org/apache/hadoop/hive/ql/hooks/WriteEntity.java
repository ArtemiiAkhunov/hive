...
public class WriteEntity extends Entity implements Serializable
{
    ...
    public static enum WriteType
    {
        ...
        INSERT, INSERT_OVERWRITE, UPDATE, DELETE, CTAS, PATH_WRITE, // Write to a URI, no locking done for this
    }
     ...
     * @param d       The name of the directory that is being written to.
     * @param isLocal Flag to decide whether this directory is local or in dfs.
     * @param isTemp  True if this is a temporary location such as scratch dir
     */
