...
public class JoinTypeCheckCtx extends TypeCheckCtx
{
    ...
    public JoinTypeCheckCtx(RowResolver leftRR, RowResolver rightRR, RexBuilder rexBuilder, JoinType hiveJoinType) throws SemanticException
    {
        super(RowResolver.getCombinedRR(leftRR, rightRR), rexBuilder, true, false, false, false, false, false, false, false, true, false);
        this.inputRRLst = ImmutableList.of(leftRR, rightRR);
        this.outerJoin = (hiveJoinType == JoinType.LEFTOUTER) || (hiveJoinType == JoinType.RIGHTOUTER) || (hiveJoinType == JoinType.FULLOUTER);
    }
