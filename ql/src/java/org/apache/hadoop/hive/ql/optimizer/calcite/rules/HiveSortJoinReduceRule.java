...
public class HiveSortJoinReduceRule extends RelOptRule
{
    ...
    {
        super(operand(HiveSortLimit.class, operand(HiveJoin.class, any())));
    }
    ...
    public void onMatch(RelOptRuleCall call)
    {
        ...
        if (join.getJoinType() == JoinRelType.LEFT)
        {
            inputLeft = sortLimit.copy(sortLimit.getTraitSet(), inputLeft, sortLimit.getCollation(), inputOffset, inputLimit);
        ...
        } else
        {
            ...
            inputRight = sortLimit.copy(sortLimit.getTraitSet().replace(rightCollation), inputRight, rightCollation, inputOffset, inputLimit);
