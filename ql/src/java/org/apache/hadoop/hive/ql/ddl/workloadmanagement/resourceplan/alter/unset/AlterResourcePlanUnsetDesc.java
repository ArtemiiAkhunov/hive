...
public class AlterResourcePlanUnsetDesc implements DDLDesc, Serializable
{
    ...
    @Explain(displayName = "Unset Query parallelism", displayOnlyOnTrue = true, explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED})
    public boolean isUnsetQueryParallelism()
    {
        return unsetQueryParallelism;
    }

    @Explain(displayName = "Unset Default Pool", displayOnlyOnTrue = true, explainLevels = {Level.USER, Level.DEFAULT, Level.EXTENDED})
