...
public class VectorExpressionDescriptor
{
    ...
    {
        NONE(0x000000L), INT_FAMILY(0x000001L), FLOAT(0x000002L), DOUBLE(0x000004L), FLOAT_FAMILY(FLOAT.value | DOUBLE.value), DECIMAL(0x000008L), STRING(0x000010L), CHAR(0x000020L), VARCHAR(0x000040L), STRING_FAMILY(STRING.value | CHAR.value | VARCHAR.value), DATE(0x000080L), TIMESTAMP(0x000100L), INTERVAL_YEAR_MONTH(0x000200L), INTERVAL_DAY_TIME(0x000400L), BINARY(0x000800L), STRUCT(0x001000L), DECIMAL_64(0x002000L), LIST(0x004000L), MAP(0x008000L), VOID(0x010000L), INT_DECIMAL_64_FAMILY(INT_FAMILY.value | DECIMAL_64.value), DATETIME_FAMILY(DATE.value | TIMESTAMP.value), INTERVAL_FAMILY(INTERVAL_YEAR_MONTH.value | INTERVAL_DAY_TIME.value), INT_INTERVAL_YEAR_MONTH(INT_FAMILY.value | INTERVAL_YEAR_MONTH.value), INT_DATE_INTERVAL_YEAR_MONTH(INT_FAMILY.value | DATE.value | INTERVAL_YEAR_MONTH.value), STRING_DATETIME_FAMILY(STRING_FAMILY.value | DATETIME_FAMILY.value), STRING_FAMILY_BINARY(STRING_FAMILY.value | BINARY.value), STRING_BINARY(STRING.value | BINARY.value), ALL_FAMILY(0xFFFFFFL);
    ...
    {
        NONE(0), COLUMN(1), SCALAR(2), DYNAMICVALUE(3), NULLSCALAR(4);
