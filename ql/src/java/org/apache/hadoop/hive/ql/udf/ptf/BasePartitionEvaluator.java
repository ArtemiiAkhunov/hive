...
public class BasePartitionEvaluator
{
    ...
    public BasePartitionEvaluator(GenericUDAFEvaluator wrappedEvaluator, WindowFrameDef winFrame, PTFPartition partition, List<PTFExpressionDef> parameters, ObjectInspector outputOI, boolean nullsLast)
    {
        ...
        LOG.info("isCountEvaluator: {}, parameters count: {}", isCountEvaluator, (parameters != null) ? parameters.size() : 0);
    }
    ...
    public static abstract class SumPartitionEvaluator<ResultType extends Writable> extends BasePartitionEvaluator
    {
        ...
        public SumPartitionEvaluator(GenericUDAFEvaluator wrappedEvaluator, WindowFrameDef winFrame, PTFPartition partition, List<PTFExpressionDef> parameters, ObjectInspector outputOI, boolean nullsLast)
        {
        ...
        public Object iterate(int currentRow, LeadLagInfo leadLagInfo) throws HiveException
        {
            ...
            if (currentRow == 0 ||  // Reset for the new partition
                    sumAgg.prevRange == null || currentRange.getSize() <= currentRange.getDiff(sumAgg.prevRange))
            {
    ...
    {
        public SumPartitionDoubleEvaluator(GenericUDAFEvaluator wrappedEvaluator, WindowFrameDef winFrame, PTFPartition partition, List<PTFExpressionDef> parameters, ObjectInspector outputOI, boolean nullsLast)
        {
            super(wrappedEvaluator, winFrame, partition, parameters, outputOI, nullsLast);
    ...
    {
        public SumPartitionLongEvaluator(GenericUDAFEvaluator wrappedEvaluator, WindowFrameDef winFrame, PTFPartition partition, List<PTFExpressionDef> parameters, ObjectInspector outputOI, boolean nullsLast)
        {
            super(wrappedEvaluator, winFrame, partition, parameters, outputOI, nullsLast);
    ...
    {
        public SumPartitionHiveDecimalEvaluator(GenericUDAFEvaluator wrappedEvaluator, WindowFrameDef winFrame, PTFPartition partition, List<PTFExpressionDef> parameters, ObjectInspector outputOI, boolean nullsLast)
        {
            super(wrappedEvaluator, winFrame, partition, parameters, outputOI, nullsLast);
    ...
    public static abstract class AvgPartitionEvaluator<ResultType extends Writable> extends BasePartitionEvaluator
    {
        ...
        public AvgPartitionEvaluator(GenericUDAFEvaluator wrappedEvaluator, WindowFrameDef winFrame, PTFPartition partition, List<PTFExpressionDef> parameters, ObjectInspector outputOI, boolean nullsLast)
        {
            super(wrappedEvaluator, winFrame, partition, parameters, outputOI, nullsLast);
        }
         ...
         */
        private Object[] calcPartialResult(PTFPartitionIterator<Object> pItr, LeadLagInfo leadLagInfo) throws HiveException
        {
            // To handle the case like SUM(LAG(f)) over(), aggregation function includes
            // LAG/LEAD call
            PTFOperator.connectLeadLagFunctionsToPartition(leadLagInfo, pItr);
        ...
        public Object iterate(int currentRow, LeadLagInfo leadLagInfo) throws HiveException
        {
            ...
            Range currentRange = PTFRangeUtil.getRange(winFrame, currentRow, partition, nullsLast);
            if (currentRow == 0 ||  // Reset for the new partition
                    avgAgg.prevRange == null || currentRange.getSize() <= currentRange.getDiff(avgAgg.prevRange))
            {
    ...
    public static class AvgPartitionDoubleEvaluator extends AvgPartitionEvaluator<DoubleWritable>
    {
        ...
        public AvgPartitionDoubleEvaluator(GenericUDAFEvaluator wrappedEvaluator, WindowFrameDef winFrame, PTFPartition partition, List<PTFExpressionDef> parameters, ObjectInspector inputOI, ObjectInspector outputOI, boolean nullsLast) throws HiveException
        {
            super(wrappedEvaluator, winFrame, partition, parameters, outputOI, nullsLast);
            this.typeOperation = new TypeOperationDoubleWritable();
        }
    ...
    public static class AvgPartitionHiveDecimalEvaluator extends AvgPartitionEvaluator<HiveDecimalWritable>
    {
        ...
        public AvgPartitionHiveDecimalEvaluator(GenericUDAFEvaluator wrappedEvaluator, WindowFrameDef winFrame, PTFPartition partition, List<PTFExpressionDef> parameters, ObjectInspector inputOI, ObjectInspector outputOI, boolean nullsLast) throws HiveException
        {
            super(wrappedEvaluator, winFrame, partition, parameters, outputOI, nullsLast);
            this.typeOperation = new TypeOperationHiveDecimalWritable();
        }
