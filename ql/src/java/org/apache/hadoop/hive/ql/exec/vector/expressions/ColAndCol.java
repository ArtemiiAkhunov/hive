    ...
    protected void doEvaluate(VectorizedRowBatch batch, LongColumnVector inputColVector1, LongColumnVector inputColVector2)
    {
        ...
        } else /* !inputColVector1.noNulls && !inputColVector2.noNulls */
        {
            ...
            if ((inputColVector1.isRepeating) && (inputColVector2.isRepeating))
            {
                ...
                outV.isRepeating = true;
                outputVector[0] = vector1[0] & vector2[0];
                outputIsNull[0] = ((vector1[0] == 1) && inputColVector2.isNull[0]) || (inputColVector1.isNull[0] && (vector2[0] == 1)) || (inputColVector1.isNull[0] && inputColVector2.isNull[0]);
            } else if (inputColVector1.isRepeating && !inputColVector2.isRepeating)
            {
                if (batch.selectedInUse)
                {
                    for (int j = 0; j != n; j++)
                    {
                        int i = sel[j];
                        outputVector[i] = vector1Value & vector2[i];
                        outputIsNull[i] = ((vector1[0] == 1) && inputColVector2.isNull[i]) || (inputColVector1.isNull[0] && (vector2[i] == 1)) || (inputColVector1.isNull[0] && inputColVector2.isNull[i]);
                    }
                } else
                {
                    for (int i = 0; i != n; i++)
            ...
            } else if (!inputColVector1.isRepeating && inputColVector2.isRepeating)
            {
                if (batch.selectedInUse)
                {
                    for (int j = 0; j != n; j++)
                    {
                        int i = sel[j];
                        outputVector[i] = vector1[i] & vector2Value;
                        outputIsNull[i] = ((vector1[i] == 1) && inputColVector2.isNull[0]) || (inputColVector1.isNull[i] && (vector2[0] == 1)) || (inputColVector1.isNull[i] && inputColVector2.isNull[0]);
                    }
                } else
                {
                    for (int i = 0; i != n; i++)
            ...
            } else /* neither side is repeating */
            {
                if (batch.selectedInUse)
                {
                    for (int j = 0; j != n; j++)
                    {
                        int i = sel[j];
                        outputVector[i] = vector1[i] & vector2[i];
                        outputIsNull[i] = ((vector1[i] == 1) && inputColVector2.isNull[i]) || (inputColVector1.isNull[i] && (vector2[i] == 1)) || (inputColVector1.isNull[i] && inputColVector2.isNull[i]);
                    }
                } else
                {
                    for (int i = 0; i != n; i++)
