...
public class TestVectorTimestampExpressions
{
    ...
    {
        VectorizedRowBatch batch = getVectorizedRowBatch(new Timestamp[]{new Timestamp(0)}, VectorizedRowBatch.DEFAULT_SIZE, testType);
    ...
    {
        TimestampTZ tsTZ = TimestampTZUtil.convert(org.apache.hadoop.hive.common.type.Timestamp.ofEpochMilli(ts.getTime()), ZoneId.systemDefault());
