...
public class TestGetPartitionInBatches
{
    ...
    public void TestNumberOfPartitionsRetrieved() throws HiveException
    {
        ...
        List<Partition> partitions = hive.getPartitionsByNames(new org.apache.hadoop.hive.ql.metadata.Table(table), numParts.subList(0, 5), false);
    ...
    public void testBatchingWhenException() throws Exception
    {
        ...
        doThrow(new MetaException()).doCallRealMethod().when(spyMSC).getPartitionsByNames(any());
