...
public class TestRexNodeConverter
{
    ...
    public void testRewriteCaseChildren() throws SemanticException
    {
        ...
        List<RexNode> childrenNodeList = ImmutableList.of(inputRef, REX_BUILDER.makeLiteral(1, integerType, true), varChar34, REX_BUILDER.makeLiteral(6, integerType, true), varChar35);

        List<RexNode> expected = ImmutableList.of(REX_BUILDER.makeCall(SqlStdOperatorTable.EQUALS, inputRef, REX_BUILDER.makeLiteral(1, smallIntegerType, true)), varChar34, REX_BUILDER.makeCall(SqlStdOperatorTable.EQUALS, inputRef, REX_BUILDER.makeLiteral(6, smallIntegerType, true)), varChar35, varCharNull);

        List<RexNode> computed = RexNodeConverter.rewriteCaseChildren(CASE_FUNC_TEST, childrenNodeList, REX_BUILDER);
    ...
    public void testRewriteCaseChildrenNullChild() throws SemanticException
    {
        ...
        List<RexNode> childrenNodeList = ImmutableList.of(inputRef, REX_BUILDER.makeLiteral(1, integerType, true), varChar34, REX_BUILDER.makeLiteral(null, integerType, true), varChar35);

        List<RexNode> expected = ImmutableList.of(REX_BUILDER.makeCall(SqlStdOperatorTable.EQUALS, inputRef, REX_BUILDER.makeLiteral(1, smallIntegerType, true)), varChar34, REX_BUILDER.makeCall(SqlStdOperatorTable.EQUALS, inputRef, REX_BUILDER.makeLiteral(null, smallIntegerType, true)), varChar35, varCharNull);
