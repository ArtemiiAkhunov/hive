...
public class TestVectorGenericDateExpressions
{
    ...
    private List<PrimitiveCategory> dateTimestampStringTypes = Arrays.<PrimitiveCategory>asList(PrimitiveCategory.DATE, PrimitiveCategory.TIMESTAMP, PrimitiveCategory.STRING);
    ...
    private void validateDateAdd(VectorizedRowBatch batch, PrimitiveCategory colType1, long scalar2, boolean isPositive, LongColumnVector date1) throws HiveException
    {
    ...
    private void validateDateAdd(VectorizedRowBatch batch, long scalar1, LongColumnVector date2, PrimitiveCategory colType1, boolean isPositive) throws HiveException
    {
    ...
    private void testDateAddScalarCol(PrimitiveCategory colType1, boolean isPositive) throws HiveException
    {
    ...
    private void validateDateAdd(VectorizedRowBatch batch, LongColumnVector date1, LongColumnVector date2, PrimitiveCategory colType1, boolean isPositive) throws HiveException
    {
    ...
    private void validateDateDiff(VectorizedRowBatch batch, LongColumnVector date1, long scalar2, PrimitiveCategory colType1, PrimitiveCategory scalarType2) throws HiveException
    {
        VectorExpression udf = null;
        switch (scalarType2)
        {
    ...
    private void validateDate(VectorizedRowBatch batch, PrimitiveCategory colType, LongColumnVector date) throws HiveException
    {
        VectorExpression udf;
    ...
    private void validateToDate(VectorizedRowBatch batch, PrimitiveCategory colType, LongColumnVector date) throws HiveException
    {
        VectorExpression udf;
        if (colType == PrimitiveCategory.STRING || colType == PrimitiveCategory.CHAR || colType == PrimitiveCategory.VARCHAR)
        {
