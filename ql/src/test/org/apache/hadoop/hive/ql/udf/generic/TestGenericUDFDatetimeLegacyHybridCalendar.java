...
public class TestGenericUDFDatetimeLegacyHybridCalendar
{
    ...
    public void testDatetimeLegacyHybridCalendar() throws Exception
    {
        ...
        runAndVerify(udf, new TimestampWritableV2(Timestamp.valueOf("0601-03-07 17:00:00")), new TimestampWritableV2(Timestamp.valueOf("0601-03-04 17:00:00")));

        runAndVerify(udf, new TimestampWritableV2(Timestamp.valueOf("1582-10-14 09:17:22.13")), new TimestampWritableV2(Timestamp.valueOf("1582-10-04 09:17:22.13")));

        runAndVerify(udf, new TimestampWritableV2(Timestamp.valueOf("1582-10-15 11:17:22.13")), new TimestampWritableV2(Timestamp.valueOf("1582-10-15 11:17:22.13")));

        runAndVerify(udf, new TimestampWritableV2(Timestamp.valueOf("2015-03-07 17:00:00")), new TimestampWritableV2(Timestamp.valueOf("2015-03-07 17:00:00")));

        // Make sure nanos are preserved
        runAndVerify(udf, new TimestampWritableV2(Timestamp.valueOf("0601-03-07 18:00:00.123456789")), new TimestampWritableV2(Timestamp.valueOf("0601-03-04 18:00:00.123456789")));

        runAndVerify(udf, new TimestampWritableV2(Timestamp.valueOf("2018-07-07 18:00:00.123456789")), new TimestampWritableV2(Timestamp.valueOf("2018-07-07 18:00:00.123456789")));
    }
}
