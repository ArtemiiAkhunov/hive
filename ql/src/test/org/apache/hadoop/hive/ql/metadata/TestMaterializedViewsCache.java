...
class TestMaterializedViewsCache
{
    ...
    {
        return new HiveRelOptMaterialization(new DummyRel(table), new DummyRel(table), null, asList(table.getDbName(), table.getTableName()), RewriteAlgorithm.ALL, IncrementalRebuildMode.AVAILABLE, ParseUtils.parse(table.getViewExpandedText(), null));
    }
    ...
    private static class DummyRel implements RelNode
    {
        ...
        {
            this.dummyTable = new RelOptHiveTable(null, null, singletonList(table.getDbName() + "." + table.getTableName()), null, table, emptyList(), emptyList(), emptyList(), null, null, null, null, null, null);
        }
