...
public class TestTrigger
{
    ...
    {
        Expression expression = ExpressionFactory.createExpression(new FileSystemCounterLimit("hdfs", FileSystemCounterLimit.FSCounter.BYTES_READ, 1024));
        ...
        expression = ExpressionFactory.createExpression(new FileSystemCounterLimit("hdfs", FileSystemCounterLimit.FSCounter.BYTES_WRITTEN, 1024));
        ...
        expression = ExpressionFactory.createExpression(new FileSystemCounterLimit("", FileSystemCounterLimit.FSCounter.BYTES_READ, 1024));
        ...
        expression = ExpressionFactory.createExpression(new FileSystemCounterLimit("", FileSystemCounterLimit.FSCounter.BYTES_WRITTEN, 1024));
        ...
        expression = ExpressionFactory.createExpression(new FileSystemCounterLimit("", FileSystemCounterLimit.FSCounter.SHUFFLE_BYTES, 1024));
        ...
        expression = ExpressionFactory.createExpression(new TimeCounterLimit(TimeCounterLimit.TimeCounter.EXECUTION_TIME, 10000));
        ...
        expression = ExpressionFactory.createExpression(new VertexCounterLimit(VertexCounterLimit.VertexCounter.VERTEX_TOTAL_TASKS, 10000));
        ...
        expression = ExpressionFactory.createExpression(new VertexCounterLimit(VertexCounterLimit.VertexCounter.DAG_TOTAL_TASKS, 10000));
        trigger = new ExecutionTrigger("highly_parallel", expression, new Action(Action.Type.KILL_QUERY));
    ...
    public void testExpressionFromString()
    {
        ...
        Expression expected = ExpressionFactory.createExpression(new FileSystemCounterLimit("", FileSystemCounterLimit.FSCounter.BYTES_READ, 1024));
        ...
        expected = ExpressionFactory.createExpression(new FileSystemCounterLimit("", FileSystemCounterLimit.FSCounter.BYTES_WRITTEN, 1024));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());

        expression = ExpressionFactory.fromString(" HDFS_BYTES_READ > 1024 ");
        expected = ExpressionFactory.createExpression(new FileSystemCounterLimit("hdfs", FileSystemCounterLimit.FSCounter.BYTES_READ, 1024));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());

        expression = ExpressionFactory.fromString(" HDFS_BYTES_WRITTEN > 1024");
        expected = ExpressionFactory.createExpression(new FileSystemCounterLimit("hdfs", FileSystemCounterLimit.FSCounter.BYTES_WRITTEN, 1024));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());

        expression = ExpressionFactory.fromString(" S3A_BYTES_READ > 1024");
        expected = ExpressionFactory.createExpression(new FileSystemCounterLimit("s3a", FileSystemCounterLimit.FSCounter.BYTES_READ, 1024));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());

        expression = ExpressionFactory.fromString(" S3A_BYTES_WRITTEN > 1024");
        expected = ExpressionFactory.createExpression(new FileSystemCounterLimit("s3a", FileSystemCounterLimit.FSCounter.BYTES_WRITTEN, 1024));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());
        ...
        expected = ExpressionFactory.createExpression(new FileSystemCounterLimit("", FileSystemCounterLimit.FSCounter.SHUFFLE_BYTES, 1024));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());

        expression = ExpressionFactory.fromString(" EXECUTION_TIME > 300");
        expected = ExpressionFactory.createExpression(new TimeCounterLimit(TimeCounterLimit.TimeCounter.EXECUTION_TIME, 300));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());

        expression = ExpressionFactory.fromString(" ELAPSED_TIME > 300");
        expected = ExpressionFactory.createExpression(new TimeCounterLimit(TimeCounterLimit.TimeCounter.ELAPSED_TIME, 300));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());
        ...
        expected = ExpressionFactory.createExpression(new VertexCounterLimit(VertexCounterLimit.VertexCounter.VERTEX_TOTAL_TASKS, 10000));
        assertEquals("counter: VERTEX_TOTAL_TASKS limit: 10000", expression.getCounterLimit().toString());
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());

        expression = ExpressionFactory.fromString(" DAG_TOTAL_TASKS > 10000");
        expected = ExpressionFactory.createExpression(new VertexCounterLimit(VertexCounterLimit.VertexCounter.DAG_TOTAL_TASKS, 10000));
        assertEquals("counter: DAG_TOTAL_TASKS limit: 10000", expression.getCounterLimit().toString());
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());
    ...
    public void testSizeValidationInTrigger()
    {
        ...
        Expression expected = ExpressionFactory.createExpression(new FileSystemCounterLimit("", FileSystemCounterLimit.FSCounter.SHUFFLE_BYTES, 100 * 1024 * 1024));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());

        expression = ExpressionFactory.fromString(" SHUFFLE_BYTES > '1gB'");
        expected = ExpressionFactory.createExpression(new FileSystemCounterLimit("", FileSystemCounterLimit.FSCounter.SHUFFLE_BYTES, 1024 * 1024 * 1024));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());

        expression = ExpressionFactory.fromString(" SHUFFLE_BYTES > '1TB'");
        expected = ExpressionFactory.createExpression(new FileSystemCounterLimit("", FileSystemCounterLimit.FSCounter.SHUFFLE_BYTES, 1024L * 1024 * 1024 * 1024));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());

        expression = ExpressionFactory.fromString(" SHUFFLE_BYTES > 100");
        expected = ExpressionFactory.createExpression(new FileSystemCounterLimit("", FileSystemCounterLimit.FSCounter.SHUFFLE_BYTES, 100));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());
    ...
    public void testTimeValidationInTrigger()
    {
        ...
        Expression expected = ExpressionFactory.createExpression(new TimeCounterLimit(TimeCounterLimit.TimeCounter.ELAPSED_TIME, 300000));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());

        expression = ExpressionFactory.fromString(" elapsed_TIME > '300seconds'");
        expected = ExpressionFactory.createExpression(new TimeCounterLimit(TimeCounterLimit.TimeCounter.ELAPSED_TIME, 300000));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());
        ...
        expected = ExpressionFactory.createExpression(new TimeCounterLimit(TimeCounterLimit.TimeCounter.ELAPSED_TIME, 24 * 60 * 60 * 1000));
        assertEquals(expected, expression);
        assertEquals(expected.hashCode(), expression.hashCode());
    }
    ...
    public void testTriggerClone()
    {
        ...
        assertNotEquals(System.identityHashCode(trigger.getExpression().getCounterLimit()), System.identityHashCode(clonedTrigger.getExpression().getCounterLimit()));
