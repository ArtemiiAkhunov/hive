...
public class TestAcidUtils
{
    ...
    public void testCreateFilename() throws Exception
    {
        ...
        options.bucket(23).minimumWriteId(100).maximumWriteId(200).writingBase(true).setOldStyle(false);
        ...
        assertEquals("/tmp/delete_delta_0000100_0000200_0000/bucket_00023", AcidUtils.createFilename(p, options).toString());
        ...
        options.writingDeleteDelta(true);
        assertEquals("/tmp/delete_delta_0000100_0000200/bucket_00023", AcidUtils.createFilename(p, options).toString());
        options.writingDeleteDelta(false);
        ...
        options.writingDeleteDelta(true);
        assertEquals("/tmp/delete_delta_0000100_0000200_0007/bucket_00023", AcidUtils.createFilename(p, options).toString());
    }
    ...
    public void testCreateFilenameLargeIds() throws Exception
    {
        ...
        options.bucket(23).minimumWriteId(1234567880).maximumWriteId(1234567890).writingBase(true).setOldStyle(false);
    ...
    public void testObsoleteOriginals() throws Exception
    {
        ...
        conf.set(ValidTxnList.VALID_TXNS_KEY, new ValidReadTxnList(new long[0], new BitSet(), 1000, Long.MAX_VALUE).writeToString());
        AcidDirectory dir = AcidUtils.getAcidState(fs, part, conf, new ValidReaderWriteIdList("tbl:150:" + Long.MAX_VALUE + ":"), null, false);
    ...
    {
        MockFileSystem fs = new MockFileSystem(new HiveConf(), new MockFile("mock:/tbl/part1/.hive-staging_dir/-ext-10002", 500, new byte[0]), new MockFile("mock:/tbl/part2/.hive-staging_dir", 500, new byte[0]), new MockFile("mock:/tbl/part1/_tmp_space.db", 500, new byte[0]), new MockFile("mock:/tbl/part1/delta_1_1/bucket-0000-0000", 500, new byte[0]));
