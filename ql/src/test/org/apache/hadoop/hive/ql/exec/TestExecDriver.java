...
public class TestExecDriver
{
    ...
    static
    {
        try
        {
            ...
            for (Object one : Utilities.makeList("mapplan1.out", "mapplan2.out", "mapredplan1.out", "mapredplan2.out", "mapredplan3.out", "mapredplan4.out", "mapredplan5.out", "mapredplan6.out"))
            {
            ...
            for (String src : srctables)
            {
                ...
                db.loadTable(hadoopDataFile[i], src, LoadFileType.KEEP_EXISTING, true, false, false, true, null, 0, false, false);
                i++;
            }
    ...
    {
        mr.getMapWork().addMapWork(tbl.getDataLocation(), alias, work, new PartitionDesc(Utilities.getTableDesc(tbl), null));
    }
    ...
    public void testMapRedPlan1() throws Exception
    {
        ...
        populateMapRedPlan1(db.getTable(Warehouse.DEFAULT_DATABASE_NAME, "src"));
        executePlan();
    ...
    public void testMapRedPlan2() throws Exception
    {
        ...
        LOG.info("Beginning testMapPlan2");
        populateMapRedPlan2(db.getTable(Warehouse.DEFAULT_DATABASE_NAME, "src"));
        executePlan();
    ...
    public void testMapRedPlan3() throws Exception
    {
        ...
        populateMapRedPlan3(db.getTable(Warehouse.DEFAULT_DATABASE_NAME, "src"), db.getTable(Warehouse.DEFAULT_DATABASE_NAME, "src2"));
        executePlan();
    ...
    public void testMapRedPlan4() throws Exception
    {
        ...
        populateMapRedPlan4(db.getTable(Warehouse.DEFAULT_DATABASE_NAME, "src"));
        executePlan();
    ...
    public void testMapRedPlan5() throws Exception
    {
        ...
        populateMapRedPlan5(db.getTable(Warehouse.DEFAULT_DATABASE_NAME, "src"));
        executePlan();
    ...
    public void testMapRedPlan6() throws Exception
    {
        ...
        populateMapRedPlan6(db.getTable(Warehouse.DEFAULT_DATABASE_NAME, "src"));
        executePlan();
