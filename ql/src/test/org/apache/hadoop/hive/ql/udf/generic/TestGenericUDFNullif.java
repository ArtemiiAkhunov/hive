...
public class TestGenericUDFNullif
{
    ...
    public void testLazy() throws HiveException
    {
        ...
        ObjectInspector[] inputOIs = {LazyPrimitiveObjectInspectorFactory.LAZY_INT_OBJECT_INSPECTOR, LazyPrimitiveObjectInspectorFactory.LAZY_INT_OBJECT_INSPECTOR};
    ...
    public void testArrayNull() throws Exception
    {
        ...
        ObjectInspector[] inputOIs = {ObjectInspectorFactory.getStandardListObjectInspector(PrimitiveObjectInspectorFactory.writableStringObjectInspector), ObjectInspectorFactory.getStandardListObjectInspector(PrimitiveObjectInspectorFactory.writableStringObjectInspector)};
