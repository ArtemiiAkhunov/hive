...
public class TestSharedWorkOptimizer
{
    ...
    public void testMapJoinCacheReuse()
    {
        ...
        MapJoinOperator mapJoin1 = (MapJoinOperator) OperatorFactory.getAndMakeChild(cCtx, getMapJoinDesc(0), joinSource1);
        MapJoinOperator mapJoin2 = (MapJoinOperator) OperatorFactory.getAndMakeChild(cCtx, getMapJoinDesc(0), joinSource2);
        ...
        MapJoinOperator mapJoin3 = (MapJoinOperator) OperatorFactory.getAndMakeChild(cCtx, getMapJoinDesc(0), joinSource3);
        MapJoinOperator mapJoin4 = (MapJoinOperator) OperatorFactory.getAndMakeChild(cCtx, getMapJoinDesc(0), joinSource4);
        ...
        MapJoinOperator mapJoin5 = (MapJoinOperator) OperatorFactory.getAndMakeChild(cCtx, getMapJoinDesc(0), joinSource5);
        MapJoinOperator mapJoin6 = (MapJoinOperator) OperatorFactory.getAndMakeChild(cCtx, getMapJoinDesc(1), joinSource6);
