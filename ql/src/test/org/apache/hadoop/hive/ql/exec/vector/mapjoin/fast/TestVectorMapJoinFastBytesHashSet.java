...
public class TestVectorMapJoinFastBytesHashSet extends CommonFastHashTable
{
    ...
    public void testOneKey() throws Exception
    {
        ...
        VectorMapJoinFastMultiKeyHashSet map = new VectorMapJoinFastMultiKeyHashSet(false, CAPACITY, LOAD_FACTOR, WB_SIZE, -1);
    ...
    public void testFullMap() throws Exception
    {
        ...
        VectorMapJoinFastMultiKeyHashSet map = new VectorMapJoinFastMultiKeyHashSet(false, CAPACITY, 1f, WB_SIZE, -1);
    ...
    public void testExpand() throws Exception
    {
        ...
        VectorMapJoinFastMultiKeyHashSet map = new VectorMapJoinFastMultiKeyHashSet(false, 1, 0.0000001f, WB_SIZE, -1);
    ...
    public void addAndVerifyMultipleKeyMultipleValue(int keyCount, VectorMapJoinFastMultiKeyHashSet map, VerifyFastBytesHashSet verifyTable) throws HiveException, IOException
    {
        for (int i = 0; i < keyCount; i++)
        {
    ...
    public void testMultipleKeysMultipleValue() throws Exception
    {
        ...
        VectorMapJoinFastMultiKeyHashSet map = new VectorMapJoinFastMultiKeyHashSet(false, LARGE_CAPACITY, LOAD_FACTOR, LARGE_WB_SIZE, -1);
    ...
    public void testLargeAndExpand() throws Exception
    {
        ...
        // Use a large capacity that doesn't require expansion, yet.
        VectorMapJoinFastMultiKeyHashSet map = new VectorMapJoinFastMultiKeyHashSet(false, MODERATE_CAPACITY, LOAD_FACTOR, MODERATE_WB_SIZE, -1);
