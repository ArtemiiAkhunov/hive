...
public class TestVectorMapJoinFastLongHashMultiSet extends CommonFastHashTable
{
    ...
    public void testOneKey() throws Exception
    {
        ...
        VectorMapJoinFastLongHashMultiSet map = new VectorMapJoinFastLongHashMultiSet(false, false, HashTableKeyType.LONG, CAPACITY, LOAD_FACTOR, WB_SIZE, -1, tableDesc);
    ...
    public void testFullMap() throws Exception
    {
        ...
        VectorMapJoinFastLongHashMultiSet map = new VectorMapJoinFastLongHashMultiSet(false, false, HashTableKeyType.LONG, CAPACITY, 1f, WB_SIZE, -1, tableDesc);
    ...
    public void testExpand() throws Exception
    {
        ...
        VectorMapJoinFastLongHashMultiSet map = new VectorMapJoinFastLongHashMultiSet(false, false, HashTableKeyType.LONG, 1, 0.0000001f, WB_SIZE, -1, tableDesc);
    ...
    public void testMultipleKeysMultipleValue() throws Exception
    {
        ...
        VectorMapJoinFastLongHashMultiSet map = new VectorMapJoinFastLongHashMultiSet(false, false, HashTableKeyType.LONG, LARGE_CAPACITY, LOAD_FACTOR, LARGE_WB_SIZE, -1, tableDesc);
    ...
    public void testLargeAndExpand() throws Exception
    {
        ...
        // Use a large capacity that doesn't require expansion, yet.
        VectorMapJoinFastLongHashMultiSet map = new VectorMapJoinFastLongHashMultiSet(false, false, HashTableKeyType.LONG, MODERATE_CAPACITY, LOAD_FACTOR, MODERATE_WB_SIZE, -1, tableDesc);
