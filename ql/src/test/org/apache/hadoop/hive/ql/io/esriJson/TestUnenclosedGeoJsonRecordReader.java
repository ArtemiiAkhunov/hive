...
{  // MRv2; for MRv1, name Mrv1
    ...
    public void TestEscape() throws Exception
    {
        ...
        Assert.assertArrayEquals(new int[]{7, 8}, getRecordIndexesInFile("unenclosed-geojs-escape.json", 414, 565));  // 6|{}"
        Assert.assertArrayEquals(new int[]{8}, getRecordIndexesInFile("unenclosed-geojs-escape.json", 474, 565));  // 7|}{"
