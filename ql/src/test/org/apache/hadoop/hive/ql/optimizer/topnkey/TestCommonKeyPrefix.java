...
public class TestCommonKeyPrefix
{
    ...
    {
        // when
        CommonKeyPrefix commonPrefix = CommonKeyPrefix.map(new ArrayList<>(0), "", "", new ArrayList<>(0), new HashMap<>(0), "", "");
        // then
    ...
    public void testmapWhenAllKeysMatch()
    {
        ...
        // when
        CommonKeyPrefix commonPrefix = CommonKeyPrefix.map(asList(childCol0, childCol1), "++", "aa", asList(parentCol0, parentCol1), exprNodeDescMap, "++", "aa");
    ...
    public void testmapWhenOnlyFirstKeyMatchFromTwo()
    {
        ...
        // when
        CommonKeyPrefix commonPrefix = CommonKeyPrefix.map(asList(childCol0, differentChildCol), "++", "aa", asList(parentCol0, parentCol1), exprNodeDescMap, "++", "aa");
    ...
    public void testmapWhenAllColumnsMatchButOrderMismatch()
    {
        ...
        // when
        commonPrefix = CommonKeyPrefix.map(asList(childCol0, childCol1), "-+", "aa", asList(parentCol0, parentCol1), exprNodeDescMap, "++", "aa");
    ...
    public void testmapWhenAllColumnsMatchButNullOrderMismatch()
    {
        ...
        // when
        CommonKeyPrefix commonPrefix = CommonKeyPrefix.map(asList(childCol0, childCol1), "++", "az", asList(parentCol0, parentCol1), exprNodeDescMap, "++", "aa");
        ...
        // when
        commonPrefix = CommonKeyPrefix.map(asList(childCol0, childCol1), "++", "za", asList(parentCol0, parentCol1), exprNodeDescMap, "++", "aa");
    ...
    public void testmapWhenKeyCountsMismatch()
    {
        ...
        // when
        CommonKeyPrefix commonPrefix = CommonKeyPrefix.map(asList(childCol0, childCol1), "++", "aa", singletonList(parentCol0), exprNodeDescMap, "++", "aa");
