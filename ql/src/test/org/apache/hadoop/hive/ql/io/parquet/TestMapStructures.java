...
public class TestMapStructures extends AbstractTestParquetDirect
{
    ...
    {
        Path test = writeDirect("StringMapRequiredPrimitive", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.mapType()).repeatedGroup().required(BINARY).as(LogicalTypeAnnotation.stringType()).named("key").required(INT32).named("value").named("key_value").named("votes").named("StringMapRequiredPrimitive"), new TestArrayCompatibility.DirectWriter()
        {
            @Override
    ...
    {
        Path test = writeDirect("StringMapOptionalPrimitive", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.mapType()).repeatedGroup().required(BINARY).as(LogicalTypeAnnotation.stringType()).named("key").optional(INT32).named("value").named("key_value").named("votes").named("StringMapOptionalPrimitive"), new TestArrayCompatibility.DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
    ...
    public void testStringMapOfOptionalArray() throws Exception
    {
        ...
        Path test = writeDirect("StringMapOfOptionalArray", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.mapType()).repeatedGroup().required(BINARY).as(LogicalTypeAnnotation.stringType()).named("key").optionalGroup().as(LogicalTypeAnnotation.listType()).repeatedGroup().optional(BINARY).as(LogicalTypeAnnotation.stringType()).named("element").named("list").named("value").named("key_value").named("examples").named("StringMapOfOptionalArray"), new TestArrayCompatibility.DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
    ...
    public void testStringMapOfOptionalIntArray() throws Exception
    {
        ...
        Path test = writeDirect("StringMapOfOptionalIntArray", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.mapType()).repeatedGroup().required(BINARY).as(LogicalTypeAnnotation.stringType()).named("key").optionalGroup().as(LogicalTypeAnnotation.listType()).repeatedGroup().optional(INT32).named("element").named("list").named("value").named("key_value").named("examples").named("StringMapOfOptionalIntArray"), new TestArrayCompatibility.DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
    ...
    {
        Path test = writeDirect("MapWithComplexKey", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.mapType()).repeatedGroup().requiredGroup().required(INT32).named("x").required(INT32).named("y").named("key").optional(DOUBLE).named("value").named("key_value").named("matrix").named("MapWithComplexKey"), new TestArrayCompatibility.DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
    ...
    {
        Path test = writeDirect("DoubleMapWithStructValue", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.mapType()).repeatedGroup().optional(DOUBLE).named("key").optionalGroup().required(INT32).named("x").required(INT32).named("y").named("value").named("key_value").named("approx").named("DoubleMapWithStructValue"), new TestArrayCompatibility.DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
    ...
    {
        Path test = writeDirect("DoubleMapWithStructValue", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.mapType()).repeatedGroup().optional(BINARY).as(LogicalTypeAnnotation.stringType()).named("key").optionalGroup().as(LogicalTypeAnnotation.mapType()).repeatedGroup().optional(BINARY).as(LogicalTypeAnnotation.stringType()).named("key").required(INT32).named("value").named("key_value").named("value").named("key_value").named("map_of_maps").named("NestedMap"), new TestArrayCompatibility.DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
