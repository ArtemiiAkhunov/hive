...
public class TestDeltaFilesMetricFlags extends CompactorTest
{
    ...
    public void testDeltaFilesMetricFromInitiatorWithMetricsDisabled() throws Exception
    {
        ...
        setup(conf);
        startInitiator();
        assertThat(Metrics.getOrCreateMapMetrics(COMPACTION_NUM_DELTAS).get(), CoreMatchers.is(ImmutableMap.of()));
    ...
    public void testDeltaFilesMetricFromWorkerWithMetricsDisabled() throws Exception
    {
        ...
        setup(conf);
        startWorker();
        assertThat(gaugeToMap(COMPACTION_NUM_SMALL_DELTAS), CoreMatchers.is(ImmutableMap.of()));
    ...
    public void testDeltaFilesMetricFromCleanerWithMetricsDisabled() throws Exception
    {
        ...
        setup(conf);
        startCleaner();
        assertThat(gaugeToMap(COMPACTION_NUM_OBSOLETE_DELTAS), CoreMatchers.is(ImmutableMap.of()));
    ...
    public void testDeltaFilesMetricFromInitiatorWithAcidMetricsThreadDisabled() throws Exception
    {
        ...
        setup(conf);
        startInitiator();
        assertThat(gaugeToMap(COMPACTION_NUM_DELTAS), CoreMatchers.is(ImmutableMap.of()));
        gaugeToMap(COMPACTION_NUM_DELTAS);
    }
