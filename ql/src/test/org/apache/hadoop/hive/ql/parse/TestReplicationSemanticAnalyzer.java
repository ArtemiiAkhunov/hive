...
public class TestReplicationSemanticAnalyzer
{
    ...
    public static class ReplDumpWithClause
    {
        ...
        public void parseTableName() throws Exception
        {
            ASTNode root = parse("repl dump testDb.'test_table' with ('key.1'='value.1','key.2'='value.2')");
    ...
    public static class ReplLoad
    {
        ...
        {
            ASTNode root = parse("repl load testDbName into targetTestDbName" + " with ('mapred.job.queue.name'='repl','hive.repl.approx.max.load.tasks'='100')");
    ...
    public static class ReplStatus
    {
        ...
        public void parseWithClause() throws Exception
        {
            ASTNode root = parse("repl status targetTestDbName with" + "('hive.metastore.uris'='thrift://localhost:12341')");
            assertTargetDatabaseName(root);
