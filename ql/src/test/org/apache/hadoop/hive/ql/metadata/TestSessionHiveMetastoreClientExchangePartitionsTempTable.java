...
public class TestSessionHiveMetastoreClientExchangePartitionsTempTable extends TestExchangePartitions
{
    ...
    {
        new TableBuilder().setDbName(dbName).setTableName(tableName).setCols(cols).setPartCols(partCols).setLocation(location).setTemporary(true).create(getClient(), getMetaStore().getConf());
    ...
    public void testExchangePartitionsNonExistingPartLocation() throws Exception
    {
        ...
        getClient().exchange_partitions(partitionSpecs, getSourceTable().getDbName(), getSourceTable().getTableName(), getDestTable().getDbName(), getDestTable().getTableName());
    }
    ...
    {
        Table source = createTable(DB_NAME, "test_source_table_cust_loc", getYearMonthAndDayPartCols(), getMetaStore().getWarehouseRoot() + "/sourceTable");
        Table dest = createTable(DB_NAME, "test_dest_table_cust_loc", getYearMonthAndDayPartCols(), getMetaStore().getWarehouseRoot() + "/destTable");
        ...
        getClient().exchange_partitions(partitionSpecs, source.getDbName(), source.getTableName(), dest.getDbName(), dest.getTableName());
    ...
    public void testExchangePartitionsOnlyMonthSetInPartSpec() throws Exception
    {
        ...
        getClient().exchange_partitions(partitionSpecs, getSourceTable().getDbName(), getSourceTable().getTableName(), getDestTable().getDbName(), getDestTable().getTableName());
        checkRemainingPartitions(getSourceTable(), getDestTable(), Lists.newArrayList(getPartitions()[2], getPartitions()[3], getPartitions()[4]));
        List<Partition> exchangedPartitions = getClient().listPartitions(getDestTable().getDbName(), getDestTable().getTableName(), MAX);
        Assert.assertEquals(2, exchangedPartitions.size());
        checkExchangedPartitions(getSourceTable(), getDestTable(), Lists.newArrayList(getPartitions()[0], getPartitions()[1]));
    }
    ...
    public void testExchangePartitionsYearAndDaySetInPartSpec() throws Exception
    {
        ...
        getClient().exchange_partitions(partitionSpecs, getSourceTable().getDbName(), getSourceTable().getTableName(), getDestTable().getDbName(), getDestTable().getTableName());
        checkRemainingPartitions(getSourceTable(), getDestTable(), Lists.newArrayList(getPartitions()[0], getPartitions()[2], getPartitions()[3], getPartitions()[4]));
        List<Partition> exchangedPartitions = getClient().listPartitions(getDestTable().getDbName(), getDestTable().getTableName(), MAX);
    ...
    {
        Map<String, String> partitionSpecs = getPartitionSpec(getPartitions()[1]);
        Partition exchangedPartition = getClient().exchange_partition(partitionSpecs, getSourceTable().getDbName(), getSourceTable().getTableName(), getDestTable().getDbName(), getDestTable().getTableName());
    ...
    public void testExchangePartitionYearSet() throws Exception
    {
        ...
        Partition exchangedPartition = getClient().exchange_partition(partitionSpecs, getSourceTable().getDbName(), getSourceTable().getTableName(), getDestTable().getDbName(), getDestTable().getTableName());
        Assert.assertNotNull(exchangedPartition);
        checkExchangedPartitions(getSourceTable(), getDestTable(), Lists.newArrayList(getPartitions()[0], getPartitions()[1], getPartitions()[2], getPartitions()[3]));
    ...
    public void testExchangePartitionCustomTableAndPartLocation() throws Exception
    {
        ...
        Map<String, String> partitionSpecs = getPartitionSpec(parts[1]);
        getClient().exchange_partition(partitionSpecs, source.getDbName(), source.getTableName(), dest.getDbName(), dest.getTableName());
    ...
    public void testExchangePartitionNonExistingPartLocation() throws Exception
    {
        ...
        cleanTempTableDir(getSourceTable());
        cleanTempTableDir(getDestTable());
        getClient().exchange_partition(partitionSpecs, getSourceTable().getDbName(), getSourceTable().getTableName(), getDestTable().getDbName(), getDestTable().getTableName());
    }
    ...
    public void testExchangePartitionBetweenTempAndNonTemp() throws Exception
    {
        ...
        partitionSpecs.put(MONTH_COL_NAME, "march");
        partitionSpecs.put(DAY_COL_NAME, "22");
        getClient().exchange_partition(partitionSpecs, getSourceTable().getDbName(), getSourceTable().getTableName(), nonTempTable.getDbName(), nonTempTable.getTableName());
    }
    ...
    public void testExchangePartitionBetweenNonTempAndTemp() throws Exception
    {
        ...
        partitionSpecs.put(MONTH_COL_NAME, "march");
        partitionSpecs.put(DAY_COL_NAME, "22");
        getClient().exchange_partition(partitionSpecs, nonTempTable.getDbName(), nonTempTable.getTableName(), getDestTable().getDbName(), getDestTable().getTableName());
    }
    ...
    public void testExchangePartitionsBetweenTempAndNonTemp() throws Exception
    {
        ...
        getClient().exchange_partitions(partitionSpecs, getSourceTable().getDbName(), getSourceTable().getTableName(), nonTempTable.getDbName(), nonTempTable.getTableName());
    }
    ...
    public void testExchangePartitionsBetweenNonTempAndTemp() throws Exception
    {
        ...
        partitionSpecs.put(MONTH_COL_NAME, "");
        partitionSpecs.put(DAY_COL_NAME, "23");
        getClient().exchange_partitions(partitionSpecs, nonTempTable.getDbName(), nonTempTable.getTableName(), getDestTable().getDbName(), getDestTable().getTableName());
    }
