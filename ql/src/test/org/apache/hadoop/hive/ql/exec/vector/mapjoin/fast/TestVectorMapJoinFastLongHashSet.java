...
public class TestVectorMapJoinFastLongHashSet extends CommonFastHashTable
{
    ...
    public void testOneKey() throws Exception
    {
        ...
        VectorMapJoinFastLongHashSet map = new VectorMapJoinFastLongHashSet(false, false, HashTableKeyType.LONG, CAPACITY, LOAD_FACTOR, WB_SIZE, -1, keyTableDesc);
    ...
    public void testFullMap() throws Exception
    {
        ...
        VectorMapJoinFastLongHashSet map = new VectorMapJoinFastLongHashSet(false, false, HashTableKeyType.LONG, CAPACITY, 1f, WB_SIZE, -1, keyTableDesc);
    ...
    public void testExpand() throws Exception
    {
        ...
        VectorMapJoinFastLongHashSet map = new VectorMapJoinFastLongHashSet(false, false, HashTableKeyType.LONG, 1, 0.0000001f, WB_SIZE, -1, keyTableDesc);
    ...
    public void addAndVerifyMultipleKeyMultipleValue(int keyCount, VectorMapJoinFastLongHashSet map, VerifyFastLongHashSet verifyTable) throws HiveException, IOException
    {
        for (int i = 0; i < keyCount; i++)
        {
    ...
    public void testMultipleKeysMultipleValue() throws Exception
    {
        ...
        VectorMapJoinFastLongHashSet map = new VectorMapJoinFastLongHashSet(false, false, HashTableKeyType.LONG, LARGE_CAPACITY, LOAD_FACTOR, LARGE_WB_SIZE, -1, keyTableDesc);
    ...
    public void testLargeAndExpand() throws Exception
    {
        ...
        // Use a large capacity that doesn't require expansion, yet.
        VectorMapJoinFastLongHashSet map = new VectorMapJoinFastLongHashSet(false, false, HashTableKeyType.LONG, MODERATE_CAPACITY, LOAD_FACTOR, MODERATE_WB_SIZE, -1, keyTableDesc);
