...
public class TestVectorizedOrcAcidRowBatchReader
{
    ...
    public void setup() throws Exception
    {
        ...
        synchronized (TestOrcFile.class)
        {
            ...
            originalInspector = ObjectInspectorFactory.getReflectionObjectInspector(DummyOriginalRow.class, ObjectInspectorFactory.ObjectInspectorOptions.JAVA);

            bigRowInspector = ObjectInspectorFactory.getReflectionObjectInspector(BigRow.class, ObjectInspectorFactory.ObjectInspectorOptions.JAVA);
            bigOriginalRowInspector = ObjectInspectorFactory.getReflectionObjectInspector(BigOriginalRow.class, ObjectInspectorFactory.ObjectInspectorOptions.JAVA);
        }
    }
    ...
    {
        boolean filterOn = HiveConf.getBoolVar(conf, HiveConf.ConfVars.FILTER_DELETE_EVENTS);
        boolean skipKeyIdx = HiveConf.getBoolVar(conf, HiveConf.ConfVars.HIVE_TEST_MODE_ACID_KEY_IDX_SKIP);
        int bucket = 1;
    ...
    private void checkPath(String splitPath, String deleteDeltaPath, boolean expected)
    {
        ...
        boolean result = VectorizedOrcAcidRowBatchReader.ColumnizedDeleteEventRegistry.isQualifiedDeleteDeltaForSplit(ao, deltaMetaData, stmtId);
    ...
    private List<AcidInputFormat.DeltaMetaData> getDeltaMetaDataWithBucketFile(int bucketId)
    {
        ...
        return Collections.singletonList(new AcidInputFormat.DeltaMetaData(0, 0, new ArrayList<>(), 0, Collections.singletonList(file)));
    }
}
