...
public class TestGenericUDFDateFormatEvaluate
{
    ...
    public TestGenericUDFDateFormatEvaluate(String value, String pattern, String zone, String formatter, String expectedResult)
    {
        this.value = value;
    ...
    public static Collection<String[]> readInputs() throws IOException, CsvException
    {
        ...
        try (InputStream in = TestGenericUDFDateFormatEvaluate.class.getResourceAsStream("TestGenericUDFDateFormatEvaluate.csv"))
        {
            Objects.requireNonNull(in);
            try (CSVReader reader = new CSVReaderBuilder(new InputStreamReader(in)).withSkipLines(1) // Skip header
    ...
    public void testEvaluate() throws HiveException, InterruptedException
    {
        ...
        ObjectInspector[] argInspectors = new ObjectInspector[]{PrimitiveObjectInspectorFactory.writableStringObjectInspector, PrimitiveObjectInspectorFactory.getPrimitiveWritableConstantObjectInspector(TypeInfoFactory.stringTypeInfo, new Text(pattern))};
