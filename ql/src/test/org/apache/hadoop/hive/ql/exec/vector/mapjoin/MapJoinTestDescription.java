...
public class MapJoinTestDescription extends DescriptionTest
{
    ...
    {
        DYNAMIC_PARTITION_HASH_JOIN, SHARED_SMALL_TABLE
    }
    ...
    public static class SmallTableGenerationParameters
    {
        ...
        {
            NO_RESTRICTION, ONLY_ONE, NO_REGULAR_SMALL_KEYS
        }
    ...
    public MapJoinTestDescription(HiveConf hiveConf, VectorMapJoinVariation vectorMapJoinVariation, TypeInfo[] bigTableTypeInfos, int[] bigTableKeyColumnNums, TypeInfo[] smallTableValueTypeInfos, int[] smallTableRetainKeyColumnNums, SmallTableGenerationParameters smallTableGenerationParameters, MapJoinPlanVariation mapJoinPlanVariation)
    {
        this(hiveConf, vectorMapJoinVariation,
                /* bigTableColumnNames */ null, bigTableTypeInfos, bigTableKeyColumnNums, smallTableValueTypeInfos, smallTableRetainKeyColumnNums, smallTableGenerationParameters, mapJoinPlanVariation);
    }

    public MapJoinTestDescription(HiveConf hiveConf, VectorMapJoinVariation vectorMapJoinVariation, String[] bigTableColumnNames, TypeInfo[] bigTableTypeInfos, int[] bigTableKeyColumnNums, TypeInfo[] smallTableValueTypeInfos, int[] smallTableRetainKeyColumnNums, SmallTableGenerationParameters smallTableGenerationParameters, MapJoinPlanVariation mapJoinPlanVariation)
    {
    ...
    public void computeDerived()
    {
        ...
        List<TypeInfo> smallTableTypeInfoList = new ArrayList<TypeInfo>(Arrays.asList(smallTableKeyTypeInfos));
        ...
        for (int i = 0; i < valueSize; i++)
        {
            smallTableValueObjectInspectors[i] = PrimitiveObjectInspectorFactory.getPrimitiveWritableObjectInspector((PrimitiveTypeInfo) smallTableValueTypeInfos[i]);
        }
         ...
         */
        bigTableStandardObjectInspector = ObjectInspectorFactory.getStandardStructObjectInspector(bigTableColumnNameList, bigTableObjectInspectorList);
        smallTableStandardObjectInspector = ObjectInspectorFactory.getStandardStructObjectInspector(smallTableColumnNameList, smallTableObjectInspectorList);
