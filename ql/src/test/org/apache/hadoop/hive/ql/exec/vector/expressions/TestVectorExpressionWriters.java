...
public class TestVectorExpressionWriters
{
    ...
    {
        return new TimestampWritableV2(org.apache.hadoop.hive.common.type.Timestamp.ofEpochMilli(value.getTime(), value.getNanos()));
    }
    ...
    private Writable getWritableValue(TypeInfo ti, long value)
    {
        ...
        } else if (ti.equals(TypeInfoFactory.timestampTypeInfo))
        {
            ...
            TimestampWritableV2 tw = new TimestampWritableV2(org.apache.hadoop.hive.common.type.Timestamp.ofEpochMilli(ts.getTime(), ts.getNanos()));
            return tw;
        }
        return null;
    }
    ...
    {
        LongColumnVector icv = VectorizedRowGroupGenUtil.generateLongColumnVector(true, false, 5, new Random(10));
        ...
        SettableListObjectInspector listOI = ObjectInspectorFactory.getStandardListObjectInspector(PrimitiveObjectInspectorFactory.writableIntObjectInspector);
