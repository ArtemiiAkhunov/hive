...
public class TestSessionHiveMetastoreClientListPartitionsTempTable extends TestListPartitions
{
    ...
    public void testListPartitionNames() throws Exception
    {
        ...
        List<List<String>> testValues = Lists.newArrayList(Lists.newArrayList("1999", defaultPartitionName, "02"), Lists.newArrayList(defaultPartitionName, "02", "10"), Lists.newArrayList("2017", "10", defaultPartitionName));
        ...
        checkPartitionNames(Lists.newArrayList("yyyy=2017/mm=10/dd=26", "yyyy=2017/mm=10/dd=__HIVE_DEFAULT_PARTITION__", "yyyy=2017/mm=11/dd=27"), (short) 3, null, defaultPartitionName, e.val("2017").strCol("yyyy").pred(">=", 2).build(), t);

        checkPartitionNames(Lists.newArrayList("yyyy=2017/mm=11/dd=27", "yyyy=2017/mm=10/dd=26"), (short) 2, "1,2:-+", defaultPartitionName, e.val("2017").strCol("yyyy").pred(">=", 2).build(), t);

        checkPartitionNames(Lists.newArrayList("yyyy=1999/mm=01/dd=02", "yyyy=1999/mm=__HIVE_DEFAULT_PARTITION__/dd=02", "yyyy=2009/mm=02/dd=10"), (short) 3, null, defaultPartitionName, null, t);

        checkPartitionNames(Lists.newArrayList("yyyy=__HIVE_DEFAULT_PARTITION__/mm=02/dd=10", "yyyy=2017/mm=10/dd=26", "yyyy=2017/mm=10/dd=__HIVE_DEFAULT_PARTITION__"), (short) 3, "0,1:-+", defaultPartitionName, null, t);
    ...
    public void testListPartitionsByExpr() throws Exception
    {
        ...
        checkExpr(2, e.strCol("yyyy").val("2017").pred("!=", 2).build());
        checkExpr(1, e.strCol("yyyy").val("2017").pred("=", 2).strCol("mm").val("10").pred(">=", 2).pred("and", 2).build());
        checkExpr(3, e.strCol("dd").val("10").pred("<", 2).strCol("yyyy").val("2009").pred("!=", 2).pred("or", 2).build());
    ...
    public void testListPartitionsByExprNullResult() throws Exception
    {
        createTable4PartColsParts(getClient());
        TestMetastoreExpr.ExprBuilder e = new TestMetastoreExpr.ExprBuilder(TABLE_NAME);
        getClient().listPartitionsByExpr(DB_NAME, TABLE_NAME, SerializationUtilities.serializeObjectWithTypeInformation(e.strCol("yyyy").val("2017").pred("=", 2).build()), null, (short) -1, null);
    }
    ...
    public void testListPartitionsByExprDefMaxParts() throws Exception
    {
        ...
        getClient().listPartitionsByExpr(DB_NAME, TABLE_NAME, SerializationUtilities.serializeObjectWithTypeInformation(e.strCol("yyyy").val("2017").pred(">=", 2).build()), null, (short) 3, result);
    ...
    public void testListPartitionsByExprHighMaxParts() throws Exception
    {
        ...
        TestMetastoreExpr.ExprBuilder e = new TestMetastoreExpr.ExprBuilder(TABLE_NAME);
        List<Partition> result = new ArrayList<>();
        getClient().listPartitionsByExpr(DB_NAME, TABLE_NAME, SerializationUtilities.serializeObjectWithTypeInformation(e.strCol("yyyy").val("2017").pred(">=", 2).build()), null, (short) 100, result);
    ...
    public void testListPartitionsByExprNoDb() throws Exception
    {
        ...
        getClient().listPartitionsByExpr(DB_NAME, TABLE_NAME, new byte[]{'f', 'o', 'o'}, null, (short) -1, new ArrayList<>());
    }
    ...
    {
        getClient().listPartitionsByExpr("", TABLE_NAME, new byte[]{'f', 'o', 'o'}, null, (short) -1, new ArrayList<>());
    }
    ...
    public void testListPartitionsByExprEmptyTblName() throws Exception
    {
        ...
        getClient().listPartitionsByExpr(DB_NAME, "", new byte[]{'f', 'o', 'o'}, null, (short) -1, new ArrayList<>());
    }

    @Test(expected = MetaException.class)
    public void testListPartitionsByExprNullDbName() throws Exception
    {
        getClient().listPartitionsByExpr(null, TABLE_NAME, new byte[]{'f', 'o', 'o'}, null, (short) -1, new ArrayList<>());
    }

    @Test(expected = MetaException.class)
    public void testListPartitionsByExprNullTblName() throws Exception
    {
        getClient().listPartitionsByExpr(DB_NAME, null, new byte[]{'f', 'o', 'o'}, null, (short) -1, new ArrayList<>());
    }

    private void checkExpr(int numParts, ExprNodeGenericFuncDesc expr) throws Exception
    {
        List<Partition> parts = new ArrayList<>();
        getClient().listPartitionsByExpr(DB_NAME, TABLE_NAME, SerializationUtilities.serializeObjectWithTypeInformation(expr), null, (short) -1, parts);
    ...
    public void testListPartitionsSpecByExpr() throws Exception
    {
        ...
        checkExprPartitionSpec(2, e.strCol("yyyy").val("2017").pred("!=", 2).build(), t);
        checkExprPartitionSpec(1, e.strCol("yyyy").val("2017").pred("=", 2).strCol("mm").val("10").pred(">=", 2).pred("and", 2).build(), t);
        checkExprPartitionSpec(3, e.strCol("dd").val("10").pred("<", 2).strCol("yyyy").val("2009").pred("!=", 2).pred("or", 2).build(), t);
    ...
    public void testListPartitionsSpecByExprNullResult() throws Exception
    {
        ...
        PartitionsByExprRequest req = new PartitionsByExprRequest(DB_NAME, TABLE_NAME, ByteBuffer.wrap(SerializationUtilities.serializeObjectWithTypeInformation(e.strCol("yyyy").val("2017").pred("=", 2).build())));
    ...
    private void checkExprPartitionSpec(int numParts, ExprNodeGenericFuncDesc expr, Table t) throws Exception
    {
        ...
        PartitionsByExprRequest req = new PartitionsByExprRequest(DB_NAME, TABLE_NAME, ByteBuffer.wrap(SerializationUtilities.serializeObjectWithTypeInformation(expr)));
        req.setMaxParts((short) -1);
        req.setId(t.getId());
