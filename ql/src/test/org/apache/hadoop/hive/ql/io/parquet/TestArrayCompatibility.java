...
public class TestArrayCompatibility extends AbstractTestParquetDirect
{
    ...
    {
        Path test = writeDirect("ThriftPrimitiveInList", Types.buildMessage().requiredGroup().as(LogicalTypeAnnotation.listType()).repeated(INT32).named("list_of_ints_tuple").named("list_of_ints").named("ThriftPrimitiveInList"), new DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
    ...
    public void testThriftSingleFieldGroupInList() throws Exception
    {
        ...
        Path test = writeDirect("ThriftSingleFieldGroupInList", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.listType()).repeatedGroup().required(INT64).named("count").named("single_element_groups_tuple").named("single_element_groups").named("ThriftSingleFieldGroupInList"), new DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
    ...
    {
        Path test = writeDirect("AvroPrimitiveInList", Types.buildMessage().requiredGroup().as(LogicalTypeAnnotation.listType()).repeated(INT32).named("array").named("list_of_ints").named("AvroPrimitiveInList"), new DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
    ...
    public void testAvroSingleFieldGroupInList() throws Exception
    {
        ...
        Path test = writeDirect("AvroSingleFieldGroupInList", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.listType()).repeatedGroup().required(INT64).named("count").named("array").named("single_element_groups").named("AvroSingleFieldGroupInList"), new DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
    ...
    public void testAmbiguousSingleFieldGroupInList() throws Exception
    {
        ...
        Path test = writeDirect("SingleFieldGroupInList", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.listType()).repeatedGroup().required(INT64).named("count").named("single_element_group").named("single_element_groups").named("SingleFieldGroupInList"), new DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
    ...
    public void testMultiFieldGroupInList() throws Exception
    {
        ...
        Path test = writeDirect("MultiFieldGroupInList", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.listType()).repeatedGroup().required(DOUBLE).named("latitude").required(DOUBLE).named("longitude").named("element") // should not affect schema conversion
                .named("locations").named("MultiFieldGroupInList"), new DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
    ...
    {
        Path test = writeDirect("NewOptionalGroupInList", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.listType()).repeatedGroup().optionalGroup().required(DOUBLE).named("latitude").required(DOUBLE).named("longitude").named("element").named("list").named("locations").named("NewOptionalGroupInList"), new DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
    ...
    {
        Path test = writeDirect("NewRequiredGroupInList", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.listType()).repeatedGroup().requiredGroup().required(DOUBLE).named("latitude").required(DOUBLE).named("longitude").named("element").named("list").named("locations").named("NewRequiredGroupInList"), new DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
    ...
    public void testHiveRequiredGroupInList() throws Exception
    {
        ...
        Path test = writeDirect("HiveRequiredGroupInList", Types.buildMessage().optionalGroup().as(LogicalTypeAnnotation.listType()).repeatedGroup().requiredGroup().required(DOUBLE).named("latitude").required(DOUBLE).named("longitude").named("element").named("bag").named("locations").named("HiveRequiredGroupInList"), new DirectWriter()
        {
            @Override
            public void write(RecordConsumer rc)
            {
