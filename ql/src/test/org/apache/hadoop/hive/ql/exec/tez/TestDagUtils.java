...
public class TestDagUtils
{
    ...
    public void outputCommitterSetToDefaultIfNotPresent() throws IOException
    {
        ...
        assertEquals(HiveFileFormatUtils.NullOutputCommitter.class.getName(), configuration.get("mapred.output.committer.class"));
    }
    ...
    public void outputCommitterNotOverriddenIfPresent() throws IOException
    {
        ...
        assertEquals(TestTezOutputCommitter.CountingOutputCommitter.class.getName(), configuration.get("mapred.output.committer.class"));
    }
