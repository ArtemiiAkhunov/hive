...
public class TestExprNodeDescExprFactory extends TestCase
{
    ...
    public void testToExprWhenColumnIsPrimitive() throws SemanticException
    {
        ...
        columnInfo.setObjectinspector(PrimitiveObjectInspectorFactory.getPrimitiveWritableConstantObjectInspector(typeInfo, new HiveDecimalWritable(HiveDecimal.create(6.4))));
    ...
    public void testToExprWhenColumnIsPrimitiveNullValue() throws SemanticException
    {
        ...
        columnInfo.setTypeName("decimal(3,2)");
        DecimalTypeInfo typeInfo = new DecimalTypeInfo(3, 2);
        columnInfo.setObjectinspector(PrimitiveObjectInspectorFactory.getPrimitiveWritableConstantObjectInspector(typeInfo, null));
    ...
    public void testToExprWhenColumnIsList() throws SemanticException
    {
        ...
        DecimalTypeInfo typeInfo = new DecimalTypeInfo(3, 2);
        columnInfo.setObjectinspector(ObjectInspectorFactory.getStandardConstantListObjectInspector(PrimitiveObjectInspectorFactory.getPrimitiveWritableObjectInspector(typeInfo), asList(new HiveDecimalWritable(HiveDecimal.create(5d)), new HiveDecimalWritable(HiveDecimal.create(0.4)), null)));
    ...
    public void testToExprWhenColumnIsListWithNullValue() throws SemanticException
    {
        ...
        columnInfo.setTypeName("array<decimal(3,2)>");
        DecimalTypeInfo typeInfo = new DecimalTypeInfo(3, 2);
        columnInfo.setObjectinspector(ObjectInspectorFactory.getStandardConstantListObjectInspector(PrimitiveObjectInspectorFactory.getPrimitiveWritableObjectInspector(typeInfo), null));
    ...
    public void testToExprWhenColumnIsMapWithNullValue() throws SemanticException
    {
        ...
        ColumnInfo columnInfo = new ColumnInfo();
        columnInfo.setTypeName("map<int,string>");
        columnInfo.setObjectinspector(ObjectInspectorFactory.getStandardConstantMapObjectInspector(PrimitiveObjectInspectorFactory.getPrimitiveWritableObjectInspector(PrimitiveObjectInspector.PrimitiveCategory.INT), PrimitiveObjectInspectorFactory.getPrimitiveWritableObjectInspector(PrimitiveObjectInspector.PrimitiveCategory.STRING), null));
    ...
    public void testToExprWhenColumnIsStructWithNullFields() throws SemanticException
    {
        ...
        ColumnInfo columnInfo = new ColumnInfo();
        columnInfo.setTypeName("struct<f1:int,f2:string>");
        columnInfo.setObjectinspector(ObjectInspectorFactory.getStandardConstantStructObjectInspector(asList("f1", "f2"), asList(PrimitiveObjectInspectorFactory.getPrimitiveWritableObjectInspector(PrimitiveObjectInspector.PrimitiveCategory.INT), PrimitiveObjectInspectorFactory.getPrimitiveWritableObjectInspector(PrimitiveObjectInspector.PrimitiveCategory.STRING)), asList(null, null)));
