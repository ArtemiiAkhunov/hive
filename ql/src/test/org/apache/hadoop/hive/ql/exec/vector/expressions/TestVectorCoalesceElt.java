...
public class TestVectorCoalesceElt
{
    ...
    private int doCoalesceElt(Random random, int iteration, boolean isCoalesce, boolean isEltIndexConst) throws Exception
    {
        ...
        doCoalesceOnRandomDataType(random, iteration++, isCoalesce, isEltIndexConst, /* columnCount */ 3,
                /* constantColumns */ null, /* nullConstantColumns */ null, /* allowNulls */ true);
        doCoalesceOnRandomDataType(random, iteration++, isCoalesce, isEltIndexConst, /* columnCount */ 3, new int[]{0}, /* nullConstantColumns */ null, /* allowNulls */ true);
        doCoalesceOnRandomDataType(random, iteration++, isCoalesce, isEltIndexConst, /* columnCount */ 3, new int[]{0}, /* nullConstantColumns */ new int[]{0}, /* allowNulls */ true);
        doCoalesceOnRandomDataType(random, iteration++, isCoalesce, isEltIndexConst, /* columnCount */ 3, new int[]{1}, /* nullConstantColumns */ null, /* allowNulls */ true);
        doCoalesceOnRandomDataType(random, iteration++, isCoalesce, isEltIndexConst, /* columnCount */ 3, new int[]{1}, /* nullConstantColumns */ new int[]{1}, /* allowNulls */ true);
        doCoalesceOnRandomDataType(random, iteration++, isCoalesce, isEltIndexConst, /* columnCount */ 3, new int[]{0, 2}, /* nullConstantColumns */ null, /* allowNulls */ true);
        doCoalesceOnRandomDataType(random, iteration++, isCoalesce, isEltIndexConst, /* columnCount */ 3, new int[]{0, 2}, /* nullConstantColumns */ new int[]{0}, /* allowNulls */ true);
        doCoalesceOnRandomDataType(random, iteration++, isCoalesce, isEltIndexConst, /* columnCount */ 3, new int[]{0, 2}, /* nullConstantColumns */ new int[]{0, 2}, /* allowNulls */ false);

        doCoalesceOnRandomDataType(random, iteration++, isCoalesce, isEltIndexConst, /* columnCount */ 4,
                /* constantColumns */ null, /* nullConstantColumns */ null, /* allowNulls */ true);
        doCoalesceOnRandomDataType(random, iteration++, isCoalesce, isEltIndexConst, /* columnCount */ 4,
                /* constantColumns */ null, /* nullConstantColumns */ null, /* allowNulls */ false);
        doCoalesceOnRandomDataType(random, iteration++, isCoalesce, isEltIndexConst, /* columnCount */ 4, new int[]{0, 1, 2}, /* nullConstantColumns */ new int[]{0, 1, 2}, /* allowNulls */ true);
        doCoalesceOnRandomDataType(random, iteration++, isCoalesce, isEltIndexConst, /* columnCount */ 4, new int[]{0, 1, 2}, /* nullConstantColumns */ new int[]{0, 1, 2}, /* allowNulls */ false);
        return iteration;
    }
    ...
    private boolean doCoalesceOnRandomDataType(Random random, int iteration, boolean isCoalesce, boolean isEltIndexConst, int columnCount, int[] constantColumns, int[] nullConstantColumns, boolean allowNulls) throws Exception
    {
        ...
        if (isCoalesce)
        {
            typeName = VectorRandomRowSource.getRandomTypeName(random, SupportedTypes.PRIMITIVES, /* allowedTypeNameSet */ null);
            typeName = VectorRandomRowSource.getDecoratedTypeName(random, typeName, SupportedTypes.PRIMITIVES, /* allowedTypeNameSet */ null,
                    /* depth */ 0, /* maxDepth */ 2);
        } else
        {
        ...
        rowSource.initGenerationSpecSchema(random, generationSpecList, /* maxComplexDepth */ 0,
                /* allowNull */ allowNulls,  /* isUnicodeOk */ true, explicitDataTypePhysicalVariationList);
