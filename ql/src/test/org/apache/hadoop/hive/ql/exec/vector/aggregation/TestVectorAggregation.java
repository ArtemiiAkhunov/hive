...
public class TestVectorAggregation extends AggregationBase
{
    ...
    public void testAvgTimestamp() throws Exception
    {
        ...
        doTests(random, "avg", TypeInfoFactory.timestampTypeInfo);
    }
    ...
    public void testBloomFilter() throws Exception
    {
        ...
        doTests(random, BLOOM_FILTER_FUNCTION, TypeInfoFactory.timestampTypeInfo);
    ...
    public void testVarianceTimestamp() throws Exception
    {
        ...
        for (String aggregationName : varianceNames)
        {
            doTests(random, aggregationName, TypeInfoFactory.timestampTypeInfo);
        }
    }
    ...
    private void doIntegerTests(String aggregationName, Random random) throws Exception
    {
        ...
        {
            doTests(random, aggregationName, typeInfo);
        }
    }
    ...
    private void doDecimalTests(String aggregationName, Random random, boolean tryDecimal64) throws Exception
    {
        ...
        {
            doTests(random, aggregationName, typeInfo, /* isCountStar */ false, tryDecimal64);
        }
    }

    private static TypeInfo[] stringFamilyTypeInfos = new TypeInfo[]{TypeInfoFactory.stringTypeInfo, new CharTypeInfo(25), new CharTypeInfo(10), new VarcharTypeInfo(20), new VarcharTypeInfo(15)};
    ...
    private void doMerge(GenericUDAFEvaluator.Mode mergeUdafEvaluatorMode, Random random, String aggregationName, TypeInfo typeInfo, GenerationSpec keyGenerationSpec, List<String> columns, String[] columnNames, int dataAggrMaxKeyCount, int reductionFactor, TypeInfo partial1OutputTypeInfo, Object[] partial1ResultsArray) throws Exception
    {
        ...
        mergeRowSource.initGenerationSpecSchema(random, mergeAggrGenerationSpecList, /* maxComplexDepth */ 0,
                /* allowNull */ false, /* isUnicodeOk */ true, mergeDataTypePhysicalVariationList);
    ...
    */
        ...
        executeAggregationTests(aggregationName, partial1OutputTypeInfo, mergeEvaluator, mergeOutputTypeInfo, mergeUdafEvaluatorMode, mergeMaxKeyCount, columns, columnNames, mergeParameters, mergeRandomRows, mergeRowSource, mergeBatchSource,
                /* tryDecimal64 */ false, mergeResultsArray);
    ...
    private void doTests(Random random, String aggregationName, TypeInfo typeInfo, boolean isCountStar, boolean tryDecimal64) throws Exception
    {
        ...
        partial1RowSource.initGenerationSpecSchema(random, dataAggrGenerationSpecList, /* maxComplexDepth */ 0, allowNull,  /* isUnicodeOk */ true, explicitDataTypePhysicalVariationList);
    ...
    */
        ...
        if (hasDifferentCompleteExpr)
        {
            ...
            completeRowSource.initGenerationSpecSchema(random, dataAggrGenerationSpecList, /* maxComplexDepth */ 0,
