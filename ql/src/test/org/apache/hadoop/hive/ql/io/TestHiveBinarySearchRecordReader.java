...
public class TestHiveBinarySearchRecordReader
{
    ...
    private static class TestHiveRecordReader<K extends WritableComparable, V extends Writable> extends HiveContextAwareRecordReader<K, V>
    {
    ...
    private void init() throws IOException
    {
        ...
        when(rcfReader.next((LongWritable) any(), (BytesRefArrayWritable) any())).thenReturn(true);
