...
public class CheckFastRowHashMap extends CheckFastHashTable
{
    ...
    private static void verifyRead(LazyBinaryDeserializeRead lazyBinaryDeserializeRead, TypeInfo typeInfo, Object expectedObject) throws IOException
    {
        ...
        {
            final Object complexFieldObj = VerifyFastRow.deserializeReadComplexType(lazyBinaryDeserializeRead, typeInfo);
    ...
    public static class VerifyFastRowHashMap
    {
        ...
        public void verify(VectorMapJoinFastHashTableContainerBase map, HashTableKeyType hashTableKeyType, TypeInfo[] valueTypeInfos, boolean doClipping, boolean useExactBytes, Random random) throws IOException
        {
            ...
            for (int index = 0; index < count; index++)
            {
                ...
                } else
                {
                    ...
                    verifyHashMapRowsMore(rows, actualToValueMap, hashMapResult, valueTypeInfos, clipIndex, useExactBytes);
                }
            }
        }
    }
