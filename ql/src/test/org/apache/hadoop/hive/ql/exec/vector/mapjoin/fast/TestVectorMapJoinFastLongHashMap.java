...
public class TestVectorMapJoinFastLongHashMap extends CommonFastHashTable
{
    ...
    public void testOneKey() throws Exception
    {
        ...
        VectorMapJoinFastLongHashMap map = new VectorMapJoinFastLongHashMap(false, false, HashTableKeyType.LONG, CAPACITY, LOAD_FACTOR, WB_SIZE, -1, tableDesc);
    ...
    public void testFullMap() throws Exception
    {
        ...
        VectorMapJoinFastLongHashMap map = new VectorMapJoinFastLongHashMap(false, false, HashTableKeyType.LONG, CAPACITY, 1f, WB_SIZE, -1, tableDesc);
    ...
    public void testExpand() throws Exception
    {
        ...
        VectorMapJoinFastLongHashMap map = new VectorMapJoinFastLongHashMap(false, false, HashTableKeyType.LONG, 1, 0.0000001f, WB_SIZE, -1, tableDesc);
    ...
    public void addAndVerifyMultipleKeyMultipleValue(int keyCount, VectorMapJoinFastLongHashMap map, VerifyFastLongHashMap verifyTable) throws HiveException, IOException
    {
        addAndVerifyMultipleKeyMultipleValue(keyCount, map, verifyTable, -1);
    }

    public void addAndVerifyMultipleKeyMultipleValue(int keyCount, VectorMapJoinFastLongHashMap map, VerifyFastLongHashMap verifyTable, int fixedValueLength) throws HiveException, IOException
    {
        for (int i = 0; i < keyCount; i++)
        {
            byte[] value;
    ...
    public void testMultipleKeysMultipleValue() throws Exception
    {
        ...
        VectorMapJoinFastLongHashMap map = new VectorMapJoinFastLongHashMap(false, false, HashTableKeyType.LONG, LARGE_CAPACITY, LOAD_FACTOR, LARGE_WB_SIZE, -1, tableDesc);
    ...
    public void testLargeAndExpand() throws Exception
    {
        ...
        // Use a large capacity that doesn't require expansion, yet.
        VectorMapJoinFastLongHashMap map = new VectorMapJoinFastLongHashMap(false, false, HashTableKeyType.LONG, MODERATE_CAPACITY, LOAD_FACTOR, MODERATE_WB_SIZE, -1, tableDesc);
