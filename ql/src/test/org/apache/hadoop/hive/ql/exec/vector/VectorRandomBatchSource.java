...
public class VectorRandomBatchSource
{
            ...
            while (true)
            {
                ...
                if (allowNull)
                {
                    ...
                    while (true)
                    {
                        ...
                        for (int columnNum = bitSet.nextSetBit(0); columnNum >= 0; columnNum = bitSet.nextSetBit(columnNum + 1))
                        {
    ...
    public static VectorRandomBatchSource createInterestingBatches(Random random, VectorRandomRowSource vectorRandomRowSource, Object[][] randomRows, VectorRandomBatchParameters vectorRandomBatchParameters) throws HiveException
    {
        ...
        VectorBatchPatterns vectorBatchPatterns = chooseBatchPatterns(random, vectorRandomRowSource, randomRows);
    ...
    public boolean fillNextBatch(VectorizedRowBatch batch)
    {
        ...
        VectorBatchPattern vectorBatchPattern = vectorBatchPatterns.getTectorBatchPatternList().get(batchCount);
