...
public class TestTypeCheckProcFactory
{
    ...
    {
        return Arrays.asList(new Object[][]{{"127", PrimitiveObjectInspectorUtils.byteTypeEntry, (byte) 127, true}, {"32767", PrimitiveObjectInspectorUtils.shortTypeEntry, (short) 32767, true}, {"2147483647", PrimitiveObjectInspectorUtils.intTypeEntry, 2147483647, true}, {"9223372036854775807", PrimitiveObjectInspectorUtils.longTypeEntry, 9223372036854775807L, true}, {"111.1", PrimitiveObjectInspectorUtils.floatTypeEntry, 111.1f, false}, {"111.1", PrimitiveObjectInspectorUtils.doubleTypeEntry, 111.1d, false}});
    }
    ...
    public TestTypeCheckProcFactory(String maxValue, PrimitiveTypeEntry constType, Object expectedValue, boolean intType)
    {
