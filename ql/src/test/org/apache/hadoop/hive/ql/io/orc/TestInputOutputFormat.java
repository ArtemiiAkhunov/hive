...
public class TestInputOutputFormat
{
    ...
    public void testFileGenerator() throws Exception
    {
        ...
        final MockFileSystem fs = new MockFileSystem(conf, new MockFile("mock:/a/b/part-00", 1000, new byte[1]), new MockFile("mock:/a/b/part-01", 1000, new byte[1]), new MockFile("mock:/a/b/_part-02", 1000, new byte[1]), new MockFile("mock:/a/b/.part-03", 1000, new byte[1]), new MockFile("mock:/a/b/part-04", 1000, new byte[1]));
        OrcInputFormat.FileGenerator gen = new OrcInputFormat.FileGenerator(context, () -> fs, new MockPath(fs, "mock:/a/b"), false, null);
        ...
        final MockFileSystem fs1 = new MockFileSystem(conf, new MockFile("mock:/a/b/part-00", 1000, new byte[1000]), new MockFile("mock:/a/b/part-01", 1000, new byte[1000]), new MockFile("mock:/a/b/_part-02", 1000, new byte[1000]), new MockFile("mock:/a/b/.part-03", 1000, new byte[1000]), new MockFile("mock:/a/b/part-04", 1000, new byte[1000]));
        gen = new OrcInputFormat.FileGenerator(context, () -> fs1, new MockPath(fs, "mock:/a/b"), false, null);
    ...
    public void testACIDSplitStrategyForSplitUpdate() throws Exception
    {
        ...
        final MockFileSystem fs = new MockFileSystem(conf, new MockFile("mock:/a/b/000000_0", 1000, new byte[1], new MockBlock("host1")), new MockFile("mock:/a/b/000000_1", 1000, new byte[1], new MockBlock("host1")));
        OrcInputFormat.FileGenerator gen = new OrcInputFormat.FileGenerator(context, () -> fs, new MockPath(fs, "mock:/a"), false, null);
        List<OrcInputFormat.SplitStrategy<?>> splitStrategies = createSplitStrategies(context, gen);
        assertEquals(1, splitStrategies.size());
        assertEquals(true, splitStrategies.get(0) instanceof OrcInputFormat.ACIDSplitStrategy);
        ...
        final MockFileSystem fs1 = new MockFileSystem(conf, new MockFile("mock:/a/b/000000_0", 1000, new byte[1], new MockBlock("host1")), new MockFile("mock:/a/b/000000_1", 1000, new byte[1], new MockBlock("host1")), new MockFile("mock:/a/base_0000001/bucket_00000", 1000, new byte[1], new MockBlock("host1")), new MockFile("mock:/a/base_0000001/bucket_00001", 1000, new byte[1], new MockBlock("host1")));
        gen = new OrcInputFormat.FileGenerator(context, () -> fs1, new MockPath(fs1, "mock:/a"), false, null);
        splitStrategies = createSplitStrategies(context, gen);
        assertEquals(1, splitStrategies.size());
        assertEquals(true, splitStrategies.get(0) instanceof OrcInputFormat.ACIDSplitStrategy);
        ...
        final MockFileSystem fs4 = new MockFileSystem(conf, new MockFile("mock:/a/b/000000_0", 1000, new byte[1], new MockBlock("host1")), new MockFile("mock:/a/delta_0000001_0000001_0000/bucket_00000", 1000, new byte[1], new MockBlock("host1")), new MockFile("mock:/a/delete_delta_0000001_0000001_0000/bucket_00000", 1000, new byte[1], new MockBlock("host1")), new MockFile("mock:/a/delete_delta_0000001_0000001_0000/bucket_00001", 1000, new byte[1], new MockBlock("host1")));
        gen = new OrcInputFormat.FileGenerator(context, () -> fs4, new MockPath(fs4, "mock:/a"), false, null);
        splitStrategies = createSplitStrategies(context, gen);
        assertEquals(2, splitStrategies.size());
        assertEquals(true, splitStrategies.get(0) instanceof OrcInputFormat.ACIDSplitStrategy);
        splits = ((OrcInputFormat.ACIDSplitStrategy) splitStrategies.get(0)).getSplits();
    ...
    public void testBIStrategySplitBlockBoundary() throws Exception
    {
        ...
        OrcInputFormat.Context context = new OrcInputFormat.Context(conf);
        final MockFileSystem fs = new MockFileSystem(conf, new MockFile("mock:/a/b/part-00", 1000, new byte[1], new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-01", 1000, new byte[1], new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-02", 1000, new byte[1], new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-03", 1000, new byte[1], new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-04", 1000, new byte[1], new MockBlock("host1", "host2")));
        OrcInputFormat.FileGenerator gen = new OrcInputFormat.FileGenerator(context, () -> fs, new MockPath(fs, "mock:/a/b"), false, null);
        List<OrcInputFormat.SplitStrategy<?>> splitStrategies = createSplitStrategies(context, gen);
        assertEquals(1, splitStrategies.size());
        assertEquals(true, splitStrategies.get(0) instanceof OrcInputFormat.BISplitStrategy);
        ...
        context = new OrcInputFormat.Context(conf);
        final MockFileSystem fs0 = new MockFileSystem(conf, new MockFile("mock:/a/b/part-00", 1000, new byte[1000], new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-01", 1000, new byte[1000], new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-02", 1000, new byte[1000], new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-03", 1000, new byte[1000], new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-04", 1000, new byte[1000], new MockBlock("host1", "host2")));
        gen = new OrcInputFormat.FileGenerator(context, () -> fs0, new MockPath(fs0, "mock:/a/b"), false, null);
        splitStrategies = createSplitStrategies(context, gen);
        assertEquals(1, splitStrategies.size());
        assertEquals(true, splitStrategies.get(0) instanceof OrcInputFormat.BISplitStrategy);
        ...
        context = new OrcInputFormat.Context(conf);
        final MockFileSystem fs1 = new MockFileSystem(conf, new MockFile("mock:/a/b/part-00", 1000, new byte[1100], new MockBlock("host1", "host2"), new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-01", 1000, new byte[1100], new MockBlock("host1", "host2"), new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-02", 1000, new byte[1100], new MockBlock("host1", "host2"), new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-03", 1000, new byte[1100], new MockBlock("host1", "host2"), new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-04", 1000, new byte[1100], new MockBlock("host1", "host2"), new MockBlock("host1", "host2")));
        gen = new OrcInputFormat.FileGenerator(context, () -> fs1, new MockPath(fs1, "mock:/a/b"), false, null);
        splitStrategies = createSplitStrategies(context, gen);
        assertEquals(1, splitStrategies.size());
        assertEquals(true, splitStrategies.get(0) instanceof OrcInputFormat.BISplitStrategy);
        splits = ((OrcInputFormat.BISplitStrategy) splitStrategies.get(0)).getSplits();
        ...
        context = new OrcInputFormat.Context(conf);
        final MockFileSystem fs2 = new MockFileSystem(conf, new MockFile("mock:/a/b/part-00", 1000, new byte[2000], new MockBlock("host1", "host2"), new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-01", 1000, new byte[2000], new MockBlock("host1", "host2"), new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-02", 1000, new byte[2000], new MockBlock("host1", "host2"), new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-03", 1000, new byte[2000], new MockBlock("host1", "host2"), new MockBlock("host1", "host2")), new MockFile("mock:/a/b/part-04", 1000, new byte[2000], new MockBlock("host1", "host2"), new MockBlock("host1", "host2")));
        gen = new OrcInputFormat.FileGenerator(context, () -> fs2, new MockPath(fs2, "mock:/a/b"), false, null);
        splitStrategies = createSplitStrategies(context, gen);
        assertEquals(1, splitStrategies.size());
        assertEquals(true, splitStrategies.get(0) instanceof OrcInputFormat.BISplitStrategy);
        splits = ((OrcInputFormat.BISplitStrategy) splitStrategies.get(0)).getSplits();
    ...
    public void testEtlCombinedStrategy() throws Exception
    {
        ...
        OrcInputFormat.Context context = new OrcInputFormat.Context(conf);
        MockFileSystem fs = new MockFileSystem(conf, new MockFile("mock:/a/1/part-00", 1000, new byte[1]), new MockFile("mock:/a/1/part-01", 1000, new byte[1]), new MockFile("mock:/a/2/part-00", 1000, new byte[1]), new MockFile("mock:/a/2/part-01", 1000, new byte[1]), new MockFile("mock:/a/3/base_0/bucket_00001", 1000, new byte[1]), new MockFile("mock:/a/4/base_0/bucket_00001", 1000, new byte[1]), new MockFile("mock:/a/5/base_0/bucket_00001", 1000, new byte[1]), new MockFile("mock:/a/5/delta_0_25/bucket_00001", 1000, new byte[1]), new MockFile("mock:/a/6/delta_27_29/bucket_00001", 1000, new byte[1]), new MockFile("mock:/a/6/delete_delta_27_29/bucket_00001", 1000, new byte[1]));
    ...
    public List<SplitStrategy<?>> createOrCombineStrategies(OrcInputFormat.Context context, MockFileSystem fs, String path, OrcInputFormat.CombinedCtx combineCtx) throws IOException
    {
        Directory adi = createAdi(context, fs, path);
        return OrcInputFormat.determineSplitStrategies(combineCtx, context, adi.getFs(), adi.getPath(), adi.getFiles(), adi.getDeleteDeltas(), null, null, true);
    }

    public Directory createAdi(OrcInputFormat.Context context, final MockFileSystem fs, String path) throws IOException
    {
    ...
    private List<OrcInputFormat.SplitStrategy<?>> createSplitStrategies(OrcInputFormat.Context context, OrcInputFormat.FileGenerator gen) throws IOException
    {
        ...
        return OrcInputFormat.determineSplitStrategies(null, context, adi.getFs(), adi.getPath(), adi.getFiles(), adi.getDeleteDeltas(), null, null, true);
    }
    ...
    public static class MockFileSystem extends FileSystem
    {
        ...
        private LocatedFileStatus createLocatedStatus(MockFile file) throws IOException
        {
            ...
            if (file.isHdfsHflushed)
            {
                ...
                when(mockStatus.getBlockLocations()).thenReturn(getFileBlockLocationsImpl(fileStatus, 0, fileStatus.getLen(), false));
                return mockStatus;
            } else
            {
    ...
    public void testProjectedColumnSize() throws Exception
    {
        ...
        OrcInputFormat.Context context = new OrcInputFormat.Context(conf);
        OrcInputFormat.SplitGenerator splitter = new OrcInputFormat.SplitGenerator(new OrcInputFormat.SplitInfo(context, fs, fs.getFileStatus(new Path("/a/file")), null, null, true, new ArrayList<>(), true, null, null), null, true, true);
        List<OrcSplit> results = splitter.call();
        OrcSplit result = results.get(0);
        ...
        HiveConf.setLongVar(conf, HiveConf.ConfVars.MAPRED_MIN_SPLIT_SIZE, 0);
        context = new OrcInputFormat.Context(conf);
        splitter = new OrcInputFormat.SplitGenerator(new OrcInputFormat.SplitInfo(context, fs, fs.getFileStatus(new Path("/a/file")), null, null, true, new ArrayList<>(), true, null, null), null, true, true);
        results = splitter.call();
    ...
    public void testAcidProjectedColumnSize() throws Exception
    {
        ...
        OrcInputFormat.SplitInfo splitInfo = new OrcInputFormat.SplitInfo(context, fs, fs.getFileStatus(file), null, null, false, new ArrayList<>(), true, null, null);
    ...
    public void testVectorization() throws Exception
    {
        ...
        JobConf conf = createMockExecutionEnvironment(workDir, new Path("mock:///"), "vectorization", inspector, true, 1, MockFileSystem.class.getName());
    ...
    public void testVectorizationWithAcid() throws Exception
    {
        ...
        JobConf conf = createMockExecutionEnvironment(workDir, new Path("mock:///"), "vectorizationAcid", inspector, true, 1, MockFileSystem.class.getName());
    ...
    public void testSplitElimination() throws Exception
    {
        ...
        writer.close(Reporter.NULL);
        serde = new OrcSerde();
        SearchArgument sarg = SearchArgumentFactory.newBuilder().startAnd().lessThan("z", PredicateLeaf.Type.LONG, Long.valueOf(0)).end().build();
    ...
    private StructObjectInspector createSoi()
    {
        synchronized (TestOrcFile.class)
        {
            return (StructObjectInspector) ObjectInspectorFactory.getReflectionObjectInspector(SimpleRow.class, ObjectInspectorFactory.ObjectInspectorOptions.JAVA);
        }
    }
    ...
    public void testVectorReaderNoFooterSerialize() throws Exception
    {
        ...
        JobConf jobConf = createMockExecutionEnvironment(workDir, new Path("mock:///"), "mocktable3", inspector, true, 0, MockFileSystem.class.getName());
        Writer writer = OrcFile.createWriter(new Path(mockPath + "/0_0"), OrcFile.writerOptions(conf).blockPadding(false).bufferSize(1024).inspector(inspector));
        for (int i = 0; i < 10; ++i)
        {
            writer.addRow(new MyRow(i, 2 * i));
    ...
    public void testVectorReaderFooterSerialize() throws Exception
    {
        ...
        JobConf jobConf = createMockExecutionEnvironment(workDir, new Path("mock:///"), "mocktable4", inspector, true, 0, MockFileSystem.class.getName());
        Writer writer = OrcFile.createWriter(new Path(mockPath + "/0_0"), OrcFile.writerOptions(conf).blockPadding(false).bufferSize(1024).inspector(inspector));
        for (int i = 0; i < 10; ++i)
        {
            writer.addRow(new MyRow(i, 2 * i));
    ...
    public void testColumnProjectionWithAcid() throws Exception
    {
        ...
        OrcSplit split = new OrcSplit(testFilePath, null, 0, fileLength, new String[0], null, false, true, new ArrayList<AcidInputFormat.DeltaMetaData>(), fileLength, fileLength, workDir, null);
        ...
        split = new OrcSplit(testFilePath, null, 0, fileLength, new String[0], null, false, true, new ArrayList<AcidInputFormat.DeltaMetaData>(), fileLength, fileLength, workDir, null);
    ...
    private static List<MockFile> mockDeltaWithSideFileForStreaming(String delta, int contentLength, int flush_length)
    {
        ...
        files.add(new MockFile("mock:/streaming/" + delta + "/bucket_00000", blockSize, new byte[contentLength], isDeltaHflushed, blocks));
        files.add(new MockFile("mock:/streaming/" + delta + "/bucket_00000_flush_length", blockSize, bb.array(), false, new MockBlock("host1")));
    ...
    private List<OrcSplit> splitsForStreamingAcidTable(List<MockFile> files) throws Exception
    {
        try
        {
            ...
            OrcInputFormat.FileGenerator gen = new OrcInputFormat.FileGenerator(context, () -> fs, new MockPath(fs, "mock:/streaming"), false, null);
            List<OrcInputFormat.SplitStrategy<?>> splitStrategies = createSplitStrategies(context, gen);
            assertEquals(1, splitStrategies.size());
            assertEquals(true, splitStrategies.get(0) instanceof OrcInputFormat.ACIDSplitStrategy);
