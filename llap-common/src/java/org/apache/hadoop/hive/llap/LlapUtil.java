...
public class LlapUtil
{
    ...
    public static List<StatisticsData> getStatisticsForScheme(final String scheme, final List<StatisticsData> stats)
    {
    ...
    private static FileSystem.Statistics combineFileSystemStatistics(final FileSystem.Statistics s1, final FileSystem.Statistics s2)
    {
    ...
    private static final String BASE_PREFIX = "base_", DELTA_PREFIX = "delta_", DELETE_DELTA_PREFIX = "delete_delta_", BUCKET_PREFIX = "bucket_", DATABASE_PATH_SUFFIX = ".db", UNION_SUDBIR_PREFIX = "HIVE_UNION_SUBDIR_";
