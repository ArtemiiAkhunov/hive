...
public class Converters
{
    ...
    public static TezTaskAttemptID createTaskAttemptId(QueryIdentifierProto queryIdProto, int vertexIndex, int fragmentNum, int attemptNum)
    {
        // Come ride the API roller-coaster!
        return TezTaskAttemptID.getInstance(TezTaskID.getInstance(TezVertexID.getInstance(TezDAGID.getInstance(ConverterUtils.toApplicationId(queryIdProto.getApplicationIdString()), queryIdProto.getDagIndex()), vertexIndex), fragmentNum), attemptNum);
    }
    ...
    public static TezTaskAttemptID createTaskAttemptId(TaskContext ctx)
    {
        ...
        return TezTaskAttemptID.getInstance(TezTaskID.getInstance(TezVertexID.getInstance(TezDAGID.getInstance(ctx.getApplicationId(), ctx.getDagIdentifier()), ctx.getTaskVertexIndex()), ctx.getTaskIndex()), ctx.getTaskAttemptNumber());
    }
    ...
    private static OutputSpec getOutputSpecFromProto(IOSpecProto outputSpecProto)
    {
        ...
        {
            outputDescriptor = convertOutputDescriptorFromProto(outputSpecProto.getIoDescriptor());
        }
    ...
    {
        GroupInputSpec groupSpec = new GroupInputSpec(groupInputSpecProto.getGroupName(), groupInputSpecProto.getGroupVerticesList(), convertInputDescriptorFromProto(groupInputSpecProto.getMergedInputDescriptor()));
        return groupSpec;
    }
    ...
    private static UserPayload convertPayloadFromProto(EntityDescriptorProto proto)
    {
