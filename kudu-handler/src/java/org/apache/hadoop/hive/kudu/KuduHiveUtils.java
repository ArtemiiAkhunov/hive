...
public final class KuduHiveUtils
{
    ...
    public static String getMasterAddresses(Configuration conf) throws IOException
    {
        ...
        if (StringUtils.isEmpty(masterAddresses))
        {
            throw new IOException("Kudu master addresses are not specified in the table property (" + KUDU_MASTER_ADDRS_KEY + "), or default configuration (" + HiveConf.ConfVars.HIVE_KUDU_MASTER_ADDRESSES_DEFAULT.varname + ").");
        }
