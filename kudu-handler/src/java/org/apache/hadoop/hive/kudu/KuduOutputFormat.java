...
public class KuduOutputFormat extends OutputFormat<NullWritable, KuduWritable> implements HiveOutputFormat<NullWritable, KuduWritable>
{
    ...
    @Override
    public org.apache.hadoop.mapred.RecordWriter<NullWritable, KuduWritable> getRecordWriter(FileSystem ignored, JobConf job, String name, Progressable progress) throws IOException
    {
        return new KuduRecordWriter(job);
    }

    @Override
    public RecordWriter<NullWritable, KuduWritable> getRecordWriter(TaskAttemptContext context) throws IOException
    {
