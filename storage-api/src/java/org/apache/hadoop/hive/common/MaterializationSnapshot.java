...
public class MaterializationSnapshot
{
    ...
    public static MaterializationSnapshot fromJson(String jsonString)
    {
        ...
        {
            LOG.warn(String.format("Unable to parse string as json '%s'. Falling back to parse it as a ValidTxnWriteIdList", jsonString), e);
    ...
    {
        return "MaterializationSnapshot{" + "validTxnList='" + validTxnList + '\'' + ", tableSnapshots=" + tableSnapshots + '}';
    }
