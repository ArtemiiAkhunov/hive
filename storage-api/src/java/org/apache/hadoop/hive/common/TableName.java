...
public class TableName implements Serializable
{
     ...
     */
    public static TableName fromString(final String name, final String defaultCatalog, final String defaultDatabase, String tableMetaRef) throws IllegalArgumentException
    {
        if (name == null)
        {
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(cat, tableName.cat) && Objects.equals(db, tableName.db) && Objects.equals(table, tableName.table);
    }
