...
public final class HiveDecimalWritable extends FastHiveDecimal implements WritableComparable<HiveDecimalWritable>
{
    ...
    public void write(DataOutput out, long[] scratchLongs, byte[] scratchBuffer) throws IOException
    {
        ...
        int byteLength = fastBigIntegerBytes(scratchLongs, scratchBuffer);
        if (byteLength == 0)
        {
    ...
    {
        fastReset();
        isSet = fastSerializationUtilsRead(inputStream, scale, scratchBytes);
        return isSet;
    }
    ...
    public void mutateAdd(HiveDecimalWritable decWritable)
    {
        ...
        isSet = fastAdd(decWritable, this);
    }
    ...
    public void mutateSubtract(HiveDecimalWritable decWritable)
    {
        ...
        isSet = fastSubtract(decWritable, this);
    }
    ...
    public void mutateMultiply(HiveDecimalWritable decWritable)
    {
        ...
        isSet = fastMultiply(decWritable, this);
    }
    ...
    public void mutateDivide(HiveDecimalWritable decWritable)
    {
        ...
        isSet = fastDivide(decWritable, this);
    }
    ...
    public void mutateRemainder(HiveDecimalWritable decWritable)
    {
        ...
        isSet = fastRemainder(decWritable, this);
    }
    ...
    public byte[] getInternalStorage()
    {
        ...
        return bigIntegerBytesCopy(internalScratchLongs, internalScratchBuffer);
    }
