...
public interface PredicateLeaf
{
    ...
    {
        EQUALS, NULL_SAFE_EQUALS, LESS_THAN, LESS_THAN_EQUALS, IN, BETWEEN, IS_NULL
    }
    ...
    public static enum Type
    {
        ...
        DATE(Date.class), DECIMAL(HiveDecimalWritable.class), TIMESTAMP(Timestamp.class), BOOLEAN(Boolean.class);
