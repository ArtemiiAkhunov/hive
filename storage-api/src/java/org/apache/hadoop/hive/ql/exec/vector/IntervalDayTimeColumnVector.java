...
public class IntervalDayTimeColumnVector extends ColumnVector
{
    ...
    {
        return asScratchIntervalDayTime(elementNum1).compareTo(intervalDayTimeColVector2.asScratchIntervalDayTime(elementNum2));
    }
    ...
    {
        return intervalDayTimeColVector1.asScratchIntervalDayTime(elementNum1).compareTo(asScratchIntervalDayTime(elementNum2));
    }
