...
public class TestHiveDecimal extends HiveDecimalTestBase
{
    ...
    public void testCreateFromBigDecimalRounding()
    {
        ...
        bigDec = new BigDecimal("1786135888657847525803324040144343378.09799306448796128931113691624");
        ...
        bigDec = new BigDecimal("8.090000000000000000000000000000000000000123456");
        ...
        // MAX_DECIMAL 9's WITH NO ROUND (longer than 38 digits)
        bigDec = new BigDecimal("99999999.99999999999999999999999999999949999");
        ...
        // MAX_DECIMAL 9's WITH ROUND.
        bigDec = new BigDecimal("99999999.99999999999999999999999999999979999");
        //                   12346678.901234667890123466789012346678
        //                             1         2         3
    ...
    public void testPrecisionScaleEnforcementEdgeCond()
    {
        ...
        Assert.assertEquals("0.999999999999999", HiveDecimal.enforcePrecisionScale(fifteenFractionalNinesDec, 15, 15).toString());

        HiveDecimal sixteenFractionalNines = HiveDecimal.create("0.9999999999999999");
        Assert.assertNotNull(sixteenFractionalNines);
        Assert.assertEquals("0.9999999999999999", HiveDecimal.enforcePrecisionScale(sixteenFractionalNines, 16, 16).toString());

        HiveDecimal seventeenFractionalNines = HiveDecimal.create("0.99999999999999999");
        Assert.assertNotNull(seventeenFractionalNines);
        Assert.assertEquals("0.99999999999999999", HiveDecimal.enforcePrecisionScale(seventeenFractionalNines, 17, 17).toString());
    ...
    private void doTestLongValue(BigDecimal bigDecimal)
    {
        ...
        boolean isLongExpected = bigDecimalFloor.equals(bigDecimalDec.valueOf(longValueBigDecimalFloor));
    ...
    private void doTestIntValue(BigDecimal bigDecimal)
    {
        ...
        boolean isIntExpected = bigDecimalFloor.equals(bigDecimalDec.valueOf(intValueBigDecimalFloor));
    ...
    private void doTestShortValue(BigDecimal bigDecimal)
    {
        ...
        boolean isShortExpected = bigDecimalFloor.equals(bigDecimalDec.valueOf(shortValueBigDecimalFloor));
    ...
    private void doTestByteValue(BigDecimal bigDecimal)
    {
        ...
        boolean isByteExpected = bigDecimalFloor.equals(bigDecimalDec.valueOf(byteValueBigDecimalFloor));
    ...
    private void doTestBigIntegerBytes(BigDecimal bigDecimal)
    {
        ...
        try
        {
            ...
            which = 3;
            HiveDecimal createFromBigIntegerBytesDec = HiveDecimal.createFromBigIntegerBytesAndScale(bytes, 0, bytes.length, scale);
    ...
    private void doTestScaleByPowerOfTen(Random r, BigDecimal bigDecimal)
    {
        ...
        for (int power = -(2 * HiveDecimal.MAX_SCALE + 1); power <= 2 * HiveDecimal.MAX_SCALE + 1; power++)
        {
            ...
            } else
            {
                ...
                if (!isEqual)
                {
                    if (oldPowerDecString.equals("0.00000000000000000000000000000000000001") || oldPowerDecString.equals("-0.00000000000000000000000000000000000001"))
                    {
                        continue;
                    }
                    Assert.fail();
    ...
    private void doTestRound(Random r, BigDecimal bigDecimal, int roundingMode)
    {
        ...
        for (int newScale = -(2 * HiveDecimal.MAX_SCALE + 1); newScale <= 2 * HiveDecimal.MAX_SCALE + 1; newScale++)
        {
