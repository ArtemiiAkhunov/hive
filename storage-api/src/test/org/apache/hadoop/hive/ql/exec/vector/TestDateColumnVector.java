...
public class TestDateColumnVector
{
    ...
    private void setDateAndVerifyProlepticUpdate(long longDay, String expectedDateString, boolean originalUseProleptic, boolean newUseProleptic) throws Exception
    {
        ...
        Assert.assertEquals("original = " + originalUseProleptic + " new = " + newUseProleptic, expectedDateString, dateColumnVector.formatDate(0));
    }
