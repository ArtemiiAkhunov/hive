...
public class TestOp
{
    ...
    public void testInlineJoinOpJsonHandling() throws Exception
    {
        ...
        Op dummyOp = new Op("Dummy Op", "dummy-id", "output-vertex-name", null, Collections.EMPTY_LIST, null, mapJoin, null, tezJsonParser);
        ...
        Op uut = new Op("Map Join Operator", "op-id", "output-vertex-name", null, Collections.EMPTY_LIST, attrs, mapJoin, vertexA, tezJsonParser);
        uut.inlineJoinOp();
