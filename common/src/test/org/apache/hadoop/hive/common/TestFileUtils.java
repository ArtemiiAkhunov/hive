...
public class TestFileUtils
{
    ...
    {
        MockFileSystem fs = new MockFileSystem(new HiveConf(), new MockFile("mock:/tmp/.staging", 500, new byte[0]), new MockFile("mock:/tmp/_dummy", 500, new byte[0]), new MockFile("mock:/tmp/dummy", 500, new byte[0]));
    ...
    {
        assertTrue(FileUtils.isSameOzoneBucket(new Path("ofs://ozone1/vol1/bucket1/dir1"), new Path("ofs://ozone1/vol1/bucket1/dir2/file1")));
        assertTrue(FileUtils.isSameOzoneBucket(new Path("ofs://ozone1/vol1/bucket1/"), new Path("ofs://ozone1/vol1/bucket1/dir2/file1")));

        assertFalse(FileUtils.isSameOzoneBucket(new Path("ofs://ozone1/vol1/"), new Path("ofs://ozone1/vol1/bucket1/dir2/file1")));

        assertFalse(FileUtils.isSameOzoneBucket(new Path("ofs://ozone1/vol1/bucket1/"), new Path("ofs://ozone1/vol2/bucket1/dir2/file1")));

        assertFalse(FileUtils.isSameOzoneBucket(new Path("ofs://ozone1/vol1/bucket1/"), new Path("ofs://ozone1/vol1/bucket2/dir2/file1")));
    }
    ...
    public void testResolveSymlinks() throws IOException
    {
        ...
        Assert.assertNull("Path without scheme should be resolved to another Path without scheme", originalPathResolvedWithoutInputScheme.toUri().getScheme());
