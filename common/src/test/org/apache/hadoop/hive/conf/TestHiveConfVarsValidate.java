...
public class TestHiveConfVarsValidate
{
    ...
    public static Collection<Object[]> generateParameters()
    {
        ...
        list.add(new Object[]{HIVE_EXPLAIN_NODE_VISIT_LIMIT, String.valueOf(Integer.MIN_VALUE), "Invalid value  -2147483648, which should be in between 1 and 2147483647"});
        list.add(new Object[]{HIVE_EXPLAIN_NODE_VISIT_LIMIT, "-10", "Invalid value  -10, which should be in between 1 and 2147483647"});
        list.add(new Object[]{HIVE_EXPLAIN_NODE_VISIT_LIMIT, "0", "Invalid value  0, which should be in between 1 and 2147483647"});
        ...
        list.add(new Object[]{HIVE_DATETIME_RESOLVER_STYLE, "strict", null});
        list.add(new Object[]{HIVE_DATETIME_RESOLVER_STYLE, "lenient", null});
        list.add(new Object[]{HIVE_DATETIME_RESOLVER_STYLE, "OTHER", "Invalid value.. expects one of [smart, strict, " + "lenient]"});
        return list;
    }
