...
public class Constants
{
    ...
    public static final String ICEBERG_PARTITION_TABLE_SCHEMA = "partition,spec_id,record_count,file_count," + "position_delete_record_count,position_delete_file_count,equality_delete_record_count," + "equality_delete_file_count,last_updated_at,total_data_file_size_in_bytes,last_updated_snapshot_id";
