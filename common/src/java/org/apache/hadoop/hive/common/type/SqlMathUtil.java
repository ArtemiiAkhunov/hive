...
public final class SqlMathUtil
{
     ...
     * @param positive whether to turn off (positive) or on (negative).
     ...
     *
     * @param dividend dividend. in.
     * @param divisor  divisor. in.
     * @param quotient quotient. out.
     * @return remainder
     */
    ...
    static
    {
        ...
        INVERSE_POWER_FIVES_INT128[0] = new UnsignedInt128(0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
        ...
        INVERSE_POWER_TENS_INT128[0] = new UnsignedInt128(0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
        ...
        for (int i = 1; i < POWER_TENS_INT128.length; ++i)
        {
            ...
            {
                quotient = ((inverseTens[j] & SqlMathUtil.LONG_MASK) + (remainder << 32)) / divisor;
                remainder = ((inverseTens[j] & SqlMathUtil.LONG_MASK) + (remainder << 32)) % divisor;
