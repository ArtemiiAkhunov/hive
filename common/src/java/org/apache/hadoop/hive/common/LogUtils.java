...
public class LogUtils
{
    ...
    private static String initHiveLog4jCommon(ConfVars confVarName) throws LogInitializationException
    {
    ...
    @VisibleForTesting
    public static String initHiveLog4jCommon(HiveConf conf, ConfVars confVarName) throws LogInitializationException
    {
    ...
    private static String initHiveLog4jDefault(HiveConf conf, String logMessage, ConfVars confVarName) throws LogInitializationException
    {
        URL hive_l4j = null;
        switch (confVarName)
        {
