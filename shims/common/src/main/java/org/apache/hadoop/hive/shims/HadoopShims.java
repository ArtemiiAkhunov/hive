...
public interface HadoopShims
{
     ...
     */
    MiniDFSShim getMiniDfs(Configuration conf, int numDataNodes, boolean format, String[] racks) throws IOException;

    MiniDFSShim getMiniDfs(Configuration conf, int numDataNodes, boolean format, String[] racks, boolean isHA) throws IOException;
    ...
    interface CombineFileInputFormatShim<K, V>
    {
        ...
        RecordReader getRecordReader(JobConf job, CombineFileSplit split, Reporter reporter, Class<RecordReader<K, V>> rrClass) throws IOException;
    }
     ...
     */
    List<HdfsFileStatusWithId> listLocatedHdfsStatus(FileSystem fs, Path path, PathFilter filter) throws IOException;
     ...
     * @throws IOException
     */
    BlockLocation[] getLocations(FileSystem fs, FileStatus status) throws IOException;
     ...
     * @throws IOException
     */
    TreeMap<Long, BlockLocation> getLocationsWithOffset(FileSystem fs, FileStatus status) throws IOException;
    ...
    public interface HCatHadoopShims
    {
        ...
        public org.apache.hadoop.mapreduce.TaskAttemptContext createTaskAttemptContext(Configuration conf, TaskAttemptID taskId);
     ...
     */
    boolean runDistCpAs(List<Path> srcPaths, Path dst, Configuration conf, UserGroupInformation proxyUser) throws IOException;
     ...
     * @return true if it is successful; false otherwise.
     */
    boolean runDistCpWithSnapshots(String oldSnapshot, String newSnapshot, List<Path> srcPaths, Path dst, boolean overwriteTarget, Configuration conf) throws IOException;
     ...
     * @return true if it is successful; false otherwise.
     */
    boolean runDistCpWithSnapshotsAs(String oldSnapshot, String newSnapshot, List<Path> srcPaths, Path dst, boolean overwriteTarget, UserGroupInformation proxyUser, Configuration conf) throws IOException;
