...
LOAD
DATA LOCAL INPATH "${hiveconf:test.data.dir}/kv1.txt"
...
ANALYZE
TABLE srcpart PARTITION(ds, hr) COMPUTE STATISTICS;

ANALYZE
TABLE srcpart PARTITION(ds, hr) COMPUTE STATISTICS FOR COLUMNS key,value;
