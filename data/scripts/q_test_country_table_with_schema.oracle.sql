...
CREATE
USER bob IDENTIFIED BY bobpass;
ALTER
USER bob QUOTA UNLIMITED ON users;
GRANT CREATE
SESSION TO bob;
...
CREATE
USER alice IDENTIFIED BY alicepass;
ALTER
USER alice QUOTA UNLIMITED ON users;
...
-- namespace.
GRANT
SELECT ANY TABLE TO bob;
GRANT
SELECT ANY TABLE TO alice;
