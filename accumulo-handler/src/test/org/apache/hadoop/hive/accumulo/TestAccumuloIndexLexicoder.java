...
public class TestAccumuloIndexLexicoder
{
    ...
    public void testBooleanString()
    {
        ...
        assertArrayEquals(AccumuloIndexLexicoder.encodeValue(value, serdeConstants.BOOLEAN_TYPE_NAME, true), value);
    }
    ...
    public void testBooleanBinary()
    {
        ...
        assertArrayEquals(AccumuloIndexLexicoder.encodeValue(value, serdeConstants.BOOLEAN_TYPE_NAME, false), Boolean.TRUE.toString().getBytes(UTF_8));
    }
    ...
    public void testDateString()
    {
        ...
        assertArrayEquals(AccumuloIndexLexicoder.encodeValue(value, serdeConstants.DATE_TYPE_NAME, true), value);
    }
    ...
    public void testDateTimeString()
    {
        ...
        assertArrayEquals(AccumuloIndexLexicoder.encodeValue(value, serdeConstants.TIMESTAMP_TYPE_NAME, true), value);
    }
    ...
    public void testString()
    {
        ...
        byte[] value = strVal.getBytes(UTF_8);
        assertArrayEquals(AccumuloIndexLexicoder.encodeValue(value, serdeConstants.STRING_TYPE_NAME, true), value);
        assertArrayEquals(AccumuloIndexLexicoder.encodeValue(value, "varChar(20)", true), value);
        assertArrayEquals(AccumuloIndexLexicoder.encodeValue(value, "CHAR (20)", true), value);
    }
}
