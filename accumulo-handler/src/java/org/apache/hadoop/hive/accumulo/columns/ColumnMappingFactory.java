...
public class ColumnMappingFactory
{
     ...
     * @param defaultEncoding The default encoding in which values should be encoded to Accumulo
     */
    public static ColumnMapping get(String columnSpec, ColumnEncoding defaultEncoding, String columnName, TypeInfo columnType)
    {
        ...
        } else
        {
            ...
            } else
            {
                ...
                {
                    cq = cq.replaceAll(AccumuloHiveConstants.ESCAPED_ASTERISK_REGEX, Character.toString(AccumuloHiveConstants.ASTERISK));
                }
