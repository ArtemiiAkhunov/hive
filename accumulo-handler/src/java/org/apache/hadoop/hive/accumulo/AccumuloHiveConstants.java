...
public class AccumuloHiveConstants
{
    ...
    public static final String ESCAPED_ASTERISK = Character.toString(ESCAPE) + Character.toString(ASTERISK);

    // Escape the escape, and escape the asterisk
    public static final String ESCAPED_ASTERISK_REGEX = Character.toString(ESCAPE) + Character.toString(ESCAPE) + Character.toString(ESCAPE) + Character.toString(ASTERISK);
