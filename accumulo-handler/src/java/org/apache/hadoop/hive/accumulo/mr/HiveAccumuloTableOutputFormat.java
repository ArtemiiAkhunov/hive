    ...
    protected void configureAccumuloOutputFormat(JobConf job) throws IOException
    {
        ...
        try
        {
            ...
            } else
            {
                ...
                getHelper().setOutputFormatZooKeeperInstance(job, cnxnParams.getAccumuloInstanceName(), cnxnParams.getZooKeepers(), cnxnParams.useSasl());
            }
            ...
            {
                getHelper().setOutputFormatConnectorInfo(job, cnxnParams.getAccumuloUserName(), new PasswordToken(cnxnParams.getAccumuloPassword()));
            }
            ...
            final boolean binaryEncoding = ColumnEncoding.BINARY.getName().equalsIgnoreCase(job.get(AccumuloSerDeParameters.DEFAULT_STORAGE_TYPE));
