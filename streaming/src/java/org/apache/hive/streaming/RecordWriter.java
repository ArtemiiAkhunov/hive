...
public interface RecordWriter
{
     ...
     * @throws StreamingException - thrown when initialization failed
     */
    default void init(StreamingConnection connection, long minWriteId, long maxWriteID, int statementId) throws StreamingException
    {
     ...
     */
    default Path getDeltaFileLocation(List<String> partitionValues, Integer bucketId, Long minWriteId, Long maxWriteId, Integer statementId, Table table) throws StreamingException
    {
