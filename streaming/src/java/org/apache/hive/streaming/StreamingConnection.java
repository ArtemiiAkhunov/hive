...
public interface StreamingConnection extends ConnectionInfo, PartitionHandler
{
     ...
     */
    default void commitTransaction(@Nullable Set<String> partitions, @Nullable String key, @Nullable String value) throws StreamingException
    {
     ...
     * @throws StreamingException - if there are errors when committing the open transaction.
     */
    default void commitTransaction(@Nullable Set<String> partitions) throws StreamingException
    {
        throw new UnsupportedOperationException();
    }
     ...
     */
    default Path getDeltaFileLocation(List<String> partitionValues, Integer bucketId, Long minWriteId, Long maxWriteId, Integer statementId) throws StreamingException
    {
        throw new UnsupportedOperationException();
    }
