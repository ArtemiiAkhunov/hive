...
public class LlapPluginServerImpl extends AbstractService implements LlapPluginProtocolPB
{
    ...
    public void serviceStart()
    {
        ...
        server = LlapUtil.startProtocolServer(port, numHandlers, bindAddress, conf, daemonImpl, LlapPluginProtocolPB.class, secretManager, new LlapPluginPolicyProvider(), ConfVars.LLAP_PLUGIN_ACL, ConfVars.LLAP_PLUGIN_ACL_DENY);
